...
#include "util.h"
#else
/* Standalone usage with the Chromium EC runtime */
#include "shared_mem.h"
...
/* Stubbed call */
static int in_interrupt_context(void) { return 0; }
/* Single task testing: stubbed out */
struct mutex {};
void mutex_lock(struct mutex *mtx) {}
void mutex_unlock(struct mutex *mtx) {}

/* Contiguous chunk of memory in lieu of shared mem */
static void *__shared_mem_buf;
static size_t __shared_mem_size;
uintptr_t system_usable_ram_end(void)
{
	return __shared_mem_size + (uintptr_t)__shared_mem_buf;
}
#endif /* CHROMIUM_EC */
...
{
	__shared_mem_buf = chunk;
	__shared_mem_size = size;
	shared_mem_init();
}
#endif /* CHROMIUM_EC */
