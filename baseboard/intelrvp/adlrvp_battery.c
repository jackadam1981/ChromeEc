...
#ifdef CONFIG_BATTERY_RUNTIME_CONFIG
/* Default 3S battery configuration */
...
struct board_batt_params board_battery2S_info[] = {
	/*
	 * Getac Battery (Getac SMP-HHP-408) Information
	 * Fuel gauge: BQ40Z50-R3
	 */
...
BUILD_ASSERT(ARRAY_SIZE(board_battery2S_info) == BATTERY_TYPE_COUNT);

const enum battery_type DEFAULT_BATTERY_TYPE = BATTERY_GETAC_SMP_HHP_408;
#endif /* CONFIG_BATTERY_RUNTIME_CONFIG */
