...
static void configure_retimer_usbmux(void)
{
	...
	case ADLN_LP5_RVP_SKU_BOARD_ID:
		...
		usb_muxes[TYPE_C_PORT_0].mux->i2c_addr_flags =
			TUSB1064_I2C_ADDR14_FLAGS;
		usb_muxes[TYPE_C_PORT_0].mux->driver = &tusb1064_usb_mux_driver;
		usb_muxes[TYPE_C_PORT_0].mux->hpd_update = tusb1044_hpd_update;

#if defined(HAS_TASK_PD_C1)
		usb_muxes[TYPE_C_PORT_1].mux->driver = NULL;
		usb_muxes[TYPE_C_PORT_1].mux->hpd_update = NULL;
#endif
		break;
...
#if defined(HAS_TASK_PD_C2)
		usb_muxes[TYPE_C_PORT_2].mux->driver = NULL;
#endif
		break;
