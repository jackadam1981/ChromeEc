...
struct usb_mux usbc0_virtual_mux = {
	.usb_port = TYPE_C_PORT_0,
...
#ifdef HAS_TASK_PD_C1
struct usb_mux usbc1_virtual_mux = {
	.usb_port = TYPE_C_PORT_1,
	.driver = &virtual_usb_mux_driver,
	.hpd_update = &virtual_hpd_update,
#ifdef CONFIG_USBC_RETIMER_INTEL_BB
...
struct usb_mux *usb_muxes[] = {
	[TYPE_C_PORT_0] = &usbc0_virtual_mux,
#ifdef HAS_TASK_PD_C1
	[TYPE_C_PORT_1] = &usbc1_virtual_mux,
#endif /* HAS_TASK_PD_C1 */
};
...
struct usb_mux usbc0_anx7440_mux = {
	.usb_port = TYPE_C_PORT_0,
...
#ifdef HAS_TASK_PD_C1
struct usb_mux usbc1_anx7440_mux = {
	.usb_port = TYPE_C_PORT_1,
...
struct usb_mux *usb_muxes[] = {
	[TYPE_C_PORT_0] = &usbc0_anx7440_mux,
#ifdef HAS_TASK_PD_C1
	[TYPE_C_PORT_1] = &usbc1_anx7440_mux,
#endif /* HAS_TASK_PD_C1 */
};
BUILD_ASSERT(ARRAY_SIZE(usb_muxes) == CONFIG_USB_PD_PORT_MAX_COUNT);
