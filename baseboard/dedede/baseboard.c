...
__override int get_pg_ec_dsw_pwrok(void)
{
	/*
...
__override int get_pg_ec_all_sys_pwrgd(void)
{
	/*
	 * ALL_SYS_PWRGD is an AND of both DRAM PGOOD and VCCST PGOOD.  Assuming
	 * that power is good if voltage is at least 80% of nominal level.  Note
	 * that this is an inverted power good; a low value mueans that the
	 * power is good.
	 */
