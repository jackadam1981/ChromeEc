...
/* Hold off on charger init until FW_CONFIG is retireved at I2C + 1 */
#undef  CONFIG_CHARGER_INIT_PRIORITY
#define CONFIG_CHARGER_INIT_PRIORITY (HOOK_PRIO_INIT_I2C + 2)
