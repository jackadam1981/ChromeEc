...
/* For AP domain */
	...
	{ AP_REG_BASE, AP_REG_BASE + 0x10000000, MPU_ATTR_W | MPU_ATTR_R | MPU_ATTR_P },
#else
	...
	{ DRAM_NC_BASE, (unsigned int)KERNEL_BASE + (unsigned int)KERNEL_SIZE, MPU_ATTR_W | MPU_ATTR_R },
#else
