...
/*
 * Port 1 USB MUX (Bits 6-7)
 */
enum ec_ssfc_c1_usb_mux {
	ec_ssfc_c1_usb_mux_tusb544 = 0,
	ec_ssfc_c1_usb_mux_ps8818 = 1,
};
#define SSFC_C1_USB_MUX_OFFSET 6
#define SSFC_C1_USB_MUX_MASK GENMASK(7, 6)
 ...
 */
enum ec_ssfc_c1_usb_mux get_cbi_ssfc_c1_usb_mux(void);
