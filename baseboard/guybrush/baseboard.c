...
{
	panic("board_ps8818_mux_set not overridden by board");
}
...
__overridable int board_anx7451_mux_set(const struct usb_mux *me,
					mux_state_t mux_state)
{
	panic("board_anx7451_mux_set not overridden by board");
}
...
struct usb_mux usbc1_anx7451 = {
	...
	.board_set = &board_anx7451_mux_set,
};
...
DECLARE_HOOK(HOOK_INIT, setup_mux, HOOK_PRIO_INIT_I2C + 2);
...
static void baseboard_chipset_resume(void)
{
	...
	case USB_A1_RETIMER_PS8811:
		...
		break;
	default:
		CPRINTSUSB("A1: Unknown retimer, not enabling A1 retimer");
	}
}
