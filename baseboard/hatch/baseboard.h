...
#ifdef CUSTOM_PD_CONFIG
#define PD_OPERATING_POWER_MW	CUS_PD_OPERATING_POWER_MW
#define PD_MAX_POWER_MW			CUS_PD_MAX_POWER_MW
#define PD_MAX_CURRENT_MA		CUS_PD_MAX_CURRENT_MA
#define PD_MAX_VOLTAGE_MV		CUS_PD_MAX_VOLTAGE_MV
#else
