...
static void ps8815_reset(void)
{
	...
	msleep(PS8XXX_PWR_H_RST_H_DELAY_MS);
	...
	if (i2c_read8(I2C_PORT_USB_C1, 0x0a, 0x0f, &val) == EC_SUCCESS)
		CPRINTS("ps8815: reg 0x0f was %02x", val);

	if (i2c_write8(I2C_PORT_USB_C1, 0x0a, 0x0f, 0x31) == EC_SUCCESS)
...
static uint8_t usb_db_type = USB_DB_NONE;
