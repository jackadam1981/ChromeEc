...
/* Responses specifally for the enablement of TBT mode in the role of UFP */

#define OPOS_TBT 1
static union tbt_dev_mode_enter_cmd
	ufp_enter_mode[CONFIG_USB_PD_PORT_MAX_COUNT];

const union tbt_mode_resp_device vdo_tbt_modes[1] = {
		{
			.tbt_alt_mode = 0x0001,
...
const uint32_t vdo_idh = VDO_IDH(
				...
				IDH_PTYPE_HUB, /* PDUSB hub */
				1, /* Supports alt modes */
				USB_VID_GOOGLE);

const uint32_t vdo_idh_rev30 = VDO_IDH_REV30(
				 1, /* Data caps as USB host     */
				 1, /* Data caps as USB device   */
				 IDH_PTYPE_HUB, /* PDUSB hub */
				 1, /* Supports alt modes */
				 IDH_PTYPE_DFP_HOST, /* PDUSB host    */
				 USB_CONN_RECEP, /* TYPE-C receptacle */
				 USB_VID_GOOGLE);

const uint32_t vdo_product = VDO_PRODUCT(CONFIG_USB_PID, CONFIG_USB_BCD_DEV);

/* TODO(b/168890624): add USB4 to capability once USB4 response implemented */
const uint32_t vdo_ufp1 = VDO_UFP1(VDO_VER_11, /* VDO version 1.1 */
				   (UFP_USB20 | UFP_USB32),
				   USB_CONN_RECEP, /* TYPE-C receptacle  */
				   UFP_TBT3, /* TBT3 */
				   USB_R30_SS_U40_GEN3 /* USB4 Gen3 */);

const uint32_t vdo_dfp = VDO_DFP(VDO_VER_11, /* VDO version 1.1 */
				 (DFP_USB20 | DFP_USB32 | DFP_USB4),
				 USB_CONN_RECEP, /* TYPE-C receptacle */
				 1  /* Port 1 */);
