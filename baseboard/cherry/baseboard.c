...
struct ppc_config_t ppc_chips[CONFIG_USB_PD_PORT_MAX_COUNT] = {
	...
	},
	{
		...
		.i2c_addr_flags = RT1718S_SLAVE_ADDR_FLAGS,
		.drv = &rt1718s_ppc_drv,
	},
};
...
__override int board_rt1718s_init(int port)
{
	...
	RETURN_ERROR(rt1718s_write8(port, RT1718S_GPIO1_VBUS_CTRL,
			RT1718S_GPIOX_CTRL_ENA_SRC_VBUS |
			RT1718S_GPIOX_CTRL_DIS_SNK_VBUS));
	RETURN_ERROR(rt1718s_write8(port, RT1718S_GPIO2_VBUS_CTRL,
			RT1718S_GPIOX_CTRL_ENA_SRC_VBUS |
			RT1718S_GPIOX_CTRL_DIS_SNK_VBUS));
	RETURN_ERROR(rt1718s_write8(port, 0xEC, 0xFF));
