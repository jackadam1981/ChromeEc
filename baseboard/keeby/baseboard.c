...
/* Keeby family-specific configuration */
 ...
 *
 * Keeby boards use this PWROK sequence:
...
/*
 * keeby does not use hibernate wake pins, but the super low power "Z-state"
...
/*
 * keeby does not have a GPIO indicating ACOK, therefore the charger or TCPC
