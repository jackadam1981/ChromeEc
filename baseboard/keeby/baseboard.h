 ...
 * VARIANT_KEEBY_NPCX797FC
 */
#if defined(VARIANT_KEEBY_EC_NPCX797FC)
	/* NPCX7 config */
...
#elif defined(VARIANT_KEEBY_EC_IT8320)
	/* IT83XX config */
...
#else
#error "Must define a VARIANT_KEEBY_EC!"
#endif
