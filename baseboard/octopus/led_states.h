 ...
 * SATE_CHARGING_FULL_CHARGE is when  led_charge_level_2 <= charge_percentage < 100
 */
enum led_states {
...
extern __attribute__((weak)) int led_power_blink_on_msec;

/* Power LED blink off msec - defined in board's led.c */
extern __attribute__((weak)) int led_power_blink_off_msec;
 ...
 */
void __attribute__((weak)) led_set_color_power(int enable);
