 ...
 */
  ...
  */
	...
	#define CONFIG_USB_PD_TCPC_LOW_POWER		/* CY_UPD undef for test */
	#define CONFIG_USB_PD_DUAL_ROLE_AUTO_TOGGLE     /* CY_UPD for test */
#if !defined(VARIANT_OCTOPUS_TCPC_0_PS8751)
	#define CONFIG_USB_PD_TCPM_ANX7447	/* C0 TCPC: ANX7447QN */
#endif
	#undef CONFIG_USB_PD_TCPM_PS8751	/* CY_UPD: undef C1 TCPC: PS8751 */
	#define CONFIG_USB_PD_TCPM_PPC_CCGXXF	/* CY_UPD: C1 TCPC: CCG6xf */
...
#define CONFIG_USB_PD_DISCHARGE_TCPC	/* CY_UPD: was PPC/ TODO if it affects C0 port? */
#define CONFIG_USB_PD_TRY_SRC		/* CY_UPD for test */
#define CONFIG_USBC_SS_MUX
#define CONFIG_USBC_VCONN	/* CY_UPD: VCONN off for debugging */
#define CONFIG_USBC_VCONN_SWAP	/* CY_UPD: VCONN off for debugging */
...
#define PD_MAX_VOLTAGE_MV	5000 /* CY_UPD for test, was 20000 */
