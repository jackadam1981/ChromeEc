...
========================
ChromiumOS EC Repository
========================
The ChromiumOS EC repository contains the open-source firmware for a variety of
...
*   **Embedded Controller (EC)**: The EC is a microcontroller present in
    ...
    charging, keyboard scanning, thermal management, USB-C port management, and other
...
*   **Integrated Sensor Hub (ISH)**: On some devices, an ISH is used to manage
    ...
    EC to save memory and processing time.
