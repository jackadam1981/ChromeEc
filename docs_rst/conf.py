...
html_baseurl = "https://placeholder.google.com"
...
def env_get_outdated(app, env, added, changed, removed): # pylint: disable=unused-argument
    """
    ...
    To support the latest version of Sphinx, the arguments must be present in
    this function, so we ignore the unused-argument linter.
    """
    return ["index"]
