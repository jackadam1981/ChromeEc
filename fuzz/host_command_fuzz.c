...
static int hostcmd_fill(const uint8_t *data, size_t size)
{
	 ...
	 * The regions corespond to field(s) of the request's struct ec_host_request header
	 * and following data payload.
	 ...
	 */
	// TODO(hesling): These are totally ineffective, since it returns above if ipos!=size.
