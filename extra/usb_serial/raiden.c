...
#define GOOGLE_USB_SUBCLASS_SERIAL	0x50
#define GOOGLE_USB_PROTOCOL_SERIAL	0x01

static struct usb_device_id const ids[] = {
	{ USB_VENDOR_AND_INTERFACE_INFO(GOOGLE_USB_VENDOR_ID,
					USB_CLASS_VENDOR_SPEC,
					GOOGLE_USB_SUBCLASS_SERIAL,
					GOOGLE_USB_PROTOCOL_SERIAL) },
        { 0 }
};
