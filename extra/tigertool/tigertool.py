...
def get_parser():
  ...
  parser.add_argument('--setserialno', type=str, default=None,
                      help='serial number to set on the board.')
  parser.add_argument('-m', '--mux', type=str, default=None,
                      help='mux selection')
  parser.add_argument('-r', '--sysjump', type=str, default=None,
