    ...
    while line is not None:
      ...
      while line is not None:
        ...
        if symbol is not None:
          # Found the function head, break the searching loop and go to the
          # step 2.
      ...
      # Move to the next line of the function head.
      line = next(disasm_file, None)
      instructions = []
      ...
      while line is not None:
        ...
        if instruction is None:
          # Reach the function end, break the parsing loop.
          break
      ...
      function_map[function_symbol.address] = Function(function_symbol.address,
...
def main():
  ...
  try:
    ...
    with tempfile.TemporaryFile(mode='w+') as symbol_file:
      ...
      symbol_file.seek(0)
      symbols = ParseSymbolFile(symbol_file)
