...
When a callsite calls a number of functions based on values from an array, one
...
is `<name>_end`), stride is the array element side, and offset is the offset of
