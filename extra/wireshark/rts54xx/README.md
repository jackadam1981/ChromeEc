...
```
    1   0.000000           EC → PDC          UCSI-RTS54xx 8 Connector Reset
    2   0.130000           EC → PDC          UCSI-RTS54xx 8 Get RTK Status
    3   0.250000          PDC → EC           UCSI-RTS54xx 6 Response-Get-RTK-Status
    4   0.260000           EC → PDC          UCSI-RTS54xx 8 Get Cable Property
    5   0.370000          PDC → EC           UCSI-RTS54xx 9 Response-Get-Cable-Property
    6   0.390000           EC → PDC          UCSI-RTS54xx 7 Get Capabilities
    7   0.490000          PDC → EC           UCSI-RTS54xx 20 Response-Get-Capabilities
...
```
