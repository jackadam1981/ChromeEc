...
class RMAOpen(object):
    ...
    def enable_testlab(self):
        ...
        print('Once the process starts keep tapping the power button for 10', end=' ')
        print('seconds.')
    ...
    def check_version(self):
        ...
        print('prePVT' if self.is_prepvt else 'prod', end=' ')
...
def main():
    ...
    if not cr50_rma_open.check(TESTLAB_IS_ENABLED) and cr50_rma_open.is_prepvt:
        ...
        print('If you are prepping a device for the testlab, you should enable', end=' ')
        print('testlab mode')
