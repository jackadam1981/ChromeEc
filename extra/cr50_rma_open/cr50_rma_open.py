...
url that will generate a authcode to open cr50. It can also be used to
...
Go to the URL from by that command to generate a authcode. Once you have
...
class RMAOpen(object):
    ...
    def check_ccd_settings(self, success):
