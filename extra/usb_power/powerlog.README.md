...
-   Example 1
    ...
    `<directory>/sweetberry<timestemp>/summary.txt`. If `<directory>` does not
    ...
    powerlog.py>/sweetberry<timestemp>/summary.txt`.
...
-   Example 2
    ...
    `<directory>/sweetberry<timestemp>/raw_data/`. If `<directory>` does not
    exist, it will be created.
    ...
    powerlog.py>/sweetberry<timestemp>/raw_data/`.
...
-   Example 3:
    ...
    `<directory>/sweetberry<timestemp>/summary.json`. If `<directory>` does not
    exist, it will be created.
    ...
    powerlog.py>/sweetberry<timestemp>/summary.json`.
