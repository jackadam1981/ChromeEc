...
#define I2C_PSEUDO_SET_TIMEOUT_CMD "SET_ADAPTER_TIMEOUT"
...
/* All values must be >= 0.  Errors should not be listed here. */
...
enum i2c_pseudo_ctrlr_state {
	 ...
	 * zero-initialized memory results in it being the default value.
	 */
...
struct i2c_pseudo_controller {
	 ...
	 * two may access the i2c_adapter field of sturct i2c_pseudo_controller.
	 */
