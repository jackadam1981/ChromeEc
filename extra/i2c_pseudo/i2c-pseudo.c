...
/* TODO: Delete this. */
#undef I2C_PSEUDO_ENABLE_CDEV_POLL
#define I2C_PSEUDO_ENABLE_CDEV_POLL
...
#ifdef I2C_PSEUDO_ENABLE_CDEV_POLL
static __poll_t i2c_pseudo_cdev_poll(struct file *filep,
	struct poll_table_struct *ptp)
{
	struct i2c_pseudo_controller *pdata;
