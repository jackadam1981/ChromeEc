...
static inline bool isnan(float a)
{
	...
	/*
	 * If value is NaN then the standard guarantees that a != a is true.
	 * This could be used as a convenient way to check if value is NaN, but
	 * we don't have guarantee that it won't trigger FPU exception.
	 */
