...
int cmd_pchg(int argc, char *argv[])
{
	...
	char *e;
	int rv;
	struct ec_response_pchg_count *rsp_count =
		static_cast<ec_response_pchg_count *>(ec_inbuf);
	...
	if (argc < 3) {
		...
		struct ec_params_pchg *p =
			static_cast<ec_params_pchg *>(ec_outbuf);
		struct ec_response_pchg *r =
			static_cast<ec_response_pchg *>(ec_inbuf);
