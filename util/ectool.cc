...
int cmd_flash_protect(int argc, char *argv[])
{
	...
	printf("Flash protect flags: %d", flash_protect_command.GetFlags());
	printf("Valid flags: %d", flash_protect_command.GetValidFlags());
	printf("Writable flags: %d", flash_protect_command.GetWritableFlags());
