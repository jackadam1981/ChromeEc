...
def transfer(prop_obj):
    ...
    Args:
        ...
        prop_obj.ec_transfer: Tells the current transfer file
    """
    ...
    while offset < prop_obj.payload_length:
        ...
        if prop_obj.ec_transfer is False:
            # This required for Second Loader transfer to SRAM
            # Boot ROM need some time to respond back
