...
file_line = [
    "S 55 AA 55 AA",
    "R 5A A5",
    "SF 65 header0.bin 40",
    "RF 65 CRC32",
    "SF 66 keyhashblob.bin 80",
    "RF 66 CRC32",
    "SF 67 fwbin0.bin 80",
    "RF 67 CRC32",
    "SC 70 CRC32",
            ...
            try:
                ...
                for n in range(sf_count):
                    while tx_file_size > 0:
                        ...
                        print(" tx file size ", tx_file_size, end="\r")
                        sf_cont_disp = []
                        crc_input_bytes = bytearray()
...
def main(argv):
    ...
    print(
        "UART_CR_V2.exe utility to send and receive commands from the Command prompt\n"
    )
    print("                        Version 2.0  10/30/22")
    print(
        "**************************************************************************"
    )
    print(argv)
