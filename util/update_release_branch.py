...
def main(argv):
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "Defaults to all known modules ({known}) if not specified. "
            "Provide the flag with no arguments to select no optional modules. "
            "Only applies if --zephyr is also set. "
            "Known modules: {known}".format(known=", ".join(ZEPHYR_MODULE_LIST))
        ),
    )
