...
extern int (*ec_command)(int command, int version,
			 void *outdata, int outsize, /* to the EC */
 ...
 */
extern uint8_t (*read_mapped_mem8)(uint8_t offset);
extern uint16_t (*read_mapped_mem16)(uint8_t offset);
extern uint32_t (*read_mapped_mem32)(uint8_t offset);
/*
 ...
 */
extern int (*read_mapped_string)(uint8_t offset, char *buf);
