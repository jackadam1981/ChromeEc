...
static bool vif_fields_present(vif_field_t *vif_fields, int count)
{
	int index;
...
static void vif_out_fields_range(FILE *vif_file, int level,
			   vif_field_t *vif_fields, int start, int count)
{
	int index;
...
static void vif_out_fields(FILE *vif_file, int level,
			   vif_field_t *vif_fields, int count)
{
...
static void vif_output_vif_component_cable_svid_mode_list(FILE *vif_file,
			vif_cableSVIDList_t *svid_list, int *level)
{
	int index;
	...
	*level += 1;
	for (index = 0; index < MAX_NUM_CABLE_SVID_MODES; ++index) {
		vif_cableSVIDModeList_t *mode_list =
...
static void vif_output_vif_component_cable_svid_list(FILE *vif_file,
			vif_Component_t *component, int *level)
{
	int index;
...
static void vif_output_vif_component_sop_svid_mode_list(FILE *vif_file,
			vif_sopSVIDList_t *svid_list, int *level)
{
	int index;
	...
	*level += 1;
	for (index = 0; index < MAX_NUM_SOP_SVID_MODES; ++index) {
		vif_sopSVIDModeList_t *mode_list =
...
static void vif_output_vif_component(FILE *vif_file, vif_t *vif,
			int *level)
{
	int index;

	for (index = 0; index < MAX_NUM_COMPONENTS; ++index) {
		vif_Component_t *component = &vif->Component[index];
...
static void vif_output_vif_product_usb4router_endpoint(FILE *vif_file,
			vif_Usb4RouterListType_t *router, int *level)
{
	int index;
	...
	*level += 1;
	for (index = 0; index < MAX_NUM_PCIE_ENDPOINTS; ++index) {
		vif_PCIeEndpointListType_t *endpont =
...
static void vif_output_vif_product_usb4router(FILE *vif_file, vif_t *vif,
			int *level)
{
	int index;
	...
	*level += 1;
	for (index = 0; index < MAX_NUM_USB4_ROUTERS; ++index) {
		vif_Usb4RouterListType_t *router =
...
static void vif_output_vif_product(FILE *vif_file, vif_t *vif, int *level)
{
...
static void vif_output_vif_xml(FILE *vif_file, vif_t *vif, int *level)
{
...
static void vif_output_xml(FILE *vif_file, vif_t *vif)
{
	int level = 0;
 ...
 */
static void set_vif_field(vif_field_t *vif_field,
			char *name,
			char *tag_value,
			char *str_value)
{
...
__maybe_unused static void set_vif_field_b(vif_field_t *vif_field,
			char *name,
			bool val)
{
	if (val)
...
__maybe_unused static void set_vif_field_stis(vif_field_t *vif_field,
			char *name,
			char *tag_value,
			int str_value)
{
...
__maybe_unused static void set_vif_field_itss(vif_field_t *vif_field,
			char *name,
			int tag_value,
			char *str_value)
{
...
__maybe_unused static void set_vif_field_itis(vif_field_t *vif_field,
			char *name,
			int tag_value,
			int str_value)
{
 ...
 */
__maybe_unused static int32_t set_vif_snk_pdo(vif_snkPdoList_t *snkPdo,
					      uint32_t pdo)
{
	int32_t power;
...
__maybe_unused static int32_t set_vif_src_pdo(vif_srcPdoList_t *srcPdo,
					      uint32_t pdo)
{
	int32_t power;
...
#if defined(CONFIG_USBC_VCONN_SWAP)
...
#if defined(CONFIG_USB_PD_SIMPLE_DFP)
...
#if defined(CONFIG_USB_PD_MANUFACTURER_INFO)
...
#if defined(CONFIG_USB_PD_SECURITY_MSGS)
...
#if defined(CONFIG_USB_PD_TRY_SRC)
...
#if defined(CONFIG_USB_ALT_MODE_ADAPTER)
...
#if defined(CONFIG_USB_PD_GIVE_BACK)
		giveback = true;
#endif
