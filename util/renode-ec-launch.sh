...
readonly DEFAULT_EC_ROOT="${HOME}/chromiumos/src/platform/ec"
readonly DEFAULT_BOARD="bloonchipper"
readonly DEFAULT_PROJECT="ec"
...
usage() {
	...
	echo ""
	echo "Args:"
	echo "  ec-path is the path to the EC source root dir" \
		"[${DEFAULT_EC_ROOT}]"
