...
class Packet(object):
    ...
    def check_trailer_and_decode_packet(self):
        ...
        if self.data_len and (
                (not self.data) or self.data[-1] != self.END_MAGIC):
            self.errors.append(
...
class Acroterm(object):
    ...
    def __init__(self, args):
        ...
        self.cr50_mode = type(self).__name__ == 'Cr50Acroterm'
