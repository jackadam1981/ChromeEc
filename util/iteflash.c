...
static void display_usage(char *program)
{
	...
	fprintf(stderr, "-m, --i2c-mux: Enable i2c-mux (to EC).\n"
		"\tDefault is no action on i2c-mux. Specify this flag if\n"
		"\tthe board has an I2C MUX and you are not using servod.\n");
	...
	fprintf(stderr, "-u, --unprotect : Remove flash write protect.\n");
