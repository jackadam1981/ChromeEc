...
uartupdatetool-files=main cmd opr l_com_port lib_crc
Uartupdatetool-objs=$(foreach c, $(uartupdatetool-files), uut/src/source/$(c).o)
$(out)/util/Uartupdatetool: BUILD_CFLAGS+=-Iutil/uut/src/include/ \
			-Iutil/uut/SWC_DEFS/
endif
endif
