...
def _DoNothing():
  """Do-nothing function for use as a callback with CallIf()."""
...
def DoIf(subprocs=_DoNothing, threads=_DoNothing):
  ...
  Args:
    subprocs: callable that does not require any args - This will be returned
    ...
    threads: callable that does not require any args - This will be returned
