...
# EC image, we can increase the timeout for stability just incase it takes a bit
# longer to receive an ACK for some reason.
...
class Console(object):
  ...
  Attributes:
    ...
    interrogation_timeout: A float represeting the current maximum seconds to
