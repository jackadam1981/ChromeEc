...
static const char *field_name[] = {
	...
	CBI_FIELD_NAME_ENTRY(BATT_SHIP_MODE_FLAGS),
	CBI_FIELD_NAME_ENTRY(BATT_SHIP_MODE_REG_ADDR),
	CBI_FIELD_NAME_ENTRY(BATT_SHIP_MODE_REG_DATA),
	CBI_FIELD_NAME_ENTRY(BATT_SLEEP_MODE_FLAGS),
	CBI_FIELD_NAME_ENTRY(BATT_SLEEP_MODE_REG_ADDR),
	CBI_FIELD_NAME_ENTRY(BATT_SLEEP_MODE_REG_DATA),
	CBI_FIELD_NAME_ENTRY(BATT_FET_FLAGS),
	...
	CBI_FIELD_NAME_ENTRY(BATT_PRECHARGE_VOLTAGE),
	CBI_FIELD_NAME_ENTRY(BATT_PRECHARGE_CURRENT),
	CBI_FIELD_NAME_ENTRY(BATT_START_CHARGING_MIN_C),
	CBI_FIELD_NAME_ENTRY(BATT_START_CHARGING_MAX_C),
	CBI_FIELD_NAME_ENTRY(BATT_CHARGING_MIN_C),
	CBI_FIELD_NAME_ENTRY(BATT_CHARGING_MAX_C),
	CBI_FIELD_NAME_ENTRY(BATT_DISCHARGING_MIN_C),
	CBI_FIELD_NAME_ENTRY(BATT_DISCHARGING_MAX_C),
};
