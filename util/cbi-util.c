...
#define ARGS_MASK_FILENAME		(1 << 4)
#define ARGS_MASK_OEM_ID		(1 << 1)
#define ARGS_MASK_SIZE			(1 << 3)
#define ARGS_MASK_SKU_ID		(1 << 2)
...
static int cmd_create(int argc, char **argv)
{
	...
	if (set_mask != (ARGS_MASK_FILENAME | ARGS_MASK_BOARD_VERSION |
			ARGS_MASK_OEM_ID | ARGS_MASK_SKU_ID | ARGS_MASK_SIZE)) {
