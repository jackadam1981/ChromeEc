...
static void param_parse_cmd_line(int argc, char *argv[])
{
	...
	while ((opt = getopt_long(argc, argv, short_opts,
		...
		case 'b':
			...
			break;
		case 'o':
			strncpy((char *)opr_name, optarg, sizeof(opr_name));
			opr_name[sizeof(opr_name)-1] = '\0';
			break;
		case 'p':
			strncpy((char *)port_name, optarg, sizeof(port_name));
			port_name[sizeof(port_name)-1] = '\0';
			break;
		case 'f':
			strncpy((char *)file_name, optarg, sizeof(file_name));
			file_name[sizeof(file_name)-1] = '\0';
			break;
		case 'a':
			strncpy((char *)addr_str, optarg, sizeof(addr_str));
			addr_str[sizeof(addr_str)-1] = '\0';
			break;
		case 's':
			strncpy((char *)size_str, optarg, sizeof(size_str));
