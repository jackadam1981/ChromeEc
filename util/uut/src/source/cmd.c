 ...
 *---------------------------------------------------------------------------
 */
void CMD_CreateWrite(UINT32 addr, UINT32 size, UINT8 *dataBuf, UINT8 *cmdInfo,
	UINT32 *cmdLen)
{
	UINT32 i;
 ...
 *---------------------------------------------------------------------------
 */
BOOLEAN CMD_DispWrite(UINT8 *respBuf, UINT32 respSize, UINT32 respNum,
		      UINT32 totalSize)
{
 ...
 *---------------------------------------------------------------------------
 */
BOOLEAN CMD_DispRead(UINT8 *respBuf, UINT32 respSize, UINT32 respNum,
		     UINT32 totalSize)
{
