...
#ifndef __UTIL_DISABLE_CLANG_OPTIMIZATIONS_H
#define __UTIL_DISABLE_CLANG_OPTIMIZATIONS_H

/* Inlude guards aren't necessary as the pragma is idempotent. Adding them to
 ...
 * unoptimizated code can still be gained at the pre-link stage by inserting a
...
#endif /* __UTIL_DISABLE_CLANG_OPTIMIZATIONS_H */
