...
# Base directory for the EC code base
EC_BASE = pathlib.Path(__file__).parents[1]
...
class KconfigCheck:
    ...
    def __init__(self, argv):
        ...
        self.log = _init_log(self.args.verbose)
        self.fail_count = 0
    ...
    def _kconf_from_path(self, path):
        ...
        If path resides under zephyr/programs, find the name of the program and
        ...
        Returns:
            A kconfiglib.Kconfig object.
        """
        program_path = pathlib.Path("zephyr", "program").resolve()
