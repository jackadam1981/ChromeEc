...
def _default_y(defaults):
    ...
    for default in defaults:
        if (
            isinstance(default[0], kconfiglib.Symbol)
            and default[0].is_constant
            and default[0].str_value == "y"
        ):
            return True
    return False
...
def _default_y_if_ztest(defaults):
    ...
    for default in defaults:
        if (
            ...
            and default[0].is_constant
            and default[0].str_value == "y"
            and isinstance(default[1], kconfiglib.Symbol)
            and default[1].name == "ZTEST"
        ):
            return True
    return False
