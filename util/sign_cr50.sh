...
arm-none-eabi-objcopy -I binary -O ihex --change-addresses 0x44000 build/cr50/RW/ec.RW.flat build/cr50/RW/ec.RW.hex

arm-none-eabi-objcopy -I binary -O ihex --change-addresses 0x84000 build/cr50/RW/ec.RW_B.flat build/cr50/RW/ec.RW_B.hex

cat build/cr50/RO/ec.RO.hex build/cr50/RW/ec.RW.hex build/cr50/RW/ec.RW_B.hex | grep -v ':00000001FF' > build/cr50/ec.hex

arm-none-eabi-objcopy -I ihex -O binary --gap-fill=0xff --pad-to=0xc0000 build/cr50/ec.hex build/cr50/ec.bin
