...
CROS_VERSION_SCRIPT_PATH="${SCRIPT_DIR}/../../../${CROS_VERSION_SCRIPT}"
...
main() {
  ...
  if [[ -f "${CROS_VERSION_SCRIPT_PATH}" ]]; then
    fwid_version=${BOARD}_$(${CROS_VERSION_SCRIPT_PATH} | \
    ...
    echo "#define CROS_FWID \"\""
    echo "#define CROS_FWID32 \"\""
  fi
}
