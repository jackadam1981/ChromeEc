...
int read_com(struct itecomdbgr_config *conf, uint8_t *inbuff, int ReadBytes)
{
	int bReadStat;
...
int write_com(struct itecomdbgr_config *conf, const uint8_t *lpOutBuffer,
	      int WriteBytes)
{
	int bWriteStat;
...
int erase_4k(struct itecomdbgr_config *conf)
{
	int i = 0;
	int result = SUCCESS;
...
int erase_flash(struct itecomdbgr_config *conf)
{
	int result = SUCCESS;
...
int fast_read_burst_cdata(struct itecomdbgr_config *conf, uint8_t *C_Data,
			  bool check_erased)
{
	unsigned int i = 0;
	uint8_t DBG_BUF[256];
...
int page_program_burst_v2(struct itecomdbgr_config *conf, uint8_t *wr_data)
{
	int result = SUCCESS;
	unsigned int j = 0;
	unsigned long start_addr = conf->update_start_addr;
...
int write_flash(struct itecomdbgr_config *conf)
{
	int result = SUCCESS;
...
int check_flash(struct itecomdbgr_config *conf)
{
	int result = SUCCESS;
...
int verify_flash(struct itecomdbgr_config *conf)
{
	int result = SUCCESS;
...
int read_flash(struct itecomdbgr_config *conf)
{
	int result = SUCCESS;
