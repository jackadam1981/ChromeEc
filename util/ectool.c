...
int cmd_version(int argc, char *argv[])
{
	...
	if (rv < 0) {
		fprintf(stderr, "WARNING: EC_CMD_GET_CROS_FWID failed: %d\n",
				rv);
		strncpy(cros_fwid.cros_fwid_string_ro, "NO_CROS_FWID", 32);
		strncpy(cros_fwid.cros_fwid_string_rw, "NO_CROS_FWID", 32);
	}
	rv = 0;
	...
	cros_fwid.cros_fwid_string_ro[
		sizeof(cros_fwid.cros_fwid_string_ro) - 1] = '\0';
	cros_fwid.cros_fwid_string_rw[
		sizeof(cros_fwid.cros_fwid_string_rw) - 1] = '\0';
