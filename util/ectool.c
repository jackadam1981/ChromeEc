...
static void cmd_smart_discharge_usage(const char *command)
{
	...
	printf("cutoff: Discharge rate in cutoff (uAh/h)\n");
	printf("hibern: Discharge rate in hibernation (uAh/h)\n");
}
...
int cmd_smart_discharge(int argc, char *argv[])
{
	...
	printf("Cutoff discharge rate: %d uAh/h\n", r->drate.cutoff);
	printf("Hibernation discharge rate: %d uAh/h\n", r->drate.hibern);
