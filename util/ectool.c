	...
	if (argc >= 3 && !strcasecmp(argv[1], "spoof")) {
		...
		if (param.spoof.spoof_enable == 3)
			...
			printf("Sensor %d spoof mode is %s.\n",
			       ...
			       resp->spoof.status ? "enabled" : "disabled");
