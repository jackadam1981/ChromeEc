...
int cmd_eldrid(int argc, char *argv[])
{
	...
	printf("Current:%d mA, Voltage:%d mV, RemainCapacity:%d mAh/mWh, display:%d %%, calculate: %d %%\n",
		r.charge_current, r.charge_voltage, r.remaining_capacity, r.RSOC_dis, r.RSOC);
