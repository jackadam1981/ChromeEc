...
int cmd_usb_pd(int argc, char *argv[])
{
	...
	if (cmdver == 0) {
		...
		if (cmdver == 2) {
			printf("USBc PD CC State: ");
			if (r_v2->flag & USBC_PD_CC_NONE)
				printf("None");
			else if (r_v2->flag & USBC_PD_CC_NO_UFP)
				printf("No UFP");
			else if (r_v2->flag & USBC_PD_CC_AUDIO_ACC)
				printf("Audio accessory");
			else if (r_v2->flag & USBC_PD_CC_DEBUG_ACC)
				printf("Debug accessory");
			else if (r_v2->flag & USBC_PD_CC_UFP_ATTACHED)
				printf("UFP attached");
			else if (r_v2->flag & USBC_PD_CC_DFP_ATTACHED)
				printf("DFP attached");
			printf("\n");
		}
