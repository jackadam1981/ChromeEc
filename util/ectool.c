...
int cmd_fp_stats(int argc, char *argv[])
{
	...
	printf("FP stats:\n");
	printf("Last capture time:  %d us\n", r.last_capture_time_us);
	printf("Last matching time: %d us\n", r.last_matching_time_us);
	printf("Last overall time:  %d us\n", r.last_overall_time_us);
