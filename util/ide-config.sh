...
#   - You must modify the tool chains to allow enabling nostdinc
#   - C/C++ Build -> Settings -> Tool Settings -> Cross GCC Compiler ->
#     Preprocessor -> Uncheck "Do not search system directories (-nostdinc)"
eclipse-cdt-import() {
	if [[ $# -gt 1 ]]; then
