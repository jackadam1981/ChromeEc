...
# This is an inefficient manor of resource management, but at least
# throttles processes creation. Due to the low utilization or each job,
# multiple the number of real processors by 2.
