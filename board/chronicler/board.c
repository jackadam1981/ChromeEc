...
static int get_battery_run_time_day(int *battery_run_time)
{
	int rv, i, run_time = 0;
	uint8_t data[6];
	...
	/* get 32bits battery run time from data, first 2 byte is command */
	for (i = 0; i < MANUFACTURE_RUNTIME_SIZE; i++)
