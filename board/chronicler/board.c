...
__maybe_unused static const struct ec_thermal_config thermal_config_without_fan = THERMAL_CONFIG_WITHOUT_FAN;
...
__maybe_unused static const struct ec_thermal_config thermal_config_with_fan = THERMAL_CONFIG_WITH_FAN;
