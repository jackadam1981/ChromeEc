...
enum gpio_signal gpio_en_pp5000_a = GPIO_EN_PP5000_A_EVT;
...
static void board_gpio_set_pp5000(void)
{
	...
	if (board_id == 0) {
		reset_gpio_flags(GPIO_EN_PP5000_A_P0, GPIO_OUT_LOW);
		/* Change runtime default for P0 */
		gpio_en_pp5000_a = GPIO_EN_PP5000_A_P0;
	} else if (board_id >= 1) {
		reset_gpio_flags(GPIO_EN_PP5000_A_EVT, GPIO_OUT_LOW);
	}
