...
void board_hibernate(void)
{
	...
	const uint32_t hibernate_pins[][2] = {
		...
		{GPIO_LED_1_L, GPIO_INPUT | GPIO_PULL_UP}, /* Yellow (hatch) */
		{GPIO_LED_2_L, GPIO_INPUT | GPIO_PULL_UP}, /* White (hatch) */
		{GPIO_LED_3_L, GPIO_INPUT | GPIO_PULL_UP},
		{GPIO_LED_4_L, GPIO_INPUT | GPIO_PULL_UP},
	...
	gpio_set_flags_by_mask(0x8, 0x04, GPIO_INPUT | GPIO_PULL_UP);
