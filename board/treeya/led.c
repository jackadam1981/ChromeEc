 ...
 *	led2		Blue	Amber
 */
static enum gpio_signal led_green = GPIO_BAT_LED_1_L;
static enum gpio_signal led_red = GPIO_BAT_LED_2_L;
...
void led_set_color_battery(enum ec_led_colors color)
{
	...
	case EC_LED_COLOR_RED:
		gpio_set_level(led_green, LED_OFF_LVL);
		gpio_set_level(led_red, LED_ON_LVL);
		break;
	case EC_LED_COLOR_AMBER:
		gpio_set_level(led_green, LED_ON_LVL);
		gpio_set_level(led_red, LED_ON_LVL);
		break;
	case EC_LED_COLOR_GREEN:
		gpio_set_level(led_green, LED_ON_LVL);
		gpio_set_level(led_red, LED_OFF_LVL);
		break;
