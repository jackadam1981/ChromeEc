...
#define I2C_PORT_ALS		NPCX_I2C_PORT3_0
#define I2C_PORT_PMIC		NPCX_I2C_PORT0_0
#define I2C_PORT_BATTERY	NPCX_I2C_PORT4_0
#define I2C_PORT_CHARGER	NPCX_I2C_PMIC
#define I2C_PORT_THERMAL	NPCX_I2C_PMIC
