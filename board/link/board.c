...
const struct gpio_info gpio_list[] = {
	...
	{"POWER_BUTTON_L",       LM4_GPIO_K, (1<<7), GPIO_IN_INT_BOTH,
	 power_button_interrupt},
	{"LID_OPEN",             LM4_GPIO_K, (1<<5), GPIO_IN_INT_BOTH,
	 lid_interrupt},
	/* Other inputs */
	{"THERMAL_DATA_READY_L", LM4_GPIO_B, (1<<4), GPIO_INPUT, NULL},
	{"AC_PRESENT",           LM4_GPIO_H, (1<<3), GPIO_IN_INT_BOTH,
	 extpower_interrupt},
	...
	{"PCH_BKLTEN",           LM4_GPIO_J, (1<<3), GPIO_IN_INT_BOTH,
	 backlight_interrupt},
	{"PCH_SLP_A_L",          LM4_GPIO_G, (1<<5), GPIO_IN_INT_BOTH,
	 x86_interrupt},
	{"PCH_SLP_ME_CSW_DEV_L", LM4_GPIO_G, (1<<4), GPIO_IN_INT_BOTH,
	 x86_interrupt},
	{"PCH_SLP_S3_L",         LM4_GPIO_J, (1<<0), GPIO_IN_INT_BOTH,
	 x86_interrupt},
	{"PCH_SLP_S4_L",         LM4_GPIO_J, (1<<1), GPIO_IN_INT_BOTH,
	 x86_interrupt},
	{"PCH_SLP_S5_L",         LM4_GPIO_J, (1<<2), GPIO_IN_INT_BOTH,
	 x86_interrupt},
	{"PCH_SLP_SUS_L",        LM4_GPIO_G, (1<<3), GPIO_IN_INT_BOTH,
	 x86_interrupt},
	{"PCH_SUSWARN_L",        LM4_GPIO_G, (1<<2), GPIO_IN_INT_BOTH,
	 ivybridge_interrupt},
	{"PGOOD_1_5V_DDR",       LM4_GPIO_K, (1<<0), GPIO_IN_INT_BOTH,
	 x86_interrupt},
	{"PGOOD_1_5V_PCH",       LM4_GPIO_K, (1<<1), GPIO_IN_INT_BOTH,
	 x86_interrupt},
	{"PGOOD_1_8VS",          LM4_GPIO_K, (1<<3), GPIO_IN_INT_BOTH,
	 x86_interrupt},
	{"PGOOD_5VALW",          LM4_GPIO_H, (1<<0), GPIO_IN_INT_BOTH,
	 x86_interrupt},
	{"PGOOD_CPU_CORE",       LM4_GPIO_M, (1<<3), GPIO_IN_INT_BOTH,
	 x86_interrupt},
	{"PGOOD_VCCP",           LM4_GPIO_K, (1<<2), GPIO_IN_INT_BOTH,
	 x86_interrupt},
	{"PGOOD_VCCSA",          LM4_GPIO_H, (1<<1), GPIO_IN_INT_BOTH,
	 x86_interrupt},
	{"PGOOD_VGFX_CORE",      LM4_GPIO_D, (1<<2), GPIO_IN_INT_BOTH,
	 x86_interrupt},
	{"RECOVERY_L",           LM4_GPIO_H, (1<<7), GPIO_IN_INT_BOTH,
	 switch_interrupt},
	{"USB1_STATUS_L",        LM4_GPIO_E, (1<<7), GPIO_INPUT, NULL},
	{"USB2_STATUS_L",        LM4_GPIO_E, (1<<1), GPIO_INPUT, NULL},
	{"WP",                   LM4_GPIO_J, (1<<4), GPIO_IN_INT_BOTH,
	 switch_interrupt},
