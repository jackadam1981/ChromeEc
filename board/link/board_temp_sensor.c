...
const struct temp_sensor_t temp_sensors[TEMP_SENSOR_COUNT] = {
	...
	{"I2C_CPU-Object", TEMP_SENSOR_POWER_VS, TEMP_SENSOR_TYPE_CASE,
	 tmp006_get_val, 1},
	{"I2C_PCH-Die", TEMP_SENSOR_POWER_VS, TEMP_SENSOR_TYPE_PCH,
	 tmp006_get_val, 2},
	{"I2C_PCH-Object", TEMP_SENSOR_POWER_VS, TEMP_SENSOR_TYPE_CASE,
	 tmp006_get_val, 3},
	{"I2C_DDR-Die", TEMP_SENSOR_POWER_VS, TEMP_SENSOR_TYPE_MEMORY,
	 tmp006_get_val, 4},
	...
	{"I2C_Charger-Object", TEMP_SENSOR_POWER_VS, TEMP_SENSOR_TYPE_CASE,
	 tmp006_get_val, 7},
	{"ECInternal", TEMP_SENSOR_POWER_NONE, TEMP_SENSOR_TYPE_EC,
