...
#ifndef __BOARD_KULNEX_FW_CONFIG_H_
#define __BOARD_KULNEX_FW_CONFIG_H_

#include <stdint.h>

/****************************************************************************
 * CBI FW_CONFIG layout for Kulnex board.
 *
 * Source of truth is the project/brask/kulnex/config.star configuration file.
 */
 ...
 */
union kulnex_cbi_fw_config get_fw_config(void);
...
#endif /* __BOARD_KULNEX_FW_CONFIG_H_ */
