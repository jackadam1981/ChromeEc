...
static union kulnex_cbi_fw_config fw_config;
BUILD_ASSERT(sizeof(fw_config) == sizeof(uint32_t));

/*
 * FW_CONFIG defaults for kulnex if the CBI.FW_CONFIG data is not
 * initialized.
 */
static const union kulnex_cbi_fw_config fw_config_defaults = {
