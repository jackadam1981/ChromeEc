...
#include "button.h"
<<<<<<< HEAD   (150dfb icm426xx: reset data rate when init)
...
>>>>>>> CHANGE (c83771 aleena: Add base accel/gyro config for icm-426xx)
...
mat33_fp_t base_standard_ref_icm426xx = {
	{ 0, FLOAT_TO_FP(-1), 0},
	{ FLOAT_TO_FP(-1), 0, 0},
	{ 0,  0, FLOAT_TO_FP(1)}
};
...
struct motion_sensor_t icm426xx_base_accel = {
	 ...
	 .rot_standard_ref = (const mat33_fp_t *)&base_standard_ref_icm426xx,
