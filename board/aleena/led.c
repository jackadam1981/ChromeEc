...
/*
 *		proto	EVT	DVT
 *	led1	Amber	Amber	Blue
 *	led2	Blue	Blue	Amber
 */
static enum gpio_signal led_1 = GPIO_BAT_LED_1_L;
static enum gpio_signal led_2 = GPIO_BAT_LED_2_L;
...
static void board_led_init(void)
{
	...
	if ((board_id == 5) || (board_id == 6)) {
		led_1 = GPIO_BAT_LED_2_L;
		led_2 = GPIO_BAT_LED_1_L;
...
void led_set_color_battery(enum ec_led_colors color)
{
	...
	case EC_LED_COLOR_BLUE:
		gpio_set_level(led_2, LED_ON_LVL);
		gpio_set_level(led_1, LED_OFF_LVL);
		break;
	case EC_LED_COLOR_AMBER:
		gpio_set_level(led_2, LED_OFF_LVL);
		gpio_set_level(led_1, LED_ON_LVL);
		break;
