...
#define SCP_CORE1_RAM_SIZE 0x20000 /* 128K */
 ...
 * | RAM .bss, .data
 * +-------------------- 0xa0000 + 0x1fc00 = 0xbfc00
 * | Reserved (padding for 1k-alignment)
 * +-------------------- 0xa0000 + 0x1fdb0 = 0xbfdb0
 * | IPI shared buffer with AP (288 + 8) * 2
 * +-------------------- 0xa0000 + 0x20000 = 0xc0000
 *
 * [Memory remap]
