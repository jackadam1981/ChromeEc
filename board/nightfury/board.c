...
static unsigned short MP2979_init[] = {
/*	SlvAdd	Reg	Count	Value */
	0x20,	0x00,	1,	0x00,	/* PAGE */
	0x20,	0x22,	2,	0x0000,	/* MFR_VOUT_TRIM */
	0x20,	0x2F,	2,	0xB8B9,	/* MFR_DEBUG */
	0x20,	0xC1,	2,	0x0255,	/* LOT_PROTOCOL_R2_R1 */
	0x20,	0xCA,	1,	0xEE,	/* MFR_PHASE_CFG */
	0x20,	0xCE,	2,	0x7286,	/* MINOFF_BLANK_TIME */
	0x20,	0xCF,	2,	0x0190,	/* MFR_PFM_SET */
	0x20,	0xDD,	2,	0x0070,	/* MFR_SLOPE_CNT_DCM */
	0x20,	0xDE,	2,	0x1CE5,	/* MFR_TRIM_2_1_DCM */
	0x20,	0xDF,	2,	0x1CE6,	/* MFR_TRIM_5_4_3 */
	0x20,	0xE5,	2,	0x0C00,	/* MFR_FS_VBOOT */
	0x20,	0xE7,	2,	0x0012,	/* VFB_TRIM_DCLL */
	0x20,	0xEE,	2,	0x192E,	/* MFR_OCP_SET */
	0x20,	0xEF,	2,	0xC946,	/* OC_LIMIT_ICC_MAX */
	0x20,	0xF9,	2,	0xC8D1,	/* MFR_FILTER_SET */
	0x20,	0xFA,	2,	0x0DC3,	/* MFR_TRANS_FAST */
	0x20,	0xFC,	2,	0x027B,	/* MFR_IMON_SVID */
	0x20,	0xFD,	2,	0x0881,	/* MFR_ALT_SET */
	0x20,	0xDE,	2,	0x1CE5,	/* MFR_TRIM_2_1_DCM */
	0x20,	0xDF,	2,	0x1CE6,	/* MFR_TRIM_5_4_3 */
	0x20,	0xE5,	2,	0x0C00,	/* MFR_FS_VBOOT */
	0x20,	0xE7,	2,	0x0012,	/* VFB_TRIM_DCLL */
	...
	0x20,	0x00,	1,	0x01,	/* PAGE */
	0x20,	0x22,	2,	0x0011,	/* MFR_VOUT_TRIM */
	0x20,	0x2F,	2,	0x0000,	/* MFR_DEBUG */
	0x20,	0xCE,	2,	0x1286,	/* MINOFF_BLANK_TIME */
	0x20,	0xDE,	2,	0x2525,	/* MFR_TRIM_2_1_DCM */
	0x20,	0xE5,	2,	0x0000,	/* MFR_FS_VBOOT */
	0x20,	0xE7,	2,	0x001F,	/* VFB_TRIM_DCLL */
	0x20,	0xEE,	2,	0x0028,	/* MFR_OCP_SET */
	0x20,	0xEF,	2,	0xC01F,	/* OC_LIMIT_ICC_MAX */
	0x20,	0xF9,	2,	0x00D1,	/* MFR_FILTER_SET */
	0x20,	0xFA,	2,	0x0DC3,	/* MFR_TRANS_FAST */
	0x20,	0xFC,	2,	0x0280,	/* MFR_IMON_SVID */
	0x20,	0xFD,	2,	0x0881,	/* MFR_ALT_SET */
	0x20,	0xDE,	2,	0x2525,	/* MFR_TRIM_2_1_DCM */
	0x20,	0xE5,	2,	0x0000,	/* MFR_FS_VBOOT */
	0x20,	0xE7,	2,	0x001F,	/* VFB_TRIM_DCLL */
	...
	0x20,	0x00,	1,	0x02,	/* PAGE */
	0x20,	0x22,	2,	0x0001,	/* MFR_VOUT_TRIM */
	0x20,	0x2F,	2,	0x0002,	/* MFR_DEBUG */
	0x20,	0xCE,	2,	0x0094,	/* MINOFF_BLANK_TIME */
	0x20,	0xDE,	2,	0x0103,	/* MFR_TRIM_2_1_DCM */
	0x20,	0xE5,	2,	0x00A1,	/* MFR_FS_VBOOT */
	0x20,	0xE7,	2,	0x0067,	/* VFB_TRIM_DCLL */
	0x20,	0xEE,	2,	0x0008,	/* MFR_OCP_SET */
	0x20,	0xEF,	2,	0x9206,	/* OC_LIMIT_ICC_MAX */
	0x20,	0xF9,	2,	0x00D1,	/* MFR_FILTER_SET */
	0x20,	0xFA,	2,	0x0DC3,	/* MFR_TRANS_FAST */
	0x20,	0xFC,	2,	0x0780,	/* MFR_IMON_SVID */
	0x20,	0xFD,	2,	0x0881,	/* MFR_ALT_SET */
	0x20,	0xDE,	2,	0x0103,	/* MFR_TRIM_2_1_DCM */
	0x20,	0xE5,	2,	0x00A1,	/* MFR_FS_VBOOT */
	0x20,	0xE7,	2,	0x0067,	/* VFB_TRIM_DCLL */
	...
	0x20,   0x00,   1,      0x00,   /* PAGE */
	0x20,   0xC0,   2,      0x0064, /* PRODUCT_REV_DATA */
	0x00
};

void init_vrm_mp2979(void)
{
	int addr, reg, val, cnt, idx;

	/* Check MP2979 Version */
	addr = 0x20; reg = 0xC0;
	i2c_read16(I2C_PORT_POWER, addr, reg, &val);
	if (val == 0x0064)
		return;

	idx = 0;
	do{
		addr = MP2979_init[idx * 4];
		if (addr == 0)
			break;
		reg = MP2979_init[idx * 4 + 1];
		val = MP2979_init[idx * 4 + 3];
		cnt = MP2979_init[idx * 4 + 2];

		if (cnt == 1)
			i2c_write8(I2C_PORT_POWER, addr, reg, val);
		else
			i2c_write16(I2C_PORT_POWER, addr, reg, val);
		idx ++;
	} while(1);
}
DECLARE_HOOK(HOOK_CHIPSET_RESUME, init_vrm_mp2979, HOOK_PRIO_DEFAULT-1);
