...
enum inj_cmd {
	...
	INJ_CMD_SEND1 = 0x1, /* Send message on CC1 */
			     /* arg0: header arg1/2:payload index/count  */
	INJ_CMD_WAVE1 = 0x2, /* Send arbitrary waveform */
			     /* stored at index arg1 of len arg0 */
	INJ_CMD_HRST1 = 0x3, /* Send Hard Reset on CC1 */
	INJ_CMD_WAIT1 = 0x4, /* Wait for arg12 edges if arg12 != 0 */
	...
	INJ_CMD_SEND2 = 0x9, /* ---- same as SEND1 on CC2 ---- */
	INJ_CMD_WAVE2 = 0xA, /* ---- same as WAVE1 on CC2 ---- */
	INJ_CMD_HRST2 = 0xB, /* ---- same as HRST1 on CC2 ---- */
	INJ_CMD_WAIT2 = 0xC, /* ---- same as WAIT1 on CC2 ---- */
