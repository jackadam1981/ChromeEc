...
{
	/*
	 * ask charger for CHG_DET
	 * probably need more charger functions, either general or chip-specific
	 */
	return 0;
}
...
int board_set_active_charge_port(int port)
{
	/*
	 * hoo boy
	 * error check, print info
	 * then set port via charger, I think? revisit whether other fanciness
	 * is needed.  Figure out how OTG plays into this
	 * baseboard variant?
	 */
	return 0;
}
