...
#include "sensors.h"
#define CONFIG_SENSOR_CHIP_BATTERY_TAP LSM6DS0_BASE
#define CONFIG_SENSOR_BATTERY_TAP LSM6DS0_BASE_ACCEL
...
#define CONFIG_SENSOR_CHIP_BASE LSM6DS0_BASE
#define CONFIG_SENSOR_BASE LSM6DS0_BASE_ACCEL
#define CONFIG_SENSOR_CHIP_LID KXCJ9_LID
#define CONFIG_SENSOR_LID KXCJ9_LID_ACCEL
