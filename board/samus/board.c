...
struct motion_sensor_t motion_sensors[] = {
	...
	{"Accel Base", SENSOR_CHIP_LSM6DS0, SENSOR_ACCELGYRO, LOCATION_BASE,
		&lsm6ds0_method, &g_lsm6ds0_mutex, NULL, LSM6DS0_ADDR1},

	{"Accel Lid",  SENSOR_CHIP_KXCJ9, SENSOR_ACCELEROMETER, LOCATION_LID,
		&kxcj9_method, &g_kxcj9_mutex, &g_kxcj9_data, KXCJ9_ADDR0},
