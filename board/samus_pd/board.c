...
const struct gpio_info gpio_list[] = {
	...
	{"USB_C0_REF_PD_ODL",      GPIO_A, (1<<6),  GPIO_ANALOG,   NULL},
	{"USB_C1_REF_PD_ODL",      GPIO_A, (1<<7),  GPIO_ANALOG,   NULL},

	{"USB_C_CC_EN",            GPIO_C, (1<<10), GPIO_OUT_HIGH, NULL},
	...
	{"USB_C0_CHARGE_EN_L",     GPIO_D, (1<<12), GPIO_OUT_HIGH, NULL},
	...
	{"EC_INT_L",               GPIO_B, (1<<2),  GPIO_OUT_HIGH, NULL},
...
const struct gpio_alt_func gpio_alt_funcs[] = {
	...
	{GPIO_B, 0x0002, 2, MODULE_USB_PD},/* TIM14_CH1: PB1) */
	{GPIO_E, 0x0002, 2, MODULE_USB_PD},/* TIM17_CH1: PE1) */
	{GPIO_A, 0x0600, 1, MODULE_UART},  /* USART1: PA9/PA10 */
	{GPIO_D, 0x0060, 1, MODULE_UART},  /* USART2: PD5/PD6 */
