...
{
	ccprintf("VBUS p0 %d\n", gpio_get_level(GPIO_USB_C0_VBUS_WAKE));
...
{
	ccprintf("VBUS p1 %d\n", gpio_get_level(GPIO_USB_C1_VBUS_WAKE));
...
int board_set_active_charge_port(int charge_port)
{
	 ...
	 */
	if (chg_is_cutoff && charge_port >= 0 && charge_port < PD_PORT_COUNT) {
