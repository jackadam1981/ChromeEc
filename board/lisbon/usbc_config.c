...
static const struct usb_mux_chain usbc0_ps8818 = {
	.mux =
		&(const struct usb_mux) {
		.usb_port = USBC_PORT_C0,
		.i2c_port = I2C_PORT_USB_C0_MUX,
		.i2c_addr_flags = PS8818_I2C_ADDR_FLAGS2,
...
void board_reset_pd_mcu(void)
{
	 ...
	 */
	gpio_set_level(GPIO_EC_USB_C0_RT_RST_L, 0);
	...
	gpio_set_level(GPIO_EC_USB_C0_RT_RST_L, 1);
