...
static union teako_cbi_fw_config fw_config;
BUILD_ASSERT(sizeof(fw_config) == sizeof(uint32_t));

/*
 * FW_CONFIG defaults for Teako if the CBI.FW_CONFIG data is not
 * initialized.
 */
static const union teako_cbi_fw_config fw_config_defaults = {
	.usb_db = DB_USB3_PS8815,
	.kb_bl = KEYBOARD_BACKLIGHT_ENABLED,
};

/****************************************************************************
 * Teako FW_CONFIG access
 */
...
union teako_cbi_fw_config get_fw_config(void)
{
	return fw_config;
}
