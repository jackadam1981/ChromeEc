...
/*
 * Enable MEC17xx specific GPIO EC UART commands
 * for debug.
 */
...
/*
 * Enable MEC17xx SHA256 hardware accelerator module.
...
#else
#define I2C_PORT_THERMAL	MEC17XX_I2C_PORT4
#endif
...
/*
 * include TFDP macros from mec1701 chip level
 */
#include "tfdp_chip.h"
