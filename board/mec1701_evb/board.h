...
/*
 * Use EC-3PO console interpreter over EC UART.
 */
/* this a binary protocol
 * #define CONFIG_EXPERIMENTAL_CONSOLE
 */


/*
 * Enables hacks in power/skylake.c for
 * Skylake RVP3 for driving SYS_RESET_L high when
 * ALL_SYS_PWRGD is received from RVP3.
 */
#define BOARD_KBL_RVP3
 ...
 * We added CONFIG_SPI_FLASH_W25Q128
 */
...
/*
 * I2C0 SCL/SDA are also GP-SPI0 pins.
 * We are using them as GP-SPI0.
 * TODO add ifdef logic
 */
