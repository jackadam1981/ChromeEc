...
/*
 * Strong version of board_exit_hard_off called
 * from power/skylake.c
 */
void board_handle_state(enum power_state state, enum power_state new_state)
{
	if (state != new_state)
...
const struct i2c_port_t i2c_ports[]  = {
	{"pmic",     MEC17XX_I2C_PORT10, 400,  GPIO_SMB10_SCL, GPIO_SMB10_SDA},
...
static void board_init(void)
{
	...
	TRACE0(129, HOOK, 0, "HOOK_INIT - call board_init");
...
static void board_extpower(void)
{
	...
	TRACE0(130, HOOK, 0, "HOOK_AC_CHANGET - call board_extpower");
	gpio_set_level(GPIO_PCH_ACOK, extpower_is_present());
}
...
int board_set_active_charge_port(int charge_port)
{
	...
	if (is_real_port && source) {
		...
		TRACE1(131, BOARD, 0, "Skip enable charge port %d",
			charge_port);
		return EC_ERROR_INVAL;
	}

	CPRINTS("MEC1701 New chg p%d", charge_port);
	TRACE1(132, BOARD, 0, "New charge port %d", charge_port);
...
static void board_chipset_startup(void)
{
	...
	TRACE0(133, HOOK, 0, "HOOK_CHIPSET_STARTUP - board_chipset_startup");
...
static void board_chipset_resume(void)
{
	...
	TRACE0(135, HOOK, 0, "HOOK_CHIPSET_RESUME - board_chipset_resume");
...
static void board_chipset_suspend(void)
{
	...
	TRACE0(136, HOOK, 0, "HOOK_CHIPSET_SUSPEND - board_chipset_suspend");
...
static void board_handle_reboot(void)
{
	...
	TRACE0(137, HOOK, 0, "HOOK_INIT - board_handle_reboot");
...
void tach0_isr(void)
{
	MEC17XX_INT_DISABLE(MEC17XX_TACH_GIRQ) = MEC17XX_TACH_GIRQ_BIT(0);
	MEC17XX_INT_SOURCE(MEC17XX_TACH_GIRQ) = MEC17XX_TACH_GIRQ_BIT(0);
}
DECLARE_IRQ(MEC17XX_IRQ_TACH_0, tach0_isr, 1);
#endif
