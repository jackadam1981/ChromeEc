 ...
 *
 * This board is designed to have nucleo-h7a3zi support (uart+btn+leds) with
 * icetower configuration (fingerprint support).
 * This allows for proxy testing of icetower on the Nucleo-H7A3ZI.
 */
