...
#define CONFIG_AUDIO_CODEC_DMIC_SOFTWARE_GAIN
#define CONFIG_AUDIO_CODEC_DMIC_MAX_SOFTWARE_GAIN 20
#define CONFIG_AUDIO_CODEC_WOV
#define CONFIG_AUDIO_CODEC_WOV_AUDIO_BUF_LEN 64000
#define CONFIG_AUDIO_CODEC_WOV_AUDIO_BUF_TYPE EC_CODEC_SHM_TYPE_SYSTEM_RAM
#define CONFIG_AUDIO_CODEC_WOV_LANG_BUF_LEN (68 * 1024)
#define CONFIG_AUDIO_CODEC_WOV_LANG_BUF_TYPE EC_CODEC_SHM_TYPE_SYSTEM_RAM
