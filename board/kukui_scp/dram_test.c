...
__SECTION(dram.data) static int8_t data_array[4] = { 0xde, 0xed, 0xca, 0xfe };

__SECTION(dram.rodata) static const int8_t const_data_array[4] = { 1, 2, 3, 4 };

__SECTION(dram.bss) int counter;

__SECTION(dram.text) int command_my_dram_test(int argc, char **argv)
{
