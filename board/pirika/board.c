...
__maybe_unused static const struct ec_thermal_config thermal_charger = THERMAL_CHARGER;
/*
 * TODO(b/202062363): Remove when clang is fixed.
 */
...
__maybe_unused static const struct ec_thermal_config thermal_vcore = THERMAL_VCORE;
/*
 * TODO(b/202062363): Remove when clang is fixed.
 */
...
__maybe_unused static const struct ec_thermal_config thermal_ambient = THERMAL_AMBIENT;
