...
__override void board_power_5v_enable(int enable)
{
	...
	/*
	 * Configure the comparator output on the sub-board charger IC as
	 * inverted in order to generate EN_SUB_RAILS.
	 */
	rv = i2c_read16(chg_chips[1].i2c_port, chg_chips[1].i2c_addr_flags,
	...
	if (!rv)
		rv |= i2c_write16(chg_chips[1].i2c_port,
				  chg_chips[1].i2c_addr_flags,
				  ISL923X_REG_CONTROL2, regval);
	if (rv)
		CPRINTS("Failed to enable sub rails!");
