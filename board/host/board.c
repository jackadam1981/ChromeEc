...
test_mockable_static int mock_temp_get_val_mk(int idx, int *temp_ptr)
{
	*temp_ptr = 0;
	return EC_SUCCESS;
}
...
const struct temp_sensor_t temp_sensors[] = {
	{"CPU", TEMP_SENSOR_TYPE_CPU, mock_temp_get_val_mk, 0},
	{"Board", TEMP_SENSOR_TYPE_BOARD, mock_temp_get_val_mk, 1},
	{"Case", TEMP_SENSOR_TYPE_CASE, mock_temp_get_val_mk, 2},
	{"Battery", TEMP_SENSOR_TYPE_BOARD, mock_temp_get_val_mk, 3},
};
