...
static const struct charger_info *mock_get_info(void)
{
	return &mock_charger_info;
}


static int mock_get_status(int chgnum, int *status)
{
...
static int mock_set_mode(int chgnum, int mode)
{
...
static int mock_get_current(int chgnum, int *current)
{
...
static int mock_set_current(int chgnum, int current)
{
	const struct charger_info *info = mock_get_info();
...
static int mock_get_voltage(int chgnum, int *voltage)
{
...
static int mock_set_voltage(int chgnum, int voltage)
{
...
static int mock_get_option(int chgnum, int *option)
{
	*option = mock_option;
	return EC_SUCCESS;
}
...
static int mock_set_option(int chgnum, int option)
{
	mock_option = option;
	return EC_SUCCESS;
}
...
static int mock_manufacturer_id(int chgnum, int *id)
{
	return EC_SUCCESS;
}


static int mock_device_id(int chgnum, int *id)
{
	return EC_SUCCESS;
}


static int mock_get_input_current(int chgnum, int *input_current)
{
...
static int mock_set_input_current(int chgnum, int current)
{
	const struct charger_info *info = mock_get_info();
...
static int mock_post_init(int chgnum)
{
