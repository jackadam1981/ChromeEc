...
/* Configuration for Gnawty mainboard */
...
#define CONFIG_BATTERY_LEVEL_LOW 1
#define CONFIG_BATTERY_LEVEL_CRITICAL 1
#define CONFIG_BATTERY_LEVEL_NEAR_FULL 1
