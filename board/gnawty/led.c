 ...
 *
 * Battery LED control for Gwanty
 */
...
{
	brightness_range[EC_LED_COLOR_ORANGE] = 100;
	brightness_range[EC_LED_COLOR_BLUE] = 100;
}

int led_set_brightness(enum ec_led_id led_id, const uint8_t *brightness)
{
	pwm_set_duty(PWM_CH_LED_ORANGE, brightness[EC_LED_COLOR_ORANGE]);
