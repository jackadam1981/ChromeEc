...
#define I2C_ADDR_PCA555_PMIC_GPIO__7b	0x21
#define PCA555_PMIC_GPIO_WRITE(reg, data) \
		pca9555_write__7b(I2C_PORT_PCA555_PMIC_GPIO, \
			I2C_ADDR_PCA555_PMIC_GPIO__7b, (reg), (data))
#define PCA555_PMIC_GPIO_READ(reg, data) \
		pca9555_read__7b(I2C_PORT_PCA555_PMIC_GPIO, \
			I2C_ADDR_PCA555_PMIC_GPIO__7b, (reg), (data))

#define I2C_PORT_PCA555_BOARD_ID_GPIO	NPCX_I2C_PORT0_0
#define I2C_ADDR_PCA555_BOARD_ID_GPIO__7b	0x20
#define PCA555_BOARD_ID_GPIO_READ(reg, data) \
		pca9555_read__7b(I2C_PORT_PCA555_BOARD_ID_GPIO, \
			I2C_ADDR_PCA555_BOARD_ID_GPIO__7b, (reg), (data))
