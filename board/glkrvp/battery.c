...
#define I2C_PORT_PCA555_BATTERY	NPCX_I2C_PORT0_0
#define I2C_ADDR_PCA555_BATTERY	0x42
#define BATTERY_WRITE(reg, data) pca9555_write(I2C_PORT_PCA555_BATTERY, \
		I2C_ADDR_PCA555_BATTERY, (reg), (data))
#define BATTERY_READ(reg, data) pca9555_read(I2C_PORT_PCA555_BATTERY, \
		I2C_ADDR_PCA555_BATTERY, (reg), (data))
...
static inline int batt_smp_cos4870_init(void)
{
	int batt_status;
...
static inline enum battery_present battery_hw_present(void)
{
	...
	rv = BATTERY_READ(PCA9555_CMD_INPUT_PORT_0, &data);
...
enum battery_present battery_is_present(void)
{
	...
	if (batt_pres == BP_YES && batt_pres_prev != batt_pres &&
		!battery_is_cut_off() && !batt_smp_cos4870_init())
		batt_pres = BP_NO;
