...
#ifdef DEBUG_GPIO_HACK
#define GPIO_BPWR_DET GPIO_EC_STATUS_LED1
#define GPIO_UFP_PLUG_DET GPIO_EC_STATUS_LED2
#define GPIO_TRIGGER_1 GPIO_MST_UFP_PLUG_DET
