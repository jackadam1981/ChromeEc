...
{
	ccprints("p%d pd_set_input_current_limit", port);
}
...
const struct adc_t adc_channels[] = {
	 ...
	 * max mV / 10 bit solution 1024).
	 * The ADC channel is used for measurement VBUS: the max mv value is
	 * the result of resistive divider, so VBUS = max mv * resistive divider
	 * (check HW schematic).
	 */
	{"ADC_VBUSSA", ADC_MAX_MVOLT * 11, ADC_READ_MAX + 1, 0, CHIP_ADC_CH7}, /* GPI7, ADC7 */
	{"ADC_VBUSSB", ADC_MAX_MVOLT * 11, ADC_READ_MAX + 1, 0, CHIP_ADC_CH3}, /* GPI3, ADC3 */
	{"ADC_VBUSSC", ADC_MAX_MVOLT * 11, ADC_READ_MAX + 1, 0, CHIP_ADC_CH16}, /* GPL0, ADC16 */
	{"ADC_EVB_CH_13", ADC_MAX_MVOLT, ADC_READ_MAX + 1, 0, CHIP_ADC_CH13}, /* GPL1, ADC13 */
	{"ADC_EVB_CH_14", ADC_MAX_MVOLT, ADC_READ_MAX + 1, 0, CHIP_ADC_CH14}, /* GPL2, ADC14 */
	{"ADC_EVB_CH_15", ADC_MAX_MVOLT, ADC_READ_MAX + 1, 0, CHIP_ADC_CH15}, /* GPL3, ADC15 */
};
