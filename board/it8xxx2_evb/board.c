...
const struct adc_t adc_channels[] = {
	/* The value of adc reading convert to mV (max mV/10 bit 1024). */
	{"ADC_VBUSSA", 11 * ADC_MAX_MVOLT, ADC_READ_MAX + 1, 0, CHIP_ADC_CH7}, /* GPI7, ADC7 */
	{"ADC_VBUSSB", 11 * ADC_MAX_MVOLT, ADC_READ_MAX + 1, 0, CHIP_ADC_CH3}, /* GPI3, ADC3 */
	{"ADC_VBUSSC", 11 * ADC_MAX_MVOLT, ADC_READ_MAX + 1, 0, CHIP_ADC_CH13}, /* GPL0, ADC13 */
	{"ADC_EVB_CH_14", ADC_MAX_MVOLT, ADC_READ_MAX + 1, 0, CHIP_ADC_CH14}, /* GPL1, ADC14 */
	{"ADC_EVB_CH_15", ADC_MAX_MVOLT, ADC_READ_MAX + 1, 0, CHIP_ADC_CH15}, /* GPL2, ADC15 */
	{"ADC_EVB_CH_16", ADC_MAX_MVOLT, ADC_READ_MAX + 1, 0, CHIP_ADC_CH16}, /* GPL3, ADC16 */
};
