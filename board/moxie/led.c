...
#define LED_PULSE_PERIOD (4 * SECOND)
#define LED_DUTY_CYCLE (25)
#define LED_PULSE_US (LED_PULSE_PERIOD * LED_DUTY_CYCLE / 100 / 2)
...
{
	CONFIG_TICK(LED_PULSE_TICK_US, LED_PULSE_PERIOD, LED_BLUE);
	led_tick();
}
