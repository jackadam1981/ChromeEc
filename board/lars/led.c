...
/* LED signals */
#define GPIO_BAT_LED0_L GPIO_CHARGE_LED1	/* Blue */
#define GPIO_BAT_LED1_L GPIO_CHARGE_LED2	/* Amber */
#define GPIO_PWR_LED0_L GPIO_PWRLED_L		/* Bule */
#define GPIO_PWR_LED1_L GPIO_SUSLED_L		/* Amber */
...
{
	return lars_led_set_gpio(color, GPIO_BAT_LED0_L, GPIO_BAT_LED1_L);
}

static int lars_led_set_color_power(enum led_color color)
{
	return lars_led_set_gpio(color, GPIO_PWR_LED0_L, GPIO_PWR_LED1_L);
}
