...
/*
 * Test keyscan with a slightly different keyboard than
 * Chromebooks use.
 * We modified include/keyboard_config.h to check if the
 * following is defined.
 */
#define BOARD_KEYBOARD_COLS	16
/*
 * If defined scancode tables in common/keyboard_8042_sharedlib.c are
 * not constant and can be modified. We overwrite both tables in
 * board_init.
 */
