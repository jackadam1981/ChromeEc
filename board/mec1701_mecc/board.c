...
/*
 * Handle Kabylake ALL_SYS_PWRGD signal on SKL RVP3 board.
...
static void board_pmic_init(void)
{
	...
	trace2(0, MEC, 0, "MEC read PMIC[0x30] = 0x%02x  rc = %d",
		pmic_data[0], rc);

	rc = 0;
	pmic_data[0] = 0xff;
	rc += i2c_read8(I2C_PORT_PMIC, I2C_ADDR_KBL_PMIC, 0x38, pmic_data);
	trace2(0, MEC, 0, "MEC read PMIC[0x38] = 0x%02x  rc = %d",
		pmic_data[0], rc);
