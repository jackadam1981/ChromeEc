 ...
 * enum vcmp_channel.
 */
struct vcmp_t vcmp_channels[] = {
	/* Threshold H/L is 2800/200 mV */
	[VCMP_SNS_PP3300] = {.name = "VCMP_SNS_PP3300",
			     .threshold = 2800,
			     .comparator = GREATER_THRESHOLD,
			     .trigger_level = EDGE_TRIGGER,
			     .resolution = V_CMP_READ_MAX + 1,
			     .vcmpx_channel = CHIP_VCMP_CH0,
			     .adcx_channel = CHIP_ADC_CH7,
			     .output_gpio = V_CMP_OUTPUT_GPIO_EN,
			     .gpio_active = ACTIVE_HIGH},
	[TEST] = {.name = "TEST",
		  .threshold = 500,
		  .comparator = LESS_EQUAL_THRESHOLD,
		  .trigger_level = LEVEL_TRIGGER,
		  .resolution = V_CMP_READ_MAX + 1,
		  .vcmpx_channel = CHIP_VCMP_CH3,
		  .adcx_channel = CHIP_ADC_CH5,
		  .output_gpio = V_CMP_OUTPUT_GPIO_EN,
		  .gpio_active = ACTIVE_HIGH},
};
