...
#define llong_type int64_t
#define ullong_type uint64_t
...
llong_type strtoll(const char *nptr, char **endptr, register int base)
{
	const char *s = nptr;
	ullong_type acc;
	int c;
