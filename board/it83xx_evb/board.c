 ...
 * enum board_vcmp_channel.
 */
struct vcmp_t vcmp_channels[] = {
	/* Threshold H/L is 2800/200 mV */
	[VCMP_SNS_PP3300] = {.name = "VCMP_SNS_PP3300",
			     .threshold = 2800,
			     .condition = (GREATER_THRESHOLD | EDGE_TRIGGER),
			     .resolution = V_CMP_READ_MAX + 1,
			     .vcmp_channel = CHIP_VCMP_CH0,
			     .adc_channel = CHIP_ADC_CH7},
	[TEST] = {.name = "TEST",
		  .threshold = 500,
		  .condition = (LESS_EQUAL_THRESHOLD | LEVEL_TRIGGER),
		  .resolution = V_CMP_READ_MAX + 1,
		  .vcmp_channel = CHIP_VCMP_CH3,
		  .adc_channel = CHIP_ADC_CH5},
};
