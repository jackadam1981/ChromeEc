...
/*
 * MUX Redriver (Bits 6-7)
 */
enum ec_ssfc_mux_redriver {
	SSFC_REDRIVER_DEFAULT = 0,
	SSFC_REDRIVER_IT5205 = 1,
	SSFC_REDRIVER_PS8743 = 2,
};
...
/**
 * Get the MUX redriver type from SSFC_CONFIG
 *
 * @return the MUX redriver type.
 */
