...
const mat33_fp_t lid_a_cover_facing_ref = {
	{ FLOAT_TO_FP(1), 0, 0},
	{ 0, FLOAT_TO_FP(1), 0},
	{ 0, 0, FLOAT_TO_FP(1)}
};

const mat33_fp_t lid_b_cover_facing_ref = {
	{ FLOAT_TO_FP(1), 0,  0},
	{ 0, FLOAT_TO_FP(-1), 0},
	{ 0, 0, FLOAT_TO_FP(-1)}
};
...
void board_hibernate(void)
{
	...
	/* Turn on power save mode but keep BGATE on, which keeps pp1800 on */
	bd9995x_set_power_save_mode(BD9995X_PWR_SAVE_HIGH);
}
