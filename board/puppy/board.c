...
const struct gpio_info gpio_list[] = {
	...
	{"XPSHOLD",     GPIO_A, (1<<3),  GPIO_IN_INT_BOTH, gaia_power_event},
	{"CHARGER_INT", GPIO_C, (1<<6),  GPIO_IN_INT_RISING, pmu_irq_handler},
	{"LID_OPEN",    GPIO_C, (1<<13), GPIO_IN_INT_BOTH, lid_interrupt},
	{"SUSPEND_L",   GPIO_C, (1<<7),  GPIO_KB_INPUT, gaia_suspend_event},
	{"SPI1_NSS",    GPIO_A, (1<<4),  GPIO_IN_INT_BOTH | GPIO_PULL_UP,
	 spi_event},
	{"AC_PRESENT",  GPIO_A, (1<<0),  GPIO_IN_INT_BOTH, extpower_interrupt},
