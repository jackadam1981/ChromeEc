 ...
 */
/*
 * This define disables link time optimization compiler flag, which doesn't
 * work with NPCX9 firmware and the clang compiler
 */
#define CONFIG_LTO

/*
 * TODO: Temporary workaround, likely required due to flash protection issue
 */
...
/*
 * TODO: should eventually bu removed, required to avoid chip_pre_init
