...
#define CONFIG_MPU
/* TODO(b/272834424): This causes an mpu_init failure*/
...
/*
 * TODO (b/274937192)
 * This define enables link time optimization compiler flag, without which
 * the NPCX9 firmware doesn't work with the clang compiler
 */
#define CONFIG_LTO

/*
 * TODO (b279045719): Temporary workaround, likely required due to flash
 * protection issue
 */
#define CONFIG_SYSTEM_UNLOCKED
/*
 * TODO (b/279046393) can this be removed for helipilot?
 * This will happen automatically on NPCX9 ES2 and later. Do not remove
 * until we can confirm all earlier chips are out of service.
 */
#define CONFIG_HIBERNATE_PSL_VCC1_RST_WAKEUP
/*
 * TODO: Remove once Quincy brought up
...
/*
 * TODO: should eventually be removed, required to avoid chip_pre_init
 * disabling JTAG internally
 */
