...
static void board_tcpc_init(void)
{
	...
	//if (i2c_read8(I2C_PORT_USB_C1_TCPC,
	//	      PS8751_I2C_ADDR1_P0_FLAGS, 0x0a, &val) == EC_SUCCESS)
	//	CPRINTS("ps8815: reg 0x0a was %02x", val);

	/* Enable compliance test */
	//if (i2c_write8(I2C_PORT_USB_C1_TCPC,
	//	       PS8751_I2C_ADDR1_P0_FLAGS, 0x0a, 0x80) == EC_SUCCESS)
	//	CPRINTS("ps8815: reg 0x0a set to 0x80");
