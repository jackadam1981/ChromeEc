...
const struct gpio_info gpio_list[] = {
	...
	{"PD_CC1_TX_DATA",    GPIO_A, (1<<6),  GPIO_OUT_LOW, NULL},
	{"PD_CC2_TX_DATA",    GPIO_B, (1<<4),  GPIO_OUT_LOW, NULL},
#endif
...
const struct gpio_alt_func gpio_alt_funcs[] = {
	{GPIO_A, 0x0040, 0, MODULE_USB_PD},/* SPI1: MISO(PA6) */
...
const struct adc_t adc_channels[] = {
	...
	/* VBUS voltage sensing is behind a 51K/510K voltage divider */
