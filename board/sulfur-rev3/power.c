...
static int ap_power_command(int argc, char *argv[])
{
	int v;
...
DECLARE_CONSOLE_COMMAND(ap_power, ap_power_command,
			"on/off", "Turn AP power on/off");
...
{
	ccprintf("Watchdog timeout, warm reset the AP\n");
