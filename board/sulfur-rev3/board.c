 ...
 */
/* National Instruments Sulfur Rev3 board configuration */
...
const struct temp_sensor_t temp_sensors[] = {
	{"TMP431_Internal", TEMP_SENSOR_TYPE_BOARD, tmp432_get_val,
		TMP432_IDX_LOCAL},
	{"TMP431_Remote", TEMP_SENSOR_TYPE_CPU, tmp432_get_val,
		TMP432_IDX_REMOTE1},
};
...
const void *const usb_strings[] = {
	...
	[USB_STR_PRODUCT]      = USB_STRING_DESC("Project Sulfur Rev3"),
...
struct ec_thermal_config thermal_params[] = {
	...
	{{C_TO_K(50), C_TO_K(65), C_TO_K(75)}, C_TO_K(30), C_TO_K(60)},	/* Ambient */
	{{C_TO_K(80), C_TO_K(85), C_TO_K(95)}, C_TO_K(50), C_TO_K(80)},	/* AP Diode */
};
