...
/* Port for charge_manager */
#define HOST_PORT CONFIG_USB_PD_PORT_MAX_COUNT
#define DEDICATED_CHARGE_PORT HOST_PORT
#undef  CONFIG_DEDICATED_CHARGE_PORT_COUNT
#define CONFIG_DEDICATED_CHARGE_PORT_COUNT 1

#ifdef SECTION_IS_RO
/* Host port use PI3USB9201 as BC1.2 detector */
#define CONFIG_BC12_DETECT_PI3USB9201
#define CONFIG_USB_HUB_GL3590
#define CONFIG_INA231
#define CONFIG_CHARGE_MANAGER
#undef  CONFIG_CHARGE_MANAGER_SAFE_MODE
/* one day we might want to enable this */
