...
#ifdef SECTION_IS_RO
static void get_input_power_def(void)
{
	get_input_power();
}
DECLARE_DEFERRED(get_input_power_def);
#endif
...
static void board_init(void)
{
	 ...
	 */
	get_input_power();
	hook_call_deferred(&get_input_power_def_data, TIME_3SEC);
