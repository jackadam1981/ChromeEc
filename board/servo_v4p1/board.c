...
const void *const usb_strings[] = {
	...
	[USB_STR_PRODUCT]      = USB_STRING_DESC("Servo V41"),
...
static void board_init(void)
{
	...
	gpio_enable_interrupt(GPIO_SYS_FAULT_IRQ_L);
	gpio_enable_interrupt(GPIO_SYS_DP_HPD);
