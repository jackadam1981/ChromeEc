...
void init_ioexpanders(void)
{
	...
	tca6416a_write_byte(1, TCA6416A_DIR_PORT_A, 0x00);
	 ...
	 */
	tca6416a_write_byte(1, TCA6416A_OUT_PORT_B, 0x40);
	 ...
	 */
	tca6424a_write_byte(1, TCA6424A_OUT_PORT_A, 0x02);
	tca6424a_write_byte(1, TCA6424A_DIR_PORT_A, 0x00);
	 ...
	 * BIT-7 (DBG_LED)           | O   | 0
	 */
	tca6424a_write_byte(1, TCA6424A_OUT_PORT_C, 0x02);
