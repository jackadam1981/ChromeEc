...
//TODO: Make board ID always cached (suggested by EC team)
...
{
	//TODO: ASSERT PROTO1 board_id_det() check
	if (board_id_cached() != BOARD_ID_PROTO1)
...
{
	// TODO if (board_id_cached() != BOARD_ID_PROTO1)
	int val;
