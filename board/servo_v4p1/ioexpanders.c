...
void init_ioexpanders(void)
{
	 ...
	 */
	tca6416a_write_byte(1, TCA6416A_OUT_PORT_0, 0x04);
	tca6416a_write_byte(1, TCA6416A_DIR_PORT_0, 0x00);

	/*
	 * Init TCA6416A, PORT B
	 * NAME                            | DIR | Initial setting
	 * -------------------------------------------------------
	 ...
	 */
	tca6416a_write_byte(1, TCA6416A_OUT_PORT_1, 0x40);
	tca6416a_write_byte(1, TCA6416A_DIR_PORT_1, 0xb8);

	/*
	 * Init TCA6424A, PORT A
	 * NAME                      | DIR | Initial setting
	 * -------------------------------------------------
	 ...
	 */
	tca6424a_write_byte(1, TCA6424A_OUT_PORT_0, 0x02);
	tca6424a_write_byte(1, TCA6424A_DIR_PORT_0, 0x00);

	/*
	 * Init TCA6424A, PORT B
	 * NAME                           | DIR | Initial setting
	 * ------------------------------------------------------
	 ...
	 */
	tca6424a_write_byte(1, TCA6424A_DIR_PORT_1, 0xff);

	/*
	 * Init TCA6424A, PORT C
	 * NAME                      | DIR | Initial setting
	 * ------------------------------------------------
	 * BIT-0 (VBUS_DISCHRG_EN)   | O   | 0
	 * BIT-1 (USBH_PWRDN_L)      | I   | x
	 * BIT-2 (EN_PP3300_DP)      | O   | 0
	 * BIT-3 (FAULT_CLEAR_CC)    | O   | 0
	 * BIT-4 (EN_VOUT_BUF_CC1)   | O   | 0
	 * BIT-5 (EN_VOUT_BUF_CC2)   | O   | 0
	 ...
	 * BIT-7 (DBG_LED)           | O   | 0
	 */
	tca6424a_write_byte(1, TCA6424A_OUT_PORT_2, 0x02);
	tca6424a_write_byte(1, TCA6424A_DIR_PORT_2, 0x02);
...
{
	tca6416a_write_bit(1, TCA6416A_OUT_PORT_0, 0, en);
}

inline void atmel_reset_l(int en)
{
	tca6416a_write_bit(1, TCA6416A_OUT_PORT_0, 1, en);
}

inline void sbu_flip_sel(int en)
{
	tca6416a_write_bit(1, TCA6416A_OUT_PORT_0, 2, en);
}

inline void usb3_a0_mux_sel(int en)
{
	tca6416a_write_bit(1, TCA6416A_OUT_PORT_0, 3, en);
}

inline void usb3_a0_mux_en_l(int en)
{
	tca6416a_write_bit(1, TCA6416A_OUT_PORT_0, 4, en);
}

inline void usb3_a0_pwr_en(int en)
{
	tca6416a_write_bit(1, TCA6416A_OUT_PORT_0, 5, en);
}

inline void uart_18_sel(int en)
{
	tca6416a_write_bit(1, TCA6416A_OUT_PORT_0, 6, en);
}

inline void uservo_power_en(int en)
{
	tca6416a_write_bit(1, TCA6416A_OUT_PORT_0, 7, en);
}

inline void uservo_fastboot_mux_sel(enum uservo_fastboot_mux_sel_t sel)
{
	tca6416a_write_bit(1, TCA6416A_OUT_PORT_1, 0, sel);
}

inline void usb3_a1_pwr_en(int en)
{
	tca6416a_write_bit(1, TCA6416A_OUT_PORT_1, 1, en);
}

inline void usb3_a1_mux_sel(int en)
{
	tca6416a_write_bit(1, TCA6416A_OUT_PORT_1, 2, en);
}
...
{
	tca6416a_write_bit(1, TCA6416A_OUT_PORT_1, 6, en);
}
...
{
	tca6424a_write_bit(1, TCA6424A_OUT_PORT_0, 0, en);
}

inline void en_pp3300_eth(int en)
{
	tca6424a_write_bit(1, TCA6424A_OUT_PORT_0, 1, en);
}

inline void en_pp3300_dp(int en)
{
	tca6424a_write_bit(1, TCA6424A_OUT_PORT_0, 2, en);
}

inline void fault_clear_cc(int en)
{
	tca6424a_write_bit(1, TCA6424A_OUT_PORT_0, 3, en);
}

inline void en_vout_buf_cc1(int en)
{
	tca6424a_write_bit(1, TCA6424A_OUT_PORT_0, 4, en);
}

inline void en_vout_buf_cc2(int en)
{
	tca6424a_write_bit(1, TCA6424A_OUT_PORT_0, 5, en);
}

void dut_chg_en(int en)
{
	dut_chg_en_state = en;
	tca6424a_write_bit(1, TCA6424A_OUT_PORT_0, 6, en);
}
...
{
	tca6424a_write_bit(1, TCA6424A_OUT_PORT_0, 7, en);
}
...
inline int read_faults(void)
{
	...
	faults = tca6424a_read_byte(1, TCA6424A_IN_PORT_1);

	/* Clear faults on this port */
	tca6424a_read_bit(1, TCA6424A_IN_PORT_2, 6);
	tca6424a_read_bit(1, TCA6424A_IN_PORT_2, 2);
...
{
	tca6424a_write_bit(1, TCA6424A_OUT_PORT_2, 0, en);
}

inline void usbh_pwrdn_l(int en)
{
	tca6424a_write_bit(1, TCA6424A_OUT_PORT_2, 1, en);
}

inline void tca_gpio_dbg_led_k_odl(int en)
{
	tca6424a_write_bit(1, TCA6424A_OUT_PORT_2, 7, !en);
}
