 ...
 */
#define GPIOX_I2C_ADDR__7b		0x20
...
static void write_ioexpander(int bank, int gpio, int val)
{
	...
	i2c_read8__7b(1, GPIOX_I2C_ADDR__7b, GPIOX_OUT_PORT_A + bank, &tmp);
	if (val)
		tmp |= BIT(gpio);
	else
		tmp &= ~BIT(gpio);
	/* Write back modified output port register */
	i2c_write8__7b(1, GPIOX_I2C_ADDR__7b, GPIOX_OUT_PORT_A + bank, tmp);
}
...
static int read_ioexpander_bit(int bank, int bit)
{
	...
	i2c_read8__7b(1, GPIOX_I2C_ADDR__7b, GPIOX_IN_PORT_A + bank, &tmp);
...
static void init_ioexpander(void)
{
	...
	i2c_write8__7b(1, GPIOX_I2C_ADDR__7b, GPIOX_OUT_PORT_A, 0x0);
	i2c_write8__7b(1, GPIOX_I2C_ADDR__7b, GPIOX_OUT_PORT_B, 0x0);

	/*
	 * Write GPIO direction: strap resistors to input,
	 * all others to output.
	 */
	i2c_write8__7b(1, GPIOX_I2C_ADDR__7b, GPIOX_DIR_PORT_A, 0x0);
	i2c_write8__7b(1, GPIOX_I2C_ADDR__7b, GPIOX_DIR_PORT_B, 0x18);
}
