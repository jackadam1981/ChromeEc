...
static void ccd_measure_sbu(void)
{
	...
	/*
	 * SBU mux should be enabled so SBU is connected to the USB2 hub. The
	 * hub needs to apply its terminations to read the correct SBU levels.
	 */
	...
	* for 100ms. We may see GND/GND while passing data since the
