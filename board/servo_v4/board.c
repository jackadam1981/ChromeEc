...
void board_config_pre_init(void)
{
	 ...
	 *  Chan 2/4 : UART1_TX
	 *  Chan 3/5 : UART1_RX
	 *  Chan 2/6 : TIM1_CH1  (C0 RX)
	 *  Chan 3 : SPI1_TX   (C0 TX)
	 *  Chan 4/6 : TIM3_CH1  (C1 RX)
	 *  Chan 5/7 : SPI2_TX   (C1 TX)
	 */
	/*
	 * the DMA mapping is :
	 *  Chan 2/4 4* : UART1_TX
	 *  Chan 3/5 5* : UART1_RX
	 *  Chan 2/6 2  : TIM1_CH1  (C0 RX)
	 *  Chan 3   3  : SPI1_TX   (C0 TX)
	 *  Chan 4/6 6* : TIM3_CH1  (C1 RX)
	 *  Chan 5/7 7* : SPI2_TX   (C1 TX)
	 */
	STM32_SYSCFG_CFGR1 |= (1 << 9);  /* UART1_TX */
	STM32_SYSCFG_CFGR1 |= (1 << 10); /* UART1_RX */
	STM32_SYSCFG_CFGR1 |= (1 << 30); /* TIM3_CH1 */
	STM32_SYSCFG_CFGR1 |= (1 << 24);  /* SPI2_TX  */
}
...
const struct adc_t adc_channels[] = {
	...
	[ADC_REF_PD] = {"REF_PD", 3300, 4096, 0, STM32_AIN(1)},
};
