...
const struct usb_mux_chain usb_muxes[] = {
	[TYPE_C_PORT_0] = {
		.mux = &usbc0_tcss_usb_mux,
	},
	[TYPE_C_PORT_1] = {
		.mux = &usbc1_tcss_usb_mux,
	},
#if CONFIG_USB_PD_PORT_MAX_COUNT > 2
	[TYPE_C_PORT_2] = {
		.mux = &usbc2_tcss_usb_mux,
	},
	[TYPE_C_PORT_3] = {
		.mux = &usbc3_tcss_usb_mux,
	},
#endif
};
BUILD_ASSERT(ARRAY_SIZE(usb_muxes) == CONFIG_USB_PD_PORT_MAX_COUNT);

const struct pd_config_t pd_config[] = {
	[TYPE_C_PORT_0] = {
		.i2c_info = {
			.port = I2C_PORT_SMLINK,
			.addr_flags = 0x50,
		},
		.alert_signal = GPIO_USBC_PD_ALRT_P0P1,
	},
	[TYPE_C_PORT_1] = {
		.i2c_info = {
			.port = I2C_PORT_SMLINK,
	...
	[TYPE_C_PORT_2] = {
		...
		.alert_signal = GPIO_USBC_PD_ALRT_P2P3,
	},
	[TYPE_C_PORT_3] = {
		.i2c_info = {
			.port = I2C_PORT_TYPEC_AIC2,
