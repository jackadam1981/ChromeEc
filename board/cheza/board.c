...
{
	/*
	 * Hack to manually enable the internal switch in BC1.2
	 * TODO(waihong): Enable BC1.2 autodetection.
	 */
	i2c_write8(I2C_PORT_TCPC0, PI3USB9281_I2C_ADDR, 0x02, 0x1b);
	i2c_write8(I2C_PORT_TCPC0, PI3USB9281_I2C_ADDR, 0x13, 0x24);
	i2c_write8(I2C_PORT_TCPC1, PI3USB9281_I2C_ADDR, 0x02, 0x1b);
	i2c_write8(I2C_PORT_TCPC1, PI3USB9281_I2C_ADDR, 0x13, 0x24);
