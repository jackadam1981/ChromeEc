...
const struct gpio_alt_func gpio_alt_funcs[] = {
	{GPIO_A, 0x03, 1},			/* UART0 */
	{GPIO_A, 0x40, 3},			/* I2C1 SCL */
	{GPIO_A, 0x80, 3, GPIO_OPEN_DRAIN},	/* I2C1 SDA */
	{GPIO_B, 0x04, 3},			/* I2C0 SCL */
	{GPIO_B, 0x08, 3, GPIO_OPEN_DRAIN},	/* I2C0 SDA */
	{GPIO_B, 0x40, 3},			/* I2C5 SCL */
	{GPIO_B, 0x80, 3, GPIO_OPEN_DRAIN},	/* I2C5 SDA */
	{GPIO_G, 0x30, 1},			/* UART2 */
	{GPIO_J, 0x40, 1},			/* PECI Tx */
	{GPIO_J, 0x80, 0, GPIO_ANALOG},		/* PECI Rx */
	{GPIO_L, 0x3f, 15},			/* LPC */
	{GPIO_M, 0x33, 15},			/* LPC */
	{GPIO_N, 0x0c, 1},			/* Fan0 PWM/tach */
	{GPIO_N, 0x40, 1},			/* Fan1 PWM = kblight */
};
