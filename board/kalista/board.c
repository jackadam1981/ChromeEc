...
/* Kalista board-specific configuration */
...
/*
 * Since Kalista has no battery, it must source all of its power from either
 * USB-C or the barrel jack (preferred). Kalista operates in continuous safe
