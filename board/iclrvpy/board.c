...
/* Intel ICL-Y-RVP-ITE board-specific configuration */
...
int board_get_version(void)
{
	 ...
	 */
	bom_id = ((board_id & 0xC0) >> 6) | ((fab_id & 0x01) << 2);
	fab_id = ((fab_id & 0x06) >> 1) + 1;
	board_id &= 0x3F;
