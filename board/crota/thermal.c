...
void board_override_fan_control(int fan, int *tmp)
{
	...
	sensor_0 = thermal_fan_percent(thermal_params[0].temp_fan_off,
				thermal_params[0].temp_fan_max,
				C_TO_K(tmp[0]));
	sensor_1 = thermal_fan_percent(thermal_params[1].temp_fan_off,
				thermal_params[1].temp_fan_max,
				C_TO_K(tmp[1]));
	sensor_2 = thermal_fan_percent(thermal_params[2].temp_fan_off,
