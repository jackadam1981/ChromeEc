...
void board_override_fan_control(int fan, int *tmp)
{
	...
	sensor_1 = thermal_fan_percent(thermal_params[0].temp_fan_off,
				...
				C_TO_K(tmp[0]));
	sensor_4 = thermal_fan_percent(thermal_params[3].temp_fan_off,
				thermal_params[3].temp_fan_max,
				C_TO_K(tmp[3]));
	sensor_3 = thermal_fan_percent(thermal_params[2].temp_fan_off,
	...
	ccprints("🈲🈲🈲🈲🈲🈲 sensor_4 %d",sensor_4);
	ccprints("🈲🈲🈲🈲🈲🈲 sensor_3 %d",sensor_3);
	ccprints("🈲🈲🈲🈲🈲🈲 f %d",f);
