...
static void fan_set_percent(int fan, int pct, int soc_temp, bool fan_triggered)
{
	int new_rpm;

	if (fan_triggered)
		fans[fan].rpm = &fan_rpm_charger;
	else if (soc_temp > SENSOR_SOC_FAN_MID)
...
void board_override_fan_control(int fan, int *tmp)
{
	 ...
	 *
	 * Sensor SOC control normal loading's speed.
