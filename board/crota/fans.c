...
#define SENSOR_SOC_FAN_OFF_SLOP2 30
#define SENSOR_SOC_FAN_MAX_SLOP2 49
#define SENSOR_SOC_FAN_OFF_SLOP1_TABLET 25
#define SENSOR_SOC_FAN_MAX_SLOP1_TABLET 53
#define SENSOR_SOC_FAN_OFF_SLOP2_TABLET 31
#define SENSOR_SOC_FAN_MAX_SLOP2_TABLET 50
#define SENSOR_SOC_FAN_SLOP_THRESHOLD 44
