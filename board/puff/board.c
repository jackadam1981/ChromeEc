...
static void board_init(void)
{
	...
	*memmap_batt_flags |= EC_BATT_FLAG_AC_PRESENT;
	...
	CPRINTS("CONFIG_CHARGER_LIMIT_POWER_THRESH_CHG_MW: %d, CONFIG_CHARGER_LIMIT_POWER_THRESH_BAT_PCT: %d",
		CONFIG_CHARGER_LIMIT_POWER_THRESH_CHG_MW, CONFIG_CHARGER_LIMIT_POWER_THRESH_BAT_PCT);
