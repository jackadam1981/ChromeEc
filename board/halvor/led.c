...
#define LED_ONOFF_STATES_BAT_LOW 10
...
static void board_led_set_battery(void)
{
	...
	case PWR_STATE_DISCHARGE:
		...
		if (charge_get_percent() <
			LED_ONOFF_STATES_BAT_LOW){
			/* Discharging in S3: Amber 1 sec, off 1 sec */
			period = (1 + 1);
