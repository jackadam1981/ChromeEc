...
enum trembyle_ec_cfg_usb_db_type {
	TREMBYLE_USB_DB_T_OPT1 = 0,
	TREMBYLE_USB_DB_T_OPT2 = 1,
	TREMBYLE_USB_DB_T_OPT3 = 2,
};
...
#define HAS_USBC1_RETIMER_PS8802 \
			(BIT(TREMBYLE_USB_DB_T_OPT2) | \
			 BIT(TREMBYLE_USB_DB_T_OPT3))
