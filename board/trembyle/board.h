 ...
 *		IOEX: TCPC
 */
enum trembyle_ec_cfg_usb_mb_type {
	TREMBYLE_T_USB0_AC = 0,
};

/**
 * TREMBYLE_T_USB1_AC_HMDI
 ...
 *		MST Hub: none
 *
 * TREMBYLE_T_USB1_AC_HDMI_MSTHUB
 *	USB-A1  Speed: 10 Gbps
 *		Retimer: PS8811
 *	USB-C1  Speed: 10 Gbps
 *		Retimer: PS8802
 ...
 *		MST Hub: RTD2141B
 */
enum trembyle_ec_cfg_usb_db_type {
	TREMBYLE_T_USB1_AC_HMDI = 0,
	TREMBYLE_T_USB1_AC = 1,
	TREMBYLE_T_USB1_AC_HDMI_MSTHUB = 2,
};

static inline enum trembyle_ec_cfg_usb_db_type
...
#define HAS_USBC1_RETIMER_PS8802 \
			(BIT(TREMBYLE_T_USB1_AC) | \
			 BIT(TREMBYLE_T_USB1_AC_HDMI_MSTHUB))
