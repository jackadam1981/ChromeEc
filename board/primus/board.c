...
{
	/* As we define CONFIG_PS2, it will set GPIO37/ GPIOA6 into PS2 mode
	...
	gpio_set_flags(GPIO_EC_PCH_RSMRST_L, GPIO_OUT_LOW);
	gpio_set_alternate_function(GPIO_PORT_A, BIT(6), GPIO_ALT_FUNC_NONE);
}
