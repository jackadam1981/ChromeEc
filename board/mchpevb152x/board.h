 ...
 * Required for handling Kabylake/Skylake RVP3 board's
...
/* TODO - Is this required for MEC152x and future chips?
...
/* TODO wire up LSM6DS3 on I2C_PORT_ACCEL */
 ...
 *
 * MEC15xx EVB with MEC1503 CPU daughter card.
 * MEC1503 has no crystal pins.
 *
#define CONFIG_CLOCK_SRC_EXTERNAL
*/
#undef CONFIG_CLOCK_SRC_EXTERNAL
...
/*
 * MEC1521 EVB + SKL/KBL RVP3 does not have
...
/*
 * MEC152x WDT can fire an interrupt to the CPU before
 * it resets the system. We do not need a regular timer
 * to implement this feature. Disable.
...
/* #define I2C_PORT_GYRO           MCHP_I2C_PORT4 */
