...
const struct gpio_info gpio_list[] = {
	...
	{"AC_PRESENT",           LM4_GPIO_H, (1<<3), GPIO_INT_BOTH_DSLEEP,
	 extpower_interrupt},
	{"PCH_SLP_S3_L",         LM4_GPIO_G, (1<<7),
	 GPIO_INT_BOTH_DSLEEP | GPIO_PULL_UP, x86_interrupt},
	{"PCH_SLP_S4_L",         LM4_GPIO_H, (1<<1),
	 GPIO_INT_BOTH_DSLEEP | GPIO_PULL_UP, x86_interrupt},
	...
	{"JTAG_TCK",             LM4_GPIO_C, (1<<0), GPIO_DEFAULT,
	 jtag_interrupt},
	{"UART0_RX",             LM4_GPIO_A, (1<<0),
	 GPIO_INT_BOTH_DSLEEP | GPIO_PULL_UP, uart_deepsleep_interrupt},
