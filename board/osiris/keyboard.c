...
/* TODO(b/220800586): modify actual_key_mask for rgb keyboard */
uint8_t actual_key_mask_rgb[KEYBOARD_COLS_MAX] = {
		0x38, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
		0xa4, 0xff, 0xfe, 0x55, 0xfa, 0xca  /* full set */
	};

/*
 * TODO(b/220800586): verify multiple keyboard matrix types
 */
