...
#define HAS_USBC1_RETIMER_ON_HDMI_DB \
			(BIT(EZKINIL_DB_T_OPT1_USBC_HDMI))

static inline bool ec_config_has_usbc1_retimer_on_hdmi_db(void)
{
	return !!(BIT(ec_config_get_usb_db()) &
		  HAS_USBC1_RETIMER_ON_HDMI_DB);
}
