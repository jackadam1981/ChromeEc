 ...
 */
/* EC for Kip board configuration */
...
const struct gpio_info gpio_list[] = {
	...
	{"BAT_PRESENT_L",        LM4_GPIO_B, (1<<1), GPIO_INPUT, NULL},
 ...
 * system is locked.
 */
const struct i2c_cmd_desc_t i2c_cmd_whitelist[] = {
	/* Battery CT LABEL */
	{
		.port = 0x00,
		.cmd = 0x70,
...
volatile const int i2c_whitelist_size = ARRAY_SIZE(i2c_cmd_whitelist);
