...
/* between 188 (doesn't work) and 192 (works).
 * Even 191k does not work
 */
/* #define HELIPILOT_CODE_RAM_SIZE_BYTES (192 * 1024) */
/* #define HELIPILOT_CODE_RAM_SIZE_BYTES (160 * 1024) */
...
#define HELIPILOT_DATA_RAM_SIZE_BYTES (181 * 1024)
