 ...
 *
 * @param cc1  Either TYPEC_CC_VOLT_SNK_DEF, TYPEC_CC_VOLT_SNK_1_5,
 *                    TYPEC_CC_VOLT_SNK_3_0, or TYPEC_CC_RD
 * @param cc2  Either TYPEC_CC_VOLT_SNK_DEF, TYPEC_CC_VOLT_SNK_1_5,
 *                    TYPEC_CC_VOLT_SNK_3_0, or TYPEC_CC_RD
 */
...
/**
 * Configure the cc1_rp1a5_odh pin as ADC, CMP, or GPO
 *
 * @param cfg  PIN_ADC, PIN_CMP, or PIN_GPO
 * @param en   When cfg is PIN_GPO, 1 sets pin high
 *             and 0 sets pin low. Else ignored
...
/**
 * Configure the cc2_rp1a5_odh pin as ADC, CMP, or GPO
 *
 * @param cfg  PIN_ADC, PIN_CMP, or PIN_GPO
 * @param en   When cfg is PIN_GPO, 1 sets pin high
 *             and 0 sets pin low. Else ignored
...
/**
 * Configure the cc1_cc2_rd_l pin to High-Impedance, low, or high
 *
 * @param val  GPO_HZ, GPO_HIGH, GPO_LOW
 */
 ...
 *
 * @param en 0 disable billboard device, 1 to enable it
 */
...
/**
 * Connects the Charge-Through CC1 to Host CC
 *
 * @param en 1 connected, 0 disconnected
 */
void vpd_cc1_sel(int en);

/**
 * Connects the Charge-Through CC2 to Host CC
 *
 * @param en 1 connected, 0 disconnected
 */
