...
int peci_update_PL1(int watt)
{
	...
	rv = peci_Wr_Pkg_Config(PECI_INDEX_POWER_LIMITS_PL1,
				PECI_PARAMS_POWER_LIMITS_PL1, data,
				PECI_WR_PKG_CONFIG_WRITE_LENGTH_DWORD);
...
int peci_update_PL2(int watt)
{
	...
	rv = peci_Wr_Pkg_Config(PECI_INDEX_POWER_LIMITS_PL2,
				PECI_PARAMS_POWER_LIMITS_PL2, data,
				PECI_WR_PKG_CONFIG_WRITE_LENGTH_DWORD);
...
int peci_update_PL4(int watt)
{
	...
	rv = peci_Wr_Pkg_Config(PECI_INDEX_POWER_LIMITS_PL4,
				PECI_PARAMS_POWER_LIMITS_PL4, data,
				PECI_WR_PKG_CONFIG_WRITE_LENGTH_DWORD);
...
int peci_update_PsysPL2(int watt)
{
	...
	data = PECI_PSYS_PL2_CONTROL_TIME_WINDOWS |
	       PECI_PSYS_PL2_POWER_LIMIT_ENABLE |
