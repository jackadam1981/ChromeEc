...
#define CYP5525_DM_CONTROL_REG(x) (0x1000 + (x * 0x1000))
#define CYP5525_SELECT_SOURCE_PDO_REG(x) (0x1004 + (x * 0x1000))
#define CYP5525_SELECT_SINK_PDO_REG(x) (0x1005 + (x * 0x1000))
#define CYP5525_PD_CONTROL_REG(x) (0x1006 + (x * 0x1000))
#define CYP5525_PD_STATUS_REG(x) (0x1008 + (x * 0x1000))
#define CYP5525_TYPE_C_STATUS_REG(x) (0x100C + (x * 0x1000))
#define CYP5525_TYPE_C_VOLTAGE_REG(x) (0x100D + (x * 0x1000))
#define CYP5525_CURRENT_PDO_REG(x) (0x1010 + (x * 0x1000))
#define CYP5525_CURRENT_RDO_REG(x) (0x1014 + (x * 0x1000))
#define CYP5525_EVENT_MASK_REG(x) (0x1024 + (x * 0x1000))
#define CYP5525_VDM_EC_CONTROL_REG(x) (0x102A + (x * 0x1000))
#define CYP5525_DP_ALT_MODE_CONFIG_REG(x) (0x102B + (x * 0x1000))
#define CYP5525_PORT_INTR_STATUS_REG(x) (0x1034 + (x * 0x1000))

#define CYP5525_PORT_PD_RESPONSE_REG(x) (0x1400 + (x * 0x1000))
...
enum pd_port_role { PORT_SINK, PORT_SOURCE, PORT_DUALROLE };

enum pd_chip { PD_CHIP_0, PD_CHIP_1, PD_CHIP_COUNT };
...
void print_pd_response_code(uint8_t controller, uint8_t port, uint8_t id,
			    int len);
