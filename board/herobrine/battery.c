...
const struct board_batt_params board_battery_info[] = {
	...
	[BATTERY_GF384998] = {
		/*
		 * TODO: Update battery specification based on final draft
		 * which will be received by ECS and update fuel_gauge
		 * parameters.
		 */
		.fuel_gauge = {
			.manuf_name = "GANFENG",
			.device_name = "GF384998",
			.ship_mode = {
				.reg_addr = 0x3A,
	...
	/* TODO: Check if other batteries can be removed, may be needed
	 * later.
	 * AP16L5J
	 */
	[BATTERY_AP16L5J] = {
...
const enum battery_type DEFAULT_BATTERY_TYPE = BATTERY_GF384998;
