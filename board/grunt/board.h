...
/* TODO(ecgh): CONFIG_BC12_DETECT_BQ24392:
 * Need to resolve PP5000 assumption
 */
#define GPIO_EN_PP5000 0
...
/* TODO(ecgh): CONFIG_USBC_PPC_SN5S330:
 * Need to resolve CONFIG_USB_PD_MAX_SINGLE_SOURCE_CURRENT build error
 */
...
enum adc_channel {
	/* TODO(ecgh): how does charge_manager read VBUS? */
	ADC_VBUS = -1,
