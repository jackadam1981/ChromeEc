...
/* TODO(ecgh): Use CONFIG_USB_PD_TCPC_LOW_POWER once HW adds CABLE_DET */
...
void board_tcpc_init(void)
{
	...
	/*
	 * TODO(ecgh): Remove when Grunt is updated with PS8751 A3.
	 *
	 ...
	 */
	i2c_read8(I2C_PORT_TCPC1, 0x10, 0xA0, &reg);
