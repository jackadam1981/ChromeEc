...
const struct i2c_port_t i2c_ports[] = {
	...
	{"eeprom_bl", I2C_PORT_EEPROM_BL, 100, GPIO_I2C5_SCL, GPIO_I2C5_SDA},
...
const struct pwm_t pwm_channels[] = {
	...
	[PWM_CH_LED1_ORANGE] = { 0, PWM_CONFIG_DSLEEP, 120 },
	[PWM_CH_LED2_BLUE] =   { 2, PWM_CONFIG_DSLEEP, 120 },
};
...
static void board_init_leds_off(void)
{
	...
	pwm_set_duty(PWM_CH_LED1_ORANGE, 100);
