...
struct bq24392_config_t bq24392_config[CONFIG_USB_PD_PORT_COUNT] = {
	[USB_PD_PORT_ANX74XX] = {
...
static void board_init(void)
{
	if (system_get_board_version() < 2) {
		...
		bq24392_config[USB_PD_PORT_ANX74XX].chip_enable_pin
			= GPIO_USB_C0_BC12_VBUS_ON_L_V0;
	}
	...
	gpio_set_flags(bq24392_config[USB_PD_PORT_ANX74XX].chip_enable_pin,
		       GPIO_ODR_HIGH);
