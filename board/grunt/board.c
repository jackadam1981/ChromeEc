...
{
	/*
	 * Allow display backlight to turn on. The EC doesn't need to control
	 * the backlight during lower power mode since the AP also controls it.
...
{
	/*
	 * Turn off display backlight. The EC doesn't need to control
	 * the backlight during lower power mode since the AP also controls it.
	 * This is here more for legacy reasons.
	 */
	enable_backlight(0);
