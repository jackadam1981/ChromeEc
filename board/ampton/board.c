...
struct usb_mux ampton_usb_muxes_mem[CONFIG_USB_PD_PORT_MAX_COUNT] = {
	[USB_PD_PORT_ITE_0] = {
...
struct usb_mux *ampton_usb_muxes[CONFIG_USB_PD_PORT_MAX_COUNT] = {
	[USB_PD_PORT_ITE_0] = &ampton_usb_muxes_mem[USB_PD_PORT_ITE_0],
	[USB_PD_PORT_ITE_1] = &ampton_usb_muxes_mem[USB_PD_PORT_ITE_1],
};
