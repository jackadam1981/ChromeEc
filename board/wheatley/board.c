...
struct motion_sensor_t motion_sensors[] = {
	...
	{.name = "Base Accel",
	 ...
	 .min_frequency = MOTIONSENSE_CHIP_BMI160_ACCEL_MIN_FREQ,
	 .max_frequency = MOTIONSENSE_CHIP_BMI160_ACCEL_MAX_FREQ,
	 .fifo_max_event_count =
			MOTIONSENSE_CHIP_BMI160_ACCEL_MAX_FIFO_EVENT_COUNT,
	 .config = {
	...
	{.name = "Base Gyro",
	 ...
	 .rot_standard_ref = NULL, /* Identity Matrix. */
	 .min_frequency = MOTIONSENSE_CHIP_BMI160_GYRO_MIN_FREQ,
	 .max_frequency = MOTIONSENSE_CHIP_BMI160_GYRO_MAX_FREQ,
	 .fifo_max_event_count =
			MOTIONSENSE_CHIP_BMI160_GYRO_MAX_FIFO_EVENT_COUNT,
	 .config = {
	...
	{.name = "Lid Accel",
	 ...
	 .rot_standard_ref = NULL, /* Identity matrix. */
	 .default_range = 2, /* g, enough for laptop. */
	 .min_frequency = MOTIONSENSE_CHIP_KX022_ACCEL_MIN_FREQ,
	 .max_frequency = MOTIONSENSE_CHIP_KX022_ACCEL_MAX_FREQ,
	 .fifo_max_event_count =
			MOTIONSENSE_CHIP_KX020_ACCEL_MAX_FIFO_EVENT_COUNT,
	 .config = {
		/* AP: by default use EC settings */
		[SENSOR_CONFIG_AP] = {
			.odr = 10000 | ROUND_UP_FLAG,
