...
#define CONFIG_CHARGER_TIMEOUT_HOURS 10
...
#undef CONFIG_FANS
#undef CONFIG_PWM
#undef CONFIG_PRECHARGE_TIMEOUT
#define CONFIG_PRECHARGE_TIMEOUT 1800
#undef HOOKS_TASK_STACK_SIZE
#define HOOKS_TASK_STACK_SIZE 768
