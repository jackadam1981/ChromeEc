...
struct pwm_led led_color_map[] = {
	...
	[EC_LED_COLOR_GREEN] =  { 0,     0,     100},
	[EC_LED_COLOR_WHITE] =  {   100,    0,   0},
	[EC_LED_COLOR_AMBER] =  {  20,   100,     0 },
};

struct pwm_led pwm_leds[] = {
	/*  Power LED uses monochrome LED, white */
	[PWM_LED0] = {
		.ch0 = PWM_CH_LED3_WHITE,
		.enable = &pwm_enable,
		.set_duty = &pwm_set_duty,
	},
	/*  Battery LED uses dual-color LED, green and red */
	[PWM_LED1] = {
		.ch0 = PWM_CH_LED1_GREEN,
		.ch1 = PWM_CH_LED2_RED,
		.enable = &pwm_enable,
		.set_duty = &pwm_set_duty,
	},
