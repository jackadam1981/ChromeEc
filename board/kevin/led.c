...
{
	pwm_set_duty(PWM_CH_CHG_LED, color_brightness[color][0]);
	pwm_set_duty(PWM_CH_PWR_LED, color_brightness[color][1]);
	pwm_set_duty(PWM_CH_FULL_LED, color_brightness[color][2]);
}
...
{
	pwm_set_duty(PWM_CH_CHG_LED, brightness[EC_LED_COLOR_RED]);
	pwm_set_duty(PWM_CH_PWR_LED, brightness[EC_LED_COLOR_BLUE]);
	pwm_set_duty(PWM_CH_FULL_LED, brightness[EC_LED_COLOR_GREEN]);
	return EC_SUCCESS;
}
