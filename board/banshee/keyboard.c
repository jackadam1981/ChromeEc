...
static const struct ec_response_keybd_config banshee_kb_evt = {
	.num_top_row_keys = 12,
	.action_keys = {
		TK_BACK,		/* T1 */
		TK_FORWARD,		/* T2 */
...
static const struct ec_response_keybd_config banshee_kb_dvt = {
	.num_top_row_keys = 12,
	.action_keys = {
		TK_BACK,		/* T1 */
		TK_REFRESH,		/* T2 */
...
{
	if (get_board_id() <= 1)
		return &banshee_kb_evt;
	else
		return &banshee_kb_dvt;
}
