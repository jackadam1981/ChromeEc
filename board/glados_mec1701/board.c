...
const struct i2c_port_t i2c_ports[]  = {
	{"pmic",     MEC17XX_I2C0_0, 400,  GPIO_SMB00_SCL, GPIO_SMB00_SDA},
	{"muxes",    MEC17XX_I2C0_2, 400,  GPIO_SMB02_SCL, GPIO_SMB02_SDA},
	{"pd_mcu",   MEC17XX_I2C1_3, 500,  GPIO_SMB03_SCL, GPIO_SMB03_SDA},
	{"sensors",  MEC17XX_I2C2_4, 400,  GPIO_SMB04_SCL, GPIO_SMB04_SDA},
	{"batt",     MEC17XX_I2C3_5, 100,  GPIO_SMB05_SCL, GPIO_SMB05_SDA},
};
#else
const struct i2c_port_t i2c_ports[]  = {
	/* {"pmic",     MEC17XX_I2C0_0, 400,  GPIO_SMB00_SCL, GPIO_SMB00_SDA},
...
static void board_pmic_init(void)
{
	...
	TRACE0(74, HOOK, 0, "HOOK_INIT - call board_pmic_init");
...
static void board_init(void)
{
	...
	TRACE0(75, HOOK, 0, "HOOK_INIT - call board_init");
...
static void board_extpower(void)
{
	...
	TRACE0(76, HOOK, 0, "HOOK_AC_CHANGET - call board_extpower");
	gpio_set_level(GPIO_PCH_ACOK, extpower_is_present());
}
...
int board_set_active_charge_port(int charge_port)
{
	...
	if (is_real_port && source) {
		...
		TRACE1(77, BOARD, 0, "Skip enable charge port %d", charge_port);
		return EC_ERROR_INVAL;
	}

	CPRINTS("MEC1701 New chg p%d", charge_port);
	TRACE1(78, BOARD, 0, "New charge port %d", charge_port);
...
static void board_chipset_startup(void)
{
	...
	TRACE0(79, HOOK, 0, "HOOK_CHIPSET_STARTUP - board_chipset_startup");
...
{
	CPRINTS("MEC1701 HOOK_CHIPSET_SHUTDOWN - called board_chipset_shutdown");
	TRACE0(80, HOOK, 0, "HOOK_CHIPSET_SHUTDOWN - board_chipset_shutdown");
...
static void board_chipset_resume(void)
{
	...
	TRACE0(81, HOOK, 0, "HOOK_CHIPSET_RESUME - board_chipset_resume");
...
static void board_chipset_suspend(void)
{
	...
	TRACE0(82, HOOK, 0, "HOOK_CHIPSET_SUSPEND - board_chipset_suspend");
...
static void board_handle_reboot(void)
{
	...
	TRACE0(83, HOOK, 0, "HOOK_INIT - board_handle_reboot");
