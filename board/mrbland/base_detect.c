...
static int base_enable_allow;
static int current_base_enable_allow;
...
static void base_detect_change(enum base_status status)
{
	...
	current_base_enable_allow = base_enable_allow;
	connected ? base_enable_lid_detect(1) :
			base_enable_lid_detect(0);
}
...
{
	/*
	 * Disable power to base and reset the base_enable_allow,
