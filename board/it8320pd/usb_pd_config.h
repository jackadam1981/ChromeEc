...
#define SRC_CC_OPEN 0x33
#define SRC_CC2_ATTACHED_CC1_OPEN 0x13
#define SRC_CC1_ATTACHED_CC2_OPEN 0x31
#define SRC_CC2_ATTACHED_CC1_POWERED_CABLE 0x10
#define SRC_CC1_ATTACHED_CC2_POWERED_CABLE 0x01
...
void ite8320_pd_set_power_role(int port, int powerRole);
void ite8320_pd_hw_reset(enum usbpd_port port,
