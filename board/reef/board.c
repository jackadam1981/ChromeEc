...
static struct thermistor_data_pair charger_thermistor_data[] = {
	{ 1500 / THERMISTOR_SCALING_FACTOR, 50 },
	{ 1810 / THERMISTOR_SCALING_FACTOR, 60 },
	{ 2092 / THERMISTOR_SCALING_FACTOR, 70 },
	{ 2334 / THERMISTOR_SCALING_FACTOR, 80 },
	{ 2697 / THERMISTOR_SCALING_FACTOR, 100 },
};

static struct thermistor_info charger_thermistor_info = {
 ...
 */
#define THERMISTOR_SCALING_FACTOR 13
static struct thermistor_data_pair amb_thermistor_data[] = {
...
static struct thermistor_info amb_thermistor_info = {
	.scaling_factor = THERMISTOR_SCALING_FACTOR,
 ...
 */
#define K(c) C_TO_K(c)	/* shorthand for table entries */
struct ec_thermal_config thermal_params[] = {
	/* {Twarn, Thigh, Thalt}, fan_off, fan_max */
	/* FIXME(dhendrix): These were chosen arbitrarily and need tuning. */
	{{K(60), K(75), K(85)}, K(60), K(85)},	/* Battery */
	{{K(60), K(70), K(85)}, K(60), K(90)},	/* Ambient */
	{{K(60), K(70), K(85)}, K(60), K(100)},	/* Charger */
};
