...
void chipset_do_shutdown(void)
{
	...
	/*
	 * FIXME: If we shut off TCPC0 the TCPC tasks will fail
	...
	/*
	 * FIXME: We currently only enable PP5000 in board_init(). If we
	 * disable it here then it should ideally be re-enabled in
	 * chipset_pre_init(). Keep enabled until we have things smoothed
	 * out with the power states.
	 */
