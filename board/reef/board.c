...
struct motion_sensor_t motion_sensors[] = {
	...
	[BASE_BARO] = {
	 ...
	 .min_sampling_frequency = MOTIONSENSE_CHIP_BMP280_BARO_MIN_FREQ,
	 .max_sampling_frequency = MOTIONSENSE_CHIP_BMP280_BARO_MAX_FREQ,
	 .fifo_max_event_count = CONFIG_ACCEL_FIFO,
	 .config = {
		 /* AP: by default shutdown all sensors */
		 [SENSOR_CONFIG_AP] = {
	...
	[LID_ALS] = {
	 ...
	 .min_sampling_frequency = MOTIONSENSE_CHIP_OPT3001_LIGHT_MIN_FREQ,
	 .max_sampling_frequency = MOTIONSENSE_CHIP_OPT3001_LIGHT_MAX_FREQ,
	 .fifo_max_event_count = CONFIG_ACCEL_FIFO,
	 .config = {
		/* AP: by default shutdown all sensors */
		[SENSOR_CONFIG_AP] = {
