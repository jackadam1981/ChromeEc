...
/* Mapping between PD port numbers and I2C port numbers */
#define USB_PD_PORT_ANX74XX	NPCX_I2C_PORT0_0
#define USB_PD_PORT_PS8751	NPCX_I2C_PORT0_1
...
const struct tcpc_config_t tcpc_config[CONFIG_USB_PD_PORT_COUNT] = {
	{USB_PD_PORT_ANX74XX, 0x50, &anx74xx_tcpm_drv, TCPC_ALERT_ACTIVE_LOW},
	{USB_PD_PORT_PS8751, 0x16, &tcpci_tcpm_drv, TCPC_ALERT_ACTIVE_LOW},
};
