...
/*
 * Kludge to pass configuration information to the ALS driver.
 * Multiplier to report data in Lux, taking in account attenuation.
 */
const matrix_3x3_t light_standard_ref = {
	{ FLOAT_TO_FP(0.05), 0, 0},
	{ 0, 0, 0},
	{ 0, 0, 0}
};
...
struct motion_sensor_t motion_sensors[] = {
	...
	[LID_ALS] = {
	 ...
	 .port = I2C_PORT_ALS,
	 .addr = OPT3001_I2C_ADDR1,
	 .rot_standard_ref = &light_standard_ref,
