...
#undef CONFIG_HOSTCMD_DEBUG_MODE
#define CONFIG_HOSTCMD_DEBUG_MODE HCDEBUG_OFF
/* Remove these in the final patch? */
#define CONFIG_CMD_I2C_STRESS_TEST
#define CONFIG_CMD_I2C_STRESS_TEST_BD99955
#define CONFIG_CMD_I2C_STRESS_TEST_BMI160
#define CONFIG_CMD_I2C_STRESS_TEST_BMP280
#define CONFIG_CMD_I2C_STRESS_TEST_KIONIX
#define CONFIG_CMD_I2C_STRESS_TEST_OPT3001
