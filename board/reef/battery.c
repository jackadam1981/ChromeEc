...
static const struct fast_charge_profile fast_charge_cos4870_info[] = {
	/* < 0C */
	[TEMP_RANGE_0] = {
		.temp_c = TEMPC_TENTHS_OF_DEG(-1),
		.curr_vtg_low_limit_mA = 0,
		.curr_vtg_high_limit_mA = 0,
	},

	/* 0C >= && <=15C */
	[TEMP_RANGE_1] = {
		.temp_c = TEMPC_TENTHS_OF_DEG(15),
		.curr_vtg_low_limit_mA = 944,
		.curr_vtg_high_limit_mA = 472,
	},

	/* 15C > && <=20C */
	[TEMP_RANGE_2] = {
		.temp_c = TEMPC_TENTHS_OF_DEG(20),
		.curr_vtg_low_limit_mA = 1416,
		.curr_vtg_high_limit_mA = 1416,
	},

	/* 20C > && <=45C */
	[TEMP_RANGE_3] = {
		.temp_c = TEMPC_TENTHS_OF_DEG(45),
		.curr_vtg_low_limit_mA = 3300,
		.curr_vtg_high_limit_mA = 3300,
	},
...
static const struct fast_charge_config fast_charge_config_cos4870_info = {
	.total_temp_ranges = ARRAY_SIZE(fast_charge_cos4870_info),
	.default_temp_range_profile = TEMP_RANGE_2,
	.vtg_low_limit_mV = 8000,
	.vtg_high_limit_mV = 8000,
};
...
static const struct fast_charge_profile fast_charge_sonycorp_info[] = {
	...
	[TEMP_RANGE_0] = {
		...
		.curr_vtg_low_limit_mA = 1200,
		.curr_vtg_high_limit_mA = 1200,
	},
...
static const struct fast_charge_config fast_charge_config_sonycorp_info = {
...
static const struct board_batt_params info[] = {
	...
	[BATTERY_SONY_CORP] = {
		...
		.fast_chg_params = {
			...
			.chg_config_info = &fast_charge_config_sonycorp_info,
		},
	...
	[BATTERY_SMP_COS4870] = {
		...
		.fast_chg_params = {
			.chg_profile_info = &fast_charge_cos4870_info[0],
			.chg_config_info = &fast_charge_config_cos4870_info,
		},
	...
	[BATTERY_SMP_C22N1626] = {
		...
		/* Fast charging params info for BQ40Z55 */
		.fast_chg_params = {
			.chg_profile_info = fast_charge_cos4870_info,
			.chg_config_info = &fast_charge_config_cos4870_info,
		},
...
static int board_get_battery_type(void)
{
	...
	fast_chg_params = &board_get_batt_params()->fast_chg_params;
	prev_chg_profile_info = &fast_chg_params->chg_profile_info[
		fast_chg_params->chg_config_info->default_temp_range_profile];
