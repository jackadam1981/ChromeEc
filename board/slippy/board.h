...
enum gpio_signal {
	...
	GPIO_PP1350_PGOOD,         /* Power good on 1.35V */
	GPIO_PP5000_PGOOD,         /* Power good on 5V */
	GPIO_VCORE_PGOOD,          /* Power good on core */
	...
	/* Other inputs */
	GPIO_FAN_ALERT_L,          /* HEY: Dunno */
	GPIO_USB1_OC_L,            /* HEY: USB overcurrent warning */
	GPIO_USB2_OC_L,            /* HEY: USB overcurrent warning */
	...
	GPIO_PP3300_DX_EN,         /* Dunno */
	GPIO_PP3300_LTE_EN,        /* Enable LTE radio */
	GPIO_PP3300_WLAN_EN,       /* Enable WiFi radio */
	GPIO_SUSP_VR_EN,           /* Dunno */
	/* HEY GPIO_VCORE_EN,         not connected */
	GPIO_PP5000_EN,            /* Enable 5V supply */
	GPIO_SYS_PWROK,            /* Some random signal */
