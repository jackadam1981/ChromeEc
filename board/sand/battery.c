...
/*
 * Physical detection of battery via GPIO.
 */

enum battery_present battery_is_present(void)
{
	/*
	 * DOTO: 1. detect physical connection status by GPIO
	 *	 2. detect DFET is on/off by reading Gauge custom register.
	 */
...
{
	return gpio_get_level(GPIO_EC_BATT_PRES_L);
}
