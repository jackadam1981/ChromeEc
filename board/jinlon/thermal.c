...
struct fan_step fan_table_clamshell[] = {
	{
		/* level 0 */
		.on = {0, -1, 45, 54}, /* Sensor 1~4 trigger point */
		.off = {99, -1, 0, 52}, /* Sensor 1~4 release point */
		.rpm = {0, 0}, /* Fan 1~2 rpm */
	},
	{
		/* level 1 */
		.on = {0, -1, 46, 56}, /* Sensor 1~4 trigger point */
		.off = {99, -1, 45, 54}, /* Sensor 1~4 release point */
		.rpm = {4200, 4700}, /* Fan 1~2 rpm */
	},
	{
		/* level 2 */
		.on = {0, -1, 47, 58}, /* Sensor 1~4 trigger point */
		.off = {99, -1, 46, 56}, /* Sensor 1~4 release point */
		.rpm = {4400, 4900}, /* Fan 1~2 rpm */
	},
	{
		/* level 3 */
		.on = {0, -1, 48, 60}, /* Sensor 1~4 trigger point */
		.off = {99, -1, 47, 58}, /* Sensor 1~4 release point */
		.rpm = {4600, 5100}, /* Fan 1~2 rpm */
	},
	{
		/* level 4 */
		.on = {80, -1, 49, 62}, /* Sensor 1~4 trigger point */
		.off = {74, -1, 48, 60}, /* Sensor 1~4 release point */
		.rpm = {4800, 5300}, /* Fan 1~2 rpm */
	},
	{
		/* level 5 */
		.on = {85, -1, 50, 64}, /* Sensor 1~4 trigger point */
		.off = {79, -1, 49, 62}, /* Sensor 1~4 release point */
		.rpm = {5200, 5700}, /* Fan 1~2 rpm */
	},
	{
		/* level 6 */
		.on = {90, -1, 51, 66}, /* Sensor 1~4 trigger point */
		.off = {84, -1, 50, 64}, /* Sensor 1~4 release point */
		.rpm = {5600, 6100}, /* Fan 1~2 rpm */
	},
	{
		/* level 7 */
		.on = {127, -1, 127, 127}, /* Sensor 1~4 trigger point */
		.off = {89, -1, 51, 66}, /* Sensor 1~4 release point */
		.rpm = {6000, 6500}, /* Fan 1~2 rpm */
	},
};
...
struct fan_step fan_table_tablet[] = {
	{
		/* level 0 */
		.on = {0, -1, 42, 40}, /* Sensor 1~4 trigger point */
		.off = {99, -1, 0, 0}, /* Sensor 1~4 release point */
		.rpm = {0, 0}, /* Fan 1~2 rpm */
	},
	{
		/* level 1 */
		.on = {0, -1, 43, 42}, /* Sensor 1~4 trigger point */
		.off = {99, -1, 42, 37}, /* Sensor 1~4 release point */
		.rpm = {0, 0}, /* Fan 1~2 rpm */
	},
	{
		/* level 2 */
		.on = {0, -1, 44, 44}, /* Sensor 1~4 trigger point */
		.off = {99, -1, 43, 39}, /* Sensor 1~4 release point */
		.rpm = {0, 0}, /* Fan 1~2 rpm */
	},
	{
		/* level 3 */
		.on = {0, -1, 45, 46}, /* Sensor 1~4 trigger point */
		.off = {99, -1, 44, 41}, /* Sensor 1~4 release point */
		.rpm = {0, 0}, /* Fan 1~2 rpm */
	},
	{
		/* level 4 */
		.on = {80, -1, 46, 48}, /* Sensor 1~4 trigger point */
		.off = {74, -1, 45, 43}, /* Sensor 1~4 release point */
		.rpm = {4800, 5300}, /* Fan 1~2 rpm */
	},
	{
		/* level 5 */
		.on = {85, -1, 47, 50}, /* Sensor 1~4 trigger point */
		.off = {79, -1, 46, 45}, /* Sensor 1~4 release point */
		.rpm = {5200, 5700}, /* Fan 1~2 rpm */
	},
	{
		/* level 6 */
		.on = {90, -1, 60, 65}, /* Sensor 1~4 trigger point */
		.off = {84, -1, 47, 47}, /* Sensor 1~4 release point */
		.rpm = {5600, 6100}, /* Fan 1~2 rpm */
	},
	{
		/* level 7 */
		.on = {127, -1, 127, 127}, /* Sensor 1~4 trigger point */
		.off = {89, -1, 53, 57}, /* Sensor 1~4 release point */
		.rpm = {6000, 6500}, /* Fan 1~2 rpm */
	},
};
