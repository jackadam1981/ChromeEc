...
/*
 * The estimated max power consumption is 65W thus we may make the supply
 * reserve more power than necessary. There is currently no such a smart power
 * supply available. We can update the value if the situation changes in the
 * future.
 */
