...
const struct tcpc_config_t tcpc_config[CONFIG_USB_PD_PORT_COUNT] = {
	...
	[USB_PD_PORT_ANX7447] = {
		...
		.i2c_info = {
			...
			.addr__7b = AN7447_TCPC3_I2C_ADDR__7b,
		},
...
#define I2C_PMIC_READ(reg, data) \
		i2c_read8__7b(I2C_PORT_PMIC, TPS650X30_I2C_ADDR1__7b, (reg), (data))
#define I2C_PMIC_WRITE(reg, data) \
		i2c_write8__7b(I2C_PORT_PMIC, TPS650X30_I2C_ADDR1__7b, (reg), (data))
...
static void board_init(void)
{
	...
	if (i2c_read16__7b(I2C_PORT_CHARGER, I2C_ADDR_CHARGER__7b,
		       ISL9238_REG_CONTROL3, &reg) == EC_SUCCESS) {
		reg |= ISL9238_C3_BB_SWITCHING_PERIOD;
		if (i2c_write16__7b(I2C_PORT_CHARGER, I2C_ADDR_CHARGER__7b,
