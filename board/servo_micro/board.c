...
#define KHz(khz) (khz * 1000)
#define MHz(mhz) (mhz * KHz(1000))
...
#define I2C_CMD_ADDR 0xB4  /* 7 bit form is 0x5A */
#define I2C_DATA_ADDR 0x6A  /* 7 bit form is 0x35 */

#define SMCLK_WAVEFORM_PERIOD_HZ KHz(100)
#define SMDAT_WAVEFORM_PERIOD_HZ KHz(200)
...
static int command_enable_ite_dfu(int argc, char **argv)
{
	...
	STM32_TIM_ARR(16) = (MHz(1) / SMCLK_WAVEFORM_PERIOD_HZ) - 1;
	STM32_TIM_ARR(17) = (MHz(1) / SMDAT_WAVEFORM_PERIOD_HZ) - 1;
	...
	STM32_TIM_CCR1(16) = (MHz(1) / SMCLK_WAVEFORM_PERIOD_HZ) / 2;
	STM32_TIM_CCR1(17) = (MHz(1) / SMDAT_WAVEFORM_PERIOD_HZ) / 2;
