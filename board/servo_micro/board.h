 ...
 * tightly, these lower limits of (1<<10)-4 writes and (1<<10)-6 reads are used,
 * leaving 4476 bytes of RAM available.  Previously, with the default 60 byte
 * limits, 7356 bytes of RAM was available.
*/
#undef CONFIG_USB_I2C_MAX_WRITE_COUNT
#undef CONFIG_USB_I2C_MAX_READ_COUNT
#define CONFIG_USB_I2C_MAX_WRITE_COUNT ((1<<10) - 4)
#define CONFIG_USB_I2C_MAX_READ_COUNT ((1<<10) - 6)
