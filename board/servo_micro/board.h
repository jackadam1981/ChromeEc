...
/* Enable JTAG/SWD via CMSIS-DAP USB protocol */
#define CONFIG_USB_CMSIS_DAP
#define CONFIG_USB_CMSIS_DAP_JTAG
#define CONFIG_USB_CMSIS_DAP_SWD

/* Enable control of I2C over USB as CMSIS-DAP vendor extension */
#define CONFIG_USB_CMSIS_DAP_I2C
#define CONFIG_I2C
...
/* Pins used by common/cmsis-dap.c */
#define GPIO_JTAG_TCLK GPIO_UART3_TX_SERVO_JTAG_TCK
#define GPIO_JTAG_TMS GPIO_SERVO_JTAG_TMS
#define GPIO_JTAG_TDI GPIO_SERVO_JTAG_TDI
#define GPIO_JTAG_TDO GPIO_UART3_RX_JTAG_BUFFER_TO_SERVO_TDO
#define GPIO_JTAG_TRST GPIO_SERVO_JTAG_TRST_L
#define GPIO_JTAG_RESET GPIO_COUNT
