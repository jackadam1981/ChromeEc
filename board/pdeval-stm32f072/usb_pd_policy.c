...
#define SRC_PDO_FIXED_FLAGS (PDO_FIXED_DUAL_ROLE | PDO_FIXED_DATA_SWAP | \
			     PDO_FIXED_COMM_CAP |			 \
			     SRC_PDO_FIXED_UNCHUNKED_EXT_MSG)
#define SNK_PDO_FIXED_FLAGS (PDO_FIXED_DUAL_ROLE | PDO_FIXED_DATA_SWAP | \
			     SNK_PDO_FIXED_FRSWAP_DEFAULT)
#else
#define SRC_PDO_FIXED_FLAGS (PDO_FIXED_DUAL_ROLE | PDO_FIXED_DATA_SWAP)
#define SNK_PDO_FIXED_FLAGS (PDO_FIXED_DUAL_ROLE | PDO_FIXED_DATA_SWAP)
#endif
...
const uint32_t pd_snk_pdo[] = {
		PDO_FIXED(5000, 900, SNK_PDO_FIXED_FLAGS),
