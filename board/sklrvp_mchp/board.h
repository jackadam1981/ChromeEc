...
/*
 * Bring-up: Disable low power idle
 */
...
#define I2C_PORT0_BB_RETIMER	MCHP_I2C_PORT4
#define I2C_PORT1_BB_RETIMER	MCHP_I2C_PORT4
 ...
 * ADC channels
 */
#define ADC_TEMP_SNS_AMBIENT_CHANNEL 3
#define ADC_TEMP_SNS_DDR_CHANNEL 4
#define ADC_TEMP_SNS_SKIN_CHANNEL 7
#define ADC_TEMP_SNS_VR_CHANNEL 1
