 ...
 */
/* EC for Yuna board configuration */
...
int fan_percent_to_rpm(int fan, int pct)
{
	 ...
	 *  3. keep path. (reuten the current RPM)
	 * The keep path have an exception: index = 0.
	 * If index = 0, the conditions are
	 *  a. initial value.
	 *  b. exactly index = 0.
	 * Use increasing path to find the correct fan table in the both
