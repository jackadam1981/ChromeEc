...
struct tcpc_config_t tcpc_config[CONFIG_USB_PD_PORT_COUNT] = {
	...
	[USB_PD_PORT_ANX7447] = {
		...
		.i2c_info = {
			.port = I2C_PORT_TCPC0,
			.addr__7b = AN7447_TCPC3_I2C_ADDR__7b, /* Verified on v1.1 */
		},
...
static void board_pmic_disable_slp_s0_vr_decay(void)
{
	 ...
	 * Bits 1:0 (10) - VR set to AUTO operating mode
	 */
	i2c_write8__7b(I2C_PORT_PMIC, I2C_ADDR_BD99992__7b, 0x38, 0x3a);
}
...
static void board_pmic_init(void)
{
	 ...
	 */
	i2c_write8__7b(I2C_PORT_PMIC, I2C_ADDR_BD99992__7b, 0x3d, 0x55);
	/* DISCHGCNT3 - enable 100 ohm discharge on V1.8U_25U/V1.00A */
	i2c_write8__7b(I2C_PORT_PMIC, I2C_ADDR_BD99992__7b, 0x3e, 0x44);
	/* DISCHGCNT4 - enable 100 ohm discharge on v1.8S */
	i2c_write8__7b(I2C_PORT_PMIC, I2C_ADDR_BD99992__7b, 0x3f, 0x04);

	board_pmic_disable_slp_s0_vr_decay();

	/* VRMODECTRL - disable low-power mode for all rails */
	i2c_write8__7b(I2C_PORT_PMIC, I2C_ADDR_BD99992__7b, 0x3b, 0x1f);
}
...
struct motion_sensor_t motion_sensors[] = {
	[LID_ACCEL] = {
		...
		.port = I2C_PORT_ACCEL,
		.addr__8b = BMA2x2_I2C_ADDR1__7b << 1,
