...
QUEUE_POLICY_DIRECT(ap_usart_to_usb_policy, ap_usart.producer, ap_usb.consumer)
QUEUE_POLICY_DIRECT(ap_usb_to_usart_policy, ap_usb.producer,   ap_usart.consumer)
QUEUE_POLICY_DIRECT(sh_usart_to_usb_policy, sh_usart.producer, sh_usb.consumer)
QUEUE_POLICY_DIRECT(sh_usb_to_usart_policy, sh_usb.producer,   sh_usart.consumer)

QUEUE_CONFIG(ap_usart_to_usb, 64, uint8_t, ap_usart_to_usb_policy.policy)
QUEUE_CONFIG(ap_usb_to_usart, 64, uint8_t, ap_usb_to_usart_policy.policy)
QUEUE_CONFIG(sh_usart_to_usb, 64, uint8_t, sh_usart_to_usb_policy.policy)
QUEUE_CONFIG(sh_usb_to_usart, 64, uint8_t, sh_usb_to_usart_policy.policy)
