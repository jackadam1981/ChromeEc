...
QUEUE_CONFIG(ap_usart_to_usb, 64, uint8_t,
	     QUEUE_POLICY_DIRECT(ap_usart.producer, ap_usb.consumer).policy)

QUEUE_CONFIG(ap_usb_to_usart, 64, uint8_t,
	     QUEUE_POLICY_DIRECT(ap_usb.producer, ap_usart.consumer).policy)

QUEUE_CONFIG(sh_usart_to_usb, 64, uint8_t,
	     QUEUE_POLICY_DIRECT(sh_usart.producer, sh_usb.consumer).policy)

QUEUE_CONFIG(sh_usb_to_usart, 64, uint8_t,
	     QUEUE_POLICY_DIRECT(sh_usb.producer, sh_usart.consumer).policy)
