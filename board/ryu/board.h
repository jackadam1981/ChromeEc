...
/* GPIO aliases for power state machine */
#define GPIO_AP_RESET_L GPIO_PMIC_RESET_OUT_L
#define GPIO_PMIC_THERM_L GPIO_AP_OVERHEAT_L
#define GPIO_SUSPEND_L GPIO_AP_IN_SUSPEND
#define GPIO_PMIC_WARM_RESET_L GPIO_PMIC_RESET_OUT_L
#define GPIO_POWER_BUTTON_L GPIO_BTN_EC_PWR_L
