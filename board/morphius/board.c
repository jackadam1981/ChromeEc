 ...
 */
static int ssfc_base_gyro_config;
static void setup_base_gyro_config(void)
{
	ssfc_base_gyro_config = get_cbi_ssfc_base_sensor();

	if (ssfc_base_gyro_config == SSFC_BASE_GYRO_ICM426XX) {
