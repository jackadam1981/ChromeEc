...
enum ec_cfg_base_gyro_sensor_type get_base_gyro_sensor(void)
{
	...
	case SSFC_BASE_GYRO_NONE:
		if (ec_config_has_base_gyro_sensor() == BASE_GYRO_ICM426XX)
			return BASE_GYRO_ICM426XX;
		else if (ec_config_has_base_gyro_sensor() == BASE_GYRO_BMI160)
			return BASE_GYRO_BMI160;
	case SSFC_BASE_GYRO_ICM426XX:
		return BASE_GYRO_ICM426XX;
	default:
		return BASE_GYRO_NONE;
	}
}
