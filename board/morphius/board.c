...
void setup_fw_config(void)
{
	...
	/*
	 * TODO(dbrockus@): remove VERSION_2 code when older version of
	 * hardware is retired and no longer needed
	 */
	if (board_ver == 2) {
		/*
		 * TODO: Add code here to remap and initialize
		 * IOEX_MST_HPD_OUT in the slot created for
		 * IOEX_HDMI_POWER_EN_DB and IOEX_HDMI_CONN_HPD_3V3_DB
		 * in the slot created for IOEX_USB_C1_PPC_ILIM_3A_EN.
		 */
