...
static hid_handle_t ish_hid_handle;
...
int ish_hid_initialize(const hid_handle_t handle)
{
	uint32_t i;
	ish_hid_handle = handle;
...
int ish_hid_get_hid_descriptor(const hid_handle_t handle,
...
int ish_hid_get_report_descriptor(const hid_handle_t handle,
				uint8_t *buf, const size_t buf_size)
{
...
int ish_hid_get_feature_report(const hid_handle_t handle,
...
int ish_hid_set_feature_report(const hid_handle_t handle,
				const uint8_t report_id,
				const uint8_t *data,
...
int ish_hid_get_input_report(const hid_handle_t handle,
				const uint8_t report_id,
				uint8_t *buf,
				const size_t buf_size)
{
