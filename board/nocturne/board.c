 ...
 * over 52 C (325 K), and stop throttling once it cools back down.
 */
#define DRAM_THROTTLE_TEMP_K	325
...
static void board_pmic_init(void)
{
	...
	i2c_write8(I2C_PORT_PMIC, I2C_ADDR_BD99992, 0x3E, 0xD0);
}
...
static void board_throttle_ap(void)
{
	...
	if (enable_throttle != throttle_ap) {
		...
		chipset_throttle_cpu(enable_throttle);
	}
}
