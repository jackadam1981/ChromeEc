...
static void imvp8_tune_deferred(void)
{
	...
	if (i2c_write16__7b(I2C_PORT_POWER, I2C_ADDR_MP2949__7b, 0xFA, 0x0AC5))
...
void board_hibernate(void)
{
	...
	i2c_write8__7b(I2C_PORT_PMIC, I2C_ADDR_BD99992__7b, 0x49, 0x1);
...
static void board_pmic_disable_slp_s0_vr_decay(void)
{
	 ...
	 */
	i2c_write8__7b(I2C_PORT_PMIC, I2C_ADDR_BD99992__7b, 0x30, 0x3a);
	 ...
	 * Bits 1:0 (10) - VR set to AUTO operating mode
	 */
	i2c_write8__7b(I2C_PORT_PMIC, I2C_ADDR_BD99992__7b, 0x34, 0x2a);
	 ...
	 * Bits 1:0 (10) - VR set to AUTO operating mode
	 */
	i2c_write8__7b(I2C_PORT_PMIC, I2C_ADDR_BD99992__7b, 0x38, 0x2a);
}
...
static void board_pmic_enable_slp_s0_vr_decay(void)
{
	 ...
	 * Bits 1:0 (10)  - VR set to AUTO operating mode
	 */
	i2c_write8__7b(I2C_PORT_PMIC, I2C_ADDR_BD99992__7b, 0x30, 0x7a);
	 ...
	 * Bits 1:0 (10) - VR set to AUTO operating mode
	 */
	i2c_write8__7b(I2C_PORT_PMIC, I2C_ADDR_BD99992__7b, 0x34, 0x6a);
	 ...
	 * Bits 1:0 (10) - VR set to AUTO operating mode
	 */
	i2c_write8__7b(I2C_PORT_PMIC, I2C_ADDR_BD99992__7b, 0x37, 0x5a);
	 ...
	 * Bits 1:0 (10) - VR set to AUTO operating mode
	 */
	i2c_write8__7b(I2C_PORT_PMIC, I2C_ADDR_BD99992__7b, 0x38, 0x6a);
}
...
static void board_pmic_init(void)
{
	...
	if (i2c_read8__7b(I2C_PORT_PMIC, I2C_ADDR_BD99992__7b, 0x18, &pgmask1))
		return;
	pgmask1 |= BIT(2);
	i2c_write8__7b(I2C_PORT_PMIC, I2C_ADDR_BD99992__7b, 0x18, pgmask1);

	board_pmic_disable_slp_s0_vr_decay();

	/* Enable active discharge (100 ohms) on V33A_PCH and V1.8A. */
	i2c_write8__7b(I2C_PORT_PMIC, I2C_ADDR_BD99992__7b, 0x3D, 0x5);
}
...
static void board_report_pmic_fault(const char *str)
{
	...
	if (i2c_read8__7b(I2C_PORT_PMIC, I2C_ADDR_BD99992__7b, 0x8, &vrfault)
	    != EC_SUCCESS)
		return;
	...
	/* PWRSTAT1 */
	i2c_read8__7b(I2C_PORT_PMIC, I2C_ADDR_BD99992__7b, 0x16, &pwrstat1);

	/* PWRSTAT2 */
	i2c_read8__7b(I2C_PORT_PMIC, I2C_ADDR_BD99992__7b, 0x17, &pwrstat2);
	...
	i2c_write8__7b(I2C_PORT_PMIC, I2C_ADDR_BD99992__7b, 0x8, BIT(4));
	i2c_write8__7b(I2C_PORT_PMIC, I2C_ADDR_BD99992__7b, 0x16, pwrstat1);
	i2c_write8__7b(I2C_PORT_PMIC, I2C_ADDR_BD99992__7b, 0x17, pwrstat2);
