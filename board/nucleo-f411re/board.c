...
static void board_init(void)
{
	...
	gpio_enable_interrupt(GPIO_ICM40608_INT1_L);
...
static struct icm_drv_data_t g_icm40608_data;

struct motion_sensor_t motion_sensors[] = {
	[BASE_ACCEL] = {
	 .name = "Base Accel",
	 .active_mask = SENSOR_ACTIVE_S0_S3,
	 .chip = MOTIONSENSE_CHIP_ICM40608,
	 .type = MOTIONSENSE_TYPE_ACCEL,
	 .location = MOTIONSENSE_LOC_BASE,
	 .drv = &icm40608_drv,
	 .mutex = &g_base_mutex,
	 .drv_data = &g_icm40608_data,
	 .port = I2C_PORT_ACCEL,
