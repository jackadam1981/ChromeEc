...
/* coral_it8320 board-specific configuration */
...
const struct adc_t adc_channels[] = {
	...
	/* TODO: Please check ADC channel for sku is correct */
	{"BRD_SKU_1",   3000, 1024, 0, 6}, /* GPI6 */
	{"BRD_SKU_0",   3000, 1024, 0, 7}, /* GPI7 */
};
 ...
 */
/* TODO: not check pwm channel yet. */
const struct pwm_t pwm_channels[] = {
	{7, PWM_CONFIG_DSLEEP, 100, PWM_PRESCALER_C4},
};
