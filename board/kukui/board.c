...
#define NT50358A_I2C_ADDR_FLAGS 0x3e
...
static void board_rev_init(void)
{
	...
	if (IS_ENABLED(BOARD_KRANE) && board_get_version() >= 4) {
		...
		i2c_read16(I2C_PORT_LCD_POWER, NT50358A_I2C_ADDR_FLAGS,
				NT50358A_REG_AVDD_AVEE, &data);
		if (data != NT50358A_OUTPUT_5800_MV) {
			i2c_write16(I2C_PORT_LCD_POWER, NT50358A_I2C_ADDR_FLAGS,
					NT50358A_REG_AVDD_AVEE,
					NT50358A_OUTPUT_5800_MV);
			i2c_write8(I2C_PORT_LCD_POWER, NT50358A_I2C_ADDR_FLAGS,
