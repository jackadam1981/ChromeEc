...
#define CONFIG_DBG
#define CONFIG_DBG_SETUP() STM32_DBGMCU_CR |= STM32_DBGMCU_CR_MASK_EZDEBUG
#define CONFIG_DBG_STALL_WATCHDOG() STM32_DBGMCU_APB4FZ |= STM32_DBGMCU_APB4FZ_WDGLSCD
#define CONFIG_DBG_STALL_WATCHDOG_HELP() STM32_DBGMCU_APB2FZ |= STM32_DBGMCU_APB2FZ_TIM16
