...
#if defined(BOARD_ZED) || defined(BOARD_STAR) || defined(BOARD_GELATIN) || defined(BOARD_EEL) || defined(BOARD_DUCK)
#if defined(SECTION_IS_RW) && !defined(CONFIG_USB_HID_KEYBOARD_VIVALDI)
#error CONFIG_USB_HID_KEYBOARD_VIVALDI must be defined in RW if board_vivaldi_keybd_config is used.
#endif
#endif
