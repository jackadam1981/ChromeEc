...
static void blaze_led_set_power(void)
{
	 ...
	 * Blinking: when the computer is in Standby, sequence of 1 second one,
...
static void blaze_led_set_battery(void)
{
	 ...
	 * Sequence of Blink is 1 second On, 1 second Off.
	 * Blinking white quickly: When the primary or secondary battery is not
	 * communicating with EC, EC will blink the white LED at the sequence
