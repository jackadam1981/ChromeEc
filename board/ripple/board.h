...
/* USB ID. TODO: This is Hammer's. Find one for Ripple. */
#define CONFIG_USB_PID 0x5022

#ifdef SECTION_IS_RW

/* For RGB matrix control */

#define CONFIG_RGB_MATRIX
#define GPIO_RGB_MATRIX_SDB_L	GPIO_SDB_L
#define GPIO_RGB_MATRIX_POWER	GPIO_L_POWER
