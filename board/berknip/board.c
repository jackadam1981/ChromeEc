...
__maybe_unused static const struct ec_thermal_config thermal_thermistor_soc = THERMAL_THERMISTOR_SOC;
...
__maybe_unused static const struct ec_thermal_config thermal_thermistor_charger = THERMAL_THERMISTOR_CHARGER;
...
__maybe_unused static const struct ec_thermal_config thermal_thermistor_5v = THERMAL_THERMISTOR_5V;
