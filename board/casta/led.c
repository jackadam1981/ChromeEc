...
void led_set_color_battery(enum ec_led_colors color)
{
	...
	case EC_LED_COLOR_GREEN:
		gpio_set_level(GPIO_LED_3_L, LED_OFF_LVL); /*red*/
		gpio_set_level(GPIO_BAT_LED_ORANGE_L, LED_ON_LVL); /*red*/
		gpio_set_level(GPIO_BAT_LED_BLUE_L, LED_OFF_LVL); /*red*/
		break;
	case EC_LED_COLOR_RED:
		gpio_set_level(GPIO_LED_3_L, LED_ON_LVL); /*red*/
		gpio_set_level(GPIO_BAT_LED_ORANGE_L, LED_OFF_LVL); /*red*/
		gpio_set_level(GPIO_BAT_LED_BLUE_L, LED_OFF_LVL); /*red*/
		break;
	default: /* LED_OFF and other unsupported colors */
		gpio_set_level(GPIO_LED_3_L, LED_OFF_LVL); /*red*/
		gpio_set_level(GPIO_BAT_LED_ORANGE_L, LED_ON_LVL); /*green*/
		gpio_set_level(GPIO_BAT_LED_BLUE_L, LED_OFF_LVL); /*blue*/
		break;
	}
}
