...
struct ppc_config_t ppc_chips[] = {
	...
	[USBC_PORT_C1] = {
		...
		.i2c_addr_flags = NX20P3483_ADDR0_FLAGS,
		.drv = &nx20p348x_drv,
	},
	[USBC_PORT_C2] = {
...
struct ioexpander_config_t ioex_config[] = {
	...
	[IOEX_C2_NCT38XX] = {
		...
		.i2c_slave_addr = NCT38XX_I2C_ADDR2_1_FLAGS,
		.drv = &nct38xx_ioexpander_drv,
	},
};
...
__override void bb_retimer_power_handle(const struct usb_mux *me, int on_off)
{
	 ...
	 * we only need to sequence reset.
	 */
...
{
	/*
	 * TODO: figure out correct timing
	 */

	gpio_set_level(GPIO_USB_C0_C2_TCPC_RST_L, 0);
	...
	gpio_set_level(GPIO_USB_C0_C2_TCPC_RST_L, 1);
