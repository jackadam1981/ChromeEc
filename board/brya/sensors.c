...
const struct temp_sensor_t temp_sensors[] = {
	...
	[TEMP_SENSOR_3_inductor] = {
		.name = "Charger",
		.type = TEMP_SENSOR_TYPE_BOARD,
		.read = get_temp_3v3_30k9_47k_4050b,
		.idx = ADC_TEMP_SENSOR_3_inductor
	},
	[TEMP_SENSOR_4_5G_area] = {
		.name = "Charger",
		.type = TEMP_SENSOR_TYPE_BOARD,
		.read = get_temp_3v3_30k9_47k_4050b,
		.idx = ADC_TEMP_SENSOR_4_5G_area
	},
};
...
static const struct ec_thermal_config thermal_3 = {
	.temp_host = {
		[EC_TEMP_THRESH_HIGH] = C_TO_K(75),
		[EC_TEMP_THRESH_HALT] = C_TO_K(80),
	},
...
static const struct ec_thermal_config thermal_4 = {
	.temp_host = {
		[EC_TEMP_THRESH_HIGH] = C_TO_K(75),
		[EC_TEMP_THRESH_HALT] = C_TO_K(80),
	},
...
struct ec_thermal_config thermal_params[] = {
	...
	[TEMP_SENSOR_3_inductor] = thermal_3,
	[TEMP_SENSOR_4_5G_area]	= thermal_4,
};
