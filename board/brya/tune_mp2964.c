...
#define _MP2964_STORE_USER_ALL		0x15
#define _MP2964_RESTORE_USER_ALL		0x16
#define _MP2964_MFR_VOUT_TRIM		0x22
#define MP2964_MFR_ALT_SET		0x3f
#define xxxMP2949_STATUS_CML		0x7e

#define xxxMP2949_PRODUCT_REV_DATA		0xc0
#define MP2964_PRODUCT_DATA_CODE	0x93	/* was MP2949_PRODUCT_REV_DATA */
#define _MP2949_CODE_REV_PROTOCOL_RB_RA	0xc1
#define _MP2949_MINOFF_BLANK_TIME	0xce

#define _MP2949_MFR_SLOPE_CNT_1P		0xdb
#define _MP2949_MFR_TRIM_2_1_DCM		0xde

#define _MP2949_MFR_FS_VBOOT		0xe5
#define _MP2949_VFB_TRIM_DCLL		0xe7
#define _MP2949_MFR_OCP_SET_LEVEL	0xee
#define _MP2949_OC_LIMIT_ICC_MAX		0xef
...
#if 0
static int mp2964_read8(uint8_t reg, uint8_t *value)
{
	uint8_t buf[2] = { reg };
	int status;
