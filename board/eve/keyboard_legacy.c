 ...
 */
#define MK_PRNSCR	0xf000
#define MK_PAUSE	0xf001
#define MK_BREAK	0xf002
...
static const struct makecode_translate_entry legacy_fn_mapping[] = {
	...
	{{0x003e, 0x000c}, {MK_PRNSCR, MK_PRNSCR}},  /* F4 => Print Screen */
	...
	{{0x0030, 0x0032}, {MK_BREAK, MK_BREAK}},  /* B => Break */
...
static const char break_key_scancode_set1[] = {
	0xe0, 0x46, 0xe0, 0xc6
};

static const char break_key_scancode_set2[] = {
	0xe0, 0x7e, 0xe0, 0xf0, 0x7e
};

static const char prnscr_key_scancode_set1_make[] = {
	0xe0, 0x2a, 0xe0, 0x37
};

static const char prnscr_key_scancode_set1_break[] = {
	0xe0, 0xb7, 0xe0, 0xaa
};

static const char prnscr_key_scancode_set2_make[] = {
	0xe0, 0x12, 0xe0, 0x7c
};

static const char prnscr_key_scancode_set2_break[] = {
...
static const struct mk_data mk_prnscr = {
	{ARRAY_SIZE(prnscr_key_scancode_set1_make),
	 ARRAY_BEGIN(prnscr_key_scancode_set1_make)},
	{ARRAY_SIZE(prnscr_key_scancode_set2_make),
	 ARRAY_BEGIN(prnscr_key_scancode_set2_make)},
	{ARRAY_SIZE(prnscr_key_scancode_set1_break),
	 ARRAY_BEGIN(prnscr_key_scancode_set1_break)},
	{ARRAY_SIZE(prnscr_key_scancode_set2_break),
	 ARRAY_BEGIN(prnscr_key_scancode_set2_break)},
};
...
static const const struct mk_data mk_break = {
				  ...
				  enum scancode_set_list code_set)
{
	...
	case MK_BREAK:
		process_mk(&mk_break, pressed, code_set);
		return 0;

	case MK_PRNSCR:
		process_mk(&mk_prnscr, pressed, code_set);
		return 0;
