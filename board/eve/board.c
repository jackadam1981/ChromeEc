...
__override enum pd_dual_role_states pd_get_drp_state_suspend(void)
{
	/*
...
static void board_extpower(void)
{
	...
	if (state == POWER_S3 || state == POWER_S0S3 || state == POWER_S5S3) {
		drp_state = pd_get_drp_state_suspend();
