...
/* MCHP DEBUG this command causing I2C issue on PS8751 PD chip */
#define CONFIG_USB_PD_TCPC_LOW_POWER
/* MCHP DEBUG get more messages from common/usb_pd_protocol.c */
/* #define CONFIG_USB_PD_DEBUG_LEVEL 2 */
#define CONFIG_USB_PD_TCPC_FW_VERSION /* Reef and variants only */
...
/* EC Debug */
/* #define CONFIG_CHIPSET_DEBUG Chip level enables JTAG */
/*
 * The following chipset debug items require CONFIG_CHIPSET_DEBUG
 * to be enabled.
 */
/* #define CONFIG_CHIPSET_DEBUG_NO_RESET */
/* #define CONFIG_CHIPSET_DEBUG_NO_WDTRST */

/* #define CONFIG_BRINGUP */
/* #define CONFIG_DEBUG_BRINGUP */
/* #define CONFIG_DEBUG_DISABLE_WRITE_BUFFER */

/* #define CONFIG_MCHP_TFDP  enable MCHP Trace FIFO */
...
#define CONFIG_BOARD_SYS_PRE_INIT
...
/*
 * MCHP from firmware-reef-9042.B using TASK_ALS
 */
#if 0
/* Light sensors */
enum als_id {
...
#ifdef CONFIG_CHIP_I2C_HELPER
void board_i2c_helper_init(void);
#endif
