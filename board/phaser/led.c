...
const struct led_descriptor
	...
	[PWR_LED_STATE_S0]           = {{EC_LED_COLOR_WHITE, LED_INDEFINITE} },
	[PWR_LED_STATE_S3_CHARGE]    = {{EC_LED_COLOR_WHITE, 3 * LED_ONE_SEC},
					{LED_OFF,	   0.5 * LED_ONE_SEC} },
	[PWR_LED_STATE_S3_DISCHARGE] = {{LED_OFF, LED_INDEFINITE} },
	[PWR_LED_STATE_S5]           = {{LED_OFF, LED_INDEFINITE} },
};
