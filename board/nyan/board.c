...
const struct gpio_info gpio_list[] = {
	...
	/*
	 * There are no EN_PP1350, EN_PP3300, EN_PP5000 in nyan.
	 * Assign them to a unused pin PA8.
	 */
	{"EN_PP1350",   GPIO_A, (1<<8),  GPIO_OUT_LOW, NULL},
	{"EN_PP3300",   GPIO_A, (1<<8),  GPIO_OUT_LOW, NULL},
	{"EN_PP5000",   GPIO_A, (1<<8),  GPIO_OUT_LOW, NULL},
...
int pmu_shutdown(void)
{
	...
	panic_puts("No pmu shutdown supported !!!\n");
