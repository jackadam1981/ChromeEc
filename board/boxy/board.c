...
int board_set_active_charge_port(int port)
{
	...
	case CHARGE_PORT_TYPEC1:
		ppc_vbus_sink_enable(USBC_PORT_C1, 1);
		break;
	default:
		return EC_ERROR_INVAL;
	}
...
static void board_charge_manager_init(void)
{
	...
	typec_set_input_current_limit(CHARGE_PORT_TYPEC0, 3000, 5000);
	typec_set_input_current_limit(CHARGE_PORT_TYPEC1, 3000, 5000);
}
