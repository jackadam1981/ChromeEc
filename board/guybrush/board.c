...
__override enum ec_error_list board_a1_ps8811_retimer_setup(void)
{
	/* Set channel A output swing */
	RETURN_ERROR(i2c_field_update8(
		I2C_PORT_TCPC1, PS8811_I2C_ADDR_FLAGS3 + PS8811_REG_PAGE1,
		PS8811_REG1_USB_CHAN_A_SWING, PS8811_CHAN_A_SWING_MASK,
	...
	RETURN_ERROR(i2c_field_update8(
		I2C_PORT_TCPC1, PS8811_I2C_ADDR_FLAGS3 + PS8811_REG_PAGE1,
		PS8811_REG1_USB_CHAN_A_SWING, PS8811_CHAN_A_SWING_MASK,
		0x2 << PS8811_CHAN_B_SWING_SHIFT));

	/* Set channel B de-emphasis to -6dB and pre-shoot to 3 dB */
	RETURN_ERROR(i2c_field_update8(
		I2C_PORT_TCPC1, PS8811_I2C_ADDR_FLAGS3 + PS8811_REG_PAGE1,
		PS8811_REG1_USB_CHAN_B_DE_PS_LSB, PS8811_CHAN_B_DE_PS_LSB_MASK,
		PS8811_CHAN_B_DE_6_PS_3_LSB));

	RETURN_ERROR(i2c_field_update8(
		I2C_PORT_TCPC1, PS8811_I2C_ADDR_FLAGS3 + PS8811_REG_PAGE1,
		PS8811_REG1_USB_CHAN_B_DE_PS_MSB, PS8811_CHAN_B_DE_PS_MSB_MASK,
		PS8811_CHAN_B_DE_6_PS_3_MSB));
