...
#define CONFIG_SCREENLOCK_BUTTONS
...
#define SCALER_SCREEN_LOCK 0x10	// ??
...
#define GPIO_SCREEN_LOCK_L GPIO_SCREENLOCK_BTN_ODL
...
extern void disp_mode_interrupt(enum gpio_signal signal);
