...
const struct i2c_port_t i2c_ports[] = {
	{
		/* I2C1 */
		.name = "tcpc0",
		.port = I2C_PORT_USB_C0_TCPC, //raymondchung: ???done
		.kbps = 1000,
	...
	},
	{
		/* I2C2 */
		.name = "ppc0",
		.port = I2C_PORT_USB_C0_PPC, //raymondchung: ???done
		.kbps = 1000,
	...
	},
	{
		/* I2C3 */
		.name = "ppc1",
		.port = I2C_PORT_USB_C1_PPC, //raymondchung: ???done
		.kbps = 1000,
	...
	},
	{
		/* I2C5 */
		.name = "scalar",
		.port = I2C_PORT_DP_REDRIVER, //raymondchung: ???done
		.kbps = 400,
	...
	{
		/* I2C6 */
		.name = "usb-a_mix0,1", //raymondchung: ???done
		.port = I2C_PORT_USB_A0_A1_MIX, //raymondchung: ???done
		.kbps = 1000,
