...
#define SCALER_NAV_KEY_DATA 0x0381
...
static void nav_key_event(void) //for Navi key  //raymondchung: ???done
{
	...
	if (i2c_read16(I2C_PORT_SCALER, I2C_ADDR_SCALER_FLAGS, SCALER_NAV_KEY_DATA,
		      &val) == EC_SUCCESS)
	{
...
#if 1 //for Nav key using CONFIG_KEYBOARD_PROTOCOL_8042
static void simulate_key(enum keyboard_button_type key_) //for Navi key  //raymondchung: ???done
{
