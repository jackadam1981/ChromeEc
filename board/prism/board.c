...
const uint8_t rgbkbd_map[] = {
	...
	RGBKBD_COORD(1, 1), RGBKBD_COORD(1, 2),
	RGBKBD_DELM,				/* 2: ! */
	RGBKBD_COORD(2, 1), RGBKBD_COORD(2, 2),
	RGBKBD_DELM,				/* 3: @ */
	RGBKBD_COORD(3, 1), RGBKBD_COORD(3, 2),
	RGBKBD_DELM,				/* 4: # */
	RGBKBD_COORD(4, 1), RGBKBD_COORD(4, 2),
	RGBKBD_DELM,				/* 5: $ */
	RGBKBD_COORD(5, 1), RGBKBD_COORD(5, 2),
	RGBKBD_DELM,				/* 6: ^ */
	RGBKBD_COORD(6, 1), RGBKBD_COORD(6, 2),
	RGBKBD_DELM,				/* 7: ^ */
	RGBKBD_COORD(7, 1), RGBKBD_COORD(7, 2),
	RGBKBD_DELM,				/* 8: & */
	RGBKBD_COORD(8, 1), RGBKBD_COORD(8, 2),
	RGBKBD_DELM,				/* 9: * */
	RGBKBD_COORD(9, 1), RGBKBD_COORD(9, 2),
	RGBKBD_DELM,				/* 10: ( */
	RGBKBD_COORD(10, 1), RGBKBD_COORD(10, 2),
	RGBKBD_DELM,				/* 11: ) */
	RGBKBD_COORD(11, 1), RGBKBD_COORD(11, 2),
	RGBKBD_DELM,				/* 12: _ */
	RGBKBD_COORD(12, 1), RGBKBD_COORD(12, 2),
	RGBKBD_DELM,				/* 13: + */
	RGBKBD_DELM,				/* 14: (null) */
	RGBKBD_COORD(13, 1), RGBKBD_COORD(13, 2),
	RGBKBD_DELM,				/* 15: backspace */
	...
	RGBKBD_COORD(11, 3), RGBKBD_COORD(12, 3),
	RGBKBD_DELM,				/* 27: [ */
	RGBKBD_COORD(13, 3), RGBKBD_COORD(14, 3),
	RGBKBD_DELM,				/* 28: ] */
	RGBKBD_COORD(15, 3), RGBKBD_COORD(16, 3),
	RGBKBD_DELM,				/* 29: \ */
	RGBKBD_COORD(0, 4), RGBKBD_COORD(1, 4),
	RGBKBD_DELM,				/* 30: caps lock */
	...
	RGBKBD_COORD(11, 4), RGBKBD_COORD(12, 4),
	RGBKBD_DELM,				/* 40: ; */
	RGBKBD_COORD(13, 4), RGBKBD_COORD(14, 4),
	RGBKBD_DELM,				/* 41: " */
	RGBKBD_DELM,				/* 42: (null) */
	RGBKBD_COORD(15, 4), RGBKBD_COORD(16, 4),
	RGBKBD_DELM,				/* 43: enter */
	...
	RGBKBD_COORD(10, 5), RGBKBD_COORD(11, 5),
	RGBKBD_DELM,				/* 53: , */
	RGBKBD_COORD(12, 5), RGBKBD_COORD(13, 5),
	RGBKBD_DELM,				/* 54: . */
	RGBKBD_COORD(14, 5), RGBKBD_COORD(15, 5),
	RGBKBD_DELM,				/* 55: / */
	RGBKBD_DELM,				/* 56: (null) */
