...
static struct tcs3400_rgb_drv_data_t g_tcs3400_rgb_data = {
	.calibration.rgb_cal[X] = {
		.offset = 0,
		.coeff[TCS_RED_COEFF_IDX] = FLOAT_TO_FP(-1.2100923),
		.coeff[TCS_GREEN_COEFF_IDX] = FLOAT_TO_FP(0.40323421),
		.coeff[TCS_BLUE_COEFF_IDX] = FLOAT_TO_FP(-2.485908),
		.coeff[TCS_CLEAR_COEFF_IDX] = FLOAT_TO_FP(1.310945022),
		.scale = {
	...
	.calibration.rgb_cal[Y] = {
		.offset = 0,
		.coeff[TCS_RED_COEFF_IDX] = FLOAT_TO_FP(-1.0896991),
		.coeff[TCS_GREEN_COEFF_IDX] = FLOAT_TO_FP(0.00972503),
		.coeff[TCS_BLUE_COEFF_IDX] = FLOAT_TO_FP(-1.7251772),
		.coeff[TCS_CLEAR_COEFF_IDX] = FLOAT_TO_FP(1.161435179),
		.scale = {
	...
	.calibration.rgb_cal[Z] = {
		.offset = 0,
		.coeff[TCS_RED_COEFF_IDX] = FLOAT_TO_FP(0.12738021),
		.coeff[TCS_GREEN_COEFF_IDX] = FLOAT_TO_FP(0.77439236),
		.coeff[TCS_BLUE_COEFF_IDX] = FLOAT_TO_FP(-0.0197716),
		.coeff[TCS_CLEAR_COEFF_IDX] = FLOAT_TO_FP(-0.16235986),
		.scale = {
