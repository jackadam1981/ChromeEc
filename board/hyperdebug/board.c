...
const char *spi_device_names[ARRAY_SIZE(spi_devices)] = { "SPI2", "QSPI" };
 ...
 */
static int octospi_indirect_read(const uint8_t *txdata, int txlen,
...
DECLARE_CONSOLE_COMMAND_FLAGS(spisetspeed, command_spi_set_speed,
			      "name bits_per_second", "Get SPI configuration",
			      CMD_FLAG_RESTRICTED);
