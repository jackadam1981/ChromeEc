...
/* Enable USART1,2,4 and USB streams */
...
/* The UART console is on ... */
#undef CONFIG_UART_CONSOLE
#define CONFIG_UART_CONSOLE 3
#undef CONFIG_UART_TX_DMA
#undef CONFIG_UART_RX_DMA
#define CONFIG_UART_TX_DMA_CH STM32_DMAC_CH1
#define CONFIG_UART_RX_DMA_CH STM32_DMAC_CH2
...
#define USB_IFACE_USART1_STREAM	4
#define USB_IFACE_USART2_STREAM	5
#define USB_IFACE_USART3_STREAM	6
#define USB_IFACE_USART4_STREAM	7
#define USB_IFACE_USART5_STREAM	8
#define USB_IFACE_USART9_STREAM	9
#define USB_IFACE_COUNT		10
...
#define USB_EP_SPI		3
#define USB_EP_I2C		4
#define USB_EP_USART1_STREAM	5
#define USB_EP_USART2_STREAM	6
#define USB_EP_USART3_STREAM	7
#define USB_EP_USART4_STREAM	8
#define USB_EP_USART5_STREAM	9
#define USB_EP_USART9_STREAM	10
#define USB_EP_COUNT		11
