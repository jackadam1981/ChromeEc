...
#ifdef CONFIG_DDR5
/* Soc side Retimers for P0 & P1 */
#define I2C_PORT0_BB_RETIMER2_ADDR      0x54
#define I2C_PORT1_BB_RETIMER2_ADDR      0x55
#define CONFIG_TCPC_P0_BBRETIMER_MAX_COUNT 2
#define CONFIG_TCPC_P1_BBRETIMER_MAX_COUNT 2
#define RETIMER_1 0
#define RETIMER_2 1
#endif

#ifdef CONFIG_LP4
#define CONFIG_TCPC_P0_BBRETIMER_MAX_COUNT 1
#define CONFIG_TCPC_P1_BBRETIMER_MAX_COUNT 1
#define RETIMER_1 0
#endif
