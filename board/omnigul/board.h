...
#undef LED_CRITICAL_LOW_BATTERY_ON_TIME
#undef LED_CRITICAL_LOW_BATTERY_PERIOD
#undef LED_LOW_BATTERY_ON_TIME
#undef LED_LOW_BATTERY_PERIOD
...
#define LED_CRITICAL_LOW_BATTERY_ON_TIME 5
#define LED_CRITICAL_LOW_BATTERY_PERIOD 10
#define LED_LOW_BATTERY_ON_TIME 5
#define LED_LOW_BATTERY_PERIOD 20
