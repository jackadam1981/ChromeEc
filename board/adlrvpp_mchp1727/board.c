...
/* Intel ADLRVP-MCHP board-specific configuration */
#include "button.h"
#include "fusb302.h"
...
/*
 * this function returns the controller for I2C port
 * return controller per port based on board design
 */
__override int board_i2c_p2c(int port)
{
	switch (port) {
	case MCHP_I2C_PORT0:
		return MCHP_I2C_CTRL0;
	case MCHP_I2C_PORT6:
		return MCHP_I2C_CTRL1;
#if defined(HAS_TASK_PD_C1)
	case MCHP_I2C_PORT3:
		return MCHP_I2C_CTRL2;
#endif
#if defined(HAS_TASK_PD_C2)
	case MCHP_I2C_PORT7:
		return MCHP_I2C_CTRL3;
	case MCHP_I2C_PORT2:
		return MCHP_I2C_CTRL4;
#endif
	default:
		return -1;
	}
