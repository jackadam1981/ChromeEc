...
static struct tcs3400_rgb_drv_data_t g_tcs3400_rgb_data = {
	.calibration.rgb_cal[X] = {
		.offset = 0,
		.coeff[TCS_RED_COEFF_IDX] = FLOAT_TO_FP(-0.12207),
		.coeff[TCS_GREEN_COEFF_IDX] = FLOAT_TO_FP(1.656628),
		.coeff[TCS_BLUE_COEFF_IDX] = FLOAT_TO_FP(-1.80521),
		.coeff[TCS_CLEAR_COEFF_IDX] = FLOAT_TO_FP(0.240447),
		.scale = {
	...
	.calibration.rgb_cal[Y] = {
		.offset = 0,
		.coeff[TCS_RED_COEFF_IDX] = FLOAT_TO_FP(-0.24805),
		.coeff[TCS_GREEN_COEFF_IDX] = FLOAT_TO_FP(0.794508),
		.coeff[TCS_BLUE_COEFF_IDX] = FLOAT_TO_FP(-1.07077),
		.coeff[TCS_CLEAR_COEFF_IDX] = FLOAT_TO_FP(0.349896),
		.scale = {
	...
	.calibration.rgb_cal[Z] = {
		.offset = 0,
		.coeff[TCS_RED_COEFF_IDX] = FLOAT_TO_FP(0.047035),
		.coeff[TCS_GREEN_COEFF_IDX] = FLOAT_TO_FP(2.49125),
		.coeff[TCS_BLUE_COEFF_IDX] = FLOAT_TO_FP(-0.74381),
		.coeff[TCS_CLEAR_COEFF_IDX] = FLOAT_TO_FP(-0.28178),
		.scale = {
