...
const enum ec_led_id supported_led_ids[] = {
	EC_LED_ID_BATTERY_LEFT_LED,
	EC_LED_ID_BATTERY_RIGHT_LED,
	EC_LED_ID_POWER_LED
};
...
static int led_set_color_battery(int port, enum led_color color)
{
	...
	amber_led = (port == RIGHT_PORT ? GPIO_BAT_LED_AMBER_C0 :
				 GPIO_BAT_LED_AMBER_C1);
	white_led = (port == RIGHT_PORT ? GPIO_BAT_LED_WHITE_C0 :
				 GPIO_BAT_LED_WHITE_C1);
...
{
	switch (led_id) {
	case EC_LED_ID_BATTERY_LEFT_LED:
		brightness_range[EC_LED_COLOR_WHITE] = 1;
		brightness_range[EC_LED_COLOR_AMBER] = 1;
		break;
	case EC_LED_ID_BATTERY_RIGHT_LED:
		brightness_range[EC_LED_COLOR_WHITE] = 1;
		brightness_range[EC_LED_COLOR_AMBER] = 1;
		break;
