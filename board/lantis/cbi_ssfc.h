...
/**
 * Get the Audio codec source from SSFC_CONFIG.
 *
 * @return the Audio codec source type.
 */
enum ec_ssfc_audio_codec_source get_audio_codec_source(void);

/**
 * Get the Touchscreen driver source for ELAN from SSFC_CONFIG.
 *
 * @return the Touchscreen driver source type.
 */
enum ec_ts_driver_source get_cbi_ts_driver_source(void);
