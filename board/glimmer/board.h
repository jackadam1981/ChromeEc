...
/* Key scanning in sleep. */
#define USE_LID_ANGLE_TO_DISABLE_KEY_SCAN_IN_SLEEP

/*
 * If USE_LID_ANGLE_TO_DISABLE_KEY_SCAN_IN_SLEEP is defined, then you must
 * define these two macros to be used in sleep to determine state of key
 * scanning based on lid angle. Note that the angle input is bound [-180, 180]
