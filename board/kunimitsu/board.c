...
{
	/*
	 * TODO (crosbug.com/p/44693): Remove the worakaround when the reboot
	 * reboot logic in the harware is fixed.
	 */
...
/*
 * TODO (crosbug.com/p/44821): Do the PMIC initialization after the I2C
