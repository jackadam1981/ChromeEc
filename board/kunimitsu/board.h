...
#define CONFIG_CHARGER_NO_LOW_BAT_OVERWRITE
#define CONFIG_CHARGER_PSYS
#define CONFIG_CHARGER_SENSE_RESISTOR 10
#define CONFIG_CHARGER_SENSE_RESISTOR_AC 20
#define CONFIG_TRICKLE_CHARGING
#undef CHARGER_INITIALIZED_DELAY_MS
#undef CHARGER_INITIALIZED_TRIES
#define CHARGER_INITIALIZED_DELAY_MS 200
#define CHARGER_INITIALIZED_TRIES 20
