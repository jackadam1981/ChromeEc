...
static void event_vdec_core_written(struct consumer const *consumer, size_t count);
...
DECLARE_IPI(IPI_VDEC_LAT, vdec_h264_ipi_handler, 0);
...
DECLARE_IPI(IPI_VDEC_CORE, vdec_h264_ipi_core_handler, 0);
