...
#define read_gpu_temp(a) \
i2c_read32(I2C_PORT_GPU, GPU_ADDR_FLAGS, GPU_TEMPERATURE_OFFSET, &a)
#define init_gpu \
i2c_write32(I2C_PORT_GPU, GPU_ADDR_FLAGS, GPU_INIT_OFFSET, GPU_INIT_WRITE_VALUE)
