 ...
 */
static uint64_t fips_trng32(bool power_up)
{
	uint64_t r;
	/* During power-up only get value once. */
	uint32_t remaining_tries = (power_up) ? 1 : 4;
	enum fips_status error;
...
#define CRYPTO_TEST_CMD_RAND_PERF 1
#endif
