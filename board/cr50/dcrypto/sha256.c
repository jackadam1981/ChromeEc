...
static const uint8_t *SHA256_final_as_hash(union hash_ctx *const ctx)
...
void SHA256_sw_init(struct sha256_ctx *const ctx)
{
	...
	static const uint32_t sha256_init[8] = { 0x6a09e667, 0xbb67ae85,
...
void SHA224_sw_init(struct sha224_ctx *const ctx)
{
	...
	static const uint32_t sha224_init[8] = { 0xc1059ed8, 0x367cd507,
						 0x3070dd17, 0xf70e5939,
						 0xffc00b31, 0x68581511,
						 0x64f98fa7, 0xbefa4fa4 };

	ctx->f = &sha224_vtable;
	memcpy(ctx->state, sha224_init, sizeof(sha224_init));
	ctx->count = 0;
}
			      ...
			      uint8_t digest[SHA224_DIGEST_SIZE])
{
	...
	memcpy(digest, SHA224_sw_final(&ctx), SHA224_DIGEST_SIZE);
	return digest;
}
/* One shot hash computation */
			      ...
			      uint8_t digest[SHA256_DIGEST_SIZE])
{
	...
	memcpy(digest, SHA256_sw_final(&ctx), SHA256_DIGEST_SIZE);
	return digest;
}
