...
/*
 * Functions that should be called at INT_AP_L assertion or deassertion.
 * [0] : function to call at deassertion
 * [1] : function to call at assertion
 */
static void (*pre_int_ap_func_[2])(void);
...
{
	if (pre_int_ap_func_[do_assert])
		pre_int_ap_func_[do_assert]();
			     ...
			     void (*int_ap_deassert_func)(void))
{
	...
	pre_int_ap_func_[0] = int_ap_deassert_func;
	pre_int_ap_func_[1] = int_ap_assert_func;
