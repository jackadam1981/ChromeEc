...
# When USE_PROD_RMA_KEY is a non-empty string, include the prod RMA server
# public key in the image.
ifneq ($(USE_PROD_RMA_KEY),)
# Make sure prod RMA server public key is compiled in.
CFLAGS += -DUSE_PROD_RMA_KEY
endif
