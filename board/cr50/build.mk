...
$(out)/RW/%.fips.checksum.dump: $(out)/RW/%.elf $(out)/RW/%.flat.prefips
	./util/inject_fips_fingerprint.sh $(OBJCOPY) $^

# Add dependencies to inject the checksum
$(out)/RW/ec.RW_B.flat: $(out)/RW/ec.RW_B.fips.checksum.dump
$(out)/RW/ec.RW.flat: $(out)/RW/ec.RW.fips.checksum.dump
