...
/*
 * Stores the whether a successful physical presence challenge
 * has been met by having the battery removed for a long time.
 * This is only used when the board options specify BOARD_WP_DISABLE_DELAY
 */
#define BOARD_FORCE_PHYS_PRESENCE    (1 << 18)
