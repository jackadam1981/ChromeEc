 ...
 * skipped
 */
static void board_set_fips_policy_test(int asserted)
{
...
static void fips_power_on(void)
{
	...
	if (_fips_status & FIPS_ERROR_MASK)
		ccprints("FIPS error 0x%08x\n", _fips_status);
	else {
		board_set_fips_policy_test(1);
