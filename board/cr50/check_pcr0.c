...
#define CHECK_PCR_NOT_INITIALIZED		BIT(1)
#define CHECK_PCR_FWMP_BLOCK_DEV_NO_ECRST	BIT(2)
#define CHECK_PCR_FWMP_BLOCK_DEV_RST_EC		BIT(3)
...
{
	static int checked_fwmp_ecrst = CHECK_PCR_NOT_INITIALIZED;
	struct board_id id;
	int i;
	...
	if (checked_fwmp_ecrst != CHECK_PCR_NOT_INITIALIZED)
		return checked_fwmp_ecrst == CHECK_PCR_FWMP_BLOCK_DEV_RST_EC;
