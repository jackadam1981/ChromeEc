...
/*
 * Uncomment the #define below to enable fallback certificate installation
 * capability.
 *
...
#else /* below for the case `not CR50_INCLUDE_FALLBACK_CERT` */
...
#endif /* above for the case `not CR50_INCLUDE_FALLBACK_CERT` */
...
#else /* below for the case `CR50_INCLUDE_FALLBACK_CERT` */
