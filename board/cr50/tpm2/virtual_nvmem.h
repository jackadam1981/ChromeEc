 ...
 *
 * These offsets correspond to the start of the NV_INDEX structure, and start
 * of the actual NV data respectively. These offsets are a product of by the
 * TPM library's NVRAM implementation. More details of this implementation,
 * and these offsets, see comment at the top of virtual_nvmem.c.
 */
