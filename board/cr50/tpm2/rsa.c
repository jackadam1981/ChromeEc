...
const TPM2B_PUBLIC_KEY_RSA RSA_768_N = {
	.t = {96, {
...
const TPM2B_PUBLIC_KEY_RSA RSA_768_D = {
	.t = {96, {
...
const TPM2B_PUBLIC_KEY_RSA RSA_2048_N = {
	.t = {256, {
...
const TPM2B_PUBLIC_KEY_RSA RSA_2048_D = {
	.t  = {256, {
...
const RSA_KEY RSA_768 = {
	65537, (TPM2B *) &RSA_768_N.b, (TPM2B *) &RSA_768_D.b
};
const RSA_KEY RSA_2048 = {
	65537, (TPM2B *) &RSA_2048_N.b, (TPM2B *) &RSA_2048_D.b
};

#define MAX_MSG_BYTES (RSA_MAX_BYTES - 2 - 2 * SHA1_DIGEST_BYTES)
				...
				size_t *response_size)
{
	...
	case TEST_RSA_ENCRYPT:
		if (_cpri__EncryptRSA(
				(uint32_t *) response_size, out, key,
