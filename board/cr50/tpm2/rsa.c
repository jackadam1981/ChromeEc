 ...
 */
static const uint8_t TPM2_RSA_EK_NAME_TEMPLATE[2 + SHA256_DIGEST_SIZE] = {
 ...
 */
static const uint8_t TPM2_RSA_EK_NAME_CR50[SHA256_DIGEST_SIZE] = {
...
BUILD_ASSERT(SHA256_DIGEST_SIZE == 32);
