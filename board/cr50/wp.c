				    ...
				    size_t *response_size)
{
	...
	*response_size = 0;
	...
	if (board_fwmp_force_wp_en()) {
		 ...
		 * gsctool versions. These flags show WP is enabled at boot which
		 * is essentially what the FWMP override does.
		 */
