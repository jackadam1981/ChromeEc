...
enum fips_status {
	...
	FIPS_FATAL_TRNG = 1 << 1,
	FIPS_FATAL_SHA256 = 1 << 2,
	FIPS_FATAL_HMAC_SHA256 = 1 << 3,
	FIPS_FATAL_HMAC_DRBG = 1 << 4,
	FIPS_FATAL_ECDSA = 1 << 5,
	FIPS_FATAL_RSA2048 = 1 << 6,
	FIPS_FATAL_AES128 = 1 << 7,
	FIPS_FATAL_AES256 = 1 << 8,
