...
void assert_ec_rst(void)
{
	 ...
	 * "power button release" assert it if set earlier to do so.
	 */
	power_button_release_interrupt_enable(0);
...
void deassert_ec_rst(void)
{
	 ...
	 * "power button release" assert it again if set earlier to do so.
	 */
	power_button_release_interrupt_enable(0);
