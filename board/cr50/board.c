...
static void ac_power_state_changed(void)
{
	...
	/*
	 * Wait until the interrupt status register is cleared. Wait a max of
	 * 50 iterations. Experimentally, 15 iterations is usually sufficient.
	 * We don't want to wait here forever.
	 */
