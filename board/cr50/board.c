...
static void detect_state_change(enum device_type device)
{
...
{
	detect_state_change(DEVICE_AP);
	detect_state_change(DEVICE_EC);
	detect_state_change(DEVICE_SERVO_AP);
	detect_state_change(DEVICE_SERVO_EC);
}
