...
static struct board_cfg board_cfg_table[] = {
	...
	{ .strap_cfg = 0x02, .board_properties = BOARD_SLAVE_CONFIG_SPI |
	  BOARD_NEEDS_SYS_RST_PULL_UP },
	/* Poppy: DI0A9 = 1M PU, DIOA1 = 1M PU */
	{ .strap_cfg = 0x0A, .board_properties = BOARD_SLAVE_CONFIG_SPI |
	  BOARD_USE_PLT_RESET },

	/* I2C Variants: DIOA9 = 1M PD, DIOA1 = 1M PD */
	/* Reef/Eve: DIOA12 = 5k PD, DIOA6 = 1M PU */
	{ .strap_cfg = 0x20, .board_properties = BOARD_SLAVE_CONFIG_I2C |
	  BOARD_USE_PLT_RESET },
	/* Rowan: DIOA12 = 5k PD, DIOA6 = 5k PU */
	{ .strap_cfg = 0x30, .board_properties = BOARD_SLAVE_CONFIG_I2C |
	  BOARD_DEEP_SLEEP_DISABLED | BOARD_DETECT_AP_WITH_UART },
	/* Sarien/Arcada: DIOA12 = 1M PD, DIOA6 = 5k PU */
	{ .strap_cfg = 0x70, .board_properties = BOARD_SLAVE_CONFIG_I2C |
	  BOARD_USE_PLT_RESET | BOARD_WP_DISABLE_DELAY |
	  BOARD_SARIEN_CUSTOM_OPTIONS },
