 ...
 */
DECLARE_IRQ_STATIC(GC_IRQNUM_RBOX0_INTR_AC_PRESENT_RED_INT,
	ac_power_state_changed, 1);
DECLARE_IRQ_STATIC(GC_IRQNUM_RBOX0_INTR_AC_PRESENT_FED_INT,
	ac_power_state_changed, 1);
 ...
 */
DECLARE_IRQ_STATIC(GC_IRQNUM_RBOX0_INTR_BUTTON_COMBO0_RDY_INT,
	key_combo0_irq, 0);
