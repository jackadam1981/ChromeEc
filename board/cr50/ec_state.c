...
int ec_is_on(void)
{
	...
	return (state == DEVICE_STATE_DEBOUNCING ||
...
{
	/*
	 * Call the state machine to move us to connected or start debouncing
	 * disconnect.  This is safe because we're already in the hook task.
	 */
	ec_detect();
}
