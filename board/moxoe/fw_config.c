...
static union moxoe_cbi_fw_config fw_config;
BUILD_ASSERT(sizeof(fw_config) == sizeof(uint32_t));

/*
 * FW_CONFIG defaults for moxoe if the CBI.FW_CONFIG data is not
 * initialized.
 */
static const union moxoe_cbi_fw_config fw_config_defaults = {
