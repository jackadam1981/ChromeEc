...
#ifndef __BOARD_MOXOE_FW_CONFIG_H_
#define __BOARD_MOXOE_FW_CONFIG_H_

#include <stdint.h>

/****************************************************************************
 * CBI FW_CONFIG layout for Moxoe board.
 *
 ...
 */
union moxoe_cbi_fw_config get_fw_config(void);
...
#endif /* __BOARD_MOXOE_FW_CONFIG_H_ */
