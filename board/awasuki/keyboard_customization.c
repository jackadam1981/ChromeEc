...
static uint16_t scancode_set2[KEYBOARD_COLS_MAX][KEYBOARD_ROWS] = {
	...
	{ 0xe011, 0x0000, 0x0000, 0x0000, 0x0037, 0x0000, 0x0000, 0x0000 },
	{ 0x0071, 0x0066, 0x000a, 0x005d, 0x005a, 0x003a, 0xe072, 0xe075 },
...
__override struct keyboard_scan_config keyscan_config = {
	...
	.actual_key_mask = { 0x08, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xa1,
			     0xff, 0xff, 0x11, 0xff, 0xff, 0x40, 0x0a, 0x40,
			     0x01, 0xc4 },
};
...
static const struct ec_response_keybd_config awasuki_keybd = {
	...
	.capabilities = KEYBD_CAP_FUNCTION_KEYS | KEYBD_CAP_ASSISTANT_KEY,
};
...
static uint8_t keycap_label[KEYBOARD_COLS_MAX][KEYBOARD_ROWS] = {
	...
	{ '=', '\'', '[', '6', ';', 'x', '7', 'e' },
	{ KLLI_UNKNO, KLLI_F9, KLLI_UNKNO, KLLI_UNKNO, 'l', 'v', '9', 'r' },
