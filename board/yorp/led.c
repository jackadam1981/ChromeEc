 ...
 *
 * Charge and battery LED control for Yorp
 */
...
static const struct led_descriptor led_state_table[][LED_NUM_PHASES] = {
	/* STATE_CHARGING */
	{ {LED_COLOR_AMBER, LED_INDEFINITE}, {LED_OFF, LED_INDEFINITE} },
	/* STATE_CHARGING_FULLY_CHARGED */
	{ {LED_COLOR_BLUE, LED_INDEFINITE}, {LED_OFF, LED_INDEFINITE} },
	/* STATE_DISCHARGE_S0 */
	{ {LED_COLOR_BLUE, LED_INDEFINITE}, {LED_OFF, LED_INDEFINITE} },
	/* STATE_DISCHARGE_S3 */
	{ {LED_COLOR_AMBER, 4 * LED_ONE_SEC},
				{LED_COLOR_AMBER, 1 * LED_ONE_SEC} },
	/* STATE_DISCHARGE_S5 */
