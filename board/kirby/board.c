...
const struct gpio_info gpio_list[] = {
	...
	{"KB_PWR_ON_L",   GPIO_A, (1<<0),  GPIO_IN_INT_BOTH, gaia_power_event},
	{"XPSHOLD",       GPIO_E, (1<<5),  GPIO_IN_INT_RISING,
	 gaia_power_event},
	{"CHARGER_INT_L", GPIO_E, (1<<2),  GPIO_IN_INT_FALLING,
	 NULL /*pmu_irq_handler*/},
	{"USB_CHG_INT",   GPIO_E, (1<<15), GPIO_IN_INT_RISING,
	 NULL /*extpower_interrupt*/},
	{"USBPD_INT_L",   GPIO_E, (1<<1),  GPIO_IN_INT_FALLING,
	 NULL /*extpower_interrupt*/},
	{"LID_OPEN",      GPIO_E, (1<<6),  GPIO_IN_INT_BOTH, lid_interrupt},
	{"SUSPEND_L",     GPIO_E, (1<<3),  GPIO_IN_INT_BOTH,
	 gaia_suspend_event},
	{"SPI1_NSS",      GPIO_A, (1<<4),  GPIO_IN_INT_BOTH | GPIO_PULL_UP,
	 spi_event},
	{"AC_PRESENT",    GPIO_A, (1<<1),  GPIO_IN_INT_BOTH,
	 NULL /*extpower_interrupt*/},
