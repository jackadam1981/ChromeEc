...
{
	gpio_set_level(port ? GPIO_LED_AMBER_C1 : GPIO_LED_AMBER_C0,
...
void led_set_color_power(enum ec_led_colors color)
{
	if (color == EC_LED_COLOR_WHITE)
		gpio_set_level(GPIO_PWR_LED_WHITE_L, BAT_LED_ON);
	else
		/* LED_OFF and unsupported colors */
		gpio_set_level(GPIO_PWR_LED_WHITE_L, BAT_LED_OFF);
}
