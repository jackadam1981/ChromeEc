...
void board_hibernate_late(void)
{
	...
	const uint32_t hibernate_pins[][2] = {
		...
		{GPIO_LED_WHITE_C0, GPIO_INPUT | GPIO_PULL_UP},
		{GPIO_LED_AMBER_C0, GPIO_INPUT | GPIO_PULL_UP},
		{GPIO_LED_WHITE_C1, GPIO_INPUT | GPIO_PULL_UP},
		{GPIO_LED_AMBER_C1, GPIO_INPUT | GPIO_PULL_UP},
	};
