...
const struct gpio_info gpio_list[] = {
	...
	{"KB_IN00",             GPIO_C, (1<<8),  GPIO_KB_INPUT,  NULL},
	{"KB_IN01",             GPIO_C, (1<<9),  GPIO_KB_INPUT,  NULL},
	{"KB_IN02",             GPIO_C, (1<<10), GPIO_KB_INPUT,  NULL},
	{"KB_IN03",             GPIO_C, (1<<11), GPIO_KB_INPUT,  NULL},
	{"KB_IN04",             GPIO_C, (1<<12), GPIO_KB_INPUT,  NULL},
	{"KB_IN05",             GPIO_C, (1<<14), GPIO_KB_INPUT,  NULL},
	{"KB_IN06",             GPIO_C, (1<<15), GPIO_KB_INPUT,  NULL},
	{"KB_IN07",             GPIO_D, (1<<2),  GPIO_KB_INPUT,  NULL},
