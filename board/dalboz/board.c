...
static void setup_fw_config(void)
{
	...
	if (cbi_get_board_version(&board_version) == EC_SUCCESS &&
		...
		usb_muxes[USBC_PORT_C1].mux->board_set = &board_ps8743_mux_set;
	} else {
		ccprints("PS8740 USB MUX");
		usb_muxes[USBC_PORT_C1].mux->i2c_addr_flags =
			PS8740_I2C_ADDR0_FLAG;
		usb_muxes[USBC_PORT_C1].mux->driver = &ps8740_usb_mux_driver;
		usb_muxes[USBC_PORT_C1].mux->board_set = NULL;
	}
