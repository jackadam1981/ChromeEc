...
void chipset_pre_init_callback(void)
{
	...
	if (pca9555_read__7b(I2C_PORT_PCA555_PMIC_BATT_GPIO,
		I2C_ADDR_PCA555_PMIC_BATT_GPIO__7b,
	...
	data &= ~PCA9555_IO_1;
	pca9555_write__7b(I2C_PORT_PCA555_PMIC_BATT_GPIO,
		I2C_ADDR_PCA555_PMIC_BATT_GPIO__7b,
		PCA9555_CMD_OUTPUT_PORT_0, data);
...
int board_get_version(void)
{
	...
	if (pca9555_read__7b(I2C_PORT_PCA555_BOARD_ID_GPIO,
			     I2C_ADDR_PCA555_BOARD_ID_GPIO__7b,
