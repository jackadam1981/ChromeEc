...
static void chipset_pre_init(void)
{
	...
	if (pca9555_read(IT83XX_I2C_CH_C, 0x42,
	...
	data &= ~PCA9555_IO_1;
	pca9555_write(IT83XX_I2C_CH_C, 0x42, PCA9555_CMD_OUTPUT_PORT_0, data);

	/* TODO: Find out from the spec */
	msleep(10);

	/* Enable PMIC_EN: Set the Output port O0.0 to high level */
	pca9555_write(IT83XX_I2C_CH_C, 0x42, PCA9555_CMD_OUTPUT_PORT_0,
			data | PCA9555_IO_0);
}
...
int board_get_version(void)
{
	...
	if (pca9555_read(IT83XX_I2C_CH_C, 0x40,
...
static void pmic_init(void)
{
	 ...
	 */
	pca9555_write(IT83XX_I2C_CH_C, 0x42,
	 ...
	 */
	pca9555_write(IT83XX_I2C_CH_C, 0x42, PCA9555_CMD_OUTPUT_PORT_0, 0xfe);
}
