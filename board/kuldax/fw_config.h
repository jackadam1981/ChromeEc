...
/*
 * Wireless charger  (Bits 5)
 */
enum ec_cfg_wireless_charger {
	WIRELESS_CHARGER_ENABLE = 0,
	WIRELESS_CHARGER_DISABLE = 1
};
...
/**
 * SWITCH the wireless charger function enable/disable from FW_CONFIG.
 */
