...
static void led_set_battery(void)
{
	...
	case PWR_STATE_CHARGE:
		/* RGB(current, duty) = (4mA,8/32) (4mA,1/32) (0mA,) */
		mt6370_led_set_brightness(LED_RED, 1);
		mt6370_led_set_brightness(LED_GRN, 1);
		mt6370_led_set_brightness(LED_BLU, 0);
	...
	case PWR_STATE_DISCHARGE:
		...
		mt6370_led_set_brightness(LED_GRN, 0);
		mt6370_led_set_brightness(LED_BLU, 0);
		break;
	case PWR_STATE_ERROR:
		/* RGB(current, duty) = (24mA,8/32) (0mA,) (0mA,) */
		mt6370_led_set_brightness(LED_RED, 7);
		mt6370_led_set_brightness(LED_GRN, 0);
		mt6370_led_set_brightness(LED_BLU, 0);
		mt6370_led_set_pwm_dim_duty(LED_RED, 7);
		break;
	case PWR_STATE_CHARGE_NEAR_FULL:
		/* RGB(current, duty) = (4mA,4/32) (4mA,2/32) (4mA,1/32) */
		mt6370_led_set_brightness(LED_RED, 1);
		mt6370_led_set_brightness(LED_GRN, 1);
		mt6370_led_set_brightness(LED_BLU, 1);
		mt6370_led_set_pwm_dim_duty(LED_RED, 3);
		mt6370_led_set_pwm_dim_duty(LED_GRN, 1);
