...
const struct adc_to_id batteries[] = {
	{ BATTERY_UNKNOWN,	576 - ADC_MARGIN_MV },
	{ BATTERY_C19_ATL,	576 + ADC_MARGIN_MV },  /* 47K  */
	{ BATTERY_UNKNOWN,	900 - ADC_MARGIN_MV },
	{ BATTERY_C18_ATL,	900 + ADC_MARGIN_MV },  /* 100K */
};
...
{
	int id = adc_read_id(ADC_BATT_ID, batteries, ARRAY_SIZE(batteries));
