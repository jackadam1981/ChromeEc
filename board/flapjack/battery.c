...
#ifdef CONFIG_BATTERY_MAX17055_FULL_MODEL
 ...
 * these and modify the the value when we need more rom space later.
 */
static const struct {
	...
	[BATTERY_C18_SUNWODA] = {
		/* TEMP_ZONE_0 */
		{BATTERY_SUNWODA_CHARGE_MIN_TEMP * 10, 10, 1170, 4400},
		/* TEMP_ZONE_1 */
		{100, 200, 1755, 4400},
		/* TEMP_ZONE_2 */
		{200, 450, 2925, 4400},
	...
	[BATTERY_C19_SUNWODA] = {
		/* TEMP_ZONE_0 */
		{BATTERY_SUNWODA_CHARGE_MIN_TEMP * 10, 10, 1300, 4400},
		/* TEMP_ZONE_1 */
		{100, 200, 1950, 4400},
		/* TEMP_ZONE_2 */
		{200, 450, 3250, 4400},
