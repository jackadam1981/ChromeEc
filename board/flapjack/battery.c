...
static const uint16_t full_model_ocv_table[][MAX17055_OCV_TABLE_SIZE] = {
	[BATTERY_C18_ATL] = {
		0x9ee0, 0xa650, 0xb6b0, 0xb890, 0xbb80, 0xbcd0, 0xbe00, 0xbfa0,
		0xc2a0, 0xc5a0, 0xc900, 0xcc80, 0xd110, 0xd280, 0xd520, 0xd9f0,
		0x0020, 0x0170, 0x0990, 0x0f60, 0x1600, 0x1ed0, 0x0e90, 0x1000,
		0x0730, 0x0910, 0x0790, 0x0730, 0x0480, 0x0910, 0x0670, 0x0670,
		0x0200, 0x0200, 0x0200, 0x0200, 0x0200, 0x0200, 0x0200, 0x0200,
		0x0200, 0x0200, 0x0200, 0x0200, 0x0200, 0x0200, 0x0200, 0x0200,
	},
	[BATTERY_C19_ATL] = {
		0x9f60, 0xae90, 0xb7a0, 0xb8c0, 0xbb50, 0xbcb0, 0xbd70, 0xbf80,
		0xc0d0, 0xc1f0, 0xc520, 0xc880, 0xcdb0, 0xd1b0, 0xd590, 0xda20,
		0x0060, 0x01c0, 0x1770, 0x0d90, 0x1610, 0x1f30, 0x13c0, 0x0fa0,
		0x0d50, 0x0a40, 0x0700, 0x0800, 0x0720, 0x0750, 0x0690, 0x0690,
		0x0200, 0x0200, 0x0200, 0x0200, 0x0200, 0x0200, 0x0200, 0x0200,
		0x0200, 0x0200, 0x0200, 0x0200, 0x0200, 0x0200, 0x0200, 0x0200,
	},
	[BATTERY_C18_SUNWODA] = {
		0x9230, 0xa7d0, 0xb770, 0xb880, 0xb9f0, 0xbc30, 0xbd60, 0xbf40,
		0xc140, 0xc340, 0xc600, 0xc8d0, 0xcbd0, 0xce80, 0xd400, 0xda00,
		0x0020, 0x0180, 0x1920, 0x0a10, 0x1100, 0x2010, 0x17c0, 0x0d00,
		0x0cb0, 0x0800, 0x07d0, 0x07a0, 0x07f0, 0x06f0, 0x05c0, 0x05c0,
		0x0200, 0x0200, 0x0200, 0x0200, 0x0200, 0x0200, 0x0200, 0x0200,
		0x0200, 0x0200, 0x0200, 0x0200, 0x0200, 0x0200, 0x0200, 0x0200,
	},
	[BATTERY_C19_SUNWODA] = {
		0x9d80, 0xb520, 0xb780, 0xb8c0, 0xbb80, 0xbcb0, 0xbd30, 0xbdd0,
		0xbfb0, 0xc1d0, 0xc4d0, 0xc7e0, 0xcb10, 0xce50, 0xd400, 0xd990,
		0x0020, 0x0ce0, 0x0f00, 0x0d00, 0x1a00, 0x2500, 0x1ed0, 0x12e0,
		0x0e50, 0x0930, 0x08f0, 0x0740, 0x07f0, 0x06d0, 0x0630, 0x0630,
		0x0200, 0x0200, 0x0200, 0x0200, 0x0200, 0x0200, 0x0200, 0x0200,
		0x0200, 0x0200, 0x0200, 0x0200, 0x0200, 0x0200, 0x0200, 0x0200,
	},
};
...
static const struct max17055_batt_profile batt_profile[] = {
	[BATTERY_C18_ATL] = {
		...
		/* Empty voltage = 3100mV, Recovery voltage = 4000mV */
		.v_empty_detect		= 0xa05f,
		.learn_cfg		= 0x4402,
		.dpacc			= 0x0c7d,
		.rcomp0			= 0x0041,
		.tempco			= 0x0b26,
	...
	[BATTERY_C18_SUNWODA] = {
		...
		.ichg_term		= 0x03c0, /* 150 mA */
		/* Empty voltage = 3200mV, Recovery voltage = 4000mV */
		.v_empty_detect		= 0x9b5c,
		.learn_cfg		= 0x4402,
		.dpacc			= 0x0c7c,
		.rcomp0			= 0x0049,
		.tempco			= 0x193f,
