...
static void board_setup_panel(void)
{
	...
	rv |= i2c_write8__7b(I2C_PORT_CHARGER, RT946X_ADDR__7b, MT6370_BACKLIGHT_BLEN,
		channel);
	rv |= i2c_write8__7b(I2C_PORT_CHARGER, RT946X_ADDR__7b, MT6370_BACKLIGHT_BLDIM,
		dim);
	rv |= i2c_write8__7b(I2C_PORT_CHARGER, RT946X_ADDR__7b, MT6370_BACKLIGHT_BLPWM,
		0xac);
	if (rv)
...
const struct tcpc_config_t tcpc_config[CONFIG_USB_PD_PORT_COUNT] = {
	{
		...
		.i2c_info = {
			.port = I2C_PORT_TCPC0,
			.addr__7b = MT6370_TCPC_I2C_ADDR__7b,
		},
		.drv = &mt6370_tcpm_drv},
};
...
struct motion_sensor_t motion_sensors[] = {
	...
	[CLEAR_ALS] = {
	 ...
	 .port = I2C_PORT_ALS,
	 .addr__8b = TCS3400_I2C_ADDR__7b << 1,
