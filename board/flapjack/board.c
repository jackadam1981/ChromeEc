...
static void board_setup_panel(void)
{
	...
	i2c_write8(I2C_PORT_CHARGER, RT946X_ADDR, MT6370_BL_BLEN, channel);
	i2c_write8(I2C_PORT_CHARGER, RT946X_ADDR, MT6370_BL_BLDIM, dim);
	i2c_write8(I2C_PORT_CHARGER, RT946X_ADDR, MT6370_BL_BLPWM, BL_PWM_EN);
}
