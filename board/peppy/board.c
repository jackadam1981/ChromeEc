...
const struct gpio_info gpio_list[] = {
	...
	{"POWER_BUTTON_L",       LM4_GPIO_A, (1<<2), GPIO_IN_INT_BOTH,
	 power_button_interrupt},
	{"LID_OPEN",             LM4_GPIO_A, (1<<3), GPIO_IN_INT_BOTH,
	 lid_interrupt},
	{"AC_PRESENT",           LM4_GPIO_H, (1<<3), GPIO_IN_INT_BOTH,
	 extpower_interrupt},
	{"PCH_BKLTEN",           LM4_GPIO_M, (1<<3), GPIO_IN_INT_BOTH,
	 backlight_interrupt},
	{"PCH_SLP_S0_L",         LM4_GPIO_G, (1<<6), GPIO_IN_INT_BOTH,
	 x86_interrupt},
	{"PCH_SLP_S3_L",         LM4_GPIO_G, (1<<7), GPIO_IN_INT_BOTH,
	 x86_interrupt},
	{"PCH_SLP_S5_L",         LM4_GPIO_H, (1<<1), GPIO_IN_INT_BOTH,
	 x86_interrupt},
	{"PCH_SLP_SUS_L",        LM4_GPIO_G, (1<<3), GPIO_IN_INT_BOTH,
	 x86_interrupt},
	{"PP1050_PGOOD",         LM4_GPIO_H, (1<<4), GPIO_IN_INT_BOTH,
	 x86_interrupt},
	{"PP1350_PGOOD",         LM4_GPIO_H, (1<<6), GPIO_IN_INT_BOTH,
	 x86_interrupt},
	{"PP5000_PGOOD",         LM4_GPIO_N, (1<<0), GPIO_IN_INT_BOTH,
	 x86_interrupt},
	{"VCORE_PGOOD",          LM4_GPIO_C, (1<<6), GPIO_IN_INT_BOTH,
	 x86_interrupt},
	{"PCH_EDP_VDD_EN",       LM4_GPIO_J, (1<<1), GPIO_IN_INT_BOTH,
	 haswell_interrupt},
	{"RECOVERY_L",           LM4_GPIO_A, (1<<5),
	 GPIO_PULL_UP | GPIO_IN_INT_BOTH, switch_interrupt},
	{"WP_L",                 LM4_GPIO_A, (1<<4), GPIO_IN_INT_BOTH,
	 switch_interrupt},

	/* Other inputs */
	{"FAN_ALERT_L",          LM4_GPIO_B, (1<<0), GPIO_INPUT, NULL},
	{"PCH_SUSWARN_L",        LM4_GPIO_G, (1<<2), GPIO_IN_INT_BOTH, NULL},
