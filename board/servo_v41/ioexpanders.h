...
/**
 * USB data path enable for general USB type A port
 *
 ...
 *
 * @param en	0 - hub connected to uservo
 *		1 - hub connected to DUT
 */
void uservo_fastboot_mux_sel(int en);
 ...
 *		1 - power enabled
 */
void usb3_a1_power_en(int en);

/**
 * USB data path selection for GL3224
 *
 * @param en	0 - GL3224 connected to DUT hub
 *		1 - GL3224 connected to HOST hub
 */
