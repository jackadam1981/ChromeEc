 ...
 */
#define DS1624_I2C_ADDR__7b		0x48
...
const struct tcpc_config_t tcpc_config[CONFIG_USB_PD_PORT_COUNT] = {
	{I2C_PORT_TCPC, (CONFIG_TCPC_I2C_BASE_ADDR__b8 >> 1), &tcpci_tcpm_drv},
	{I2C_PORT_TCPC, (CONFIG_TCPC_I2C_BASE_ADDR__b8 >> 1) + 1, &tcpci_tcpm_drv},
};
#endif
...
static void board_pmic_init(void)
{
	...
	cfg = 0x66;
	rv = i2c_read8__7b(I2C_PORT_THERMAL, DS1624_I2C_ADDR__7b,
	...
	if ((rv == EC_SUCCESS) && (cfg & (1u << 0))) {
		...
		rv = i2c_write8__7b(I2C_PORT_THERMAL, DS1624_I2C_ADDR__7b,
				DS1624_ACCESS_CFG, 0);
...
static void ds1624_update(void)
{
	...
	rv = i2c_read16__7b(I2C_PORT_THERMAL,
			(DS1624_I2C_ADDR__7b | I2C_FLAG_BIG_ENDIAN),
...
struct motion_sensor_t motion_sensors[] = {
	...
	[BASE_ACCEL] = {
		...
		.addr__8b = BMI160_SET_SPI_ADDRESS__8b(CONFIG_SPI_ACCEL_PORT),
