 ...
 */
#define DS1624_I2C_ADDR__7bf		0x48
...
const struct tcpc_config_t tcpc_config[CONFIG_USB_PD_PORT_COUNT] = {
	{I2C_PORT_TCPC,
	 (CONFIG_TCPC_I2C_BASE_ADDR__b8 >> 1),
	 &tcpci_tcpm_drv},

	{I2C_PORT_TCPC,
	 (CONFIG_TCPC_I2C_BASE_ADDR__b8 >> 1) + 1,
	 &tcpci_tcpm_drv},
};
#endif
...
static void ds1624_update(void)
{
	...
	rv = i2c_read16__7bf(I2C_PORT_THERMAL,
			(DS1624_I2C_ADDR__7bf | I2C_FLAG_BIG_ENDIAN),
