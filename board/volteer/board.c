...
/*
 * TODO: P0 boards don't have this sensor mounted so the rotation
...
/* Volteer Temperature sensors */
/*
 * TODO: These setting need to be reviewed and set appropriately
 * for Volteer. They matter when the EC is controlling the fan as opposed to
 * DPTF control.
 */
