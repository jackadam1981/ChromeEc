...
const struct adc_t adc_channels[] = {
	...
	[ADC_EC_SKU_ID] =
		{"EC_SKU_ID", ADC_MAX_MVOLT, ADC_READ_MAX + 1, 0, CHIP_ADC_CH2},
};
...
const struct i2c_port_t i2c_ports[] = {
	{"typec",   IT83XX_I2C_CH_C, 400, GPIO_I2C_A_SCL, GPIO_I2C_A_SDA},
#ifdef BOARD_JACUZZI
	{"other",   IT83XX_I2C_CH_B, 100, GPIO_I2C_B_SCL, GPIO_I2C_B_SDA},
#else /* Juniper */
	{"other",   IT83XX_I2C_CH_B, 400, GPIO_I2C_B_SCL, GPIO_I2C_B_SDA},
#endif
	{"battery", IT83XX_I2C_CH_A, 100, GPIO_I2C_C_SCL, GPIO_I2C_C_SDA},
};
