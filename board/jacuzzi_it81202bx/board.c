...
#else
	[ADC_BOARD_ID] =
		{"BOARD_ID", ADC_MAX_MVOLT, ADC_READ_MAX + 1, 0, CHIP_ADC_CH5},
	[ADC_EC_SKU_ID] =
		{"EC_SKU_ID", ADC_MAX_MVOLT, ADC_READ_MAX + 1, 0, CHIP_ADC_CH6},
#endif
};
...
const struct i2c_port_t i2c_ports[] = {
	{"typec",   IT83XX_I2C_CH_A, 400, GPIO_I2C_A_SCL, GPIO_I2C_A_SDA},
#ifdef BOARD_JACUZZI
