...
const struct pwm_t pwm_channels[] = {
	[PWM_CH_LED_GREEN] = { STM32_TIM(1), STM32_TIM_CH(1), 0, 100 },
	[PWM_CH_LED_RED] = { STM32_TIM(1), STM32_TIM_CH(3), 0, 100 },
	[PWM_CH_LED_BLUE] = { STM32_TIM(1), STM32_TIM_CH(4), 0, 100 },
};
...
const struct i2c_port_t i2c_ports[] = {
	{"charger", I2C_PORT_CHARGER,   100, GPIO_I2C0_SCL, GPIO_I2C0_SDA},
