...
static const struct max17055_batt_profile batt_profile[] = {
	 ...
	 * battery once we have the characterization result. For now
	 * we mostly reuse the numbers from AE-Tech battery.
	 */
	[BATTERY_SIMPLO] = {
		.is_ez_config		= 1,
		.design_cap		= 0x23A0, /* 9120mAh */
		.ichg_term		= 0x0240, /* 180mA */
		/* Empty voltage = 2800mV, Recovery voltage = 3280mV */
		.v_empty		= 0x2328,
	},
	[BATTERY_AETECH] = {
		.is_ez_config		= 0,
