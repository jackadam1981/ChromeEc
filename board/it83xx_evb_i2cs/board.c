...
/*
 * i2c slave test:
 * Refer to the console command "i2cxfer" in i2c_master.c
 * write data(1 byte): i2cxfer w port addr offset value
 * read data(1 byte): i2cxfer r port addr offset len
 * Example:
 * Master port: IT83XX_I2C_CH_C(2), Slave address: I2C_SLAVE_ADDRA(0xa4),
 * offset: 0x10, data: 0x20
 * write data command: i2cxfer w 2 0xa4 0x10 0x20
 * read data command: i2cxfer r 2 0xa4 0x10 1
 */
