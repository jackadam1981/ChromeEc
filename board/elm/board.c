...
int anx7688_passthru_allowed__7b(const struct i2c_port_t *port,
			     const uint16_t addr__7b)
{
	/* Allow access to 0x2c (TCPC) */
	if (addr__7b == 0x2c)
		return 1;

	CPRINTF("Passthru rejected on %x", addr__7b);
