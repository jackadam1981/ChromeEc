...
{
	int current;
	enum BATTERY_LED_COLORS color = LED_COLOR_RED;
	...
	case ST_CHARGING:
		...
		/*
		 * Battery discharges slowly when nearly full. Set LED to green
		 * in this case.
		 * See crosbug.com/p/17644
		 */
	...
	case LED_COLOR_GREEN:
		return lp5562_set_color(0, 0x80, 0);
	case LED_COLOR_YELLOW:
		return lp5562_set_color(0, 0, 0x80);
	case LED_COLOR_RED:
		return lp5562_set_color(0x80, 0, 0);
	}
