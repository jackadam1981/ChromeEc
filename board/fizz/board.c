...
{
	/* Performs the same check as system_can_boot_ap(). It's repeated here
	 * just because charge_manager hasn't updated charge_current/voltage,
	 * which are referenced by system_can_boot_ap(). */
	if (charge_ma * charge_mv >=
