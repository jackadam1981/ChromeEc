...
struct ec_thermal_config thermal_params[] = {
	 ...
	 * fan_off, fan_max
	 */
<<<<<<< HEAD   (f953ca fan: Refactor and test the most common custom fan_percent_to)
...
static const fan_step fan_table3[] = {
	{ .on = 0, .off = 1, .rpm = 0 },
	{ .on = 36, .off = 22, .rpm = 2500 }, /* on at 34 C, off at 30 C */
	{ .on = 54, .off = 49, .rpm = 3200 }, /* on at 39 C, off at 37 C */
	{ .on = 61, .off = 56, .rpm = 3500 }, /* on at 40 C, off at 39 C */
	{ .on = 68, .off = 63, .rpm = 3900 }, /* on at 42 C, off at 40 C */
	{ .on = 75, .off = 69, .rpm = 4500 }, /* on at 44 C, off at 42 C */
	{ .on = 82, .off = 76, .rpm = 5100 }, /* on at 46 C, off at 44 C */
	{ .on = 92, .off = 85, .rpm = 5400 }, /* on at 48 C, off at 46 C */
};
