...
static const struct fan_step_1_1 fan_table0[] = {
	{ .decreasing_temp_threshold = C_TO_K(25),
	  .increasing_temp_threshold = C_TO_K(34),
	  .rpm = 2800 },
	{ .decreasing_temp_threshold = C_TO_K(39),
	  .increasing_temp_threshold = C_TO_K(40),
	  .rpm = 3200 },
	{ .decreasing_temp_threshold = C_TO_K(40),
	  .increasing_temp_threshold = C_TO_K(42),
	  .rpm = 3400 },
	...
	{ .decreasing_temp_threshold = C_TO_K(44),
	  ...
	  .rpm = 4800 },
	{ .decreasing_temp_threshold = C_TO_K(45),
	  .increasing_temp_threshold = C_TO_K(47),
	  .rpm = 5200 },
	{ .decreasing_temp_threshold = C_TO_K(47),
...
static const struct fan_step_1_1 fan_table2[] = {
	...
	{ .decreasing_temp_threshold = C_TO_K(39),
	  ...
	  .rpm = 2900 },
	{ .decreasing_temp_threshold = C_TO_K(41),
...
static const struct fan_step_1_1 fan_table3[] = {
	{ .decreasing_temp_threshold = C_TO_K(30),
	  .increasing_temp_threshold = C_TO_K(34),
	  .rpm = 2500 },
	{ .decreasing_temp_threshold = C_TO_K(37),
	  .increasing_temp_threshold = C_TO_K(39),
	  .rpm = 3200 },
	{ .decreasing_temp_threshold = C_TO_K(39),
	  .increasing_temp_threshold = C_TO_K(40),
	  .rpm = 3500 },
