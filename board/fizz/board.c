...
static const struct fan_step fan_table0[] = {
	...
	{ .on = 46, .off = 34, .rpm = 3200 },
	{ .on = 54, .off = 44, .rpm = 3400 },
	{ .on = 58, .off = 52, .rpm = 4200 },
	{ .on = 63, .off = 56, .rpm = 4800 },
	{ .on = 67, .off = 61, .rpm = 5200 },
	{ .on = 70, .off = 65, .rpm = 5600 },
};
...
static const struct fan_step fan_table2[] = {
	...
	{ .on = 46, .off = 34, .rpm = 2900 },
	{ .on = 54, .off = 44, .rpm = 3000 },
	{ .on = 56, .off = 52, .rpm = 3300 },
	{ .on = 59, .off = 54, .rpm = 3600 },
	{ .on = 62, .off = 57, .rpm = 3900 },
	{ .on = 67, .off = 60, .rpm = 5000 },
};
static const struct fan_step fan_table3[] = {
	{ .on = 0, .off = 1, .rpm = 0 },
	{ .on = 36, .off = 22, .rpm = 2500 },
	{ .on = 46, .off = 34, .rpm = 3200 },
	{ .on = 54, .off = 44, .rpm = 3500 },
	{ .on = 59, .off = 52, .rpm = 3900 },
	{ .on = 63, .off = 57, .rpm = 4500 },
	{ .on = 67, .off = 61, .rpm = 5100 },
	{ .on = 70, .off = 65, .rpm = 5400 },
};
