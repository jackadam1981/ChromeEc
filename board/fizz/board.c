...
struct usb_mux usb_muxes[CONFIG_USB_PD_PORT_COUNT] = {
	{
		.port_addr = 0,		/* dnojiri: verify */
		.driver = &tcpci_tcpm_usb_mux_driver,
		.hpd_update = &ps8751_tcpc_update_hpd_status,
	}
};

struct usb_port usb_ports[USB_PORT_COUNT] = {
	{ .enable = GPIO_USB1_ENABLE, },
	{ .enable = GPIO_USB2_ENABLE, },
	{ .enable = GPIO_USB3_ENABLE, },
	{ .enable = GPIO_USB4_ENABLE, },
	{ .enable = GPIO_USB5_ENABLE, },
};
...
static void board_init(void)
{
	...
	/* dnojiri: Poppy enables VBUS interrupt even though the line is not
	 * used */
	/* dnojiri: Poppy enables pericom BC1.2 interrupts */
}
