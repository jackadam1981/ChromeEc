...
#define CONFIG_RW_A_SIGN_STORAGE_OFF	CONFIG_RW_STORAGE_OFF
#define CONFIG_RW_B_SIGN_STORAGE_OFF	(CONFIG_RW_STORAGE_OFF + CONFIG_RW_SIZE)
#undef  CONFIG_RW_A_STORAGE_OFF
#define CONFIG_RW_A_STORAGE_OFF		(CONFIG_RW_A_SIGN_STORAGE_OFF + \
					 CONFIG_RW_SIG_SIZE)
#undef  CONFIG_RW_B_STORAGE_OFF
#define CONFIG_RW_B_STORAGE_OFF		(CONFIG_RW_B_SIGN_STORAGE_OFF + \
					 CONFIG_RW_SIG_SIZE)
