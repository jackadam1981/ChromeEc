...
static int is_battery_i2c__7bf(const int port, const uint16_t i2c_addr__7bf)
{
	return (port == I2C_PORT_BATTERY)
		&& (i2c_addr__7bf == BATTERY_ADDR__7bf);
}

void i2c_start_xfer_notify__7bf(const int port, const uint16_t i2c_addr__7bf)
{
	unsigned int time_delta_us;

	if (!is_battery_i2c__7bf(port, i2c_addr__7bf))
		return;
...
void i2c_end_xfer_notify__7bf(const int port, const uint16_t i2c_addr__7bf)
{
	if (!is_battery_i2c__7bf(port, i2c_addr__7bf))
		return;
