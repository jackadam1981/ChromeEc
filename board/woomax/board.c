...
static int pi3dpx1207_i2c_write_eq(const struct usb_mux *me,
					uint8_t *val)
{
	int rv = EC_SUCCESS;
	int attempt;
		...
		mux_state_t mux_state)
{
	...
	if (ec_config_has_usbc1_retimer_ps8802())
		rv = pi3dpx1207_i2c_write_eq(me,
				&pi3dpx1207_dali_eq[usb_mode*13]);
	else
		rv = pi3dpx1207_i2c_write_eq(me,
				&pi3dpx1207_picasso_eq[usb_mode*13]);
