...
__maybe_unused static int command_lidopen(int argc, const char **argv)
{
	lid_switch_open();
	return EC_SUCCESS;
}
...
__maybe_unused static int command_lidclose(int argc, const char **argv)
{
	lid_switch_close();
	return EC_SUCCESS;
}
...
__maybe_unused static int command_lidstate(int argc, const char **argv)
{
