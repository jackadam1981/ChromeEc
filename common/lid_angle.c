...
/*
 * Currently, the only way of measuring lid angle is with accelerometers,
 * so the motion_sense task must be enabled.
 */
#ifndef HAS_TASK_MOTIONSENSE
#error "Cannot use lid angle to disable key scanning without motion_sense task."
#endif
