...
int process_espi_oob_cycle_data(void)
{
	...
	case OOB_SMBUS_GET_RTC:
		...
		/*
		 * 7[0]-DS - Daylight saving (1-enable, 0-disabled)
		 * 7[1]-HF - Hour format (1-24hr format, 0-12hr format)
		 * 7[2]-DM - Data mode (1-Binay, 0-BCD)
		 * 7[7]=MD - Meridium (when HF=0; 1-PM, 0-AM)
		 */
