...
static int host_command_get_features(struct host_cmd_handler_args *args)
{
	...
	r->flags[0] = 0
		...
		| EC_FEATURE_MASK(EC_FEATURE_LIMITED)
#endif
#ifdef CONFIG_FLASH
		| EC_FEATURE_MASK(EC_FEATURE_FLASH)
#endif
#ifdef CONFIG_FANS
		| EC_FEATURE_MASK(EC_FEATURE_PWM_FAN)
#endif
#ifdef CONFIG_PWM_KBLIGHT
		| EC_FEATURE_MASK(EC_FEATURE_PWM_KEYB)
#endif
#ifdef HAS_TASK_LIGHTBAR
		| EC_FEATURE_MASK(EC_FEATURE_LIGHTBAR)
#endif
#ifdef CONFIG_LED_COMMON
		| EC_FEATURE_MASK(EC_FEATURE_LED)
#endif
#ifdef HAS_TASK_MOTIONSENSE
		| EC_FEATURE_MASK(EC_FEATURE_MOTION_SENSE)
#endif
#ifdef HAS_TASK_KEYSCAN
		| EC_FEATURE_MASK(EC_FEATURE_MKBP)
#endif
#ifdef CONFIG_PSTORE
		| EC_FEATURE_MASK(EC_FEATURE_PSTORE)
#endif
#ifdef CONFIG_LPC
		| EC_FEATURE_MASK(EC_FEATURE_PORT80)
#endif
#ifdef CONFIG_TEMP_SENSOR
		| EC_FEATURE_MASK(EC_FEATURE_THERMAL)
#endif
/* Hack to uniquely identify Samus and Falco ec */
#if (defined EC_CMD_SWITCH_ENABLE_BKLIGHT) || \
		(defined CONFIG_BATTERY_SAMUS) || \
		(defined CONFIG_EXTPOWER_FALCO)
		| EC_FEATURE_MASK(EC_FEATURE_SWITCH_CTRL)
#endif
#ifdef CONFIG_HOSTCMD_EVENTS
		| EC_FEATURE_MASK(EC_FEATURE_HOST_EVENTS)
#endif
#ifdef CONFIG_COMMON_GPIO
		| EC_FEATURE_MASK(EC_FEATURE_GPIO)
#endif
#ifdef CONFIG_I2C
		| EC_FEATURE_MASK(EC_FEATURE_I2C)
#endif
#ifdef CONFIG_CHARGER
		| EC_FEATURE_MASK(EC_FEATURE_CHARGER)
#endif
#if (defined CONFIG_BATTERY) || (defined CONFIG_BATTERY_SMART)
		| EC_FEATURE_MASK(EC_FEATURE_BATTERY)
#endif
#ifdef CONFIG_BATTERY_SMART
		| EC_FEATURE_MASK(EC_FEATURE_SMART_BATTERY)
#endif
#ifdef CONFIG_AP_HANG_DETECT
		| EC_FEATURE_MASK(EC_FEATURE_HANG_DECTECT)
#endif
#ifdef CONFIG_PMU_POWERINFO
		| EC_FEATURE_MASK(EC_FEATURE_PMU)
#endif
#ifdef HAS_TASK_PDCMD
		| EC_FEATURE_MASK(EC_FEATURE_PD_MCU)
#endif
#ifdef CONFIG_CHARGE_MANAGER
		| EC_FEATURE_MASK(EC_FEATURE_USB_PD)
#endif
/* should be more generic */
#ifdef CONFIG_USB_SWITCH_TSU6721
		| EC_FEATURE_MASK(EC_FEATURE_USB_MUX)
#endif
		;
	return EC_RES_SUCCESS;
}
