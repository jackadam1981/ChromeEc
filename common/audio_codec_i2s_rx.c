...
static int i2s_rx_set_daifmt(struct host_cmd_handler_args *args)
{
	...
	case EC_CODEC_I2S_RX_DAIFMT_PCM_A:
	case EC_CODEC_I2S_RX_DAIFMT_PCM_B:
	case EC_CODEC_I2S_RX_DAIFMT_PCM_TDM:
		break;
	}
...
static int i2s_rx_set_tdm_config(struct host_cmd_handler_args *args)
{
	if (!priv.driver.set_tdm_config)
		return EC_RES_ERROR;
...
static int (*sub_cmds[])(struct host_cmd_handler_args *) = {
	...
	[EC_CODEC_I2S_RX_SET_TDM_CONFIG] = i2s_rx_set_tdm_config,
};
...
static char *strcmd[EC_CODEC_I2S_RX_SUBCMD_COUNT] = {
	...
	[EC_CODEC_I2S_RX_SET_TDM_CONFIG] = "EC_CODEC_I2S_RX_SET_TDM_CONFIG",
};
#endif
	...
	struct audio_codec_i2s_rx_driver *driver)
{
	...
	if (driver->set_tdm_config)
		priv.driver.set_tdm_config = driver->set_tdm_config;
