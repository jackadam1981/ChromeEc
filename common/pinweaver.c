		      ...
		      struct pw_response_t *response)
{
	...
	/* This variable is needed because the switch statement misbehaves if
	 * you overwrite the value it is testing inside the switch. The request
	 * is overwritten by the response if they are backed by the same buffer.
	 */
