...
#ifdef CONFIG_USB_PD_DECODE_SOP
	/*
	 * Check for discovery identity ack to distinguish the response between
	 * SOP and SOP' since, cable acks SOP' with discovery identity command
	 * request and sink nacks SOP with disovery idenitity command request.
	 */
...
void pd_task(void *u)
{
	...
	while (1) {
		...
		case PD_STATE_SRC_DISCOVERY:
			 ...
			 * capabilities - USB_PD_R2_0 Section 4.5
			 */
			if (pd[port].flags & PD_FLAGS_CHECK_CABLE_ENABLE) {
