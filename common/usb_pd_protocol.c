...
static void pd_vdm_send_state_machine(int port)
{
	...
	case VDM_STATE_READY:
		 ...
		 * should be established, VCONN should be enabled and data_role
		 ...
		 * data role swap takes place during implicit contract and in
		 * case of failure, a soft reset is issued.
		 */
