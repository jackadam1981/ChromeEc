...
int typec_update_cc(int port)
{
	...
	if (pd[port].select_drp == pd[port].set_drp &&
	    ...
	    polarity == pd[port].set_polarity &&
	    cc1_pull == pd[port].set_cc1_pull &&
	    cc2_pull == pd[port].set_cc2_pull) {
	...
	pd[port].set_polarity = polarity;
	pd[port].set_cc1_pull = cc1_pull;
	pd[port].set_cc2_pull = cc2_pull;
