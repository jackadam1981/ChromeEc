...
/*
 * Open Rp/Rd to ensure the partner port is in a known state (eg. not
 * PD negotiated, not providing 20V).
 */
static void pd_partner_port_reset(int port)
{
	...
	/* Open Rp/Rd for 100 msec. or until we no longer have VBUS. */
