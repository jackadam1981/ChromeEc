...
#if defined(CONFIG_USB_PD_DEV_ID_MAJOR) && defined(CONFIG_USB_PD_DEV_ID_MINOR)
	info_data[5] = VDO_INFO(CONFIG_USB_PD_DEV_ID_MAJOR,
				CONFIG_USB_PD_DEV_ID_MINOR,
				ver_get_numcommits(),
#ifdef CONFIG_COMMON_RUNTIME
