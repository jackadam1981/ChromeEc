...
#if 0
static char * state_lookup[] = {
	[PD_STATE_DISABLED]	= "DISABLED",
	[PD_STATE_SUSPENDED]	= "SUSPENDED",
	[PD_STATE_SNK_DISCONNECTED]	= "SNK_DISCONNECTED",
	[PD_STATE_SNK_DISCONNECTED_DEBOUNCE]	= "SNK_DISCONNECTED_DEBOUNCE",
	...
	[PD_STATE_SRC_DISCONNECTED]	= "SRC_DISCONNECTED",
	[PD_STATE_SRC_DISCONNECTED_DEBOUNCE]	= "SRC_DISCONNECTED_DEBOUNCE",
	[PD_STATE_SRC_ACCESSORY]	= "SRC_ACCESSORY",
...
static inline void set_state(int port, enum pd_states next_state)
{
	...
	CPRINTF("C%d: set_state f %s\n", port, pd_state_names[last_state]);
	CPRINTF("C%d: set_state t %s\n", port, pd_state_names[next_state]);
#ifdef CONFIG_USB_PD_DUAL_ROLE
