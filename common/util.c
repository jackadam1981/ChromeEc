...
/****************************************************************************/
/*
 * Standard functions that need to be a within the cr50 fips boundary. There
 * will be equivalent functions in board/cr50/dcrypto that are built separately.
 */
#ifndef CONFIG_FIPS_BOUNDARY
