 ...
 * reset.
 */
static enum ap_ro_status apro_result = AP_RO_UNSUPPORTED_NOT_TRIGGERED;
...
{
	if (apro_result == AP_RO_UNSUPPORTED_NOT_TRIGGERED)
		return;
	/*
	...
	apro_result = AP_RO_UNSUPPORTED_NOT_TRIGGERED;
}
