...
static const struct {
	...
	{0x15, 0x00},				/* output current for LED 6 */
	{0x16, 0x00},				/* output current for LED 5 */
	{0x17, 0x00},				/* output current for LED 4 */
	{0x18, 0x00},				/* output current for LED 3 */
	{0x19, 0x00},				/* output current for LED 2 */
	{0x1a, 0x00},				/* output current for LED 1 */
...
void lightsaber_setcolor(int led, int red, int green, int blue)
{
	int driver, bank;
...
static int command_lightsaber(int argc, char **argv)
{
	...
	lightsaber_setcolor(led, red, green, blue);
