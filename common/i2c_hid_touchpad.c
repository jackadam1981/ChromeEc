...
#error "Must define touchpad VID"
#endif
#ifndef I2C_HID_TOUCHPAD_PRODUCT_ID
#error "Must define touchpad PID"
#endif
...
#error "Must define finger maximum X value"
#endif
#ifndef I2C_HID_TOUCHPAD_MAX_Y
#error "Must define finger maximum Y value"
#endif
/* Physical dimensions are in the unit of mms */
#ifndef I2C_HID_TOUCHPAD_MAX_PHYSICAL_X
#error "Must define touchpad physical X dimension"
#endif
#ifndef I2C_HID_TOUCHPAD_MAX_PHYSICAL_Y
#error "Must define touchpad physical Y dimension"
#endif
/*
...
#error "Must define finger maximum width value"
#endif
#ifndef I2C_HID_TOUCHPAD_MAX_HEIGHT
#error "Must define finger maximum height value"
#endif
#ifndef I2C_HID_TOUCHPAD_MAX_PRESSURE
#error "Must define finger maximum pressure value"
#endif
/*
...
#error "Must define mouse horizontal scaling factor"
#endif
#ifndef I2C_HID_TOUCHPAD_MOUSE_SCALE_Y
#error "Must define mouse vertical scaling factor"
#endif
...
( \
		(DIV_ROUND_UP(N_VAR_BITS, 8) * 8) - N_VAR_BITS \
)
...
void i2c_hid_compile_report(struct touchpad_event *event)
{
	...
	for (int i = 0; i < I2C_HID_TOUCHPAD_MAX_FINGERS; i++) {
		if (event->finger[i].valid) {
			...
			/*
			 * Deal with hovering later if there is no any updating
			 * finger.
			 */
