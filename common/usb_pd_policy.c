...
/*
 * The function returns number of objects required to enter
 * Thunderbolt-Compatible mode i.e.
 * 2 - When SOP' is enabled and SOP'' controller is absent or
 *     when SOP'' is enabled.
 * 1 - When SOP' is enabled and SOP'' controller is present.
 * 0 - Otherwise.
 */
