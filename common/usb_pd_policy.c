...
uint32_t get_enter_usb_msg_payload(int port)
{
	...
	if (get_usb_pd_mux_cable_type(port) == IDH_PTYPE_ACABLE) {
		eudo.cable_type = cable[port].attr2.a2_rev30.active_elem ?
			CABLE_TYPE_ACTIVE_RETIMER : CABLE_TYPE_ACTIVE_REDRIVER;
	} else
...
/*
 * For passive cables the function returns :
 * True for  Revision 3 USB4 Gen3 cable.
 *           Revision 3 USB3.2 Gen2 cable without DFP Gen3 capability.
 *           Revision 3 USB3.1 Gen1 cable.
 * False for Revision 3 USB3.2 Gen2 cable with DFP Gen3 capability.
 *           Revision 3 USB2.0 cable.
 *           Revision 2 cables.
 */
