...
static bool is_cable_usb4_capable(int port, int cnt)
{
	...
	if (IS_ENABLED(CONFIG_USB_PD_USB4) &&
	   (get_usb_pd_mux_cable_type(port) == IDH_PTYPE_PCABLE) &&
		...
		case PD_REV20:
			/*
			 * Checking for Rev 2 Thunderbolt-compatible cable
			 * since, Thunderbolt Gen3 cable has same speed as
			 * USB4 Gen3 cable i.e 40Gbps and Thunderbolt Gen1_Gen2
			 * cable has same speed as USB3.2 Gen2 cable i.e. 20Gbps
			 * Reference: USB Type-C cable and connector specification
			 * Table 5-1.
			 */
			return false;
		default:
