...
#define CPRINTF(format, args...) info_printf(CC_THERMAL, format, ## args)
...
{
	CPRINTF("DPTF sensor %d, threshold %d C, index %d, %sabled",
...
{
	CPRINTF("can't read any temp sensors!");
