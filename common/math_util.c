...
fp_t cosine_of_angle_diff(const vector_3_t v1, const vector_3_t v2)
{
	...
	/*
	 * The dot product and denominator may be larger than representable in
	 * fixed point.  So need to do 64-bit divide here and then convert to
	 * fixed point, rather than the other way around.
	 */
