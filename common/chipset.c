...
static int PRESERVE_LOGS_SECT next_reset_log;
...
static int PRESERVE_LOGS_SECT reset_log_checksum;
...
{
	if (reset_log_checksum != calc_reset_log_checksum() ||
	   next_reset_log < 0 || next_reset_log >= ARRAY_SIZE(reset_logs)) {
