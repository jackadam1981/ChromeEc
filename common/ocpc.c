...
set_vsys:
	...
	chg_chips[SECONDARY_CHARGER].drv->set_current(SECONDARY_CHARGER,
						      current_ma);
	chg_chips[SECONDARY_CHARGER].drv->set_voltage(SECONDARY_CHARGER,
						      vsys_target);
...
void ocpc_get_params(struct ocpc_data *ocpc)
{
	int val;
