...
static int lpc_cmd_lightbar(struct host_cmd_handler_args *args)
{
	...
	/*
	 * TODO: Now that params and response are separate pointers, they need
	 * to be propagated to the lightbar sub-commands.  For now, just copy
	 * params to response so the sub-commands above will work unchanged.
	 */
