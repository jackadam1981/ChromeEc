...
/*
 * TODO(b/147672225): Can be removed when generic driver is removed
...
/*
 * TODO(b/147672225): boards should define their own charger structures, for now
 * create general structures which provide equivalent behavior
 * function which reads ADCs to determine board version
 */
...
const struct charger_info *charger_get_info(void)
{
	...
	if (chg_chips[chgnum].drv->get_info)
		ret = chg_chips[chgnum].drv->get_info();
