...
static int host_event_get_smi_mask(uint8_t *data)
{
	...
	return sizeof(struct lpc_response_host_event_mask);
}
DECLARE_HOST_COMMAND(EC_LPC_COMMAND_HOST_EVENT_GET_SMI_MASK,
		     host_event_get_smi_mask);


static int host_event_get_sci_mask(uint8_t *data)
{
	struct lpc_response_host_event_mask *r =
		(struct lpc_response_host_event_mask *)data;
...
static int host_event_get_wake_mask(uint8_t *data)
{
	struct lpc_response_host_event_mask *r =
		(struct lpc_response_host_event_mask *)data;
...
static int host_event_set_smi_mask(uint8_t *data)
{
...
static int host_event_set_sci_mask(uint8_t *data)
{
	const struct lpc_params_host_event_mask *p =
		(const struct lpc_params_host_event_mask *)data;
...
static int host_event_set_wake_mask(uint8_t *data)
{
	const struct lpc_params_host_event_mask *p =
		(const struct lpc_params_host_event_mask *)data;
...
static int host_event_clear(uint8_t *data)
{
	const struct lpc_params_host_event_mask *p =
		(const struct lpc_params_host_event_mask *)data;
