...
static int command_ch(int argc, const char **argv)
{
	...
	// *((uint32_t*)(0x40020800 + 4*i))); 	ccprintf("DMAMUX1_RG%dCR val :
	// 0x%08x\n", i, *((uint32_t*)(0x40020800 + 0x100 + 4*i)));
	// }
	// for(int i = 0; i < 8; i++) {
	// 	ccprintf("DMA2_S%dCR   val: 0x%08x\n", i,
	// *((uint32_t*)(0x40020400 + 0x10 + 0x18*i)));
	// ccprintf("DMA2_S%dPAR val: 0x%08x\n", i, *((uint32_t*)(0x40020400 +
	// 0x18 + 0x18*i))); 	ccprintf("DMA2_S%dM0AR val: 0x%08x\n", i,
	// *((uint32_t*)(0x40020400 + 0x1C + 0x18*i)));
	// ccprintf("DMA2_S%dM1AR val: 0x%08x\n", i, *((uint32_t*)(0x40020400 +
	// 0x20 + 0x18*i))); 	ccprintf("DMA2_S%dFCR  val: 0x%08x\n", i,
	// *((uint32_t*)(0x40020400 + 0x24 + 0x18*i)));
	// }
	// for(int i = 0; i < 8; i++) {
	// 	ccprintf("DMA1_S%dCR   val: 0x%08x\n", i,
	// *((uint32_t*)(0x40020000 + 0x10 + 0x18*i)));
	// ccprintf("DMA1_S%dPAR val: 0x%08x\n", i, *((uint32_t*)(0x40020000 +
	// 0x18 + 0x18*i))); 	ccprintf("DMA1_S%dM0AR val: 0x%08x\n", i,
	// *((uint32_t*)(0x40020000 + 0x1C + 0x18*i)));
	// ccprintf("DMA1_S%dM1AR val: 0x%08x\n", i, *((uint32_t*)(0x40020000 +
	// 0x20 + 0x18*i))); 	ccprintf("DMA1_S%dFCR  val: 0x%08x\n", i,
	// *((uint32_t*)(0x40020000 + 0x24 + 0x18*i)));
	// }
