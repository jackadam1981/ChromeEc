...
enum tbt_compat_cable_speed get_tbt_cable_speed(int port)
{
	...
	cable_mode_resp.raw_value = get_tbt_mode_sop_prime_response(port);
			...
			uint32_t *payload)
{
	...
	cable_mode_resp.raw_value = get_tbt_mode_sop_prime_response(port);
	dev_mode_resp.raw_value = get_tbt_mode_sop_response(port);

	/* Table F-13 TBT3 Device Enter Mode Command */
	enter_dev_mode.vendor_spec_b1 =
				dev_mode_resp.vendor_spec_b1;
	enter_dev_mode.vendor_spec_b0 =
				dev_mode_resp.vendor_spec_b0;
