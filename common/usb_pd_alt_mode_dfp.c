...
__overridable void svdm_dp_post_config(int port)
{
	...
	/* Sleep 3ms minimum when replaying HPD per spec
	 *
	 * TODO(b/159761215): This should be FSM timeout
	 * in hpd_update(), but code is noncompliant with
	 * DP VESA AltMode Spec. Even using the define
	 * HPD_USTREAM_DEBOUNCE_LVL is inappropriate.
	 *
	 *  Use usleep(3000); as a workaround.
	 */
