			...
			uint32_t *payload)
{
	...
	/*
	 * Enter safe mode before sending the safe mode information to the
	 * port-partner/cable.
	 * Ref: USB Power Delivery Specification Rev 3.0, Version 2.0
	 * Figure 8-60 DFP to UFP Enter Mode, and Figure 8-62 DFP to
	 * Cable Plug Enter Mode.
	 */
