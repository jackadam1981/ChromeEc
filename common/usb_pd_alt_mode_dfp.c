...
static int command_mfoverride(int argc, char **argv)
{
	char *e;
	int port;
	...
	ccprintf("Port: %d multi function override is %s ", port, argv[2]);
	return EC_SUCCESS;
}
DECLARE_CONSOLE_COMMAND(mfoverride, command_mfoverride, "port[0|1] [on | off]",
