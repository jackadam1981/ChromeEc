...
#if !defined(CONFIG_USB_PD_TCPMV3) && defined(CONFIG_USB_POWER_DELIVERY) && \
...
#if defined(CONFIG_USB_PD_TCPMV3)
		/* TODO: Add support for PDC Chip Type */
#else
		/* Only available on boards that use TCPMV3 */
		return EC_RES_UNAVAILABLE; /* LCOV_EXCL_LINE */
#endif /* CONFIG_USB_PD_TCPMV3 */
		break;
	default:
