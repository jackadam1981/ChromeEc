...
test_mockable size_t system_usable_ram_end(void)
{
	...
	return (size_t)jdata - jdata->jump_tag_total;
}
...
{
	size_t my_addr = (size_t)system_get_image_copy - CONFIG_FLASH_BASE;
 ...
 */
static void jump_to_image(size_t init_addr)
{
...
const char *system_get_version(enum system_image_copy_t copy)
{
	...
	addr += ((size_t)&version_data - get_base(system_get_image_copy()));
