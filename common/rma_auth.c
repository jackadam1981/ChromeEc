...
static void enter_rma_mode(void)
{
	...
	/*
	 * The presence of this state is the indication that WP shouls not be
	 * enalbed. Failure to create it will prevent activating RMA mode, not
	 * much we can do at this point as far as informing the AP is
	 * concerned, as this function runs after the vendor command was
	 * processed.
	 *
	 * Worse comes to worst the user will have to repeat RMA enabling
	 * process.
	 */
