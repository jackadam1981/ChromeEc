...
void vboot_main(void)
{
	...
	if (IS_ENABLED(CONFIG_HIBERNATE)
		...
		/*
		 * EC doesn't hibernate from G# when AC is present thus if AC is
		 * not present here, it implies we woke up by power button or by
		 * lid. Clear AP_IDLE to avoid interfering with the AP boot.
		 */
