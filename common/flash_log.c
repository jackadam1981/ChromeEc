 ...
 * multiple of the physical flash write size. Padding bytes value is not
 * defined. The users of this service are oblivious to the padding, they write
 * and read back entries of arbitrary not necessarily aligned sizes in
 * 0..MAX_FLASH_LOG_PAYLOAD_SIZE range.
 *
