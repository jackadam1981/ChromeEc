...
void __attribute__((weak)) i2c_start_xfer_notify(int port)
{
	/* Default weak implementation (does nothing). */
}

void __attribute__((weak)) i2c_end_xfer_notify(int port)
{
	/* Default weak implementation (does nothing). */
}
