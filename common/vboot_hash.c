...
/*
 * True if hash computation is done progressively through deferred function.
 * Flase if hash computation is done synchronously (with a blocking call).
 */
 ...
 * @param deferred	See is_deferred.
 * @return
 */
