...
#ifdef CONFIG_ZEPHYR
	/*
	 * For Zephyr: to convert an i2c port enum value to a port number in
	 * mutex_lock(), this number should be soc's i2c port where the i2
	 * device is connected to.
	 */
	port = (i2c_get_physical_port(port) < 0) ?
