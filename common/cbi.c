 ...
 *
 * TODO: On error (I2C or bad contents), retry and set initialized to -1
 * to avoid attempting reads doomed to fail.
 */
...
static int hc_cbi_set(struct host_cmd_handler_args *args)
{
	...
	/* This creates wrong CRC for newer versions unless we overwrite
	 * total_size and version as well. */
