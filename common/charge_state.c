...
/* Override with charger or board specific function if supported. */
__attribute__((weak)) int enable_discharge_on_ac(void)
{
	return EC_ERROR_UNIMPLEMENTED;
}

/* Override with charger or board specific function if supported. */
__attribute__((weak)) int disable_discharge_on_ac(void)
{
	return EC_ERROR_UNIMPLEMENTED;
}
