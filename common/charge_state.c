...
static void sustain_battery_soc(void)
{
	 ...
	 *                              lower    upper
	 *
	 * The switch statement below allows the sustainer to start from
	 * anywhere soc = 0% ~ 100%, including restart with new limits. It sets
	 * mode to NORMAL to charge till the soc hits the lower limit or sets
	 * mode to DISCHARGE to discharge till the soc hits the upper limit.
	 *
