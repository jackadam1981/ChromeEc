...
/*
 * Number of characters to print before pause.
 * Let's pause a little bit twice during watchdog period.
 */
#define CHARS_TO_PAUSE	     ((CONFIG_UART_BAUD_RATE / 10) *                   \
				(CONFIG_WATCHDOG_PERIOD_MS / 2 / 1000))
