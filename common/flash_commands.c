...
int flash_command_get_info(uint8_t *data)
{
	...
	return sizeof(struct ec_response_flash_info);
}
...
int flash_command_checksum(uint8_t *data)
{
	...
	return sizeof(struct ec_response_flash_checksum);
}
...
int flash_command_read(uint8_t *data)
{
	...
	return sizeof(struct ec_response_flash_read);
}
...
int flash_command_wp_get_state(uint8_t *data)
{
	...
	return sizeof(struct ec_response_flash_wp_enable);
}
...
int flash_command_wp_get_range(uint8_t *data)
{
	...
	return sizeof(struct ec_response_flash_wp_range);
}
