...
struct fp_sensor_interface_t fp_driver_mock = {
	FP_SENSOR_TYPE_UNKNOWN,	       &fp_sensor_init_mock,
	&fp_sensor_deinit_mock,	       &fp_sensor_get_info_mock,
	&fp_sensor_low_power_mock,     &fp_sensor_configure_detect_mock,
	&fp_sensor_finger_status_mock, &fp_sensor_acquire_image_with_mode_mock,
	&fp_finger_enroll_mock,	       &fp_finger_match_mock,
	&fp_enrollment_begin_mock,     &fp_enrollment_finish_mock,
	&fp_maintenance_mock
};
