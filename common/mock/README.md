...
for a given mock that acts as the settings for the mock implementation.
For example, a field may control what value is returned by a provided function.
The mock user can then modify the fields of this struct to change the
mock's behavior.
