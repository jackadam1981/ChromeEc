...
This name is defined in [common/build.mk](../build.mk) and referenced
...
* Add an new entry in [common/build.mk](../build.mk)
  (under the `# Mocks` section) that is conditioned on your mock's name.
...
in [common/build.mk](../build.mk).

Example line from [common/build.mk](../build.mk):
