...
static int mock_select_rp_value(int port, int rp)
{
	static const char *const names[] = {
		[TYPEC_RP_USB] = "USB-DEFAULT",
		[TYPEC_RP_1A5] = "1A5",
		[TYPEC_RP_3A0] = "3A0",
		[TYPEC_RP_RESERVED] = "RESERVED",
	};
	...
	ccprints("[TCPC] Setting host side Rp to %s", names[rp]);
...
static int mock_set_cc(int port, int pull)
{
	...
	ccprints("[TCPC] Setting host side CC to %s", names[pull]);
...
static int mock_set_polarity(int port, enum tcpc_cc_polarity polarity)
{
	static const char *const names[] = {
		[POLARITY_CC1] = "CC1",
		[POLARITY_CC2] = "CC2",
		[POLARITY_CC1_DTS] = "CC1 DTS",
		[POLARITY_CC2_DTS] = "CC2 DTS",
	};
	...
	ccprints("[TCPC] Setting polarity to %s", names[polarity]);
...
static int mock_set_msg_header(int port, int power_role, int data_role)
{
	...
	ccprints("[TCPC] header set to %s %s",
