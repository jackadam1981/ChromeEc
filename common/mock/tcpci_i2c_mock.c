...
static void tcpci_reset_register_defaults(void)
{
	...
	value = TCPC_REG_CONFIG_STD_OUTPUT_AUDIO_CONN_N |
		TCPC_REG_CONFIG_STD_OUTPUT_DBG_ACC_CONN_N;
	tcpci_regs[TCPC_REG_CONFIG_STD_OUTPUT].value =		value;

	value = TCPC_REG_POWER_CTRL_VOLT_ALARM_DIS |
		TCPC_REG_POWER_CTRL_VBUS_VOL_MONITOR_DIS;
	tcpci_regs[TCPC_REG_POWER_CTRL].value =			value;

	value = TCPC_REG_FAULT_STATUS_ALL_REGS_RESET;
	tcpci_regs[TCPC_REG_FAULT_STATUS].value =		value;

	value = TCPC_REG_DEV_CAP_1_SOURCE_VBUS |
		TCPC_REG_DEV_CAP_1_SINK_VBUS |
		TCPC_REG_DEV_CAP_1_PWRROLE_SRC_SNK_DRP |
		TCPC_REG_DEV_CAP_1_SRC_RESISTOR_RP_3P0_1P5_DEF;
	tcpci_regs[TCPC_REG_DEV_CAP_1].value =			value;
