...
struct fp_sensor_interface fp_driver_mock = {
	...
	.sensor_init = &fp_sensor_init_mock,
	.sensor_deinit = &fp_sensor_deinit_mock,
	.sensor_get_info = &fp_sensor_get_info_mock,
	.sensor_low_power = &fp_sensor_low_power_mock,
	.sensor_configure_detect = &fp_sensor_configure_detect_mock,
	.sensor_finger_status = &fp_sensor_finger_status_mock,
	.sensor_acquire_image_with_mode_ =
		&fp_sensor_acquire_image_with_mode_mock,
	.finger_enroll = &fp_finger_enroll_mock,
	.finger_match = &fp_finger_match_mock,
	.enrollment_begin = &fp_enrollment_begin_mock,
	.enrollment_finish = &fp_enrollment_finish_mock,
	.maintenance = &fp_maintenance_mock,
