...
/* Type-C states */
DECLARE_STATE(tc, disabled, true);
DECLARE_STATE(tc, unattached_snk, false);
DECLARE_STATE(tc, attach_wait_snk, false);
DECLARE_STATE(tc, attached_snk, true);

/* Super States */
DECLARE_STATE(tc, host_rard, false);
DECLARE_STATE(tc, host_open, false);
DECLARE_STATE(tc, vbus_cc_iso, false);
