...
test_mockable const int supplier_priority[] = {
	...
	[CHARGE_SUPPLIER_SAMSUNG_CHARGER] = 8,
	[CHARGE_SUPPLIER_APPLE_0_5A_CHARGER] = 9,
	[CHARGE_SUPPLIER_APPLE_1_0A_CHARGER] = 10,
	[CHARGE_SUPPLIER_APPLE_2_1A_CHARGER] = 11,
	[CHARGE_SUPPLIER_APPLE_2_4A_CHARGER] = 12
#endif
};
