...
void charge_manager_leave_safe_mode(void)
{
	 ...
	 * transition, which could happen when the charge manager leaves safe
	 * mode because it drops a CAP_UNKNOWN and CAP_DUALROLE port previously
	...
	if (IS_ENABLED(CONFIG_CHARGE_MANAGER) &&
			dualrole_capability[charge_port] != CAP_DEDICATED)
