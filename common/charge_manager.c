 ...
 *
 * TODO: Save the SOC in NVRAM and update the discharge rates dynamically when
 * the system wake up from cutoff or hibernation.
 *
 * TODO: We probably want to use mA/h to more accurately estimate discharge
 * rates and calculate thresholds.
 */
