...
static void charge_manager_refresh(void)
{
	...
	timestamp_t ts_cm_entry_to_refresh = get_time();
	...
	pd_record_timestamp(new_port, PD_INTERVAL_CM_ENTRY_TO_RUN_CM_REFRESH,
			    PD_END, ts_cm_entry_to_refresh);

	pd_record_timestamp(new_port, PD_INTERVAL_CM_REFRESH_TO_PPC, PD_START,
			    ts_cm_entry_to_refresh);
