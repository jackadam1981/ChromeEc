 ...
 * way of determining the actual dualrole capability of the charger, so just
 * assume that it is dual-role. In addition, if no battery is present, the
 * charger may be our only source of power, so don't cut it off.
 */
