...
static volatile char PRESERVE_LOGS_SECT(preserve_console_logs)
			tx_buf[CONFIG_UART_TX_BUF_SIZE] __uncached;
static volatile int PRESERVE_LOGS_SECT(preserve_console_logs) tx_buf_head;
static volatile int PRESERVE_LOGS_SECT(preserve_console_logs) tx_buf_tail;
...
static int PRESERVE_LOGS_SECT(preserve_console_logs) tx_checksum;
