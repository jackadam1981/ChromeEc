...
DECLARE_STATE(tc, error_recovery, false);
DECLARE_STATE(tc, unattached_snk, false);
DECLARE_STATE(tc, attach_wait_snk, false);
DECLARE_STATE(tc, attached_snk, true);
DECLARE_STATE(tc, try_snk, false);
DECLARE_STATE(tc, unattached_src, false);
DECLARE_STATE(tc, attach_wait_src, false);
DECLARE_STATE(tc, try_wait_src, false);
DECLARE_STATE(tc, attached_src, false);
DECLARE_STATE(tc, ct_try_snk, true);
DECLARE_STATE(tc, ct_attach_wait_unsupported, true);
DECLARE_STATE(tc, ct_attached_unsupported, true);
DECLARE_STATE(tc, ct_unattached_unsupported, true);
DECLARE_STATE(tc, ct_unattached_vpd, true);
DECLARE_STATE(tc, ct_disabled_vpd, false);
DECLARE_STATE(tc, ct_attached_vpd, false);
DECLARE_STATE(tc, ct_attach_wait_vpd, true);

/* Super States */
DECLARE_STATE(tc, host_rard_ct_rd, false);
DECLARE_STATE(tc, host_open_ct_open, false);
DECLARE_STATE(tc, vbus_cc_iso, false);
DECLARE_STATE(tc, host_rp3_ct_rd, false);
DECLARE_STATE(tc, host_rp3_ct_rpu, false);
DECLARE_STATE(tc, host_rpu_ct_rd, false);
