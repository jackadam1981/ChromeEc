...
static uint8_t ir357x_settings[][2] = {
	{0x10, 0xa2},{0x11, 0x22},{0x12, 0x88},{0x13, 0x10},
	...
	{0x28, 0x00},{0x29, 0x60},{0x2a, 0x15},{0x2b, 0x26},
	{0x2c, 0xb6},{0x2d, 0x60},{0x2e, 0x1c},{0x2f, 0x2b},
	{0x30, 0xf6},{0x31, 0x14},{0x32, 0x90},{0x33, 0x4d},
	{0x34, 0x75},{0x35, 0x44},{0x36, 0x44},{0x37, 0x09},
	{0x38, 0xc4},{0x39, 0x20},{0x3a, 0xe0},{0x3b, 0x00},
	{0x3c, 0x00},{0x3d, 0xaa},{0x3e, 0x00},{0x3f, 0x00},
	{0x40, 0x50},{0x41, 0x40},{0x42, 0x00},{0x43, 0x00},
	{0x44, 0x00},{0x45, 0x00},{0x46, 0x00},{0x47, 0x00},
	{0x48, 0x0c},{0x49, 0x0f},{0x4a, 0x0a},{0x4b, 0x40},
	{0x4c, 0x80},{0x4d, 0x40},{0x4e, 0x80},
	{0x51, 0x00},{0x52, 0x45},{0x53, 0x55},
	{0x54, 0x23},{0x55, 0x00},{0x56, 0x77},{0x57, 0x04},
	{0x58, 0x62},{0x59, 0x74},{0x5a, 0x32},{0x5b, 0x04},
	{0x5c, 0x33},{0x5d, 0x05},{0x5e, 0x03},{0x5f, 0x35},
	{0x60, 0x32},{0x61, 0x00},{0x62, 0xd8},{0x63, 0x00},
	{0x64, 0x52},{0x65, 0x00},{0x66, 0x00},{0x67, 0x87},
	{0x68, 0x80},{0x69, 0x00},{0x6a, 0x00},{0x6b, 0x00},
	{0x6c, 0x00},{0x6d, 0xff},{0x6e, 0x06},{0x6f, 0xff},
	{0x70, 0xff},{0x71, 0x20},{0x72, 0x00},{0x73, 0x00},
