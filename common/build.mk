...
common-$(CONFIG_KBLIGHT_RUNTIME)+=kblight.o
common-$(CONFIG_KBLIGHT_RUNTIME_I2C)+=i2c_kblight.o
common-$(CONFIG_KBLIGHT_RUNTIME_PWM)+=pwm_kblight.o
common-$(CONFIG_KBLIGHT_STATIC_PWM)+=pwm_kblight.o
common-$(CONFIG_KBLIGHT_STATIC_PWM)+=kblight.o
