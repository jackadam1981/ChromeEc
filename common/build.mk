...
common-$(CONFIG_KEYBOARD_PROTOCOL_MKBP)+=mkbp_fifo.o
common-$(CONFIG_KEYBOARD_PROTOCOL_MKBP)+=mkbp_input_devices.o
common-$(CONFIG_MKBP_INPUT_DEVICES)+=mkbp_fifo.o
common-$(CONFIG_MKBP_INPUT_DEVICES)+=mkbp_input_devices.o
