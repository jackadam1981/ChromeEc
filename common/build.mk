...
common-y=util.o shared_mem.o version.o queue.o
ifneq "$(EMU_BUILD)" "y"
	common-y+=main.o system_common.o hooks.o gpio_common.o printf.o
	common-y+=uart_buffering.o console_output.o memory_commands.o
endif
