...
$(out)/touchpad_fw_hash.h.new: $(out)/util/gen_touchpad_hash $(TOUCHPAD_FW)
	$(call quiet,tp_hash,TPHASH )

.PHONY: $(out)/touchpad_fw_hash.h.new
endif
