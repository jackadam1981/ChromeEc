...
$(out)/touchpad_fw_hash.bin: $(out)/touchpad_fw_hash.bin.new
	@cmp -s $@ $< || mv $< $@

$(out)/touchpad_fw_hash.bin.new: $(out)/util/gen_touchpad_hash $(TOUCHPAD_FW)
	$(call quiet,tp_hash,TPHASH )

.PHONY: $(out)/touchpad_fw_hash.bin.new
endif
