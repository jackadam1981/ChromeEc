...
common-$(CONFIG_BATTERY_DAISY)+=battery_daisy.o
common-$(CONFIG_BATTERY_SNOW)+=battery_snow.o
common-$(CONFIG_BATTERY_PIT)+=battery_pit.o
common-$(CONFIG_BATTERY_PUPPY)+=battery_puppy.o
