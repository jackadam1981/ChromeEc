...
static struct battery_power_info pwr_info; /* Struct to shuttle information
                                              fromt battery to periodic update */
...
static void avg_power_update(void)
{
	...
	avg_pwr_info.avg_power = avg_pwr_info.sample_sum / avg_pwr_info.samples_recorded;
	avg_pwr_info.ptr++;
