...
#else
		switch (charge_manager_get_active_charge_supplier()) {
		case CHARGE_SUPPLIER_NONE:
		case CHARGE_SUPPLIER_VBUS:
			/*
			 * Initially charger is detected as VBUS supplier type,
			 * hence return ilim once charger type is detected.
			 */
			return CHARGE_CURRENT_UNINITIALIZED;
		case CHARGE_SUPPLIER_PD:
			return (PD_MAX_POWER_MW * 1000) / PD_MAX_VOLTAGE_MV;
		default:
			return PD_MAX_CURRENT_MA;
		}
#endif /* CONFIG_USB_POWER_DELIVERY */
