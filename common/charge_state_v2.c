...
#else
int board_is_base_connected(void) { return 0; }
#endif
...
/**
 * Setup current settings for base, and record previous values, and if the base
 * is responsive.
 *
