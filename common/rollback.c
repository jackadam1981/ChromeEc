 ...
 *                           be a negative value if entropy is provided (in that
 *                           case the current minimum version is kept).
 * @param entropy	     Entropy to be added to rollback block secret (can
 *                           be NULL, in that case no entropy is added).
