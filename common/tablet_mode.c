 ...
 */
#ifndef CONFIG_GMR_SENSOR_DEBOUNCE_US_CUSTOM
#define GMR_SENSOR_DEBOUNCE_US (CONFIG_LID_DEBOUNCE_US + 10 * MSEC)
#else
#define GMR_SENSOR_DEBOUNCE_US CONFIG_GMR_SENSOR_DEBOUNCE_US_CUSTOM
#endif
