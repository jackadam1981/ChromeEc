...
#if defined(CONFIG_USB_TYPEC_VPD_CT)
#include "usb_tc_vpd_ct_sm.h"
...
#if defined(CONFIG_ENABLE_USB_TYPEC_TESTING)
int get_typec_state_id(int port)
{
	return get_state_id(SM_OBJ(tc[port].obj));
}
#endif
