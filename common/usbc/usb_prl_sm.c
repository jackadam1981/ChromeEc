...
#define RCH_CLR_FLAG(port, flag) \
	deprecated_atomic_clear_bit(&rch[port].flags, (flag))
...
#define TCH_CLR_FLAG(port, flag) \
	deprecated_atomic_clear_bit(&tch[port].flags, (flag))
...
#define PRL_TX_CLR_FLAG(port, flag) \
	deprecated_atomic_clear_bit(&prl_tx[port].flags, (flag))
...
#define PRL_HR_CLR_FLAG(port, flag) \
	deprecated_atomic_clear_bit(&prl_hr[port].flags, (flag))
...
#define PDMSG_CLR_FLAG(port, flag) \
	deprecated_atomic_clear_bit(&pdmsg[port].flags, (flag))
