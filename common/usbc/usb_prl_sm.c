...
/* Flag to note an AMS is currently is starting */
#define PRL_FLAGS_START_AMS               BIT(1)
/* Flag to note an AMS is no longer is ending */
...
/* Flag to note a message transmission should be aborted */
#define PRL_FLAGS_ABORT                   BIT(9)
/* Flag to note current message transmission should use chunking */
