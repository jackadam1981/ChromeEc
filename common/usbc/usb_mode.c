...
enum usb_rev30_ss get_usb4_cable_speed(int port)
{
	 ...
	 * speed.
	 * Note: Some cables correctly specify TBT speed Gen3 but incorrectly
	 * specify USB speed Gen2. Support these cables by using USB Gen3
	 * whenever a cable specifies TBT Gen3. See b:401262704.
	 */
