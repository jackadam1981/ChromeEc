...
static atomic_t prl_flags[CONFIG_USB_PD_PORT_MAX_COUNT];
...
/*
 * 7-bit timers running at 5ms
 *
 * Bit 7 is set if the timer is enabled, else its disabled
 * Bits 6:0 are incremented every 5ms for a max time of 635ms
 */
