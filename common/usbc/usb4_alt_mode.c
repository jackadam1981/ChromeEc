...
enum usb4_enter_usb_status {
	USB4_ENTER_USB_FAILURE,
	USB4_ENTER_USB_SUCCESS,
};
...
static void usb4_debug_prints(int port, enum usb4_enter_usb_status usb4_status)
{
...
void usb4_entry_failed(int port)
{
	...
	usb4_debug_prints(port, USB4_ENTER_USB_FAILURE);
...
void enter_usb_acked(int port, enum tcpm_transmit_type type)
{
	...
	case USB4_ENTER_SOP:
		...
		usb4_debug_prints(port, USB4_ENTER_USB_SUCCESS);
		break;
	default:
		usb4_entry_failed(port);
	}
