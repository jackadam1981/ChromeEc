...
void tc_state_init(int port)
{
	...
	/*
	 * If this is non-EFS2 device, battery is not present or detected and
	 * EC RO doesn't keep power-on reset flag after reset caused by H1,
	 * then don't apply CC open because it will cause brown out.
	 *
