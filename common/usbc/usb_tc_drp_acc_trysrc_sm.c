...
{
	//// changes in this function is just for  pujjoga
...
{
	pd_record_timestamp_start(port, PD_INTERVAL_ATTACHED_SNK_EXIT);//change in this function are common for anraggar and pujjoga
	if (!TC_CHK_FLAG(port, TC_FLAGS_REQUEST_PR_SWAP)) {
		/*
...
static void tc_cc_open_entry(const int port)
{
	...
	pd_record_timestamp_start(port, PD_INTERVAL_CC_OPEN_ENTRY);	//change in this function are common for anraggar and pujjoga
