...
static void tc_attached_src_entry(const int port)
{
	 ...
	 * changing the RoleControl register. Due to that, we have to ignore
	 * CC_NONE state before PD_T_SRC_DISCONNECT delay has elapsed.
	 * From the USB Type-C specification 4.5.2.2.9.2:
