...
#define TC_FLAGS_WAKE_FROM_LPM          BIT(23)/* CC lines have changed */
#define TC_FLAGS_POWER_STATE_CHANGE     BIT(24)/* Chipset Power state changed */
 ...
 * they are set.
 */
#define CLR_NONE_LPM_FLAGS(port) (tc[port].flags &= \
(TC_FLAGS_AUTO_TOGGLE_SUPPORTED | TC_FLAGS_LPM_REQUESTED | \
