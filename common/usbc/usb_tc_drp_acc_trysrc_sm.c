...
/* Flag to note that TCPC controls DRP toggling */
#define TC_FLAGS_TCPC_DRP_TOGGLE        BIT(22)
/* Flag to note we should wake form LPM */
#define TC_FLAGS_WAKE_FROM_LPM          BIT(23)
/* Flag to note a chipset power state has changed */
#define TC_FLAGS_POWER_STATE_CHANGE     BIT(24)
/* Flat to note the TCPM supports auto toggle */
