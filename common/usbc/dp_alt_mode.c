					    ...
					    uint32_t *vdm)
{
	...
	case DP_STATUS_ACKED:
		...
		/*
		 * According to VESA DisplayPort Alt Mode on USB Type-C Standard Version 2.0.
		 * 5.2.4 DisplayPort Configure Command
		 * Before issuing the command, the DFP_U shall place the USB-C pins that are
		 * to be reconfigured to DisplayPort Configuration into the Safe state,
		 * as specified in USB-C.
		 */
