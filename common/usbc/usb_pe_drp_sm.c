...
/* Cable VDOs */
struct passive_cable_vdo {
	union {
		struct passive_cable_vdo_rev30 pvdo;
		uint32_t raw_value;
	};
};

struct active_cable_vdo_1 {
	union {
		struct active_cable_vdo_rev30 avdo1;
		uint32_t raw_value;
	};
};

struct active_cable_vdo_2 {
	union {
		struct active_cable_vdo2_rev30 avdo2;
		uint32_t raw_value;
	};
};
...
static struct policy_engine {
	...
	struct passive_cable_vdo  p_cable_vdo;
	struct active_cable_vdo_1 a_cable_vdo1;
	struct active_cable_vdo_2 a_cable_vdo2;
	int32_t ama_vdo;
	int32_t vpd_vdo;
