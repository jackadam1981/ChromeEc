...
static void pe_prs_snk_src_transition_to_off_entry(int port)
{
	...
	/*
	 * THE FRS diagram in the PD spec does not show turning SNK
	 * power off.  The text below does mention that it should
	 * happen here.  Going to follow the text and be aware if
	 * this area seems to not work correctly for FRS, then
	 * guard turning power off to only do so for PRS
	 */
