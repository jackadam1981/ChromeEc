...
union sido dpm_get_source_info_msg(int port)
{
	...
	source_info.sido1.port_maximum_pdp = (CONFIG_USB_PD_3A_PORTS > 0) ? 15 :
									    7;

	/* Max PDP: 5V * 3A = 15W; 5V * 1.5A = 7.5W */
	source_info.sido2.port_maximum_pdp = (CONFIG_USB_PD_3A_PORTS > 0) ? 30 :
									    15;
