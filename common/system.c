...
const char *system_get_version(enum system_image_copy_t copy)
{
	...
	/*
	 * Read from directly from mapped flash, if available.
	 * Notice CONFIG_CDRAM_BASE and CONFIG_FLASH_BASE are not the same
	 * if hardware support flash memory mapping.
	 */
