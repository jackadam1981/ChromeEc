...
{
    memcpy(current_region_code.region_code, args->params, sizeof(current_region_code.region_code));
	
	cprints(2,"hahahhahahha!!!!!!:%s", current_region_code.region_code );
	return EC_SUCCESS;
}
DECLARE_HOST_COMMAND(EC_CMD_TRANSMIT_REGION_CODE, board_get_region_code, EC_VER_MASK(0));
