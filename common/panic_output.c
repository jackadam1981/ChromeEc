...
/* Called from the panic handler. Triggers a nested crash when enabled. */
void command_crash_nested_handler(void)
{
	...
	command_crash(command_crash_nested_argc - 1,
