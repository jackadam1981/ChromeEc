...
#ifdef CONFIG_LED_POWER_COLOR_GREEN
#define EC_LED_COLOR_POWER EC_LED_COLOR_GREEN
#define POWER_LED_COLOR LED_GREEN
#else
#define EC_LED_COLOR_POWER EC_LED_COLOR_WHITE
#define POWER_LED_COLOR LED_WHITE
#endif
