...
void lp5562_init(void)
{
	...
	lp5562_write(LP5562_REG_CONFIG, 0x1);
	lp5562_write(LP5562_REG_LED_MAP, 0);
}
/* TODO(vpalatin): debug using the I2C early in the HOOK_INIT */
#if 0
DECLARE_HOOK(HOOK_INIT, lp5562_init, HOOK_PRIO_DEFAULT);
#endif
