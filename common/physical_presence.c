...
static bool pp_type_is_extended;

static const char * const pp_desc[] = {
	[PP_DETECT_SHORT] = "short",
	[PP_DETECT_LONG] = "long",
	[PP_DETECT_EXTENDED] = "extended",
};
BUILD_ASSERT(ARRAY_SIZE(pp_desc) == PP_DETECT_TYPE_COUNT);
				...
				void (*callback)(void))
{
	...
	CPRINTS("PP start %s", pp_desc[type]);
