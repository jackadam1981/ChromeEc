...
fp_command_establish_pk_keygen(struct host_cmd_handler_args *args)
{
	...
	struct ec_response_fp_establish_pk_keygen *r =
		static_cast<struct ec_response_fp_establish_pk_keygen *>(
			args->response);
...
fp_command_establish_pk_wrap(struct host_cmd_handler_args *args)
{
	...
	const struct ec_params_fp_establish_pk_wrap *params =
		static_cast<const struct ec_params_fp_establish_pk_wrap *>(
			args->params);
	struct ec_response_fp_establish_pk_wrap *r =
		static_cast<struct ec_response_fp_establish_pk_wrap *>(
			args->response);
	int ret;
...
static enum ec_status fp_command_load_pk(struct host_cmd_handler_args *args)
{
	...
	const struct ec_params_fp_load_pk *params =
		static_cast<const struct ec_params_fp_load_pk *>(args->params);
	int ret;
