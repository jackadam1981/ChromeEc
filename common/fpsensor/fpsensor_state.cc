...
#define FP_TEMPLATE_SECTION	\
	__attribute__((__section__(LINKER_DT_NODE_REGION_NAME(DT_NODELABEL(sram1_3)))))
#endif
#if 1
/* This buffer is used to communicate with sensor, which means it can not be cachable. */
