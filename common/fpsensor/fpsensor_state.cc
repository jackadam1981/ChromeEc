...
{
	CPRINTS("FPMCU STATE: fp_clear_finger_context");
...
{
	CPRINTS("FPMCU STATE: fp_clear_context");
	templ_valid = 0;
	templ_dirty = 0;
...
{
	CPRINTS("FPMCU STATE: fp_reset_and_clear_context");
...
{
	CPRINTS("FPMCU STATE: fp_get_next_event");
...
{
	CPRINTS("FPMCU STATE: fp_command_tpm_seed");
	const auto *params =
...
{
	CPRINTS("FPMCU STATE: fp_command_encryption_status");
	auto *r =
...
{
	CPRINTS("FPMCU STATE: fp_set_sensor_mode");
	int ret;
...
{
	CPRINTS("FPMCU STATE: fp_command_mode");
...
{
	CPRINTS("FPMCU STATE: fp_command_context");
	const auto *p =
...
{
	timestamp_t now;
	CPRINTS("FPMCU STATE: fp_enable_positive_match_secret");
	...
	uint8_t positive_match_secret[FP_POSITIVE_MATCH_SECRET_BYTES])
{
	...
	CPRINTS("FPMCU STATE: fp_read_match_secret");
...
{
	CPRINTS("FPMCU STATE: fp_command_read_match_secret");
	const auto *params =
