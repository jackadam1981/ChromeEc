...
# If HAS_TASK_FPSENSOR is "y".
ifneq (,$(filter y,$(HAS_TASK_FPSENSOR)))
...
all-obj-y+=$(_fpsensor_auth_crypto_stateless_obj)
endif # HAS_TASK_FPSENSOR or fpsensor projects.
...
else ifeq (fpsensor,$(findstring fpsensor,$(PROJECT))$(findstring stateless,$(PROJECT)))
all-obj-y+=$(_fpsensor_crypto_obj)
all-obj-y+=$(_fpsensor_state_without_driver_info_obj)
all-obj-y+=$(_fpsensor_auth_crypto_stateful_obj)
endif # HAS_TASK_FPSENSOR or stateful fpsensor projects.
