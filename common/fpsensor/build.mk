...
_fpsensor_auth_first_obj:=$(_fpsensor_dir)fpsensor_auth_first.o
...
$(out)/RW/$(_fpsensor_auth_first_obj): CFLAGS+=$(fpsensor_CFLAGS)
...
all-obj-$(HAS_TASK_FPSENSOR)+=$(_fpsensor_auth_first_obj)
