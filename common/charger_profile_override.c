			...
			int batt_vtg_max)
{
	 ...
	 * greater than the lower limit or the battery voltage is not in the
	 * charger profile voltage range, consider battery has high voltage
	 * range so that we charge at lower current limit.
	 */
