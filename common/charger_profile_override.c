			...
			int batt_vtg_max)
{
	...
	/*
	 * If the battery voltage reading is bad or the battery voltage is not
	 * in the charger profile voltage range, consider battery has high
	 * voltage range so that we charge at lower current limit.
	 */
	enum fast_chg_voltage_ranges voltage_range = VOLTAGE_RANGE_HIGH;
