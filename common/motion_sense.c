...
const vector_3_t orientation_modes[] = {
	[MOTIONSENSE_ORIENTATION_LANDSCAPE] = { 1, 0, 0 },
	[MOTIONSENSE_ORIENTATION_PORTRAIT] = { 0, 1, 0 },
	[MOTIONSENSE_ORIENTATION_UPSIDE_DOWN_PORTRAIT] = { 0, -1, 0 },
	[MOTIONSENSE_ORIENTATION_UPSIDE_DOWN_LANDSCAPE] = { -1, 0, 0 },
};
		...
		enum motionsensor_orientation orientation)
{
	...
	vector_3_t rotated_orientation_v, final_orientation_v;
	...
	rotate(rotated_orientation_v, landscape_ref, final_orientation_v);

	/* Convert to unique orientation using (2y + x + 4) % 5 */
	rotated_orientation = ((2 * final_orientation_v[1] +
			final_orientation_v[0] + 4) % 5);
