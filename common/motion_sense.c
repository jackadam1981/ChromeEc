...
/*
 * TDOD(crbug:498352):
 * For we collect the data every accel_interval.
 * For non FIFO sensor, we should set accel_interval high.
 * But if we haev a mix a FIFO and non FIFO sensors, setting it
