...
#if defined(CONFIG_ACCEL_FIFO) && \
    (!defined(CONFIG_ACCEL_FIFO_SIZE) || !defined(CONFIG_ACCEL_FIFO_THRES))
#error "For CONFIG_ACCEL_FIFO CONFIG_ACCEL_FIFO_SIZE and CONFIG_ACCEL_FIFO_THRES must also be defined"
#endif
