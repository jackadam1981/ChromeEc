...
void crc32_hash32(uint32_t *crc, uint32_t val)
{
	*crc = crc32_hash(*crc, &val, sizeof(uint32_t));
}

void crc32_hash16(uint32_t *crc, uint16_t val)
{
	*crc = crc32_hash(*crc, &val, sizeof(uint16_t));
}

uint32_t crc32_result(uint32_t *crc)
{
