...
#define OUTER_WINDOW \
	(CONFIG_OUTER_WINDOW_T / CONFIG_GESTURE_SAMPLING_INTERVAL_MS)
#define INNER_WINDOW \
	(CONFIG_INNER_WINDOW_T / CONFIG_GESTURE_SAMPLING_INTERVAL_MS)
#define MIN_INTERSTICE \
	(CONFIG_MIN_INTERSTICE_T / CONFIG_GESTURE_SAMPLING_INTERVAL_MS)
#define MAX_INTERSTICE \
	(CONFIG_MAX_INTERSTICE_T / CONFIG_GESTURE_SAMPLING_INTERVAL_MS)
