...
static void stillDetReset(struct still_det *still_det)
{
...
static int stillnessBatchComplete(struct still_det *still_det,
...
void stillDetInit(struct still_det *still_det, float var_threshold,
...
int stillDetUpdate(struct still_det *still_det, uint32_t sample_time,
