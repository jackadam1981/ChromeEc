...
#ifdef CONFIG_I2C_PASSTHRU_RESTRICTED
__attribute__((weak)) const struct i2c_param_t i2c_param_whitelist[] = {
};
__attribute__((weak)) const unsigned int i2c_param_whitelist_size =
		 ARRAY_SIZE(i2c_param_whitelist);
