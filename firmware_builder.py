...
BUNDLE_FILES = [
        ...
        (os.path.join(SCRIPT_DIR, 'board/cr50/rma_key_blob.x25519*'), ''),
        (os.path.join(SCRIPT_DIR, 'board/cr50/rma_key_blob.p256*'), ''),
        (os.path.join(SCRIPT_DIR, 'util/signer/fuses.xml'), ''),
]
