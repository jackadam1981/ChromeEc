...
mod tests {
    ...
    fn test_u8_enum_conversion() {
        assert!(matches!(TestU8::from_u8(1), Some(TestU8::One)));
        assert!(matches!(TestU8::from_u8(8), Some(TestU8::Eight)));
        assert!(matches!(TestU8::from_u8(32), Some(TestU8::ThirtyTwo)));
    ...
    fn test_u8_enum_equals() {
        assert!(TestU8::One == TestU8::One);
        assert!(TestU8::Eight == TestU8::Eight);
        assert!(TestU8::ThirtyTwo == TestU8::ThirtyTwo);

        assert!(TestU8::One != TestU8::Eight);
        assert!(TestU8::Eight != TestU8::ThirtyTwo);
        assert!(TestU8::ThirtyTwo != TestU8::One);
    }
    ...
    fn test_u16_enum_conversion() {
        assert!(matches!(TestU16::from_u16(0), Some(TestU16::Zero)));
        assert!(matches!(TestU16::from_u16(1), Some(TestU16::One)));
        assert!(matches!(TestU16::from_u16(10), Some(TestU16::Ten)));
        assert_eq!(TestU16::END, 11);
    ...
    fn test_u16_enum_equals() {
        assert!(TestU16::Zero == TestU16::Zero);
        assert!(TestU16::One == TestU16::One);
        assert!(TestU16::Ten == TestU16::Ten);

        assert!(TestU16::Zero != TestU16::One);
        assert!(TestU16::One != TestU16::Ten);
        assert!(TestU16::Ten != TestU16::Zero);
    }
    ...
    fn test_usize_enum_conversion() {
        assert!(matches!(TestUsize::from_usize(0), Some(TestUsize::Zero)));
        assert!(matches!(TestUsize::from_usize(1), Some(TestUsize::One)));
        assert!(matches!(TestUsize::from_usize(2), Some(TestUsize::Two)));
    ...
    fn test_usize_enum_equals() {
        assert!(TestUsize::Zero == TestUsize::Zero);
        assert!(TestUsize::One == TestUsize::One);
        assert!(TestUsize::Two == TestUsize::Two);
        assert!(TestUsize::Zero != TestUsize::One);
        assert!(TestUsize::One != TestUsize::Two);
        assert!(TestUsize::Two != TestUsize::Zero);
    }
    ...
    fn test_u64_enum_conversion() {
        assert!(matches!(TestU64::from_u64(0), Some(TestU64::Zero)));
        assert!(matches!(
            TestU64::from_u64(0xFFFF_FFFF),
            Some(TestU64::MaxU32)
        ));
        assert!(matches!(
            TestU64::from_u64(0x1_0000_0000),
            Some(TestU64::U64)
        ));
    ...
    fn test_u64_enum_equals() {
        assert!(TestU64::Zero == TestU64::Zero);
        assert!(TestU64::MaxU32 == TestU64::MaxU32);
        assert!(TestU64::U64 == TestU64::U64);
        assert!(TestU64::Zero != TestU64::MaxU32);
        assert!(TestU64::MaxU32 != TestU64::U64);
        assert!(TestU64::U64 != TestU64::Zero);
    }
