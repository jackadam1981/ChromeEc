...
const sMfltCoredumpRegion *memfault_platform_coredump_get_regions(
  ...
  s_coredump_regions[0] = MEMFAULT_COREDUMP_MEMORY_REGION_INIT(crash_info->stack_address, MEMFAULT_STACK_COLLECTION_SIZE);
  s_coredump_regions[1] = MEMFAULT_COREDUMP_MEMORY_REGION_INIT(BSS_START, MEMFAULT_BSS_COLLECTION_SIZE);
  s_coredump_regions[2] = MEMFAULT_COREDUMP_MEMORY_REGION_INIT(DATA_START, MEMFAULT_DATA_COLLECTION_SIZE);
