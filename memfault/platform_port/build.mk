...
MEMFAULT_COMPONENTS := demo core util panics
...
memfault_COMMON_WARN=-Wall -Wundef -Werror-implicit-function-declaration \
...
$(out)/RW/memfault/%.o: override COMMON_WARN=$(memfault_COMMON_WARN)
$(out)/RO/memfault/%.o: override COMMON_WARN=$(memfault_COMMON_WARN)
