...
int memfault_platform_init(void) {
	...
	MEASURE_TIME_RV(memfault_events_storage_boot(s_ram_backed_events_region, sizeof(s_ram_backed_events_region)), evt_storage, "memfault_events_storage_boot");
	...
	MEASURE_TIME(memfault_log_boot(s_ram_backed_log_region, sizeof(s_ram_backed_log_region)), "memfault_log_boot");
	...
	MEASURE_TIME(MEMFAULT_LOG_INFO("Hello"), "MEMFAULT_LOG_INFO");
	MEASURE_TIME(ccprintf("Hello"), "ccprintf");
