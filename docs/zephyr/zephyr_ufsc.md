...
The `CROS_EC_CBI_UFSC_PARSER` Kconfig option enables the driver that parses UFSC
fields from the devicetree and provides the necessary APIs.
...
`cros_cbi_ufsc_check_match()`. This is less error-prone and mirrors the legacy
