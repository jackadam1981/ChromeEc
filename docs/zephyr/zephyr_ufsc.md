...
*   **BIT 0-55, 64-119 (Standardized Firmware Configuration):** Contain
    standardized definitions for common hardware components (e.g., audio codecs,
    sensors).
*   **BIT 56-63 (AP OEM Customization Field):** Reserved for OEM/ODM partners to
    encode board-specific information for the AP use.
*   **BIT 120-127 (EC OEM Customization Field):** Reserved for OEM/ODM partners
