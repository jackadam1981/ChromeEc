...
Hibernate support puts the EC into the lowest operating power state.
...
[`cros-ec,hiberate-wake-pins`] node defines the interrupt signals that
...
[`cros-ec,hiberate-z5`] mode defines the GPIO connected to the EC used to
