...
:------------------------------------ | :-----------: | :--------------------------
`CONFIG_PLATFORM_EC_CBI_STORAGE_TYPE` |               | [`KconfigCBI_STORAGE_TYPE`]
`CONFIG_PLATFORM_EC_CBI_EEPROM`       | n             | [`KconfigCBI_EEPROM`]
`CONFIG_PLATFORM_EC_CBI_GPIO`         | n             | [`KconfigCBI_GPIO`]
...
[`KconfigCBI_STORAGE_TYPE`]: https://source.chromium.org/chromiumos/chromiumos/codesearch/+/main:src/platform/ec/zephyr/Kconfig.cbi?q=%22config%20PLATFORM_EC_CBI_STORAGE_TYPE%22&ss=chromiumos
[`KconfigCBI_EEPROM`]: https://source.chromium.org/chromiumos/chromiumos/codesearch/+/main:src/platform/ec/zephyr/Kconfig.cbi?q=%22config%20PLATFORM_EC_CBI_EEPROM%22&ss=chromiumos
[`KconfigCBI_GPIO`]: https://source.chromium.org/chromiumos/chromiumos/codesearch/+/main:src/platform/ec/zephyr/Kconfig.cbi?q=%22config%20PLATFORM_EC_CBI_GPIO%22&ss=chromiumos
