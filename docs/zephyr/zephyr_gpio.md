...
Set or get the GPIO value in the C source code directy using the `enum-name`
...
[Include GPIO drivers in system config]: https://github.com/zephyrproject-rtos/zephyr/blob/727ea490292255e3d0462f583fbc490a5c4936e4/drivers/gpio/Kconfig#L6
