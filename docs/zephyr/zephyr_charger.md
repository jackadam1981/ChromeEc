...
Use the [chgsup] command afterwards to view changes.
...
Use the [chgstate] command afterwards to view changes.
...
Use the [chargestate] [ectool] command afterwards to view changes.
...
Use the [chgsup] [EC console command] afterwards to view which port is the
charger supplier.
...
[chgsup]: ./zephyr_charger.md.md#chgsup
