...
If you want to use a local token database, this will require mounting your path
to the token database to the docker image.
...
```
%tokens on /tmp/cros_ec/tokens.bin
```
