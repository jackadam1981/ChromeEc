...
| Thermistors | [driver/temp_sensor/thermistor.c](../../driver/temp_sensor/thermistor.c) | Various analog thermistor configurations   * `thermistor_3V3_30K9_47K_4050B`  * `thermistor_3V0_22K6_47K_4050B`  * `thermistor_3V3_13K7_47K_4050B`  * `thermistor_3V3_51K1_47K_4050B`  See [zephyr/include/cros/thermistor/thermistor.dtsi](../../zephyr/include/cros/thermistor/thermistor.dtsi) and [zephyr/test/drivers/overlay.dts](../../zephyr/test/drivers/overlay.dts) |
...
In the thermistor type naming scheme, the first resistance value corresponds to the
pull-up resistor in the divider, and the second value indicates the thermistor’s.
