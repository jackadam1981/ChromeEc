...
The Kconfig option `PLATFORM_EC_USB_PD_TCPM` enables the selection of a [TCPC].
See the file [Kconfig.tcpc] for all Kconfig options related to this feature.
...
[Kconfig.ppc]: https://source.chromium.org/chromiumos/chromiumos/codesearch/+/main:src/platform/ec/zephyr/Kconfig.tcpc
[`DTS Bindings`]: https://source.chromium.org/chromiumos/chromiumos/codesearch/+/main:src/platform/ec/zephyr/dts/bindings/usbc/tcpc
