...
The `battfake` console command could be used to force the battery level and then
reboot the EC and then verify that the AP does not power up if the battery level
is too low.
