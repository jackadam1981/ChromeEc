...
| `CONFIG_PLATFORM_EC_CHARGER`                      | y       | [charger]       |
...
The following options are available only when sub-option `CONFIG_PLATFORM_EC_CHARGER=y`.

| Kconfig `CONFIG_PLATFORM_EC_CHARGER` sub-option | Default | Documentation            |
|:------------------------------------------------|:--------|:-------------------------|
| `PLATFORM_EC_CHARGER_SINGLE_CHIP`               | y       | [charger_single_chip]    |
| `PLATFORM_EC_OCPC`                              | n       | [charger_ocpc]           |
| `PLATFORM_EC_CHARGER_RUNTIME_CONFIG`            | n       | [charger_runtime_config] |
| `PLATFORM_EC_CHARGE_MANAGER`                    | y       | [charge_manager]         |
| `PLATFORM_EC_CHARGER_ISL9237`                   | n       | [CHARGER_ISL9237]        |
...
[charger]:https://source.chromium.org/chromiumos/chromiumos/codesearch/+/main:src/platform/ec/zephyr/Kconfig.battery?q=%22menuconfig%20PLATFORM_EC_CHARGER%22&ss=chromiumos
