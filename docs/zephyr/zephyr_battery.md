...
:------------------------------------- | :-----: | :------------
`CONFIG_PLATFORM_EC_BATTERY`           | n       | [kconfig_battery]

Kconfig sub-option                     | Default | Documentation
:------------------------------------- | :-----: | :------------
`CONFIG_PLATFORM_EC_CHARGER`           | y       | [kconfig_charger]


<!-- `CONFIG_PLATFORM_EC_SMART`             | n     |   [kconfig_battery_smart] -->
<!-- `CONFIG_PLATFORM_EC_BATTERY_PRESENT_CUSTOM`             | n     |   [kconfig_battery_smart] -->
<!-- `CONFIG_PLATFORM_EC_BATTERY_PRESENT_GPIO`             | n     |   [kconfig_battery_smart] -->
<!-- `CONFIG_PLATFORM_EC_USE_BATTERY_DEVICE_CHEMISTRY`             | n     |   [kconfig_battery_smart] -->
<!-- `CONFIG_PLATFORM_EC_BATTERY_DEVICE_CHEMISTRY`             | n     |   [kconfig_battery_smart] -->
<!-- `CONFIG_PLATFORM_EC_I2C_VIRTUAL_BATTERY`             | n     |   [kconfig_battery_smart] -->
<!-- `CONFIG_PLATFORM_EC_I2C_VIRTUAL_BATTERY_ADDR`             | n     |   [kconfig_battery_smart] -->
...
[kconfig_battery]:https://source.chromium.org/chromiumos/chromiumos/codesearch/+/main:src/platform/ec/zephyr/Kconfig.battery?q=%22menuconfig%20PLATFORM_EC_BATTERY%22&ss=chromiumos
[kconfig_charger]:https://source.chromium.org/chromiumos/chromiumos/codesearch/+/main:src/platform/ec/zephyr/Kconfig.battery?q=%22menuconfig%20PLATFORM_EC_CHARGER%22&ss=chromiumos
