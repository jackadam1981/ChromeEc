...
#### Add batteries devicetree node to the board's overlay
...
Add the battery present GPIO signal to the `named-gpios` node:
...
[battery-smart.yaml](https://source.chromium.org/chromiumos/chromiumos/codesearch/+/main:src/platform/ec/zephyr/dts/bindings/battery/battery-smart.yaml)
