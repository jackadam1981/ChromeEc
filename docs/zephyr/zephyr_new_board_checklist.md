...
- **Devicetree Nodes** - This section details the devicetree nodes and
  properties required by the feature. The [Zephyr Introductin to Devicetree]
...
[Zephyr Introductin to Devicetree]: https://docs.zephyrproject.org/latest/build/dts/intro.html
