...
:--------------------------------------------------- | :-----: | :------------
`CONFIG_PLATFORM_EC_USB_A_PORT_COUNT`                | 0       | [USBA port count]
`CONFIG_PLATFORM_EC_USB_PORT_POWER_DUMB`             | y       | [USBA port power]
`CONFIG_PLATFORM_EC_USB_PORT_POWER_DUMB_CUSTOM_HOOK` | n       | [USBA port hook]
...
[USBA port count]: https://source.chromium.org/chromiumos/chromiumos/codesearch/+/main:src/platform/ec/zephyr/Kconfig.usba?q=%22config%20PLATFORM_EC_USB_A_PORT_COUNT%22&ss=chromiumos
[USBA port power]: https://source.chromium.org/chromiumos/chromiumos/codesearch/+/main:src/platform/ec/zephyr/Kconfig.usba?q=%22config%20PLATFORM_EC_USB_PORT_POWER_DUMB%22&ss=chromiumos
[USBA port hook]: https://source.chromium.org/chromiumos/chromiumos/codesearch/+/main:src/platform/ec/zephyr/Kconfig.usba?q=%22config%20PLATFORM_EC_USB_PORT_POWER_DUMB_CUSTOM_HOOK%22&ss=chromiumos
