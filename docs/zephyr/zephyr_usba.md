...
The `ectool usbchargemode` could also be used to enable and disable charging
from the USB Type-A port.
...
The system defines the number of USB-A ports as `CONFIG_PLATFORM_EC_USB_A_PORT_COUNT`
