...
The CBI data is stored in the write-protected (RO) portion of the flash. The EC
firmware and flashing tools have safeguards to prevent this data from being
accidentally erased during routine firmware updates.
