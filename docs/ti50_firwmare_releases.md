...
RW images can be downloaded from

```
Unreleased versions of images at:
gs://chromeos-localmirror-private/distfiles/ti50/
...
3    | 0.23.20   | current    | 0.24.20       | current        | Image header fixes b/129545588
