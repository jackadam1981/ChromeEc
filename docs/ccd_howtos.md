...
6.  (recommended) [Setup CCD]. It's really easy to open cr50 with the battery
    removed. You might want to setup CCD while it's removed. Doing these extra
    CCD setup steps may make it easier to recover a bricked device using CCD.
    These will require SuzyQ.
...
6.  (recommended) Setup capabilities, so you can flash the device or open ccd
    without being able to boot the AP.
