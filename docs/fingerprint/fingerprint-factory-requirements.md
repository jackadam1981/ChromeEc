...
fingerprint firmware stored in the FSI image, which is [recorded] and saved in
[HWID]. See [this CL] for an example of what the HWID result looks like. The
[design doc][hash design] and http://b/181174798 provides more background.
