...
| ---------- | ------------------ | ------------------ | -------------------- |
| Version    | Number describing  | 2                  | 0                    |
:            : the version of the :                    :                      :
:            : file format. Set   :                    :                      :
:            : to 3 at launch.    :                    :                      :
| Reserved   | Reserved bytes,    | 2                  | 2                    |
:            : set to 0           :                    :                      :
| Nonce      | Randomly-generated | 12                 | 4                    |
:            : IV                 :                    :                      :
| Salt       | Randomly-generated | 16                 | 16                   |
:            : salt               :                    :                      :
| Tag        | AES-GCM            | 16                 | 32                   |
:            : Authentication tag :                    :                      :
...
[EC primitives]: https://www.chromium.org/chromium-os/ec-development#TOC-Software-Features
