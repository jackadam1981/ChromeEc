...
Ideally, the Chromebook you receive from Google should already have a test image
with [developer mode] enabled and [hardware write protection] disabled, so you
should be able to SSH into the device and have full access to flashing the FPMCU
firmware.
