...
**Example**: Capture a "test_rest" image from the sensor and write it to a [PNM]
file (viewable with the ImageMagick `display` command):
...
[Git: Concepts and Workflows]: https://docs.google.com/presentation/d/1IQCRPHEIX-qKo7QFxsD3V62yhyGA9_5YsYXFOiBpgkk/
[Gerrit: Concepts and Workflows]: https://docs.google.com/presentation/d/1C73UgQdzZDw0gzpaEqIC6SPujZJhqamyqO1XOHjH-uk/
...
[Regular Yoshi Flex]: ../images/yoshi_flex.jpg
...
[Connect Yoshi Flex to DragonClaw]: ../images/dragonclaw_yoshi_flex_header.jpg
