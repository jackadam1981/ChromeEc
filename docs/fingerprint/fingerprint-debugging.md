...
FPMCU with [`gdb`](#gdb) or to [flash the FPMCU](#flash-fpmcu).
...
*   In order to perform breakpoint debugging, you will need a tool that supports
    connecting `gdbserver`. This document will assume [CLion] and was tested
    with `JLink_Linux_V684a_x86_64`. Alternatively, you can use [Ozone], a
    standalone debugger from Segger.
