...
`ec_cmd_api.h` consists of 3 sections corresponding to the different
...
3. This section consists of functions that are auto-generated by the
   `host-command/api-gen.sh` script.
