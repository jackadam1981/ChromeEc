...
*   SVDM {#svdm}
    *   Structure Vendor Defined Messages are a class of [USB PD](#pd) messages
        to enable non-power related communication between port partners.
*   DRP {#drp}
...
[Introduction to USB Power Delivery]: http://ww1.microchip.com/downloads/en/AppNotes/00001974A.pdf
