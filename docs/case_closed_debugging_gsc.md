...
To reset capabilities to back to `Default`, run the following command. Note this
will exit factory mode and restrict which operations you can perform; e.g.
adjusting `spi_drive` strength will no longer be permitted.
