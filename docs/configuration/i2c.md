...
recovery actions without involvement by the EC-specific I2C device driver.
...
The last piece for I2C configuration is to create the `i2c_ports[]` array using the macros and enumerations added to `baseboard.h` and `gpio.inc`.
