...
The original implementation of ITE EC reflashing via Servo was only compatible
...
1.  When `servod` starts, it creates a pseudo I2C adapter in Linux for every
    servo I2C bus it controls. This pseudo I2C adapter can be used on the host
    system
    *
