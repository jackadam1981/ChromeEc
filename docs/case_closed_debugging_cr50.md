...
the RW firmware using only the UART interface. This is used to recovery a bad
...
UART* and starting the `cr50-rescue` utility as follows:

```bash
sudo emerge cr50-utils  # provides cr50-rescue
