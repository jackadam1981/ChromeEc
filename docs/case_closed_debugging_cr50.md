...
-------------------------------- | ------------- | ----------------------------
`follow_batt_pres` (**DEFAULT**) |               | Battery Connected: Enabled<br>Battery Disconnected: Disabled<br>Chromebox (no battery): Write Protect Screw present means Enabled
`enabled`                        | Any           | Enabled
