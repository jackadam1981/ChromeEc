...
1. Make sure you have read the above Cnfiguration section
  ...
  ```c
   ...
   help
     The TI BQ25720 is a blah blah (describe summary from datasheet,
      at least 3 lines so take your time and wax lyrical)
  ```
...
4. Add the source file to zephyr/CMakeLists.txt (check the ordering comments in
   the file):
