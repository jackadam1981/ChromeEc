...
write protect" GPIO that is connected to the AP SPI flash, EC SPI flash, EEPROM,
and FPMCU via a
...
in ccd. Disabling this write protect disables it for everything connected to
this signal.
...
Older Chrome OS devices had a write protect screw that had to be physically
removed. More details on this history can be found here:
