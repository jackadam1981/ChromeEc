...
*   **MKBP - Matrix Keyboard Protocol**{#mkbp}
    ...
    Message based protocol for communicating keyboard state from the [EC](#ec)
    to the [AP](#ap). This the [EC MKBP driver] implementation.
...
*   **SVDM - Structure Vendor Defined Messages**{#svdm}
