...
The version you are looking at migt be not the latest and greatest, [this
...
If you don't have Chrome OS chroot, to access the scripts you you can clone
the EC tree as follows:
