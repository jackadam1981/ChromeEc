...
/* GL3590 slave is unique in terms of i2c_read, since it doesn't support
 * repeated start sequence. One need to issue two separate transactions - first
 * is write with a register offset, then after a delay second transaction is
 * actual read.
 */
