...
STATIC_IF(CONFIG_ACCEL_LSM6DSO_INT_ENABLE) \
...
#ifdef CONFIG_ACCEL_LSM6DSO_INT_ENABLE
/**
...
#endif /* CONFIG_ACCEL_LSM6DSO_INT_ENABLE */
...
static int set_data_rate(const struct motion_sensor_t *s, int rate, int rnd)
{
	...
	if (ret == EC_SUCCESS) {
		...
		if (IS_ENABLED(CONFIG_ACCEL_LSM6DSO_INT_ENABLE))
