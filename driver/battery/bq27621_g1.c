 ...
 *                             0x354 (ALT_CHEM2)
 *
 * For extra large or extra small batteries, scale everything but voltages.
 */
...
#define DESIGN_CAPACITY       ENDIAN_SWAP_2B(BQ27621_DESIGN_CAPACITY)
#define DESIGN_ENERGY         ENDIAN_SWAP_2B(BQ27621_DESIGN_ENERGY)
...
{
	return bq27621_read(REG_REMAINING_CAPACITY, capacity);
}

int battery_full_charge_capacity(int *capacity)
{
	return bq27621_read(REG_FULL_CHARGE_CAPACITY, capacity);
}
...
{
	return bq27621_read(REG_DESIGN_CAPACITY, capacity);
}
