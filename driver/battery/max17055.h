...
enum MAX17055_ERROR {
	MAX17055_ERROR_OCV_UNLOCK = EC_ERROR_INTERNAL_FIRST,
	MAX17055_ERROR_OCV_WRITE,
	MAX17055_ERROR_OCV_READ,
	MAX17055_ERROR_OCV_LOCK,
};
...
/**
 * Return the battery/system's temperature calibration data max17055 needs.
 */
__override_proto struct max17055_temp_profile *max17055_get_temp_profile(void);
