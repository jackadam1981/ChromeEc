...
#define MAX17055_VALRTTH_REG(mx, mn)                                           \
	MAX17055_MAX_MIN_REG((uint8_t)(mx / 20), (uint8_t)(mn / 20))
...
#define MAX17055_IALRTTH_RESOLUTION (0.4f / BATTERY_MAX17055_RSENSE)
#define MAX17055_IALRTTH_REG(mx, mn)                                           \
	MAX17055_MAX_MIN_REG((int8_t)(mx / MAX17055_IALRTTH_RESOLUTION),       \
			     (int8_t)(mn / MAX17055_IALRTTH_RESOLUTION))
