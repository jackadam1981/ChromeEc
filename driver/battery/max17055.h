...
#define STATUS_IMN                  0x0004
#define STATUS_BST                  0x0008
#define STATUS_IMX                  0x0040
#define STATUS_VMN                  0x0100
#define STATUS_TMN                  0x0200
#define STATUS_SMN                  0x0400
#define STATUS_VMX                  0x1000
#define STATUS_TMX                  0x2000
#define STATUS_SMX                  0x4000
#define STATUS_ALL_ALRT                                                        \
	(STATUS_IMN | STATUS_IMX | STATUS_VMN | STATUS_VMX | STATUS_TMN |      \
	 STATUS_TMX | STATUS_SMN | STATUS_SMX)

/* Alert resolutions (0x01, 0x02, 0x03, 0xb4) */
...
#define MAX17055_MAX_MIN_REG(mx, mn) \
	(((mx) << 8) | ((mn)))
...
/*
 * max17055 support alert on voltage, current, state-of-charge, and temperature.
 * To enable this feature, the information of the limit range is needed.
 */
struct max17055_alert_profile {
	/*
	 * Sets voltage upper and lower limits that generate an alert if
	 * exceeded by the v_alert_mxmn value.
