...
#ifndef __CROS_EC_SMART_BATTERY_FIRMWARE_UPDATE_H
#define __CROS_EC_SMART_BATTERY_FIRMWARE_UPDATE_H
...
/**
 * Check if a Smart Battery Firmware Update is in progress.
 *
 * @return 1 if YES, 0 if NO.
 */
int sbfu_in_progress(void);

#endif /* __CROS_EC_SMART_BATTERY_FIRMWARE_UPDATE_H */
