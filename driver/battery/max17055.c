...
#define VOLTAGE_CONV(REG)       ((REG >> 6) * 5)
/* Current reg value to mA */
#define CURRENT_CONV(REG)       (((REG >> 4) * 25) / BATTERY_MAX17055_RSENSE)
/* Capacity reg value to mAh */
#define CAPACITY_CONV(REG)      (REG * 5 / BATTERY_MAX17055_RSENSE)
/* Time reg value to minute */
#define TIME_CONV(REG)          ((REG >> 3) * 45)
/* Temperature reg value to 0.1K */
#define TEMPERATURE_CONV(REG)   ((REG >> 8) * 10 + 2731)
