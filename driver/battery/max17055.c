...
static int max17055_init_config(void)
{
	 ...
	 * see maxim17055.h and the maxim17055 datasheet for details.
	 */
	if (max17055_shift_mask_write(REG_FILTERCFG, ((AVG_VOLT_CFG_1MIN_PERIOD
						       << AVG_VOLT_CFG_SHIFT) |
						      AVG_CURR_CFG_1MIN_PERIOD),
				      AVG_CURR_CFG_SHIFT,
				      (AVG_CURR_CFG_MASK | AVG_VOLT_CFG_MASK)))
		return EC_ERROR_UNKNOWN;
#endif /* CONFIG_CMD_PWR_AVG */
