...
/**
 * Returns true if the charge detect pin is activated.
 *
 * @parm drv driver for chip to read the charge detect pin for.
 * @return 1 if charge detect is activated (high when active high or
