...
struct bq24392_config_t {
	...
	/*
	 * Charge detect signal from BC 1.2. Can be active high or low depending
	 * on BQ24392_FLAGS_CHG_DET_ACTIVE_LOW flag bit.
	 */
...
/*
 * Array of size (USB-C Ports number) that contains boards-specific
 * configuration for BC 1.2 charging chips.
 */
extern const struct bq24392_config_t bq24392_config[];
