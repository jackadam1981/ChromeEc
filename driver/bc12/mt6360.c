...
int mt6360_ldo_set_voltage(enum mt6360_ldo_id ldo_id, int min_uV, int max_uV)
{
	...
	case MT6360_LDO3:
		/*
		 * TODO(pihsun): Fix this. Have a table of voltages and do real
		 * things.
		 */
		switch (min_uV) {
		case 1800000:
			return mt6360_ldo_update_bits(
				MT6360_REG_LDO3_CTRL3, MT6360_MASK_LDO3_VOSEL,
		...
		default:
			CPRINTS("Unknown LDO3 voltage: %d", min_uV);
			return EC_ERROR_INVAL;
		}
	case MT6360_LDO5:
		switch (min_uV) {
		case 3300000:
			return mt6360_ldo_update_bits(
				MT6360_REG_LDO5_CTRL3, MT6360_MASK_LDO5_VOSEL,
				MT6360_MASK_LDO5_VOSEL_3_3V);
		default:
			CPRINTS("Unknown LDO5 voltage: %d", min_uV);
			return EC_ERROR_INVAL;
		}
	default:
		return EC_ERROR_INVAL;
