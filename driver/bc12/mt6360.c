...
void mt6360_set_switches(int port, enum usb_switch setting)
{
}

int mt6360_ramp_allowed(int port, int supplier)
{
	return supplier == CHARGE_SUPPLIER_BC12_DCP;
}

int mt6360_ramp_max(int port, int supplier, int sup_curr)
{
...
const struct bc12_drv mt6360_drv = {
	...
	.set_switches = mt6360_set_switches,
