...
#define PI3USB9201_REG_CTRL_1_INT_MODE (1 << 1)
#define PI3USB9201_REG_CTRL_1_INT_MODE_BIT_SHIFT 1
#define PI3USB9201_REG_CTRL_1_INT_MODE_MASK 0x7
...
#define PI3USB9201_REG_CLIENT_STS_CHG_2_4A (1 << 1)
#define PI3USB9201_REG_CLIENT_STS_CHG_2_0A (1 << 2)
#define PI3USB9201_REG_CLIENT_STS_CHG_1_0A (1 << 3)
#define PI3USB9201_REG_CLIENT_STS_CHG_CDP (1 << 5)
#define PI3USB9201_REG_CLIENT_STS_CHG_SDP (1 << 6)
#define PI3USB9201_REG_CLIENT_STS_CHG_DCP (1 << 7)
...
extern const struct pi3usb2901_config_t bc12_chips[];
