...
{
	return i2c_read8__7b(pi3usb2901_bc12_chips[port].i2c_port,
			 pi3usb2901_bc12_chips[port].i2c_addr__7b,
			 offset, value);
}

static inline int raw_write8(int port, int offset, int value)
{
	return i2c_write8__7b(pi3usb2901_bc12_chips[port].i2c_port,
			  pi3usb2901_bc12_chips[port].i2c_addr__7b,
			  offset, value);
}
