...
static void imvp_update_page_RAILA_VCC_CORE()
{
	...
	rt3645_imvp_write(DVID_ENHANCE_SPM_EN_REG,
			  DVID_ENHANCE_SPM_EN_RAILA_VAL);
	k_msleep(1);
...
static void imvp_update_page_RAILC_VCCGT()
{
	...
	rt3645_imvp_write(RIPPLE_COMP_SVID_ADDR_REG,
			  RIPPLE_COMP_SVID_ADDR_RAILC_VAL);
...
static void imvp_update_page_RAILD_VCC_ECORE()
{
	...
	rt3645_imvp_write(DVID_ENHANCE_SPM_EN_REG,
			  DVID_ENHANCE_SPM_EN_RAILD_VAL);
	rt3645_imvp_write(RIPPLE_COMP_SVID_ADDR_REG,
			  RIPPLE_COMP_SVID_ADDR_RAILD_VAL);
	k_msleep(1);
