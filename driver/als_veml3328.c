 ...
 */
static int veml3328_read_lux_xyz(VEML3328_CALIB *calib, int *lux, fp_t *x, fp_t *y, fp_t *z)
{
    int ret;
    int raw_data[5];
    for (int i = 0; i < 5; i++) {
    ...
    *z = 1.0 - *x - *y;
    ...
    // Calculate lux
    fp_t gain1[] = {0.5, 1.0, 2.0, 4.0};   // IT: 50ms, 100ms, 200ms, 400ms
    fp_t gain2[] = {1.0, 2.0, 4.0};        // Gain1: x1, x2, x4
    fp_t gain3[] = {1.0, 2.0, 4.0, 0.5};   // Gain2: x1, x2, x4, 1/2
    fp_t gain4[] = {1.0, 1/3.0f};          // HD: x1, 1/3
    ...
    fp_t Lux_gain = gain1[IT_gain] * gain2[Gain1_gain] * gain3[Gain2_gain] * gain4[HD_gain];
    fp_t Ch, Cl;
