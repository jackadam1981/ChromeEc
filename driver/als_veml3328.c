...
static void veml3328_init_calib(void)
{
    ...
    // CCT
    calib.per_model.Lccti0 = 1.0;
    calib.per_model.Lccti1 = 0.0;
    calib.per_model.X1 = 2.0;
    calib.per_model.X2 = 1.0;
    calib.per_model.Y1 = 1.0;

    // Per System Factor
    // Lux
    calib.per_system.C_lux = 1.0;
    // CCT
    calib.per_system.C_ccti = 1.0;
}
...
static int veml3328_init(struct motion_sensor_t *s)
{
    ...
    VEML3328_GET_DATA(s)->scale = 1;
    VEML3328_GET_DATA(s)->uscale = 10;
