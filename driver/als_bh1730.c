...
static int bh1730_read_lux(const struct motion_sensor_t *s, intv3_t v)
{
	...
	ret = i2c_read32__7b(s->port, s->addr__8b >> 1, BH1730_DATA0LOW, &data0_1);
	if (ret != EC_SUCCESS) {
...
static int bh1730_init(const struct motion_sensor_t *s)
{
	...
	/* set timing */
	ret = i2c_write8__7b(s->port, s->addr__8b >> 1, BH1730_TIMING, BH1730_CONF_ITIME);
	if (ret != EC_SUCCESS) {
		CPRINTF("bh1730_init_sensor - time fail %d\n", ret);
		return ret;
	}
	/* set ADC gain */
	ret = i2c_write8__7b(s->port, s->addr__8b >> 1, BH1730_GAIN, BH1730_CONF_GAIN);
