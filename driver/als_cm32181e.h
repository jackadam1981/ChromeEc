...
// initial as 0x00C0, refresh time is 1300ms, about 7mhz
#define CM32181E_LIGHT_MIN_FREQ          1300
#define CM32181E_LIGHT_MAX_FREQ          10000

#define CM32181E_GET_DATA(_s)	((struct cm32181e_drv_data_t *)(_s)->drv_data)

struct cm32181e_drv_data_t {
	int rate;
	int last_value;
