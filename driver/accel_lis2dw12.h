...
/* LIS2DW12 accelerometer module for Chrome EC. */
...
#define LIS2DW12_I2C_ADDR(__x)		(__x << 1)

/*
 * 7-bit address is 011000Xb. Where 'X' is determined
 * by the voltage on the ADDR pin.
 */
#define LIS2DW12_ADDR0			LIS2DW12_I2C_ADDR(0x19)
#define LIS2DW12_ADDR1			LIS2DW12_I2C_ADDR(0x1a)
