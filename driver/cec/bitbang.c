...
int cec_index_test;
uint8_t cec_states_transition_test[4096];
...
static void enter_state(int port, enum cec_state new_state)
{
	...
	cec_states_transition_test[cec_index_test++] = new_state + 100;
...
void cec_event_timeout(int port)
{
	...
	cec_states_transition_test[cec_index_test++] = port_data->state + 200;
