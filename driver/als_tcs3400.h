...
#define TCS_SATURATION_LEVEL    65535           /* for 0 < atime < 0x70 */
#define TCS_DEFAULT_ATIME       TCS_MIN_ATIME   /* 712 ms */
#define TCS_CALIBRATION_ATIME   TCS_MIN_ATIME
#define TCS_GAIN_UPSHIFT_ATIME  ((TCS_MAX_ATIME - TCS_MIN_ATIME) / 2)
...
#define TCS_PERCENT_PER_ATIME           2 /* at GAIN=16x, 5 atime bumps = 2% */

enum calibration_mode {
	RUN_MODE = 0,
	CAL_MODE_SWITCH_PENDING,
	CAL_MODE,
};
