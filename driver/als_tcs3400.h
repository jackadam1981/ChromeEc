...
#define TCS_I2C_STATUS_RGBC_VALID                   TCS_I2C_BIT(0)
#define TCS_I2C_STATUS_ALS_IRQ                      TCS_I2C_BIT(4)
#define TCS_I2C_STATUS_ALS_VALID                    TCS_I2C_BIT(7)

#define TCS_I2C_AUX_ASL_INT_ENABLE                  TCS_I2C_BIT(5)
