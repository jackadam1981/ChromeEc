...
#if DT_NODE_EXISTS(DT_ALIAS(veml3328_int))
/*
 * Get the mostion sensor ID of the VEML3328 sensor that
 ...
 * aliases {
 *     veml3328-int = &als_clear;
 * };
 */
#define CONFIG_ALS_VEML3328_INT_EVENT \
	TASK_EVENT_MOTION_SENSOR_INTERRUPT(SENSOR_ID(DT_ALIAS(veml3328_int)))
#endif
#endif /* CONFIG_ZEPHYR */
