...
static int elan_tp_read_cmd(uint16_t reg, uint16_t *val)
{
	...
	return i2c_xfer__7b(CONFIG_TOUCHPAD_I2C_PORT, CONFIG_TOUCHPAD_I2C_ADDR__7b,
...
static int elan_tp_read_report(void)
{
	...
	rv = i2c_xfer__7b(CONFIG_TOUCHPAD_I2C_PORT,
		      CONFIG_TOUCHPAD_I2C_ADDR__7b,
...
static void elan_tp_init(void)
{
	...
	msleep(100);
	rv = i2c_xfer__7b(CONFIG_TOUCHPAD_I2C_PORT, CONFIG_TOUCHPAD_I2C_ADDR__7b,
