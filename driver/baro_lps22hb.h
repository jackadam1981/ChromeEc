...
/* Pressure sensitivity: 100 LSB/C. */
#define LPS22HB_T_SENSITIVITY			100

#define LPS22HB_P_RANGE				1260
#define LPS22HB_T_RANGE				85

#define LPS22HB_P_RESOLUTION			24

extern const struct accelgyro_drv lps22hb_drv;

void lps22hb_interrupt(enum gpio_signal signal);
