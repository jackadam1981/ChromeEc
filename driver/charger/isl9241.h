...
/* VIN Voltage (ADP Min Voltage) */
#define ISL9241_REG_VIN_VOLTAGE		0x4B
#define ISL9241_VIN_VOLTAGE_0085MV	BIT(6)
#define ISL9241_VIN_VOLTAGE_0171MV	BIT(7)
#define ISL9241_VIN_VOLTAGE_0341MV	BIT(8)
#define ISL9241_VIN_VOLTAGE_0683MV	BIT(9)
#define ISL9241_VIN_VOLTAGE_1365MV	BIT(10)
#define ISL9241_VIN_VOLTAGE_2731MV	BIT(11)
/* Charge ramp voltage for ISL9241 = 4693mV */
#define ISL9241_HW_CHARGE_RAMP_VIN_VTG (ISL9241_VIN_VOLTAGE_0085MV | \
		ISL9241_VIN_VOLTAGE_0171MV | ISL9241_VIN_VOLTAGE_0341MV | \
		ISL9241_VIN_VOLTAGE_1365MV | ISL9241_VIN_VOLTAGE_2731MV)
