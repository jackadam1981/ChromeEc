...
#define ISL9241_CONTROL1_SWITCHING_FREQUENCY_MASK  GENMASK(9, 7)
#define ISL9241_CONTROL1_SWITCHING_FREQUENCY_1420kHz  (0 << 7)
#define ISL9241_CONTROL1_SWITCHING_FREQUENCY_1180kHz  (1 << 7)
#define ISL9241_CONTROL1_SWITCHING_FREQUENCY_1020kHz  (2 << 7)
#define ISL9241_CONTROL1_SWITCHING_FREQUENCY_890kHz   (3 << 7)
#define ISL9241_CONTROL1_SWITCHING_FREQUENCY_808kHz   (4 << 7)
#define ISL9241_CONTROL1_SWITCHING_FREQUENCY_724kHz   (5 << 7)
#define ISL9241_CONTROL1_SWITCHING_FREQUENCY_656kHz   (6 << 7)
#define ISL9241_CONTROL1_SWITCHING_FREQUENCY_600kHz   (7 << 7)
