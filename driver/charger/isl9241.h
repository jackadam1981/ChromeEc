...
#define ISL9241_REG_AC_PROCHOT_L_LIM   GENMASK(6, 0)
#define ISL9241_REG_AC_PROCHOT_H_LIM   GENMASK(15, 13)

#define ISL9241_REG_DC_PROCHOT		0x48
#define ISL9241_REG_DC_PROCHOT_L_LIM   GENMASK(7, 0)
#define ISL9241_REG_DC_PROCHOT_H_LIM   GENMASK(15, 14)
