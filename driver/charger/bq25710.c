...
#ifndef CONFIG_BQ25720_IDCHG_TH2_CUSTOM
#define CONFIG_BQ25720_IDCHG_TH2 1
#endif
...
static int bq257x0_init_charge_option_4(int chgnum)
{
	...
	if (!IS_ENABLED(CONFIG_BQ25720_VSYS_UVP_CUSTOM) &&
	    ...
	    !IS_ENABLED(CONFIG_BQ25720_IDCHG_TH2_CUSTOM))
		return EC_SUCCESS;
	...
	if (IS_ENABLED(CONFIG_BQ25720_IDCHG_TH2_CUSTOM))
		reg = SET_CO4(IDCHG_TH2, CONFIG_BQ25720_IDCHG_TH2, reg);
