...
static int bq25710_get_option(int chgnum, int *option);
static int bq25710_set_option(int chgnum, int option);
...
/* Charger interfaces */
static const struct charger_info *bq25710_get_info(void)
{
	return &bq25710_charger_info;
}

static int bq25710_post_init(int chgnum)
{
	/*
...
static int bq25710_get_status(int chgnum, int *status)
{
	int rv;
	int option;
...
static int bq25710_set_mode(int chgnum, int mode)
{
	int rv;
	int option;
...
static int bq25710_enable_otg_power(int chgnum, int enabled)
{
	/* This is controlled with the EN_OTG pin. Support not added yet. */
	return EC_ERROR_UNIMPLEMENTED;
}

static int bq25710_set_otg_current_voltage(int chgum, int output_current,
					   int output_voltage)
{
	/* Add when needed. */
	return EC_ERROR_UNIMPLEMENTED;
...
static int bq25710_get_current(int chgnum, int *current)
{
	int rv, reg;
...
static int bq25710_set_current(int chgnum, int current)
{
...
static int bq25710_get_voltage(int chgnum, int *voltage)
{
	return raw_read16(chgnum, BQ25710_REG_MAX_CHARGE_VOLTAGE, voltage);
}

static int bq25710_set_voltage(int chgnum, int voltage)
{
	return raw_write16(chgnum, BQ25710_REG_MAX_CHARGE_VOLTAGE, voltage);
}

/* Discharge battery when on AC power. */
static int bq25710_discharge_on_ac(int chgnum, int enable)
{
	int rv, option;
...
static int bq25710_set_input_current(int chgnum, int input_current)
{
...
static int bq25710_get_input_current(int chgnum, int *input_current)
{
	int rv, reg;
...
static int bq25710_manufacturer_id(int chgnum, int *id)
{
	return raw_read16(chgnum, BQ25710_REG_MANUFACTURER_ID, id);
}

static int bq25710_device_id(int chgnum, int *id)
{
...
static int bq25710_set_hw_ramp(int chgnum, int enable)
{
...
{
	bq25710_set_low_power_mode(0, 0);
}
...
{
	bq25710_set_low_power_mode(0, 1);
}
