...
#define BQ25710_IIN_DPM_CODE0_OFFSET \
	(50 * DEFAULT_SENSE_RESISTOR / CONFIG_CHARGER_BQ25710_SENSE_RESISTOR_AC)
...
static const struct charger_info bq25710_charger_info = {
	...
	.voltage_min  = 1024,
	.voltage_step = 8,
	.current_max  = 8128 * DEFAULT_SENSE_RESISTOR /
		CONFIG_CHARGER_BQ25710_SENSE_RESISTOR,
	.current_min  = 64 * DEFAULT_SENSE_RESISTOR /
		CONFIG_CHARGER_BQ25710_SENSE_RESISTOR,
	.current_step = 64 * DEFAULT_SENSE_RESISTOR /
		CONFIG_CHARGER_BQ25710_SENSE_RESISTOR,
	.input_current_max  = 6400 * DEFAULT_SENSE_RESISTOR /
		CONFIG_CHARGER_BQ25710_SENSE_RESISTOR_AC,
	.input_current_min  = 50 * DEFAULT_SENSE_RESISTOR /
		CONFIG_CHARGER_BQ25710_SENSE_RESISTOR_AC,
	.input_current_step = 50 * DEFAULT_SENSE_RESISTOR /
		CONFIG_CHARGER_BQ25710_SENSE_RESISTOR_AC,
};
...
{
	return (current * DEFAULT_SENSE_RESISTOR /
		CONFIG_CHARGER_BQ25710_SENSE_RESISTOR_AC /
