...
#ifndef CONFIG_CHARER_BQ25710_IL_AVG_CUSTOM
#define CONFIG_CHARER_BQ25710_IL_AVG BQ257X0_CHARGE_OPTION_3_IL_AVG__10A
#endif
...
static int bq257x0_init_charge_option_3(int chgnum)
{
	...
	if (IS_ENABLED(CONFIG_CHARER_BQ25710_IL_AVG_CUSTOM))
		reg = SET_CO3(IL_AVG, CONFIG_CHARER_BQ25710_IL_AVG, reg);
