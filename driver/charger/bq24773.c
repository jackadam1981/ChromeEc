...
static inline int raw_write8(int chgnum, int offset, int value)
{
...
static int bq2477x_set_input_current(int chgnum, int input_current)
{
...
static int bq2477x_get_input_current(int chgnum, int *input_current)
{
	int rv;
	int reg;
...
static int bq2477x_manufacturer_id(int chgnum, int *id)
{
#ifdef CONFIG_CHARGER_BQ24770
...
static int bq2477x_device_id(int chgnum, int *id)
{
#ifdef CONFIG_CHARGER_BQ24770
...
static int bq2477x_get_option(int chgnum, int *option)
{
	return raw_read16(chgnum, REG_CHARGE_OPTION0, option);
}

static int bq2477x_set_option(int chgnum, int option)
{
...
static const struct charger_info *bq2477x_get_info(void)
{
	return &bq2477x_charger_info;
}

static int bq2477x_get_status(int chgnum, int *status)
{
	int rv;
	int option;
...
static int bq2477x_set_mode(int chgnum, int mode)
{
	int rv;
	int option;
...
static int bq2477x_get_current(int chgnum, int *current)
{
	int rv;
	int reg;
...
static int bq2477x_set_current(int chgnum, int current)
{
...
static int bq2477x_get_voltage(int chgnum, int *voltage)
{
	return raw_read16(chgnum, REG_MAX_CHARGE_VOLTAGE, voltage);
}

static int bq2477x_set_voltage(int chgnum, int voltage)
{
...
static int bq2477x_post_init(int chgnum)
{
	int rv, option;
...
static int bq2477x_discharge_on_ac(int chgnum, int enable)
{
	int rv;
	int option;
