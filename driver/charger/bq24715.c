...
static inline int sbc_read(int chgnum, int cmd, int *param)
{
...
static inline int sbc_write(int chgnum, int cmd, int param)
{
...
static int bq24715_set_input_current(int chgnum, int input_current)
{
	return sbc_write(chgnum, BQ24715_INPUT_CURRENT,
			 CURRENT_TO_REG(input_current, R_AC));
}

static int bq24715_get_input_current(int chgnum, int *input_current)
{
	int rv;
	int reg;
...
static int bq24715_manufacturer_id(int chgnum, int *id)
{
	return sbc_read(chgnum, BQ24715_MANUFACTURER_ID, id);
}

static int bq24715_device_id(int chgnum, int *id)
{
	return sbc_read(chgnum, BQ24715_DEVICE_ID, id);
}

static int bq24715_get_option(int chgnum, int *option)
{
	return sbc_read(chgnum, BQ24715_CHARGE_OPTION, option);
}

static int bq24715_set_option(int chgnum, int option)
{
...
static const struct charger_info *bq24715_get_info(void)
{
	return &bq24715_charger_info;
}

static int bq24715_get_status(int chgnum, int *status)
{
	int rv;
	int option;
...
static int bq24715_set_mode(int chgnum, int mode)
{
	int rv;
	int option;
...
static int bq24715_get_current(int chgnum, int *current)
{
	int rv;
	int reg;
...
static int bq24715_set_current(int chgnum, int current)
{
...
static int bq24715_get_voltage(int chgnum, int *voltage)
{
	int ret;
...
static int bq24715_set_voltage(int chgnum, int voltage)
{
...
static int bq24715_post_init(int chgnum)
{
	int rv;
	int option;
...
static int bq24715_discharge_on_ac(int chgnum, int enable)
{
	int rv;
	int option;
