				...
				enum BD99955_COMMANDS map_cmd)
{
	...
	return i2c_read16(I2C_PORT_CHARGER, I2C_ADDR_CHARGER, cmd, param);
}
					...
					enum BD99955_COMMANDS map_cmd)
{
	...
	return i2c_write16(I2C_PORT_CHARGER, I2C_ADDR_CHARGER, cmd, param);
}
...
int charger_set_input_current(int input_current)
{
	...
	input_current = (input_current >> 5) << 5;
...
/* Charger console commands */

#ifdef CONFIG_CMD_CHARGER_DEBUG
int console_command_bd99955(int argc, char **argv)
{
	int rv;
	int reg;
	int data;
...
DECLARE_CONSOLE_COMMAND(bd99955, console_command_bd99955,
			...
			NULL);
#endif /* CONFIG_CMD_CHARGER_DEBUG */
