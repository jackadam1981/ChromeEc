...
static int bd99955_por_reset(void)
{
	...
	do {
		msleep(10);
		ch_raw_read16(BD99955_CMD_SYSTEM_STATUS, &reg,
				BD99955_EXTENDED_COMMAND);

		reg &= (BD99955_CMD_SYSTEM_STATUS_OTPLD_STATE |
			BD99955_CMD_SYSTEM_STATUS_ALLRST_STATE);
	} while (reg != (BD99955_CMD_SYSTEM_STATUS_OTPLD_STATE |
			BD99955_CMD_SYSTEM_STATUS_ALLRST_STATE));
...
void bd99955_bc12_enable_charging(enum bd99955_charge_port port, int enable)
{
	...
	ch_raw_write16(BD99955_CMD_CHGOP_SET1, reg, BD99955_EXTENDED_COMMAND);
}
