...
enum ec_error_list sm5803_is_acok(int chgnum, bool *acok)
{
	...
	/*
	 * The ACOK should check wa're sinking.
	 * Also check if the VBUS is connected and assume that ACOK would be
	 * asserted if Vbus is higher than ~4V.
	 */
	*acok = !!(reg &= SM5803_STATUS1_CHG_DET) && vbus_mv >= 4000;
