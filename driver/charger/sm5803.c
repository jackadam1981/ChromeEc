...
static void sm5803_init(int chgnum)
{
	...
	if (reg == 0x02) {
		...
		rv |= sm5803_set_phot_duration(chgnum, CONFIG_CHARGER_SM5803_PROCHOT_DURATION);
#endif
#ifdef CONFIG_CHARGER_SM5803_VBUS_MON_SEL
		rv |= sm5803_set_vbus_monitor_sel(chgnum, CONFIG_CHARGER_SM5803_VBUS_MON_SEL);
#endif
#ifdef CONFIG_CHARGER_SM5803_VSYS_MON_SEL
		rv |= sm5803_set_vsys_monitor_sel(chgnum, CONFIG_CHARGER_SM5803_VSYS_MON_SEL);
#endif
#ifdef CONFIG_CHARGER_SM5803_IBAT_PHOT_SEL
		rv |= sm5803_set_ibat_phot_sel(chgnum, CONFIG_CHARGER_SM5803_IBAT_PHOT_SEL);
#endif
	}
