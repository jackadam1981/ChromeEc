 ...
 */
	...
	/*
	 * 4750mV - 95mV => 4655mV - 3200 (offset reg 0x27) => 1455mv
	 * 3200 + (1455 / 64) * 64 = 4608mV (data for register 0x27)
	 */
	#define BQ25703_BC12_MIN_VOLTAGE_MV	4608
#endif
...
#define BQ25703_ADC_OPTION_EN_ADC_VBUS		(1 << 6)
...
#define BQ25703_ADC_VBUS_STEP_SHIFT_VAL		6	/* 64mV */
#define BQ25703_ADC_VBUS_FULL_RANGE		3200
