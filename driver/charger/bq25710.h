...
#define BQ25710_PROCHOT_PROFILE_COMP		(1 << 6)
#define BQ25710_PROCHOT_PROFILE_ICRIT		(1 << 5)
#define BQ25710_PROCHOT_PROFILE_INOM		(1 << 4)
#define BQ25710_PROCHOT_PROFILE_IDCHG		(1 << 3)
#define BQ25710_PROCHOT_PROFILE_VSYS		(1 << 2)
#define BQ25710_PROCHOT_PROFILE_BATPRES		(1 << 1)
#define BQ25710_PROCHOT_PROFILE_ACOK		(1 << 0)
#define BQ25710_PROCHOT_PROFILE_MASK_ALL	0xFF

/* Enable/Disable PROCHOT events */
