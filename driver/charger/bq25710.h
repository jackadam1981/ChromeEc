...
#define BQ25710_CHARGE_OPTION_1_CMP_REF_MASK	BIT(7)
#define BQ25710_CHARGE_OPTION_1_CMP_REF_2P3	0
#define BQ25710_CHARGE_OPTION_1_CMP_REF_1P2	BIT(7)
...
#define BQ25710_REG_CHARGE_CURRENT_MASK		GENMASK(12, 6)
...
#define BQ25710_CHARGE_OPTION_2_EN_ACOC		BIT(3)
#define BQ25710_CHARGE_OPTION_2_ACOC_VTH_MASK	BIT(2)
#define BQ25710_CHARGE_OPTION_2_ACOC_VTH_133	0
#define BQ25710_CHARGE_OPTION_2_ACOC_VTH_200	BIT(2)
#define BQ25710_CHARGE_OPTION_2_BATOC_VTH_MASK	BIT(0)
#define BQ25710_CHARGE_OPTION_2_BATOC_VTH_150	0	/* 133% on bq25720 */
#define BQ25710_CHARGE_OPTION_2_BATOC_VTH_200	BIT(0)

/* ChargeOption3 Register */
#define BQ25710_CHARGE_OPTION_3_RESET_REG	BIT(14)
#define BQ25710_CHARGE_OPTION_3_EN_ICO_MODE	BIT(11)
#define BQ25710_CHARGE_OPTION_3_IL_AVG_SHIFT	3
#define BQ25710_CHARGE_OPTION_3_IL_AVG_MASK	(0x03 << \
					BQ25710_CHARGE_OPTION_3_IL_AVG_SHIFT)
#define BQ25710_CHARGE_OPTION_3_IL_AVG_6A	(0 << \
					BQ25710_CHARGE_OPTION_3_IL_AVG_SHIFT)
#define BQ25710_CHARGE_OPTION_3_IL_AVG_8A	(1 << \
					BQ25710_CHARGE_OPTION_3_IL_AVG_SHIFT)
#define BQ25720_CHARGE_OPTION_3_IL_AVG_10A	(1 << \
					BQ25710_CHARGE_OPTION_3_IL_AVG_SHIFT)
#define BQ25710_CHARGE_OPTION_3_IL_AVG_10A	(2 << \
					BQ25710_CHARGE_OPTION_3_IL_AVG_SHIFT)
#define BQ25720_CHARGE_OPTION_3_IL_AVG_15A	(2 << \
					BQ25710_CHARGE_OPTION_3_IL_AVG_SHIFT)
#define BQ25710_CHARGE_OPTION_3_IL_AVG_15A	(3 << \
					BQ25710_CHARGE_OPTION_3_IL_AVG_SHIFT)
#define BQ25720_CHARGE_OPTION_3_IL_AVG_OFF	(3 << \
					BQ25710_CHARGE_OPTION_3_IL_AVG_SHIFT)

/* ChargeOption4 Register */
#define BQ25720_CHARGE_OPTION_4_VSYS_UVP_SHIFT	13
#define BQ25720_CHARGE_OPTION_4_VSYS_UVP_MASK	GENMASK(15,13)
#define BQ25720_CHARGE_OPTION_4_VSYS_UVP_4P0	(2 << \
					BQ25720_CHARGE_OPTION_4_VSYS_UVP_SHIFT)

#define BQ25720_CHARGE_OPTION_4_IDCHG_DEG2_SHIFT	6
#define BQ25720_CHARGE_OPTION_4_IDCHG_DEG2_MASK		GENMASK(7, 6)
#define BQ25720_CHARGE_OPTION_4_IDCHG_DEG2_12MS		(3 << \
				BQ25720_CHARGE_OPTION_4_IDCHG_DEG2_SHIFT)

#define BQ25720_CHARGE_OPTION_4_IDCHG_TH2_SHIFT		3
#define BQ25720_CHARGE_OPTION_4_IDCHG_TH2_MASK		GENMASK(5,3)
#define BQ25720_CHARGE_OPTION_4_IDCHG_TH2_1P25		(0 << \
				BQ25720_CHARGE_OPTION_4_IDCHG_TH2_SHIFT)
...
#define BQ25710_ADC_OPTION_FULL_SCALE		BIT(13)
...
#define BQ25710_PROCHOT_PROFILE_INOM		BIT(4)
#define BQ25710_PROCHOT_PROFILE_IDCHG		BIT(3)
#define BQ25710_PROCHOT_PROFILE_VSYS		BIT(2)
#define BQ25710_PROCHOT_PROFILE_BATPRES		BIT(1)
#define BQ25710_PROCHOT_PROFILE_ACOK		BIT(0)
