...
int mt6370_db_set_voltages(int vbst, int vpos, int vneg)
{
	...
	rv |= rt946x_update_bits(MT6370_REG_DBCTRL2,
				 MT6370_MASK_DB_VNEG_DISC |
					 MT6370_MASK_DB_VPOS_DISC,
				 (1 << MT6370_SHIFT_DB_VNEG_DISC) |
					 (1 << MT6370_SHIFT_DB_VPOS_DISC));
