...
static int mt6370_get_ieoc(uint32_t *ieoc)
{
	...
	reg_ieoc = (reg_ieoc & RT946X_MASK_IEOC) >> RT946X_SHIFT_IEOC;
	*ieoc = rt946x_closest_reg(RT946X_IEOC_MIN, RT946X_IEOC_MAX,
					RT946X_IEOC_STEP, reg_ieoc);
	return ret;
}
...
static int rt946x_set_mivr(unsigned int mivr)
{
	...
	rv = rt946x_update_bits(RT946X_REG_CHGCTRL6, RT946X_MASK_MIVR,
	...
	/* Store IEOC */
	return mt6370_get_ieoc(&ieoc_stat);
#endif
	return rv;
}
