...
{
	int ibus;
	mt6370_get_adc(MT6370_ADC_IBUS, &ibus);
	return 0;
}
...
static const uint8_t mt6370_irqr_filter[MT6370_IRQ_SIZE] = {
	0xF1, 0xF8, 0xF0, 0xF8, 0xFF, 0xE3, 0xFB, 0xF8,
	0xF8, 0xCF, 0x3F, 0xE0, 0x80, 0xFF, 0xC0, 0xF8,
};

static const uint8_t mt6370_irqf_filter[MT6370_IRQ_SIZE] = {
...
{
	uint8_t data[MT6370_IRQ_SIZE] = {0}, mask[MT6370_IRQ_SIZE] = {0};
	uint8_t stat_chg[MT6370_IRQ_SIZE] = {0};
	uint8_t stat_old[MT6370_IRQ_SIZE] = {0};
	uint8_t stat_new[MT6370_IRQ_SIZE] = {0};
	uint8_t valid_chg[MT6370_IRQ_SIZE] = {0};
	int i, j, ret, reg_val;
