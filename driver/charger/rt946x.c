...
{
	return i2c_read8__7b(I2C_PORT_CHARGER, RT946X_ADDR__7b, reg, val);
}

static int rt946x_write8(int reg, int val)
{
	return i2c_write8__7b(I2C_PORT_CHARGER, RT946X_ADDR__7b, reg, val);
}

static int rt946x_block_write(int reg, const uint8_t *val, int len)
{
	return i2c_write_block__7b(I2C_PORT_CHARGER, RT946X_ADDR__7b, reg, val, len);
}
