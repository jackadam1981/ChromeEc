...
static int sy21612_clear_set_reg(int reg, int clear, int set)
{
	...
	rv = i2c_read8__7b(I2C_PORT_SY21612, SY21612_ADDR__7b, reg, &old_val);
	if (rv)
		return rv;
	...
	if (val != old_val || clear || set)
		rv = i2c_write8__7b(I2C_PORT_SY21612, SY21612_ADDR__7b, reg, val);
...
{
	return i2c_read8__7b(I2C_PORT_SY21612, SY21612_ADDR__7b, reg, val);
}
