...
#define SM5803_PHOT1_DURATION_10ms 0x07
#define SM5803_PHOT1_DURATION_SHIFT 4
#define SM5803_PHOT1_IRQ_MODE BIT(7)

#define SM5803_REG_PHOT2 0x73
#define SM5803_PROT2_VBUS_SEL GENMASK(4, 0)
#define SM5803_PROT2_VBUS_SEL_4V 0x04

#define SM5803_REG_PHOT3 0x74
#define SM5803_PROT3_VSYS_SEL GENMASK(4, 0)
#define SM5803_PROT3_VSYS_SEL_6V 0x0A

#define SM5803_REG_PHOT4 0x75
#define SM5803_PROT4_IBAT_SEL GENMASK(5, 0)
#define SM5803_PROT4_IBAT_SEL_4P8A 0x08
