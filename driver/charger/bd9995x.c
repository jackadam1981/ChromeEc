...
#ifdef CONFIG_CHARGE_RAMP_SW
int bd9995x_ramp_allowed(int port, int supplier)
{
...
int bd9995x_ramp_max(int port, int supplier, int sup_curr)
{
...
void bd9995x_set_switches(int port, enum usb_switch setting)
{
...
void bd9995x_usb_charger_task(void *u)
{
...
struct bc12_config bc12_chips[BD9995X_CHARGE_PORT_COUNT] = {
	{
...
BUILD_ASSERT(ARRAY_SIZE(bc12_chips) == CHARGE_PORT_COUNT);
