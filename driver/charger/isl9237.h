...
#define ISL9237_C2_PSYS_GAIN_1_44 (100000000ul / \
		(CHARGER_PSYS_REGISTER * (144 - BOARD_PSYS_GAIN_OFFSET)))
#define ISL9237_C2_PSYS_GAIN_0_36 (100000000ul / \
		(CHARGER_PSYS_REGISTER * (36 - BOARD_PSYS_GAIN_OFFSET)))
