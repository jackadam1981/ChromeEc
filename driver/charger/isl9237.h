...
#define ISL9237_REG_DEVIDE_ID        0xff
...
/* Control1: learn mode */
#define ISL9237_C1_LAERN_MODE_DISABLE (0 << 12)
#define ISL9237_C1_LEARN_MODE_FORCE   (2 << 12)
#define ISL9237_C1_LEARN_MODE_AUTO    (3 << 12)
#define ISL9237_C1_LEARN_MODE_MASK    (3 << 12)
...
/* Calculate charging register value */
static inline uint16_t isl9237_calc_chg_reg(uint16_t current)
{
	uint16_t reg_val = current * CONFIG_CHARGER_SENSE_RESISTOR /
			ISL9237_DEFAULT_SENSE_RESISTOR;

	return min(ISL9237_CURRENT_REG_MAX, reg_val);
}

static inline uint16_t is9237_calc_chg_current(uint16_t reg_val)
{
	return reg_value * ISL9237_DEFAULT_SENSE_RESISTOR /
			CONFIG_CHARGER_SENSE_RESISTOR;
}

static inline uint16_t isl9237_calc_adapter_reg(uint16_t current)
{
	uint16_t reg_val = current * CONFIG_CHARGER_SENSE_RESISTOR_AC /
			ISL9237_DEFAULT_SENSE_RESISTOR_AC;

	return min(ISL9237_CURRENT_REG_MAX, reg_val);
}

static inline uint16_t is9237_calc_adapter_current(uint16_t reg_val)
{
	return reg_value * ISL9237_DEFAULT_SENSE_RESISTOR_AC /
