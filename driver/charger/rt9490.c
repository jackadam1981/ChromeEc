...
const struct thermistor_data_pair charger_thermistor_data[] = {
	{ 731 / SCALING_FACTOR, 0 },   { 708 / SCALING_FACTOR, 5 },
	{ 682 / SCALING_FACTOR, 10 },  { 653 / SCALING_FACTOR, 15 },
	{ 622 / SCALING_FACTOR, 20 },  { 589 / SCALING_FACTOR, 25 },
	{ 554 / SCALING_FACTOR, 30 },  { 519 / SCALING_FACTOR, 35 },
	{ 483 / SCALING_FACTOR, 40 },  { 446 / SCALING_FACTOR, 45 },
	{ 411 / SCALING_FACTOR, 50 },  { 376 / SCALING_FACTOR, 55 },
	{ 343 / SCALING_FACTOR, 60 },  { 312 / SCALING_FACTOR, 65 },
	{ 284 / SCALING_FACTOR, 70 },  { 257 / SCALING_FACTOR, 75 },
	{ 232 / SCALING_FACTOR, 80 },  { 209 / SCALING_FACTOR, 85 },
	{ 188 / SCALING_FACTOR, 90 },  { 169 / SCALING_FACTOR, 95 },
	{ 152 / SCALING_FACTOR, 100 },
};

const struct thermistor_info charger_thermistor_info = {
...
#else
	const struct thermistor_info *info = &charger_thermistor_info;
#endif
