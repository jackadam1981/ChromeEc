...
int charger_post_init(void)
{
	...
	sbc_write(0x15, 0x10FE);
	sbc_write(0x3B, 0x0210);
	sbc_write(0x38, 0x0000);
	sbc_write(0x3C, 0x4BAA);
	sbc_write(0x3D, 0x203C);
	sbc_write(0x3E, 0x0D00);
