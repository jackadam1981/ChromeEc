...
static int isl9241_discharge_on_ac(int chgnum, int enable);

static inline int isl9241_read(int chgnum, int offset, int *value)
{
...
static inline int isl9241_write(int chgnum, int offset, int value)
{
...
static inline int isl9241_update(int chgnum, int offset, uint16_t mask,
...
/*****************************************************************************/
/* Charger interfaces */
static int isl9241_set_input_current(int chgnum, int input_current)
{
	int rv;
...
static int isl9241_get_input_current(int chgnum, int *input_current)
{
	int rv;
...
static int isl9241_manufacturer_id(int chgnum, int *id)
{
	return isl9241_read(chgnum, ISL9241_REG_MANUFACTURER_ID, id);
}

static int isl9241_device_id(int chgnum, int *id)
{
	return isl9241_read(chgnum, ISL9241_REG_DEVICE_ID, id);
}

static int isl9241_get_option(int chgnum, int *option)
{
	int rv;
	uint32_t controls;
	int reg;
...
static int isl9241_set_option(int chgnum, int option)
{
	int rv;
...
static const struct charger_info *isl9241_get_info(void)
{
	return &isl9241_charger_info;
}

static int isl9241_get_status(int chgnum, int *status)
{
	int rv;
	int reg;
...
static int isl9241_set_mode(int chgnum, int mode)
{
	int rv;
...
static int isl9241_get_current(int chgnum, int *current)
{
	int rv;
...
static int isl9241_set_current(int chgnum, int current)
{
	return isl9241_write(chgnum, ISL9241_REG_CHG_CURRENT_LIMIT,
				BC_CURRENT_TO_REG(current));
}

static int isl9241_get_voltage(int chgnum, int *voltage)
{
	return isl9241_read(chgnum, ISL9241_REG_MAX_SYSTEM_VOLTAGE, voltage);
}

static int isl9241_set_voltage(int chgnum, int voltage)
{
...
static int isl9241_post_init(int chgnum)
{
	return EC_SUCCESS;
}
...
static int isl9241_set_hw_ramp(int chgnum, int enable)
{
