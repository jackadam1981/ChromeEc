...
#ifdef CONFIG_CHARGER_AC_PRESENT
/*
...
void raa489000_check_ac_present(void)
{
	...
	if (rv == EC_SUCCESS) {
		newval = (((regval >> RAA489000_INFO2_STATE_SHIFT) &
...
DECLARE_HOOK(HOOK_SECOND, raa489000_check_ac_present, HOOK_PRIO_DEFAULT);
#endif /* CONFIG_CHARGER_AC_PRESENT */
