...
#else /* ISL9238 */
	/* TODO(crosbug.com/p/61166): Is ISL9237's "Input Voltage Regulation
	 * Reference" the same as ISL9238's "V_IN loop voltage reference"
	 * that can be set in register 0x4B?
	 */
	return EC_SUCCESS;
#endif
#else
