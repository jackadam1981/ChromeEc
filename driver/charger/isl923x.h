...
enum isl923x_ac_prochot_current {
	ISL923X_AC_PROCHOT_CURRENT_ZERO = 0,	/* Accepted */
	ISL923X_AC_PROCHOT_CURRENT_MIN = 128,	/* mA */
	/* Anything between MIN and MAX is accepted */
	ISL923X_AC_PROCHOT_CURRENT_MAX = 6400,	/* mA */
};

/**
 * Initialize AC prochot threshold
 *
 * @param	Porchot threshold current in mA
 * @return enum ec_error_list
 */
int isl923x_set_ac_prochot(enum isl923x_ac_prochot_current ma);
