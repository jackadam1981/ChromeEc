...
static int cm36781_read_lux(int *lux)
{
	...
	ret = i2c_read16(I2C_PORT_SENSOR, CM36781_I2C_ADDR, CM36781_ALS_DATA,
			 &data);
	if (ret)
		return ret;
	/*
...
static int cm36781_init(struct motion_sensor_t *s)
{
	...
	ret = i2c_read16(s->port, s->i2c_spi_addr_flags, CM36781_ALS_DATA,
			 &data);
	if (ret)
		return ret;
