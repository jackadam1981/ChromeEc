...
#define RT1718S_GPIOX_CTRL_FRS_RX_VBUS			BIT(6)
#define RT1718S_GPIOX_CTRL_FRS_TX_VBUS			BIT(5)
#define RT1718S_GPIOX_CTRL_ENA_SRC_HV_VBUS		BIT(4)
#define RT1718S_GPIOX_CTRL_ENA_SRC_VBUS			BIT(3)
#define RT1718S_GPIOX_CTRL_DIS_SRC_VBUS			BIT(2)
#define RT1718S_GPIOX_CTRL_ENA_SNK_VBUS			BIT(1)
#define RT1718S_GPIOX_CTRL_DIS_SNK_VBUS			BIT(0)
