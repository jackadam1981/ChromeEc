...
#define TUSB422_REG_VENDOR_ALERT 0x90
#define TUBS422_REG_VENDOR_ALERT_FRS_RX BIT(0)

#define TUSB422_REG_VENDOR_ALERT_MASK 0x92
#define TUBS422_REG_VENDOR_ALERT_MASK_FRS_RX BIT(0)
