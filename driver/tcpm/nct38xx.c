...
static int nct3807_handle_fault(int port, int fault)
{
	...
	if (fault & TCPC_REG_FAULT_STATUS_ALL_REGS_RESET) {
		...
		/*
		 * if (fault & TCPC_REG_FAULT_STATUS_FORCE_OFF_VBUS) {
		 * }
		 * if (fault & TCPC_REG_FAULT_STATUS_AUTO_DISCHARGE_FAIL) {
		 * }
		 * if (fault & TCPC_REG_FAULT_STATUS_FORCE_DISCHARGE_FAIL) {
		 * }
		 * if (fault & TCPC_REG_FAULT_STATUS_VBUS_OVER_CURRENT) {
		 * }
		 */
		...
		/*
		 * if (fault & TCPC_REG_FAULT_STATUS_VCONN_OVER_CURRENT) {
		 * }
		 * if (fault & TCPC_REG_FAULT_STATUS_I2C_INTERFACE_ERR) {
		 * }
		 */
	}
	return rv;
