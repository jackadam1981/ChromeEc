...
static int measure_cc_pin_source(int port, int cc_measure)
{
	...
	/* Set desired pullup register bits */
...
{
	/* Measure CC1 */
	*cc1_lvl = measure_cc_pin_source(port, TCPC_REG_SWITCHES0_MEAS_CC1);
	/* Measure CC2 */
	*cc2_lvl = measure_cc_pin_source(port, TCPC_REG_SWITCHES0_MEAS_CC2);
}
