...
static void it83xx_tcpm_plug_out_isr_enable(int port, int enable)
{
	if (enable) {
		/*
		 ...
		 * Before swap, SRC enable SNK plug out detection,
		 * so we disable detection now.
		 */
...
const struct tcpm_drv it83xx_tcpm_drv = {
	...
	.plug_out_isr_enable	= &it83xx_tcpm_plug_out_isr_enable,
};
