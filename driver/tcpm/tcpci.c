 ...
 */
int tcpci_get_chip_info(int port, enum ec_pd_chip_info_src src,
			struct ec_response_pd_chip_info_v1 **chip_info)
{
	...
	/* If already populated and src is local data, return local data */
	if (i->vendor_id && src == SRC_LOCAL_DATA)
		return EC_SUCCESS;
