...
static enum polarity_t cable_polarity[CONFIG_USB_PD_PORT_MAX_COUNT];
...
static enum polarity_t get_cable_polarity(int port)
{
	int cc, rv;
	enum polarity_t polarity = cable_polarity[port];
