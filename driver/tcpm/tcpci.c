...
void tcpci_tcpc_alert(int port)
{
	 ...
	 *
	 * For example: TCPC_REG_ALERT_ALERT_EXT (FRS) requires re-populating
	 * alert_ext variable. Return to the top of the loop and handle this.
	 *
	 * WARNING: The only ALERT bits to trigger call must be ones that were
	 * previously cleared as handled_alerts. Otherwise will infinite-loop.
	 */
	if (nonatomic_rx) {
