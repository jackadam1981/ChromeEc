...
int tcpc_write(int port, int reg, int val)
{
	...
	rv = i2c_write8__7b(tcpc_config[port].i2c_info.port,
...
int tcpc_write16(int port, int reg, int val)
{
	...
	rv = i2c_write16__7b(tcpc_config[port].i2c_info.port,
			 tcpc_config[port].i2c_info.addr__7b, reg, val);
...
int tcpc_read(int port, int reg, int *val)
{
	...
	rv = i2c_read8__7b(tcpc_config[port].i2c_info.port,
		       tcpc_config[port].i2c_info.addr__7b, reg, val);
...
int tcpc_read16(int port, int reg, int *val)
{
	...
	rv = i2c_read16__7b(tcpc_config[port].i2c_info.port,
			tcpc_config[port].i2c_info.addr__7b, reg, val);
...
int tcpc_read_block(int port, int reg, uint8_t *in, int size)
{
	...
	rv = i2c_read_block__7b(tcpc_config[port].i2c_info.port,
...
int tcpc_write_block(int port, int reg, const uint8_t *out, int size)
{
	...
	rv = i2c_write_block__7b(tcpc_config[port].i2c_info.port,
			    ...
			    uint8_t *in, int in_size, int flags)
{
	...
	rv = i2c_xfer_unlocked__7b(tcpc_config[port].i2c_info.port,
				   tcpc_config[port].i2c_info.addr__7b, out,
