...
static inline int tcpm_chk_vbus_level(int port, enum vbus_level level)
{
	return tcpc_config[port].drv->chk_vbus_level(port, level);
}
 ...
 */
int tcpm_chk_vbus_level(int port, enum vbus_level level);
