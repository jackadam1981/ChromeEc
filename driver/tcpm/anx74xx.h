...
#define TCPC_REG_MUX_DP_MODE_ACE_CC1	0x49
#define TCPC_REG_MUX_DP_MODE_ACE_CC2	0x86
#define TCPC_REG_MUX_DP_MODE_BDF_CC1	0x61
#define TCPC_REG_MUX_DP_MODE_BDF_CC2	0x92

#define TCPC_REG_MUX_ML2_B		(1 << 4)
#define TCPC_REG_MUX_ML2_A		(1 << 5)
#define TCPC_REG_MUX_SSTX_B		(1 << 6)
#define TCPC_REG_MUX_SSTX_A		(1 << 7)
...
#define TCPC_REG_IRQ_CC_MSG_INT		(1 << 0)
#define TCPC_REG_IRQ_CC_STATUS_INT	(1 << 1)
#define TCPC_REG_IRQ_GOOD_CRC_INT	(1 << 2)
#define TCPC_REG_IRQ_SOURCE_RECV_MSG_MASK	0x6c

#define TCPC_REG_CLEAR_SET_BITS		0xff
#define TCPC_REG_ALERT_MSG_RECV		(1 << 5)
#define TCPC_REG_ALERT_TX_MSG_ERROR	(1 << 4)
#define TCPC_REG_ALERT_TX_ACK_RECV	(1 << 3)
#define TCPC_REG_ALERT_TX_CABLE_RESETOK	(1 << 2)
#define TCPC_REG_ALERT_TX_HARD_RESETOK	(1 << 1)
#define TCPC_REG_ALERT_CC_CHANGE	(1 << 0)
...
#define TCPC_REG_HPD_OUT_DATA		0x10
