...
STATIC_IF(CONFIG_USB_PD_DECODE_SOP)
	bool sop_prime_en[CONFIG_USB_PD_ITE_ACTIVE_PORT_COUNT];
STATIC_IF(CONFIG_USB_PD_DECODE_SOP)
	int rx_en[CONFIG_USB_PD_ITE_ACTIVE_PORT_COUNT];
...
static void it83xx_tcpm_sw_reset(void)
{
	...
	/*
	 * Disable PD PHY Tx and Rx module for better power consumption
	 * since TypeC has disconnected.
	 */
