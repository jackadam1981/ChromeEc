...
#define PS8XXX_PRODUCT_ID 0x0
#elif defined(CONFIG_USB_PD_TCPM_PS8751)
...
#if defined(CONFIG_USB_PD_TCPM_PS8755)
/* Vendor defined registers */
#define PS8755_P1_REG_MUX_USB_DCI_CFG           0x4B

#endif

#if defined(CONFIG_USB_PD_TCPM_PS8805)
/* Vendor defined registers */
