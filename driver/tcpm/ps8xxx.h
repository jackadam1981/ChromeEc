...
#define PS8XXX_INTERNAL_REG_SLAVE_ADDR	0x12
#define PS8XXX_INTERNAL_REG_GPIO_SEL	0x44
#define PS8XXX_INTERNAL_REG_GPIO_OUT	0x45
#define PS8XXX_INTERNAL_REG_GPIO_OEB	0x46
#define PS8XXX_INTERNAL_REG_GPIO_SRC	(1 << 0)
#define PS8XXX_INTERNAL_REG_GPIO_SNK	(1 << 1)
