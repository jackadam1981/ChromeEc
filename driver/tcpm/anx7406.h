...
#define ANX7406_FAST_ROLE_CTRL 0xAB
#define ANX7406_FAST_ROLE_ENABLE 0x31
...
#define ANX7406_REG_GPIO1_2 0x88
#define GPIO2_OUTPUT_HIGH (BIT(2) | BIT(3))
#define GPIO2_OUTPUT_LOW BIT(2)
#define GPIO2_MASK (BIT(2) | BIT(3))
