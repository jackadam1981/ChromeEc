...
#elif defined(CONFIG_USB_PD_TCPM_ITE8XXX2)
...
#define USBPD_REG_MASK_CC_SELECT_RP_DEF           (BIT(2) | BIT(3))
...
#define IT83XX_USBPD_CCCSR(p)       REG8(IT83XX_USBPD_BASE(p)+0x05)
#define IT83XX_USBPD_CCPSR(p)       REG8(IT83XX_USBPD_BASE(p)+0x06)
#endif /* !defined(CONFIG_USB_PD_TCPM_ITE83XX && CONFIG_USB_PD_TCPM_ITE8XXX2) */
