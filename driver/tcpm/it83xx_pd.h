...
#define USBPD_REG_MASK_DISABLE_CC_VOL_DETECOR     BIT(6)
#define IT83XX_USBPD_CCCSR(p)       REG8(IT83XX_USBPD_BASE(p)+0x05)
...
#define IT83XX_USBPD_CCCSR(p)       REG8(IT83XX_USBPD_BASE(p)+0x05)
#define IT83XX_USBPD_CCPSR(p)       REG8(IT83XX_USBPD_BASE(p)+0x06)
#endif /* !defined CONFIG_USB_PD_TCPM_ITE83XX & CONFIG_USB_PD_TCPM_ITE83XX_V2 */
...
#define TASK_EVENT_PHY_TX_MSG_DISCARD       \
			    TASK_EVENT_CUSTOM_BIT((PD_EVENT_FIRST_FREE_BIT + 1))
#define TASK_EVENT_PHY_TX_DONE_NO_GDCRC     \
			    TASK_EVENT_CUSTOM_BIT((PD_EVENT_FIRST_FREE_BIT + 2))
#define TASK_EVENT_PHY_TX_NOT_EN            \
			    TASK_EVENT_CUSTOM_BIT((PD_EVENT_FIRST_FREE_BIT + 3))
...
#define USBPD_IS_TX_DISCARD(port)       \
	IS_MASK_SET(IT83XX_USBPD_MTCR(port), USBPD_REG_MASK_TX_DISCARD_STAT)
#define USBPD_IS_TX_NO_GOODCRC(port)    \
	IS_MASK_SET(IT83XX_USBPD_MTCR(port), USBPD_REG_MASK_TX_NO_RESPONSE_STAT)
#define USBPD_IS_TX_NOT_EN(port)        \
	IS_MASK_SET(IT83XX_USBPD_MTCR(port), USBPD_REG_MASK_TX_NOT_EN_STAT)
#endif /* !defined(CONFIG_USB_PD_TCPM_ITE83XX) */
