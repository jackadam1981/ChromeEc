...
#define TCPC_REG_COMMAND_I2CWAKE                 0x11
...
#define TCPC_REG_COMMAND_HIGHVOLT_SRC_CTRL_HIGH  0x88
#define TCPC_REG_COMMAND_LOOK4CONNECTION         0x99
#define TCPC_REG_COMMAND_RXONEMORE               0xAA
#define TCPC_REG_COMMAND_SEND_FRSWAP_SIGNAL      0xCC
#define TCPC_REG_COMMAND_RESET_TRANSMIT_BUFFER   0xDD
#define TCPC_REG_COMMAND_RESET_RECEIVE_BUFFER    0xEE
