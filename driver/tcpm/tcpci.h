...
#define TCPC_REG_ALERT_BEGIN_SOP    BIT(12)
...
#define TCPC_REG_POWER_CTRL_DISABLE_VOLT_ALARMS        BIT(5)
#define TCPC_REG_POWER_CTRL_AUTO_DISCHARGE_DISCONNECT  BIT(4)
#define TCPC_REG_POWER_CTRL_ENABLE_BLEED_DISCHARGE     BIT(3)
#define TCPC_REG_POWER_CTRL_FORCE_DISCHARGE            BIT(2)
#define TCPC_REG_POWER_CTRL_VCONN_POWER_SUPPORTED      BIT(1)
#define TCPC_REG_POWER_CTRL_ENABLE_VCONN               BIT(0)
...
#define TCPC_REG_POWER_STATUS_DBGACC    BIT(7)
#define TCPC_REG_POWER_STATUS_UNINIT    BIT(6)
#define TCPC_REG_POWER_STATUS_SRC_HV    BIT(5)
#define TCPC_REG_POWER_STATUS_SRC_VBUS  BIT(4)
...
#define TCPC_REG_POWER_STATUS_SNK_VBUS  BIT(0)

#define TCPC_REG_FAULT_STATUS      0x1f
#define TCPC_REG_FAULT_STATUS_RESET_ALL         BIT(7)
#define TCPC_REG_FAULT_STATUS_FRC_OFF_VBUS      BIT(6)
...
#define TCPC_REG_COMMAND_SRC_CTRL_HV_HIGH        0x88
#define TCPC_REG_COMMAND_LOOK4CONNECTION         0x99
#define TCPC_REG_COMMAND_RX_ONE_MORE             0xAA
#define TCPC_REG_COMMAND_SEND_FR_SWAP_SIGNAL     0xCC
#define TCPC_REG_COMMAND_RESET_TX_BUFFER         0xDD
#define TCPC_REG_COMMAND_RESET_RX_BUFFER         0xEE
...
#define TCPC_REG_VBUS_HV_TARGET              0x7A
