...
#ifndef __CROS_EC_USB_PD_TCPM_MT6360_H
#define __CROS_EC_USB_PD_TCPM_MT6360_H
...
#define MT6360_TCPC_I2C_ADDR_FLAGS			0x4E
...
#define MT6360_REG_BMC_CTRL_DEFAULT \
	(MT6360_VBUS_DET_EN | MT6360_BMCIO_OSC_EN)
...
#define MT6360_MASK_VCONN_LOAD_SEL	(0x06)
#define MT6360_VCONN_LOAD_LVL0		(0)
...
extern const struct tcpm_drv mt6360_tcpm_drv;

/* Enable VCONN discharge. */
int mt6360_vconn_discharge(int port);

#endif /* __CROS_EC_USB_PD_TCPM_MT6360_H */
