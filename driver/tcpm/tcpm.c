...
/*
 * TCPM implementation for non CONFIG_USB_PD_TCPC implementation. This is impl
 * will be used by computing devices (instead of adapters like Zinger)
 */
...
/*
 * CONFIG_USB_PD_TCPC is defined for adapters (e.g Zinger), otherwise it is left
 * undefined for "normal" devices.
 */
