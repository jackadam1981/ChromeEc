...
const struct mux_chip_id_t mux_chip_id_verify[] = {
...
static int it5205_get_mux(int i2c_addr, mux_state_t *mux_state)
{
	...
	*mux_state = 0;
	if ((reg & IT5205_DP_USB_CTRL_MASK) == IT5205_USB)
		*mux_state |= MUX_USB_ENABLED;
	else if ((reg & IT5205_DP_USB_CTRL_MASK) == IT5205_DP)
		*mux_state |= MUX_DP_ENABLED;
	else if ((reg & IT5205_DP_USB_CTRL_MASK) == IT5205_DP_USB)
