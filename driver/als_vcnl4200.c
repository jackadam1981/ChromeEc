...
/*
 * Read data from VCNL4200 light and proximity sensor.
 */
static int vcnl4200_read(const struct motion_sensor_t *s, intv3_t v)
{
	...
	ret = i2c_read16(I2C_PORT_SENSOR, VCNL4200_I2C_ADDR_FLAGS,
			 VCNL4200_PS_DATA, &ps_data);
