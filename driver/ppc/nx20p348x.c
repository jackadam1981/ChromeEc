...
static int nx20p348x_vbus_sink_enable(int port, int enable)
{
	...
	rv = write_reg(port, NX20P348X_SWITCH_CONTROL_REG,
		       enable ? NX20P348X_SWITCH_CONTROL_HVSNK : 0);
#else
	/*
...
#ifdef CONFIG_USBC_PPC_NX20P3481
	rv = write_reg(port, NX20P348X_SWITCH_CONTROL_REG, enable ?
		       NX20P348X_SWITCH_CONTROL_5VSRC : 0);
#else
	/*
