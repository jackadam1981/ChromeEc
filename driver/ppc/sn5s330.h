...
extern const struct sn5s330_map sn5s330_tbl[];
extern const unsigned int sn5s330_cnt;

/**
 * Turn on/off the PP1 or PP2 FET.
 *
 * @param port: The i2c port of the SN5S330.
 * @param addr: The i2c address of the SN5S330.
 ...
 */
int sn5s330_pp_fet_enable(int port, int addr, int pp, int enable);
