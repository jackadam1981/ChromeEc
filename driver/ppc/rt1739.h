...
#define RT1739_REG_VCONN_CTRL1_VCONN_ORIENT	BIT(1)
#define RT1739_REG_VCONN_CTRL1_VCONN_EN		BIT(0)

#define RT1739_REG_SBU_CTRL_01		0x38
#define RT1739_REG_SBU_CTRL_DM_SWEN		BIT(1)
#define RT1739_REG_SBU_CTRL_DP_SWEN		BIT(0)
