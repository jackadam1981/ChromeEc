...
static int aoz1380_discharge_vbus(int port, int enable)
{
	return EC_ERROR_UNIMPLEMENTED;
}

#ifdef CONFIG_USB_PD_VBUS_DETECT_PPC
static int aoz1380_is_vbus_present(int port)
{
	return EC_ERROR_UNIMPLEMENTED;
}
...
static int aoz1380_set_polarity(int port, int polarity)
{
	return EC_ERROR_UNIMPLEMENTED;
}
#endif
...
static int aoz1380_set_vconn(int port, int enable)
{
	return EC_ERROR_UNIMPLEMENTED;
}
#endif
...
const struct ppc_drv aoz1380_drv = {
	...
	.discharge_vbus = &aoz1380_discharge_vbus,
#ifdef CONFIG_USB_PD_VBUS_DETECT_PPC
	.is_vbus_present = &aoz1380_is_vbus_present,
#endif /* defined(CONFIG_USB_PD_VBUS_DETECT_PPC) */
#ifdef CONFIG_USBC_PPC_POLARITY
	.set_polarity = &aoz1380_set_polarity,
#endif /* defined(CONFIG_USBC_PPC_POLARITY) */
#ifdef CONFIG_USBC_PPC_VCONN
	.set_vconn = &aoz1380_set_vconn,
