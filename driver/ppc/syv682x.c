...
{
	int regval;
	int oldval;	//this change is common for anraggar and pujjoga
	int rv;
	/*
	...
	oldval=regval;	//this change is common for anraggar and pujjoga
	if (enable) {
	...
	if (regval != oldval)		//this change is common for anraggar and pujjoga
