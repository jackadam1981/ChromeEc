...
void accel_task(void)
{
	...
	while (1) {
		 ...
		 * can't just initializethe accelerometers once at the beginning
		 * of this task, we have to re-initialize everytime that we
		 * detect that the accelerometers have been power cycled. The
		 * accelerometers return -1 if they are powered but have not
		 * been initialized and 0 if they are not powered.
		 */
