...
STATIC_IF(CONFIG_ACCELGYRO_ICM42607_INT_ENABLE) \
...
#ifdef CONFIG_ACCELGYRO_ICM42607_INT_ENABLE
...
#endif	/* CONFIG_ACCELGYRO_ICM42607_INT_ENABLE */
				  ...
				  int rnd)
{
	...
	if (rate == 0) {
		...
		if (IS_ENABLED(CONFIG_ACCELGYRO_ICM42607_INT_ENABLE))
