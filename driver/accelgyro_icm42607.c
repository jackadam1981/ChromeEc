...
static int icm42607_read_temp_mk(const struct motion_sensor_t *s, int *temp_ptr)
{
	int val, ret;
	...
	*temp_ptr = CELSIUS_TO_MILLI_KELVIN((val / 128) + 25);
	return EC_SUCCESS;
}
...
const struct accelgyro_drv icm42607_drv = {
	.init = icm42607_init,
	.read = icm42607_read,
	.read_temp_mk = icm42607_read_temp_mk,
