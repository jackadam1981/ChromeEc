...
#define AMD_FP6_MUX_ORIENTATION		BIT(5)
#define AMD_FP6_MUX_LOW_POWER		BIT(6)

#define AMD_FP6_MUX_PORT_STATUS_OFFSET	6
#define AMD_FP6_MUX_PORT_CMD_BUSY	0
#define AMD_FP6_MUX_PORT_CMD_COMPLETE	1
#define AMD_FP6_MUX_PORT_CMD_TIMEOUT	2
