...
/*
 * 3.3.2 Command Timeout recomendation
 */
#define WRITE_CMD_TIMEOUT_MS 250
...
static int amd_fp6_mux_port0_read(const struct usb_mux *me, uint8_t *val)
{
	...
	/*
	 * TODO(b/184680878): Ready bit is not asserting for FP6 USB0 Mux,
	 * so just ignore it for C0.
	 */
	if (!mux_ready && me->usb_port != 0) {
...
/*
 * The FP6 USB Mux will not be ready until sometime after S0.
 */
