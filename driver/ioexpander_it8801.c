...
#ifndef CONFIG_IT8801_KSO_BOARD_CONFIG
/*
 * Use default KSO config of IT8801, if we don't declare
 * CONFIG_IT8801_KSO_BOARD_CONFIG in board level.
 */
static const uint8_t kso_mapping[KEYBOARD_COLS_MAX] = {
	0, 1, 2, 3, 4, 5, 6,
	17, 18, 16, 15, 11, 12,
