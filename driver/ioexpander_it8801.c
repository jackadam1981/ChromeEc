...
void keyboard_raw_task_start(void)
{
	...
	i2c_write8(I2C_PORT_IO_EXPANDER, IT8801_REG_ADDR, IT8801_REG_KSIEER,
		0xff);
	/* Keyboard scan in interrupt enable register */
	i2c_write8(I2C_PORT_IO_EXPANDER, IT8801_REG_ADDR, IT8801_REG_KSIIER,
		0xff);
	/* Gather KSI interrupt enable */
	i2c_write8(I2C_PORT_IO_EXPANDER, IT8801_REG_ADDR, IT8801_REG_GIECR,
		IT8801_REG_MASK_GKSIIE);
	/* Alert response enable */
	i2c_write8(I2C_PORT_IO_EXPANDER, IT8801_REG_ADDR, IT8801_REG_SMBCR,
		IT8801_REG_MASK_ARE);

	if (IS_ENABLED(CONFIG_KEYBOARD_COL2_INVERTED))
		/* KSO[2] is high, others are low. */
		i2c_write8(I2C_PORT_IO_EXPANDER, IT8801_REG_ADDR,
	...
	i2c_write8(I2C_PORT_IO_EXPANDER, IT8801_REG_ADDR, IT8801_REG_KSO18,
		IT8801_REG_MASK_FUNC2);
	i2c_write8(I2C_PORT_IO_EXPANDER, IT8801_REG_ADDR, IT8801_REG_KSO19,
		IT8801_REG_MASK_FUNC2);
	i2c_write8(I2C_PORT_IO_EXPANDER, IT8801_REG_ADDR, IT8801_REG_KSO20,
		IT8801_REG_MASK_FUNC2);
	i2c_write8(I2C_PORT_IO_EXPANDER, IT8801_REG_ADDR, IT8801_REG_KSO21,
		IT8801_REG_MASK_FUNC2);
...
test_mockable int keyboard_raw_read_rows(void)
{
	...
	i2c_read8(I2C_PORT_IO_EXPANDER, IT8801_REG_ADDR,
 ...
 */
void io_expander_interrupt(enum gpio_signal signal)
{
	gpio_clear_pending_interrupt(GPIO_IT8801_SMB_INT);
...
static void dump_register(int reg)
{
	...
	rv = i2c_read8(I2C_PORT_IO_EXPANDER, IT8801_REG_ADDR, reg, &data);
