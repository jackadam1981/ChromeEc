...
#ifdef CONFIG_KEYBOARD_KSO_CUSTOM
...
static void dump_register(int low, int high)
{
	int rv, data, reg;
...
{
	dump_register(0x40, 0x43);
	dump_register(0xfa, 0xfb);
	dump_register(0x0a, 0x0b);
	dump_register(0x1c, 0x1d);
