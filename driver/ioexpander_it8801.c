...
static int it8801_i2c_read8(int port, int addr, int reg, int *data)
{
	return i2c_read8(port, addr, reg, data);
}

static int it8801_i2c_write8(int port, int addr, int reg, int data)
{
...
void keyboard_raw_task_start(void)
{
	...
	it8801_i2c_write8(I2C_PORT_IO_EXPANDER_IT8801, IT8801_I2C_ADDR,
...
test_mockable int keyboard_raw_read_rows(void)
{
	...
	it8801_i2c_read8(I2C_PORT_IO_EXPANDER_IT8801, IT8801_I2C_ADDR,
...
static void dump_register(int reg)
{
	...
	rv = it8801_i2c_read8(I2C_PORT_IO_EXPANDER_IT8801, IT8801_I2C_ADDR,
		reg, &data);
