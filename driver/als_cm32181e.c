...
#define CM32181E_GET_DATA(_s)	((struct cm32181e_drv_data *)(_s)->drv_data)

/*
 * Read data from CM32181E light sensor, and transfer unit into lux.
 */
static int cm32181e_read_lux(const struct motion_sensor_t *s, intv3_t v)
{
...
static int cm32181e_set_range(struct motion_sensor_t *s, int range,
			     int rnd)
{
	return EC_SUCCESS;
}
...
{
	*offset = CM32181E_GET_DATA(s)->offset;
	return EC_SUCCESS;
}
/**
 * Initialise CM32181E light sensor.
 */
static int cm32181e_init(struct motion_sensor_t *s)
{
	/*
	 * [9-6]  : 0011b	Conversion time 800ms
	 */
	i2c_write16(s->port, s->i2c_spi_addr_flags,
		CM32181E_REG_CONFIGURE, 0x00C0);
	return EC_SUCCESS;
}
