...
static int opt3001_i2c_test_read(uint8_t port, uint8_t addr,
				 int reg, int *data)
{
	return opt3001_i2c_read(reg, data);
}

static int opt3001_i2c_test_write(uint8_t port, uint8_t addr,
				  int reg, int data)
{
	return opt3001_i2c_write(reg, data);
}
