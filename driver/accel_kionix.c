...
static int init(const struct motion_sensor_t *s)
{
	...
	do {
		/*
		 * Some chips require a period of time to boot.  Some host
		 * boards require some time to energize the sensor power rails.
		 * Run the startup sequence with a retry loop in all cases.
		 */
		if (V(s)) {
