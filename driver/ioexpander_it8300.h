...
/* I2C GPIO Control Register */
#define IT8300_I2CGPIOCR	0x5 /* ? */
...
static inline int it8300_read(int port, int addr, int reg, int *data_ptr)
{
	return i2c_read8(port, addr, reg, data_ptr);
}

static inline int it8300_write(int port, int addr, int reg, int data)
{
