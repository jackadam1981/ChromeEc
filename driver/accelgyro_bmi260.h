...
/* The max positvie value of accel data is 0x7FFF, equal to 2^(1+range)g */
/* So, in order to get +1g, divide the 0x7FFF by 2^(1+range) */
#define BMI260_ACC_DATA_PLUS_1G(range) (0x7FFF >> (1 + (range)))
