...
#define BMI_AUX_X_L_G          BMI260_AUX_X_L_G
#define BMI_AUX_X_H_G          BMI260_AUX_X_H_G
#define BMI_AUX_Y_L_G          BMI260_AUX_Y_L_G
#define BMI_AUX_Y_H_G          BMI260_AUX_Y_H_G
#define BMI_AUX_Z_L_G          BMI260_AUX_Z_L_G
#define BMI_AUX_Z_H_G          BMI260_AUX_Z_H_G
#define BMI_AUX_R_L_G          BMI260_AUX_R_L_G
#define BMI_AUX_R_H_G          BMI260_AUX_R_H_G
#define BMI_ACC_X_L_G          BMI260_ACC_X_L_G
#define BMI_ACC_X_H_G          BMI260_ACC_X_H_G
#define BMI_ACC_Y_L_G          BMI260_ACC_Y_L_G
#define BMI_ACC_Y_H_G          BMI260_ACC_Y_H_G
#define BMI_ACC_Z_L_G          BMI260_ACC_Z_L_G
#define BMI_ACC_Z_H_G          BMI260_ACC_Z_H_G
#define BMI_GYR_X_L_G          BMI260_GYR_X_L_G
#define BMI_GYR_X_H_G          BMI260_GYR_X_H_G
#define BMI_GYR_Y_L_G          BMI260_GYR_Y_L_G
#define BMI_GYR_Y_H_G          BMI260_GYR_Y_H_G
#define BMI_GYR_Z_L_G          BMI260_GYR_Z_L_G
#define BMI_GYR_Z_H_G          BMI260_GYR_Z_H_G
...
#define BMI_GSEL_2G            BMI260_GSEL_2G
#define BMI_GSEL_4G            BMI260_GSEL_4G
#define BMI_GSEL_8G            BMI260_GSEL_8G
#define BMI_GSEL_16G           BMI260_GSEL_16G
...
#define BMI_DPS_SEL_2000            BMI260_DPS_SEL_2000
#define BMI_DPS_SEL_1000            BMI260_DPS_SEL_1000
#define BMI_DPS_SEL_500             BMI260_DPS_SEL_500
#define BMI_DPS_SEL_250             BMI260_DPS_SEL_250
#define BMI_DPS_SEL_125             BMI260_DPS_SEL_125

#define BMI260_AUX_CONF         0x44

#define BMI260_CONF_REG(_sensor)   (0x40 + 2 * (_sensor))
#define BMI260_RANGE_REG(_sensor)  (0x41 + 2 * (_sensor))
#define BMI_CONF_REG(_sensor)      BMI260_CONF_REG(_sensor)
#define BMI_RANGE_REG(_sensor)     BMI260_RANGE_REG(_sensor)
...
#define BMI_GET_SAVED_DATA(_s) BMI260_GET_SAVED_DATA(_s)
