...
#ifdef CONFIG_ACCELGYRO_BMI_SPI
...
#elif defined(CONFIG_ACCELGYRO_BMI_I2C)
	rv = i2c_read8(port, i2c_spi_addr_flags, reg, data_ptr);
#else
#error "UNIMPLEMENTED bmi_read8"
#endif
	return rv;
}
...
#else
#error "UNIMPLEMENTED bmi_write8"
#endif
	/*
...
#else
#error "UNIMPLEMENTED bmi_read16"
#endif
}
...
#else
#error "UNIMPLEMENTED bmi_write16"
#endif
	/*
	 * From Bosch:  BMI needs a delay of 450us after each write if it
	 * is in suspend mode, otherwise the operation may be ignored by
...
#else
#error "UNIMPLEMENTED bmi_read32"
#endif
}
...
#else
#error "UNIMPLEMENTED bmi_read_n"
#endif
}
...
#else
#error "UNIMPLEMENTED bmi_write_n"
#endif
	/*
	 * From Bosch:  BMI needs a delay of 450us after each write if it
	 * is in suspend mode, otherwise the operation may be ignored by
