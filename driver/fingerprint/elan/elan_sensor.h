...
#define FP_ALGORITHM_TEMPLATE_SIZE	65000
#define FP_MAX_FINGER_COUNT			3
#endif
...
#define ImageFormat		0
#define TemplateFormat	1
#define DataFormat		ImageFormat
#define TemplateDummyByte		10

/**
 * set ELAN fingerprint sensor into finger touch detecting and power saving mode
 *
 * @return 0 on success.
...
/**
 * set ELAN fingerprint sensor into image sensing mode
 *
 * @return 0 on success.
 *         negative value on error.
 */
...
/**
 * to initialize parameters of ELAN matching algorithm
 *
 */
