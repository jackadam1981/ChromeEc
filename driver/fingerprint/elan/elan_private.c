...
struct fp_sensor_interface_t fp_driver_elan = {
	FP_SENSOR_TYPE_ELAN,	       &fp_sensor_init_elan,
	&fp_sensor_deinit_elan,	       &fp_sensor_get_info_elan,
	&fp_sensor_low_power_elan,     &fp_sensor_configure_detect_elan,
	&fp_sensor_finger_status_elan, &fp_sensor_acquire_image_with_mode_elan,
	&fp_finger_enroll_elan,	       &fp_finger_match_elan,
	&fp_enrollment_begin_elan,     &fp_enrollment_finish_elan,
	&fp_maintenance_elan
};
