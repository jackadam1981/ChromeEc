 ...
 * @brief Maximum size of the image.
 *
 * @def FP_SENSOR_IMAGE_OFFSET
 * @brief the offset into that buffer that contains the actual image data. For
 * FPC, they have some additional data right before the captured image.
 *
 * @def FP_SENSOR_RES_X
 * @brief Width of a fingerprint image.
 *
 * @def FP_SENSOR_RES_Y
 * @brief Height of a fingerprint image.
 *
 * @def FP_SENSOR_HWID
