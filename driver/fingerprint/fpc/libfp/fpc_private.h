...
enum fpc_error_code_external {
	...
	FPC_ERROR_MAXIMUM_REACHED =
		23, /**< The allowed maximum has been reached. */
	FPC_ERROR_MINIMUM_NOT_REACHED =
		24, /**< The required minimum was not reached. */
	FPC_ERROR_SENSOR_LOW_COVERAGE =
		25, /**< Minimum sensor coverage was not reached. */
	FPC_ERROR_SENSOR_LOW_QUALITY =
		26, /**< Sensor image is considered low quality. */
	FPC_ERROR_SENSOR_FINGER_NOT_STABLE =
		27, /**< Finger was not stable during image capture */
};

/* Internal error codes from FPC's sensor library */
enum fpc_error_code_internal {
	FPC_ERROR_INTERNAL_0 =
		0, /**< Indicates that no internal code was set. */
	FPC_ERROR_INTERNAL_1 = 1, /**< Not supported by sensor. */
	FPC_ERROR_INTERNAL_2 =
		2, /**< Sensor got a NULL response (from other module). */
	FPC_ERROR_INTERNAL_3 =
		3, /**< Runtime config not supported by firmware. */
	...
	FPC_ERROR_INTERNAL_20 =
		20, /**< Sensor type in hw desc could not be extracted. */
	...
	FPC_ERROR_INTERNAL_24 =
		24, /**< Companion type in hw desc could not be extracted. */
	FPC_ERROR_INTERNAL_25 =
		25, /**< Coating type in hw desc could not be extracted. */
	FPC_ERROR_INTERNAL_26 = 26, /**< Sensor mode type is invalid. */
	FPC_ERROR_INTERNAL_27 = 27, /**< Wrong Sensor state in OTP read. */
	FPC_ERROR_INTERNAL_28 =
		28, /**< Mismatch of register size in overlay vs rrs. */
	FPC_ERROR_INTERNAL_29 = 29, /**< Checkerboard capture failed. */
	FPC_ERROR_INTERNAL_30 =
		30, /**< Error converting to fpc_image in dp calibration. */
	FPC_ERROR_INTERNAL_31 = 31, /**< Failed to capture reset pixel image. */
	FPC_ERROR_INTERNAL_32 =
		32, /**< API level not support in dp calibration. */
	FPC_ERROR_INTERNAL_33 =
		33, /**< The image data in parameter is invalid. */
	FPC_ERROR_INTERNAL_34 = 34, /**< PAL delay function has failed. */
	FPC_ERROR_INTERNAL_35 = 35, /**< AFD sensor command did not complete. */
	FPC_ERROR_INTERNAL_36 =
		36, /**< AFD wrong runlevel detected after calibration. */
	FPC_ERROR_INTERNAL_37 = 37, /**< Wrong rrs size. */
	FPC_ERROR_INTERNAL_38 =
		38, /**< There was a finger on the sensor when calibrating
		     * finger detect.
		     */
	FPC_ERROR_INTERNAL_39 =
		39, /**< The calculated calibration value is larger than max. */
	FPC_ERROR_INTERNAL_40 = 40, /**< The sensor fifo always underflows */
	FPC_ERROR_INTERNAL_41 =
		41, /**< The oscillator calibration resulted in a too high or
		     * low value.
		     */
	FPC_ERROR_INTERNAL_42 =
		42, /**< Sensor driver was opened with NULL configuration. */
	FPC_ERROR_INTERNAL_43 =
		43, /**< Sensor driver as opened with NULL hw descriptor. */
	FPC_ERROR_INTERNAL_44 =
		44, /**< Error occurred during image drive test. */
};
