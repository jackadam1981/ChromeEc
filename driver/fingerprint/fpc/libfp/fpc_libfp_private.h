...
#ifndef __CROS_EC_DRIVER_FINGERPRINT_FPC_LIBFP_LIBFP_PRIVATE_H
#define __CROS_EC_DRIVER_FINGERPRINT_FPC_LIBFP_LIBFP_PRIVATE_H
...
#endif /* __CROS_EC_DRIVER_FINGERPRINT_FPC_LIBFP_LIBFP_PRIVATE_H */
