...
#ifndef __CROS_EC_DRIVER_FINGERPRINT_FPC_BEP_FPC_BEP_ALGORITHM_H_
#define __CROS_EC_DRIVER_FINGERPRINT_FPC_BEP_FPC_BEP_ALGORITHM_H_
...
#endif /* __CROS_EC_DRIVER_FINGERPRINT_FPC_BEP_FPC_BEP_ALGORITHM_H_ */
