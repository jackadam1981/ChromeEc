...
static int convert_fp_capture_mdoe_to_fpc_get_image_type(int mode)
{
	switch (mode) {
...
{
	return fp_sensor_acquire_image_with_mode(
		image_data,
		convert_fp_capture_mdoe_to_fpc_get_image_type(mode));
}
