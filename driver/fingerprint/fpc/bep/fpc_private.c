...
struct fp_sensor_interface_t fp_driver_fpc = {
	FP_SENSOR_TYPE_FPC,	  &fp_sensor_init_fpc,
	&fp_sensor_deinit_fpc,	  &fp_sensor_get_info_fpc,
	&fp_sensor_low_power_fpc, &fp_sensor_configure_detect,
	&fp_sensor_finger_status, &fp_sensor_acquire_image_with_mode,
	&fp_finger_enroll_fpc,	  &fp_finger_match_fpc,
	&fp_enrollment_begin_fpc, &fp_enrollment_finish_fpc,
	&fp_maintenance_fpc
};
