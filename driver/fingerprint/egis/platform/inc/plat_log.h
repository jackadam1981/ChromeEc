...
#ifndef __CROS_EC_DRIVER_FINGERPRINT_EGIS_PLATFORM_PLAT_LOG_H_
#define __CROS_EC_DRIVER_FINGERPRINT_EGIS_PLATFORM_PLAT_LOG_H_
...
#endif /* __CROS_EC_DRIVER_FINGERPRINT_EGIS_PLATFORM_PLAT_LOG_H_ */
