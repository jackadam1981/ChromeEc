 ...
 * @param tag A tag or category for the message.
 * @param file_name The file path where the log message originates.
 * @param func The function name where the log message originates.
 * @param line The line number where the log message originates.
 * @param format A format string for the message (like in printf).
