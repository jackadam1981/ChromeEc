...
static const struct fp_image_frame_params egis_image_frame_params[7] = {
...
static egis_capture_mode_t convert_fp_capture_mode_to_egis_get_image_type(
...
int fp_acquire_image(uint8_t *image_data, enum fp_capture_type capture_type)
{
	egis_capture_mode_t rc =
		convert_fp_capture_mode_to_egis_get_image_type(capture_type);
