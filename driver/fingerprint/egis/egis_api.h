...
#define MAX_ENROLL_COUNT 15
#define FAKE_STRATEGY NO_FAKE
#else
 ...
 * @return EGIS_API_ERROR_DEVICE_NOT_FOUND : the sensor cannot be detected.
 * @return EGIS_API_ERROR_IO_SPI : when execute SPI transfer fail.
 ...
 * @return other value : when the sensor detects ESD or is reset.
 */
