...
#define ORIENTATION_CHANGED(_sensor) \
	(((struct bmi160_drv_data_t *)(_sensor->drv_data))->orientation != \
	((struct bmi160_drv_data_t *)(_sensor->drv_data))->last_orientation)

#define GET_ORIENTATION(_sensor) \
	(((struct bmi160_drv_data_t *)(_sensor->drv_data))->orientation)

#define SET_ORIENTATION(_sensor, _val) \
	(((struct bmi160_drv_data_t *)(_sensor->drv_data))->orientation = _val)
