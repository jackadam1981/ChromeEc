...
/* Use these when reading INT_STATUS as a long */
#define BMI160_ORIENT_XY_MASK_32	  (3 << 28)
#define BMI160_ORIENT_PORTRAIT_32	  (0 << 28)
#define BMI160_ORIENT_PORTRAIT_INVERT_32  (1 << 28)
#define BMI160_ORIENT_LANDSCAPE_32	  (2 << 28)
#define BMI160_ORIENT_LANDSCAPE_INVERT_32 (3 << 28)
