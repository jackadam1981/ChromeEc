...
#define WLC_HOST_CTRL_WRITE_SESSION_PARAM 0b000111
...
/* WLC_HOST_CTRL_WRITE_SESSION_PARAMETER constants */
/* Tag size (1) plus value (n), which depends on the tag. */
#define WLC_HOST_CTRL_WRITE_SESSION_PARAM_CMD_MAX_SIZE 2
#define WLC_HOST_CTRL_WRITE_SESSION_PARAM_RSP_SIZE 1
#define WLC_HOST_CTRL_WRITE_SESSION_PARAM_CMD_CHARGING_INFO 1
#define WLC_HOST_CTRL_WRITE_SESSION_PARAM_CMD_CHARGING_INFO_SIZE 1
