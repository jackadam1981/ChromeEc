				     ...
				     int suppress_error)
{
	...
	/*
	 * All of these are "FW shall halt" errors **AND** can be
	 * recovered by resetting touchpad after dumping errors.
	 */
 ...
 *
 * @param suppress_error: still success even if error events presents.
 *
