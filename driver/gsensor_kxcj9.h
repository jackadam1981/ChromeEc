...
#ifndef __CROS_EC_GSENSOR_KXCJ9_H
#define __CROS_EC_GSENSOR_KXCJ9_H

/*
 * 7-bit address is 000111Xb. Where 'X' is determined
 * by the voltage on the ADDR pin.
 */
#define KXCJ9_ADDR0		0x48
#define KXCJ9_ADDR1		0x4C
...
#define KXCJ9_CTRL1_GSEL	(3 << 3)
#define KXCJ9_CTRL1_DRDYE	(1 << 5)
#define KXCJ9_CTRL1_RES		(1 << 6)
#define KXCJ9_CTRL1_PC1		(1 << 7)

#define KXCJ9_GSEL_2G		0
#define KXCJ9_GSEL_4G		1
#define KXCJ9_GSEL_8G		2
#define KXCJ9_GSEL_8G_14BIT	3
...
#endif /* __CROS_EC_GSENSOR_KXCJ9_H */
