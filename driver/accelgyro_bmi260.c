...
STATIC_IF(CONFIG_ACCELGYRO_BMI260_INT_ENABLE) \
			 ...
			 int rnd)
{
	...
	if (rate == 0) {
		...
		if (IS_ENABLED(CONFIG_ACCELGYRO_BMI260_INT_ENABLE))
			bmi_enable_fifo(s, 0);
		/* disable sensor */
...
#ifdef CONFIG_ACCELGYRO_BMI260_INT_ENABLE
/**
...
#endif  /* CONFIG_ACCELGYRO_BMI260_INT_ENABLE */
