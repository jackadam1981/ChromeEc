...
STATIC_IF(CONFIG_ACCEL_LIS2DS_INT_ENABLE)
...
#ifdef CONFIG_ACCEL_LIS2DS_INT_ENABLE
/**
...
#endif  /* CONFIG_ACCEL_LIS2DS_INT_ENABLE */
...
static int set_data_rate(const struct motion_sensor_t *s, int rate, int rnd)
{
	...
	mutex_lock(s->mutex);
	if (IS_ENABLED(CONFIG_ACCEL_LIS2DS_INT_ENABLE)) {
