...
STATIC_IF(CONFIG_ACCEL_LSM6DSM_INT_ENABLE) \
...
#ifdef CONFIG_ACCEL_LSM6DSM_INT_ENABLE
/*
...
#endif  /* CONFIG_ACCEL_LSM6DSM_INT_ENABLE */
...
static int init(struct motion_sensor_t *s)
{
	...
	if (s->type == MOTIONSENSE_TYPE_ACCEL) {
		...
		if (IS_ENABLED(CONFIG_ACCEL_LSM6DSM_INT_ENABLE))
