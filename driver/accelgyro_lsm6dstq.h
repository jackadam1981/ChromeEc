...
/* LSM6DSTQ Accel and Gyro driver for Chrome EC */

#ifndef __CROS_EC_ACCELGYRO_LSM6DSTQ_H
#define __CROS_EC_ACCELGYRO_LSM6DSTQ_H
...
extern const struct accelgyro_drv lsm6dstq_drv;
