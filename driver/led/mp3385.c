...
static struct mp3385_value mp3385_conf[] = {
	...
	{.offset = 1, .data = 0x43},
	/*
	 * Reigster 0x02: LED current Full-Scale Register
	...
	{.offset = 2, .data = 0x65},
	/*
	 * Reigster 0x03: Fault Indication Register
	 * Status function: Read only
	 */
	{.offset = 3, .data = 0x00},
	/*
	 * Reigster 0x04: Internal LED Dimming Brightness Register
	 * SMBus PWM function: None Use
	 */
	{.offset = 4, .data = 0x00},
	/*
	 * Reigster 0x05: OVP, OCP Threshold Register
	...
	{.offset = 5, .data = 0x97},
	/*
	 * Reigster 0x00: Dimming mode Register
