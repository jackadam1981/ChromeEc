...
/*
 * This function does the preparation for firwmare update including:
...
/*
 * This function write the fireware data to buffer and send command to MCU
 * to wrtie the data from buffer to flash
 */
