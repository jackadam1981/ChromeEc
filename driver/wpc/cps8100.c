...
/*
 * This function write the firmware block to the chip. The steps are:
 ...
 * 1. Send command to the chip to calculate the CRC of the firmware in the flash
 * 2. Read the CRC vlaue from the chip and compare
