...
#define WIRELESS_CHARGER_NAME	'P9221_R7'
...
#define P9221_DC_IVL_BPP_UV			5000000
#define P9221_DC_IVL_EPP_UV			9000000
#define P9221_EPP_THRESHOLD_UV			7000000

#define true    1
#define false   0

typedef void (*cb_update_charger)(int type,struct charge_port_info *chg);
...
struct wpc_charger_info {
	...
	uint8_t tx_id;
	//uint8_t                               tx_id_str[(sizeof(u32) * 2) + 1];
	uint8_t tx_len;
	uint8_t tx_done;
	uint8_t tx_busy;
