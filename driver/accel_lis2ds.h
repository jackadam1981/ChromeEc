...
#define LIS2DS_I2C_ADDR(__x)		(__x << 1)

/*
 * 7-bit address is 110101Xb. Where 'X' is determined
 * by the voltage on the ADDR pin.
 */
#define LIS2DS_ADDR0			LIS2DS_I2C_ADDR(0x1d)
#define LIS2DS_ADDR1			LIS2DS_I2C_ADDR(0x1e)
...
#define LIS2DS_ODR_MAX_VAL		800000

/* ODR reg value from selected data rate in mHz */
#define LIS2DS_ODR_TO_REG(_odr) \
	(32 - __builtin_clz(_odr / LIS2DS_ODR_MIN_VAL))

/* Normalized ODR value from selected data rate in mHz */
#define LIS2DS_ODR_TO_NORMALIZE(_odr) \
	(LIS2DS_ODR_MIN_VAL << (31 - __builtin_clz(_odr/LIS2DS_ODR_MIN_VAL)))
...
#define LIS2DS_GAIN_FS(_gain) \
	(1 << (32 - __builtin_clz(_gain / LIS2DS_FS_2G_GAIN)))

/* Gain value from selected Full Scale */
#define LIS2DS_FS_GAIN(_fs) \
	(LIS2DS_FS_2G_GAIN << (31 - __builtin_clz(_fs / 2)))
...
#define LIS2DS_NORMALIZE_FS(_fs) \
	(1 << (32 - __builtin_clz(_fs / 2)))

/* Sensor resolution in number of bits. Sensor has two resolution: 10 and 14 bit
 * for LP and HR mode resp. */
