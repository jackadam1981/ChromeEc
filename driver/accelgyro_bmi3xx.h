...
#define BMI3_FEATURE_EVENT_STATUS		0x47

/* BMI3 Orientation outputs */
...
/* Offset user register */
#define ACC_DP_OFF_X				0x60
#define GYR_DP_OFF_X				0x66

/*
 * Start address of the DMA transaction. Has to be written to initate a
 * transaction.
 */
