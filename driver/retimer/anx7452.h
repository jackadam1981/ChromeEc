...
/*
 * CTLTOP Ultra Low Power Control register
 *
 */
#define ANX7452_CTLTOP_ULTRA_LOW_POWER_CTRL_REG 0xE6
#define ANX7452_CTLTOP_ULTRA_LOW_POWER_CTRL_REG_BIT_MASK 0x07
