...
#define ANX7452_CTLTOP_CFG1_HPD_LVL BIT(7)
#define ANX7452_CTLTOP_CFG1_IRQ_HPD BIT(6)

#define ANX7452_CTLTOP_CFG1_DP_PM_E 0
#define ANX7452_CTLTOP_CFG1_DP_PM_C_D BIT(2)

#define ANX7452_CTLTOP_CFG1_DP_EN BIT(0)
#define ANX7452_CTLTOP_CFG1_REG_BIT_MASK \
	(ANX7452_CTLTOP_CFG1_HPD_LVL | ANX7452_CTLTOP_CFG1_DP_EN)
