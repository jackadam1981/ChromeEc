...
#define BB_RETIMER_TBT_COMPAT_ACTIVE		BIT(2)
...
#define BB_RETIMER_TBT_COMPAT_CONN		BIT(16)
#define BB_RETIMER_TBT_COMPAT_TYPE		BIT(17)
#define BB_RETIMER_TBT_COMPAT_CTYPE		BIT(18)
#define BB_RETIMER_TBT_COMPAT_LSRX_LINK		BIT(20)
#define BB_RETIMER_USB4_ENABLED			BIT(23)
#define BB_RETIMER_TBT_COMPAT_CABLE_SPEED(x)	((x) << 25)
#define BB_RETIMER_TBT_COMPAT_CABLE_GEN(x)	((x) << 28)
