...
int ps8818_i2c_read(struct usb_mux *this, int page, int offset, int *data)
{
	int rv;
...
int ps8818_i2c_write(struct usb_mux *this, int page, int offset, int data)
{
	int rv;
...
int ps8818_i2c_field_update8(struct usb_mux *this, int page, int offset,
...
int ps8818_detect(struct usb_mux *this)
{
...
static int ps8818_set_mux(struct usb_mux *this, mux_state_t mux_state)
{
	int rv;
	int val = 0;
