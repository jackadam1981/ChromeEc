...
int nb7v904m_tune_usb_eq(const struct usb_mux *me, uint8_t eq_a, uint8_t eq_d)
{
        int ret;

        ret = nb7v904m_write(me, NB7V904M_REG_CH_A_EQ_SETTINGS, eq_a);
        ret |= nb7v904m_write(me, NB7V904M_REG_CH_D_EQ_SETTINGS, eq_d);
