...
const test_export_static struct anx7483_tuning_set anx7483_AA_usb_term[] = {
...
const test_export_static struct anx7483_tuning_set anx7483_BA_usb_term[] = {
...
const test_export_static struct anx7483_tuning_set anx7483_AA_dp_term[] = {
...
const test_export_static struct anx7483_tuning_set anx7483_BA_dp_term[] = {
	{ ANX7483_URX1_PORT_CFG3_REG, ANX7483_BA_CFG3_90Ohm_OUT },
	{ ANX7483_URX2_PORT_CFG3_REG, ANX7483_BA_CFG3_90Ohm_OUT },
...
const test_export_static struct anx7483_tuning_set
	anx7483_AA_dock_noflip_term[] = {
...
const size_t anx7483_AA_usb_term_count = ARRAY_SIZE(anx7483_AA_usb_term);
const size_t anx7483_BA_usb_term_count = ARRAY_SIZE(anx7483_BA_usb_term);
const size_t anx7483_AA_dp_term_count = ARRAY_SIZE(anx7483_AA_dp_term);
const size_t anx7483_BA_dp_term_count = ARRAY_SIZE(anx7483_BA_dp_term);
const size_t anx7483_AA_dock_noflip_term_count = ARRAY_SIZE(anx7483_AA_dock_noflip_term);
const size_t anx7483_BA_dock_noflip_term_count = ARRAY_SIZE(anx7483_BA_dock_noflip_term);
	...
	if (mux_state == USB_PD_MUX_USB_ENABLED) {
		...
		if (pid == ANX7483_BA)
			return anx7483_apply_tuning(
				me, anx7483_BA_usb_term,
				anx7483_BA_usb_term_count);
		else
			return anx7483_apply_tuning(
				me, anx7483_AA_usb_term,
				anx7483_AA_usb_term_count);
		...
		if (pid == ANX7483_BA)
			return anx7483_apply_tuning(
				me, anx7483_BA_dp_term,
				anx7483_BA_dp_term_count);
		else
			return anx7483_apply_tuning(
				me, anx7483_AA_dp_term,
				anx7483_AA_dp_term_count);
		...
		if (pid == ANX7483_BA)
			return anx7483_apply_tuning(
				me, anx7483_BA_dock_noflip_term,
				anx7483_BA_dock_noflip_term_count);
		else
			return anx7483_apply_tuning(
				me, anx7483_AA_dock_noflip_term,
				anx7483_AA_dock_noflip_term_count);
	} else if (mux_state == USB_PD_MUX_DOCK && flipped) {
		...
		if (pid == ANX7483_BA)
			return anx7483_apply_tuning(
				me, anx7483_BA_dock_flip,
				anx7483_BA_dock_flip_count);
		else
			return anx7483_apply_tuning(
				me, anx7483_AA_dock_flip,
