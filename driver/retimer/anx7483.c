...
const test_export_static size_t anx7483_usb_enabled_count
	= ARRAY_SIZE(anx7483_usb_enabled);
const test_export_static size_t anx7483_dp_enabled_count
	= ARRAY_SIZE(anx7483_dp_enabled);
const test_export_static size_t anx7483_dock_noflip_count
	= ARRAY_SIZE(anx7483_dock_noflip);
const test_export_static size_t anx7483_dock_flip_count
