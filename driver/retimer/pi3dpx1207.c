...
static void pi3dpx1207_shutoff_power(struct usb_mux *this)
{
 ...
 */
static int pi3dpx1207_init(struct usb_mux *this)
{
	const int port = this->usb_port;
	const int gpio_enable = pi3dpx1207_controls[port].enable_gpio;
...
static int pi3dpx1207_enter_low_power_mode(struct usb_mux *this)
{
	pi3dpx1207_shutoff_power(this);
	return EC_SUCCESS;
}

static int pi3dpx1207_set_mux(struct usb_mux *this, mux_state_t mux_state)
{
	int rv = EC_SUCCESS;
	...
	rv = pi3dpx1207_i2c_write(this->i2c_port, this->i2c_addr_flags,
