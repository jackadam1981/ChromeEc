...
def _ec_deps_impl(module_ctx):
    ...
    _coreboot_sdk_subtool(
        "libstdcxx-i386-elf",
        "14.2.0-r1/58c27b95f0200262ee820bc5463cf3d7fbe62a51",
        "734e7f7165a99d2c6c61c053f515b4ea0148384f41d9bfff7834321e249279d8",
    )
    _coreboot_sdk_subtool(
        "arm-eabi",
    ...
    _coreboot_sdk_subtool(
        "libstdcxx-arm-eabi",
        "14.2.0-r1/30aade7c85a812bd9b37c5530d3f15772340f553",
        "6d4e9841a6743966d62da591cd70267279bbed941a9f51aa4ce50cd10feba4b7",
    )
    _coreboot_sdk_subtool(
        "riscv-elf",
