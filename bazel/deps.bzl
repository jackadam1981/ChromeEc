...
def _cr50_deps_impl(module_ctx):
    http_archive(
        ...
        url = "https://storage.googleapis.com/chromiumos-sdk/toolchains/coreboot-sdk-arm-eabi/11.3.0-r2/8adade1392d87565482ea57bfafaf74223cebbe5.tar.zst" % (arch, version),
    )
