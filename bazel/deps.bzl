...
def _ec_deps_impl(module_ctx):
    ...
    _coreboot_sdk_subtool(
        "i386-elf",
        "14.2/5ba88fb0227c76584851bd9cbb24d785e31a717c",
        "d80fee9ee221013fddecdf0a9e0c36eb265d99139ff0eaa930a95c6fdd40bc12",
    )
    _coreboot_sdk_subtool(
        "arm-eabi",
        "14.2/8adade1392d87565482ea57bfafaf74223cebbeb",
