...
load("//bazel/workspace_root/fwsdk:MODULE.bazel", "module_extension")
...
def _ec_deps_impl(module_ctx):
    ...
    return module_ctx.extension_metadata(
        root_module_direct_deps = [
            "coreboot-sdk-aarch64-elf",
            "coreboot-sdk-arm-eabi",
            "coreboot-sdk-i386-elf",
            "coreboot-sdk-iasl",
            "coreboot-sdk-nds32le-elf",
            "coreboot-sdk-riscv-elf",
            "coreboot-sdk-x86_64-elf",
        ],
