...
def _ec_deps_impl(module_ctx):
    def _coreboot_sdk_subtool(arch, version, sha256, bucket = "chromiumos-sdk", qualifier = ""):
        ...
        http_archive(
            ...
            sha256 = sha256,
            url = "https://storage.googleapis.com/%s/toolchains/coreboot-sdk-%s/%s.tar.zst" % (bucket, arch, version),
        )
    ...
    _coreboot_sdk_subtool(
        "i386-elf",
        "14.2/5ba88fb0227c76584851bd9cbb24d785e3000036",
    ...
    _coreboot_sdk_subtool(
        "arm-eabi",
        "14.2/8adade1392d87565482ea57bfafaf74223000036",
