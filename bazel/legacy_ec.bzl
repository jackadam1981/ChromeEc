...
_rule = rule(
    ...
    attrs = {
        "_legacy_ec_makefile": attr.label(default = "//platform/ec:legacy_ec_makefile", allow_single_file = True),
        "_legacy_ec_srcs": attr.label(default = "//platform/ec:legacy_ec_srcs", allow_files = True),
