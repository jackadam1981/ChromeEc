...
static inline void deprecated_atomic_clear_bits(atomic_t *addr, atomic_val_t bits)
{
...
static inline atomic_val_t deprecated_atomic_or(atomic_t *addr, atomic_val_t bits)
{
	atomic_val_t ret;
	atomic_t volatile *ptr = addr;
	uint32_t int_mask = read_clear_int_mask();
...
static inline atomic_val_t deprecated_atomic_add(atomic_t *addr, atomic_val_t value)
{
	atomic_val_t ret;
	atomic_t volatile *ptr = addr;
	uint32_t int_mask = read_clear_int_mask();
...
static inline atomic_val_t deprecated_atomic_sub(atomic_t *addr, atomic_val_t value)
{
	atomic_val_t ret;
	atomic_t volatile *ptr = addr;
	uint32_t int_mask = read_clear_int_mask();
...
static inline atomic_val_t deprecated_atomic_read_clear(atomic_t *addr)
{
	atomic_val_t ret;
	atomic_t volatile *ptr = addr;
	uint32_t int_mask = read_clear_int_mask();
