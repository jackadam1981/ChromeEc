...
void __ram_code interrupt_disable(void)
{
	...
	/* Group 7: disable and clear interrupts */
	IT83XX_INTC_REG(IT83XX_INTC_IER7) &= ~GROUP7_TO_INT3_MASK;
	IT83XX_INTC_ISR7 |= GROUP7_TO_INT3_MASK;
	...
	IT83XX_INTC_ISR19 |= GROUP7_TO_INT3_MASK;
