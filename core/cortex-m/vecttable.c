...
#ifdef __clang__
#define SECTION_NAME ".text.vecttable"
#else
#define SECTION_NAME ".text.vecttable,\"a\" @"
#endif
#define table(x) func vectors[] __attribute__((section(SECTION_NAME))) = { x [IRQ_UNUSED_OFFSET] = null };
