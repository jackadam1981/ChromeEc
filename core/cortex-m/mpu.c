...
/* Get the bit alignment of x; the number of trailing zeroes. */
static uint8_t alignment_log2(int32_t x)
{
...
{
	uint8_t addr_alignment = alignment_log2(addr);
	uint8_t size_alignment = alignment_log2(size);
	 ...
	 */
	if (addr_alignment < size_alignment)
		natural_alignment = addr_alignment;
	else
		natural_alignment = size_alignment;
