			 ...
			 const union rts54_request *req)
{
	...
	data->response.ic_status.pd_version[1] = data->info.pd_version &
						 BIT_MASK(8);
	data->response.ic_status.vid[1] = data->info.vid >> 8 & BIT_MASK(8);
	data->response.ic_status.vid[0] = data->info.vid & BIT_MASK(8);
	data->response.ic_status.pid[1] = data->info.pid >> 8 & BIT_MASK(8);
	data->response.ic_status.pid[0] = data->info.pid & BIT_MASK(8);
