 ...
 *
 * @return Voltage visable at CC resistor side
 */
			       ...
			       bool active_cable)
{
	...
	if (active_cable) {
		cc2_v = TYPEC_CC_VOLT_RA;
	} else {
		cc2_v = TYPEC_CC_VOLT_OPEN;
	}

	/* Switch CC lines in case of rotation of the plug */
	if (cc1) {
		cc1_v = cc_v;
	} else {
		cc1_v = cc2_v;
