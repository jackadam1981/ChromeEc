...
enum functional_mode {
	/* TODO shutdown_mode, */
	/* TODO bypass, */
	standby = LN9310_SYS_STANDBY,
	switching_21 = LN9310_SYS_SWITCHING21_ACTIVE,
	switching_31 = LN9310_SYS_SWITCHING31_ACTIVE
};
