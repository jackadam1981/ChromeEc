...
LOG_MODULE_REGISTER(emul_fpc1025, LOG_LEVEL_DBG);
...
void fpc1025_emul_reset(const struct emul *target)
{
			   ...
			   const struct spi_buf_set *rx_bufs)
{
	...
	LOG_DBG("Received command 0x%x", cmd);
...
#define FPC1025_EMUL(n)                                                  \
	...
	EMUL_DT_INST_DEFINE(n, fpc1025_emul_init, &fpc1025_emul_data##n, \
			    NULL, &fpc1025_emul_api, NULL)
