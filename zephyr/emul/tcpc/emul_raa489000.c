...
#define DT_DRV_COMPAT cros_raa489000_emul
			       ...
			       const struct device *parent)
{
	...
	zassert_ok(tcpci_emul_set_reg(emul, TCPC_REG_VENDOR_ID, 0x45b));
	zassert_ok(tcpci_emul_set_reg(emul, TCPC_REG_PRODUCT_ID, 0x256));
