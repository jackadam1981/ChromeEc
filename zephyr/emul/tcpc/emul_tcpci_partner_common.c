	...
	enum tcpci_emul_tx_status tx_status)
{
	...
	/* If receiving message was unsuccessful, abandone processing message */
	...
	case PD_CTRL_ACCEPT:
		if (data->wait_for_response) {
			...
			/*
			 * Accpet/reject is expected message and emulator code
			 * should handle it
			 */
			return TCPCI_PARTNER_COMMON_MSG_NOT_HANDLED;
		}

		/* Unexepected message - trigger soft reset */
