...
def translate_results(platform_ec):
    """Translate Zephyr Test results to ResultDB"""
    exe_path = platform_ec / "util" / "zephyr_to_resultdb.py"
    ...
    ret = subprocess.run(cmd, check=True, cwd=platform_ec).returncode
