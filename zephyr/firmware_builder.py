...
def bundle_firmware(opts):
    ...
    # TODO(b/287268093 asemjonovs): Add universal token database artifact
    meta = info.objects.add()
    meta.file_name = str(platform_ec / "build" / "database.bin")
    # meta.token_info.type = firmware_pb2.FirmwareArtifactInfo.TokenDatabaseInfo.
    # TokenDatabaseType.EC
    write_metadata(opts, info)
