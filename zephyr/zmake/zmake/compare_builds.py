...
class CompareBuilds:
    ...
    def check_binaries(self, projects):
        ...
        Args:
            ...
            build_base_dir1: The first base directory for all projects. This should
                be the same path set BuildInfo.ec_build_dir.
            build_base_dir2: The second base directory for all projects.  This
                should be the same path set BuildInfo.ec_build_dir.
