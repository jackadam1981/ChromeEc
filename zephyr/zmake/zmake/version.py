...
def get_version_string(
    ...
    Args:
        ...
        static: if set, create a version string not dependent on git
            ...
            commits.
        official_build: if set, use the format of official build, otherwise,
            use the format of dev build.
    ...
    if not version:
        if official_build:
            raise ValueError("No version information provided")
        version = "0.0.0"
    ...
    if _is_tree_dirty(str(git_path)):
        result += "+"
