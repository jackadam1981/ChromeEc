...
class BuildConfig:
    ...
    def _get_paths_for_hashing(self):
        # Zephyr's CMake system won't detect all necessary re-runs
        # when certain input files have been changed.  We can work
        # around this in Zmake by hashing the contents paths to known
        # that the CMake system won't rebuild when required.
