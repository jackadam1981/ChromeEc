...
**Usage:** `zmake configure [-h] [--skip-host-tests] [-t TOOLCHAIN] [--bringup] [--clobber] [--allow-warnings] [-B BUILD_DIR] [-c] [--extra-cflags EXTRA_CFLAGS] [--delete-intermediates] (-a | --host-tests-only | --boards-only | project_name [project_name ...])`
...
|---|---|
| `-h`, `--help` | show this help message and exit |
| `--skip-host-tests` | Skip all test projects |
...
**Usage:** `zmake build [-h] [--skip-host-tests] [-t TOOLCHAIN] [--bringup] [--clobber] [--allow-warnings] [-B BUILD_DIR] [-c] [--extra-cflags EXTRA_CFLAGS] [--delete-intermediates] (-a | --host-tests-only | --boards-only | project_name [project_name ...])`
