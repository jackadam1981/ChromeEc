...
def test_zephyr(fake_project: project.Project, zephyr_exists, no_envron):
...
def test_no_toolchains(fake_project: project.Project, mockfs, no_envron):
...
def test_override_without_sdk(fake_project: project.Project, mockfs, no_envron):
