...
EXPECTED_HEADER = (
    ...
    'hal_stm32:f8ff8d"\n'
    '#define CROS_EC_VERSION32 "hayato_v2.6.73670-ec:5bd1aa"\n'
...
EXPECTED_HEADER2 = (
    ...
    '#define CROS_EC_VERSION32 "herobrine_npcx9_v2.6.73695"\n'
    '#define BUILDER "toukmond@pokey"\n'
    '#define DATE "2021-06-28 03:18:53"\n'
    '#define CROS_FWID_MISSING_STR "CROS_FWID_MISSING"\n'
    "#define CROS_FWID32 CROS_FWID_MISSING_STR\n"
...
def test_header_gen2(fake_user_hostname, fake_date, tmp_path):
    # Test the simple case (static=False, no existing header).
    output_file = tmp_path / "ec_version.h"
    version.write_version_header(HEADER_VERSION_STR2, output_file)
    assert output_file.read_text() == EXPECTED_HEADER2
