 ...
 */
#ifndef __AP_PWRSEQ_HOST_H
#define __AP_PWRSEQ_HOST_H

#if defined(CONFIG_AP_PWRSEQ) && defined(CONFIG_PLATFORM_EC_POWERSEQ_S0IX)
...
#endif /* CONFIG_AP_PWRSEQ && CONFIG_PLATFORM_EC_POWERSEQ_S0IX */

#endif /* __AP_PWRSEQ_HOST_H */
