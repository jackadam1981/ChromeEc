...
/*
 * Get the temperature sensor ID from a child node under "cros-ec,temp-sensors".
 *
 ...
 *
 *     TEMP_SENSOR_ID(DT_NODELABEL(i2c_sensor))
 *
...
/*
 * Get the temperature sensor ID from a hardware device node.
 *
 * Example devicetree fragment:
 *
 *     temp_charger_thermistor: charger-thermistor {
