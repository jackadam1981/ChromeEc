...
#define GPIO_UNIMPL_LIST(id) DT_FOREACH_PROP_ELEM(id, enum_names, GPIO_UNIMPL)
...
#endif
		GPIO_COUNT,
#if DT_HAS_COMPAT_STATUS_OKAY(unimplemented_gpios)
	DT_FOREACH_STATUS_OKAY(unimplemented_gpios, GPIO_UNIMPL_LIST)
#endif
		GPIO_LIMIT = 0x0FFF,
