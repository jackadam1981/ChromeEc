...
#ifdef CONFIG_PLATFORM_EC_FAN_MIN_DUTY_PCT
#define CONFIG_FAN_MIN_DUTY_PCT CONFIG_PLATFORM_EC_FAN_MIN_DUTY_PCT
#endif

#undef CONFIG_FAN_MAX_DUTY_PCT
#ifdef CONFIG_PLATFORM_EC_FAN_MAX_DUTY_PCT
#define CONFIG_FAN_MAX_DUTY_PCT CONFIG_PLATFORM_EC_FAN_MAX_DUTY_PCT
#endif
