...
#undef CONFIG_TEMP_SENSOR_EACH_READ_DELAY_MS
#ifdef CONFIG_PLATFORM_EC_TEMP_SENSOR_EACH_READ_DELAY
#define CONFIG_TEMP_SENSOR_EACH_READ_DELAY_MS \
	CONFIG_PLATFORM_EC_TEMP_SENSOR_EACH_READ_DELAY_MS
#endif
