...
#undef CONFIG_RT3645
#ifdef CONFIG_PLATFORM_EC_RT3645
#define CONFIG_RT3645
#define I2C_ADDR_IMVP DT_REG_ADDR(DT_COMPAT_GET_ANY_STATUS_OKAY(richtek_rt3645))
BUILD_ASSERT((DT_NUM_INST_STATUS_OKAY(richtek_rt3645)) == 1,
	     "Only one instance of richtek,rt3645 should be defined");
#endif

#undef CONFIG_IMVP_FACTORY_UPDATE
#ifdef CONFIG_PLATFORM_EC_IMVP_FACTORY_UPDATE
#define CONFIG_IMVP_FACTORY_UPDATE
#endif
