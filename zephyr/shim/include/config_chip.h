...
/*
 * Mutually exclusive, either single charger or
 * one charger per type-C port.
 */
#undef CONFIG_CHARGER_SINGLE_CHIP
#undef CONFIG_CHARGER_OCPC
#ifdef CONFIG_PLATFORM_EC_CHARGER_MULTIPLE
#if CONFIG_PLATFORM_EC_CHARGER_DEF_RBATT_MOHMS == 0
#error "A value for PLATFORM_EC_CHARGER_DEF_RBATT_MOHMS must be chosen"
#endif
#define CONFIG_CHARGER_OCPC
#define CONFIG_OCPC_DEF_RBATT_MOHMS CONFIG_PLATFORM_EC_CHARGER_DEF_RBATT_MOHMS
#else /* CONFIG_PLATFORM_EC_CHARGER_MULTIPLE */
#define CONFIG_CHARGER_SINGLE_CHIP
#endif /* CONFIG_PLATFORM_EC_CHARGER_MULTIPLE */
