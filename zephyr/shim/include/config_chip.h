...
#undef CONFIG_USBC_RETIMER_INTEL_BB_NO_VPRO_HOST_SUPPORT
#ifdef CONFIG_PLATFORM_EC_USBC_RETIMER_INTEL_BB_NO_VPRO_HOST_SUPPORT
#define CONFIG_USBC_RETIMER_INTEL_BB_NO_VPRO_HOST_SUPPORT
#endif
