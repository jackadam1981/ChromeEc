...
#if !defined(CONFIG_PLATFORM_EC_USB_PD_PORT_0_SHARED) && \
	CONFIG_USB_PD_PORT_MAX_COUNT > 0
#define HAS_TASK_PD_INT_C0 1
#endif

#if !defined(CONFIG_PLATFORM_EC_USB_PD_PORT_1_SHARED) && \
	CONFIG_USB_PD_PORT_MAX_COUNT > 1
#define HAS_TASK_PD_INT_C1 1
#endif

#if !defined(CONFIG_PLATFORM_EC_USB_PD_PORT_2_SHARED) && \
	CONFIG_USB_PD_PORT_MAX_COUNT > 2
#define HAS_TASK_PD_INT_C2 1
#endif

#if !defined(CONFIG_PLATFORM_EC_USB_PD_PORT_3_SHARED) && \
	CONFIG_USB_PD_PORT_MAX_COUNT > 3
