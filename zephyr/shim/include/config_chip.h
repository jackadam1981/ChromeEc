...
#ifdef CONFIG_PLATFORM_EC_HIBERNATE_DELAY_SECS
#undef CONFIG_HIBERNATE_DELAY_SECS
#define CONFIG_HIBERNATE_DELAY_SECS CONFIG_PLATFORM_EC_HIBERNATE_DELAY_SECS
#endif
#endif
