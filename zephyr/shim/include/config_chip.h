...
#ifdef CONFIG_PLATFORM_EC_POWER_LED_OFF_IN_SUSPEND
#undef CONFIG_POWER_LED_OFF_IN_SUSPEND
#define CONFIG_POWER_LED_OFF_IN_SUSPEND \
	CONFIG_PLATFORM_EC_POWER_LED_OFF_IN_SUSPEND
#endif
