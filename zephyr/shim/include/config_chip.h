...
/* For jedec,spi-nor RISCV chips expects the spi controller to memory map the
 * flash and for that mapping to be the second register property of the spi
 * controller.
 */
...
#undef CONFIG_HOST_COMMAND_ENTER_BOOTLOADER
#ifdef CONFIG_PLATFORM_EC_HOST_COMMAND_ENTER_BOOTLOADER
#define CONFIG_HOST_COMMAND_ENTER_BOOTLOADER
#endif
