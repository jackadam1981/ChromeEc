...
#undef CONFIG_CMD_KEYBOARD_KBLOG
#ifdef CONFIG_PLATFORM_EC_CONSOLE_CMD_KEYBOARD_KBLOG
#define CONFIG_CMD_KEYBOARD_KBLOG
#endif

#undef CONFIG_CMD_KEYBOARD_KBLOG_LEN
#ifdef CONFIG_PLATFORM_EC_CONSOLE_CMD_KEYBOARD_KBLOG_LEN
#define CONFIG_CMD_KEYBOARD_KBLOG_LEN \
	(CONFIG_PLATFORM_EC_CONSOLE_CMD_KEYBOARD_KBLOG_LEN)
#endif
