...
#undef CONFIG_USB_PD_EVENT_DRIVEN_SRC_OPEN_DETECT
#ifdef CONFIG_PLATFORM_EC_USB_PD_EVENT_DRIVEN_SRC_OPEN_DETECT
#define CONFIG_USB_PD_EVENT_DRIVEN_SRC_OPEN_DETECT
#endif
