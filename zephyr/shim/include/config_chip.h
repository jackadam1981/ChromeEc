...
#undef CONFIG_USBC_RETIMER_INTEL_BB_VPRO_CAPABLE_HOST
#ifdef CONFIG_PLATFORM_EC_USBC_RETIMER_INTEL_BB_VPRO_CAPABLE_HOST
#define CONFIG_USBC_RETIMER_INTEL_BB_VPRO_CAPABLE_HOST
#endif
