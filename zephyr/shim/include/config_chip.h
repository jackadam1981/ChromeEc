...
#undef CONFIG_USB_PD_PRL_EVENT_LOG_DEPTH
#ifdef CONFIG_PLATFORM_EC_USB_PD_PRL_EVENT_LOG_DEPTH
#define CONFIG_USB_PD_PRL_EVENT_LOG_DEPTH \
	CONFIG_PLATFORM_EC_USB_PD_PRL_EVENT_LOG_DEPTH
#endif
