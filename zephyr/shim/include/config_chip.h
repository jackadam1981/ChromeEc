 ...
 */
#define PD_OPERATING_POWER_MW	CONFIG_PD_OPERATING_POWER_MW
#define PD_MAX_POWER_MW		CONFIG_PD_MAX_POWER_MW
#define PD_MAX_CURRENT_MA	CONFIG_PD_MAX_CURRENT_MA
#define PD_MAX_VOLTAGE_MV	CONFIG_PD_MAX_VOLTAGE_MV
