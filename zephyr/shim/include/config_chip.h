...
#undef CONFIG_TIMER_CMD_CHGRAMP
#ifdef CONFIG_PLATFORM_EC_TIMER_CMD_CHGRAMP
#define CONFIG_TIMER_CMD_CHGRAMP
#endif
...
#ifdef CONFIG_PLATFORM_EC_UCONFIG_USBC_PPC_DEDICATED_INTSB_PD_DECODE_SOP
...
/* These are not supported with TCPMv2 */
