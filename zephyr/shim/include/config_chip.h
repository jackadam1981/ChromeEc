...
#ifdef CONFIG_PLATFORM_EC_DEDICATED_CHARGE_PORT_COUNT
#define CONFIG_DEDICATED_CHARGE_PORT_COUNT \
	CONFIG_PLATFORM_EC_DEDICATED_CHARGE_PORT_COUNT
#define DEDICATED_CHARGE_PORT \
	CONFIG_PLATFORM_EC_DEDICATED_CHARGE_PORT
#else
