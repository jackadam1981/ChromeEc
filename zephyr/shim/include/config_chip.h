...
#undef CONFIG_USB_PD_SHORT_PRESS_LIMIT
#ifdef CONFIG_PLATFORM_EC_USB_PD_SHORT_PRESS_LIMIT
#define CONFIG_USB_PD_SHORT_PRESS_LIMIT \
	CONFIG_PLATFORM_EC_USB_PD_SHORT_PRESS_LIMIT
#endif

#undef CONFIG_USB_PD_LONG_PRESS_LIMIT
#ifdef CONFIG_PLATFORM_EC_USB_PD_LONG_PRESS_LIMIT
#define CONFIG_USB_PD_LONG_PRESS_LIMIT \
	CONFIG_PLATFORM_EC_USB_PD_LONG_PRESS_LIMIT
#endif
