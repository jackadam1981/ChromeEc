...
#undef CONFIG_BATTERY_SMART_I2C_RETRY_COUNT
#ifdef CONFIG_PLATFORM_EC_BATTERY_SMART_I2C_RETRY_COUNT
#define CONFIG_BATTERY_SMART_I2C_RETRY_COUNT \
	CONFIG_PLATFORM_EC_BATTERY_SMART_I2C_RETRY_COUNT
#endif
