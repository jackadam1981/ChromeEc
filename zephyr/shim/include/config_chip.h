...
#ifdef CONFIG_PLATFORM_EC_USB_PD_TCPMV3
#define CONFIG_USB_PD_TCPMV3
#endif
...
#if defined(CONFIG_PLATFORM_EC_USB_POWER_DELIVERY) && defined(CONFIG_PLATFORM_EC_USB_PD_TCPMV2)
/* USBC-PD Port 0 */
