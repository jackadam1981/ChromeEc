...
#undef PLATFORM_EC_BUTTON_DEBOUNCE_CUSTOMER
#ifdef CONFIG_PLATFORM_EC_BUTTON_DEBOUNCE_CUSTOMER
#define CONFIG_BUTTON_DEBOUNCE_CUSTOMER
#endif

#undef PLATFORM_EC_BUTTON_DEBOUNCE_S0S0IX
#ifdef CONFIG_PLATFORM_EC_BUTTON_DEBOUNCE_S0S0IX
#define CONFIG_BUTTON_DEBOUNCE_S0S0IX CONFIG_PLATFORM_EC_BUTTON_DEBOUNCE_S0S0IX
#endif

#undef PLATFORM_EC_BUTTON_DEBOUNCE_S5
#ifdef CONFIG_PLATFORM_EC_BUTTON_DEBOUNCE_S5
#define CONFIG_BUTTON_DEBOUNCE_S5 CONFIG_PLATFORM_EC_BUTTON_DEBOUNCE_S5
#endif
