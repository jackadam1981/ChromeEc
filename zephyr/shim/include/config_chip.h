...
#ifdef CONFIG_PLATFORM_EC_MKBP_EVENT_KEY_MATRIX
#define CONFIG_EC_MKBP_EVENT_KEY_MATRIX (1 << 0)
#else
#define CONFIG_EC_MKBP_EVENT_KEY_MATRIX 0
#endif

#ifdef CONFIG_PLATFORM_EC_MKBP_EVENT_HOST_EVENT
#define CONFIG_EC_MKBP_EVENT_HOST_EVENT (1 << 1)
#else
#define CONFIG_EC_MKBP_EVENT_HOST_EVENT 0
#endif

#ifdef CONFIG_PLATFORM_EC_MKBP_EVENT_SENSOR_FIFO
#define CONFIG_EC_MKBP_EVENT_SENSOR_FIFO (1 << 2)
#else
#define CONFIG_EC_MKBP_EVENT_SENSOR_FIFO 0
#endif

#ifdef CONFIG_PLATFORM_EC_MKBP_EVENT_BUTTON
#define CONFIG_EC_MKBP_EVENT_BUTTON (1 << 3)
#else
#define CONFIG_EC_MKBP_EVENT_BUTTON 0
#endif

#ifdef CONFIG_PLATFORM_EC_MKBP_EVENT_SWITCH
#define CONFIG_EC_MKBP_EVENT_SWITCH (1 << 4)
#else
#define CONFIG_EC_MKBP_EVENT_SWITCH 0
#endif

#ifdef CONFIG_PLATFORM_EC_MKBP_EVENT_FINGERPRINT
#define CONFIG_EC_MKBP_EVENT_FINGERPRINT (1 << 5)
#else
#define CONFIG_EC_MKBP_EVENT_FINGERPRINT  0
#endif

#ifdef CONFIG_PLATFORM_EC_MKBP_EVENT_SYSRQ
#define CONFIG_EC_MKBP_EVENT_SYSRQ (1 << 6)
#else
#define CONFIG_EC_MKBP_EVENT_SYSRQ 0
#endif

#ifdef CONFIG_PLATFORM_EC_MKBP_EVENT_HOST_EVENT64
#define CONFIG_EC_MKBP_EVENT_HOST_EVENT64 (1 << 7)
#else
#define CONFIG_EC_MKBP_EVENT_HOST_EVENT64 0
#endif

#ifdef CONFIG_PLATFORM_EC_MKBP_EVENT_CEC_EVENT
#define CONFIG_EC_MKBP_EVENT_CEC_EVENT (1 << 8)
#else
#define CONFIG_EC_MKBP_EVENT_CEC_EVENT 0
#endif

#ifdef CONFIG_PLATFORM_EC_MKBP_EVENT_CEC_MESSAGE
#define CONFIG_EC_MKBP_EVENT_CEC_MESSAGE (1 << 9)
#else
#define CONFIG_EC_MKBP_EVENT_CEC_MESSAGE 0
#endif

#ifdef CONFIG_PLATFORM_EC_MKBP_EVENT_DP_ALT_MODE_ENTERED
#define CONFIG_EC_MKBP_EVENT_DP_ALT_MODE_ENTERED (1 << 10)
#else
#define CONFIG_EC_MKBP_EVENT_DP_ALT_MODE_ENTERED 0
#endif

#ifdef CONFIG_PLATFORM_EC_MKBP_EVENT_ONLINE_CALIBRATION
#define CONFIG_EC_MKBP_EVENT_ONLINE_CALIBRATION (1 << 11)
#else
#define CONFIG_EC_MKBP_EVENT_ONLINE_CALIBRATION 0
#endif

#ifdef CONFIG_PLATFORM_EC_MKBP_EVENT_PCHG
#define CONFIG_EC_MKBP_EVENT_PCHG (1 << 12)
#else
#define CONFIG_EC_MKBP_EVENT_PCHG 0
#endif

#undef CONFIG_MKBP_EVENT_WAKEUP_MASK
#ifdef CONFIG_PLATFORM_EC_MKBP_EVENT_WAKEUP_MASK
#define CONFIG_MKBP_EVENT_WAKEUP_MASK \
	(CONFIG_EC_MKBP_EVENT_KEY_MATRIX | \
	CONFIG_EC_MKBP_EVENT_HOST_EVENT | \
	CONFIG_EC_MKBP_EVENT_SENSOR_FIFO | \
	CONFIG_EC_MKBP_EVENT_BUTTON | \
	CONFIG_EC_MKBP_EVENT_SWITCH | \
	CONFIG_EC_MKBP_EVENT_FINGERPRINT | \
	CONFIG_EC_MKBP_EVENT_SYSRQ | \
	CONFIG_EC_MKBP_EVENT_HOST_EVENT64 | \
	CONFIG_EC_MKBP_EVENT_CEC_EVENT | \
	CONFIG_EC_MKBP_EVENT_CEC_MESSAGE | \
	CONFIG_EC_MKBP_EVENT_DP_ALT_MODE_ENTERED | \
	CONFIG_EC_MKBP_EVENT_ONLINE_CALIBRATION | \
	CONFIG_EC_MKBP_EVENT_PCHG)
#endif

#undef CONFIG_MKBP_HOST_EVENT_WAKEUP_MASK
#ifdef CONFIG_PLATFORM_EC_MKBP_HOST_EVENT_WAKEUP_MASK
#define CONFIG_MKBP_HOST_EVENT_WAKEUP_MASK 0
#endif
