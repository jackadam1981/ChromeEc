...
#ifdef PLATFORM_EC_POWER_SLEEP_FAILURE_DETECTION_MS
#define CONFIG_SLEEP_TIMEOUT_MS PLATFORM_EC_POWER_SLEEP_FAILURE_DETECTION_MS
#endif

#undef CONFIG_POWER_SLEEP_FAILURE_DETECTION_RESET
#ifdef CONFIG_PLATFORM_EC_POWER_SLEEP_FAILURE_DETECTION_RESET
