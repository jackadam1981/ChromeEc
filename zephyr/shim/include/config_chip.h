...
#ifdef CONFIG_PLATFORM_EC_RGB_KEYBOARD
#define CONFIG_RGB_KEYBOARD
#endif

#undef CONFIG_RGB_KEYBOARD_DEBUG
#ifdef CONFIG_PLATFORM_EC_RGB_KEYBOARD_DEBUG
#define CONFIG_RGB_KEYBOARD_DEBUG
#endif

#undef CONFIG_LED_DRIVER_TLC59116F
#ifdef CONFIG_PLATFORM_EC_LED_DRIVER_TLC59116F
#define CONFIG_LED_DRIVER_TLC59116F
#endif
