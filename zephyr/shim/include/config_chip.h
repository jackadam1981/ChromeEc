...
// The binary file is flash at 0x1000 for FT
//#define CONFIG_EC_PROTECTED_STORAGE_OFF DT_PROP(_BINMAN_RO_PATH, offset)
#define CONFIG_EC_PROTECTED_STORAGE_OFF (DT_PROP(_BINMAN_RO_PATH, offset) + 0x1000)
...
#define CONFIG_EC_WRITABLE_STORAGE_OFF (DT_PROP(_BINMAN_RW_PATH, offset) + 0x1000) 
