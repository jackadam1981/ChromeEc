...
#define SENSOR_LID_ACCEL_NODE_ID	DT_NODELABEL(lid_accel)
#define SENSOR_BASE_ACCEL_NODE_ID	DT_NODELABEL(base_accel)
#define CONFIG_LID_ANGLE_SENSOR_LID	SENSOR_ID(SENSOR_LID_ACCEL_NODE_ID)
#define CONFIG_LID_ANGLE_SENSOR_BASE	SENSOR_ID(SENSOR_BASE_ACCEL_NODE_ID)
#endif
