...
#define BC12_CHIP_FIND(usbc_id, bc12_id)                                       \
	COND_CODE_1(DT_NODE_HAS_COMPAT(bc12_id, RT1718S_BC12_COMPAT),          \
		    (BC12_CHIP_ENTRY(usbc_id, bc12_id, BC12_CHIP_RT1718S)),    \
		    ())                                                        \
	COND_CODE_1(DT_NODE_HAS_COMPAT(bc12_id, RT1739_BC12_COMPAT),           \
		    (BC12_CHIP_ENTRY(usbc_id, bc12_id, BC12_CHIP_RT1739)), ()) \
	COND_CODE_1(DT_NODE_HAS_COMPAT(bc12_id, RT9490_BC12_COMPAT),           \
		    (BC12_CHIP_ENTRY(usbc_id, bc12_id, BC12_CHIP_RT9490)), ()) \
	COND_CODE_1(DT_NODE_HAS_COMPAT(bc12_id, PI3USB9201_COMPAT),            \
		    (BC12_CHIP_ENTRY(usbc_id, bc12_id, BC12_CHIP_PI3USB9201)), \
		    ())
