...
const struct power_signal_info power_signal_list[] = {
	DT_FOREACH_STATUS_OKAY(named_gpios, GEN_POWER_SIGNAL_STRUCT_PARENT)
};
...
/*
 * TODO: Convert all of the profiles that define
 * CONFIG_AP_ARM_MTK_MT8192 and replace this default
 * enum with the following warning
 *
