...
#define PWM_DT_SPEC_BY_IDX_INIT(node_id, led_ch)                            \
	{                                                                   \
...
static const struct pwm_dt_spec _pwm_dt_spec_sidesel =
	PWM_DT_SPEC_BY_IDX_INIT(DT_INST_PROP(0, sidesel), 0);
