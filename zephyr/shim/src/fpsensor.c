...
BUILD_ASSERT(FINGERPRINT_CAPTURE_TYPE_VENDOR_FORMAT ==
	     (enum fingerprint_capture_type)FP_CAPTURE_VENDOR_FORMAT);
BUILD_ASSERT(FINGERPRINT_CAPTURE_TYPE_SIMPLE_IMAGE ==
	     (enum fingerprint_capture_type)FP_CAPTURE_SIMPLE_IMAGE);
BUILD_ASSERT(FINGERPRINT_CAPTURE_TYPE_PATTERN0 ==
	     (enum fingerprint_capture_type)FP_CAPTURE_PATTERN0);
BUILD_ASSERT(FINGERPRINT_CAPTURE_TYPE_PATTERN1 ==
	     (enum fingerprint_capture_type)FP_CAPTURE_PATTERN1);
BUILD_ASSERT(FINGERPRINT_CAPTURE_TYPE_QUALITY_TEST ==
	     (enum fingerprint_capture_type)FP_CAPTURE_QUALITY_TEST);
BUILD_ASSERT(FINGERPRINT_CAPTURE_TYPE_RESET_TEST ==
	     (enum fingerprint_capture_type)FP_CAPTURE_RESET_TEST);
BUILD_ASSERT(FINGERPRINT_CAPTURE_TYPE_MAX ==
	     (enum fingerprint_capture_type)FP_CAPTURE_TYPE_MAX);
