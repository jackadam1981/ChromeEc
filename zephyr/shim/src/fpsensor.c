...
BUILD_ASSERT(FINGERPRINT_CAPTURE_TYPE_SIMPLE_IMAGE == FP_CAPTURE_SIMPLE_IMAGE);
BUILD_ASSERT(FINGERPRINT_CAPTURE_TYPE_PATTERN0 == FP_CAPTURE_PATTERN0);
BUILD_ASSERT(FINGERPRINT_CAPTURE_TYPE_PATTERN1 == FP_CAPTURE_PATTERN1);
BUILD_ASSERT(FINGERPRINT_CAPTURE_TYPE_QUALITY_TEST == FP_CAPTURE_QUALITY_TEST);
BUILD_ASSERT(FINGERPRINT_CAPTURE_TYPE_RESET_TEST == FP_CAPTURE_RESET_TEST);
BUILD_ASSERT(FINGERPRINT_CAPTURE_TYPE_MAX == FP_CAPTURE_TYPE_MAX);
