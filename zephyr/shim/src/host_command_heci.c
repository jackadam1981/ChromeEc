...
static bool heci_cros_ec_connected;
...
static int cros_ec_ishtp_client_init(void)
{
	...
	heci_client_t cros_ec_ishtp_client = {
...
SYS_INIT(cros_ec_ishtp_client_init, APPLICATION, 95);
