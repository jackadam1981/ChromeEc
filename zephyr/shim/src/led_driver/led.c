...
<<<<<<< PATCH SET (28b9be6936757953e27bd5e939818d24b0992d71 led driver: support 2 policies)
#if PINS2_DEFINED
	DT_FOREACH_CHILD_STATUS_OKAY_VARGS(PINS2_PARENT_NODE, DT_FOREACH_CHILD,
					   INVOKE_APPLY_COLOR_API)
#endif
||||||| BASE      (6abe0e322b3d0aa1a72b83393dc0268d02a5840f led: test function pointer)
=======
>>>>>>> BASE      (c8985f721f15fe15c13516f7707d10bff417f3e1 power/qcom_exp: Boot system if AC present and battery is low)
}
