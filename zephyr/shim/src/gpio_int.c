...
/*
 * Structure containing the configuration data for an interrupt,
 * such as the initial flags and the handler vector.
 ...
 */
struct gpio_callback int_cb_data[COUNT_INT_ENUM];
