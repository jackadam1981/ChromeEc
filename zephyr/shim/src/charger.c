...
#include "usbc/chg_isl923x.h"
#include "usbc/chg_isl9241.h"
#include "usbc/chg_rt9490.h"
#include "usbc/chg_sm5803.h"
...
BUILD_ASSERT(ARRAY_SIZE(chg_chips) == 1,
	"For the CHARGER_SINGLE_CHIP config, the number of defined charger chips must equal 1.");
#else
BUILD_ASSERT(ARRAY_SIZE(chg_chips) == CONFIG_USB_PD_PORT_MAX_COUNT,
	"For the OCPC config, the number of defined charger chips must equal the number of USB-C ports.");
#endif
