...
#if DT_HAS_COMPAT_STATUS_OKAY(RT1739_COMPAT) || \
...
struct ppc_config_t ppc_chips[] = {
	DT_FOREACH_STATUS_OKAY_VARGS(RT1739_COMPAT, PPC_CHIP_PRIM,
				     PPC_CHIP_RT1739)
...
struct ppc_config_t ppc_chips_alt[] = {
	DT_FOREACH_STATUS_OKAY_VARGS(RT1739_COMPAT, PPC_CHIP_ALT,
				     PPC_CHIP_RT1739)
