...
test_export_static inline k_tid_t get_idle_thread(void)
{
...
test_export_static inline k_tid_t get_sysworkq_thread(void)
{
...
test_export_static inline k_tid_t get_main_thread(void)
{
