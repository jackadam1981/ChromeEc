...
/*
 * Macros here are used for data structures defined in accelgyro.h.
 * the structures are used and used by motion sensor driver.
 *
 * Using the information from device tree, macros help to create
 * driver data for motion sensors
 *
 */
