...
#include "usbc/tcpc_nct38xx_2.h"
#include "usbc/tcpci.h"
#include "usbc/utils.h"

#if DT_HAS_COMPAT_STATUS_OKAY(FUSB302_TCPC_COMPAT) ||                          \
	DT_HAS_COMPAT_STATUS_OKAY(NCT38XX_TCPC_COMPAT1) ||                      \
	DT_HAS_COMPAT_STATUS_OKAY(NCT38XX_TCPC_COMPAT2) ||                      \
...
MAYBE_CONST struct tcpc_config_t tcpc_config[] = {
	DT_FOREACH_STATUS_OKAY_VARGS(FUSB302_TCPC_COMPAT, TCPC_CONFIG,
				     TCPC_CONFIG_FUSB302)
	DT_FOREACH_STATUS_OKAY_VARGS(NCT38XX_TCPC_COMPAT1, TCPC_CONFIG,
				     TCPC_CONFIG_NCT38XX1)
	DT_FOREACH_STATUS_OKAY_VARGS(IT8XXX2_TCPC_COMPAT, TCPC_CONFIG,
				     TCPC_CONFIG_IT8XXX2)
	DT_FOREACH_STATUS_OKAY_VARGS(PS8XXX_COMPAT, TCPC_CONFIG,
				     TCPC_CONFIG_PS8XXX)
	DT_FOREACH_STATUS_OKAY_VARGS(NCT38XX_TCPC_COMPAT2, TCPC_CONFIG,
				     TCPC_CONFIG_NCT38XX2)
