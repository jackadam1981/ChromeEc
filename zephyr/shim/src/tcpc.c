...
#define TCPC_CHIP_FIND(usbc_id, tcpc_id)                                       \
	...
	CHECK_COMPAT(RT171X_TCPC_COMPAT, usbc_id, tcpc_id, TCPC_CONFIG_RT171X) \
...
/*
 * Define a global struct tcpc_config_t for every TCPC node in the tree with the
 * "is-alt" property set.
 */
DT_FOREACH_STATUS_OKAY_VARGS(ANX7447_TCPC_COMPAT, TCPC_ALT_DEFINE, TCPC_CONFIG_ANX7447)
DT_FOREACH_STATUS_OKAY_VARGS(CCGXXF_TCPC_COMPAT, TCPC_ALT_DEFINE,
			     TCPC_CONFIG_CCGXXF)
DT_FOREACH_STATUS_OKAY_VARGS(FUSB302_TCPC_COMPAT, TCPC_ALT_DEFINE, TCPC_CONFIG_FUSB302)
DT_FOREACH_STATUS_OKAY_VARGS(IT8XXX2_TCPC_COMPAT, TCPC_ALT_DEFINE, TCPC_CONFIG_IT8XXX2)
DT_FOREACH_STATUS_OKAY_VARGS(NCT38XX_TCPC_COMPAT, TCPC_ALT_DEFINE,
			     TCPC_CONFIG_PS8XXX)
DT_FOREACH_STATUS_OKAY_VARGS(RAA489000_TCPC_COMPAT, TCPC_ALT_DEFINE, TCPC_CONFIG_RAA489000)
DT_FOREACH_STATUS_OKAY_VARGS(RT1718S_TCPC_COMPAT, TCPC_ALT_DEFINE,
			     TCPC_CONFIG_RT1718S)
DT_FOREACH_STATUS_OKAY_VARGS(TCPCI_COMPAT, TCPC_ALT_DEFINE,
			     TCPC_CONFIG_TCPCI)
DT_FOREACH_STATUS_OKAY_VARGS(RT171X_TCPC_COMPAT, TCPC_ALT_DEFINE,
			     TCPC_CONFIG_RT171X)
