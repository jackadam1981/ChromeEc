...
void system_jump_to_booter(void)
{
	...
	/* MCHP TODO Read selected image from SPI flash into SRAM
 ...
 * We don't need this as the SPI flash is fully read-able.
 */
