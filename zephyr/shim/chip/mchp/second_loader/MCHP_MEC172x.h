...
typedef struct {
	/* GPIO_000_036_INST Structure */

	union {
		__IO uint32_t GPIO_000_PIN_CONTROL;
		...
		} GPIO_000_PIN_CONTROL_b;
	};
	__I uint32_t RESERVED;

	union {
		__IO uint32_t GPIO_002_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_002_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_003_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_003_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_004_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_004_PIN_CONTROL_b;
	};
	__I uint32_t RESERVED1[2];

	union {
		__IO uint32_t GPIO_007_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_007_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_010_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_010_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_011_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_011_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_012_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_012_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_013_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_013_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_014_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_014_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_015_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_015_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_016_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_016_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_017_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_017_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_020_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_020_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_021_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_021_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_022_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_022_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_023_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_023_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_024_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_024_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_025_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_025_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_026_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_026_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_027_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_027_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_030_PIN_CONTROL;
		struct {
			__IO uint32_t PU_PD : 2;
			__IO uint32_t POWER_GATING : 2;
			__IO uint32_t INTERRUPT_DETECTION : 3;
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_030_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_031_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_031_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_032_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_032_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_033_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_033_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_034_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_034_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_035_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_035_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_036_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_036_PIN_CONTROL_b;
	};
} GPIO_000_036_INST_Type;

typedef struct {
	/* GPIO_040_073_INST Structure */

	union {
		__IO uint32_t GPIO_040_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_040_PIN_CONTROL_b;
	};
	__I uint32_t RESERVED;

	union {
		__IO uint32_t GPIO_042_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_042_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_043_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_043_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_044_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_044_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_045_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_045_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_046_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_046_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_047_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_047_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_050_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_050_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_051_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_051_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_052_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_052_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_053_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_053_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_054_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_054_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_055_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_055_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_056_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_056_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_057_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_057_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_060_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_060_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_061_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_061_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_062_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_062_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_063_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_063_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_064_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_064_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_065_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_065_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_066_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_066_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_067_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_067_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_070_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_070_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_071_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_071_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_072_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_072_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_073_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_073_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_074_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_074_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_075_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_075_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_076_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_076_PIN_CONTROL_b;
	};
} GPIO_040_073_INST_Type;

typedef struct {
	/* GPIO_100_137_INST Structure */

	union {
		__IO uint32_t GPIO_100_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_100_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_101_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_101_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_102_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_102_PIN_CONTROL_b;
	};
	__I uint32_t RESERVED;

	union {
		__IO uint32_t GPIO_104_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_104_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_105_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_105_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_106_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_106_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_107_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_107_PIN_CONTROL_b;
	};
	__I uint32_t RESERVED1[2];

	union {
		__IO uint32_t GPIO_112_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_112_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_113_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_113_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_114_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_114_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_115_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_115_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_116_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_116_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_117_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_117_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_120_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_120_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_121_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_121_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_122_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_122_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_123_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_123_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_124_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_124_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_125_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_125_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_126_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_126_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_127_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_127_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_130_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_130_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_131_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_131_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_132_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_132_PIN_CONTROL_b;
	};
} GPIO_100_137_INST_Type;

typedef struct {
	/* GPIO_140_176_INST Structure */

	union {
		__IO uint32_t GPIO_140_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_140_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_141_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_141_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_142_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_142_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_143_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_143_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_144_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_144_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_145_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_145_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_146_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_146_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_147_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_147_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_150_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_150_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_151_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_151_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_152_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_152_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_153_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_153_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_154_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_154_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_155_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_155_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_156_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_156_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_157_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_157_PIN_CONTROL_b;
	};
	__I uint32_t RESERVED;

	union {
		__IO uint32_t GPIO_161_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_161_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_162_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_162_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_163_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_163_PIN_CONTROL_b;
	};
	__I uint32_t RESERVED1;

	union {
		__IO uint32_t GPIO_165_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_165_PIN_CONTROL_b;
	};
	__I uint32_t RESERVED2[2];

	union {
		__IO uint32_t GPIO_170_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_170_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_171_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_171_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_172_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_172_PIN_CONTROL_b;
	};
	__I uint32_t RESERVED3[2];

	union {
		__IO uint32_t GPIO_175_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_175_PIN_CONTROL_b;
	};
} GPIO_140_176_INST_Type;

typedef struct {
	/* GPIO_200_234_INST Structure */

	union {
		__IO uint32_t GPIO_200_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_200_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_201_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_201_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_202_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_202_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_203_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_203_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_204_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_204_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_205_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_205_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_206_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_206_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_207_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_207_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_210_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_210_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_211_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_211_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_212_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_212_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_213_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_213_PIN_CONTROL_b;
	};
	__I uint32_t RESERVED[5];

	union {
		__IO uint32_t GPIO_221_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_221_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_222_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_222_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_223_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_223_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_224_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_224_PIN_CONTROL_b;
	};
	__I uint32_t RESERVED1;

	union {
		__IO uint32_t GPIO_226_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_226_PIN_CONTROL_b;
	};

	union {
		__IO uint32_t GPIO_227_PIN_CONTROL;
		...
		struct {
			...
			uint32_t: 7;
			__I uint32_t GPIO_INPUT : 1;
		} GPIO_227_PIN_CONTROL_b;
	};
} GPIO_200_234_INST_Type;

typedef struct {
	/* GPIO_PIN_CONTROL_2_INST Structure */

	union {
		__IO uint32_t GPIO_000_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_000_PIN_CONTROL_2_b;
	};
	__I uint32_t RESERVED;

	union {
		__IO uint32_t GPIO_002_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_002_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_003_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_003_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_004_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_004_PIN_CONTROL_2_b;
	};
	__I uint32_t RESERVED1[2];

	union {
		__IO uint32_t GPIO_007_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_007_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_010_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_010_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_011_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_011_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_012_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_012_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_013_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_013_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_014_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_014_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_015_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_015_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_016_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_016_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_017_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_017_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_020_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_020_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_021_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_021_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_022_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_022_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_023_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_023_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_024_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_024_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_025_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_025_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_026_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_026_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_027_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_027_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_030_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_030_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_031_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_031_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_032_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_032_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_033_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_033_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_034_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_034_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_035_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_035_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_036_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_036_PIN_CONTROL_2_b;
	};
	__I uint32_t RESERVED2;

	union {
		__IO uint32_t GPIO_040_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_040_PIN_CONTROL_2_b;
	};
	__I uint32_t RESERVED3;

	union {
		__IO uint32_t GPIO_042_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_042_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_043_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_043_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_044_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_044_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_045_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_045_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_046_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_046_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_047_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_047_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_050_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_050_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_051_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_051_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_052_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_052_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_053_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_053_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_054_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_054_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_055_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_055_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_056_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_056_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_057_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_057_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_060_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_060_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_061_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_061_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_062_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_062_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_063_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_063_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_064_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_064_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_065_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_065_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_066_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_066_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_067_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_067_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_070_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_070_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_071_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_071_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_072_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_072_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_073_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_073_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_074_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_074_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_075_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_075_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_076_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_076_PIN_CONTROL_2_b;
	};
	__I uint32_t RESERVED4;

	union {
		__IO uint32_t GPIO_100_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_100_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_101_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_101_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_102_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_102_PIN_CONTROL_2_b;
	};
	__I uint32_t RESERVED5;

	union {
		__IO uint32_t GPIO_104_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_104_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_105_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_105_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_106_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_106_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_107_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_107_PIN_CONTROL_2_b;
	};
	__I uint32_t RESERVED6[2];

	union {
		__IO uint32_t GPIO_112_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_112_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_113_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_113_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_114_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_114_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_115_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_115_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_116_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_116_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_117_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_117_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_120_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_120_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_121_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_121_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_122_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_122_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_123_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_123_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_124_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_124_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_125_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_125_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_126_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_126_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_127_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_127_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_130_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_130_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_131_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_131_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_132_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_132_PIN_CONTROL_2_b;
	};
	__I uint32_t RESERVED7[5];

	union {
		__IO uint32_t GPIO_140_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_140_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_141_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_141_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_142_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_142_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_143_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_143_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_144_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_144_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_145_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_145_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_146_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_146_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_147_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_147_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_150_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_150_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_151_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_151_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_152_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_152_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_153_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_153_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_154_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_154_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_155_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_155_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_156_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_156_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_157_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_157_PIN_CONTROL_2_b;
	};
	__I uint32_t RESERVED8;

	union {
		__IO uint32_t GPIO_161_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_161_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_162_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_162_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_163_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_163_PIN_CONTROL_2_b;
	};
	__I uint32_t RESERVED9;

	union {
		__IO uint32_t GPIO_165_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_165_PIN_CONTROL_2_b;
	};
	__I uint32_t RESERVED10[2];

	union {
		__IO uint32_t GPIO_170_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_170_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_171_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_171_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_172_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_172_PIN_CONTROL_2_b;
	};
	__I uint32_t RESERVED11[2];

	union {
		__IO uint32_t GPIO_175_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_175_PIN_CONTROL_2_b;
	};
	__I uint32_t RESERVED12[2];

	union {
		__IO uint32_t GPIO_200_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_200_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_201_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_201_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_202_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_202_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_203_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_203_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_204_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_204_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_205_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_205_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_206_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_206_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_207_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_207_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_210_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_210_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_211_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_211_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_212_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_212_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_213_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_213_PIN_CONTROL_2_b;
	};
	__I uint32_t RESERVED13[5];

	union {
		__IO uint32_t GPIO_221_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_221_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_222_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_222_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_223_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_223_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_224_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_224_PIN_CONTROL_2_b;
	};
	__I uint32_t RESERVED14;

	union {
		__IO uint32_t GPIO_226_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_226_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_227_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_227_PIN_CONTROL_2_b;
	};
	__I uint32_t RESERVED15[8];

	union {
		__IO uint32_t GPIO_240_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_240_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_241_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_241_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_242_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_242_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_243_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_243_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_244_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_244_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_245_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_245_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_246_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_246_PIN_CONTROL_2_b;
	};
	__I uint32_t RESERVED16;

	union {
		__IO uint32_t GPIO_250_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_250_PIN_CONTROL_2_b;
	};
	__I uint32_t RESERVED17[2];

	union {
		__IO uint32_t GPIO_253_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_253_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_254_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_254_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_255_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_255_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_256_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_256_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_257_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_257_PIN_CONTROL_2_b;
	};

	union {
		__IO uint32_t GPIO_260_PIN_CONTROL_2;

		struct {
			__IO uint32_t SLEW_RATE : 1;
			uint32_t: 3;
			__IO uint32_t DRIVE_STRENGTH : 2;
		} GPIO_260_PIN_CONTROL_2_b;
	};
...
#define GPIO_040_073_INST ((GPIO_040_073_INST_Type *)GPIO_040_073_INST_BASE)
...
#define GPIO_200_234_INST ((GPIO_200_234_INST_Type *)GPIO_200_234_INST_BASE)
#define GPIO_PIN_CONTROL_2_INST \
	((GPIO_PIN_CONTROL_2_INST_Type *)GPIO_PIN_CONTROL_2_INST_BASE)
