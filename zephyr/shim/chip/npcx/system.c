...
/*
 * The priority should be higher than CROS_BBRAM_NPCX_INIT_PRIORITY.
 */
#if (CONFIG_PLATFORM_EC_CHIP_SYSTEM_PRE_INIT_PRIORITY <= \
     CROS_BBRAM_NPCX_INIT_PRIORITY)
#error CONFIG_PLATFORM_EC_CHIP_SYSTEM_PRE_INIT_PRIORITY must greater than \
	CROS_BBRAM_NPCX_INIT_PRIORITY
#endif
SYS_INIT(chip_system_init, PRE_KERNEL_1,
	 CONFIG_PLATFORM_EC_CHIP_SYSTEM_PRE_INIT_PRIORITY);
