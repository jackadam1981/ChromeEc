 ...
 */
#if (CONFIG_SYSTEM_PRE_INIT_PRIORITY <= CONFIG_CROS_SYSTEM_NPCX_INIT_PRIORITY \
     || CONFIG_SYSTEM_PRE_INIT_PRIORITY <= CROS_BBRAM_NPCX_INIT_PRIORITY)
#error CONFIG_SYSTEM_PRE_INIT_PRIORITY must greater than \
	CONFIG_CROS_SYSTEM_NPCX_INIT_PRIORITY & CROS_BBRAM_NPCX_INIT_PRIORITY
#endif
SYS_INIT(chip_system_init, PRE_KERNEL_1, CONFIG_SYSTEM_PRE_INIT_PRIORITY);
