...
{
	char *end_ptr;
	int num = strtoi(argv[1], &end_ptr, 0);
...
SHELL_STATIC_SUBCMD_SET_CREATE(sub_gpiodbg,
...
SHELL_CMD_ARG_REGISTER(gpiodbg, &sub_gpiodbg, "Commands for power consumption "
		       "investigation", NULL, 2, 0);
