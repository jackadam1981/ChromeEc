...
/*
 * The base address (Word offset) for the EGIS ET171 EGIS_KEY area in the OTP
 * memory map. This entire area is locked.
 */
#define EGIS_ET171_OTP_EGIS_KEY_BASE_ADDR 0x64
...
/* Calculated starting address (Word offset) of EGIS_KEY3 in the OTP memory. */
static const uint32_t otp_key_word_addr =
	EGIS_ET171_OTP_EGIS_KEY_BASE_ADDR +
