...
/*
 * There is no cleare awnser to this, because flash protection is set according
 ...
 * Set the vaule as the smallest possible protection range which is 1/256 of the
