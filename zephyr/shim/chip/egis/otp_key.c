...
/* EGIS ET171 OTP memory map details from the Flash Memory Address Map */
#define EGIS_ET171_OTP_BASE_ADDR 0x64

/* Index of the secret key (skey3) within the OTP key region */
#define EGIS_ET171_OTP_SECRET_KEY_INDEX 2

static const uint32_t otp_key_len = OTP_KEY_SIZE_BYTES / sizeof(uint32_t);

/* Calculated address of the OTP key @index 2 in the EGIS ET171 OTP memory */
static const uint32_t otp_key_addr =
	EGIS_ET171_OTP_BASE_ADDR +
	EGIS_ET171_OTP_SECRET_KEY_INDEX * otp_key_len;
