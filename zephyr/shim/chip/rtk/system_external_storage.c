...
#define CHROME_ECRO_WORD 0x4F524345u /* ASCII ECRO */
#define CHROME_ECRW_WORD 0x57524345u /* ASCII ECRW */
...
#define RTK_FW_LOAD_BASED (CONFIG_CROS_EC_PROGRAM_MEMORY_BASE - CONFIG_CROS_EC_HEADER_OFF)
#define RTK_FW_RESET_VECTOR (CONFIG_CROS_EC_PROGRAM_MEMORY_BASE + 0x04u)
