...
SPIC_STATUS_t spic_command_transfer(const SPIC_COMMAND_t *command, const void *tx_data, uint32_t tx_size, void *rx_data, uint32_t rx_size);
SPIC_STATUS_t spic_read(const SPIC_COMMAND_t *command, void *data, uint32_t *length);
