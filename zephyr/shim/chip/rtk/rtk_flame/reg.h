...
typedef struct {                                /*!< (@ 0x40091000) IOPAD Structure                                            */
  ...
  union {
    volatile uint32_t FLASHWP;                     /*!< (@ 0x00000000) INTERNAL FLASH_WP PAD CONTROL REGISTER                     */

    struct {
      volatile uint32_t INDETEN    : 1;            /*!< [0..0] Input Detection Enable                                             */
      volatile uint32_t OUTDRV     : 1;            /*!< [1..1] Pin Status                                                         */
      volatile uint32_t SLEWRATE   : 1;            /*!< [2..2] Slew-rate selection                                                */
      volatile uint32_t PULLDWEN   : 1;            /*!< [3..3] Pull-Down Enable                                                   */
      volatile uint32_t PULLUPEN   : 1;            /*!< [4..4] Pull-Up Enable                                                     */
      volatile uint32_t SCHEN      : 1;            /*!< [5..5] Schmitter-Trigger Enable                                           */
            uint32_t            : 26;
    } FLASHWP_b;
  } ;

  union {
    volatile uint32_t FLASHHOLD;                   /*!< (@ 0x00000004) INTERNAL FLASH_HOLD PAD CONTROL REGISTER                   */
  ...
  union {
    volatile uint32_t FLASHSI;                     /*!< (@ 0x00000008) INTERNAL FLASH_SI PAD CONTROL REGISTER                     */
  ...
  union {
    volatile uint32_t FLASHSO;                     /*!< (@ 0x0000000C) INTERNAL FLASH_SO PAD CONTROL REGISTER                     */
  ...
  union {
    volatile uint32_t FLASHCS;                     /*!< (@ 0x00000010) INTERNAL FLASH_CS PAD CONTROL REGISTER                     */
  ...
  union {
    volatile uint32_t FLASHCLK;                    /*!< (@ 0x00000014) INTERNAL FLASH_CLK PAD CONTROL REGISTER                    */
  ...
  union {
    volatile uint32_t PECI;                        /*!< (@ 0x00000018) PECI PAD CONTROL REGISTER                                  */
...
typedef struct {                                /*!< (@ 0x40010200) SPIC Structure                                             */
  ...
  union {
    ...
    struct {
            uint32_t            : 6;
      volatile uint32_t SCPH       : 1;            /*!< [6..6] Serial Clock Phase                                                 */
      volatile uint32_t SCPOL      : 1;            /*!< [7..7] Serial Clock Polarity                                              */
      volatile uint32_t TMOD       : 2;            /*!< [9..8] Transfer Mode                                                      */
            uint32_t            : 6;
      volatile uint32_t ADDRCH     : 2;            /*!< [17..16] Channel Number of Address Phase After Command Phase              */
      volatile uint32_t DATACH     : 2;            /*!< [19..18] Channel Number of Data in Transmitting or Receiving
                                                     Data                                                                      */
      volatile uint32_t CMDCH      : 2;            /*!< [21..20] Channel Number of Command Phase in Transmitting or
                                                     Receiving Data                                                            */
            uint32_t            : 9;
      volatile uint32_t USERMD     : 1;            /*!< [31..31] User Mode Bit                                                    */
    } CTRL0_b;
  } ;

  union {
    volatile uint32_t RXNDF;                       /*!< (@ 0x00000004) NUMBER OF RX DATA FRAME REGISTER                           */

    struct {
      volatile uint32_t NUM        : 24;           /*!< [23..0] Number of Rx Data Frames                                          */
            uint32_t            : 8;
    } RXNDF_b;
  } ;
  ...
  union {
    ...
    struct {
      volatile uint32_t SPICEN     : 1;            /*!< [0..0] Set to Enable SPIC and Start User Mode Transaction                 */
      volatile uint32_t ATCKCMD    : 1;            /*!< [1..1] Set to enable ATCK_CMD implementation                              */
            uint32_t            : 30;
    } SSIENR_b;
  } ;
  ...
  union {
    volatile uint32_t SER;                         /*!< (@ 0x00000010) SELECT TARGET FLASH REGISTER                               */

    struct {
      volatile uint32_t SEL        : 1;            /*!< [0..0] Select to SPI Flash                                                */
            uint32_t            : 31;
    } SER_b;
  } ;

  union {
    volatile uint32_t BAUDR;                       /*!< (@ 0x00000014) BAUD RATE SELECT REGISTER                                  */

    struct {
      volatile uint32_t SCKDV      : 12;           /*!< [11..0] Define SPI Clock Divider Value                                    */
            uint32_t            : 20;
    } BAUDR_b;
  } ;
  volatile uint32_t  TXFTLR;                       /*!< (@ 0x00000018) TX FIFO THRESHOLD REGISTER                                 */
  volatile uint32_t  RXFTLR;                       /*!< (@ 0x0000001C) RECEIVE FIFO THRESHOLD LEVEL                               */
  volatile uint32_t  TXFLR;                        /*!< (@ 0x00000020) TRANSMIT FIFO LEVEL REGISTER                               */
  ...
  union {
    ...
    struct {
      volatile const  uint32_t BUSY       : 1;            /*!< [0..0] SPIC busy flag                                                     */
      volatile const  uint32_t TFNF       : 1;            /*!< [1..1] Transmit FIFO is not full                                          */
      volatile const  uint32_t TFE        : 1;            /*!< [2..2] Transmit FIFO is empty                                             */
      volatile const  uint32_t RFNE       : 1;            /*!< [3..3] Receive FIFO is not empty                                          */
      volatile const  uint32_t RFF        : 1;            /*!< [4..4] Receive FIFO full                                                  */
      volatile const  uint32_t TXE        : 1;            /*!< [5..5] Transmission error                                                 */
            uint32_t            : 26;
    } SR_b;
  } ;

  union {
    volatile uint32_t IMR;                         /*!< (@ 0x0000002C) Interrupt Mask Register                                    */

    struct {
      volatile uint32_t TXEIM      : 1;            /*!< [0..0] Transmit FIFO empty interrupt masked                               */
      volatile uint32_t TXOIM      : 1;            /*!< [1..1] Transmit FIFO overflow interrupt mask                              */
      volatile uint32_t RXUIM      : 1;            /*!< [2..2] Receive FIFO underflow interrupt masked                            */
      volatile uint32_t RXOIM      : 1;            /*!< [3..3] Receive FIFO overflow interrupt masked                             */
      volatile uint32_t RXFIM      : 1;            /*!< [4..4] Receive FIFO full interrupt masked                                 */
      volatile uint32_t FSEIM      : 1;            /*!< [5..5] FIFO size error interrupt mask                                     */
            uint32_t            : 3;
      volatile uint32_t USSIM      : 1;            /*!< [9..9] User-mode error interrupt mask                                     */
      volatile uint32_t TFSIM      : 1;            /*!< [10..10] Transmit finish interrupt mask                                   */
            uint32_t            : 21;
    } IMR_b;
  } ;

  union {
    volatile uint32_t ISR;                         /*!< (@ 0x00000030) INTERRUPT STATUS REGISTER                                  */

    struct {
      volatile const  uint32_t TXEIS      : 1;            /*!< [0..0] Transmit FIFO empty interrupt status after masking                 */
      volatile const  uint32_t TXOIS      : 1;            /*!< [1..1] Transmit FIFO overflow interrupt status after masking              */
      volatile const  uint32_t RXUIS      : 1;            /*!< [2..2] Receive FIFO underflow interrupt status after masking              */
      volatile const  uint32_t RXOIS      : 1;            /*!< [3..3] Receive FIFO overflow interrupt status after masking               */
      volatile const  uint32_t RXFIS      : 1;            /*!< [4..4] Receive FIFO full interrupt status after masking                   */
      volatile const  uint32_t FSEIS      : 1;            /*!< [5..5] FIFO size error interrupt status after masking                     */
            uint32_t            : 3;
      volatile const  uint32_t USEIS      : 1;            /*!< [9..9] User mode error status after masking                               */
      volatile const  uint32_t TFSIS      : 1;            /*!< [10..10] Transmit finish status after masking                             */
            uint32_t            : 21;
    } ISR_b;
  } ;

  union {
    volatile uint32_t RISR;                        /*!< (@ 0x00000034) RAW INTERRUPT STATUS REGISTER                              */

    struct {
      volatile const  uint32_t TXEIR      : 1;            /*!< [0..0] Transmit Fifo Empty Interrupt Status Before Masking                */
      volatile const  uint32_t TXOIR      : 1;            /*!< [1..1] Transmit Fifo Overflow Interrupt Status Before Masking             */
      volatile const  uint32_t RXUIR      : 1;            /*!< [2..2] Receive Fifo Underflow Interrupt Status Before Masking             */
      volatile const  uint32_t RXOIR      : 1;            /*!< [3..3] Receive Fifo Overflow Interrupt Status Before Masking              */
      volatile const  uint32_t RXFIR      : 1;            /*!< [4..4] Receive Fifo Full Interrupt Status Before Masking                  */
      volatile const  uint32_t FSEIR      : 1;            /*!< [5..5] FIFO Size Error Interrupt Status Before Masking                    */
            uint32_t            : 3;
      volatile const  uint32_t USEIR      : 1;            /*!< [9..9] User_mode Error Status Interrupt Status Before Masking             */
      volatile const  uint32_t TFSIR      : 1;            /*!< [10..10] Transmit Finish Status Interrupt Status Before Masking           */
            uint32_t            : 21;
    } RISR_b;
  } ;
  volatile uint32_t  TXOICR;                       /*!< (@ 0x00000038) TRANSMIT FIFO OVERFLOW INTERRUPT CLEAR REGISTER            */
  volatile uint32_t  RXOICR;                       /*!< (@ 0x0000003C) RECEIVE FIFO OVERFLOW INTERRUPT CLEAR REGISTER             */
  volatile uint32_t  RXUICR;                       /*!< (@ 0x00000040) RECEIVE FIFO UNDERFLOW INTERRUPT CLEAR REGISTER            */
  volatile uint32_t  MSTICR;                       /*!< (@ 0x00000044) MASTER ERROR INTERRUPT CLEAR REGISTER                      */
  ...
  union {
    volatile uint32_t USERLENGTH;                  /*!< (@ 0x00000118) DECIDES BYTE NUMBERS OF COMMAND, ADDRESS AND
                                                                    DATA PHASE TO TRANSMIT                                     */

    struct {
      volatile uint32_t RDDUMMYLEN : 12;           /*!< [11..0] Indicate Delay Cycles For Receiving Data In User Mode             */
      volatile uint32_t CMDLEN     : 2;            /*!< [13..12] Indicate Number Of Bytes In Command Phase In User Mode           */
            uint32_t            : 2;
      volatile uint32_t ADDRLEN    : 4;            /*!< [19..16] Indicate Number Of Bytes In Address Phase In User Mode           */
            uint32_t            : 12;
    } USERLENGTH_b;
  } ;
  ...
  union {
    ...
    struct {
      volatile uint32_t ALL        : 1;            /*!< [0..0] Clear All Data In All FIFO (Include TX_FIFO, RX_FIFO
                                                     and ST_FIFO)                                                              */
      volatile uint32_t DRFIFO     : 1;            /*!< [1..1] Clear All Data in the TX FIFO and RX FIFO                          */
      volatile uint32_t STFIFO     : 1;            /*!< [2..2] Clear All Data in the ST_FIFO                                      */
            uint32_t            : 29;
    } FLUSH_b;
  } ;
  ...
  union {
    volatile uint32_t TXNDF;                       /*!< (@ 0x00000130) A NUMBER OF DATA FRAMES OF TX DATA IN USER MODE            */
...
typedef struct {                                /*!< (@ 0x40090000) GPIO Structure                                             */
  ...
  union {
    ...
    struct {
      ...
      volatile uint32_t INDETEN    : 1;            /*!< [1..1] Input Detection Enable                                             */
      volatile uint32_t INVOLMD    : 1;            /*!< [2..2] Input Voltage Mode                                                 */
      const volatile  uint32_t PINSTS     : 1;            /*!< [3..3] Status of GPIO Pin                                                 */
            uint32_t            : 4;
      volatile uint32_t MFCTRL     : 3;            /*!< [10..8] Multiple Function Control                                         */
      volatile uint32_t OUTDRV     : 1;            /*!< [11..11] Driving Current Selection                                        */
      volatile uint32_t SLEWRATE   : 1;            /*!< [12..12] Slew Rate Selection                                              */
      volatile uint32_t PULLDWEN   : 1;            /*!< [13..13] Internal Pull-Down Resistor Enable                               */
      volatile uint32_t PULLUPEN   : 1;            /*!< [14..14] Internal Pull-Up Resistor Enable                                 */
      volatile uint32_t SCHEN      : 1;            /*!< [15..15] Schmitter-Trigger Enable                                         */
      volatile uint32_t OUTMD      : 1;            /*!< [16..16] Output Mode Selection                                            */
      volatile uint32_t OUTCTRL    : 1;            /*!< [17..17] Output Control                                                   */
            uint32_t            : 6;
      volatile uint32_t INTCTRL    : 3;            /*!< [26..24] Type of GPIO Interrupt                                           */
            uint32_t            : 1;
      volatile uint32_t INTEN      : 1;            /*!< [28..28] Interrupt Enable                                                 */
            uint32_t            : 2;
      volatile uint32_t INTSTS     : 1;            /*!< [31..31] Interrupt Status                                                 */
    } GCR_b[132];
  } ;
...
/**
  ...
  */
  ...
  typedef struct {                                /*!< (@ 0x40010000) KBM Structure                                              */
    ...
    union {
      volatile  uint32_t SCANOUT;                     /*!< (@ 0x00000000) SCAN OUT CONTROL REGISTER                                  */
      ...
      struct {
        ...
        volatile  uint32_t KSO10      : 1;            /*!< [10..10] KSO Output Level                                                 */
        volatile  uint32_t KSO11      : 1;            /*!< [11..11] KSO Output Level                                                 */
        volatile  uint32_t KSO12      : 1;            /*!< [12..12] KSO Output Level                                                 */
        volatile  uint32_t KSO13      : 1;            /*!< [13..13] KSO Output Level                                                 */
        volatile  uint32_t KSO14      : 1;            /*!< [14..14] KSO Output Level                                                 */
        volatile  uint32_t KSO15      : 1;            /*!< [15..15] KSO Output Level                                                 */
        volatile  uint32_t KSO16      : 1;            /*!< [16..16] KSO Output Level                                                 */
        volatile  uint32_t KSO17      : 1;            /*!< [17..17] KSO Output Level                                                 */
        volatile  uint32_t KSO18      : 1;            /*!< [18..18] KSO Output Level                                                 */
        volatile  uint32_t KSO19      : 1;            /*!< [19..19] KSO Output Level                                                 */
              uint32_t            : 12;
      } SCANOUT_b;
    } ;
    
    union {
      volatile const  uint32_t SCANIN;                      /*!< (@ 0x00000004) SACN INPUT STATUS REGISTER                                 */
      
      struct {
        volatile const  uint32_t KSI0       : 1;            /*!< [0..0] KSI Input Level                                                    */
        volatile const  uint32_t KSI1       : 1;            /*!< [1..1] KSI Input Level                                                    */
        volatile const  uint32_t KSI2       : 1;            /*!< [2..2] KSI Input Level                                                    */
        volatile const  uint32_t KSI3       : 1;            /*!< [3..3] KSI Input Level                                                    */
        volatile const  uint32_t KSI4       : 1;            /*!< [4..4] KSI Input Level                                                    */
        volatile const  uint32_t KSI5       : 1;            /*!< [5..5] KSI Input Level                                                    */
        volatile const  uint32_t KSI6       : 1;            /*!< [6..6] KSI Input Level                                                    */
        volatile const  uint32_t KSI7       : 1;            /*!< [7..7] KSI Input Level                                                    */
        volatile const  uint32_t KSI8       : 1;            /*!< [8..8] KSI Input Level                                                    */
        volatile const  uint32_t KSI9       : 1;            /*!< [9..9] KSI Input Level                                                    */
              uint32_t            : 22;
      } SCANIN_b;
    } ;
    
    union {
      volatile  uint32_t INTEN;                       /*!< (@ 0x00000008) INTERRUPT ENABLE REGISTER                                  */
      
      struct {
        volatile  uint32_t KSI0       : 1;            /*!< [0..0] KSI Interrupt Enable                                               */
        volatile  uint32_t KSI1       : 1;            /*!< [1..1] KSI Interrupt Enable                                               */
        volatile  uint32_t KSI2       : 1;            /*!< [2..2] KSI Interrupt Enable                                               */
        volatile  uint32_t KSI3       : 1;            /*!< [3..3] KSI Interrupt Enable                                               */
        volatile  uint32_t KSI4       : 1;            /*!< [4..4] KSI Interrupt Enable                                               */
        volatile  uint32_t KSI5       : 1;            /*!< [5..5] KSI Interrupt Enable                                               */
        volatile  uint32_t KSI6       : 1;            /*!< [6..6] KSI Interrupt Enable                                               */
        volatile  uint32_t KSI7       : 1;            /*!< [7..7] KSI Interrupt Enable                                               */
        volatile  uint32_t KSI8       : 1;            /*!< [8..8] KSI Interrupt Enable                                               */
        volatile  uint32_t KSI9       : 1;            /*!< [9..9] KSI Interrupt Enable                                               */
              uint32_t            : 22;
      } INTEN_b;
    } ;
    ...
    union {
      ...
      struct {
        volatile  uint32_t KSOTYPE    : 1;            /*!< [0..0] Output Type of KSO pin                                             */
        volatile  uint32_t KSI8EN     : 1;            /*!< [1..1] Enable KSI8                                                        */
        volatile  uint32_t KSI9EN     : 1;            /*!< [2..2] Enable KSI9                                                        */
              uint32_t            : 13;
        volatile  uint32_t KSO18EN    : 1;            /*!< [16..16] Enable KSO18                                                     */
        volatile  uint32_t KSO19EN    : 1;            /*!< [17..17] Enable KSO19                                                     */
        volatile  uint32_t KSIINTSTS  : 1;            /*!< [18..18] KSI Interrupt Status                                             */
              uint32_t            : 13;
      } CTRL_b;
    } ;
...
/**
  ...
  */
  ...
  typedef struct {                                /*!< (@ 0x40020000) SYSTEM Structure                                           */
    ...
    union {
      union {
        volatile uint32_t I3CCLK;                    /*!< (@ 0x00000000) I3C CLOCK REGISTER                                         */
        
        struct {
          volatile uint32_t I3C0DIV  : 2;            /*!< [1..0] I3C0 Clock Divider                                                 */
          volatile uint32_t I3C1DIV  : 2;            /*!< [3..2] I3C1 Clock Divider                                                 */
                uint32_t          : 28;
        } I3CCLK_b;
      } ;
      
      union {
        volatile uint32_t TMRRST;                    /*!< (@ 0x00000000) TIMER RESET REGISTER                                       */
        
        struct {
                uint32_t          : 4;
          volatile uint32_t TMR0RST  : 1;            /*!< [4..4] Reset Timer0, low-active                                           */
          volatile uint32_t TMR1RST  : 1;            /*!< [5..5] Reset Timer1, low-active                                           */
          volatile uint32_t TMR2RST  : 1;            /*!< [6..6] Reset Timer2, low-active                                           */
          volatile uint32_t TMR3RST  : 1;            /*!< [7..7] Reset Timer3, low-active                                           */
          volatile uint32_t TMR4RST  : 1;            /*!< [8..8] Reset Timer4, low-active                                           */
          volatile uint32_t TMR5RST  : 1;            /*!< [9..9] Reset Timer5, low-active                                           */
                uint32_t          : 22;
        } TMRRST_b;
      } ;
    };
    ...
    union {
      ...
      struct {
        volatile uint32_t I2C0CLKPWR : 1;            /*!< [0..0] I2C0 Clock Power                                                   */
        volatile uint32_t I2C0CLKSRC : 1;            /*!< [1..1] I2C0 Clock Source                                                  */
        volatile uint32_t I2C0CLKDIV : 2;            /*!< [3..2] I2C0 Clock Divider                                                 */
        volatile uint32_t I2C1CLKPWR : 1;            /*!< [4..4] I2C1 Clock Power                                                   */
        volatile uint32_t I2C1CLKSRC : 1;            /*!< [5..5] I2C1 Clock Source                                                  */
        volatile uint32_t I2C1CLKDIV : 2;            /*!< [7..6] I2C1 Clock Divider                                                 */
        volatile uint32_t I2C2CLKPWR : 1;            /*!< [8..8] I2C2 Clock Power                                                   */
        volatile uint32_t I2C2CLKSRC : 1;            /*!< [9..9] I2C2 Clock Source                                                  */
        volatile uint32_t I2C2CLKDIV : 2;            /*!< [11..10] I2C2 Clock Divider                                               */
        volatile uint32_t I2C3CLKPWR : 1;            /*!< [12..12] I2C3 Clock Power                                                 */
        volatile uint32_t I2C3CLKSRC : 1;            /*!< [13..13] I2C3 Clock Source                                                */
        volatile uint32_t I2C3CLKDIV : 2;            /*!< [15..14] I2C3 Clock Divider                                               */
        volatile uint32_t I2C4CLKPWR : 1;            /*!< [16..16] I2C4 Clock Power                                                 */
        volatile uint32_t I2C4CLKSRC : 1;            /*!< [17..17] I2C4 Clock Source                                                */
        volatile uint32_t I2C4CLKDIV : 2;            /*!< [19..18] I2C4 Clock Divider                                               */
        volatile uint32_t I2C5CLKPWR : 1;            /*!< [20..20] I2C5 Clock Power                                                 */
        volatile uint32_t I2C5CLKSRC : 1;            /*!< [21..21] I2C5 Clock Source                                                */
        volatile uint32_t I2C5CLKDIV : 2;            /*!< [23..22] I2C5 Clock Divider                                               */
        volatile uint32_t I2C6CLKPWR : 1;            /*!< [24..24] I2C6 Clock Power                                                 */
        volatile uint32_t I2C6CLKSRC : 1;            /*!< [25..25] I2C6 Clock Source                                                */
        volatile uint32_t I2C6CLKDIV : 2;            /*!< [27..26] I2C6 Clock Divider                                               */
        volatile uint32_t I2C7CLKPWR : 1;            /*!< [28..28] I2C7 Clock Power                                                 */
        volatile uint32_t I2C7CLKSRC : 1;            /*!< [29..29] I2C7 Clock Source                                                */
        volatile uint32_t I2C7CLKDIV : 2;            /*!< [31..30] I2C7 Clock Divider                                               */
      } I2CCLK_b;
    } ;
    
    union {
      volatile uint32_t TMRCLK;                      /*!< (@ 0x00000008) TIMER32 CLOCK REGISTER                                     */
      
      struct {
        volatile uint32_t TMR0DIV    : 4;            /*!< [3..0] Timer0 Clock Divider                                               */
        volatile uint32_t TMR1DIV    : 4;            /*!< [7..4] Timer1 Clock Divider                                               */
        volatile uint32_t TMR2DIV    : 4;            /*!< [11..8] Timer2 Clock Divider                                              */
        volatile uint32_t TMR3DIV    : 4;            /*!< [15..12] Timer3 Clock Divider                                             */
        volatile uint32_t TMR4DIV    : 4;            /*!< [19..16] Timer4 Clock Divider                                             */
        volatile uint32_t TMR5DIV    : 4;            /*!< [23..20] Timer5 Clock Divider                                             */
        volatile uint32_t TMR0PAUSE  : 1;            /*!< [24..24] Timer0 Clock Pause                                               */
        volatile uint32_t TMR1PAUSE  : 1;            /*!< [25..25] Timer1 Clock Pause                                               */
        volatile uint32_t TMR2PAUSE  : 1;            /*!< [26..26] Timer2 Clock Pause                                               */
        volatile uint32_t TMR3PAUSE  : 1;            /*!< [27..27] Timer3 Clock Pause                                               */
        volatile uint32_t TMR4PAUSE  : 1;            /*!< [28..28] Timer4 Clock Pause                                               */
        volatile uint32_t TMR5PAUSE  : 1;            /*!< [29..29] Timer5 Clock Pause                                               */
              uint32_t            : 2;
      } TMRCLK_b;
    } ;
    
    union {
      volatile uint32_t PERICLKPWR0;                 /*!< (@ 0x0000000C) PERIPHERAL CLOCK POWER REGISTER #0                         */
      
      struct {
        volatile uint32_t GPIOCLKPWR : 1;            /*!< [0..0] GPIO Clock Power                                                   */
        volatile uint32_t TACHO0CLKPWR : 1;          /*!< [1..1] Tachometer0 Clock Power                                            */
        volatile uint32_t TACHO1CLKPWR : 1;          /*!< [2..2] Tachometer1 Clock Power                                            */
        volatile uint32_t TACHO2CLKPWR : 1;          /*!< [3..3] Tachometer2 Clock Power                                            */
        volatile uint32_t TACHO3CLKPWR : 1;          /*!< [4..4] Tachometer3 Clock Power                                            */
        volatile uint32_t PS2CLKPWR  : 1;            /*!< [5..5] PS2 Clock Power                                                    */
        volatile uint32_t KBMCLKPWR  : 1;            /*!< [6..6] KBM Clock Power                                                    */
        volatile uint32_t PECICLKPWR : 1;            /*!< [7..7] PECI Clock Power                                                   */
        volatile uint32_t PL0CLKPWR  : 1;            /*!< [8..8] PWMLED0 Clock Power                                                */
        volatile uint32_t PL1CLKPWR  : 1;            /*!< [9..9] PWMLED1 Clock Power                                                */
        volatile uint32_t PWM0CLKPWR : 1;            /*!< [10..10] PWM0 Clock Power                                                 */
        volatile uint32_t PWM1CLKPWR : 1;            /*!< [11..11] PWM1 Clock Power                                                 */
        volatile uint32_t PWM2CLKPWR : 1;            /*!< [12..12] PWM2 Clock Power                                                 */
        volatile uint32_t PWM3CLKPWR : 1;            /*!< [13..13] PWM3 Clock Power                                                 */
        volatile uint32_t PWM4CLKPWR : 1;            /*!< [14..14] PWM4 Clock Power                                                 */
        volatile uint32_t PWM5CLKPWR : 1;            /*!< [15..15] PWM5 Clock Power                                                 */
        volatile uint32_t PWM6CLKPWR : 1;            /*!< [16..16] PWM6 Clock Power                                                 */
        volatile uint32_t PWM7CLKPWR : 1;            /*!< [17..17] PWM7 Clock Power                                                 */
        volatile uint32_t PWM8CLKPWR : 1;            /*!< [18..18] PWM8 Clock Power                                                 */
        volatile uint32_t PWM9CLKPWR : 1;            /*!< [19..19] PWM9 Clock Power                                                 */
        volatile uint32_t PWM10CLKPWR : 1;           /*!< [20..20] PWM10 Clock Power                                                */
        volatile uint32_t PWM11CLKPWR : 1;           /*!< [21..21] PWM11 Clock Power                                                */
        volatile uint32_t ESPICLKPWR : 1;            /*!< [22..22] eSPI Clock Power                                                 */
        volatile uint32_t KBCCLKPWR  : 1;            /*!< [23..23] KBC Clock Power                                                  */
        volatile uint32_t ACPICLKPWR : 1;            /*!< [24..24] ACPI Clock Power                                                 */
        volatile uint32_t PMPORT0CLKPWR : 1;         /*!< [25..25] PMPORT0 Clock Power                                              */
        volatile uint32_t PMPORT1CLKPWR : 1;         /*!< [26..26] PMPORT1 Clock Power                                              */
        volatile uint32_t PMPORT2CLKPWR : 1;         /*!< [27..27] PMPORT2 Clock Power                                              */
        volatile uint32_t PMPORT3CLKPWR : 1;         /*!< [28..28] PMPORT3 Clock Power                                              */
        volatile uint32_t P80CLKPWR  : 1;            /*!< [29..29] Port80 Clock Power                                               */
        volatile uint32_t EMI0CLKPWR : 1;            /*!< [30..30] EMI0 Clock Power                                                 */
        volatile uint32_t EMI1CLKPWR : 1;            /*!< [31..31] EMI1 Clock Power                                                 */
      } PERICLKPWR0_b;
    } ;
    
    union {
      volatile uint32_t UARTCLK;                     /*!< (@ 0x00000010) UART CLOCK REGISTER                                        */
      
      struct {
        volatile uint32_t PWR        : 1;            /*!< [0..0] UART Clock Power                                                   */
        volatile uint32_t SRC        : 1;            /*!< [1..1] UART Clock Source                                                  */
        volatile uint32_t DIV        : 2;            /*!< [3..2] UART Clock Divider                                                 */
              uint32_t            : 28;
      } UARTCLK_b;
    } ;
    
    union {
      volatile uint32_t SYSCLK;                      /*!< (@ 0x00000014) SYSTEM CLOCK REGISTER                                      */
      
      struct {
              uint32_t            : 1;
        volatile uint32_t SRC        : 1;            /*!< [1..1] System Clock Source                                                */
        volatile uint32_t DIV        : 1;            /*!< [2..2] System Clock Divider                                               */
              uint32_t            : 29;
      } SYSCLK_b;
    } ;
    ...
    union {
      volatile uint32_t PERICLKPWR1;                 /*!< (@ 0x0000001C) PERIPHERAL CLOCK POWER REGISTER #1                         */
      
      struct {
        volatile uint32_t EMI2CLKPWR : 1;            /*!< [0..0] EMI2 Clock Power                                                   */
        volatile uint32_t EMI3CLKPWR : 1;            /*!< [1..1] EMI3 Clock Power                                                   */
        volatile uint32_t EMI4CLKPWR : 1;            /*!< [2..2] EMI4 Clock Power                                                   */
        volatile uint32_t EMI5CLKPWR : 1;            /*!< [3..3] EMI5 Clock Power                                                   */
        volatile uint32_t EMI6CLKPWR : 1;            /*!< [4..4] EMI6 Clock Power                                                   */
        volatile uint32_t EMI7CLKPWR : 1;            /*!< [5..5] EMI7 Clock Power                                                   */
              uint32_t            : 3;
        volatile uint32_t I3C0CLKPWR : 1;            /*!< [9..9] I3C0 Clock Power                                                   */
        volatile uint32_t I3C1CLKPWR : 1;            /*!< [10..10] I3C1 Clock Power                                                 */
        volatile uint32_t I2CAUTOCLKPWR : 1;         /*!< [11..11] I2C Auto-Power Circuit Clock Power                               */
        volatile uint32_t MCCLKPWR   : 1;            /*!< [12..12] Monotonic Counter Clock Power                                    */
        volatile uint32_t TMR0CLKPWR : 1;            /*!< [13..13] Timer0 Clock Power                                               */
        volatile uint32_t TMR1CLKPWR : 1;            /*!< [14..14] Timer1 Clock Power                                               */
        volatile uint32_t TMR2CLKPWR : 1;            /*!< [15..15] Timer2 Clock Power                                               */
        volatile uint32_t TMR3CLKPWR : 1;            /*!< [16..16] Timer3 Clock Power                                               */
        volatile uint32_t TMR4CLKPWR : 1;            /*!< [17..17] Timer4 Clock Power                                               */
        volatile uint32_t TMR5CLKPWR : 1;            /*!< [18..18] Timer5 Clock Power                                               */
        volatile uint32_t RTMRCLKPWR : 1;            /*!< [19..19] RTOS Timer Clock Power                                           */
        volatile uint32_t SLWTMR0CLKPWR : 1;         /*!< [20..20] Slow Timer 0 Clock Power                                         */
        volatile uint32_t SLWTMR1CLKPWR : 1;         /*!< [21..21] Slow Timer 1 Clock Power                                         */
              uint32_t            : 10;
      } PERICLKPWR1_b;
    } ;
    ...
    union {
      volatile uint32_t SLPCTRL;                     /*!< (@ 0x00000080) SYSTEM SLEEP CONTROL REGISTER                              */
    ...
    union {
      volatile uint32_t VIVOCTRL;                    /*!< (@ 0x000000A0) VINVOUT CONTROL REGISTER                                   */
      ...
      struct {
        ...
        volatile uint32_t VIN4POL    : 1;            /*!< [16..16] VIN4 Polarity                                                    */
        volatile uint32_t VIN5POL    : 1;            /*!< [17..17] VIN5 Polarity                                                    */
              uint32_t            : 12;
        volatile uint32_t REGWREN    : 1;            /*!< [30..30] Register Write Enable                                            */
        volatile uint32_t VOUTMD     : 1;            /*!< [31..31] VOUT Mode Selection                                              */
      } VIVOCTRL_b;
    } ;
    
    union {
      volatile uint32_t LDOCTRL;                     /*!< (@ 0x000000A4) LDO CONTROL REGISTER                                       */
      
      struct {
              uint32_t            : 3;
        volatile uint32_t LDO2EN     : 1;            /*!< [3..3] LDO2 Power Enable                                                  */
              uint32_t            : 3;
        volatile uint32_t LDO3EN     : 1;            /*!< [7..7] LDO3 Power Enable                                                  */
              uint32_t            : 24;
      } LDOCTRL_b;
    } ;
    
    union {
      volatile uint32_t RC25MCTRL;                   /*!< (@ 0x000000A8) RC25M CONTROL REGISTER                                     */
      
      struct {
        volatile uint32_t EN         : 1;            /*!< [0..0] RC25M Power Enable                                                 */
        volatile uint32_t CALCURR    : 7;            /*!< [7..1] RC25M Calibration Coefficient                                      */
              uint32_t            : 24;
      } RC25MCTRL_b;
    } ;
    
    union {
      volatile uint32_t PLLCTRL;                     /*!< (@ 0x000000AC) PLL CONTROL REGISTER                                       */
      
      struct {
        volatile uint32_t EN         : 1;            /*!< [0..0] PLL Power Enable                                                   */
              uint32_t            : 18;
        volatile uint32_t RDY        : 1;            /*!< [19..19] PLL Ready and Stable                                             */
              uint32_t            : 12;
      } PLLCTRL_b;
    } ;
    ...
    union {
      volatile uint32_t RC32KCTRL;                   /*!< (@ 0x000000E0) RC32K CONTROL REGISTER                                     */
    ...
    union {
      volatile uint32_t PERICLKPWR2;                 /*!< (@ 0x000000E8) PERIPHERAL CLOCK POWER REGISTER #2                         */
      
      struct {
        volatile uint32_t RTCCLKPWR  : 1;            /*!< [0..0] RTC Clock Power                                                    */
        volatile uint32_t WDTCLKPWR  : 1;            /*!< [1..1] WDT Clock Power                                                    */
        volatile uint32_t PWRBTNCLKPWR : 1;          /*!< [2..2] Power Button over WDT Clock Power                                  */
              uint32_t            : 27;
        volatile uint32_t RC32KSRC   : 2;            /*!< [31..30] RC32K Clock Source Selection                                     */
      } PERICLKPWR2_b;
    } ;
...
#define SPIC_CTRL0_USERMD_Pos             (31UL)                    /*!< USERMD (Bit 31)                                       */
#define SPIC_CTRL0_USERMD_Msk             (0x80000000UL)            /*!< USERMD (Bitfield-Mask: 0x01)                          */
/* =========================================================  RXNDF  ========================================================= */
#define SPIC_RXNDF_NUM_Pos                (0UL)                     /*!< NUM (Bit 0)                                           */
...
/* ==========================================================  SER  ========================================================== */
#define SPIC_SER_SEL_Pos                  (0UL)                     /*!< SEL (Bit 0)                                           */
#define SPIC_SER_SEL_Msk                  (0x1UL)                   /*!< SEL (Bitfield-Mask: 0x01)                             */
/* =========================================================  BAUDR  ========================================================= */
...
/* =========================================================  TXNDF  ========================================================= */
#define SPIC_TXNDF_NUM_Pos                (0UL)                     /*!< NUM (Bit 0)                                           */
