...
#define ccprintf(format, ...) PW_TOKENIZE_TO_CALLBACK(SetMessage, format, __VA_ARGS__)
#define ccprints(format, ...) PW_TOKENIZE_TO_CALLBACK(SetMessage, format, __VA_ARGS__)
