...
int main(void)
{
	const struct i2c_dt_spec i2c_dt = { I2C_DT_SPEC_GET_ON_I2C(PDC_POWER_P0_NODE_ID) }; /*Get PDC_POWER_P0_NODE is blong which i2c node(bus) & reg of PDC_POWER_P0_NODE(address)*/
