...
#ifndef ZEPHYR_TEST_TEST_UTILS_INCLUDE_CONSOLE_UTILS_H_
#define ZEPHYR_TEST_TEST_UTILS_INCLUDE_CONSOLE_UTILS_H_
...
#endif /* ZEPHYR_TEST_TEST_UTILS_INCLUDE_CONSOLE_UTILS_H_ */
