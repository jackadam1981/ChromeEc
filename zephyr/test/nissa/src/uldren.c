...
// 	// rv = i2c_write8(I2C_PORT_SENSOR, BMA4_I2C_ADDR_PRIMARY, 0x00, 0x12);
// 	// rv = i2c_write8(I2C_PORT_SENSOR, LIS2DW12_ADDR1, 0x0f, 0x44);
// 	// rv = i2c_write32(I2C_PORT_SENSOR, BMI3_ADDR_I2C_PRIM, 0x00, 0x10C00000);
// 	// rv = i2c_write8(I2C_PORT_SENSOR, LSM6DS0_ADDR0_FLAGS, 0x0f, 0x6c);
