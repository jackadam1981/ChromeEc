...
FAKE_VALUE_FUNC(int, pujjoga_get_sb_type);
...
static void test_before(void *fixture)
{
	...
	RESET_FAKE(pujjoga_get_sb_type);
...
{
	pujjoga_get_sb_type_fake.return_val = PUJJOGA_SB_NONE;
	board_reset_pd_mcu();
	zassert_equal(nct38xx_reset_notify_fake.call_count, 1);
	zassert_equal(nct38xx_reset_notify_fake.arg0_val, 0);

	pujjoga_get_sb_type_fake.return_val = PUJJOGA_SB_HDMI_A;
	board_reset_pd_mcu();
