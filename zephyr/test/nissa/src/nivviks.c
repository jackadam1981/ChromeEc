...
FAKE_VOID_FUNC(set_pwm_led_color, enum ec_led_id, int);
...
ZTEST(nivviks, test_base_inversion)
{
	...
	cros_cbi_get_fw_config_fake.return_val = EINVAL;
	form_factor_init();
	zassert_equal_ptr(motion_sensors[BASE_ACCEL].rot_standard_ref, NULL,
...
ZTEST(nivviks, test_led_pwm)
{
	...
	zassert_equal(set_pwm_led_color_fake.arg0_val, EC_LED_ID_BATTERY_LED);
