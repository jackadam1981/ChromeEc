...
ZTEST_SUITE(notebook_interrupt, NULL, NULL, NULL, NULL, NULL);

ZTEST(notebook_interrupt, test_gpio_toggles_tablet_mode)
{
	const struct gpio_dt_spec spec =
		GPIO_DT_SPEC_GET(DT_NODELABEL(notebook_interrupt), gpios);
