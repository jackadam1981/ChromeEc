...
ZTEST(dps_config, test_console_cmd_print_info)
{
	/* Print current status to console */
	zassert_ok(shell_execute_cmd(get_ec_shell(), "dps"), NULL);
}

ZTEST(dps_config, test_console_cmd_enable)
{
...
ZTEST(dps_config, test_console_cmd_disable)
{
...
ZTEST(dps_config, test_console_cmd_fakepwr_print)
{
	/* Print current fake power status to console */
	zassert_ok(shell_execute_cmd(get_ec_shell(), "dps fakepwr"), NULL);
}

ZTEST(dps_config, test_console_cmd_fakepwr_enable_disable)
{
...
ZTEST(dps_config, test_console_cmd_fakepwr_invalid)
{
...
ZTEST(dps_config, test_console_cmd_debuglevel)
{
...
ZTEST(dps_config, test_console_cmd_setkmore)
{
	struct dps_config_t *config = dps_get_config();
	char cmd[32];
...
ZTEST(dps_config, test_console_cmd_setkless)
{
	struct dps_config_t *config = dps_get_config();
	char cmd[32];
...
ZTEST(dps_config, test_console_cmd_setksample)
{
	struct dps_config_t *config = dps_get_config();
...
ZTEST(dps_config, test_console_cmd_setkwindow)
{
	struct dps_config_t *config = dps_get_config();
...
ZTEST(dps_config, test_console_cmd_settcheck)
{
	struct dps_config_t *config = dps_get_config();
...
ZTEST(dps_config, test_console_cmd_settstable)
{
	struct dps_config_t *config = dps_get_config();
...
ZTEST(dps_config, test_console_cmd_invalid)
{
