...
void set_device_vdo(int port, enum tcpci_msg_type type)
{
	...
	dev_disc->identity.idh.product_type = IDH_PTYPE_ACABLE;
	dev_disc->svid_cnt = 1;
				  ...
				  enum idh_ptype ptype)
{
	...
	dev_disc->identity.product_t2.a2_rev30.active_elem = ACTIVE_RETIMER;
	dev_disc->identity.product_t1.p_rev30.ss = USB_R30_SS_U32_U40_GEN2;
