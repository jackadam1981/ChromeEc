...
ZTEST_F(usb_attach_5v_3a_pd_source_rev3, test_get_status_response_pd30)
{
	disconnect_source_from_port(fixture->tcpci_emul, fixture->charger_emul);
	/* Set the partner's USB PD Revision to 3.1 */
	fixture->source_5v_3a.rmdo = 0x30000000;
	connect_source_to_port(&fixture->source_5v_3a, &fixture->src_ext, 1,
			       fixture->tcpci_emul, fixture->charger_emul);
	...
	/* When a partner supplies a Revision of PD r3.0, the TCPM should
	 * respond to Get_Status with a 6-byte Status Data Block, as defined in
	 * PD r3.0.
	 */
	zassert_equal(get_status_data_size(&fixture->source_5v_3a.msg_log), 6);
}
