...
static void verify_vdm_messages(struct usbc_usb4_mode_fixture *fixture,
...
ZTEST_F(usbc_usb4_mode, verify_tbt_entry_fail)
{
...
ZTEST_F(usbc_usb4_mode, verify_tbt_passive_entry_exit)
{
	struct ec_response_typec_status status;
