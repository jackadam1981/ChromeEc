...
ZTEST_F(usbc_usb4_mode, verify_usb4_passive_entry_exit)
{
	...
	/* Verify that we properly identify a USB4 cabaple passive cable */
	...
	/* TODO(b/260095516): PD logs are being enabled here for this test,
	 * but messages from the logs are not being explicitly checked. The
	 * contents of the Enter_USB message could be checked here to validate
	 * that it's formed properly.
	 */
