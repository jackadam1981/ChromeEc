...
static struct ppc_config_t ppc_chips_saved[] = {
	DT_FOREACH_STATUS_OKAY(named_usbc_port, PPC_CHIP_STUB)
};
...
ZTEST_SUITE(ppc_shim, NULL, NULL, ppc_shim_before_test, ppc_shim_after_test, NULL);
