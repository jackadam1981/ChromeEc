...
static void add_dp_identity(struct tcpci_partner_data *partner)
{
...
ZTEST_F(ap_vdm_control, test_vdm_response_ack)
{
	...
	zassert_equal(vdm_resp.vdm_response_size,
	...
	zassert_equal(memcmp(vdm_resp.vdm_response,
			     ...
			     vdm_resp.vdm_response_size * sizeof(uint32_t)),
