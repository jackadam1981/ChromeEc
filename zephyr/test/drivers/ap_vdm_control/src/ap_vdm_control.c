...
static void verify_expected_reply(enum typec_partner_type type, int objects,
				  uint32_t *contents)
{
	struct ec_response_typec_status status;
	struct ec_response_typec_vdm_response vdm_resp;
