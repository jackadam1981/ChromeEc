...
{
	uint8_t val = anx7452_emul_get_reg(EMUL, ANX7452_TOP_STATUS_REG);
	...
	zassert_equal(anx7452_emul_get_reg(EMUL, ANX7452_TOP_STATUS_REG),
		      val | ANX7452_TOP_REG_EN, NULL);
	zassert_equal(anx7452_emul_get_reg(EMUL, ANX7452_TOP_USB_I2C_ADDR_REG),
		      ANX7452_I2C_ADDR_USB_FLAGS_NEW, NULL);
	zassert_equal(1,
		      gpio_emul_output_get(usb_en_gpio_dev, GPIO_USB_C1_USB_EN_PORT),
		      NULL);
	zassert_equal(0,
		      gpio_emul_output_get(dp_en_gpio_dev, GPIO_USB_C1_DP_EN_PORT),
		      NULL);
	...
	zassert_equal(anx7452_emul_get_reg(EMUL, ANX7452_TOP_STATUS_REG),
		      val | ANX7452_TOP_REG_EN, NULL);
	zassert_not_equal(anx7452_emul_get_reg(EMUL, ANX7452_TOP_USB_I2C_ADDR_REG),
		      ANX7452_I2C_ADDR_USB_FLAGS_NEW, NULL);
	zassert_equal(1,
		      gpio_emul_output_get(usb_en_gpio_dev, GPIO_USB_C1_USB_EN_PORT),
		      NULL);
	...
	zassert_not_equal(anx7452_emul_get_reg(EMUL, ANX7452_TOP_USB_I2C_ADDR_REG),
		      ANX7452_I2C_ADDR_USB_FLAGS_NEW, NULL);
	zassert_equal(0, gpio_emul_output_get(usb_en_gpio_dev, GPIO_USB_C1_USB_EN_PORT), NULL);
	zassert_equal(0, gpio_emul_output_get(dp_en_gpio_dev, GPIO_USB_C1_DP_EN_PORT), NULL);
}
