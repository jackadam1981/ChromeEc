...
int  __attribute__((optnone)) board_set_active_charge_port(int port)
{
...
void __attribute__((optnone)) board_set_charge_limit(int port, int supplier, int charge_ma, int max_ma,
			    int charge_mv)
{
