...
{
	/*
	 * TODO(b/Ticket): Why do we need this copy?
	 * Was: struct integration_usb_fixture *fixture = &this->fixture;
	 */
	struct integration_usb_fixture fixture_copy = this->fixture;
	struct integration_usb_fixture *fixture = &fixture_copy;
