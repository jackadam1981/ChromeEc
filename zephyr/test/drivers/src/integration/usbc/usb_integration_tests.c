...
ZTEST_F(integration_usb_test, verify_detach_src_snk)
{
	...
	integration_usb_get_pd_power_info(USB_SINK_PORT, &snk_power_info);
	integration_usb_get_pd_power_info(USB_SOURCE_PORT, &src_power_info);
...
ZTEST_F(integration_usb_test, verify_detach_source)
{
	...
	integration_usb_get_pd_power_info(USB_SOURCE_PORT, &pd_power_info);
