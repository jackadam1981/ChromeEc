...
static void integration_usb_get_pd_power_info(
...
ZTEST_F(usb_detach_test, verify_detach_src_snk)
{
	...
	integration_usb_get_pd_power_info(SNK_PORT, &snk_power_info);
	integration_usb_get_pd_power_info(SRC_PORT, &src_power_info);
...
ZTEST_F(usb_detach_test, verify_detach_sink)
{
	...
	integration_usb_get_pd_power_info(SNK_PORT, &pd_power_info);
...
ZTEST_F(usb_detach_test, verify_detach_source)
{
	...
	integration_usb_get_pd_power_info(SRC_PORT, &pd_power_info);
