...
static void test_tcpci_init(void)
{
	...
	zassert_equal(TCPC_REG_POWER_STATUS_VBUS_PRES,
		      ...
		      NULL);
	zassert_equal(exp_mask, tcpc_emul_get_reg(emul, TCPC_REG_ALERT_MASK),
		      NULL);
...
static void test_tcpci_release(void)
{
	...
	zassert_equal(0, tcpc_emul_get_reg(emul, TCPC_REG_POWER_STATUS_MASK),
		      NULL);
	zassert_equal(0, tcpc_emul_get_reg(emul, TCPC_REG_ALERT_MASK), NULL);
	zassert_equal(0, tcpc_emul_get_reg(emul, TCPC_REG_ALERT), NULL);
}
...
static void test_tcpci_alert(void)
{
	...
	tcpci_tcpc_alert(USBC_PORT_C1);
	zassert_equal(0, tcpc_emul_get_reg(emul, TCPC_REG_ALERT), NULL);
	zassert_equal(0, tcpc_emul_get_reg(emul, TCPC_REG_FAULT_STATUS),
		      NULL);
	...
	tcpci_tcpc_alert(USBC_PORT_C1);
	zassert_equal(0, tcpc_emul_get_reg(emul, TCPC_REG_ALERT), NULL);
	zassert_equal(0, tcpc_emul_get_reg(emul, TCPC_REG_ALERT_EXT), NULL);
	/* Test CC changed */
	tcpc_emul_set_reg(emul, TCPC_REG_CC_STATUS, 0x1e);
