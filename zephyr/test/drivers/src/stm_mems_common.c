...
static void test_st_write_data_with_mask(void)
{
	...
	struct mock_properties write_fn_props = { 0 };
...
static void test_st_normalize(void)
{
	...
	zassert_equal(actual_output[X], expected_output[X],
		      "X output is %d but expected %d", actual_output[X],
		      expected_output[X]);
	zassert_equal(actual_output[Y], expected_output[Y],
		      "Y output is %d but expected %d", actual_output[Y],
		      expected_output[Y]);
	zassert_equal(actual_output[Z], expected_output[Z],
