				...
				uint16_t rp_detect_ctrl, const char *test_case)
{
	...
	/* Clear RP detecte register to see if it is set after test */
...
static void test_ps8815_set_cc(void)
{
	...
	/* TODO: Find if it is possible to detect additional 1 ms delay */
	check_ps8815_set_cc(TYPEC_RP_1A5, TYPEC_CC_RP, 0,
...
static void test_ps8xxx_set_vconn(void)
{
	...
	check_tcpci_reg(tcpci_emul, TCPC_REG_POWER_CTRL, exp_ctrl);
	/*
	 * Delay for VCONN disable is required because of issue:
...
static void test_ps8xxx_transmit(void)
{
	...
	/* Test fail on transmiting BIST MODE 2 message */
	i2c_common_emul_set_write_fail_reg(tcpci_i2c_emul, TCPC_REG_TRANSMIT);
	zassert_equal(EC_ERROR_INVAL,
		      ps8xxx_tcpm_drv.transmit(USBC_PORT_C1,
...
static void test_ps88x5_drp_toggle(void)
{
	...
	/*
	 * TODO: PS8815 sleep here if specific FW rev.
...
static void test_ps8xxx_get_chip_info(void)
{
	const struct emul *tcpci_emul =
				emul_get_binding(DT_LABEL(TCPCI_EMUL_LABEL));
	struct i2c_emul *tcpci_i2c_emul = tcpci_emul_get_i2c_emul(tcpci_emul);
	...
	product = board_get_ps8xxx_product_id(USBC_PORT_C1);
...
void test_suite_ps8xxx(void)
{
	...
	ztest_test_suite(ps8805,
			 ztest_user_unit_test(test_ps8xxx_init_fail),
			 ztest_user_unit_test(test_ps8805_init),
			 ztest_user_unit_test(test_ps8xxx_release),
			 ztest_user_unit_test(test_ps8xxx_get_cc),
			 ztest_user_unit_test(test_ps8xxx_set_cc),
			 ztest_user_unit_test(test_ps8xxx_set_vconn),
			 ztest_user_unit_test(test_ps8xxx_transmit),
			 ztest_user_unit_test(test_ps88x5_drp_toggle),
			 ztest_user_unit_test(test_ps8xxx_get_chip_info),
			 ztest_user_unit_test(test_ps8805_get_chip_info),
			 ztest_user_unit_test(test_ps8805_gpio));
	...
	ztest_test_suite(ps8815,
			 ztest_user_unit_test(test_ps8xxx_init_fail),
			 ztest_user_unit_test(test_ps8815_init),
			 ztest_user_unit_test(test_ps8xxx_release),
			 ztest_user_unit_test(test_ps8xxx_get_cc),
			 ztest_user_unit_test(test_ps8xxx_set_cc),
			 ztest_user_unit_test(test_ps8815_set_cc),
			 ztest_user_unit_test(test_ps8xxx_set_vconn),
			 ztest_user_unit_test(test_ps8xxx_transmit),
			 ztest_user_unit_test(test_ps88x5_drp_toggle),
			 ztest_user_unit_test(test_ps8xxx_get_chip_info),
			 ztest_user_unit_test(test_ps8815_get_chip_info));
