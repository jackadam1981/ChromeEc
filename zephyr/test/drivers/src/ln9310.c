...
ZTEST(ln9310, test_ln9310_read_chip_fails)
{
	...
	i2c_common_emul_set_read_fail_reg(emulator, LN9310_REG_BC_STS_C);
	...
	i2c_common_emul_set_read_fail_reg(emulator,
...
ZTEST(ln9310, test_ln9310_2s_cfly_precharge_startup)
{
	...
	i2c_common_emul_set_write_func(
		emulator, mock_write_fn_intercept_startup_workaround,
		&test_data);
	...
	i2c_common_emul_set_write_func(emulator, NULL, NULL);
}
...
ZTEST(ln9310, test_ln9310_2s_battery_read_fails)
{
	...
	i2c_common_emul_set_read_fail_reg(emulator, LN9310_REG_BC_STS_B);
	...
	i2c_common_emul_set_read_fail_reg(emulator, LN9310_REG_TRACK_CTRL);
...
ZTEST(ln9310, test_ln9310_lion_ctrl_reg_fails)
{
	...
	i2c_common_emul_set_read_fail_reg(emulator, LN9310_REG_LION_CTRL);
...
ZTEST(ln9310, test_ln9310_cfly_precharge_timesout)
{
	...
	i2c_common_emul_set_write_func(
		emulator, mock_intercept_startup_ctrl_reg, &test_data);
...
ZTEST(ln9310, test_ln9310_interrupt_reg_fail)
{
	...
	i2c_common_emul_set_read_func(emulator, mock_read_intercept_reg_to_fail,
				      &test_data);
	...
	i2c_common_emul_set_read_func(emulator, NULL, NULL);
}
...
ZTEST(ln9310, test_ln9310_sys_sts_reg_fail)
{
	...
	i2c_common_emul_set_read_func(
		emulator, &mock_read_intercept_reg_to_fail, &test_data);
...
ZTEST(ln9310, test_ln9310_reset_explicit_detected_startup)
{
	...
	i2c_common_emul_set_read_func(emulator, &mock_read_interceptor,
				      &test_data);
