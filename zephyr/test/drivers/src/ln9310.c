...
static bool startup_workaround_done;
						      ...
						      int bytes, void *data)
{
	...
	startup_workaround_done = startup_workaround_done ||
...
static void test_ln9310_2s_cfly_precharge_startup(void)
{
	...
	ln9310_software_enable(1);
	zassert_true(startup_workaround_done, NULL);
