...
static void test_ln9310_2s_software_enable(void)
{
	...
	ln9310_emul_reset(emulator);
	ln9310_emul_set_battery_cell_type(emulator, BATTERY_CELL_TYPE_2S);
	ln9310_emul_set_version(emulator, AN_UNFIXED_CHIP_REV);
...
static void test_ln9310_2s_software_enable_fixed_chip(void)
{
	const struct emul *emulator =
		emul_get_binding(DT_LABEL(DT_NODELABEL(ln9310)));
	...
	/* This should not be needed, might be driver bug */
	k_msleep(TEST_DELAY_MS);
...
static void test_ln9310_3s_software_enable_fixed_chip(void)
{
	const struct emul *emulator =
		emul_get_binding(DT_LABEL(DT_NODELABEL(ln9310)));
...
void test_suite_ln9310(void)
{
	ztest_test_suite(
		...
		ztest_unit_test_setup_teardown(
			test_ln9310_2s_software_enable_fixed_chip,
			reset_ln9310_state, reset_ln9310_state),
		ztest_unit_test_setup_teardown(
			test_ln9310_3s_software_enable_fixed_chip,
			reset_ln9310_state, reset_ln9310_state));
