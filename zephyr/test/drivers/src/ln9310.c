...
static bool startup_workaround_should_fail;
						      ...
						      int bytes, void *data)
{
	...
	if (startup_workaround_should_fail)
		return -1;
...
{
	printf("attempting to match 0x%x to 0x%x\n", reg,
...
void test_suite_ln9310(void)
{
	ztest_test_suite(
		...
		ztest_unit_test_setup_teardown(
			test_ln9310_cfly_precharge_timesout, reset_ln9310_state,
			reset_ln9310_state),
		ztest_unit_test_setup_teardown(test_ln9310_lion_ctrl_reg_fails,
					       reset_ln9310_state,
					       reset_ln9310_state),
		ztest_unit_test_setup_teardown(
			test_ln9310_2s_battery_read_fails, reset_ln9310_state,
			reset_ln9310_state),
