...
void test_set_chipset_to_s0(void)
{
	...
	printk("test_set_chipset_to_s0: Forcing power on\n");
	...
	zassert_ok(gpio_emul_input_set(battery_gpio_dev, GPIO_BATT_PRES_ODL_PORT, 0), NULL);
...
{
	printk("test_set_chipset_to_g3: Forcing shutdown\n");
