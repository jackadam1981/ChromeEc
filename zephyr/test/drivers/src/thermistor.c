...
#define TEMP_SENSORS_ENABLED_SIZE DT_FOREACH_STATUS_OKAY(cros_temp_sensor, \
	_ENABLED_TEMP_SENSOR_COUNTER) 0
...
#define ASSERT_VALID_ADC_VALUE(node_id)                                      \
	zassert_ok(                                                          \
...
void test_suite_thermistor(void)
{
	...
	ztest_test_suite(thermistor,
			 ...
			 ztest_user_unit_test(test_thermistors_adc_temperature_conversion));
