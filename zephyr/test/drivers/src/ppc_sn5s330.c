...
ZTEST(ppc_sn5s330, test_fail_once_func_set1)
{
	...
	i2c_common_emul_set_write_func(emul, fail_until_write_func, &count);
...
ZTEST(ppc_sn5s330, test_dead_battery_boot_force_pp2_fets_set)
{
	...
	i2c_common_emul_set_write_func(emul, intercept_write_func,
				       &test_write_data);
	i2c_common_emul_set_read_func(emul, intercept_read_func,
				      &test_read_data);
...
ZTEST(ppc_sn5s330, test_dump)
{
	...
	i2c_common_emul_set_read_func(EMUL, dump_read_fn, NULL);
...
ZTEST(ppc_sn5s330, test_init_reg_fails)
{
	...
	INIT_I2C_FAIL_HELPER(EMUL, I2C_WRITE, SN5S330_FUNC_SET5);
	INIT_I2C_FAIL_HELPER(EMUL, I2C_READ, SN5S330_FUNC_SET6);
	INIT_I2C_FAIL_HELPER(EMUL, I2C_WRITE, SN5S330_FUNC_SET6);
	INIT_I2C_FAIL_HELPER(EMUL, I2C_WRITE, SN5S330_FUNC_SET2);
	INIT_I2C_FAIL_HELPER(EMUL, I2C_WRITE, SN5S330_FUNC_SET9);
	INIT_I2C_FAIL_HELPER(EMUL, I2C_WRITE, SN5S330_FUNC_SET11);
	INIT_I2C_FAIL_HELPER(EMUL, I2C_READ, SN5S330_FUNC_SET8);
	INIT_I2C_FAIL_HELPER(EMUL, I2C_WRITE, SN5S330_FUNC_SET8);

	INIT_I2C_FAIL_HELPER(EMUL, I2C_READ, SN5S330_FUNC_SET4);
	INIT_I2C_FAIL_HELPER(EMUL, I2C_WRITE, SN5S330_FUNC_SET4);

	INIT_I2C_FAIL_HELPER(EMUL, I2C_READ, SN5S330_FUNC_SET3);
	INIT_I2C_FAIL_HELPER(EMUL, I2C_WRITE, SN5S330_FUNC_SET3);

	INIT_I2C_FAIL_HELPER(EMUL, I2C_READ, SN5S330_FUNC_SET10);
	INIT_I2C_FAIL_HELPER(EMUL, I2C_WRITE, SN5S330_FUNC_SET10);

	INIT_I2C_FAIL_HELPER(EMUL, I2C_WRITE, SN5S330_INT_STATUS_REG4);

	INIT_I2C_FAIL_HELPER(EMUL, I2C_WRITE, SN5S330_INT_MASK_RISE_REG1);
	INIT_I2C_FAIL_HELPER(EMUL, I2C_WRITE, SN5S330_INT_MASK_FALL_REG1);
	INIT_I2C_FAIL_HELPER(EMUL, I2C_WRITE, SN5S330_INT_MASK_RISE_REG2);
	INIT_I2C_FAIL_HELPER(EMUL, I2C_WRITE, SN5S330_INT_MASK_FALL_REG2);
	INIT_I2C_FAIL_HELPER(EMUL, I2C_WRITE, SN5S330_INT_MASK_RISE_REG3);
	INIT_I2C_FAIL_HELPER(EMUL, I2C_WRITE, SN5S330_INT_MASK_FALL_REG3);

	INIT_I2C_FAIL_HELPER(EMUL, I2C_READ, SN5S330_INT_STATUS_REG4);

	INIT_I2C_FAIL_HELPER(EMUL, I2C_WRITE, SN5S330_INT_TRIP_RISE_REG1);
	INIT_I2C_FAIL_HELPER(EMUL, I2C_WRITE, SN5S330_INT_TRIP_RISE_REG2);
	INIT_I2C_FAIL_HELPER(EMUL, I2C_WRITE, SN5S330_INT_TRIP_RISE_REG3);
	INIT_I2C_FAIL_HELPER(EMUL, I2C_WRITE, SN5S330_INT_TRIP_FALL_REG1);
	INIT_I2C_FAIL_HELPER(EMUL, I2C_WRITE, SN5S330_INT_TRIP_FALL_REG2);
	INIT_I2C_FAIL_HELPER(EMUL, I2C_WRITE, SN5S330_INT_TRIP_FALL_REG3);
}
...
ZTEST(ppc_sn5s330, test_pp_fet_enable_fail)
{
	...
	i2c_common_emul_set_read_func(EMUL, pp_fet_test_mock_read_fn, &counter);
...
ZTEST(ppc_sn5s330, test_set_vbus_source_current_limit_fail)
{
	...
	i2c_common_emul_set_read_fail_reg(EMUL, SN5S330_FUNC_SET1);
...
ZTEST(ppc_sn5s330, test_sn5s330_discharge_vbus_fail)
{
	...
	i2c_common_emul_set_read_fail_reg(EMUL, SN5S330_FUNC_SET3);
...
ZTEST(ppc_sn5s330, test_low_power_mode_fail)
{
	...
	i2c_common_emul_set_read_fail_reg(EMUL, SN5S330_FUNC_SET4);
	ret = sn5s330_drv.enter_low_power_mode(SN5S330_PORT);
	zassert_equal(EC_ERROR_INVAL, ret, "Expected EC_ERROR_INVAL but got %d",
		      ret);

	i2c_common_emul_set_read_fail_reg(EMUL, SN5S330_FUNC_SET2);
	ret = sn5s330_drv.enter_low_power_mode(SN5S330_PORT);
	zassert_equal(EC_ERROR_INVAL, ret, "Expected EC_ERROR_INVAL but got %d",
		      ret);

	i2c_common_emul_set_read_fail_reg(EMUL, SN5S330_FUNC_SET9);
	ret = sn5s330_drv.enter_low_power_mode(SN5S330_PORT);
	zassert_equal(EC_ERROR_INVAL, ret, "Expected EC_ERROR_INVAL but got %d",
		      ret);
}
