...
static void test_enter_low_power_mode(void)
{
	...
	zassert_true((func_set3_reg & SN5S330_PP1_EN) == 0, NULL);
	zassert_true((func_set3_reg & SN5S330_PP2_EN) == 0, NULL);

	/* 2) Verify VCONN power path is off */
	sn5s330_emul_peek_reg(emul, SN5S330_FUNC_SET4, &func_set4_reg);
	zassert_true((func_set4_reg & SN5S330_CC_EN) != 0, NULL);
	zassert_true((func_set4_reg & SN5S330_VCONN_EN) == 0, NULL);

	/* 3) Verify SBU OVP FET is off */
	sn5s330_emul_peek_reg(emul, SN5S330_FUNC_SET2, &func_set2_reg);
	zassert_true((func_set2_reg & SN5S330_SBU_EN) == 0, NULL);

	/* 4) Verify VBUS and SBU OVP comparators are off */
	sn5s330_emul_peek_reg(emul, SN5S330_FUNC_SET9, &func_set9_reg);
	zassert_true((func_set9_reg & SN5S330_FORCE_OVP_EN_SBU) == 0, NULL);
	zassert_true((func_set9_reg & SN5S330_PWR_OVR_VBUS) == 0, NULL);
	zassert_true((func_set9_reg & SN5S330_OVP_EN_CC) != 0, NULL);
	zassert_true((func_set9_reg & SN5S330_FORCE_ON_VBUS_OVP) == 0, NULL);
	zassert_true((func_set9_reg & SN5S330_FORCE_ON_VBUS_UVP) == 0, NULL);
}
