...
void test_lis2dw12_set_rate(void)
{
	const struct emul *emul = emul_get_binding(EMUL_LABEL);
	struct i2c_emul *i2c_emul = lis2dw12_emul_to_i2c_emul(emul);
	struct motion_sensor_t *ms = &motion_sensors[LIS2DW12_SENSOR_ID];
	struct stprivate_data *drv_data = (struct stprivate_data *)ms->drv_data;
	int rv;
	...
	struct {
		...
		int round; /* 0=round down, 1=round up */
		int expected_norm_rate; /* millihertz */
		uint8_t expected_reg_val;
	} test_params[] = {
		{ 1000, 0, LIS2DW12_ODR_MIN_VAL, LIS2DW12_ODR_12HZ_VAL },
		{ 12501, 0, 12500, LIS2DW12_ODR_12HZ_VAL },
		{ 25001, 0, 25000, LIS2DW12_ODR_25HZ_VAL },
		{ 50001, 0, 50000, LIS2DW12_ODR_50HZ_VAL },
		{ 100001, 0, 100000, LIS2DW12_ODR_100HZ_VAL },
		{ 200001, 0, 200000, LIS2DW12_ODR_200HZ_VAL },
		{ 400001, 0, 400000, LIS2DW12_ODR_400HZ_VAL },
		{ 800001, 0, 800000, LIS2DW12_ODR_800HZ_VAL },
		{ 1600001, 0, 1600000, LIS2DW12_ODR_1_6kHZ_VAL },
		{ 3200001, 0, LIS2DW12_ODR_MAX_VAL, LIS2DW12_ODR_1_6kHZ_VAL },

		{ 1000, 1, LIS2DW12_ODR_MIN_VAL, LIS2DW12_ODR_12HZ_VAL },
		{ 12501, 1, 25000, LIS2DW12_ODR_25HZ_VAL },
		{ 25001, 1, 50000, LIS2DW12_ODR_50HZ_VAL },
		{ 50001, 1, 100000, LIS2DW12_ODR_100HZ_VAL },
		{ 100001, 1, 200000, LIS2DW12_ODR_200HZ_VAL },
		{ 200001, 1, 400000, LIS2DW12_ODR_400HZ_VAL },
		{ 400001, 1, 800000, LIS2DW12_ODR_800HZ_VAL },
		{ 800001, 1, 1600000, LIS2DW12_ODR_1_6kHZ_VAL },
		{ 1600001, 1, LIS2DW12_ODR_MAX_VAL, LIS2DW12_ODR_1_6kHZ_VAL },
	};
