...
static void *console_cmd_charge_state_setup(void)
{
	...
	fixture.source_ext.ext.ops = &tcpci_src_emul_ops;
	fixture.source_ext.ext.next = NULL;
	fixture.source_5v_3a.extensions = &fixture.source_ext.ext;
	tcpci_partner_init(&fixture.source_5v_3a);
