 ...
 *
 * CONFIG_AP_PWRSEQ must be disabled. These tests are for
 ...
 * When CONFIG_AP_PWRSEQ is disabled, events flow from hooks to the
 * AP power callbacks.
...
#error CONFIG_AP_PWRSEQ must be disabled
#endif
