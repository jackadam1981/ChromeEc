...
/*
 * Main timer for used sending/recieving CEC messages. Used in a similar way to
...
ZTEST_SUITE(cec_bitbang, drivers_predicate_post_main, NULL, cec_bitbang_before,
	    NULL, NULL);
