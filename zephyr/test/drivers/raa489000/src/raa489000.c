<<<<<<< PATCH SET (1a8bcb Raa489000: enable bist mode ASAP)
<<<<<<< HEAD   (a7ad7b Gallida360: Support Canadian French keyboard (US Type).)
=======
...
ZTEST_SUITE(tcpc_raa489000, drivers_predicate_post_main, NULL, NULL, NULL,
	    NULL);
>>>>>>> CHANGE (fc233f Raa489000: enable bist mode ASAP)
=======
/* Copyright 2025 The ChromiumOS Authors
 * Use of this source code is governed by a BSD-style license that can be
 * found in the LICENSE file.
...
ZTEST_SUITE(tcpc_raa489000, drivers_predicate_post_main, NULL, NULL, NULL,
	    NULL);
>>>>>>> BASE      (d471bb zephyr/emul/tcpc/raa489000: Add raa489000 emulator)
