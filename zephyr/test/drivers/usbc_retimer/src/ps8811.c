...
ZTEST(ps8811, test_page1_registers_rw)
{
	...
	expected |= (uint8_t)(~PS8811_REG1_50OHM_ADJUST_CHAN_B_RESERVED_MASK);
	rv = ps8811_emul_test_write1(PS8811_REG1_50OHM_ADJUST_CHAN_B,
			   expected);
	zexpect_ok(rv);
...
ZTEST(ps8811, test_reserved)
{
	...
	rv = ps8811_emul_test_write1(PS8811_REG1_USB_CHAN_A_SWING,
	...
	rv = ps8811_emul_test_write1(PS8811_REG1_USB_CHAN_B_SWING,
