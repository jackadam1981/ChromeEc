...
ZTEST(ps8811, test_page0_registers)
{
	int rv;
	int val;
	 ...
	 */
	rv = ps8811_write0(0, 0);
	zexpect_not_equal(rv, EC_SUCCESS);
	rv = ps8811_read0(0, &val);
	zexpect_not_equal(rv, EC_SUCCESS);
	rv = ps8811_update0(0, 0xff, 0xff);
	zexpect_not_equal(rv, EC_SUCCESS);
}

ZTEST(ps8811, test_page1_registers_rw)
{
	int val;
	int rv;
	uint8_t expected;
	 ...
	 */
	expected = 0xff;
	rv = ps8811_write1(PS8811_REG1_USB_AEQ_LEVEL, expected);
	...
	expected = 0xff;
	rv = ps8811_write1(PS8811_REG1_USB_ADE_CONFIG, expected);
	zexpect_ok(rv);
	...
	expected = 0xff;
	rv = ps8811_write1(PS8811_REG1_USB_BEQ_LEVEL, expected);
	zexpect_ok(rv);
	...
	expected = 0xff;
	rv = ps8811_write1(PS8811_REG1_USB_BDE_CONFIG, expected);
	zexpect_ok(rv);
	...
	expected |= (uint8_t)(~PS8811_REG1_USB_CHAN_A_SWING_RESERVED_MASK);
	rv = ps8811_write1(PS8811_REG1_USB_CHAN_A_SWING, expected);
	zexpect_ok(rv);
	...
	expected |= (uint8_t)(~PS8811_REG1_USB_CHAN_B_SWING_RESERVED_MASK);
	rv = ps8811_write1(PS8811_REG1_USB_CHAN_B_SWING, expected);
	zexpect_ok(rv);
	...
	expected |= (uint8_t)(~PS8811_REG1_USB_CHAN_B_DE_PS_LSB_RESERVED_MASK);
	rv = ps8811_write1(PS8811_REG1_USB_CHAN_B_DE_PS_LSB, expected);
	zexpect_ok(rv);
	...
	expected |= (uint8_t)(~PS8811_REG1_USB_CHAN_B_DE_PS_MSB_RESERVED_MASK);
	rv = ps8811_write1(PS8811_REG1_USB_CHAN_B_DE_PS_MSB, expected);
	zexpect_ok(rv);
...
ZTEST(ps8811, test_page1_registers_update)
{
	int rv;
	uint8_t val;
	...
	rv = ps8811_set_reg1(PS8811_REG1_USB_BDE_CONFIG, 0xff);
	zexpect_ok(rv);
	rv = ps8811_update1(PS8811_REG1_USB_BDE_CONFIG, 0x0f, 0x0);
	zexpect_ok(rv);
	rv = ps8811_get_reg1(PS8811_REG1_USB_BDE_CONFIG, &val);
	zexpect_equal(val, 0xf0);
