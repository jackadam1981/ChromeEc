...
static int anx7483_emul_test_i2c_read(int reg, int *data)
{
	return anx7483_read(&mux, reg, data);
}

static int anx7483_emul_test_i2c_write(int reg, int data)
{
...
ZTEST(anx7483, test_emul_registers_rw)
{
	...
	expected |= (uint8_t)(~ANX7483_LFPS_TIMER_REG_RESERVED_MASK);
	rv = anx7483_emul_test_i2c_write(ANX7483_LFPS_TIMER_REG, expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_LFPS_TIMER_REG, &val);
	...
	expected |= (uint8_t)(~ANX7483_ANALOG_STATUS_CTRL_REG_RESERVED_MASK);
	rv = anx7483_emul_test_i2c_write(ANX7483_ANALOG_STATUS_CTRL_REG,
					 expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_ANALOG_STATUS_CTRL_REG, &val);
	zexpect_equal(val, expected);

	expected = (uint8_t)(ANX7483_ENABLE_EQ_FLAT_SWING_REG_RESERVED_MASK
		& ANX7483_ENABLE_EQ_FLAT_SWING_REG_DEFAULT);
	expected |= (uint8_t)(~ANX7483_ENABLE_EQ_FLAT_SWING_REG_RESERVED_MASK);
	rv = anx7483_emul_test_i2c_write(ANX7483_ENABLE_EQ_FLAT_SWING_REG,
					 expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_ENABLE_EQ_FLAT_SWING_REG, &val);
	zexpect_equal(val, expected);

	expected = (uint8_t)(ANX7483_AUX_SNOOPING_CTRL_REG_RESERVED_MASK
		& ANX7483_AUX_SNOOPING_CTRL_REG_DEFAULT);
	expected |= (uint8_t)(~ANX7483_AUX_SNOOPING_CTRL_REG_RESERVED_MASK);
	rv = anx7483_emul_test_i2c_write(ANX7483_AUX_SNOOPING_CTRL_REG,
					 expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_AUX_SNOOPING_CTRL_REG, &val);
	zexpect_equal(val, expected);
	...
	expected |= (uint8_t)(~ANX7483_UTX1_PORT_CFG0_REG_RESERVED_MASK);
	rv = anx7483_emul_test_i2c_write(ANX7483_UTX1_PORT_CFG0_REG, expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_UTX1_PORT_CFG0_REG, &val);
	zexpect_equal(val, expected);

	expected = (uint8_t)(ANX7483_UTX2_PORT_CFG0_REG_RESERVED_MASK
		& ANX7483_UTX2_PORT_CFG0_REG_DEFAULT);
	expected |= (uint8_t)(~ANX7483_UTX2_PORT_CFG0_REG_RESERVED_MASK);
	rv = anx7483_emul_test_i2c_write(ANX7483_UTX2_PORT_CFG0_REG, expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_UTX2_PORT_CFG0_REG, &val);
	zexpect_equal(val, expected);

	expected = (uint8_t)(ANX7483_URX1_PORT_CFG0_REG_RESERVED_MASK
		& ANX7483_URX1_PORT_CFG0_REG_DEFAULT);
	expected |= (uint8_t)(~ANX7483_URX1_PORT_CFG0_REG_RESERVED_MASK);
	rv = anx7483_emul_test_i2c_write(ANX7483_URX1_PORT_CFG0_REG, expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_URX1_PORT_CFG0_REG, &val);
	zexpect_equal(val, expected);

	expected = (uint8_t)(ANX7483_URX2_PORT_CFG0_REG_RESERVED_MASK
		& ANX7483_URX1_PORT_CFG0_REG_DEFAULT);
	expected |= (uint8_t)(~ANX7483_URX2_PORT_CFG0_REG_RESERVED_MASK);
	rv = anx7483_emul_test_i2c_write(ANX7483_URX2_PORT_CFG0_REG, expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_URX2_PORT_CFG0_REG, &val);
	zexpect_equal(val, expected);

	expected = (uint8_t)(ANX7483_DRX1_PORT_CFG0_REG_RESERVED_MASK
		& ANX7483_DRX1_PORT_CFG0_REG_DEFAULT);
	expected |= (uint8_t)(~ANX7483_DRX1_PORT_CFG0_REG_RESERVED_MASK);
	rv = anx7483_emul_test_i2c_write(ANX7483_DRX1_PORT_CFG0_REG, expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_DRX1_PORT_CFG0_REG, &val);
	zexpect_equal(val, expected);

	expected = (uint8_t)(ANX7483_DRX2_PORT_CFG0_REG_RESERVED_MASK
		& ANX7483_DRX2_PORT_CFG0_REG_DEFAULT);
	expected |= (uint8_t)(~ANX7483_DRX2_PORT_CFG0_REG_RESERVED_MASK);
	rv = anx7483_emul_test_i2c_write(ANX7483_DRX2_PORT_CFG0_REG, expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_DRX2_PORT_CFG0_REG, &val);
	zexpect_equal(val, expected);

	/* CFG1 */
	expected = 0xff;
	rv = anx7483_emul_test_i2c_write(ANX7483_UTX1_PORT_CFG1_REG, expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_UTX1_PORT_CFG1_REG, &val);
	zexpect_equal(val, expected);

	expected = 0xff;
	rv = anx7483_emul_test_i2c_write(ANX7483_UTX2_PORT_CFG1_REG, expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_UTX2_PORT_CFG1_REG, &val);
	zexpect_equal(val, expected);

	expected = 0xff;
	rv = anx7483_emul_test_i2c_write(ANX7483_URX1_PORT_CFG1_REG, expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_URX1_PORT_CFG1_REG, &val);
	zexpect_equal(val, expected);

	expected = 0xff;
	rv = anx7483_emul_test_i2c_write(ANX7483_URX2_PORT_CFG1_REG, expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_URX2_PORT_CFG1_REG, &val);
	zexpect_equal(val, expected);

	expected = 0xff;
	rv = anx7483_emul_test_i2c_write(ANX7483_DRX1_PORT_CFG1_REG, expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_DRX1_PORT_CFG1_REG, &val);
	zexpect_equal(val, expected);

	expected = 0xff;
	rv = anx7483_emul_test_i2c_write(ANX7483_DRX2_PORT_CFG1_REG, expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_DRX2_PORT_CFG1_REG, &val);
	zexpect_equal(val, expected);
	...
	expected |= (uint8_t)(~ANX7483_UTX1_PORT_CFG2_REG_RESERVED_MASK);
	rv = anx7483_emul_test_i2c_write(ANX7483_UTX1_PORT_CFG2_REG, expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_UTX1_PORT_CFG2_REG, &val);
	zexpect_equal(val, expected);

	expected = (uint8_t)(ANX7483_UTX2_PORT_CFG2_REG_RESERVED_MASK
		& ANX7483_UTX2_PORT_CFG2_REG_DEFAULT);
	expected |= (uint8_t)(~ANX7483_UTX2_PORT_CFG2_REG_RESERVED_MASK);
	rv = anx7483_emul_test_i2c_write(ANX7483_UTX2_PORT_CFG2_REG, expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_UTX2_PORT_CFG2_REG, &val);
	zexpect_equal(val, expected);

	expected = (uint8_t)(ANX7483_URX1_PORT_CFG2_REG_RESERVED_MASK
		& ANX7483_URX1_PORT_CFG2_REG_DEFAULT);
	expected |= (uint8_t)(~ANX7483_URX1_PORT_CFG2_REG_RESERVED_MASK);
	rv = anx7483_emul_test_i2c_write(ANX7483_URX1_PORT_CFG2_REG, expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_URX1_PORT_CFG2_REG, &val);
	zexpect_equal(val, expected);

	expected = (uint8_t)(ANX7483_URX2_PORT_CFG2_REG_RESERVED_MASK
		& ANX7483_URX1_PORT_CFG2_REG_DEFAULT);
	expected |= (uint8_t)(~ANX7483_URX2_PORT_CFG2_REG_RESERVED_MASK);
	rv = anx7483_emul_test_i2c_write(ANX7483_URX2_PORT_CFG2_REG, expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_URX2_PORT_CFG2_REG, &val);
	zexpect_equal(val, expected);

	expected = (uint8_t)(ANX7483_DRX1_PORT_CFG2_REG_RESERVED_MASK
		& ANX7483_DRX1_PORT_CFG2_REG_DEFAULT);
	expected |= (uint8_t)(~ANX7483_DRX1_PORT_CFG2_REG_RESERVED_MASK);
	rv = anx7483_emul_test_i2c_write(ANX7483_DRX1_PORT_CFG2_REG, expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_DRX1_PORT_CFG2_REG, &val);
	zexpect_equal(val, expected);

	expected = (uint8_t)(ANX7483_DRX2_PORT_CFG2_REG_RESERVED_MASK
		& ANX7483_DRX2_PORT_CFG2_REG_DEFAULT);
	expected |= (uint8_t)(~ANX7483_DRX2_PORT_CFG2_REG_RESERVED_MASK);
	rv = anx7483_emul_test_i2c_write(ANX7483_DRX2_PORT_CFG2_REG, expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_DRX2_PORT_CFG2_REG, &val);
	zexpect_equal(val, expected);

	/* CFG3 */
	expected = 0xff;
	rv = anx7483_emul_test_i2c_write(ANX7483_UTX1_PORT_CFG3_REG, expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_UTX1_PORT_CFG3_REG, &val);
	zexpect_equal(val, expected);

	expected = 0xff;
	rv = anx7483_emul_test_i2c_write(ANX7483_UTX2_PORT_CFG3_REG, expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_UTX2_PORT_CFG3_REG, &val);
	zexpect_equal(val, expected);

	expected = 0xff;
	rv = anx7483_emul_test_i2c_write(ANX7483_URX1_PORT_CFG3_REG, expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_URX1_PORT_CFG3_REG, &val);
	zexpect_equal(val, expected);

	expected = 0xff;
	rv = anx7483_emul_test_i2c_write(ANX7483_URX2_PORT_CFG3_REG, expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_URX2_PORT_CFG3_REG, &val);
	zexpect_equal(val, expected);

	expected = 0xff;
	rv = anx7483_emul_test_i2c_write(ANX7483_DRX1_PORT_CFG3_REG, expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_DRX1_PORT_CFG3_REG, &val);
	zexpect_equal(val, expected);

	expected = 0xff;
	rv = anx7483_emul_test_i2c_write(ANX7483_DRX2_PORT_CFG3_REG, expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_DRX2_PORT_CFG3_REG, &val);
	zexpect_equal(val, expected);
	...
	expected |= (uint8_t)(~ANX7483_UTX1_PORT_CFG4_REG_RESERVED_MASK);
	rv = anx7483_emul_test_i2c_write(ANX7483_UTX1_PORT_CFG4_REG, expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_UTX1_PORT_CFG4_REG, &val);
	zexpect_equal(val, expected);

	expected = (uint8_t)(ANX7483_UTX2_PORT_CFG4_REG_RESERVED_MASK
		& ANX7483_UTX2_PORT_CFG4_REG_DEFAULT);
	expected |= (uint8_t)(~ANX7483_UTX2_PORT_CFG4_REG_RESERVED_MASK);
	rv = anx7483_emul_test_i2c_write(ANX7483_UTX2_PORT_CFG4_REG, expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_UTX2_PORT_CFG4_REG, &val);
	zexpect_equal(val, expected);

	expected = (uint8_t)(ANX7483_URX1_PORT_CFG4_REG_RESERVED_MASK
		& ANX7483_URX1_PORT_CFG4_REG_DEFAULT);
	expected |= (uint8_t)(~ANX7483_URX1_PORT_CFG4_REG_RESERVED_MASK);
	rv = anx7483_emul_test_i2c_write(ANX7483_URX1_PORT_CFG4_REG, expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_URX1_PORT_CFG4_REG, &val);
	zexpect_equal(val, expected);

	expected = (uint8_t)(ANX7483_URX2_PORT_CFG4_REG_RESERVED_MASK
		& ANX7483_URX1_PORT_CFG4_REG_DEFAULT);
	expected |= (uint8_t)(~ANX7483_URX2_PORT_CFG4_REG_RESERVED_MASK);
	rv = anx7483_emul_test_i2c_write(ANX7483_URX2_PORT_CFG4_REG, expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_URX2_PORT_CFG4_REG, &val);
	zexpect_equal(val, expected);

	expected = (uint8_t)(ANX7483_DRX1_PORT_CFG4_REG_RESERVED_MASK
		& ANX7483_DRX1_PORT_CFG4_REG_DEFAULT);
	expected |= (uint8_t)(~ANX7483_DRX1_PORT_CFG4_REG_RESERVED_MASK);
	rv = anx7483_emul_test_i2c_write(ANX7483_DRX1_PORT_CFG4_REG, expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_DRX1_PORT_CFG4_REG, &val);
	zexpect_equal(val, expected);

	expected = (uint8_t)(ANX7483_DRX2_PORT_CFG4_REG_RESERVED_MASK
		& ANX7483_DRX2_PORT_CFG4_REG_DEFAULT);
	expected |= (uint8_t)(~ANX7483_DRX2_PORT_CFG4_REG_RESERVED_MASK);
	rv = anx7483_emul_test_i2c_write(ANX7483_DRX2_PORT_CFG4_REG, expected);
	zexpect_ok(rv);
	rv = anx7483_emul_test_i2c_read(ANX7483_DRX2_PORT_CFG4_REG, &val);
	zexpect_equal(val, expected);

	/* Ensure that reading/writing a non-existent register fails. */
	rv = anx7483_emul_test_i2c_read(0xff, &val);
	zexpect_not_equal(rv, 0);
	rv = anx7483_emul_test_i2c_write(0xff, 0xff);
	zexpect_not_equal(rv, 0);
}
...
ZTEST(anx7483, test_mux_state_set)
{
	...
	rv = anx7483_set(&mux, USB_PD_MUX_USB_ENABLED
...
ZTEST(anx7483, test_emul_reserved)
{
	...
	/* CFG0 */
	rv = anx7483_emul_test_set_reg(ANX7483_UTX1_PORT_CFG0_REG,
			     ANX7483_UTX1_PORT_CFG0_REG_RESERVED_MASK);
	zexpect_not_equal(rv, 0);

	rv = anx7483_emul_test_set_reg(ANX7483_UTX2_PORT_CFG0_REG,
			     ANX7483_UTX2_PORT_CFG0_REG_RESERVED_MASK);
	zexpect_not_equal(rv, 0);

	rv = anx7483_emul_test_set_reg(ANX7483_URX1_PORT_CFG0_REG,
			     ANX7483_URX1_PORT_CFG0_REG_RESERVED_MASK);
	zexpect_not_equal(rv, 0);

	rv = anx7483_emul_test_set_reg(ANX7483_URX2_PORT_CFG0_REG,
			     ANX7483_URX2_PORT_CFG0_REG_RESERVED_MASK);
	zexpect_not_equal(rv, 0);

	rv = anx7483_emul_test_set_reg(ANX7483_DRX1_PORT_CFG0_REG,
			     ANX7483_DRX1_PORT_CFG0_REG_RESERVED_MASK);
	zexpect_not_equal(rv, 0);

	rv = anx7483_emul_test_set_reg(ANX7483_DRX2_PORT_CFG0_REG,
			     ANX7483_DRX2_PORT_CFG0_REG_RESERVED_MASK);
	zexpect_not_equal(rv, 0);

	/* CFG2 */
	rv = anx7483_emul_test_set_reg(ANX7483_UTX1_PORT_CFG2_REG,
			     ANX7483_UTX1_PORT_CFG2_REG_RESERVED_MASK);
	zexpect_not_equal(rv, 0);

	rv = anx7483_emul_test_set_reg(ANX7483_UTX2_PORT_CFG2_REG,
			     ANX7483_UTX2_PORT_CFG2_REG_RESERVED_MASK);
	zexpect_not_equal(rv, 0);

	rv = anx7483_emul_test_set_reg(ANX7483_URX1_PORT_CFG2_REG,
			     ANX7483_URX1_PORT_CFG2_REG_RESERVED_MASK);
	zexpect_not_equal(rv, 0);

	rv = anx7483_emul_test_set_reg(ANX7483_URX2_PORT_CFG2_REG,
			     ANX7483_URX2_PORT_CFG2_REG_RESERVED_MASK);
	zexpect_not_equal(rv, 0);

	rv = anx7483_emul_test_set_reg(ANX7483_DRX1_PORT_CFG2_REG,
			     ANX7483_DRX1_PORT_CFG2_REG_RESERVED_MASK);
	zexpect_not_equal(rv, 0);

	rv = anx7483_emul_test_set_reg(ANX7483_DRX2_PORT_CFG2_REG,
			     ANX7483_DRX2_PORT_CFG2_REG_RESERVED_MASK);
	zexpect_not_equal(rv, 0);

	/* CFG4 */
	rv = anx7483_emul_test_set_reg(ANX7483_UTX1_PORT_CFG4_REG,
			     ANX7483_UTX1_PORT_CFG4_REG_RESERVED_MASK);
	zexpect_not_equal(rv, 0);

	rv = anx7483_emul_test_set_reg(ANX7483_UTX2_PORT_CFG4_REG,
			     ANX7483_UTX2_PORT_CFG4_REG_RESERVED_MASK);
	zexpect_not_equal(rv, 0);

	rv = anx7483_emul_test_set_reg(ANX7483_URX1_PORT_CFG4_REG,
			     ANX7483_URX1_PORT_CFG4_REG_RESERVED_MASK);
	zexpect_not_equal(rv, 0);

	rv = anx7483_emul_test_set_reg(ANX7483_URX2_PORT_CFG4_REG,
			     ANX7483_URX2_PORT_CFG4_REG_RESERVED_MASK);
	zexpect_not_equal(rv, 0);

	rv = anx7483_emul_test_set_reg(ANX7483_DRX1_PORT_CFG4_REG,
			     ANX7483_DRX1_PORT_CFG4_REG_RESERVED_MASK);
	zexpect_not_equal(rv, 0);

	rv = anx7483_emul_test_set_reg(ANX7483_DRX2_PORT_CFG4_REG,
