...
extern const size_t anx7483_AA_usb_term_count;
extern const size_t anx7483_BA_usb_term_count;
extern const size_t anx7483_AA_dp_term_count;
extern const size_t anx7483_BA_dp_term_count;
extern const size_t anx7483_AA_dock_noflip_term_count;
extern const size_t anx7483_BA_dock_noflip_term_count;
...
ZTEST(anx7483, test_tuning_usb_AA)
{
	...
	rv = anx7483_emul_test_set_reg(ANX7483_VID, 0x00);
	zexpect_ok(rv);
	...
	rv = anx7483_emul_validate_tuning(ANX7483_EMUL, usb_enabled,
			anx7483_usb_enabled_count + anx7483_BA_usb_term_count);
	zexpect_ok(rv);
}
...
ZTEST(anx7483, test_tuning_usb_BA)
{
	...
	rv = anx7483_emul_test_set_reg(ANX7483_VID, 0xBA);
	zexpect_ok(rv);
	rv = anx7483_set_default_tuning(&mux, USB_PD_MUX_USB_ENABLED);
	zexpect_ok(rv);
...
ZTEST(anx7483, test_tuning_dp_AA)
{
	...
	rv = anx7483_emul_validate_tuning(ANX7483_EMUL, dp_enabled,
			anx7483_dp_enabled_count + anx7483_AA_dp_term_count);
	zexpect_ok(rv);
}
...
ZTEST(anx7483, test_tuning_dp_BA)
{
	...
	rv = anx7483_emul_validate_tuning(ANX7483_EMUL, dp_enabled,
			anx7483_dp_enabled_count + anx7483_BA_dp_term_count);
	zexpect_ok(rv);
}
...
ZTEST(anx7483, test_tuning_dock_noflip_AA)
{
	...
	rv = anx7483_emul_validate_tuning(ANX7483_EMUL, dock_noflip,
			anx7483_dock_noflip_count + anx7483_AA_dock_noflip_term_count);
...
ZTEST(anx7483, test_tuning_dock_noflip_BA)
{
	...
	rv = anx7483_emul_validate_tuning(ANX7483_EMUL, dock_noflip,
				anx7483_dock_noflip_count + anx7483_BA_dock_noflip_term_count);
	zexpect_ok(rv);
}
