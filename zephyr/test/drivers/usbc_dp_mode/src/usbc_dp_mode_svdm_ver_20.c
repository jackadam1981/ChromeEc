...
static void add_dp_discovery_svdm_ver_20(struct tcpci_partner_data *partner)
{
	add_dp_discovery(partner, SVDM_VER_2_0);
}

static void
add_displayport_mode_responses_svdm_ver_20(struct tcpci_partner_data *partner)
{
...
static void setup_passive_cable_svdm_ver_20(struct tcpci_partner_data *partner)
{
	...
	add_dp_discovery_svdm_ver_20(partner);
	partner->cable = &passive_usb3_32;
	add_displayport_mode_responses_svdm_ver_20(partner);
}

static void *usbc_dp_mode_setup_svdm_ver_20(void)
{
	set_passive_usb3_32(&passive_usb3_32, SVDM_VER_2_0);
...
ZTEST_F(usbc_dp_mode_svdm_ver_20, test_discovery_svdm_ver_20)
{
	...
	fixture->partner.cable->identity_vdm[VDO_INDEX_IDH] |= VDO_MODAL_OPERATION_BIT;
	...
	zassert_equal(pd_get_vdo_ver(TEST_PORT, TCPCI_MSG_SOP_PRIME), SVDM_VER_2_0,
		      "Expected SVDM version 2.0 for SOP', got %d",
