...
#define ACTIVE_1                                                               \
	VDO_REV30_ACTIVE_1(USB_R30_SS_U40_GEN3, 0, BIT(0), USB_VBUS_CUR_3A, 0, \
			   BIT(0), 0, (BIT(0) | BIT(1)), USB_REV30_LATENCY_1m, \
			   USB_REV30_TYPE_C)

#define ACTIVE_2                                                       \
	VDO_REV30_ACTIVE_2(1, 1, 1, 0, 1, 0, 0, 0, 1, 0, 0, 0xfffffff, \
			   0xfffffff)

/* Active optical redriver cable */
struct tcpci_cable_data active_optical_redriver = {
	.identity_vdm[VDO_INDEX_HDR] =
		VDO(USB_SID_PD, /* structured VDM */ true,
		    VDO_CMDT(CMDT_RSP_ACK) | CMD_DISCOVER_IDENT) |
		VDO_SVDM_VERS_MAJOR(SVDM_VER_2_1) | VDM_VERS_MINOR,
	...
	.identity_vdm[VDO_INDEX_CSTAT] = 0,
	.identity_vdm[VDO_INDEX_PRODUCT] = VDO_PRODUCT(0x1234, 0xABCD),
	.identity_vdm[VDO_INDEX_PTYPE_CABLE1] = ACTIVE_1,
	.identity_vdm[VDO_INDEX_PTYPE_CABLE2] = ACTIVE_2,
...
static void setup_active_cable_test(struct tcpci_partner_data *partner)
{
	add_dp_21_discovery(partner);
...
ZTEST_F(usbc_dp_mode, test_dp21_entry_active_test)
{
	setup_active_cable_test(&fixture->partner);
	connect_sink_to_port(&fixture->partner, fixture->tcpci_emul,
			     fixture->charger_emul);
