...
ZTEST(rt9490_bc12, test_detection_flow)
{
	...
	zassert_ok(rt9490_emul_write_reg(emul, RT9490_REG_CHG_STATUS1,
					 RT9490_DCP << RT9490_VBUS_STAT_SHIFT));
	rt9490_interrupt(0);
	...
	zassert_false(rt9490_emul_peek_reg(emul, RT9490_REG_CHG_CTRL2) &
			      RT9490_BC12_EN,
		      NULL);
	zassert_equal(charge_manager_get_supplier(), CHARGE_SUPPLIER_BC12_DCP,
		      "expect supplier is DCP, got %d",
