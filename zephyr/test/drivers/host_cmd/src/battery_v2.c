...
ZTEST(host_cmd_battery_v2, test_get_static_invalid_index)
{
...
ZTEST(host_cmd_battery_v2, test_get_static_v0)
{
	struct ec_params_battery_static_info params = {
		.index = 0,
	};
...
ZTEST(host_cmd_battery_v2, test_get_static_v1)
{
...
ZTEST(host_cmd_battery_v2, test_get_static_v2)
{
...
ZTEST(host_cmd_battery_v2, test_get_dynamic_invalid_index)
{
