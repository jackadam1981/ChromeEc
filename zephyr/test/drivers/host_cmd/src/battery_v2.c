...
ZTEST(host_cmd_battery_v2, get_static__invalid_index)
{
...
ZTEST(host_cmd_battery_v2, get_static__v0)
{
	struct ec_params_battery_static_info params = {
		.index = 0,
	};
...
ZTEST(host_cmd_battery_v2, get_static__v1)
{
...
ZTEST(host_cmd_battery_v2, get_dynamic__invalid_index)
{
...
ZTEST(host_cmd_battery_v2, get_dynamic)
{
	struct ec_response_battery_dynamic_info response;
	struct ec_params_battery_dynamic_info params = {
		.index = 0,
