...
ZTEST(led_common, test_host_command_query)
{
...
ZTEST(led_common, test_host_command_invalid_led)
{
...
ZTEST(led_common, test_host_command_supported_channel)
{
...
ZTEST(led_common, test_host_command_manual_control)
{
...
ZTEST(led_common, test_host_command_auto_control)
{
