...
ZTEST_USER(common_cbi, test_hc_cbi_bin_write_then_read)
{
	 ...
	 */
	const uint8_t data[] = {
		0x43, 0x42, 0x49, 0xCA, 0x00, 0x00, 0x30, 0x00
	};
...
ZTEST_USER(common_cbi, test_hc_cbi_bin_write_bad_cbi)
{
	...
	const uint8_t data[] = {
		0x43, 0x42, 0x00, 0xCA, 0x00, 0x00, 0x30, 0x00
	};
	...
	/* fails cbi version */
	hc_set_params.params.data[3] = 0xCA;
	hc_set_params.params.data[5] = 0xCA;
