...
ZTEST(system_function, test_system_encode_save_flags)
{
	int flags_to_save = 0;
...
ZTEST_SUITE(system_functions, drivers_predicate_post_main, NULL,
	    system_before_after, system_before_after, NULL);
