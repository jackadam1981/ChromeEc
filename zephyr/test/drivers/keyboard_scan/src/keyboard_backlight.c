...
ZTEST(keyboard_backlight, test_host_command_set_backlight_normal)
{
...
ZTEST(keyboard_backlight, test_host_command_set_backlight_out_of_range)
{
	/* Too high */
...
ZTEST(keyboard_backlight, test_host_command_get_backlight_normal)
{
...
ZTEST(keyboard_backlight, test_console_command_noargs)
{
...
ZTEST(keyboard_backlight, test_console_command_set_on)
{
...
ZTEST(keyboard_backlight, test_console_command_set_off)
{
...
ZTEST(keyboard_backlight, test_console_command_bad_params)
{
...
ZTEST(keyboard_backlight, test_set_backlight_device_not_ready)
{
