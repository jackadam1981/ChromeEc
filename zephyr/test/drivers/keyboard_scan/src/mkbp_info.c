...
ZTEST(mkbp_info, test_host_command_mkbp_info_keyboard_info)
{
...
ZTEST(mkbp_info, test_host_command_mkbp_info_supported_buttons)
{
...
ZTEST(mkbp_info, test_host_command_mkbp_info_supported_switches)
{
...
ZTEST(mkbp_info, test_host_command_mkbp_info_supported_invalid)
{
...
ZTEST(mkbp_info, test_host_command_mkbp_info_current_keyboard_matrix)
{
...
ZTEST(mkbp_info, test_host_command_mkbp_info_current_host_events)
{
	int ret;
	union ec_response_get_next_data response;
	struct ec_params_mkbp_info request = {
...
ZTEST(mkbp_info, test_host_command_mkbp_info_current_host_events64)
{
	int ret;
	union ec_response_get_next_data response;
	struct ec_params_mkbp_info request = {
...
ZTEST(mkbp_info, test_host_command_mkbp_info_current_buttons)
{
	int ret;
	union ec_response_get_next_data response;
	struct ec_params_mkbp_info request = {
...
ZTEST(mkbp_info, test_host_command_mkbp_info_current_switches)
{
	int ret;
	union ec_response_get_next_data response;
	struct ec_params_mkbp_info request = {
...
ZTEST(mkbp_info, test_host_command_mkbp_info_current_invalid)
{
	int ret;
	union ec_response_get_next_data response;
	struct ec_params_mkbp_info request = {
...
ZTEST(mkbp_info, test_host_command_mkbp_info_invalid)
{
	int ret;
	union ec_response_get_next_data response;
	struct ec_params_mkbp_info request = {
