 ...
 */
#define zassume_unreachable(msg, ...) zassert_unreachable(msg, ...)
 ...
 * @param msg Optional message to print if the assumption fails
 */
#define zassume_true(cond, msg, ...) zassert_true(cond, msg, ...)
 ...
 * @param msg Optional message to print if the assumption fails
 */
#define zassume_false(cond, msg, ...) zassert_false(cond, msg, ...)
 ...
 * @param msg Optional message to print if the assumption fails
 */
#define zassume_ok(cond, msg, ...) zassert_ok(cond, msg, ...)
 ...
 * @param msg Optional message to print if the assumption fails
 */
#define zassume_is_null(ptr, msg, ...) zassert_is_null(ptr, msg, ...)
 ...
 * @param msg Optional message to print if the assumption fails
 */
#define zassume_not_null(ptr, msg, ...) zassert_not_null(ptr, msg, ...)
 ...
 * @param msg Optional message to print if the assumption fails
 */
#define zassume_equal(a, b, msg, ...) zassert_equal(a, b, msg, ...)
 ...
 * @param msg Optional message to print if the assumption fails
 */
#define zassume_not_equal(a, b, msg, ...) zassert_not_equal(a, b, msg, ...)
 ...
 * @param msg Optional message to print if the assumption fails
 */
#define zassume_equal_ptr(a, b, msg, ...) zassert_equal_ptr(a, b, msg, ...)
 ...
 * @param msg Optional message to print if the assumption fails
 */
#define zassume_within(a, b, d, msg, ...) zassert_within(a, b, d, msg, ...)
 ...
 */
#define zassume_mem_equal(...) zassert_mem_equal(...)
