...
ZTEST(usb_port_power_dumb, test_console_command_noargs)
{
...
ZTEST(usb_port_power_dumb, test_console_command_modify_port_status)
{
	const char *outbuffer;
	size_t buffer_size;
...
ZTEST(usb_port_power_dumb, test_console_command_invalid)
{
	/* Various bad input */
...
ZTEST(usb_port_power_dumb, test_host_command_enable)
{
	int ret;
...
ZTEST(usb_port_power_dumb, test_host_command_invalid_port_id)
{
	int ret;
	struct ec_params_usb_charge_set_mode params = {
		.mode = USB_CHARGE_MODE_ENABLED,
...
ZTEST(usb_port_power_dumb, test_host_command_invalid_mode)
{
	int ret;
	struct ec_params_usb_charge_set_mode params = {
