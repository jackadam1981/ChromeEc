...
The c`onsole.output` test suite verifies the following behavior of EC messages
sent to the UART.

* The Zephyr shell sends it's output to the UART.
...
* Zephyr logging calls are sent to the UART.
