...
static void emul_signal_work_hanlder(struct k_work *work)
{
	...
	printf("Setting input signal - %d\n", in_power_signal[in_signal]);
				 ...
				 gpio_port_pins_t pins)
{
	...
	case PWR_EC_PCH_RSMRST:
		k_delayed_work_submit(&out_work[index], K_MSEC(5));
		break;
	}
}
