...
ZTEST(ap_pwrseq, test_ap_pwrseq_3)
{
	zassert_equal(0,
		      ...
		      "Unable to load test platfform `tp_sys_s5_slp_sus_fail`");
...
ZTEST(ap_pwrseq, test_ap_pwrseq_4)
{
	zassert_equal(
		...
		"Unable to load test platfform `tp_sys_s4_dsw_pwrok_fail`");
...
ZTEST(ap_pwrseq, test_ap_pwrseq_5)
{
	zassert_equal(
		...
		"Unable to load test platfform `tp_sys_s3_dsw_pwrok_fail`");
