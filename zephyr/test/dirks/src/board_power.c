 ...
 *
 * Unit tests for program/dirks/src/board_power.c.
 */
...
ZTEST_SUITE(dirks_board_power, NULL, NULL, before_test, NULL, NULL);

ZTEST(dirks_board_power, test_power_signal_set)
{
	/* No settable signal is board-defined */
	zassert_equal(board_power_signal_set(PWR_EN_PP3300_A, 1), -EINVAL);
}

ZTEST(dirks_board_power, test_power_signal_get)
{
...
ZTEST(dirks_board_power, test_g3_s5_action)
{
	/*
...
ZTEST(dirks_board_power, test_rails_enabled)
{
...
ZTEST(dirks_board_power, test_assert_pch_pwrok)
{
...
ZTEST(dirks_board_power, test_s0_entry_exit)
{
...
ZTEST(dirks_board_power, test_force_shutdown)
{
