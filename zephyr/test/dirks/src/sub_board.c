 ...
 *
 * Unit tests for program/dirks/src/sub_board.c.
 */
#include "cros_cbi.h"
...
struct dirks_sub_board_fixture {
...
{
	struct dirks_sub_board_fixture *fixture =
		k_malloc(sizeof(struct dirks_sub_board_fixture));
...
{
	struct dirks_sub_board_fixture *fixture = fixture_;
...
ZTEST_SUITE(dirks_sub_board, NULL, suite_setup_fn, test_before_fn, NULL, NULL);

ZTEST_F(dirks_sub_board, test_usb_c_a)
{
...
ZTEST_F(dirks_sub_board, test_usb_c_lte)
{
...
ZTEST_F(dirks_sub_board, test_usb_a_hdmi)
{
...
ZTEST(dirks_sub_board, test_unset_board)
{
...
ZTEST(dirks_sub_board, test_cbi_error)
{
	/*
