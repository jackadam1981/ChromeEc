...
LOG_MODULE_REGISTER(dirks, LOG_LEVEL_INF);

extern const struct ec_response_keybd_config dirks_kb_legacy;
...
ZTEST(dirks, test_board_check_extpower)
{
...
ZTEST(dirks, test_board_hibernate)
{
	board_hibernate();
...
ZTEST(dirks, test_pd_check_vbus_level)
{
...
ZTEST(dirks, test_chargers_suspend)
{
...
ZTEST(dirks, test_set_active_charge_port)
{
...
ZTEST(dirks, test_tcpc_get_alert_status)
{
...
ZTEST(dirks, test_typec_set_source_current_limit)
{
...
ZTEST(dirks, test_usb_c1_interrupt)
{
