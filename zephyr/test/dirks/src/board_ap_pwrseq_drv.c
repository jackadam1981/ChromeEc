 ...
 *
 * AP Power sequence driver unit tests for program/dirks/src/board_power.c.
 * Dirks only has action handlers for power state G3 and S0.
 */
...
ZTEST_SUITE(dirks_board_power, NULL, setup_test, NULL, after_test, NULL);
 ...
 */
ZTEST(dirks_board_power, test_board_ap_power_g3_run_0)
{
 ...
 */
ZTEST(dirks_board_power, test_board_ap_power_g3_run_1)
{
	const struct device *dev = ap_pwrseq_get_instance();
 ...
 */
ZTEST(dirks_board_power, test_board_ap_power_g3_run_2)
{
	const struct device *dev = ap_pwrseq_get_instance();
 ...
 */
ZTEST(dirks_board_power, test_board_ap_power_g3_run_3)
{
	const struct device *dev = ap_pwrseq_get_instance();
 ...
 *
 * @details
 * Since S0 action handler for Dirks does notdo any power signal check, this
 ...
 * - G3 action handler verifies power signals are set.
 */
ZTEST(dirks_board_power, test_board_ap_power_s0_run_0)
{
	const struct device *dev = ap_pwrseq_get_instance();
