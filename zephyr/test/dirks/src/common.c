...
ZTEST_SUITE(dirks_common, NULL, NULL, suite_before, NULL, NULL);

ZTEST(dirks_common, test_pen_power_control)
{
...
ZTEST(dirks_common, test_ocpc_configuration)
{
	int kp, kp_div;
	int ki, ki_div;
	int kd, kd_div;
...
ZTEST(dirks_common, test_sm5803_buck_boost_forbidden)
{
...
ZTEST(dirks_common, test_i2c_passthru_policy)
{
