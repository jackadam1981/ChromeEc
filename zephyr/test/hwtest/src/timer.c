...
ZTEST(timer, test_crec_usleep)
{
	...
	/* The SYS_CLK for NPCX is generated from with a timer
	 * clocked by LFCLK which runs at 32768 Hz with an
	 * error of 2%. The SYS_CLK frequency is configurable
	 * and defaults to 10000 Hz for Zephyr. The maximum error
	 * therefore needs to be calculated based on the configured
	 * frequency (CONFIG_SYS_CLOCK_TICKS_PER_SEC) and 2% error
	 */
