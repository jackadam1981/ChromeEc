...
{
	zassert_equal(test_ram_lock_config_lock_region_invalid_addr(), EC_SUCCESS);
	zassert_equal(test_ram_lock_config_lock_region_invalid_size(), EC_SUCCESS);
...
static void (*test_steps[])(void) = { test_step1_ram_lock, test_step2_ram_lock, test_step3_ram_lock };
