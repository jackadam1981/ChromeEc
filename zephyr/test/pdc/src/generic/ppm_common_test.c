 ...
 */
ZTEST_EXPECT_SKIP(ppm_common_test, test_PROCESSING_busy_rejects_commands);
ZTEST_USER_F(ppm_common_test, test_PROCESSING_busy_rejects_commands)
{
 ...
 */
ZTEST_EXPECT_SKIP(ppm_common_test, test_PROCESSING_busy_allows_cancel_command);
ZTEST_USER_F(ppm_common_test, test_PROCESSING_busy_allows_cancel_command)
{
 ...
 */
ZTEST_USER_F(ppm_common_test, test_CIACK_ack_immediately_or_later)
{
	ppm_initialize_to_idle_notify(fixture);
	int notified_count = fixture->notified_count;
 ...
 * Indication.
 */
ZTEST_USER_F(ppm_common_test, test_CIACK_fail_if_no_active_connector_indication)
{
	ppm_initialize_to_idle_notify(fixture);
	int notified_count = fixture->notified_count;
 ...
 */
ZTEST_F(ppm_common_test, test_lpm_error_accepts_new_command)
{
	ppm_initialize_to_idle_notify(fixture);
	int notified_count = fixture->notified_count;
