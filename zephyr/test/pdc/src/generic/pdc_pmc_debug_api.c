...
ZTEST_USER(pdc_pmc_debug_api, test_usb_connection)
{
	...
	connector_status.conn_partner_flags = 1;
	...
	zassert_true(status.usb2 == connector_status.conn_partner_flags);
	zassert_true(status.usb3_2 == connector_status.conn_partner_flags);
