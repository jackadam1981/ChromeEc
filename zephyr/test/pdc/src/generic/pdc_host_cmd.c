...
// static void host_cmd_pdc_setup(void)
// {
...
ZTEST(host_cmd_pdc, test_ec_cmd_pd_chip_info_v0)
{
	...
	zassert_equal(EC_RES_ERROR, rv, "Got %d, expected %d", EC_RES_ERROR,
		      rv);
	...
	zassert_equal(EC_RES_SUCCESS, rv, "Got %d, expected %d", EC_RES_SUCCESS,
		      rv);
