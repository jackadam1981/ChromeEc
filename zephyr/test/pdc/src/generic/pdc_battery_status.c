...
static void *pdc_battery_policy_setup(void)
{
...
static void pdc_battery_policy_before(void *data)
{
    emul_pdc_reset(emul);
...
ZTEST_SUITE(pdc_battery_policy, NULL, pdc_battery_policy_setup,
        pdc_battery_policy_before, NULL, NULL);

ZTEST_USER(pdc_battery_policy, test_battery_status_update)
{
...
ZTEST_USER(pdc_battery_policy, test_battery_capability_update)
{
    union connector_status_t connector_status = {};
