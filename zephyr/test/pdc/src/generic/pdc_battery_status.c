...
ZTEST_USER(pdc_battery_status, test_battery_status_update)
{
    ...
    zassert_equal(battery_design_voltage_fake.call_count, 4);
    zassert_equal(battery_remaining_capacity_fake.call_count, 2);
    zassert_equal(battery_status_fake.call_count, 2);
}
