...
FAKE_VOID_FUNC(pdc_trace_msg_req, int, enum pdc_trace_chip_type,
	       const uint8_t *, const int);
FAKE_VOID_FUNC(pdc_trace_msg_resp, int, enum pdc_trace_chip_type,
	       const uint8_t *, const int);
...
static void mock_pdc_trace_msg_req(int port, enum pdc_trace_chip_type msg_type,
...
static void mock_pdc_trace_msg_resp(int port, enum pdc_trace_chip_type msg_type,
				    const uint8_t *buf, const int count)
{
	int pl_size;
