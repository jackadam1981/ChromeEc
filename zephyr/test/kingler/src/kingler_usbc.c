...
static void kingler_usbc_before(void *data)
{
}

static void kingler_usbc_after(void *data)
{
}

ZTEST_RULE(kingler_usbc_reset_rule, kingler_usbc_reset_rule_before, NULL);
ZTEST_SUITE(kingler_usbc, NULL, kingler_usbc_setup, kingler_usbc_before,
	    kingler_usbc_after, NULL);
