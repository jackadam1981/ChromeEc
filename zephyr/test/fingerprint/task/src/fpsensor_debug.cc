...

{
	...
	zassert_equal(upload_pgm_image(frame, 0), EC_ERROR_UNKNOWN);
	zassert_equal(upload_pgm_image(frame, 17), EC_ERROR_UNKNOWN);
	zassert_equal(upload_pgm_image(frame, 24), EC_ERROR_UNKNOWN);
}
...
{
	printk("The value of get_sensor_bpp(): %d", get_sensor_bpp());
