...
ZTEST_USER(fpsensor_finger_presence, test_finger_up_present_then_no_finger_interrupt)
{
	struct ec_params_fp_mode params = {
		.mode = FP_MODE_FINGER_UP,
	};
...
ZTEST_USER(fpsensor_finger_presence, test_finger_up_present_then_no_finger_no_interrupt)
{
	struct ec_params_fp_mode params = {
		.mode = FP_MODE_FINGER_UP,
	};
...
ZTEST_USER(fpsensor_finger_presence, test_finger_up_present_then_partial_no_interrupt)
{
	struct ec_params_fp_mode params = {
		.mode = FP_MODE_FINGER_UP,
	};
...
ZTEST_USER(fpsensor_finger_presence, test_finger_up_partial_then_no_finger_no_interrupt)
{
	struct ec_params_fp_mode params = {
		.mode = FP_MODE_FINGER_UP,
	};
...
ZTEST_SUITE(fpsensor_finger_presence, NULL, fpsensor_setup, fpsensor_before, NULL, NULL);
