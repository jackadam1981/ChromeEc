...
#define ELAN80SG_IMAGE_FRAME_PARAM_INITIALIZER(idx, node_id)                \
	{                                                                   \
...
static const struct fingerprint_image_frame_params
	expected_image_frame_params_array[] = { LISTIFY(
		NUM_IMAGE_CAPTURE_TYPES, ELAN80SG_IMAGE_FRAME_PARAM_INITIALIZER,
...
ZTEST_F(elan80sg, test_pal_oops_on_memory_alloc_fail)
{
	...
	elan80sg_pal_malloc(CONFIG_FINGERPRINT_SENSOR_ELAN80SERIES_HEAP_SIZE);
