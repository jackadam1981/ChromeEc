...
ZTEST_F(fpc1145, test_fingerprint_acquire_image_small_image_buf_size)
{
	uint8_t buffer[4] = { 0 };
...
ZTEST_F(fpc1145, test_fingerprint_acquire_image_wrong_capture_mode)
{
	uint8_t buffer[4] = { 0 };
...
ZTEST_F(fpc1145, test_fingerprint_acquire_image_no_private_driver)
{
	uint8_t buffer[4] = { 0 };
	size_t image_buf_size = CONFIG_FINGERPRINT_SENSOR_IMAGE_SIZE;
	int mode = FINGERPRINT_CAPTURE_TYPE_VENDOR_FORMAT;
