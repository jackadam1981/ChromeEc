...
__no_optimization static void test_strtoull(void)
{
	...
	/* This doesn't work as expected on posix. */
...
ZTEST(stdlib, test_memmove)
{
	...
	/* Do not compare time for aligned and unligned access, because it is
	 * required that the alligned access has to be faster.
	 */
