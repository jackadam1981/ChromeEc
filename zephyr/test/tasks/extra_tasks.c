...
ZTEST_USER(extra_tasks, test_main_thread_to_task_mapping)
{
...
ZTEST_USER(extra_tasks, test_sysworkq_thread_to_task_mapping)
{
...
ZTEST_USER(extra_tasks, test_idle_thread_to_task_mapping)
{
	k_tid_t idle_thread;
