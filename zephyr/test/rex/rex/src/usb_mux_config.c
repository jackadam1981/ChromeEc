...
int mock_cros_cbi_get_fw_config_no_usb_db(
	enum cbi_fw_config_field_id field_id, uint32_t *value)
{
	*value = FW_IO_DB_NOT_CONNECTED;
	return 0;
}
...
{
	cros_cbi_get_fw_config_fake.custom_fake = mock_cros_cbi_get_fw_config_no_usb_db;
...
{
	cros_cbi_get_fw_config_fake.custom_fake = mock_cros_cbi_get_fw_config_error;
