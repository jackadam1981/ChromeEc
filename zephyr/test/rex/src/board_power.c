...
DECLARE_FAKE_VALUE_FUNC(int, power_wait_mask_signals_timeout, power_signal_mask_t,
				    power_signal_mask_t, int);
DEFINE_FAKE_VALUE_FUNC(int, power_wait_mask_signals_timeout, power_signal_mask_t,
				    power_signal_mask_t, int);
...
{
	power_signal_set_fake.custom_fake = mock_power_signal_set_ap_force_shutdown;
	power_signal_get_fake.custom_fake = mock_power_signal_get_ap_force_shutdown;
...
{
	power_signal_set_fake.custom_fake = mock_power_signal_set_ap_force_shutdown;
	power_signal_get_fake.custom_fake = mock_power_signal_get_ap_force_shutdown_retries;
	...
	zassert_equal(2, power_signal_set_fake.call_count);
	zassert_true((end_ms - start_ms) >= X86_NON_DSX_MTL_FORCE_SHUTDOWN_TO_MS);
	zassert_true(2 < power_signal_get_fake.call_count);
}

ZTEST_USER(board_power, test_board_ap_power_check_power_rails_enabled_0)
{
	power_signal_get_fake.custom_fake = mock_power_signal_get_check_power_rails_enabled_0;
...
{
	power_signal_get_fake.custom_fake = mock_power_signal_get_check_power_rails_enabled_1;
...
{
	power_signal_set_fake.custom_fake = mock_power_signal_set_ap_power_action_g3_s5;
	power_wait_mask_signals_timeout_fake.custom_fake = mock_power_wait_mask_signals_timeout_0;
	ap_power_ev_send_callbacks_fake.custom_fake = mock_ap_power_ev_send_callbacks;
...
{
	power_signal_set_fake.custom_fake = mock_power_signal_set_ap_power_action_g3_s5;
	power_wait_mask_signals_timeout_fake.custom_fake = mock_power_wait_mask_signals_timeout_1;
	ap_power_ev_send_callbacks_fake.custom_fake = mock_ap_power_ev_send_callbacks;

	board_ap_power_action_g3_s5();

	zassert_equal(1, power_signal_set_fake.call_count);
	zassert_equal(0, power_wait_mask_signals_timeout_fake.call_count);
