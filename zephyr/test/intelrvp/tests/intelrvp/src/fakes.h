...
#ifndef ZEPHYR_TEST_MTLRVP_SRC_FAKES_H
#define ZEPHYR_TEST_MTLRVP_SRC_FAKES_H
...
#if defined(CONFIG_TEST_PROJECT_PTLRVPP_MCHP)
...
#endif /* ZEPHYR_TEST_MTLRVP_SRC_FAKES_H */