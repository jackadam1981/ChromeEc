...
/* SSFC field defined in zephyr/projects/nissa/craask/cbi.dts */
#define SSFC_LID_MAIN_SENSOR (0x0)
#define SSFC_LID_ALT_SENSOR (0x1 << 2)

#define SSFC_BASE_MAIN_SENSOR 0x0
#define SSFC_BASE_ALT_SENSOR (0x1 << 4)
