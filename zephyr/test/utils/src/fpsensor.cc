...
ZTEST_SUITE(fpsernsor_utils, NULL, NULL, NULL, NULL, NULL);
...
ZTEST(fpsernsor_utils, test_validate_fp_buffer_offset_success)
{
	zassert_equal(validate_fp_buffer_offset(1, 0, 1), EC_SUCCESS, "%d");
}

ZTEST(fpsernsor_utils, test_validate_fp_buffer_offset_failure_no_overflow)
{
	zassert_equal(validate_fp_buffer_offset(1, 1, 1), EC_ERROR_INVAL, "%d");
}

ZTEST(fpsernsor_utils, test_validate_fp_buffer_offset_failure_overflow)
{
	zassert_equal(validate_fp_buffer_offset(1, UINT32_MAX, 1),
		      EC_ERROR_OVERFLOW, "%d");
}

ZTEST(fpsernsor_utils, test_is_test_capture)
{
...
ZTEST(fpsernsor_utils, test_is_raw_capture)
{
