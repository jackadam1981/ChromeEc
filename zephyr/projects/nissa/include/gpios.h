 ...
 */
extern const struct gpio_dt_spec gpio_sub_alt_1;
...
/*
 * Aliases for alternate pins.
 */
#define gpio_usb_c1_int_odl gpio_sub_alt_1
#define gpio_en_sub_rails_odl gpio_sub_alt_1
