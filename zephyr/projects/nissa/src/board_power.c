...
void board_ap_power_force_shutdown(void)
{
	...
	power_signal_disable_interrupt(PWR_DSW_PWROK);
	power_signal_disable_interrupt(PWR_PG_PP1P05);
	s0_stable = false;
}

void board_ap_power_action_g3_s5(void)
{
	power_signal_enable_interrupt(PWR_DSW_PWROK);
	power_signal_enable_interrupt(PWR_PG_PP1P05);
