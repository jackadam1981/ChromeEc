...
static void set_input_current_extension(void)
{
	...
	reg_read = i2c_read8(chg_chips[chgnum].i2c_port, chg_chips[chgnum].i2c_addr_flags, SM5803_ISO_CL_REG2, &val);
	val |= SM5803_CHG_ILIM_EXTD;
	rv = i2c_write8(chg_chips[chgnum].i2c_port, chg_chips[chgnum].i2c_addr_flags, SM5803_ISO_CL_REG2, val);
