...
static uint16_t villager_scancode_set2[KEYBOARD_COLS_MAX][KEYBOARD_ROWS] = {
    {0x0000, 0x0000, 0x0014, 0xe01f, 0x001c, 0xe007, 0x0000, 0x0000},
...
/* TODO(b/???):  need to verify on rgb keyboard */
static void keyboard_init(void)
{
    register_scancode_set2(villager_scancode_set2, sizeof(villager_scancode_set2));
}
