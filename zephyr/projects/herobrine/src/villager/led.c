 ...
 *
 * Power and battery LED control for Villager
 */
...
__override void led_set_color_battery(enum ec_led_colors color)
{
	...
	case EC_LED_COLOR_AMBER:
		gpio_pin_set_dt(GPIO_DT_FROM_NODELABEL(gpio_ec_chg_led_r_c0),
			LED_ON_LVL);
		gpio_pin_set_dt(GPIO_DT_FROM_NODELABEL(gpio_ec_chg_led_b_c0),
			LED_OFF_LVL);
		break;
