...
int board_anx7483_c0_mux_set(const struct usb_mux *me,
...
int board_anx7483_c1_mux_set(const struct usb_mux *me,
				 mux_state_t mux_state)
{
...
int board_c1_ps8818_mux_set(const struct usb_mux *me,
					  mux_state_t mux_state)
{
