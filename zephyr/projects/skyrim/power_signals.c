...
static void baseboard_set_soc_pgood(void)
{
...
static void baseboard_set_en_pwr_pcore(void)
{
	...
	baseboard_set_soc_pgood();
}

void baseboard_check_pwr_soc_pgood(enum gpio_signal signal)
{
	baseboard_set_soc_pgood();
}

void baseboard_check_pwr_pcore(enum gpio_signal signal)
{
