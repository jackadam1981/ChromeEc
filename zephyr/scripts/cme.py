...
def insert_i2c_component(ctype, node, usbc_port, i2c_portmap, manifest):
    ...
    if not hasattr(node, "parent") or node.parent.name not in i2c_portmap:
        logging.info(
    ...
    # TODO: Check if the name needs to be modified. The compatible may not
    # be the same as the component name.

    # TODO: Add the probe methods if multiple components share the same
    # compatible. These components need to be identified.

    # TODO: Add the SSFC field.
