...
def main(argv: Optional[List[str]] = None) -> Optional[int]:
    ...
    logging.info("*** ITE Debug project_dir %s", args.project_dir)
    logging.info("*** ITE Debug project_name %s", args.project_name)
    logging.info("*** ITE Debug build_dir %s", args.build_dir)
    logging.info("*** ITE Debug version %s", args.version)
    logging.info("*** ITE Debug static_version %s", args.static_version)
