...
FOREACH_COL(DT_INST(0, DT_DRV_COMPAT), DT_COL_CHECK)

static uint16_t scancode_set2[KEYBOARD_COLS_MAX][KEYBOARD_ROWS] = {
	FOREACH_COL(DT_INST(0, DT_DRV_COMPAT), DT_COL)
};
...
#define SET2_CONFIG_COUNT DT_INST_CHILD_NUM(0)

#if SET2_CONFIG_COUNT > 0
