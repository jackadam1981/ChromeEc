...
using TestTransportBase = cros::dsp::service::Transport<
    TestStatus, kTestResponseReadyBit, kTestResponseBufferSize,
    sizeof(TestStatus), decltype(TestStatus::flags), &TestStatus::flags,
    decltype(TestStatus::response_length), &TestStatus::response_length>;
