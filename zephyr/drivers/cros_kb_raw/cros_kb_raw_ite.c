...
#include <assert.h>
/* include <dt-bindings/clock/ite_clock.h> */
#include <drivers/cros_kb_raw.h>
#include <drivers/clock_control.h>
#include <drivers/gpio.h>
#include <kernel.h>
#include <soc.h>
/* include <soc/ite/reg_def_cros.h> */
...
#define IT83XX_IRQ_WKINTC 13 /* or use config->irq */
					    ...
					    int enable)
{
	...
	if (enable) {
		...
		ite_intc_isr_clear(IT83XX_IRQ_WKINTC);
		irq_enable(IT83XX_IRQ_WKINTC);
	} else
		irq_disable(IT83XX_IRQ_WKINTC);
