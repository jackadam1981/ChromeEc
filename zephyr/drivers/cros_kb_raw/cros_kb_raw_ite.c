...
static void cros_kb_raw_ite_ksi_isr(const struct device *dev)
{
	...
	/*
	 * We clear irq status in ite_intc_irq_handler(),
	 * after interrupt was fired.
	 */
