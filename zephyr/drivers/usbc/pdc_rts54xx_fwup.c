...
int pdc_rts54xx_fwup_start(const struct device *dev)
{
...
int pdc_rts54xx_fwup_write(uint8_t *buffer, size_t buffer_len)
{
...
int pdc_rts54xx_fwup_finish(void)
{
	int rv;
...
int pdc_rts54xx_fwup_abort(void)
{
	int rv;
