...
SHELL_STATIC_SUBCMD_SET_CREATE(
	...
	SHELL_CMD_ARG(stream, NULL,
		      SHELL_HELP("Stream data for TFUi or TFUd after sending the command",
				 "<base64>"),
		      cmd_pdc_tps_fwup_stream, 2, 0),
	SHELL_CMD_ARG(complete, NULL,
		      SHELL_HELP("Finalize the FW update and restart PD subsystem", NULL),
		      cmd_pdc_tps_fwup_complete, 1, 0),
	SHELL_CMD_ARG(abort, NULL,
		      SHELL_HELP("Recover from a failed or interrupted update session", NULL),
