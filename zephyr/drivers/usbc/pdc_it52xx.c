...
static enum smf_state_result st_init_run(void *o)
{
	...
	case INIT_PDC_GET_IC_STATUS: /* TODO: */
				     ...
				     /* 2. get pdc_info_t data by UCSI cmd VDM (it5271 add support) (LPM_PPM info not enough data)? after set PPM_RESET? */
	...
	case INIT_PDC_RESET:
		...
		return SMF_EVENT_HANDLED;
	case INIT_PDC_SET_NOTIFICATION_ENABLE: /* change ppm reset -> set ntf (spec), it5271 ignore cmd that prior ppm_reset */
