...
#if 0 //not ucsi cmd, it5271 not support, Notify the PDC of the current AP power state and then?
...
#if 0 //not ucsi cmd, it5271 not support, set it5271 DRP/ trysrc DRP (default)/ trysnk DRP
...
static DEVICE_API(pdc, pdc_driver_api) = {
	...
	//.set_drp_mode = it52xx_set_drp_mode, //not ucsi cmd, it5271 not support
	.get_drp_mode = it52xx_get_drp_mode, //not ucsi cmd, it5271 not support
	...
	.get_current_pdo = it52xx_get_current_pdo, //not ucsi cmd, it5271 not support
	...
	.set_frs = it52xx_set_frs, //not ucsi cmd, it5271 not support
	...
	//.set_ap_power_state = it52xx_set_ap_power_state, //not ucsi cmd, it5271 not support, what purpose & need support?
};
