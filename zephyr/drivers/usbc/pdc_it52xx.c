...
static DEVICE_API(pdc, pdc_driver_api) = {
	...
	.get_rdo = it52xx_get_rdo, //not ucsi cmd, support by [CONTROL] VDM
	.set_rdo = it52xx_set_rdo, //not ucsi cmd, support by [CONTROL] VDM
	...
	.read_power_level = it52xx_read_power_level, //mgmt api not done
