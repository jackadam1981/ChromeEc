...
static const struct smbus_cmd_t SET_PDO = { 0x81, 0x08, 0x10 };
...
static int it52xx_i2c_write(const struct device *dev)
{
	...
	//if i2c needs second transmission for MSGOUT
...
static enum smf_state_result st_init_run(void *o)
{
	...
	case INIT_PDC_GET_IC_STATUS: /* TODO: */
		...
		return SMF_EVENT_HANDLED;
	case INIT_PDC_SET_NOTIFICATION_ENABLE: /* can notify first -> ppm reset? yes */
