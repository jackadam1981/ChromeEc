...
static int
intel_pd_controller_emul_set_connect_orient(const struct emul *target,
...
static int intel_pd_controller_emul_set_usb3_2_speed(const struct emul *target,
						     const uint8_t speed)
{
	struct intel_pd_controller_emul_data *data = target->data;
...
static int intel_pd_controller_emul_set_reg_value(const struct emul *target,
						  uint16_t reg,
						  const uint8_t *value,
						  const uint8_t len)
{
