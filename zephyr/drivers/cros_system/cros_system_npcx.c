...
#if DT_NODE_HAS_PROP(SYSTEM_DT_NODE_HIBERNATE_CONFIG, wakeup_gpios)
...
#endif /* DT_NODE_HAS_PROP(SYSTEM_DT_NODE_HIBERNATE_CONFIG, wakeup_gpios) */
#endif /* DT_NODE_EXISTS(SYSTEM_DT_NODE_HIBERNATE_CONFIG) */
}
