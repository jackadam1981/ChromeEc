...
#define ALT_LABEL0 DT_PHANDLE(DT_NODELABEL(pinctrl_shi_mosi), pinctrls)
#define ALT_LABEL1 DT_PHANDLE(DT_NODELABEL(pinctrl_shi_miso), pinctrls)
#define ALT_LABEL2 DT_PHANDLE(DT_NODELABEL(pinctrl_shi_clk), pinctrls)
#define ALT_LABEL3 DT_PHANDLE(DT_NODELABEL(pinctrl_shi_cs), pinctrls)

#define DEV_PINMUX(idx)     DEVICE_DT_GET(ALT_LABEL##idx)
