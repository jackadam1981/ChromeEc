...
#define SENSOR_ATTR_UPPER_VOLTAGE_THRESH 0
#define SENSOR_ATTR_LOWER_VOLTAGE_THRESH 1
#endif
...
#define TH_HIGH_PERCENT 90
#define TH_LOW_PERCENT 10
				 ...
				 const struct sensor_trigger *trigger)
{
	...
	LOG_INF("PROCHOT state: %sasserted", data->last_state ? "" : "de");
}
