...
#define PI2USB9201_DEFINE(inst)                                              \
	...
	static const struct pi3usb9201_config pi3usb9201_config_##inst = {   \
		...
		.intb_gpio =                                                 \
			GPIO_DT_SPEC_INST_GET_OR(inst, intb_gpios, { 0 }),   \
		.enable_gpio =                                               \
