...
BUILD_ASSERT(FINGERPRINT_SENSOR_LOW_IMAGE_QUALITY ==
	     FPC_SENSOR_LOW_IMAGE_QUALITY);
BUILD_ASSERT(FINGERPRINT_SENSOR_TOO_FAST == FPC_SENSOR_TOO_FAST);
BUILD_ASSERT(FINGERPRINT_SENSOR_LOW_SENSOR_COVERAGE == FPC_SENSOR_LOW_COVERAGE);
...
BUILD_ASSERT(FINGER_STATE_NONE == FPC_FINGER_NONE);
BUILD_ASSERT(FINGER_STATE_PARTIAL == FPC_FINGER_PARTIAL);
BUILD_ASSERT(FINGER_STATE_PRESENT == FPC_FINGER_PRESENT);
