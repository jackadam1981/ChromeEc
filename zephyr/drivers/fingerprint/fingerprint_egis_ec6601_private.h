...
#ifndef ZEPHYR_DRIVERS_FINGERPRINT_EGIS_EC6601_PRIVATE_H_
#define ZEPHYR_DRIVERS_FINGERPRINT_EGIS_EC6601_PRIVATE_H_

#include <stdint.h>

/* EGIS type which keeps sensor specific information. */
struct egis_bep_sensor;

/* Declare EC6601 sensor specific information. */
extern const struct egis_bep_sensor egis_bep_sensor_6601g175;

struct egis_sensor_info {
	const struct egis_bep_sensor *sensor;
...
#endif /* ZEPHYR_DRIVERS_FINGERPRINT_EGIS_EC6601_PRIVATE_H_ */
