...
/******************************************************************************************************************
*NAME               :   focal_algo_enroll_by_feature

* INPUT				:	feature	        : finger feature (curr
input) :	enroll_num	    : enrolled times :	finger_template	: finger
template
...
/******************************************************************************************************************
*NAME               :   focal_algo_verify_by_feature
...
int focal_algo_verify_by_feature(uint8_t *feature, uint8_t *finger_template,
				 uint8_t *update_flag);
/******************************************************************************************************************
*NAME               :   focal_algo_update_template_by_feature
*INPUT              :   feature          : the feature data need to update
					:	finger_template       : the
template need to be update to *OUTPUT             :   0               : ok -1 :
memory error -2              : not reach the threshold of update -3 : update
function not enabled -4              : the template read error -5              :
the template not study fully *FUNCTION           :   template update
*******************************************************************************************************************/
