...
LOG_MODULE_REGISTER(egis_ec6601_pal, LOG_LEVEL_INF);
...
K_HEAP_DEFINE(fp_driver_heap, CONFIG_FINGERPRINT_SENSOR_EGIS_EC6601_HEAP_SIZE);
...
{
	int err = 0;
	const struct ec6601_cfg *cfg = fp_sensor_dev->config;
