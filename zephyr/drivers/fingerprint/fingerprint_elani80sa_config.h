...
#define BASE_IMAGE_ADDR DT_PROP(DT_NODELABEL(fp_sensor), base_image_addr)

/* Read-only Ft Info address in internal flash */
#define FT_INFO_ADDR DT_PROP(DT_NODELABEL(fp_sensor), ft_info_addr)
