...
void __unused set_debug_log_callback(event_callback_t event_callback);
#endif
 ...
 *
 */
static __unused inline void PLAT_FREE(void **x)
{
 ...
 * @return Pointer to the allocated memory or NULL if the allocation failed.
 */
static __unused inline void *plat_alloc(size_t size)
{
