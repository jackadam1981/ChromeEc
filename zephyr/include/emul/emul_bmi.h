 ...
 */
typedef int (*bmi_emul_read_func)(struct i2c_emul *emul, int reg, void *data);
 ...
 * @return negative on error
 */
typedef int (*bmi_emul_write_func)(struct i2c_emul *emul, int reg, uint8_t val,
				   void *data);
 ...
 */
void bmi_emul_set_acc(struct i2c_emul *emul, int axis, int16_t val);
