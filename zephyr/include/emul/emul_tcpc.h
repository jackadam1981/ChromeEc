 ...
 *
 * - call @ref tcpc_emul_set_reg and @ref tcpc_emul_get_reg to set and get value
 *   of TCPC registers
 ...
 */
typedef void (*tcpc_emul_alert_state_func)(const struct emul *emul, bool alert,
					   void *data);
...
/** Revisions supported by TCPC emaluator */
enum tcpc_emul_rev {
	TCPC_EMUL_REV1_0_VER1_0 = 0,
	TCPC_EMUL_REV2_0_VER1_1
};

/** TCPC specific device operations. Not all of them need to be implemented. */
...
/** TCPC partner operations. Not all of them need to be implemented. */
