...
struct tcpci_partner_extension_ops {
	 ...
	 *        @ref tcpci_emul_connect_partner
	 *        TODO: There should be probably some tcpci_partner_connect
	 *              function for extension to call instead of directly
	 *              operating on tcpci_emul
	 *
	 * @param ext Pointer to partner extension
	 * @param common_data Pointer to TCPCI partner emulator
	 * @param tcpci_emul Pointer to emulator to which partner will be connected
	 *
