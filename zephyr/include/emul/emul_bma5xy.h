...
#ifndef ZEPHYR_INCLUDE_EMUL_EMUL_BMA5XY_H_
#define ZEPHYR_INCLUDE_EMUL_EMUL_BMA5XY_H_

#include <zephyr/drivers/emul.h>
#include <zephyr/drivers/i2c_emul.h>

/** Reset the state of the provided bma5xy emulator. */
...
void bma5xy_emul_get_offset(const struct emul *emul, int16_t (*offset)[3]);
...
emul_bma5xy_get_i2c_common_data(const struct emul *emul);

#endif /* ZEPHYR_INCLUDE_EMUL_EMUL_BMA5XY_H_ */