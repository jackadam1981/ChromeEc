...
typedef int (*emul_pdc_set_battery_capability_t)(
	const struct emul *target, const union battery_capability_t *bcap);
typedef int (*emul_pdc_set_battery_status_t)(
	const struct emul *target, const union battery_status_t *bstat);
