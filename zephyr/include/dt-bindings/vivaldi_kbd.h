...
#define VIVALDI_CAP_STRAUSS                                                 \
	(VIVALDI_KEYBD_CAP_FUNCTION_KEYS | VIVALDI_KEYBD_CAP_SCRNLOCK_KEY | \
	 VIVALDI_KEYBD_CAP_ASSISTANT_KEY)

#define VIVALDI_CAP_STRAUSS_NUMERIC_KEYPAD \
	(VIVALDI_CAP_STRAUSS | VIVALDI_KEYBD_CAP_NUMERIC_KEYPAD)
