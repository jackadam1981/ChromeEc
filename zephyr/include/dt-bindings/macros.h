...
#define _BINARY2(b1, b0) (((b1) << 1) | _BINARY1(b0))
#define _BINARY3(b2, b1, b0) (((b2) << 2) | _BINARY2(b1, b0))
#define _BINARY4(b3, b2, b1, b0) (((b3) << 3) | _BINARY3(b2, b1, b0))
#define _BINARY5(b4, b3, b2, b1, b0) (((b4) << 4) | _BINARY4(b3, b2, b1, b0))
