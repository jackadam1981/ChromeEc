...
#define _BINARY1(b0) \
	(b0)
#define _BINARY2(b1, b0) \
	(((b1) << 1) | _BINARY1(b0))
#define _BINARY3(b2, b1, b0) \
	(((b2) << 2) | _BINARY2(b1, b0))
#define _BINARY4(b3, b2, b1, b0) \
	(((b3) << 3) | _BINARY3(b2, b1, b0))
#define _BINARY5(b4, b3, b2, b1, b0) \
	(((b4) << 4) | _BINARY4(b3, b2, b1, b0))
#define _BINARY6(b5, b4, b3, b2, b1, b0) \
	(((b5) << 5) | _BINARY5(b4, b3, b2, b1, b0))
#define _BINARY7(b6, b5, b4, b3, b2, b1, b0) \
	(((b6) << 6) | _BINARY6(b5, b4, b3, b2, b1, b0))
#define _BINARY8(b7, b6, b5, b4, b3, b2, b1, b0) \
	(((b7) << 7) | _BINARY7(b6, b5, b4, b3, b2, b1, b0))
 ...
 *
 * The Device Tree Compiler (dtc) lacks support for binary literals (e.g., 0b110).
 * This macro is a helper to achieve this functionality.
 * For example, BINARY(1, 1, 0) is equivalent to 0b110, which is 6.
 */
