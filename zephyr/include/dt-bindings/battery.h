...
/* Battery status */
#define SB_STATUS_ERR_CODE_MASK 0xf
#define SB_STATUS_CODE_OK 0
#define SB_STATUS_CODE_BUSY 1
#define SB_STATUS_CODE_RESERVED 2
#define SB_STATUS_CODE_UNSUPPORTED 3
#define SB_STATUS_CODE_ACCESS_DENIED 4
#define SB_STATUS_CODE_OVERUNDERFLOW 5
#define SB_STATUS_CODE_BADSIZE 6
#define SB_STATUS_CODE_UNKNOWN_ERROR 7
