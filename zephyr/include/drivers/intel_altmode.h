...
#define INTEL_ALTMODE_DATA_STATUS_REG_LEN \
	CONFIG_USBC_INTEL_ALTMODE_STATUS_REG_LENGTH
...
#define INTEL_ALTMODE_DATA_CONTROL_REG_LEN \
	CONFIG_USBC_INTEL_ALTMODE_CONTROL_REG_LENGTH
