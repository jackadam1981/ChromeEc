 ...
 *
 * @param dev Pointer to tz_impl_cros_kb_raw_enable_interrupthe device structure
 * for the keyboard driver instance.
 ...
 *
 * @param dev Pointer to tz_impl_cros_kb_raw_config_alt device structure for the
