 ...
 * GPIO module. Use the presence of the alias node "gpio-kbd-kso2" to determne
...
/**
 * @brief Set the physical value of the keyboard column 2 outpu.
 *
 * When CONFIG_PLATFORM_EC_KEYBOARD_COL2_INVERTED is enabled, the keyboard
...
static inline void cros_kb_raw_set_col2(int value)
{
	...
	const struct gpio_dt_spec *kbd_dt_spec =
		GPIO_DT_FROM_ALIAS(gpio_kbd_kso2);
