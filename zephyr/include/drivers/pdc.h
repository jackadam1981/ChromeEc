...
/**
 * Extract the 16-bit VID or PID from the 32-bit container returned by
 * `pdc_get_vid_pid_t`
 */
...
/**
 * Extract the major, minor, and patch elements from a 32-bit version returned
 * by `pdc_get_fw_version_t`
 */
