...
#ifndef ZEPHYR_INCLUDE_DRIVERS_CROS_FINGERPRINT_H_
#define ZEPHYR_INCLUDE_DRIVERS_CROS_FINGERPRINT_H_
...
/**
 * @typedef fingerprint_set_mode_api
 * @brief Callback API for changing fingerprint sensor mode.
 * @param dev Fingerprint sensor device.
 * @param mode Fingerprint sensor mode.
 */
typedef int (*fingerprint_set_mode_api)(const struct device *dev,
...
__subsystem struct fingerprint_driver_api {
	...
	fingerprint_set_mode_api set_mode;
...
#endif /* ZEPHYR_INCLUDE_DRIVERS_CROS_FINGERPRINT_H_ */
