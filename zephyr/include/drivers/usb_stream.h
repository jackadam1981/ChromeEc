...
void usb_written_usb_i2c(struct consumer const *consumer, size_t count);

__maybe_unused static void usb_stream_written(struct consumer const *consumer,
					      size_t count)
{
...
extern const struct usb_stream_config usb_i2c;
