...
enum system_reset_cause {
	/* the reset is triggerred by VCC power-up */
	POWERUP = 0,
	/* the reset is triggerred by external VCC1 reset pin */
	VCC1_RST_PIN = 1,
	/* the reset is triggerred by ICE debug reset request */
	DEBUG_RST = 2,
	/* the reset is triggerred by watchdog */
	WATCHDOG_RST = 3,
	/* unknown reset type */
	UNKNOWN_RST,
};
