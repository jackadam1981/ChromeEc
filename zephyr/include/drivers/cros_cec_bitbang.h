 ...
 */
static inline void cros_cec_bitbang_tmr_cap_start(const struct device *dev,
						  int port,
						  enum cec_cap_edge edge,
						  int timeout)
{
 ...
 * @retval -ENOTSUP Not supported api function.
 */
static inline void cros_cec_bitbang_tmr_cap_stop(const struct device *dev,
						 int port)
{
	const struct cros_cec_bitbang_driver_api *api =
		(const struct cros_cec_bitbang_driver_api *)dev->api;
 ...
 */
static inline int cros_cec_bitbang_tmr_cap_get(const struct device *dev,
					       int port)
{
	const struct cros_cec_bitbang_driver_api *api =
		(const struct cros_cec_bitbang_driver_api *)dev->api;
 ...
 * @retval -ENOTSUP Not supported api function.
 */
static inline void cros_cec_bitbang_debounce_enable(const struct device *dev,
						    int port)
{
	const struct cros_cec_bitbang_driver_api *api =
		(const struct cros_cec_bitbang_driver_api *)dev->api;
 ...
 * @retval -ENOTSUP Not supported api function.
 */
static inline void cros_cec_bitbang_debounce_disable(const struct device *dev,
						     int port)
{
	const struct cros_cec_bitbang_driver_api *api =
		(const struct cros_cec_bitbang_driver_api *)dev->api;
 ...
 * @retval -ENOTSUP Not supported api function.
 */
static inline void cros_cec_bitbang_trigger_send(const struct device *dev,
						 int port)
{
	const struct cros_cec_bitbang_driver_api *api =
		(const struct cros_cec_bitbang_driver_api *)dev->api;
 ...
 * @retval -ENOTSUP Not supported api function.
 */
static inline void cros_cec_bitbang_enable_timer(const struct device *dev,
						 int port)
{
	const struct cros_cec_bitbang_driver_api *api =
		(const struct cros_cec_bitbang_driver_api *)dev->api;
 ...
 * @retval -ENOTSUP Not supported api function.
 */
static inline void cros_cec_bitbang_disable_timer(const struct device *dev,
						  int port)
{
	const struct cros_cec_bitbang_driver_api *api =
		(const struct cros_cec_bitbang_driver_api *)dev->api;
 ...
 * @retval -ENOTSUP Not supported api function.
 */
static inline void cros_cec_bitbang_init_timer(const struct device *dev,
					       int port)
{
	const struct cros_cec_bitbang_driver_api *api =
		(const struct cros_cec_bitbang_driver_api *)dev->api;
