...
/**
 * @brief Get size of raw fingerprint image (in bytes) for a given configuration
 * index.
 *
 ...
 * @return Size of the raw image in bytes.
 */
 ...
 * sensor.
 */
#define FINGERPRINT_SENSOR_NUM_CAPTURE_TYPES(node_id) \
	DT_PROP_LEN(node_id, width)
 ...
 *
 * This structure holds information that generally does not change after
