...
/* TODO:
 * Currently the `NAME` used in USB_STREAM_CONFIG_FULL macro is hard-coded here.
 * Need a better way to pass the queues between usb_update and
 * one_wire_uart_module.
 */
