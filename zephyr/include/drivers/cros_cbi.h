 ...
 */
#define CBI_FW_CONFIG_ENUM_LIST(node) \
	DT_FOREACH_CHILD_STATUS_OKAY(node, CBI_FW_CONFIG_ENUM_WITH_COMMA)

/*
 * Generate a list of enum entries with a value assigned.
 */
#define CBI_FW_CONFIG_ENUM_VALUE_LIST(node) \
	DT_FOREACH_CHILD_STATUS_OKAY(node, CBI_FW_CONFIG_ENUM_WITH_VALUE)
