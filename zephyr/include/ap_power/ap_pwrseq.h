...
enum ap_pwrseq_state {
	AP_POWER_STATE_PG3, /* EC and AP are OFF */
 ...
 * @retval None.
 **/
void ap_pwrseq_task_start(const struct device *dev);
 ...
 *
 * Callback funciotn will be executed by AP power sequence driver when exiting
 * selected state.
 *
 * @param dev Pointer of AP power sequence device driver.
 *
 ...
 * @brief Register callback into AP power sequence driver.
 *
 * Callback funciotn will be executed by AP power sequence driver when entering
 * into selected state.
 *
 * @param dev Pointer of AP power sequence device driver.
 *
