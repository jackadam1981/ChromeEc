...
/* Set what role the partner is right now, for the PPC module */
 ...
 */
static void tc_snk_attached_debug_accessory_snk_entry(const int port)
{
	enum tcpc_cc_voltage_status cc1, cc2;
	...
	/* Inform the PPC module that a source is connected */
...
static void tc_snk_attached_debug_accessory_snk_run(const int port)
{
	/* Detach detection */
...
static void tc_snk_attached_debug_accessory_snk_exit(const int port)
{
	/*
