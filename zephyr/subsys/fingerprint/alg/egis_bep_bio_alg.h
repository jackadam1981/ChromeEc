 ...
 */
typedef struct egis_bep_algorithm egis_bep_algorithm_t;
/*
 * Struct with biometric algorithm information.
 */
typedef struct {
	const egis_bep_algorithm_t *algorithm;
...
/* Declaration of EC6601 algorithm. */
extern const egis_bep_algorithm_t egis_bep_algorithm_pfe_6601g175_as;
