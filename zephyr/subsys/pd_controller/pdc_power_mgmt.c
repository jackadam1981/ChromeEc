...
int pdc_power_mgmt_get_bus_info(int port, struct pdc_hw_config_t *pdc_hw_config)
{
	...
	return pdc_get_bus_info(pdc_data[port]->port.pdc, pdc_hw_config);
}
...
int pdc_power_mgmt_get_ccd_port(void)
{
	...
	for (int i = 0; i < pdc_power_mgmt_get_usb_pd_port_count(); i++) {
		...
		pdc_power_mgmt_get_bus_info(i, &pdc_hw_config);
