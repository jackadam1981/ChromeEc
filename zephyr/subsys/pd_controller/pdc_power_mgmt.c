...
#define PDC_SUBSYS_INIT(inst)                                                  \
	...
	static struct pdc_data_t data_##inst = {                               \
		...
		.port.board_unattach_cb = DT_STRING_TOKEN(                     \
			DT_INST_PROP(inst, policy), board_unattach_cb),        \
		.port.board_dp_attention_cb = DT_STRING_TOKEN(                 \
			DT_INST_PROP(inst, policy), board_dp_attention_cb),    \
