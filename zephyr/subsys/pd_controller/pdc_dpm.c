...
__overridable int get_board_3a_ports(void)
{
#ifdef CONFIG_PLATFORM_EC_USB_PD_3A_PORTS_CUSTOM
	BUILD_ASSERT(0, "Board must implement get_board_3a_ports()");
#endif
	return CONFIG_PLATFORM_EC_USB_PD_3A_PORTS;
}
