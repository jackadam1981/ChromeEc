...
static const struct chipset_pwrseq_config chip_cfg = {
	...
	.vccst_pwrgd_od = PWRSEQ_GPIO_DT_SPEC_GET(vccst_pwrgd_od_gpios),
	.imvp9_vrrdy_od = PWRSEQ_GPIO_DT_SPEC_GET(imvp9_vrrdy_od_gpios),
	.pch_pwrok = PWRSEQ_GPIO_DT_SPEC_GET(pch_pwrok_gpios),
	.ec_pch_sys_pwrok = PWRSEQ_GPIO_DT_SPEC_GET(ec_pch_sys_pwrok_gpios),
 ...
 */
__attribute__((weak)) int all_sys_pwrgd_handler(void)
{
	int sys_pg;
	int vccst_pg;
	int retry = 0;
