...
DECLARE_CONSOLE_COMMAND(slp_s0_debug_alarm, console_command_slp_s0_debug_alarm,
			"[seconds]", "slp s0 debug alarm");
#endif
...
{
#ifdef CONFIG_SLPS0_DEBUG
	ccprintf("Detected sleep hang cancel the slp_s0_debug_alarm"
