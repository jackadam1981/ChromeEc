...
ap_pwrseq_sm_init_func __weak init_func = NULL;

ap_pwrseq_sm_get_init_state __weak get_init_state_func = NULL;
			   ...
			   enum ap_pwrseq_state state)
{
	...
	data->entry_handled = data->exit_handled = false;
