...
{
	return power_has_signals(IN_PCH_SLP_S3_DEASSERTED) &&
	       gpio_get_lvl(GPIO_NET_NAME(EC_OUT_ALL_SYS_PWRGD)) &&
	       pp1p05_pgood;
}

int power_signal_gpio_is_asserted(const struct power_signal_info *s)
{
