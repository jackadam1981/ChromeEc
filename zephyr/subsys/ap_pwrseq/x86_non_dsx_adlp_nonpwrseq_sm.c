...
#define  X86_NON_DSX_ADLP_NONPWRSEQ_FORCE_STHUTDOWN_TO_MS	5
...
{
	int timeout_ms = X86_NON_DSX_ADLP_NONPWRSEQ_FORCE_STHUTDOWN_TO_MS;
	...
	timeout_ms = X86_NON_DSX_ADLP_NONPWRSEQ_FORCE_STHUTDOWN_TO_MS;
