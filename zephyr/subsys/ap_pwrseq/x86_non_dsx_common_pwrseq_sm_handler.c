...
static const struct common_pwrseq_config com_cfg = {
	...
	.enable_pp5000_a = PWRSEQ_GPIO_DT_SPEC_GET(en_pp5000_s5_gpios),
#endif
#if PWRSEQ_GPIO_PRESENT(en_pp3300_s5_gpios)
	.enable_pp3300_a = PWRSEQ_GPIO_DT_SPEC_GET(en_pp3300_s5_gpios),
#endif
	.pg_ec_rsmrst_odl = PWRSEQ_GPIO_DT_SPEC_GET(pg_ec_rsmrst_odl_gpios),
	.ec_pch_rsmrst_odl = PWRSEQ_GPIO_DT_SPEC_GET(ec_pch_rsmrst_odl_gpios),
#if PWRSEQ_GPIO_PRESENT(pg_ec_dsw_pwrok_gpios)
	.pg_ec_dsw_pwrok = PWRSEQ_GPIO_DT_SPEC_GET(pg_ec_dsw_pwrok_gpios),
#endif
#if PWRSEQ_GPIO_PRESENT(ec_soc_dsw_pwrok_gpios)
	.ec_soc_dsw_pwrok = PWRSEQ_GPIO_DT_SPEC_GET(ec_soc_dsw_pwrok_gpios),
#endif
	.slp_s3_l = PWRSEQ_GPIO_DT_SPEC_GET(slp_s3_l_gpios),
	.all_sys_pwrgd = PWRSEQ_GPIO_DT_SPEC_GET(pg_ec_all_sys_pwrgd_gpios),
	.slp_sus_l = PWRSEQ_GPIO_DT_SPEC_GET(slp_sus_l_gpios),
};
...
{
	return gpio_pin_get_raw(s->int_config.port, s->int_config.pin) ==
