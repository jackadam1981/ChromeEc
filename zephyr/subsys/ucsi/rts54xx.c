...
#define DT_DRV_COMPAT ucsi_pdc_driver
...
#define DT_RTS54XX DT_INST(0, ucsi_pdc_driver)
#define NUM_PORTS DT_PROP_LEN(DT_RTS54XX, pdc)
...
static struct rts5453_device rts54xx_dev = {
	.pdc = { DT_FOREACH_PROP_ELEM(DT_RTS54XX, pdc, PHANDLE_TO_DEV) },
};
