...
#define USB_GDUMMY_DEVICE_COUNT 0
...
#define USB_GDUMMY_DEVICE_COUNT 2
#else
/* Keyboard or touchpad devices are both disabled in RW firmware */
#define USB_GDUMMY_DEVICE_COUNT 1
#endif
...
LISTIFY(USB_GDUMMY_DEVICE_COUNT, DEFINE_GDUMMY_DESCR, (;), _);
LISTIFY(USB_GDUMMY_DEVICE_COUNT, DEFINE_GDUMMY_EP, (;), _);
LISTIFY(USB_GDUMMY_DEVICE_COUNT, DEFINE_GDUMMY_CFG_DATA, (;), _);
