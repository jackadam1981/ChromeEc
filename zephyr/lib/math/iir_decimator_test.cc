...
TEST(IirDecimator, Init)
{
	...
	EXPECT_EQ(decimator.decimation_factor, 10);
}
...
TEST(IirDecimator, InitRounding)
{
	...
	EXPECT_EQ(decimator.decimation_factor, 11);
}
...
TEST(IirDecimator, InitZeroSampleRate)
{
	...
	EXPECT_EQ(decimator.decimation_factor, 0);
}
...
TEST(IirDecimator, InitDecimationFactorZero)
{
	...
	EXPECT_EQ(decimator.decimation_factor, 1);
}
