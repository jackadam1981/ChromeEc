...
BUILD_ASSERT(defined(CONFIG_EC_HOST_CMD_BACKEND_SPI),
	     "The SPI backend not enabled");
BUILD_ASSERT(defined(CONFIG_EC_HOST_CMD_BACKEND_UART),
	     "The UART backend not enabled");
...
static int fp_transport_init(void)
{
