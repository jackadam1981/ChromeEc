...
#ifndef CONFIG_EC_HOST_CMD_BACKEND_SPI
BUILD_ASSERT(0, "The SPI backend not enabled");
#endif
#ifndef CONFIG_EC_HOST_CMD_BACKEND_UART
BUILD_ASSERT(0, "The UART backend not enabled");
#endif
