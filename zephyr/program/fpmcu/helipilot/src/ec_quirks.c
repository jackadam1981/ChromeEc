...
/*
 * Old FPMCU RO (EC based) uses ITIM32-5 to measure system uptime and save
 * the CPU state before the real watchdog resets it. Zephyr uses different
 * counter for these purposes, so disable it.
 */
