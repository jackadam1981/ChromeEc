...
static bool sourcing_vbus[CONFIG_USB_PD_PORT_MAX_COUNT];	//this change is just for pujjoga
...
static void notify_power_change(void)	//this change is just for pujjoga
{
...
void pd_power_supply_reset(int port)
{
	...
	//  * Recovery path.
	//  */
	hook_call_deferred(&notify_power_change_data, 0);		//this change is just for pujjoga
}
