 ...
 */
static uint16_t kb_without_numpad_scancode_set2[KEYBOARD_COLS_MAX][KEYBOARD_ROWS] = {
 ...
 * check the key 30 (row:3, col:0), and 128 (row:6, col:15).
 */
static uint16_t kb_with_numpad_scancode_set2[KEYBOARD_COLS_MAX][KEYBOARD_ROWS] = {
	/* KSO   KSI0   KSI1    KSI2    KSI3    KSI4    KSI5    KSI6   KSI7*/
	/*  0 */ { 0x0000, 0x0000, 0x0000, 0xe01f, 0x0000, 0x0000, 0x0000,
		   0x0000 },
...
static uint16_t (*scancode_set2)[KEYBOARD_ROWS] = kb_without_numpad_scancode_set2;
...
test_export_static void keyboard_matrix_init(void)
{
	...
	case FW_KB_NUMPAD_PRESENT:
		scancode_set2 = kb_with_numpad_scancode_set2;
		LOG_INF("numpad keyboard matrix");
		break;
	case FW_KB_NUMPAD_NOT_PRESENT:
		scancode_set2 = kb_without_numpad_scancode_set2;
