...
test_export_static enum gothrax_sub_board_type nissa_cached_sub_board =
	GOTHRAX_SB_UNKNOWN;
/*
...
enum gothrax_sub_board_type gothrax_get_sb_type(void)
{
	 ...
	 * Return cached value.
	 */
	if (nissa_cached_sub_board != GOTHRAX_SB_UNKNOWN)
		return nissa_cached_sub_board;

	nissa_cached_sub_board = GOTHRAX_SB_NONE; /* Defaults to none */
	...
	default:
		...
		break;
	case FW_SUB_BOARD_1:
		nissa_cached_sub_board = GOTHRAX_SB_C_A;
		LOG_INF("SB: USB type C, USB type A");
		break;

	case FW_SUB_BOARD_2:
		nissa_cached_sub_board = GOTHRAX_SB_C_A_LTE;
		LOG_INF("SB: USB type C,USB type A, WWAN LTE");
		break;

	case FW_SUB_BOARD_3:
		nissa_cached_sub_board = GOTHRAX_SB_A;
