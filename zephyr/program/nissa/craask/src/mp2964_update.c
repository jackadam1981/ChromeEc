 ...
 */
/* Tune the MP2964 IMVP9.1 parameters for craask */
#include "charger.h"
#include "common.h"
...
const static struct mp2964_reg_val rail_a[] = {
	...
	{ 0x47, 0x0003 }, { 0x48, 0x0115 }, { 0x49, 0x0000 }, { 0x4a, 0x1734 },
	...
	{ 0x93, 0x002a }, { 0x94, 0x0002 }, { 0x95, 0x497a }, { 0x96, 0x300a },
	...
	{ 0xbc, 0x0069 }, { 0xbd, 0x001b }, { 0xc0, 0x00a0 }, { 0xc1, 0x2ab8 },
...
const static struct mp2964_reg_val rail_b[] = {
	...
	{ 0x21, 0x0083 }, { 0x22, 0x00de }, { 0x23, 0x0000 }, { 0x24, 0x00ff },
	...
	{ 0x46, 0x00d0 }, { 0x47, 0x0003 }, { 0x48, 0x00c0 }, { 0x49, 0x0000 },
