...
#if DT_NODE_EXISTS(GPIO_DT_FROM_NODELABEL(gpio_hdmi_sel))
...
#if DT_NODE_EXISTS(GPIO_DT_FROM_ALIAS(gpio_en_sub_s5_rails))
...
#if DT_NODE_EXISTS(GPIO_DT_FROM_NODELABEL(gpio_sub_usb_a1_ilimit_sdp))
