...
LOG_MODULE_REGISTER(kinmen_touch, LOG_LEVEL_INF);
...
void kinmen_touch_enable_event_handler(struct ap_power_ev_callback *cb,
...
static void touch_enable_init(void)
{
	...
	ap_power_ev_init_callback(&power_cb, kinmen_touch_enable_event_handler,
