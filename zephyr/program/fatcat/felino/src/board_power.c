...
{
	/* Disable vddq en before goto S5 */
...
AP_POWER_APP_STATE_DEFINE(AP_POWER_STATE_S4, NULL, board_ap_power_action_s4_run, NULL);
...
AP_POWER_APP_STATE_DEFINE(AP_POWER_STATE_S3, NULL, board_ap_power_action_s3_run, NULL);
