...
assert_rw_fwid_DO_NOT_EDIT(project_name="rauru", addr=0x60104)
assert_rw_fwid_DO_NOT_EDIT(project_name="navi", addr=0x60104)
assert_rw_fwid_DO_NOT_EDIT(project_name="hylia", addr=0x60104)
