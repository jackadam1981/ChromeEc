...
static void setup_mux(void)
{
	...
	if (ret != 0) {
		LOG_ERR("Error finding FW_DB_IO in CBI FW_CONFIG, ret: %d", ret);
		return;
	}
...
//	if (val == FW_IO_DB_USB4_KB8010) {
//		LOG_INF("C1: Setting KB8010 mux");
...
//	}
//	if (val == FW_IO_DB_USB4_HB) {
//		LOG_INF("C1: Setting HB mux");
//		USB_MUX_ENABLE_ALTERNATIVE(usb_mux_chain_hb_port1);
//	}
}
