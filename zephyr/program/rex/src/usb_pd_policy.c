...
#if defined(CONFIG_USB_PD_TBT_COMPAT_MODE) && \
	defined(CONFIG_USB_PD_ALT_MODE_UFP)
...
int test_set_tbt_ufp_reply(int port, enum typec_tbt_ufp_reply reply)
{
	return board_set_tbt_ufp_reply(port, reply);
}
#endif
...
#endif /* CONFIG_USB_PD_TBT_COMPAT_MODE && CONFIG_USB_PD_ALT_MODE_UFP */
