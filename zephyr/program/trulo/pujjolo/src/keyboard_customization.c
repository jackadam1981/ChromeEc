...
static uint16_t pujjolo_scancode_set2[KEYBOARD_COLS_MAX][KEYBOARD_ROWS] = {
...
static uint16_t pujjoquince_scancode_set2[KEYBOARD_COLS_MAX][KEYBOARD_ROWS] = {
	{ 0x0000, 0x0000, 0x0000, 0xe01f, 0x0000, 0x0000, 0x0000, 0x0000 },
	{ 0x0000, 0x0076, 0x000d, 0x000e, 0x001c, 0x0016, 0x001a, 0x003c },
	{ 0x0000, 0x0000, 0x0000, 0x0000, 0x0023, 0x0041, 0x0026, 0x0043 },
	{ 0x0032, 0x0034, 0x002c, 0x002e, 0x002b, 0x0049, 0x0025, 0x0044 },
	...
	{ 0x0055, 0x0052, 0x0054, 0x0036, 0x004c, 0x0022, 0x003d, 0x0024 },
	{ 0xe06c, 0x0000, 0xe071, 0x0000, 0x004b, 0x002a, 0x0046, 0x002d },
...
static uint16_t (*scancode_set2)[KEYBOARD_ROWS] = pujjolo_scancode_set2;
...
test_export_static void keyboard_matrix_init(void)
{
	...
	case FW_KB_NUMERIC_PAD_PRESENT:
		scancode_set2 = pujjoquince_scancode_set2;
		key_numpad = FW_KB_NUMERIC_PAD_PRESENT;
		LOG_INF("pojjoquince keyboard matrix");
		break;
	case FW_KB_NUMERIC_PAD_ABSENT:
		scancode_set2 = pujjolo_scancode_set2;
		key_numpad = FW_KB_NUMERIC_PAD_ABSENT;
		LOG_INF("pujjolo keyboard matrix");
		break;
	default:
