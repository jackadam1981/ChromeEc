...
LOG_MODULE_DECLARE(turlo, CONFIG_Trulo_LOG_LEVEL);

#define BAT_LED_ON 0
#define BAT_LED_OFF 1

#define BATT_LOW_BCT 8
#define BATT_CRT_BCT 8
...
static void led_set_battery(void)
{
	...
	/*
	 * Override battery LEDs for Kaladin without power led support,
	...
	case LED_PWRS_DISCHARGE:
		 ...
		 */
		if (led_auto_control_is_enabled(EC_LED_ID_RIGHT_LED)) {
			int batt_pct = charge_get_percent();

			if (batt_pct < BATT_CRT_BCT) {
