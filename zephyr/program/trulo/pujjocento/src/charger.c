...
static void set_bq25710_charge_option_1(void)
{
	int reg;
	int rv;
	int data;
...
DECLARE_DEFERRED(set_bq25710_charge_option_1);

void batt_pres_interrupt(enum gpio_signal signal)
{
	hook_call_deferred(&set_bq25710_charge_option_1_data, 2 * USEC_PER_SEC);
}
