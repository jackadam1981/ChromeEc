...
assert_rw_fwid_DO_NOT_EDIT(project_name="luuke", addr=0x60104)
assert_rw_fwid_DO_NOT_EDIT(project_name="obiwan", addr=0x40144)
assert_rw_fwid_DO_NOT_EDIT(project_name="yoda", addr=0x40144)
assert_rw_fwid_DO_NOT_EDIT(project_name="anakin", addr=0x60104)
assert_rw_fwid_DO_NOT_EDIT(project_name="baze", addr=0x60104)
assert_rw_fwid_DO_NOT_EDIT(project_name="tarkin", addr=0x60104)
assert_rw_fwid_DO_NOT_EDIT(project_name="padme", addr=0x60104)
assert_rw_fwid_DO_NOT_EDIT(project_name="grogu", addr=0x60104)
