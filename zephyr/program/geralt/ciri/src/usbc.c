<<<<<<< HEAD   (cd61aa0a218be17bee20ca3b62d07aa4e0401dbc geralt: improve usbc performance)
...
DECLARE_HOOK(HOOK_POWER_SUPPLY_CHANGE, manage_source_port_power_change,
	     HOOK_PRIO_DEFAULT);
||||||| BASE   (32c7216deff35001d5f3ee23c8d6a99281c0844a Remove unused board tglrvp_ish)
/* Copyright 2024 The ChromiumOS Authors
 * Use of this source code is governed by a BSD-style license that can be
 * found in the LICENSE file.
 */
...
DECLARE_HOOK(HOOK_POWER_SUPPLY_CHANGE, manage_source_port_power_change,
	     HOOK_PRIO_DEFAULT);
=======
>>>>>>> CHANGE (81ab054a344573e78200dd8797cc7fdac6fe07e0 ciri: Remove specific Type-C port output policy)
