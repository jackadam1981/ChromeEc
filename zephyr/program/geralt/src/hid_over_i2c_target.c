...
static const uint8_t REPORT_DESC_BLOB[] = REPORT_DESC(255, 2925, 1426, 929, 457);
...
static int hid_i2c_target_register(const struct device *dev)
{
	...
	ccprints("\x1b[1;31mresume\x1b[m");
...
static int hid_i2c_target_unregister(const struct device *dev)
{
	...
	ccprints("\x1b[1;31msuspend\x1b[m");
				    ...
				    struct ap_power_ev_data data)
{
	...
	case AP_POWER_SUSPEND:
		i2c_target_driver_unregister(DEVICE_DT_GET(DT_NODELABEL(hid_i2c_target)));
		break;
	}
}
