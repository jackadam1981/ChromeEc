...
enum cust_keys {
...
#if 1
	KEY_F1 = SCANCODE_VOLUME_MUTE,
	KEY_F2 = SCANCODE_VOLUME_DOWN,
	KEY_F3 = SCANCODE_VOLUME_UP,
	KEY_F4 = SCANCODE_BACK, /* Play/Pause => Back */
	KEY_F5 = SCANCODE_FORWARD, /* Insert => Forward */
	KEY_F6 = SCANCODE_REFRESH, /* Print Screen => Refresh */
	KEY_F7 = SCANCODE_FULLSCREEN, /* F7 => Full screen */
	KEY_F8 = SCANCODE_PRIVACY_SCRN_TOGGLE, /* F8 => Next tab/Window */
	KEY_F9 = SCANCODE_BRIGHTNESS_DOWN, /* Brightness down */
	KEY_F10 = SCANCODE_BRIGHTNESS_UP, /* Brightness up */
	KEY_F11 = 0x0000, /* TODO: Airplane Mode */
	KEY_F12 = 0x0000, /* TODO: Scroll lock */
#else
	KEY_F1 = SCANCODE_F1,
	KEY_F2 = SCANCODE_F2,
	KEY_F3 = SCANCODE_F3,
	...
	KEY_KL = 0x0000, /* TODO: Not working, Caps lock => Search */
	KEY_A = 0x001c,
	KEY_S = 0x001b,
	KEY_D = 0x0023,
	KEY_F = 0x002b,
...
static uint16_t scancode_set2[KEYBOARD_COLS_MAX][KEYBOARD_ROWS] = {
	...
	{ KEY_W, KEY_KL, KEY_S, 0x0000, KEY_X, 0x0000, KEY_F1, KEY_2 }, //2
	{ KEY_E, KEY_F3, KEY_D, KEY_F4, KEY_C, 0x0000, KEY_F2, KEY_3 }, //3
	...
	{ 0x0000, KEY_BACKSP, KEY_BSLSH, 0x0000, KEY_ENTR, 0x0000, KEY_F9, KEY_F10 }, //10
