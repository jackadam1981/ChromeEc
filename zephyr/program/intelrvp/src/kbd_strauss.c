...
static uint16_t scancode_set2[KEYBOARD_COLS_MAX][KEYBOARD_ROWS] = {
	...
	{ KNONE,    KNONE,      KNONE,     KEY_GOOG,  KNONE,    KNONE,     KNONE,    KNONE     }, /* KS000 */
	{ KNONE,    KEY_ESC,    KEY_TAB,   KEY_BKTK,  KEY_A,    KEY_1,     KEY_Z,    KEY_U     }, /* KSO01 */
	{ KNONE,    KNONE,      KNONE,     KNONE,     KEY_D,    KEY_COM,   KEY_3,    KEY_I     }, /* KSO02 */
	{ KEY_B,    KEY_G,      KEY_T,     KEY_5,     KEY_F,    KEY_DOT,   KEY_4,    KEY_O     }, /* KSO03 */
	{ KNONE,    KNONE,      KNONE,     KEY_S,     KNONE,    KEY_FSLSH, KEY_2,    KEY_P     }, /* KSO04 */
	{ KEY_N,    KNONE,      KEY_CBRC,  KNONE,     KEY_K,    KEY_C,     KEY_8,    KEY_Q     }, /* KSO05 */
	{ KNONE,    KEY_H,      KEY_Y,     KEY_HPN,   KEY_J,    KEY_SPACE, KEY_0,    KEY_W     }, /* KSO06 */
	{ KNONE,    KNONE,      KNONE,     KNONE,     KNONE,    KEY_LSHFT, KNONE,    KEY_RSHFT }, /* KSO07 */
	{ KEY_EQVL, KEY_APST,   KEY_OBRC,  KEY_6,     KEY_SCOL, KEY_X,     KEY_7,    KEY_E     }, /* KSO08 */
	{ KNONE,    KNONE,      KNONE,     KNONE,     KEY_L,    KEY_V,     KEY_9,    KEY_R     }, /* KSO09 */
	{ KEY_RALT, KNONE,      KNONE,     KNONE,     KNONE,    KNONE,     KNONE,    KNONE     }, /* KSO10 */
	{ KNONE,    KEY_BACKSP, KNONE,     KEY_BSLSH, KEY_ENTR, KEY_M,     KEY_DN,   KEY_UP    }, /* KSO11 */
	{ KNONE,    KNONE,      KNONE,     KNONE,     KNONE,    KNONE,     KEY_RT,   KEY_LF    }, /* KSO12 */
	{ KNONE,    KNONE,      KNONE,     KNONE,     KNONE,    KNONE,     KEY_LALT, KNONE     }, /* KSO13 */
	{ KNONE,    KEY_LCTRL,  KNONE,     KEY_RCTRL, KNONE,    KNONE,     KNONE,    KNONE     }, /* KSO14 */
	{ KNONE,    KNONE,      KNONE,     KNONE,     KNONE,    KNONE,     KEY_KL,   KNONE     }, /* KSO15 */
	{ KEY_FUNC, KNONE,      KNONE,     KNONE,     KNONE,    KNONE,     KNONE,    KNONE     }, /* KSO16 */
};
/* clang-format on */
