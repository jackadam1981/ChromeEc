                                        ...
                                        const enum ap_pwrseq_state exit)
{
        ...
        {
                LOG_INF("S4 callback triggered, when exiting S5");
...
static void setup_pca95xx_init_callback(void)
{
...
DECLARE_HOOK(HOOK_INIT, setup_pca95xx_init_callback, HOOK_PRIO_DEFAULT);
#endif
