...
/* Dirks sub-board hardware configuration */

#include "cros_board_info.h"
#include "cros_cbi.h"
#include "dirks_hdmi.h"
#include "dirks_sub_board.h"
...
LOG_MODULE_DECLARE(dirks, CONFIG_DIRKS_LOG_LEVEL);
...
#if CONFIG_DIRKS_BOARD_HAS_HDMI_SUPPORT
...
#endif /* CONFIG_DIRKS_BOARD_HAS_HDMI_SUPPORT */
