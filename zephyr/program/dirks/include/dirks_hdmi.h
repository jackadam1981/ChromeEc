...
/* Dirks shared HDMI sub-board functionality */

#ifndef __CROS_EC_DIRKS_DIRKS_HDMI_H__
#define __CROS_EC_DIRKS_DIRKS_HDMI_H__
...
#endif /* __CROS_EC_DIRKS_DIRKS_HDMI_H__ */
