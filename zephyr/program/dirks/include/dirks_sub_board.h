...
/* Dirks sub-board declarations */

#ifndef __CROS_EC_DIRKS_DIRKS_SUB_BOARD_H__
#define __CROS_EC_DIRKS_DIRKS_SUB_BOARD_H__
...
#endif /* __CROS_EC_DIRKS_DIRKS_SUB_BOARD_H__ */
