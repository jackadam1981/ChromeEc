 ...
 *
 * @param setup[in] Information about the request to execute.
 * @param len[out]  Size of the buffer.
 * @param data[out] Buffer containing the request result.
 *
...
/*
 * Handle the Set Interface Request.
 */
