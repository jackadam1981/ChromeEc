...
# doesn't use RO+RW
assert_rw_fwid_DO_NOT_EDIT(project_name="brox", addr=0x65098)
assert_rw_fwid_DO_NOT_EDIT(project_name="brox-ish-ec", addr=0x65098)
assert_rw_fwid_DO_NOT_EDIT(project_name="brox-tokenized", addr=0x65098)
assert_rw_fwid_DO_NOT_EDIT(project_name="greenbayupoc", addr=0x65098)
assert_rw_fwid_DO_NOT_EDIT(project_name="lotso", addr=0x65098)
