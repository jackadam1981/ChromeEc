...
void board_ap_power_force_shutdown(void)
{
	...
	/*
	 * Brox follower devices populate a diode so that de-asserting
	 * DSW_PWROK also asserts RSMRST.
	 *
	 * Brox is missing this, so the Brox specifically asserts RSMRST
	 * before DSR_PWROK.
	 */
	if (IS_ENABLED(CONFIG_BOARD_BROX)) {
