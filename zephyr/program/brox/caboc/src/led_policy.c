...
#define BATT_LOW_LED_FULL_ON_PERIOD_MS (1000 * USEC_PER_MSEC)
#define BATT_LOW_LED_FULL_OFF_PERIOD_MS (1000 * USEC_PER_MSEC)
...
#define PWR_SUSPEND_LED_ON_STEP_TIME_MS (30 * USEC_PER_MSEC)
#define PWR_SUSPEND_LED_OFF_STEP_TIME_MS (30 * USEC_PER_MSEC)
#define PWR_SUSPEND_LED_FULL_OFF_PERIOD_MS (1500 * USEC_PER_MSEC)
#define PWR_SUSPEND_LED_PULSE_ON_PERIOD_MS (1500 * USEC_PER_MSEC)
#define PWR_SUSPEND_LED_PULSE_OFF_PERIOD_MS (1500 * USEC_PER_MSEC)
