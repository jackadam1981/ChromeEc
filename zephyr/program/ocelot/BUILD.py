...
register_npcx9_project(
    project_name="ocelotrvp_npcx",
)

# For use on RVP SKU3
register_it8xxx2_project(
    project_name="ocelotrvp_ite",
)

# For use on RVP SKU4
register_mec172x_project(
    project_name="ocelotrvp_mchp",
)


# Note for reviews, do not let anyone edit these assertions, the addresses
# must not change after the first RO release.
assert_rw_fwid_DO_NOT_EDIT(project_name="ocelotrvp_npcx", addr=0x80144)
assert_rw_fwid_DO_NOT_EDIT(project_name="ocelotrvp_ite", addr=0x60098)
assert_rw_fwid_DO_NOT_EDIT(project_name="ocelotrvp_mchp", addr=0x40318)
