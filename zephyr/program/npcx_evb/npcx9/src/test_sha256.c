...
uint8_t hmac_tmp[SHA256_DIGEST_SIZE];
/* Short Msg from NIST FIPS 180-4 (Len = 8) */
static const uint8_t sha256_8_input[] __aligned(4) = { 0xd3 };
...
static const uint8_t sha256_72_input[] __aligned(4) = { 0x33, 0x34, 0xc5,
							0x80, 0x75, 0xd3,
							0xf4, 0x13, 0x9e };
...
static const uint8_t sha256_2888_input[] __aligned(4) = {
...
static const uint8_t hmac_short_msg[] __aligned(4) = {
...
static const uint8_t hmac_medium_msg[] __aligned(4) = {
...
{
	hmac_SHA256(hmac_tmp, key, key_len, input, input_len);

	if (memcmp(hmac_tmp, output, SHA256_DIGEST_SIZE) != 0) {
...
static int command_sha_test(int argc, const char **argv)
{
	run_test();

	return 0;
}
DECLARE_CONSOLE_COMMAND(sha_test, command_sha_test, "", "");
