...
/*
 * base_update updates the base status to the specified state.
 */
...
static void base_detect_deferred(void)
{
	...
	/*
	 * If a disable base detection is issued during the deferred hook and is
	 * before the deferred hook run, then we need to check whether the
