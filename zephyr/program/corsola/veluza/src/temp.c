...
static void current_update(void)
{
	...
	/*
	 * When current average temperature > last average temperature and keep
	 * 5 second, will follow thermal table drop charging current to avoid
	 * skin overtemperature.
	 */
	if (temp < prev_tmp) {
		/* Decrease */
