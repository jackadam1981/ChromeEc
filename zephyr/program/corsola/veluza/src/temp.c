...
/*
 * When the current average temperature is over the last average and the
 * temperature is kept at 5 seconds, it will follow the thermal table drop
 * charging current to avoid skin overtemperature.
 */
