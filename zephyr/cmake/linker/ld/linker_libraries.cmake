...
if(CONFIG_REQUIRES_FULL_LIBCPP)
  ...
  set_linker_property(PROPERTY c++_library APPEND "${COREBOOT_SDK_ROOT_LIBSTDCXX}/${CROSS_COMPILE_TARGET}/lib/gcc/${CROSS_COMPILE_TARGET}/${GCC_VERSION}/${CROSS_COMPILE_QUALIFIER}libgcc.a")
endif()
