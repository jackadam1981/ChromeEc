...
#define IN_SUSPEND		POWER_SIGNAL_MASK(FCL_AP_IN_SLEEP)
#define IN_AP_SHUTDOWN_REQ 	IN_SUSPEND

#define IN_ALL_S0		(POWER_SIGNAL_MASK(FCL_PG_VDD1_VDD2) | \
...
static const struct power_seq_op s3s5_power_seq[] = {
	{GPIO_EN_VDD_CPU, 0, 0},
	{GPIO_EN_VDD_GPU, 0, 0},
	{GPIO_EN_VDD_MEDIA_ML, 0, 0},

	{GPIO_EN_VDDQ_VR_D, 0, 0},    /* LPDDR */
	{GPIO_EN_VDD1_VDD2_VR, 0, 0}, /* LPDDR */
	{GPIO_EN_VDD_DDR, 0, 0},
	{GPIO_EN_PP3300A_IO_X, 0, 0},
	{GPIO_EN_PP3300_S3, 0, 0},
...
static const struct power_seq_op g3s5_power_seq[] = {
	{GPIO_EN_PP5000_S5, 1, 0},
	{GPIO_EN_PP1800_S5, 1, 0},

	{GPIO_EN_PP1800_VDDIO_PMC_X, 1, 1},
	{GPIO_EN_PP0800_VDD_PMC_X, 1, 0},
	{GPIO_EN_VDD_SOC, 1, 0},
	{GPIO_EN_PP1800_VDD33_PMC, 1, 0},
};

/* This is the power sequence for POWER_S0S3. */
static const struct power_seq_op s5s3_power_seq[] = {
	{GPIO_EN_PP1800_S3, 1, 0},
	{GPIO_EN_PP1820A_IO_X, 1, 0},

	{GPIO_EN_PP3300_S3, 1, 1},
	{GPIO_EN_PP3300A_IO_X, 1, 0},
	{GPIO_EN_VDD_DDR, 1, 0},
	{GPIO_EN_VDD1_VDD2_VR, 1, 0}, /* LPDDR */
	{GPIO_EN_VDDQ_VR_D, 1, 0},    /* LPDDR */
...
static const struct power_seq_op s5g3_power_seq[] = {
	{GPIO_EN_PP1800_VDD33_PMC, 0, 0},
	{GPIO_EN_VDD_SOC, 0, 0},
	{GPIO_EN_PP0800_VDD_PMC_X, 0, 0},
	{GPIO_EN_PP1800_VDDIO_PMC_X, 0, 1},

	{GPIO_EN_PP1800_S5, 0, 0},
	{GPIO_EN_PP5000_S5, 0, 0},
};
