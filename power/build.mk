...
ifndef CONFIG_CHIPSET_POWER_CUSTOM
power-$(CONFIG_CHIPSET_APL_GLK)+=apollolake.o
power-$(CONFIG_CHIPSET_BRASWELL)+=braswell.o
power-$(CONFIG_CHIPSET_CANNONLAKE)+=cannonlake.o
power-$(CONFIG_CHIPSET_COMETLAKE)+=cometlake.o
power-$(CONFIG_CHIPSET_COMETLAKE_DISCRETE)+=cometlake-discrete.o
power-$(CONFIG_CHIPSET_ECDRIVEN)+=ec_driven.o
power-$(CONFIG_CHIPSET_ICELAKE)+=icelake.o
...
power-$(CONFIG_POWER_INTEL_X86)+=intel_x86.o
