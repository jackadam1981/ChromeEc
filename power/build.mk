...
power-$(CONFIG_CHIPSET_ALDERLAKE_SLG4BD44540)+=intel_x86.o common_x86.o
power-$(CONFIG_CHIPSET_APL_GLK)+=apollolake.o intel_x86.o common_x86.o
power-$(CONFIG_CHIPSET_BRASWELL)+=braswell.o
power-$(CONFIG_CHIPSET_CANNONLAKE)+=cannonlake.o intel_x86.o common_x86.o
power-$(CONFIG_CHIPSET_COMETLAKE)+=cometlake.o intel_x86.o common_x86.o
power-$(CONFIG_CHIPSET_COMETLAKE_DISCRETE)+=cometlake-discrete.o intel_x86.o
power-$(CONFIG_CHIPSET_COMETLAKE_DISCRETE)+=common_x86.o
power-$(CONFIG_CHIPSET_ECDRIVEN)+=ec_driven.o
power-$(CONFIG_CHIPSET_ICELAKE)+=icelake.o intel_x86.o common_x86.o
...
power-$(CONFIG_CHIPSET_CEZANNE)+=amd_x86.o common_x86.o
...
power-$(CONFIG_CHIPSET_SKYLAKE)+=skylake.o intel_x86.o common_x86.o
power-$(CONFIG_CHIPSET_STONEY)+=amd_x86.o common_x86.o
