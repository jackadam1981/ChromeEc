...
enum power_state power_handle_state(enum power_state state)
{
	...
	case POWER_S5G3:
		 ...
		 * triggered by EC side, then EC is unable to setup PMIC
		 * registers for a gracefully shutdown. What we can do instead
		 * is a force shutdown by asserting EC_PMIC_EN_ODL for 8
		 * seconds, and all the rails are force off, and the system will
		 * enter G3 after EC_PMIC_EN_ODL released.
		 */
