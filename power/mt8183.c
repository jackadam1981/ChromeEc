...
/*
 * The AP informs the EC of its S3 state through IN_S3_L.
 * Latency between deassertion and power rails coming up must be minimized, so
 * check for deassertion at various stages of our suspend power sequencing, and
 * immediately transition out of suspend if necessary.
 *
 * TODO(b:109850749): Check if this is required on MT8183.
 */
...
enum power_state power_handle_state(enum power_state state)
{
	...
	case POWER_G3S5:
		 ...
		 *
		 * TODO(b:109850749): Check if this is necessary on MT8183.
		 */
