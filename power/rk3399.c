...
/*
 * This is the power sequence from S5 to S3.
...
/*
 * This is the power sequence from S3 to S0.
 * The entries in the table are handled sequentially from the top
 * to the bottom.
 */
...
/*
 * This is the power sequence from S0 to S3.
 * The entries in the table are handled sequentially from the top
 * to the bottom.
 */
...
/*
 * This is the power sequence from S3 to S5.
 * The entries in the table are handled sequentially from the top
 * to the bottom.
 */
 ...
 * @return	1 if suspend aborted during the transition from S0 to S3,
 *		0 otherwise.
 */
