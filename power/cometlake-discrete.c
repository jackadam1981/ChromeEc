 ...
 *   a. Enable PP5000_A and PP3300_A (EN_ROA_RAILS)
 *   b. Wait for PP5000_A good, indicated by a rising edge on PP5000_A_PGOOD
 ...
 *      PP1050_A are good.
 *   h. Bring the PCH out of reset by deasserting RSMRST
 * 3. A power button press begins power-on to S3 (controlled by the power button
 *    task).
 ...
 *   c. Enable PP950_VCCIO.
 *   d. Wait for PG_PP950_VCCIO. Although the PCH may be asserting CPU_C10_GATED
 ...
 *   a. Turn on EN_S0_RAILS (enabling PP1200_PLLOC and PP1050_STG).
 *   b. Wait 2ms (for EN_S0_RAILS load switches to turn on).
 *   c. Assert VCCST_PWRGD. This notionally tracks PP1050_ST_S but must be
 *      deasserted in S3 and lower.
 *   d. Enable IMVP8_VR.
 *   e. Wait 2ms.
 *   f. Assert SYS_PWROK.
 *   g. Wait for IMVP8_VRRDY.
 *   h. Wait 2ms.
 *   i. Assert PCH_PWROK.
 *
