...
enum power_state power_handle_state(enum power_state state)
{
	...
	/*
	 * Check value of PG_EC_ALL_SYS_PWRGD to see if EC_PCH_SYS_PWROK needs
	 * to be changed. If it's low->high transition, require a 2msec delay.
	 */
	...
	if (all_sys_pwrgd_in != all_sys_pwrgd_out) {
		...
		gpio_set_level(GPIO_PG_EC_ALL_SYS_PWRGD, all_sys_pwrgd_in);
