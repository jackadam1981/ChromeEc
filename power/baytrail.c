...
enum power_state power_handle_state(enum power_state state)
{
...
#ifdef BOARD_CANDY
		msleep(1);
		gpio_set_level(GPIO_TOUCHSCREEN_RESETB, lid_is_open());
#endif
	...
	case POWER_S3S0:
...
#ifdef BOARD_CANDY
		msleep(1);
		gpio_set_level(GPIO_TOUCHSCREEN_RESETB, 1);
#endif
...
#ifdef BOARD_CANDY
			gpio_set_level(GPIO_TOUCHSCREEN_RESETB, 0);
#endif
		...
		/*
		 * Wait 105 ms after all voltages good.  100 ms is needed
		 * for PCIe devices; mini-PCIe devices is needed 10 ms.
		 */
		msleep(105);
