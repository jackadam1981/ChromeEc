...
# changed.
# Note, we use ifndef logic to ensure the likelyhood of rebuilding is
# much higher. For example, if variable cmd_libcryptoc_clean is modified
# or blank, we will rebuild.
