 ...
 *
 * port: SPI master port to use. 0 if only one port.
 * gpio: gpio to select the device. Only one device currently supported.
 * div: when enable is set, the frequency diviser to use.
