...
struct spi_device_t {
	/*
	 * SPI port to the device is connected to.
 ...
 * txdata: buffer to transmit
 * txlen: number of bytes in txdata.
 * rxdata: receive buffer.
 * txlen: number of bytes in rxdata.
 */
