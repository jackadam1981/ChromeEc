...
/*
 * Query wether async response is complete.  spi_transaction_flush() must still
 * be called eventually, but can be assumed to return instantly, after this
 * method has returned non-zero.
 */
