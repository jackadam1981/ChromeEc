...
struct fast_charge_profile {
	 ...
	 * Last battery voltage range is battery MAX hence the array size is
	 * +1 than the battery charger profile voltage ranges.
	 */
	const int current_mA[CONFIG_CHARGER_PROFILE_VOLTAGE_RANGES + 1];
};
