...
struct fast_charge_profile {
	...
	int temp_c;
	/* charge current at lower battery voltage in mA */
	int curr_vtg_low_limit_mA;
	/* charge current at high battery voltage in mA */
	int curr_vtg_high_limit_mA;
};

/* Charge profile override config */
struct fast_charge_config {
	/* Total temperature ranges of the charge profile */
	int total_temp_ranges;
	/* Default temperature range of the charge profile */
	int default_temp_range_profile;
	/* lower limit of battery voltage in mV */
	int vtg_low_limit_mV;
	/* higher limit of battery voltage in mV */
	int vtg_high_limit_mV;
};
