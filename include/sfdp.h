...
#define SFDP_DEFINE_BITMASK_32(name, hi, lo) \
	const uint32_t name = (((1ULL << ((hi) - (lo) + 1)) - 1UL) << (lo));
#define SFDP_DEFINE_SHIFT_32(name, hi, lo) \
	const size_t name = (lo);
 ...
 */
#define SFDP_BITFIELD(name, value) (((dw) & name ## _MASK) << name ## _SHIFT)
#define SFDP_UNUSED(hi, lo) (((-1UL >> (32 - ((hi) - (lo)))) << (lo)) << lo)
...
#define BFPT_1_5_DWORD11(crmunit, crmcount, mrbunit, mrbcount, initunit,  \
...
#define BFPT_1_5_DWORD12(unsup, susprmlatun, susprmlatcnt, rmressusplatcnt, \
...
#define BFPT_1_5_DWORD13(suspop, resop, wrsspop, wrresop)          \
...
#define BFPT_1_5_DWORD14(pwrdwnunsup, pwrdwnop, pwrupop, pwrupunit, pwrupcnt, \
			 busypollflags)                                       \
...
#define BFPT_1_5_DWORD15(holdwpdis, qereq, fr044entry, fr044exit, fr044sup, \
	...
	(SFDP_RESERVED(31, 24) |                                            \
	 ...
	 SFDP_BITFIELD(BFPT_1_5_DW15_0_4_4_EXIT, fr0444exit) |              \
...
#define BFPT_1_5_DWORD16(entry, exit, softreset, statusreg1)  \
