...
/* Number of preamble bytes sent from EC to CR50. Should fill CR50 RX buffer */
#define CR50_COMM_PREAMBLE_SEND_LENGTH 32
...
/**
 * EC-Cr50 request data frame looks like the following:
 *
...
/**
 * EC-Cr50 response data frame looks like the following:
 *
 *   [preamble][response_code]
 *
 * preamble: 0xec (single byte)
 * response_code: enum cr50_comm_err
 */
struct cr50_comm_response {
	uint8_t preamble;	/* CR50_COMM_PREAMBLE */
	uint8_t response_code;	/* Values are enum cr50_comm_err */
} __packed;
...
/* Response codes from CR50 */
enum cr50_comm_err {
	CR50_COMM_SUCCESS =		0x00,
	CR50_COMM_ERR_UNKNOWN =		0x01,
	CR50_COMM_ERR_MAGIC =		0x02,
	CR50_COMM_ERR_CRC =		0x03,
	CR50_COMM_ERR_SIZE =		0x04,
	CR50_COMM_ERR_TIMEOUT =		0x05,	/* Generated by EC only */
	CR50_COMM_ERR_BAD_PAYLOAD =	0x06,
	CR50_COMM_ERR_UNDEFINED_CMD =	0x07,
	CR50_COMM_ERR_STRUCT_VERSION =	0x08,
	CR50_COMM_ERR_NVMEM =		0x09,
} __packed;
BUILD_ASSERT(sizeof(enum cr50_comm_err) == sizeof(uint8_t));
