...
#define CR50_COMM_PREMBLE               0xec
#define MIN_LENGTH_PREMBLE              4
...
/* return code */
#define CR50_COMM_RESPONSE(X)           ((0xec <<  8) | ((X) & 0xff))
...
#define CR50_COMM_HASH_MISMATCH         CR50_COMM_RESPONSE(0x06)
