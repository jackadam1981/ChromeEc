...
#define CR50_COMM_PREEMBLE               0xec
#define MIN_LENGTH_PREEMBLE              4
...
/* return code */
#define CR50_COMM_RESPONSE_PRE		0xec00
#define CR50_COMM_SUCCESS               (CR50_COMM_RESPONSE_PRE | 0x00)
#define CR50_COMM_ERROR_UNKNOWN         (CR50_COMM_RESPONSE_PRE | 0x01)
#define CR50_COMM_ERROR_MAGIC           (CR50_COMM_RESPONSE_PRE | 0x02)
#define CR50_COMM_ERROR_CRC             (CR50_COMM_RESPONSE_PRE | 0x03)
#define CR50_COMM_ERROR_SIZE            (CR50_COMM_RESPONSE_PRE | 0x04)
#define CR50_COMM_ERROR_TIMEOUT         (CR50_COMM_RESPONSE_PRE | 0x05)
#define CR50_COMM_HASH_MISMATCH         (CR50_COMM_RESPONSE_PRE | 0x06)
#define CR50_COMM_ERROR_UNDEFINED_CMD   (CR50_COMM_RESPONSE_PRE | 0x07)
