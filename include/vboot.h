...
#ifndef CONFIG_SOC_REQUIRED_FOR_RECOVERY
#define CONFIG_SOC_REQUIRED_FOR_RECOVERY	20
#endif
 ...
 * EFS failed.
 */
__override_proto void led_critical(void);
...
enum cr50_comm_res {
	...
	CR50_COMM_ERROR_UNKNOWN =	0xec01,
	CR50_COMM_ERROR_MAGIC =		0xec02,
	CR50_COMM_ERROR_CRC =		0xec03,
	CR50_COMM_ERROR_SIZE	=	0xec04,
	CR50_COMM_ERROR_TIMEOUT =	0xec05,
	CR50_COMM_ERROR_HASH_MISMATCH =	0xec06,
	CR50_COMM_ERROR_UNDEFINED_CMD =	0xec07,
} __packed;
...
enum boot_mode {
	...
	BOOT_MODE_NO_BOOT          = 0x02,
	BOOT_MODE_NO_BOOT_RECOVERY = 0x03,
	BOOT_MODE_RESET            = 0xff,
} __packed;
