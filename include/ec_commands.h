...
enum ec_flash_region {
	...
	/* Same as EC_FLASH_REGION_UPDATE but includes only used portion */
	EC_FLASH_REGION_UPDATE_USED,
	/* Region which holds active (running) RW image */
	EC_FLASH_REGION_ACTIVE,
	/* Same as EC_FLASH_REGION_ACTIVE but includes only used portion */
	EC_FLASH_REGION_ACTIVE_USED,
	/*
...
/* Switch active slot */
#define EC_CMD_SWITCH_SLOT 0x11E

struct __ec_align1 ec_response_switch_slot {
	uint8_t slot;	/* Activated slot */
};
