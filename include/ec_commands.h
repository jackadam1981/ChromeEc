...
enum motionsense_command {
	...
	/*
	 * Value command returns the sensor data.
	 */
	MOTIONSENSE_CMD_VALUE = 6,
...
struct ec_params_motion_sense {
	...
	union {
		...
		/* Used for MOTIONSENSE_CMD_INFO, MOTIONSENSE_CMD_VALUE. */
		struct {
			uint8_t sensor_num;
		} info, value;
...
struct ec_response_motion_sense {
	union {
		...
		/* Used for MOTIONSENSE_CMD_VALUE */
		struct ec_response_motion_sensor_data value;
