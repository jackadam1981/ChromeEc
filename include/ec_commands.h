 ...
 *
 * Returns the variable-length platform-dependent panic_data struct.
 */
#define EC_CMD_GET_PANIC_INFO 0x00D3

/*
 * The panic_data struct is included here so the kernel can parse panic data
 * structure returned by EC_CMD_GET_PANIC_INFO.
 */
