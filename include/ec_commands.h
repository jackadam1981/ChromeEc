...
/*
 * These defines provide translation layer between Zephyr and legacy EC enums.
 * They may be removed after resolving the issue b/228865177
 */
#include <zephyr/mgmt/ec_host_cmd/ec_host_cmd.h>

#define ec_status ec_host_cmd_status
#define EC_RES_SUCCESS EC_HOST_CMD_SUCCESS
#define EC_RES_INVALID_COMMAND EC_HOST_CMD_INVALID_COMMAND
#define EC_RES_ERROR EC_HOST_CMD_ERROR
#define EC_RES_INVALID_PARAM EC_HOST_CMD_INVALID_PARAM
#define EC_RES_ACCESS_DENIED EC_HOST_CMD_ACCESS_DENIED
#define EC_RES_INVALID_RESPONSE EC_HOST_CMD_INVALID_RESPONSE
#define EC_RES_INVALID_VERSION EC_HOST_CMD_INVALID_VERSION
#define EC_RES_INVALID_CHECKSUM EC_HOST_CMD_INVALID_CHECKSUM
#define EC_RES_IN_PROGRESS EC_HOST_CMD_IN_PROGRESS
#define EC_RES_UNAVAILABLE EC_HOST_CMD_UNAVAILABLE
#define EC_RES_TIMEOUT EC_HOST_CMD_TIMEOUT
#define EC_RES_OVERFLOW EC_HOST_CMD_OVERFLOW
#define EC_RES_INVALID_HEADER EC_HOST_CMD_INVALID_HEADER
#define EC_RES_REQUEST_TRUNCATED EC_HOST_CMD_REQUEST_TRUNCATED
#define EC_RES_RESPONSE_TOO_BIG EC_HOST_CMD_RESPONSE_TOO_BIG
#define EC_RES_BUS_ERROR EC_HOST_CMD_BUS_ERROR
#define EC_RES_BUSY EC_HOST_CMD_BUSY
#define EC_RES_INVALID_HEADER_VERSION EC_HOST_CMD_INVALID_HEADER_VERSION
#define EC_RES_INVALID_HEADER_CRC EC_HOST_CMD_INVALID_HEADER_CRC
#define EC_RES_INVALID_DATA_CRC EC_HOST_CMD_INVALID_DATA_CRC
#define EC_RES_DUP_UNAVAILABLE EC_HOST_CMD_DUP_UNAVAILABLE
#define EC_RES_MAX EC_HOST_CMD_MAX
