 ...
 * the Power Delivery Specification Revision 3.0
 * (See 6.2.1.1.4 Port Power Role)
 */
enum pd_power_role {
	PD_ROLE_SINK = 0,
	PD_ROLE_SOURCE = 1
 ...
 * align to those in the Power Deliveriy Specification Revision 3.0 (See
...
struct ec_response_typec_status {
	...
	uint8_t sopp_connected;	/* Device is SOP' PD capable - bool */
