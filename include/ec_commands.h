...
enum host_sleep_event {
	HOST_SLEEP_EVENT_S3_PREPARE_SUSPEND = 1,
	HOST_SLEEP_EVENT_S3_SUSPEND = 2,
	HOST_SLEEP_EVENT_S3_RESUME = 3,
	HOST_SLEEP_EVENT_S3_RESUME_COMPLETE = 4,
	HOST_SLEEP_EVENT_S0IX_PREPARE_SUSPEND = 5,
	HOST_SLEEP_EVENT_S0IX_SUSPEND = 6,
	HOST_SLEEP_EVENT_S0IX_RESUME = 7,
	HOST_SLEEP_EVENT_S0IX_RESUME_COMPLETE = 8,
	/* S3 suspend with additional enabled wake sources */
	HOST_SLEEP_EVENT_S3_WAKEABLE_SUSPEND = 9,
};
