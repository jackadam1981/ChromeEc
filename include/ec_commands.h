...
enum cbi_data_tag {
	...
	CBI_TAG_BATT_SHIP_MODE_FLAGS = 0x15, /* enum ship_mode_flag */
	/* struct sleep_mode_info */
	CBI_TAG_BATT_SLEEP_MODE_REG_ADDR = 0x16,
	CBI_TAG_BATT_SLEEP_MODE_REG_DATA = 0x17,
	CBI_TAG_BATT_SLEEP_MODE_FLAGS = 0x18, /* enum sleep_mode_flag */
	/* struct fet_info */
	CBI_TAG_BATT_FET_REG_ADDR = 0x19,
	CBI_TAG_BATT_FET_REG_MASK = 0x1a,
	CBI_TAG_BATT_FET_DISCONNECT_VAL = 0x1b,
	CBI_TAG_BATT_FET_CFET_MASK = 0x1c,
	CBI_TAG_BATT_FET_CFET_OFF_VAL = 0x1d,
	CBI_TAG_BATT_FET_FLAGS = 0x1e, /* enum batt_fet_flag */
	/* struct battery_info */
	CBI_TAG_BATT_VOLTAGE_MAX = 0x1f,
	CBI_TAG_BATT_VOLTAGE_NORMAL = 0x20,
	CBI_TAG_BATT_VOLTAGE_MIN = 0x21,
	CBI_TAG_BATT_PRECHARGE_VOLTAGE = 0x22,
	CBI_TAG_BATT_PRECHARGE_CURRENT = 0x23,
	CBI_TAG_BATT_START_CHARGING_MIN_C = 0x24,
	CBI_TAG_BATT_START_CHARGING_MAX_C = 0x25,
	CBI_TAG_BATT_CHARGING_MIN_C = 0x26,
	CBI_TAG_BATT_CHARGING_MAX_C = 0x27,
	CBI_TAG_BATT_DISCHARGING_MIN_C = 0x28,
	CBI_TAG_BATT_DISCHARGING_MAX_C = 0x29,
	/* Reserved for BCIC: 0x2a ~ 0x3f */
