...
enum ec_feature_code {
	...
	/*
	 * Commands for proding/writing/erasing the flash in the
	 * EC are present.
	 */
	EC_FEATURE_FLASH = 1,
	/*
	...
	/*
	 * Can control the intensity of the keyboard blacklight.
	 */
	...
	/* The keyboard is control by the EC */
	EC_FEATURE_KEYB = 7,
	...
	/* EC cand dectect when the host hangs. */
	...
	/* Control USB multiplexer, for audio through USB por for instance. */
