...
#define FP_PAIRING_KEY_EC_PUBLIC_KEY_POINT_LEN 32
...
struct ec_response_fp_establish_pairing_key_keygen {
	struct {
		uint8_t x[FP_PAIRING_KEY_EC_PUBLIC_KEY_POINT_LEN];
		uint8_t y[FP_PAIRING_KEY_EC_PUBLIC_KEY_POINT_LEN];
	} __ec_align4 pubkey;
	struct {
