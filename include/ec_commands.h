...
struct ec_params_charge_control {
	...
	/*
	 * Lower and upper thresholds for for battery sustainer. Added in v2.
	 ...
	 * will be disabled. To go back to normal mode (and disable battery
	 * sustainer), set mode=NORMAL, lower=-1, upper=-1.
	 */
	struct {
		int16_t lower;
		int16_t upper;
