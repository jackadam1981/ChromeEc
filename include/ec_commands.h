 ...
 * interpreting ACPI bytecode, to "EC_FEATURES[0-3] is not supported". Since
 * these are supported, it defaults to 0.
 * This allows detecting the presence of this field since older versions of
 * the EC codebase would simply return 0xff to these unknown addresses. Check
...
/* The list of reported features is defined in ec_features.h */
