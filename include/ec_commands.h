...
/*
 * Gather the response to the most recent VDM REQ from the AP, as well as any
 * queued VDM:Attention messages
 *
 * Note: Host command is still under contstruction and subject to change
 */
...
/* TODO(b/208884535): Add VDM:Attention queue */

struct ec_response_typec_vdm_response {
	/* Number of 32-bit fields filled in */
	uint8_t vdm_response_size;
	/* Partner to address - see enum typec_partner_type */
	uint8_t partner_type;
	/* Reserved */
	uint16_t reserved;
