...
enum ec_mkbp_event {
	...
	/* CEC has either data read out or is reporting a send failure */
	EC_MKBP_EVENT_CEC = 8,
...
/* AP sets CEC logical address */
#define EC_CMD_CEC_SET_LOGICAL_ADDR 0x00BA

struct __ec_align1 ec_params_cec_addr {
