 ...
 * and how many params it has. That way we can change the EC code without
...
/* We have to set *some* upper bound on the params */
#define EC_TMP006_MAX_PARAMS 32
struct ec_response_tmp006_get_calibration_v1 {
	uint8_t algorithm;
	uint8_t num_params;
	uint8_t reserved[2];
	float val[EC_TMP006_MAX_PARAMS];
} __packed;
