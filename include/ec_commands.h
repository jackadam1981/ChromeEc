 ...
 * one nonzero byte (MEM_STRINGS_FIFO_V1 for example) if MEM_STRINGS_FIFO is
 * supported. Returned values will indicate which strings are supported.
 */
#define EC_ACPI_MEM_STRINGS_FIFO 0x15
