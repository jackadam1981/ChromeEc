...
struct __ec_todo_packed ec_param_ec_codec_wov {
	...
	union {
		struct __ec_todo_unpacked ec_param_ec_codec_wov_get_shm_addr {
			uint8_t shm_id;
		} get_shm_addr_param;

		struct __ec_todo_unpacked ec_param_ec_codec_wov_set_lang {
			char name[20];
			uint32_t total_len;
			uint32_t offset;
			uint32_t len;
		...
		struct __ec_todo_unpacked ec_param_ec_codec_wov_set_lang_shm {
			char name[20];
		} set_lang_shm_param;
	};
} __ec_align4;
