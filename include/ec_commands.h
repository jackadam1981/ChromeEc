...
enum configure_power_button_cmds {
	/* Enable/Disable SMI pulses for x86 devices */
	ENABLE_SMI_PULSE = 0
};

struct __ec_align1 ec_params_config_powerbtn {
	/*
	 * bit 0 == 1, SMI pulse on
	 *       == 0, SMI pulse disabled
	 *
	 * other bits can be used for future config options
	 */
	uint8_t flags;
};
