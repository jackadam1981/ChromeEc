...
enum motionsense_command {
	...
	/*
	 * Setter/getter command for the lid angle at which the keyboard is
	 * disabled as a wake source in S3.
	 */
	MOTIONSENSE_CMD_KB_DISABLE_ANGLE = 5,
...
struct ec_params_motion_sense {
	...
	union {
		 ...
		 * MOTIONSENSE_CMD_KB_DISABLE_ANGLE.
		 */
		struct {
			/* Data to set or EC_MOTION_SENSE_NO_VALUE to read. */
			int16_t data;
		} ec_rate, kb_dis_angle;
...
struct ec_response_motion_sense {
	union {
		...
		struct {
			...
			int32_t ret;
		} ec_rate, sensor_odr, sensor_range, kb_dis_angle;
	};
} __packed;
