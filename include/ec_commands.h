...
enum mkbp_config_valid {
	...
	EC_MKBP_VALID_DISABLE_WAIT		= 1 << 7,
	EC_MKBP_VALID_FIFO_MAX_DEPTH		= 1 << 8,
};
...
/* Program the EC for key scan emulation sequence (fold into 0x66?) */
#define EC_CMD_KEYSCAN_SEQ_ADD 0x66
...
#define EC_CMD_KEYSCAN_SEQ_CTRL 0x67
