...
struct ec_response_usb_pd_ports_v1 {
	uint8_t num_ports;
	/*
	 * USB port mapping for each of the USBC EC's ports on the board.
	 * These USB mapping are needed for configuring the Intel Virtual MUX,
	 * as EC's USBC port number may not match AP's USB2 & USB3 port numbers.
	 * 1. Super-speed lines of USBC are connected to Intel SOC.
	 * 2. USB2 lines of USBC are connected to Intel PCH.
	 * 3. USBx ports are 1 to n based for respective USBC EC's port.
