...
#define EC_MEMMAP_POWER_SRC        0xA6 /* Power source (8 bits) */
#define EC_MEMMAP_ARTG             0xA8 /* Adapter rating (W) (32 bits) */
/* Worst case Rest Of Platform power (W) (32 bits) */
#define EC_MEMMAP_PROP             0xAC
/* Maximum platform power supported by Battery (W) (32 bits) */
#define EC_MEMMAP_BATT_PMAX        0xB0
/* Maximum sustained power for battery (W) (32 bits) */
#define EC_MEMMAP_BATT_PBSS        0xB4
/* Unused 0xb8 - 0xdf */
 ...
 */
enum ec_system_power_source {
	/*
	 * Haven't established which power source is used yet,
	 * or no presence signals are available
	 */
	POWER_SOURCE_UNKNOWN = 0,
	POWER_SOURCE_AC = BIT(0),
	POWER_SOURCE_BATTERY = BIT(1),
	POWER_SOURCE_BATTERY_1 = BIT(2),
	POWER_SOURCE_ALL = POWER_SOURCE_AC | POWER_SOURCE_BATTERY |
						POWER_SOURCE_BATTERY_1,
	POWER_SOURCE_MAX = UINT8_MAX
};
