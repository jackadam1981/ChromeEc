...
enum cbi_data_tag {
	...
	CBI_TAG_FUEL_GAUGE_FLAGS = 0x12, /* uint32_t */
	/* struct ship_mod_info */
	CBI_TAG_BATT_SHIP_MODE_REG_ADDR = 0x13, /* uint8_t */
	/* uint16_t[2] represented by uint8_t[4] */
	CBI_TAG_BATT_SHIP_MODE_REG_DATA = 0x14,
	/* struct sleep_mode_info */
	/* struct fuel_gauge_reg_addr_data represented by uint8_t[3] */
	CBI_TAG_BATT_SLEEP_MODE = 0x15,
	/* struct fet_info */
	CBI_TAG_BATT_FET_REG_ADDR = 0x16, /* uint8_t */
	CBI_TAG_BATT_FET_REG_MASK = 0x17, /* uint16_t */
	CBI_TAG_BATT_FET_DISCONNECT_VAL = 0x18, /* uint16_t */
	CBI_TAG_BATT_FET_CFET_MASK = 0x19, /* uint16_t */
	CBI_TAG_BATT_FET_CFET_OFF_VAL = 0x1a, /* uint16_t */
	/* struct battery_info */
	CBI_TAG_BATT_VOLTAGE_MAX = 0x1b, /* int32_t */
	CBI_TAG_BATT_VOLTAGE_NORMAL = 0x1c, /* int32_t */
	CBI_TAG_BATT_VOLTAGE_MIN = 0x1d, /* int32_t */
	/* struct battery_voltage_current in uint8_t[4] */
	CBI_TAG_BATT_PRECHARGE_VOLTAGE_CURRENT = 0x1e,
	/* struct battery_temperature_range represented by uint8_t[2] */
