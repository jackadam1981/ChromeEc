...
enum ec_codec_i2s_rx_daifmt {
	...
	EC_CODEC_I2S_RX_DAIFMT_PCM_A,
	EC_CODEC_I2S_RX_DAIFMT_PCM_B,
	EC_CODEC_I2S_RX_DAIFMT_PCM_TDM,
};
...
struct ec_param_ec_codec_i2s_rx {
	...
	union {
		...
		struct ec_param_ec_codec_i2s_rx_set_bclk {
			uint32_t bclk;
		} __packed set_bclk_param;

		struct ec_param_ec_codec_i2s_rx_set_tdm_config {
			/* 0 to 496 */
			int16_t ch0_delay;
			/* -1 to 496 */
			int16_t ch1_delay;
...
#define EC_CMD_EC_CODEC_WOV 0x00BE
...
enum ec_codec_wov_shm_type {
	EC_CODEC_WOV_SHM_TYPE_SYSTEM_RAM = 0,
