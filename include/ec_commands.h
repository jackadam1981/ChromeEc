...
struct sb_fw_update_status {
	uint8_t v_fail_maker_id; /* b0 */
	uint8_t v_fail_hw_id; /* b1 */
	uint8_t v_fail_fw_version; /* b2 */
	uint8_t v_fail_permanent; /* b3 */

	uint8_t rsvd5; /* b4 */
	uint8_t permanent_failure; /* b5 */
	uint8_t abnormal_condition; /* b6 */
	uint8_t fw_update_supported; /* b7 */

	uint8_t fw_update_mode; /* b8 */
	uint8_t fw_corrupted; /* b9 */
	uint8_t cmd_reject; /* b10 */
	uint8_t invalid_data; /* b11 */

	uint8_t fw_fatal_error; /* b12 */
	uint8_t fec_error;   /* b13 */
	uint8_t busy;        /* b14 */
	uint8_t rsvd15;
};
