...
#define EC_CMD_AUX_FW_PS8751_CHIP_ID "ps8751"
#define EC_CMD_AUX_FW_PS8805_CHIP_ID "ps8805"
#define EC_CMD_AUX_FW_ANX3429_CHIP_ID "anx3429"
...
struct aux_fw_chip_info {
	...
	uint8_t i2c_bus;
	uint8_t port;
	/* Protect status of the tunnel so that EC does not need to be requested again for boards that support this command */
