...
#define BB_RETIMER_FW_UPDATE_QUERY_PORT 0 /* Which ports has BB retimer */
#define BB_RETIMER_FW_UPDATE_SUSPEND_PD 1 /* Suspend PD port */
#define BB_RETIMER_FW_UPDATE_RESUME_PD  2 /* Resume PD port  */
