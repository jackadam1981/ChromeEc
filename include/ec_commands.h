 ...
 * @FP_CAPTURE_BLACK_PXL_TEST: Capture for check dark pixel test
 * @FP_CAPTURE_WHITE_PXL_TEST: Capture for check white pixel test
 * @FP_CAPTURE_DEFECT_PXL_TEST: Capture for check defect pixel test
 * @FP_CAPTURE_NOISE_TEST: Capture for check abnormal pixel test
 * @FP_CAPTURE_ABNORMAL_TEST: Capture for check abnormal pixel test
 * @FP_CAPTURE_RV_INT_TEST: Capture for pixel reset value test
...
enum fp_capture_type {
	...
	FP_CAPTURE_BLACK_PXL_TEST = 6,
	FP_CAPTURE_WHITE_PXL_TEST = 7,
	FP_CAPTURE_DEFECT_PXL_TEST = 8,
	FP_CAPTURE_NOISE_TEST = 9,
	FP_CAPTURE_ABNORMAL_TEST = 10,
	FP_CAPTURE_RV_INT_TEST = 11,
	FP_CAPTURE_TYPE_MAX,
};
