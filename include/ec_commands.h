...
struct ec_params_locate_chip {
	uint16_t type;		/* enum ec_chip_type */
	uint16_t index;		/* Specifies one instance of chip type */
...
struct ec_response_locate_chip {
	...
	uint8_t padding;	/* Aligning the following union to 2 bytes */
	union {
