 ...
 */
#define USB_CHARGER_EVT_BIT(x) BUILD_CHECK_INLINE(BIT(x), BIT(x) & 0xff)

#define USB_CHG_EVENT_BC12	USB_CHARGER_EVT_BIT(0)
#define USB_CHG_EVENT_VBUS	USB_CHARGER_EVT_BIT(1)
#define USB_CHG_EVENT_INTR	USB_CHARGER_EVT_BIT(2)
#define USB_CHG_EVENT_DR_UFP	USB_CHARGER_EVT_BIT(3)
#define USB_CHG_EVENT_DR_DFP	USB_CHARGER_EVT_BIT(4)
#define USB_CHG_EVENT_CC_OPEN	USB_CHARGER_EVT_BIT(5)
#define USB_CHG_EVENT_MUX	USB_CHARGER_EVT_BIT(6)
