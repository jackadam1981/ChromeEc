...
/**
 * Instructs the Attached.SNK to stop drawing current. This function only has
 * effect if the current Type-C state Attached.SNK.
 *
 * @param port USB_C port number
 */
__override_proto void pd_sink_stop_drawing_current(int port);
