...
/**
 * @brief Save gpio state of IO expander
 *
 ...
 */
int gpio_save_port_config(const struct device *port,
			gpio_flags_t *flags, int buff_size);

/**
 * @brief Restore gpio state of IO expander
 *
 ...
 */
int gpio_restore_port_config(const struct device *port,
			gpio_flags_t *flags, int buff_size);
