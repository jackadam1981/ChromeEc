...
/*
 * GPIO_ALL_PORTS signifies a "don't care" for the GPIO port.  This is used in
 * gpio_config_pins().  When the port parameter is set to this, the pin_mask
 * parameter is ignored.
 */
#define GPIO_ALL_PORTS 0xFFFFFFFF
