...
/**
 * Set the reboot command executed on shutdown.
 *
 * @param p: Reboot command to be executed.
 */
void system_set_reboot_at_shutdown(struct ec_params_reboot_ec *p);

/**
 * Get the reboot command to be executed on shutdown.
 *
 * @return Reboot command to be executed.
 */
