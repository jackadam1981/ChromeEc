 ...
 */
enum ec_current_image system_get_image_copy(void);
 ...
 */
enum ec_current_image system_get_ro_image_copy(void);
 ...
 * not supported.
 */
uintptr_t get_program_memory_addr(enum ec_current_image copy);
 ...
 */
const char *system_image_copy_t_to_string(enum ec_current_image copy);
 ...
 * error.
 */
int system_get_image_used(enum ec_current_image copy);

/**
 * Jump to the specified image copy.
 */
int system_run_image_copy(enum ec_current_image copy);
 ...
 */
int32_t system_get_rollback_version(enum ec_current_image copy);
 ...
 * @return	Image data
 */
const struct image_data *system_get_image_data(enum ec_current_image copy);
 ...
 * error.
 */
const char *system_get_version(enum ec_current_image copy);
 ...
 */
void system_set_image_copy(enum ec_current_image copy);
 ...
 *
 */
enum ec_current_image system_get_shrspi_image_copy(void);
 ...
 */
enum ec_current_image system_get_active_copy(void);
 ...
 */
enum ec_current_image system_get_update_copy(void);
 ...
 */
int system_set_active_copy(enum ec_current_image copy);
 ...
 */
uint32_t flash_get_rw_offset(enum ec_current_image copy);
