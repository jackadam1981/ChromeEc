 ...
 * tying up the power button for long periods when we no longer care.
 */
...
/**
 * Start/stop capturing the power button for physical presence.
 *
 * When enabled, a debounced power button press+release should call
 * physical_detect_press().
 *
 * This should be implemented by the board.
 *
 * @param enable	Enable (!=0) or disable (==0) capturing power button.
 */
