...
enum ccd_capability {
	...
	/* Allow ccd open from the console */
	CCD_CAP_OPEN_FROM_CONSOLE = 18,
...
#else
/* In prod images restrict the methods cr50 can be opened */
...
#define CAP_INFO_DATA {					  \
	...
	{"OpenW/ODevMode",	CCD_CAP_STATE_OPEN_REQ}, \
	{"OpenFromConsole",	CCD_CAP_STATE_OPEN_REQ}, \
	}
