...
struct ti50_stats {
	 ...
	 * [27: 3] - unused
	 * [ 2: 2] - CCD_MODE
	 * [ 1: 1] - rdd keep alive at boot
	 * [ 0: 0] - rdd keep alive state
	 */
	uint32_t misc_status;
};

#define METRICSV_BITS_USED_SHIFT 27
#define METRICSV_RDD_KEEP_ALIVE_MASK 1
#define METRICSV_RDD_KEEP_ALIVE_AT_BOOT_SHIFT 1
#define METRICSV_RDD_KEEP_ALIVE_AT_BOOT_MASK (1 << \
		METRICSV_RDD_KEEP_ALIVE_AT_BOOT_SHIFT)
#define METRICSV_CCD_MODE_SHIFT 2
