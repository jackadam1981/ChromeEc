...
enum vendor_cmd_cc {
	...
	VENDOR_CC_WP = 39,
	/*
	 * Either enable/disable or query TPM mode.
	 * Once TPM mode is set, it cannot be altered to the other mode value.
	 * The allowed input values are defined in
	 * 'enum tpm_mode_vendor_subcommands', tpm_registers.h.
	 *
