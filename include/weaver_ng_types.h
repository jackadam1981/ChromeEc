...
typedef struct {
	...
	union {
		...
		wng_message_reset_tree_t reset_tree;
		wng_message_insert_leaf_t insert_leaf;
		wng_message_remove_leaf_t remove_leaf;
		wng_message_try_auth_t try_auth;
		wng_message_reset_auth_t reset_auth;
	} data;
} wng_message_t;
