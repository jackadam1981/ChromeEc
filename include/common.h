 ...
 *
 * IS_ENABLED(CONFIG_MY_OPTION) will return 1 in the following cases:
 * #define CONFIG_MY_OPTION
 * #define CONFIG_MY_OPTION 1
 *
 * Otherwise if the option has not been defined or defined to anything other
