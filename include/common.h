 ...
 * take advantage of division-by-zero to raise a compiler error. If
 * you encounter division-by-zero when using IS_ENABLED, it is because
 * you are using a config value which was not either undefined or
 * empty.
 */
