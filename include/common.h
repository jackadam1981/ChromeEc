...
/*
 * Define a new macro (FIXED_SECTION) to abstract away the linker details. Each
 * build has a slightly different way of ensuring that the given section is in
 * the same relative location in both the RO/RW images.
 */
