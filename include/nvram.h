 ...
 *
 * CrOS EC currently supports two non-volatile memories but their availabilities
 * are limited:
 *
 ...
 *
 * NVRAM is a non-volatile memory stored on a flash memory. NVRAM is
 * persistently and consistently available on all platforms.
 *
