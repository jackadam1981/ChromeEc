...
/*
 * rgbkbd_map describes the mapping between key ID -> matrix coordinate (x, y).
 * Multiple keys can be mapped to the same coordinate. That means, those LEDs
 * are grouped together (a.k.a. zone) and can show only one color at a time.
 */
extern const struct rgbkbd_cord rgbkbd_map[128];
