 ...
 */
#define VDO_UFP1(ver, cap, ctype, alt, speed)				\
	(((ver) & 0x7) << 29 | ((cap) & 0xf) << 24			\
...
/* Alternate Modes */
#define UFP_TBT3        (1 << 0)
#define UFP_TBT3_REC    (1 << 1)
#define UFP_TBT3_NO_REC (1 << 2)

/* UFP VDO Device Capability */
#define UFP_USB20    (1 << 0)
#define UFP_USB20_BB (1 << 1)
#define UFP_USB32    (1 << 2)
#define UFP_USB4     (1 << 3)
/*****************************************************************************/
/*
 * Table 6-37 DFP VDO
 ...
 * <4:0>   : Port number
 */
#define VDO_DFP(ver, cap, ctype, port)			\
	(((ver) & 0x7) << 29 | ((cap) & 0x7) << 24	\
	| ((ctype) & 0x3) << 22 | ((port) & 0x1f))

/* DFP VDO Host Capability */
#define DFP_USB20 (1 << 0)
#define DFP_USB32 (1 << 1)
#define DFP_USB4  (1 << 2)
