...
#define VDO_UFP1_TBT3        (1 << 0)
#define VDO_UFP1_TBT3_REC    (1 << 1)
#define VDO_UFP1_TBT3_NO_REC (1 << 2)

/* UFP VDO 1 Device Capability */
#define VDO_UFP1_USB20           (1 << 0)
#define VDO_UFP1_USB20_BILLBOARD (1 << 1)
#define VDO_UFP1_USB32           (1 << 2)
#define VDO_UFP1_USB4            (1 << 3)
/*****************************************************************************/
/*
 * Table 6-37 DFP VDO
 * -------------------------------------------------------------
...
#define VDO_DFP_USB20 (1 << 0)
#define VDO_DFP_USB32 (1 << 1)
#define VDO_DFP_USB4  (1 << 2)
