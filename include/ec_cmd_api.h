 ...
 * macros.
 *
 * _cmd    the name of the host command
 * _v      host command version number
 * _fn     host command function name (lower case of _cmd)
 * _in     host command input (param) data type (without ec_params_ prefix)
 * _out    host command output (response) data type
 *         (without ec_response_ prefix)
 */

/*
 * Template for EC CMD API functions that take a param and returns a
 * response.
 */
...
/*
 * Template for EC CMD API functions that take a param but do not return
 * a response.
 */
...
/*
 * Template for EC CMD API functions that do not take a param but do
 * return a response.
 */
...
/*
 * Template for EC CMD API functions that do not take a param and do not
 * return a response.
 */
...
/*
 * Shorthand for host command version 0 where param and resonse name is
 * derived from the function name.
 */
#define _CROS_EC_C0_F_PF_RF(_cmd, _fn) _CROS_EC_CV_F_P_R(_cmd, 0, _fn, _fn, _fn)

/*
 * Shorthand for host command version 1 where param and resonse name is
 * derived from the function name.
 */
...
_CROS_EC_C0_F_PF_RF(EC_CMD_TYPEC_DISCOVERY, typec_discovery)
...
_CROS_EC_C0_F(EC_CMD_TP_FRAME_SNAPSHOT, tp_frame_snapshot)
_CROS_EC_C0_F(EC_CMD_TP_SELF_TEST, tp_self_test)
