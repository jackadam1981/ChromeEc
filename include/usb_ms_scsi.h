...
#define SCSI_SENSE_CODE_NOT_READY_COMMAND_REQUIRED	((0x04 << 4) | 0x02)
...
extern usb_uint ep_buf_tx[USB_MS_PACKET_SIZE] __usb_ram;
extern usb_uint ep_buf_rx[USB_MS_PACKET_SIZE] __usb_ram;
