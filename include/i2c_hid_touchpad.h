 ...
 *
 * @return the HID command identified.	< 0 - error/unsupported
 *					= 0 - not a command/request
 *					> 0 - Last byte:
 *						I2C HID commands as defined in
 *						include/i2c-hid.h
 *					      Other bytes:
 *						Parsed request content (e.g.,
 *						power state)
 */
 ...
 */
void compile_report(struct touchpad_event *event);
