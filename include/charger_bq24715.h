...
#define CHARGE_I_MIN                    (CHARGE_I_128MA)
#define CHARGE_I_MAX                    (0x1fc0)
#define CHARGE_I_STEP                   (CHARGE_I_64MA)
...
#define CHARGE_V_MIN                    (CHARGE_V_4096MV)
#define CHARGE_V_MAX                    (0x7ff0)
#define CHARGE_V_STEP                   (CHARGE_V_16MV)
...
#define MIN_SYS_V_MIN                   (MIN_SYS_V_4096MV) /* 4.096V min. */
...
#define INPUT_I_MIN                    (INPUT_I_128MA)
#define INPUT_I_MAX                    (0x1fc0) /* 8.064mA */
#define INPUT_I_STEP                   (INPUT_I_64MA)
