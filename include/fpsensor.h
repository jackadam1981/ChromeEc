...
extern enum fp_sensor_type sensor_type;
...
struct fp_sensor_interface_t {
	 ...
	 * one.
	 */
	int (*fp_sensor_acquire_image_with_mode_ptr)(uint8_t *image_data,
						     int mode);
...
extern struct fp_sensor_interface_t *fp_driver;
