...
/**
 * Determine which charger IC is to be used based upon charge port.
 *
 * @param chg_port The charge port selected by charge manager.
 */
int board_get_chg_chip_from_chg_port(int chg_port);

/**
 * Select which charger IC will actually be peforming the charger switching.
 *
