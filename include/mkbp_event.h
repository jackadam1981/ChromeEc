 ...
 *
 * The default implementation in mkbp_event.c has weak linkage and can
 * by individual boards depending on their hardware configuration.
 *
 ...
 *
 * This can be used without a dedicated interrupt pin configured.
 */
