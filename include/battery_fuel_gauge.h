...
#ifdef CONFIG_ZEPHYR
BUILD_ASSERT(FG_FLAG_WRITE_BLOCK == FUEL_GAUGE_FLAG_WRITE_BLOCK);
BUILD_ASSERT(FG_FLAG_SLEEP_MODE == FUEL_GAUGE_FLAG_SLEEP_MODE);
BUILD_ASSERT(FG_FLAG_MFGACC == FUEL_GAUGE_FLAG_MFGACC);
BUILD_ASSERT(FG_FLAG_MFGACC_SMB_BLOCK == FUEL_GAUGE_FLAG_MFGACC_SMB_BLOCK);
#endif
