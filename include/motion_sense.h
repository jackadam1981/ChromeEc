...
/*
 * Fifo size in events and Min and Max sampling frequencies in
 * miliHertz for Chrome-supported motion sensor chips.
 */
#define MOTIONSENSE_CHIP_BMA255_ACCEL_MAX_FIFO_EVENT_COUNT  32
#define MOTIONSENSE_CHIP_BMA255_ACCEL_MIN_FREQ              7810
#define MOTIONSENSE_CHIP_BMA255_ACCEL_MAX_FREQ              1000000

/*
 * BMI160 FIFO is in header mode, so
 * max events = 1024 / (12 sensor data + 1 header)
 */
#define MOTIONSENSE_CHIP_BMI160_ACCEL_MAX_FIFO_EVENT_COUNT  78
#define MOTIONSENSE_CHIP_BMI160_ACCEL_MIN_FREQ              781
#define MOTIONSENSE_CHIP_BMI160_ACCEL_MAX_FREQ              1600000
#define MOTIONSENSE_CHIP_BMI160_GYRO_MAX_FIFO_EVENT_COUNT   78
#define MOTIONSENSE_CHIP_BMI160_GYRO_MIN_FREQ               25
#define MOTIONSENSE_CHIP_BMI160_GYRO_MAX_FREQ               3200000
#define MOTIONSENSE_CHIP_BMI160_MAG_MAX_FIFO_EVENT_COUNT    78
#define MOTIONSENSE_CHIP_BMI160_MAG_MIN_FREQ                781
#define MOTIONSENSE_CHIP_BMI160_MAG_MAX_FREQ                800000

#define MOTIONSENSE_CHIP_BMP280_BARO_MAX_FIFO_EVENT_COUNT   1
#define MOTIONSENSE_CHIP_BMP280_BARO_MIN_FREQ               17
#define MOTIONSENSE_CHIP_BMP280_BARO_MAX_FREQ               181800

#define MOTIONSENSE_CHIP_OPT3001_LIGHT_MAX_FIFO_EVENT_COUNT 1
#define MOTIONSENSE_CHIP_OPT3001_LIGHT_MIN_FREQ             1250
#define MOTIONSENSE_CHIP_OPT3001_LIGHT_MAX_FREQ             10000

#define MOTIONSENSE_CHIP_KX022_ACCEL_MAX_FIFO_EVENT_COUNT   41
