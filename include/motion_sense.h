...
#define TASK_EVENT_MOTION_FIRST_HW_EVENT    2
#define TASK_EVENT_MOTION_INTERRUPT_NB      8
#define TASK_EVENT_MOTION_INTERRUPT_MASK    \
	(((1 << TASK_EVENT_MOTION_INTERRUPT_NB) - 1) << \
	 TASK_EVENT_MOTION_FIRST_HW_EVENT)
#define TASK_EVENT_MOTION_SENSOR_INTERRUPT(_sensor_id) \
	(TASK_EVENT_CUSTOM( \
		1 << (TASK_EVENT_MOTION_FIRST_HW_EVENT + (_sensor_id))))
#define TASK_EVENT_MOTION_FIRST_SW_EVENT   \
	(TASK_EVENT_MOTION_FIRST_HW_EVENT + TASK_EVENT_MOTION_INTERRUPT_NB)
