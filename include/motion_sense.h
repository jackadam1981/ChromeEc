...
#define TASK_EVENT_MOTION_FLUSH_PENDING     TASK_EVENT_CUSTOM(1 << 0)
#define TASK_EVENT_MOTION_ODR_CHANGE        TASK_EVENT_CUSTOM(1 << 1)
/* Next 8 events for sensor interrupt lines */
#define TASK_EVENT_MOTION_FIRST_HW_EVENT_BIT    2
#define TASK_EVENT_MOTION_INTERRUPT_NUM      8
#define TASK_EVENT_MOTION_INTERRUPT_MASK    \
	(((1 << TASK_EVENT_MOTION_INTERRUPT_NUM) - 1) << \
	 TASK_EVENT_MOTION_FIRST_HW_EVENT_BIT)
#define TASK_EVENT_MOTION_SENSOR_INTERRUPT(_sensor_id) \
	(TASK_EVENT_CUSTOM( \
		1 << (TASK_EVENT_MOTION_FIRST_HW_EVENT_BIT + (_sensor_id))))
#define TASK_EVENT_MOTION_FIRST_SW_EVENT   \
	(TASK_EVENT_MOTION_FIRST_HW_EVENT_BIT + TASK_EVENT_MOTION_INTERRUPT_NUM)
