 ...
 */
#define SLAVE_IS_SPI_MASK		I2C_FLAG_ADDR_IS_SPI

#define SLAVE_MK_I2C_ADDR__7bf(x__7b)	(x__7b)
#define SLAVE_MK_SPI_ADDR__7bf(x__7b)	((x__7b) | SLAVE_IS_SPI_MASK)

#define SLAVE_I2C_ADDR__7b(x__7bf)	((x__7bf) & I2C_ADDR_MASK)
#define SLAVE_SPI_ADDR__7b(x__7bf)	((x__7bf) & I2C_ADDR_MASK)

#define SLAVE_IS_SPI(x__7bf)		((x__7bf) & SLAVE_IS_SPI_MASK)
