...
/*
 * Time at which the last element has been added into the fifo.
 * the unit is in CONFIG_ACCEL_TIMESTAMP_UNIT.
 */
extern timestamp_t motion_fifo_timestamp;
...
#else
#define TASK_EVENT_MOTION_FLUSH_PENDING 0
#define TASK_EVENT_MOTION_ODR_CHANGE    0
#endif

#ifdef CONFIG_ACCEL_INTERRUPTS
#define TASK_EVENT_MOTION_INTERRUPT     TASK_EVENT_CUSTOM(2)
#else
#define TASK_EVENT_MOTION_INTERRUPT     0
#endif
