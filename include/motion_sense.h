...
/* Marks which AP power states a sensor is powered and active */
#define SENSOR_ACTIVE_S0	BIT(0)
#define SENSOR_ACTIVE_S3	BIT(3)
#define SENSOR_ACTIVE_S5	BIT(5)
#define SENSOR_ACTIVE_S0_S3	(BIT(0) | BIT(5))
#define SENSOR_ACTIVE_S0_S3_S5	(BIT(0) | BIT(3) | BIT(5))
