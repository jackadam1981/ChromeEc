 ...
 *
 * Note: per-port events will be retrieved through pd_get_event(), but this
 * function will continue to notify the AP there are events to retrieve, and
 * direct it to the per-port events through PD_EVENT_TYPEC
 *
 ...
 *
 * @param port USB-C port number
 * @param clear_mask bitmask of events to clear
 */
