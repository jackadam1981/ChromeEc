 ...
 * pointer from pd_get_am_discovery() since last clear.
 *
 * @param port USB-C port number
 * @param type Transmit type (SOP, SOP')
 ...
 * Note: Caller function can mutate the data in this structure.  TCPMv2 will
 * track access to this data when callers are reading it out.
 *
 * @param port USB-C port number
