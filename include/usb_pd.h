...
#define DISCOVERY_TYPE_MAX TCPC_TX_SOP_PRIME_PRIME
#else
#define DISCOVERY_TYPE_MAX TCPC_TX_SOP
#endif
...
struct pd_discovery {
	...
	struct identity_data identity[DISCOVERY_TYPE_MAX + 1];
 ...
 * @return      pointer to response structure, which the caller may alter
 */
...
/*
 * Return the pointer to PD alternate mode discovery results
