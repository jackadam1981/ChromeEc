...
enum cable_flags {
	...
	CABLE_FLAGS_SOP_PRIME_ENABLE,
	/* Flag for sending SOP Prime Prime packet */
	CABLE_FLAGS_SOP_PRIME_PRIME_ENABLE,
	/* Check if Thunderbolt-compatible mode enabled */
	CABLE_FLAGS_TBT_COMPAT_ENABLE,
	/* Check if Enter Thunderbolt-compatible mode */
	CABLE_FLAGS_TBT_COMPAT_READY,
