...
#define SKEDB_SM_PPS_CHARGING_SUPPORTED BIT(0)
#define SKEDB_SM_VBUS_POWERED BIT(1)
#define SKEDB_SM_MAINS_POWERED BIT(2)
#define SKEDB_SM_BATTERY_POWERED BIT(3)
#define SKEDB_SM_BATTERY_ESSENTIALLY_UNLIMITED BIT(4)
#define SKEDB_SM_AVS_SUPPORTED BIT(5)
