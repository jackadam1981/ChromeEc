...
struct vdo_rev20 {
	enum ss_support ss: 3;
	uint32_t controller : 1;
	uint32_t vbus_cable : 1;
	enum current_capacity current : 2;
	enum dir_support ssrx2 : 1;
	enum dir_support ssrx1 : 1;
	enum dir_support sstx2 : 1;
	enum dir_support sstx1 : 1;
...
#define CABLE_FLAGS_SOP_PRIME_ENABLE	BIT(20)
