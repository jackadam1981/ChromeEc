...
/**
 * Looks if the specified SVID is discovered and sets vdo_out with
 * discovered mode VDO of specificed SVID.
 *
 * @param port     USB-C port number
 * @param type     Transmit type (SOP, SOP') for VDM
 * @param svid     SVID to get
 * @param vdo_out  Discover Mode VDO response to set
 * @return         True if specified SVID is discovered,
 *                 False otherwise
 */
...
/**
 * Returns Mode VDO for Intel SVID
 *
 * @param port  USB-C port number
 * @param type  Transmit type (SOP, SOP') for VDM
 * @return      Discover Mode VDO for Intel SVID
 */
