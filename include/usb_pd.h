...
/* States supported by all configurations */
#define PD_STATE_00(state) PD_STATE_##state
#define PD_STATE_01(state) PD_STATE_##state
#define PD_STATE_14(state) PD_STATE_##state
#define PD_STATE_15(state) PD_STATE_##state
#define PD_STATE_16(state) PD_STATE_##state
#define PD_STATE_17(state) PD_STATE_##state
#define PD_STATE_18(state) PD_STATE_##state
#define PD_STATE_19(state) PD_STATE_##state
#define PD_STATE_20(state) PD_STATE_##state
#define PD_STATE_21(state) PD_STATE_##state
#define PD_STATE_22(state) PD_STATE_##state
#define PD_STATE_23(state) PD_STATE_##state
#define PD_STATE_24(state) PD_STATE_##state
#define PD_STATE_25(state) PD_STATE_##state
#define PD_STATE_33(state) PD_STATE_##state
#define PD_STATE_34(state) PD_STATE_##state
#define PD_STATE_35(state) PD_STATE_##state

/* States supported by dual role devices */
#ifdef CONFIG_USB_PD_DUAL_ROLE
#define PD_STATE_02(state) PD_STATE_##state
#define PD_STATE_03(state) PD_STATE_##state
#define PD_STATE_04(state) PD_STATE_##state
#define PD_STATE_05(state) PD_STATE_##state
#define PD_STATE_06(state) PD_STATE_##state
#define PD_STATE_07(state) PD_STATE_##state
#define PD_STATE_08(state) PD_STATE_##state
#define PD_STATE_09(state) PD_STATE_##state
#define PD_STATE_10(state) PD_STATE_##state
#define PD_STATE_11(state) PD_STATE_##state
#define PD_STATE_12(state) PD_STATE_##state
#define PD_STATE_13(state) PD_STATE_##state
#define PD_STATE_26(state) PD_STATE_##state
#define PD_STATE_27(state) PD_STATE_##state
#define PD_STATE_28(state) PD_STATE_##state
#define PD_STATE_29(state) PD_STATE_##state
#ifdef CONFIG_USBC_VCONN_SWAP
#define PD_STATE_30(state) PD_STATE_##state
#define PD_STATE_31(state) PD_STATE_##state
#define PD_STATE_32(state) PD_STATE_##state
#else
#define PD_STATE_30(state) PD_STATE_UNSUPPORTED_30
#define PD_STATE_31(state) PD_STATE_UNSUPPORTED_31
#define PD_STATE_32(state) PD_STATE_UNSUPPORTED_32
#endif

#else /* !CONFIG_USB_PD_DUAL_ROLE */

#define PD_STATE_02(state) PD_STATE_UNSUPPORTED_02
#define PD_STATE_03(state) PD_STATE_UNSUPPORTED_03
#define PD_STATE_04(state) PD_STATE_UNSUPPORTED_04
#define PD_STATE_05(state) PD_STATE_UNSUPPORTED_05
#define PD_STATE_06(state) PD_STATE_UNSUPPORTED_06
#define PD_STATE_07(state) PD_STATE_UNSUPPORTED_07
#define PD_STATE_08(state) PD_STATE_UNSUPPORTED_08
#define PD_STATE_09(state) PD_STATE_UNSUPPORTED_09
#define PD_STATE_10(state) PD_STATE_UNSUPPORTED_10
#define PD_STATE_11(state) PD_STATE_UNSUPPORTED_11
#define PD_STATE_12(state) PD_STATE_UNSUPPORTED_12
#define PD_STATE_13(state) PD_STATE_UNSUPPORTED_13
#define PD_STATE_26(state) PD_STATE_UNSUPPORTED_26
#define PD_STATE_27(state) PD_STATE_UNSUPPORTED_27
#define PD_STATE_28(state) PD_STATE_UNSUPPORTED_28
#define PD_STATE_29(state) PD_STATE_UNSUPPORTED_29
#define PD_STATE_30(state) PD_STATE_UNSUPPORTED_30
#define PD_STATE_31(state) PD_STATE_UNSUPPORTED_31
#define PD_STATE_32(state) PD_STATE_UNSUPPORTED_32
...
#define PD_STATE_36(state) PD_STATE_##state
#define PD_STATE_37(state) PD_STATE_##state
#else
#define PD_STATE_36(state) PD_STATE_UNSUPPORTED_36
#define PD_STATE_37(state) PD_STATE_UNSUPPORTED_37
#endif

#ifdef CONFIG_USB_PD_DUAL_ROLE_AUTO_TOGGLE
#define PD_STATE_38(state) PD_STATE_##state
#else
#define PD_STATE_38(state) PD_STATE_UNSUPPORTED_38
#endif

enum pd_states {
	PD_STATE_00(DISABLED),
	PD_STATE_01(SUSPENDED),
	PD_STATE_02(SNK_DISCONNECTED),
	PD_STATE_03(SNK_DISCONNECTED_DEBOUNCE),
	PD_STATE_04(SNK_HARD_RESET_RECOVER),
	PD_STATE_05(SNK_DISCOVERY),
	PD_STATE_06(SNK_REQUESTED),
	PD_STATE_07(SNK_TRANSITION),
	PD_STATE_08(SNK_READY),
	PD_STATE_09(SNK_SWAP_INIT),
	PD_STATE_10(SNK_SWAP_SNK_DISABLE),
	PD_STATE_11(SNK_SWAP_SRC_DISABLE),
	PD_STATE_12(SNK_SWAP_STANDBY),
	PD_STATE_13(SNK_SWAP_COMPLETE),
	PD_STATE_14(SRC_DISCONNECTED),
	PD_STATE_15(SRC_DISCONNECTED_DEBOUNCE),
	PD_STATE_16(SRC_HARD_RESET_RECOVER),
	PD_STATE_17(SRC_STARTUP),
	PD_STATE_18(SRC_DISCOVERY),
	PD_STATE_19(SRC_NEGOCIATE),
	PD_STATE_20(SRC_ACCEPTED),
	PD_STATE_21(SRC_POWERED),
	PD_STATE_22(SRC_TRANSITION),
	PD_STATE_23(SRC_READY),
	PD_STATE_24(SRC_GET_SINK_CAP),
	PD_STATE_25(DR_SWAP),
	PD_STATE_26(SRC_SWAP_INIT),
	PD_STATE_27(SRC_SWAP_SNK_DISABLE),
	PD_STATE_28(SRC_SWAP_SRC_DISABLE),
	PD_STATE_29(SRC_SWAP_STANDBY),
	PD_STATE_30(VCONN_SWAP_SEND),
	PD_STATE_31(VCONN_SWAP_INIT),
	PD_STATE_32(VCONN_SWAP_READY),
	PD_STATE_33(SOFT_RESET),
	PD_STATE_34(HARD_RESET_SEND),
	PD_STATE_35(HARD_RESET_EXECUTE),
	PD_STATE_36(BIST_RX),
	PD_STATE_37(BIST_TX),
	PD_STATE_38(DRP_AUTO_TOGGLE),
