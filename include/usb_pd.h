 ...
 * @param port USB-C port number
 * @param type USB-C port partner
 * @return 0 for VDM_VER1.0, 1 for VDM_VER2.0
 */
 ...
 */
__override_proto union tbt_dev_mode_enter_cmd pd_ufp_get_enter_mode(int port);
 ...
 * @param port     USB-C port number
 */
__override_proto void ufp_clear_alt_mode(int port);
 ...
 * @param port     USB-C port number
 */
__override_proto void ufp_mux_set_alt_mode(int port);
