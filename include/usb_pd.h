...
enum pd_debug_interval {
	 ...
	 */
	PD_INTERVAL_INVALID,
	PD_INTERVAL_UNATTACHED_SRC_ENTRY,
	PD_INTERVAL_UNATTACHED_SRC_RUN,
	PD_INTERVAL_UNATTACHED_SRC_EXIT,

	PD_INTERVAL_UNATTACHED_SNK_ENTRY,
	PD_INTERVAL_UNATTACHED_SNK_RUN,
	PD_INTERVAL_UNATTACHED_SNK_EXIT,

	PD_INTERVAL_ATTACHWAIT_SRC_ENTRY,
	PD_INTERVAL_ATTACHWAIT_SRC_RUN,
	PD_INTERVAL_ATTACHWAIT_SRC_EXIT,

	PD_INTERVAL_ATTACHWAIT_SNK_ENTRY,
	PD_INTERVAL_ATTACHWAIT_SNK_RUN,
	PD_INTERVAL_ATTACHWAIT_SNK_EXIT,

	PD_INTERVAL_ATTACHED_SRC_ENTRY,
	PD_INTERVAL_ATTACHED_SRC_RUN,
	PD_INTERVAL_ATTACHED_SRC_EXIT,

	PD_INTERVAL_ATTACHED_SNK_ENTRY,
	PD_INTERVAL_ATTACHED_SNK_RUN,
	PD_INTERVAL_ATTACHED_SNK_EXIT,

	PD_INTERVAL_TSRC_DISCONNECT,
	PD_INTERVAL_CC_DETECT_RD,
