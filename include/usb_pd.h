...
union sido {
	struct {
		struct {
			/* PDP values are the integer portion (floor) of the
		...
		struct {
			/* PDP values are rounded to the nearest 0.5W of the
			 * relevant PDP rating in W.
			 */
			uint32_t port_guaranteed_pdp : 9;
			uint32_t port_maximum_pdp : 9;
