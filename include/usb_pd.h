...
#define PD_T_SENDER_RESPONSE        (21*MSEC) /* between 24ms and 30ms */ 
#define PD_T_PS_SOURCE_ON          (420*MSEC) /* between 390ms and 480ms */	
#define PD_T_PD_DEBOUNCE            (11*MSEC) /* between 10ms and 20ms */
