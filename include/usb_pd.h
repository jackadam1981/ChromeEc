...
union cable_vdo {
	...
	/* Thunderbolt-compatible passive cable VDO */
	union tbt_passive_cable_vdo_rev20 p_tbt_rev20;
	union tbt_passive_cable_vdo_rev30 p_tbt_rev30;

	uint32_t raw_value;
};

union tbt_vdo_response {
	union tbt_mode_resp_device dev_mode;
	union tbt_mode_resp_cable cable_mode;
...
struct pd_cable {
	...
	union cable_vdo attr2;
	/* For storing Discover mode response from device */
	union tbt_vdo_response dev_mode_resp;
	/* For storing Discover mode response from cable */
	union tbt_vdo_response cable_mode_resp;
};
