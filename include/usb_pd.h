...
#define PDO_GET_TYPE(pdo) ((pdo) >> 30)
...
#define PDO_FIXED_GET_DRP(pdo) (((pdo) >> 29) & 1)
#define PDO_FIXED_GET_UNCONSTRAINED_PWR(pdo) (((pdo) >> 27) & 1)
#define PDO_FIXED_GET_USB_COMM_CAPABLE(pod) (((pdo) >> 26) & 1)
