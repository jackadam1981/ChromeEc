 ...
 *
 * @return Bits[7:0]: represent port 0-7 (ports 1 - 8 in AP)
 *         EC port is  0-base; bit 0 is port 0, while bit 7 is port 7
...
/**
 * Result of last BB retimer firmware update operation requsted
