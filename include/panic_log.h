...
static inline void panic_log_init(void){};
static inline void panic_log_write_char(const char c){};
static inline void panic_log_write_str(const char *str, size_t size){};
