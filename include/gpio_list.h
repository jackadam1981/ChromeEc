...
#define UNCONNECTED(pin) {GPIO_##pin},
/* Unconnected pin list. */
const struct unconnected_pin_info unconnected_pin_list[] = {
	#include "gpio.wrap"
};

const int unconnected_pin_count = ARRAY_SIZE(unconnected_pin_list);
