...
#define TCS_MIN_ATIME 0x89 /* 400 ms */	
#define TCS_MAX_ATIME 0xFF /* 712 ms */ 
#define TCS_ATIME_GRANULARITY 256 /* 256 atime settings */
#define TCS_SATURATION_LEVEL 0xffff /* for 0 < atime < 0x70 */
#define TCS_DEFAULT_ATIME TCS_MAX_ATIME /* 712 ms */
#define TCS_CALIBRATION_ATIME TCS_MAX_ATIME
#define TCS_GAIN_UPSHIFT_ATIME TCS_MIN_ATIME
