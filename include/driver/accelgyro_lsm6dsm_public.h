...
#ifndef __CROS_EC_ACCELGYRO_LSM6DSM_PUBLIC_H
#define __CROS_EC_ACCELGYRO_LSM6DSM_PUBLIC_H
...
#define LSM6DSM_ODR_MAX_VAL MOTION_MAX_SENSOR_FREQUENCY(416000, 13000)

#endif /* __CROS_EC_ACCELGYRO_LSM6DSM_PUBLIC_H */
