 ...
 * return a temperature in degrees Millikelvin.
 *
 ...
 * @param temp_ptr	Destination for temperature (in degrees Millikelvin)
 *
 ...
 *
 * @param idx_adc	The idx value from the temp_sensor_t struct, which is
 *			the ADC channel to read and convert to Millikelvin
 * @param temp_ptr	Destination for temperature (in degrees Millikelvin)
 *
 * @return EC_SUCCESS, or non-zero if error.
 */
