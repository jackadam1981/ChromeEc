...
#define APL6012_I2C_ADDR_FLAGS 0x7E
#define APL6012_I2C_ADDR_FLAGS_CUSTOM 0x38
 ...
 *
 * @param idx		Index to read, from board's enum apl6012_sensor
 *			definition
 *
...
int apl6012_get_thermistor_val(const struct temp_sensor_t *sensor,
			      int *temp_ptr);
