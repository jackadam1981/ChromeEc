 ...
 * BATTERY_CUTOFF_STATE_CUT_OFF: Battery cutoff has been completed. EC doesn't
 * see this state unless AC is plugged.
 * BATTERY_CUTOFF_STATE_SCHEDULED: Battery cutoff is requested by the AP but
 * hasn't started.
 */
