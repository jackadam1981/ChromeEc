...
struct charger_drv {
	 ...
	 */
	enum ocpc_pid_status (*set_vsys_compensation)(int chgnum,
						      struct ocpc_data *o,
						      int current_ma,
						      int voltage_mv);
};
 ...
 * charger ICs can dynamically compensate meaning that the PID loop is not
 ...
 * @return OCPC_PID_LOOP_[NOT_]_NEEDED or UNKNOWN_ERROR
 */
