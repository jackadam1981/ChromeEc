 ...
 * 		should be pointing to the data section of CBI.
 * @param tag	Tag of the data item
 * @param str	Pointer to the string data being copied. If pointer is NULL, this
 * 		function will ignore adding the tag as well. Else, the string data
 * 		will be added to CBI using size of string length + 1.
