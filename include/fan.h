...
/**
 * Individual boards may provide a custom function to translate a
 * cooling-needed percentage into a target RPM, if the default function
 * isn't sufficient. This is that function.
 *
