...
/* Super States */
static unsigned int tc_state_host_rd(int port, enum signal sig);
static unsigned int tc_state_host_rd_entry(int port);
static unsigned int tc_state_host_rd_run(int port);
static unsigned int tc_state_host_rd_exit(int port);
...
static const state_sig tc_state_host_rd_sig[] = {
	tc_state_host_rd_entry,
	tc_state_host_rd_run,
	tc_state_host_rd_exit,
	get_super_state
};
...
static unsigned int tc_state_unattached_snk(int port, enum signal sig)
{
	...
	return SUPER(ret, sig, tc_state_host_rd);
}
...
static unsigned int tc_state_host_rd(int port, enum signal sig)
{
	...
	ret = (*tc_state_host_rd_sig[sig])(port);
