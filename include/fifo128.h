...
inline int fifo128_is_full(struct fifo128 *que)
{
	return ((que->write_ptr ^ que->read_ptr) ==  FIFO_SIZE_128);
}

inline int fifo128_is_empty(struct fifo128 *que)
{
	return (que->read_ptr == que->write_ptr);
}

inline int fifo128_get_size(struct fifo128 *que)
{
	return (que->read_ptr > que->write_ptr) ?
...
inline int fifo128_enque8(struct fifo128 *que, uint8_t k)
{
...
inline uint8_t *fifo128_at8(struct fifo128 *que, int ith)
{
...
inline uint8_t *fifo128_top8(struct fifo128 *que)
{
	return fifo128_at8(que, 0);
}

inline int fifo128_deque8(struct fifo128 *que, uint8_t *pK)
{
...
inline int fifo128_enque32(struct fifo128 *que, uint32_t k)
{
	register int is_full = fifo128_is_full(que);
	if (!is_full) {
...
inline uint32_t *fifo128_at32(struct fifo128 *que, int ith)
{
...
inline uint32_t *fifo128_top32(struct fifo128 *que)
{
	return fifo128_at32(que, 0);
}

inline int fifo128_deque32(struct fifo128 *que, uint32_t *pK)
{
	register int size = fifo128_get_size(que);
...
#ifdef SELF_TEST
inline void fifo128_print8(struct fifo128 *que)
{
	register int size = fifo128_get_size(que);
	int i;
	CPRINTS("---------sz: %d -------------------\n", size);
...
inline void fifo128_print32(struct fifo128 *que)
{
	register int size = fifo128_get_size(que);
	int i;
	CPRINTS("---------sz: %d -------------------\n", size);
