...
/* Awasuki board runs from ILM */
#undef CONFIG_IT83XX_EXTENDED_ILM_AWASUKI_BOARD
...
/* USBC intr task runs from ILM */
#undef CONFIG_IT83XX_EXTENDED_ILM_USBC_INTR_TASK
/* USBC task runs from ILM */
#undef CONFIG_IT83XX_EXTENDED_ILM_USBC_TASK
/* USBC SM runs from ILM */
#undef CONFIG_IT83XX_EXTENDED_ILM_USBC_SM
...
/* Select CONFIG_IT83XX_EXTENDED_ILM automatically */
#if defined(CONFIG_IT83XX_EXTENDED_ILM_AWASUKI_BOARD) ||      \
	defined(CONFIG_IT83XX_EXTENDED_ILM_HWTIMER_DRIVER) || \
	...
	defined(CONFIG_IT83XX_EXTENDED_ILM_USBC_INTR_TASK) || \
	defined(CONFIG_IT83XX_EXTENDED_ILM_USBC_TASK) ||      \
	defined(CONFIG_IT83XX_EXTENDED_ILM_USBC_SM) ||        \
