...
/*
 * Enable tcs3400 to operate in polling mode. This config is used in conjunction
 * with CONFIG_ALS_TCS3400_INT_EVENT. When polling is enabled, the read is
 * initiated in the same manner as when interrupts are used, but the event which
 * triggers the irq_handler is generated by deferred call using a fixed delay.
 * Use this option if your board does not have an interrupt pin for als.
 */
