 ...
 * reset.
 */
#undef CONFIG_HOLD_STARUP_ON_POR
 ...
 */
#if defined(CONFIG_USB_PD_TCPMV2) && !defined(CONFIG_HOLD_STARUP_ON_POR)
#error TPMV2 relies on correct power on flag after CR50 double reset.
#endif
