...
/*
 * Use a binary search to scan key. First drive the all (16) columns to scan,
 * then halfing it to 8, 4, 2, and 1. It reduces the number of scans for the
 * paths, which are clearly impossible.
 */
