...
/* Define if auto discharge disconect circuit is using PD discharge
 * registers on TCPC.
 */
#undef CONFIG_USB_PD_AUTO_DISCHARGE_DISCONECT_TCPC
...
#define CONFIG_USB_PD_AUTO_DISCHARGE_DISCONECT_TCPC
