...
/*
 * Allow VolumeUp + AC disconnect battery cutoff sequence.
 */
...
#if defined(CONFIG_BATTERY_CUTOFF_VOL_UP) && !defined(CONFIG_VOLUME_BUTTONS)
#error "VOLUME_BUTTONS must be defined to use BATTERY_CUTOFF_VOL_UP"
#endif
