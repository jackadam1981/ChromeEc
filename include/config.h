 ...
 */
#undef CONFIG_ACCELGYRO_ICM_SPI
#undef CONFIG_ACCELGYRO_ICM_I2C
 ...
 * automatically be set.
 */
#undef CONFIG_ACCELGYRO_BMI_SPI
#undef CONFIG_ACCELGYRO_BMI_I2C
...
#if !defined(CONFIG_ACCELGYRO_ICM_SPI) && !defined(CONFIG_ACCELGYRO_ICM_I2C)
#ifdef I2C_PORT_ACCEL
#define CONFIG_ACCELGYRO_ICM_I2C
#else
#define CONFIG_ACCELGYRO_ICM_SPI
#endif
#endif /* !CONFIG_ACCELGYRO_ICM_SPI && !CONFIG_ACCELGYRO_ICM_I2C */

#if !defined(CONFIG_ZEPHYR) && !defined(CONFIG_ACCELGYRO_BMI_SPI) && \
	!defined(CONFIG_ACCELGYRO_BMI_I2C)
#ifdef I2C_PORT_ACCEL
#define CONFIG_ACCELGYRO_BMI_I2C
#else
#define CONFIG_ACCELGYRO_BMI_SPI
#endif
#endif /* !CONFIG_ACCELGYRO_BMI_SPI && !CONFIG_ACCELGYRO_BMI_I2C */
