 ...
 * enabled otherwise an error will be emmitted.
 */
 ...
 * Also these defines don't take affect unless CONFIG_USB_PD_TCPMV2 is also
 * defined.
 *
...
/* Define to enable USB State Machine framwework. */
...
#error Must define at least one CONFIG_USB_ device type.
#endif
#endif
