 ...
 * in the USB-IF Product Registration form for this device. This macro is used
 * during VIF generation and is to generate the product name in the
 ...
 */
#undef CONFIG_USB_PD_MANUFACTURE_INFO
