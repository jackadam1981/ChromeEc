...
/* Define to enable USB TypeC testing api */
#undef CONFIG_ENABLE_USB_TYPEC_TESTING

/* Define to enable USB Protocol Layer testing api */
#undef CONFIG_ENABLE_USB_PRL_TESTING
 ...
 * with CONFIG_USB_SM_FRAMEWORK and CONFIG_USB_TYPEC
 */
