...
#undef CONFIG_ALS_BH1730_CONSTANTS
 ...
 * See Crosbug #51207 for detail info.
 */
...
#define CONFIG_PRECHARGE_TIMEOUT 30
...
#define CONFIG_CMD_HIBDELAY
#define CONFIG_CMD_HIBERNATE
...
#define CONFIG_CMD_SPI_FLASHINFO
