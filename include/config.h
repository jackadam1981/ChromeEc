 ...
 *
 * This is on by default. There are relaxed security implications for boards
 * without a matrix keyboard. Boards must manually undefine it if they don't
 * have an internal keyboard.
 */
