...
/*
 * Support common RGB PWM-controlled LEDs that conform to the Chrome OS LED
 ...
 */
#define CONFIG_LED_RGB_CHARGE_COLOR EC_LED_COLOR_AMBER
#define CONFIG_LED_RGB_NEAR_FULL_COLOR EC_LED_COLOR_GREEN
#define CONFIG_LED_RGB_CHARGE_ERROR_COLOR EC_LED_COLOR_RED
#define CONFIG_LED_RGB_SOC_ON_COLOR EC_LED_COLOR_GREEN
#define CONFIG_LED_RGB_SOC_SUSPEND_COLOR EC_LED_COLOR_GREEN
#define CONFIG_LED_RGB_LOW_BATT_COLOR EC_LED_COLOR_AMBER

/*
 * How many RGB LEDs does the system have that will be controlled by the common
 * RGB LED policy?
 */
