...
/*
 * The board has brightness up and brightness down buttons.
 * Note, these are *buttons* and not keys in the keyboard matrix.
 */
#undef CONFIG_BRIGHTNESS_BUTTONS

/*
 * The board has screen lock buttons.
 * Note, these are *buttons* and not keys in the keyboard matrix.
 */
#undef CONFIG_SCREENLOCK_BUTTONS
