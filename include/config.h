 ...
 * in the range of 8 2.4 V to 8.0 V to be specified.
 */
 ...
 * limit deglitch time (IDCHG_DEG2). This is a 2 bit field with default
 * value 1 (1.6 ms). The encoded value ranges from 100 us to 12 ms.
 */
