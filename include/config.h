...
/*
 * Enable RF charge for peripheral device charger. This allows the board to give
 * a peripheral device wrongly detected as a foreign object a chance to recover.
 */
