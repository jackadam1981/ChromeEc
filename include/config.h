...
/**
 * Preserve EC reset logs and console logs on SRAM so that the logs will be
 * preserved after EC shutting down. It will keep the contents across EC resets,
 * so that we have more information about system states.
 */
