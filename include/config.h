...
/******************************************************************************/
/*
 * If CONFIG_USB_POWER_DELIVERY is enabled, make sure either only one of
 * CONFIG_USB_PD_TCPMV1, CONFIG_USB_PD_TCPMV2, or CONFIG_USB_PD_CONTROLLER
 * is enabled. Also make sure CONFIG_USB_PD_DECODE_SOP is enabled with
