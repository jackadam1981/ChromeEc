...
/*
 * Enables Version 2 of the Power Deleiver state machine
 *
...
/******************************************************************************/
/*
 * If CONFIG_USB_POWER_DELIVER is enabled, make sure either CONFIG_USB_PD_TCPMV1
 * or CONFIG_USB_PD_TCPMV2 is enabled but not both. Also make sure
 * CONFIG_USB_PD_DECODE_SOP is enabled with CONFIG_USB_PD_TCPMV2
 */
