 ...
 * https://wwww.bluetooth.org/en-us/specification/
...
uint8_t *pack_adv(uint8_t *dest, int length, int type, uint8_t *data);
uint8_t *pack_adv_int(uint8_t *dest, int length, int type, int data);
uint8_t *pack_adv_addr(uint8_t *dest, uint64_t addr);

uint8_t *unpack_adv(uint8_t *src, int *length, int *type, uint8_t **data);
...
int ble_radio_add_device_to_white_list(uint8_t *addr_ptr, uint8_t rand);
int ble_radio_remove_device_from_white_list(uint8_t *addr_ptr, uint8_t rand);
