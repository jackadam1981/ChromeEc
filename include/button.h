...
#ifndef CONFIG_VOLUME_BUTTONS_RUNTIME_CONFIG
...
/*
 * Reconfigure a button GPIO signal at runtime.
 *
 * @param button_type	Button type to reconfigured
 * @param gpio		GPIO to assign to the button
 *
 * Returns EC_SUCCESS if button change is accepted and made active,
 * EC_ERROR_* otherwise.
 */
int button_reconfigure_gpio(enum button button_type, enum gpio_signal gpio);
