...
#define ADD_(prefix, name, exit)  ADD_##exit(prefix, name)
#define ADD_WITH_EXIT(prefix, name)   static unsigned int \
				prefix##_##name##_exit(int port)
#define ADD_NOOP_EXIT(prefix, name)

#define IMP_(prefix, name, exit)  IMP_##exit(prefix, name)
#define IMP_WITH_EXIT(prefix, name)   prefix##_##name##_exit
#define IMP_NOOP_EXIT(prefix, name)  do_nothing_exit
