...
struct temperature_mean_data {
	int8_t temperature_min_celsius;
	int8_t temperature_max_celsius;
	int8_t latest_temperature_celsius;
...
struct gyro_cal {
	 ...
	 * stalls.
	 */
	uint32_t gyro_watchdog_start_us;
	uint32_t gyro_watchdog_timeout_duration_us;
	 ...
	 */
	fp_t temperature_mean_celsius;
	fp_t temperature_delta_limit_celsius;
};

/** Reset trackers for tests. */
__test_only void gyro_cal_reset(struct gyro_cal *gyro_cal);
