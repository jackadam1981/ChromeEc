...
#define TEST_EQUAL(a, b, fmt) TEST_OPERATOR(a, b, ==, fmt)
#define TEST_NEQUAL(a, b, fmt) TEST_OPERATOR(a, b, !=, fmt)
#define TEST_HAS_BITS_SET(a, bits) TEST_OPERATOR(a & bits, bits, ==, %u)
#define TEST_HAS_BITS_CLEARED(a, bits) TEST_OPERATOR(a & bits, 0, ==, %u)
