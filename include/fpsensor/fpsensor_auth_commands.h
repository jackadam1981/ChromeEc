 ...
 * @return EC_ERROR_ACCESS_DENIED if falied to validate the request.
 ...
 *
 * @param[in] context the context.
 * @param[in] message the message we authenticate.
 ...
 */
enum ec_error_list
sign_message(std::span<const uint8_t> context, std::span<const uint8_t> message,
