...
struct protect_ranges {
	char cmp; /* complement bit */
	char sec;	/* sector/block bit */
	char tb; /* top/bottom block bit */
	char bp; /* block protect bits (3) */
	unsigned int start; /* start offset */
	unsigned int len; /* offset length */
};
