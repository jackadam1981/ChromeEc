...
extern const struct hook_data __hooks_chipset_pre_shutdown[];
extern const struct hook_data __hooks_chipset_pre_shutdown_end[];
extern const struct hook_data __hooks_chipset_post_shutdown[];
extern const struct hook_data __hooks_chipset_post_shutdown_end[];
