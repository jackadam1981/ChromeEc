...
/**
 * Read specified  size <len> bytes data from the slave at 8-bit slave address <slaveaddr>, at
...
/**
 * Write specified size <len> bytes data to the slave at 8-bit slave address <slaveaddr>, at
 * the specified 16-bit <offset> in the slave's address space.
 */
