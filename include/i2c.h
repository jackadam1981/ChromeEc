...
#define I2C_XFER_PARAMS_WRITE(_port, _slave, _out, _out_size)	\
	I2C_XFER_PARAMS(_port, _slave, _out, _out_size, NULL, 0, \
			I2C_XFER_SINGLE)

#define I2C_XFER_PARAMS_READ(_port, _slave, _in, _in_size)	\
	I2C_XFER_PARAMS(_port, _slave, NULL, 0, _in, _in_size, \
			I2C_XFER_SINGLE)
 ...
 * i2c_xfer().
 *
 * @param p		Pointer to I2C xfer params. Note that this is *not*
 *                      const, so chip_i2c_xfer() may change any of it.  It's a
 *                      copy of the struct passed into i2c_xfer(), not a direct
 *                      pointer to it.
 * @return EC_SUCCESS, or non-zero if error.
 */
 ...
 * @param p		Pointer to I2C xfer params
 */
void i2c_start_xfer_notify(const struct i2c_xfer_params *p);
 ...
 * @param p		Pointer to I2C xfer params
 */
void i2c_end_xfer_notify(const struct i2c_xfer_params *p);
