 ...
 * perif_addr, etc.  If the 7 bit address contains flags for BIG
 ...
 * be addr_flags, i2c_addr_flags, perif_addr_flags, etc.
 *
...
struct i2c_drv {
	int (*xfer)(const struct i2c_port_t *i2c_port,
		    const uint16_t perif_addr_flags,
 ...
 * @param perif_addr	Peripheral device address
 ...
 * <perifaddr>, at the specified 8-bit <offset> in the peripheral's address
 * space.
 */
 ...
 * address <perif_addr_flags> at the specified 8-bit <offset> in the
 ...
 * peripheral address <perif_addr_flags>, at the specified 8-bit <offset> in
 ...
 * * <perifaddr>, at 16-bit <offset> in the peripheral's address space.
 */
 ...
 * Read bytestream from <perifaddr>:<offset> with format:
 ...
 * peripheral address <perifaddr>, at the specified 8-bit <offset> in the
 ...
 */
void i2c_trace_notify(int port, uint16_t perif_addr_flags,
