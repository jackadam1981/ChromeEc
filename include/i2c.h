 ...
 *
 * - Slave addresses are always 16 bit values.  The least significant
...
#define I2C_FLAG_BIG_ENDIAN	BIT(13)
/* BIT(14) READ_FLAG - used in ec_commands */
#define I2C_FLAG_READ_REQUEST	BIT(14)
/* BIT(15) SPI_FLAG - used in motion_sense to overload address */
#define I2C_FLAG_ADDR_IS_SPI	BIT(15)

#define I2C_ADDR(x)		(I2C_ADDR__7b(x))
#define I2C_ADDR__7b(x__7bf)			((x__7bf) & I2C_ADDR_MASK)
...
struct i2c_port_t {
	...
	int (*passthru_allowed__7b)(const struct i2c_port_t *port,
				uint16_t address__7b);
};
