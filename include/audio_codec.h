...
#define ERR(format, args...) cprintf(CC_AUDIO_CODEC, "[ERR] " format, ##args)
#define WARN(format, args...) cprintf(CC_AUDIO_CODEC, "[WARN] " format, ##args)

#ifdef DEBUG_AUDIO_CODEC
#define DBG(format, args...) cprintf(CC_AUDIO_CODEC, "[DBG] " format, ##args)
#else
