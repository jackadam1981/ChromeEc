 ...
 *
 * Usually, chips need to implement the function if there are shared memory
 * between EC and AP on the system RAM.  Otherwise, compiler should generate
 * link errors.
 *
 ...
 * @addr is the address point to the SHM.
