...
#define TCPC_REG_DEV_CAP_1         0xa
#define TCPC_REG_DEV_CAP_2         0xb
#define TCPC_REG_DEV_CAP_3         0xc
#define TCPC_REG_DEV_CAP_4         0xd
#define TCPC_REG_ALERT1            0xe
#define TCPC_REG_ALERT1_I2C_WAKE     (1<<7)
...
#define TCPC_REG_ALERT2            0xf
#define TCPC_REG_ALERT2_GPIO_CHANGE  (1<<3)

#define TCPC_REG_ALERT3            0x10
#define TCPC_REG_ALERT4            0x11
#define TCPC_REG_ALERT_MASK_1      0x12
#define TCPC_REG_ALERT_MASK_2      0x13
#define TCPC_REG_POWER_STATUS_MASK 0x14
#define TCPC_REG_CC_STATUS         0x16
#define TCPC_REG_CC_STATUS_SET(cc1, cc2) \
		((cc2) << 4 | (cc1))
#define TCPC_REG_CC_STATUS_CC2(reg) (((reg) & 0xf0) >> 4)
#define TCPC_REG_CC_STATUS_CC1(reg) ((reg) & 0xf)
enum tcpc_cc_status {
/* CC status when we are a source (we expose Rp) */
	TYPEC_CC_SRC_RA = 0x1,
	TYPEC_CC_SRC_RD = 0x2,
	TYPEC_CC_SRC_OPEN = 0x3,
/* CC status when we are a sink (we expose Rd) */
	TYPEC_CC_SNK_OPEN = 0x8,
	TYPEC_CC_SNK_PWR_DEFAULT = 0x9,
	TYPEC_CC_SNK_PWR_1_5 = 0xa,
	TYPEC_CC_SNK_PWR_3_0 = 0xb,
};

#define TCPC_REG_POWER_STATUS      0x17
#define TCPC_REG_ROLE_CTRL         0x18
...
#define TCPC_REG_POWER_PATH_CTRL   0x19
#define TCPC_REG_POWER_CTRL        0x1a
...
#define TCPC_REG_COMMAND           0x2c
#define TCPC_REG_MSG_HDR_INFO      0x2f
...
#define TCPC_REG_RX_STATUS         0x31
#define TCPC_REG_RX_HDR_LOW        0x32
#define TCPC_REG_RX_HDR_HIGH       0x33
...
#define TCPC_REG_TX_HDR_LOW        0x52
#define TCPC_REG_TX_HDR_HIGH       0x53
