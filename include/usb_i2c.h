 ...
 *         header. Be catious that receiving side has enough buffer size.
 *
 *   - rc: read count: 1 byte, zero based count of bytes to read. To read more
 *         than 127 bytes please see the special notes above.
 *
 ...
 *          sopecial notes above for concatenatubg detaisl.
 *
 ...
 *     +-------------+---+---+--------------+
 *
 *   - read payload might not fit into a single USB packets. Remaininge will be
 *     transimitted witout header. Receiving side should concat them.
 *
