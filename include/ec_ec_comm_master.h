 ...
 * battery dynamic information into battery_dynamic[1].
 *
 * Leaves battery_dynamic[1] intact on error: it is the callers responsibility
 ...
 * battery static information into battery_static[1].
 *
 * Leaves battery_static[1] intact on error: it is the callers responsibility
 * to clear the data or ignore it.
 *
 * @return EC_RES_SUCCESS on success, EC_RES_ERROR on communication error,
 * else forwards the error code from the slave.
