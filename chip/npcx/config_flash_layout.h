 ...
 * depending on alignment of CONFIG_RO/RW_SIZE. There is one assumption here:
 * 1. CONFIG_RO_MEM_OFF is always 0 i.e. RO starts at 0.
 *
 * If this assumption is not true, then additional checks are required to ensure
 * that the erase block size is selected based on the alignment of both
