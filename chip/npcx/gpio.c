		...
		int sz_wui_items)
{
	...
	for (i = 0; i < sz_wui_items; i++) {
		const struct npcx_gpio *gpio = wui_items[i].gpio;
		uint8_t table = wui_items[i].table;
		uint8_t group = wui_items[i].group;
