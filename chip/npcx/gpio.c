...
DECLARE_CONSOLE_COMMAND(gpio_get_out, gpio_get_output_level_func,
		"[0|1]",
...
DECLARE_CONSOLE_COMMAND(gpio_set_out, gpio_set_output_level_func,
		"[0|1] [0|1]",
