...
/* The optinal hardware features depend on chip variant */
#if defined(CHIP_VARIANT_NPCX7M6F)
#define CONFIG_NPCX_INT_FLASH  /* Internal flash support */
#define CONFIG_NPCX_PSL_MODE   /* Power switch logic mode for ultra-low power */
#define CONFIG_NPCX_EXT32K_OSC /* External 32KHz crytal osc. input support */
#endif
...
#if defined(CHIP_VARIANT_NPCX7M6F)
/* 62KB data ram */
#define CONFIG_RAM_SIZE    (0x00010000 - CONFIG_BTRAM_SIZE)
