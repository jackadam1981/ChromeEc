...
static void print_espi_bus_error(void) {
	if (!DEBUG_ESPI)
		return;
	ccprintf("ESPIERR(%x): ", NPCX_ESPIERR);
	if (IS_BIT_SET(NPCX_ESPIERR, NPCX_ESPIERR_INVCMD))
		ccprintf("INVCMD ");
	if (IS_BIT_SET(NPCX_ESPIERR, NPCX_ESPIERR_INVCYC))
		ccprintf("INVCYC ");
	if (IS_BIT_SET(NPCX_ESPIERR, NPCX_ESPIERR_CRCERR))
		ccprintf("CRCERR ");
	if (IS_BIT_SET(NPCX_ESPIERR, NPCX_ESPIERR_ABCOMP))
		ccprintf("ABCOMP ");
	if (IS_BIT_SET(NPCX_ESPIERR, NPCX_ESPIERR_PROTERR))
		ccprintf("PROTERR ");
	if (IS_BIT_SET(NPCX_ESPIERR, NPCX_ESPIERR_BADSIZE))
		ccprintf("BADSIZE ");
	if (IS_BIT_SET(NPCX_ESPIERR, NPCX_ESPIERR_NPBADALN))
		ccprintf("NPBADALN ");
	if (IS_BIT_SET(NPCX_ESPIERR, NPCX_ESPIERR_PCBADALN))
		ccprintf("PCBADALN ");
	if (IS_BIT_SET(NPCX_ESPIERR, NPCX_ESPIERR_UNCMD))
		ccprintf("UNCMD ");
	if (IS_BIT_SET(NPCX_ESPIERR, NPCX_ESPIERR_EXTRACYC))
		ccprintf("EXTRACYC ");
	if (IS_BIT_SET(NPCX_ESPIERR, NPCX_ESPIERR_VWERR))
		ccprintf("VWERR ");
	if (IS_BIT_SET(NPCX_ESPIERR, NPCX_ESPIERR_UNPBM))
		ccprintf("UNPBM ");
	if (IS_BIT_SET(NPCX_ESPIERR, NPCX_ESPIERR_UNFLASH))
		ccprintf("UNFLASH ");
	ccprintf("\n");
}
