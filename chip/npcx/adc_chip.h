 ...
 * member variables.  The threshold levels may be set from 0 to 1023 inclusive.
 */
struct npcx_adc_thresh_t {
	...
	/* Desired level to assert.  Set for both single and dual thresholds. */
	int thresh_assert;

	/* Desired level to de-assert. Set to -1 for single thresholds. */
	int thresh_deassert;
};
