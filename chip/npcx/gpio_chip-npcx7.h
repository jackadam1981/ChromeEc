...
/* I2C & MIWU Mapping Groups on npcx7 */
#define NPCX_I2C_WKINEN_0_0 NPCX_I2C_WKINEN_ITEM(B, 5, B, 4) /* I2C0_0 */
#define NPCX_I2C_WKINEN_1_0 NPCX_I2C_WKINEN_ITEM(9, 0, 8, 7) /* I2C1_0 */
#define NPCX_I2C_WKINEN_2_0 NPCX_I2C_WKINEN_ITEM(9, 2, 9, 1) /* I2C2_0 */
#define NPCX_I2C_WKINEN_3_0 NPCX_I2C_WKINEN_ITEM(D, 1, D, 0) /* I2C3_0 */
#if !defined(NPCX_PSL_MODE_SUPPORT)
#define NPCX_I2C_WKINEN_4_0 NPCX_I2C_WKINEN_ITEM(8, 5, 8, 6) /* I2C4_0 */
#else
#define NPCX_I2C_WKINEN_4_0
#endif
#define NPCX_I2C_WKINEN_4_1 NPCX_I2C_WKINEN_ITEM(F, 3, F, 2) /* I2C4_1 */
#define NPCX_I2C_WKINEN_5_0 NPCX_I2C_WKINEN_ITEM(3, 3, 3, 6) /* I2C5_0 */
#define NPCX_I2C_WKINEN_5_1 NPCX_I2C_WKINEN_ITEM(F, 5, F, 4) /* I2C5_1 */
#define NPCX_I2C_WKINEN_6_0 NPCX_I2C_WKINEN_ITEM(C, 2, C, 1) /* I2C6_0 */
#define NPCX_I2C_WKINEN_6_1 NPCX_I2C_WKINEN_ITEM(E, 4, E, 3) /* I2C6_1 */
#define NPCX_I2C_WKINEN_7_0 NPCX_I2C_WKINEN_ITEM(B, 3, B, 2) /* I2C7_0 */

#define NPCX_I2C_WKINEN_TABLE { NPCX_I2C_WKINEN_0_0 \
				NPCX_I2C_WKINEN_1_0 \
				NPCX_I2C_WKINEN_2_0 \
				NPCX_I2C_WKINEN_3_0 \
				NPCX_I2C_WKINEN_4_0 \
