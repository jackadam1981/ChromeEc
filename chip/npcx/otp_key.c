...
enum API_RETURN_STATUS_T otp_key_read(uint8_t *key_buffer)
{
	enum API_RETURN_STATUS_T status = API_RET_OTP_STATUS_FAIL;
	uint8_t i;
...
static enum API_RETURN_STATUS_T otp_key_write(uint8_t *key_buffer)
{
	enum API_RETURN_STATUS_T status = API_RET_OTP_STATUS_FAIL;
	uint8_t i;
...
enum API_RETURN_STATUS_T otp_key_provision(void)
{
	enum API_RETURN_STATUS_T status = API_RET_OTP_STATUS_FAIL;
