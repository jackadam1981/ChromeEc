...
void pwm_set_duty(enum pwm_channel ch, int percent)
{
	...
	pwm_set_raw_duty(ch, (percent * PWM_MAX_DUTY) / 100);
}
...
{
	return DIV_ROUND_NEAREST(pwm_get_raw_duty(ch) * 100, PWM_MAX_DUTY);
}
