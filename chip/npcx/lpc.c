...
static void __keep lpc_kbc_ibf_interrupt(void)
{
	uint8_t status;
	uint8_t ibf;
...
static void __keep lpc_kbc_obe_interrupt(void)
{
...
static void __keep lpc_pmc_ibf_interrupt(void)
{
...
static void __keep lpc_pmc_obe_interrupt(void)
{
}
DECLARE_IRQ(NPCX_IRQ_PM_CHAN_OBE, lpc_pmc_obe_interrupt, 4);

static void __keep lpc_port80_interrupt(void)
{
	uint8_t i;
	uint8_t count = 0;
	uint32_t code = 0;
