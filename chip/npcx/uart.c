 ...
 * on the global variable "pad". It also disactivates the previous pad.
 *
...
void uart_tx_start(void)
{
	...
	/*
	 * Do not allow deep sleep while transmit in progress on default pad.
	 * (deep sleep is disabled whenever the alternate pad is selected).
	 */
