...
/* KBSCAN definitions */
#define KB_KSI_NUM  8  /* Rows numbers of keyboard matrix */
#define KB_KSO_NUM  18 /* Columns numbers of keyboard matrix */
#define KB_KSI_MASK ((1<<KB_KSI_NUM) - 1) /* Mask of rows of keyboard matrix */
#define KB_KSO_MASK ((1<<KB_KSO_NUM) - 1) /* Mask of cols of keyboard matrix */
