 ...
 */
static const volatile uint32_t *ADDR_DOWNLOAD_FROM_FLASH = 0x40;
...
static const volatile uint32_t *ADDR_OTPI_POWER = 0x4C;
static inline enum API_RETURN_STATUS_T otpi_power(bool on)
{
	return ((otpi_power_ptr)ADDR_OTPI_POWER)(on);
}

static const volatile uint32_t *ADDR_OTPI_READ = 0x50;
...
static const volatile uint32_t *ADDR_OTPI_WRITE = 0x54;
...
static const volatile uint32_t *ADDR_OTPI_WRITE_PROTECT = 0x5C;
