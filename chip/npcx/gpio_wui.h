...
#define MIWU_SHIFT_BIT  (7)
#define MIWU_BIT        (1<<MIWU_SHIFT_BIT)
#define WUI(miwu, grp, idx) (((miwu) << MIWU_SHIFT_BIT) | ((grp) << 4) | (idx))
#define WUI_MIWU(wui)  ((wui) >> MIWU_SHIFT_BIT)
#define WUI_GROUP(wui) (((wui) >> 4) & 0x7)
#define WUI_BIT(wui)   ((wui) & 0xF)
