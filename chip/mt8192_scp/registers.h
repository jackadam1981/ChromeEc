...
#define SCP_CORE0_INTC_IRQ_WAKE_EN(w)				\
	REG32_ADDR(SCP_INTC_IRQ_BASE + 0x0030)[w]
...
#define SCP_CORE0_INTC_IRQ_OUT		REG32(SCP_INTC_IRQ_BASE + 0x0250)
#define SCP_CORE0_INTC_IRQ_CLR_TRG	REG32(SCP_INTC_IRQ_BASE + 0x0254)
#define SCP_CORE0_INTC_UART0_RX_IRQ	REG32(SCP_INTC_IRQ_BASE + 0x0258)
#define SCP_CORE0_INTC_UART1_RX_IRQ	REG32(SCP_INTC_IRQ_BASE + 0x025C)
#define SCP_CORE0_INTC_UART_RX_IRQ(n)	CONCAT3(SCP_CORE0_INTC_UART, n, _RX_IRQ)

/* XGPT (general purpose timer) */
#define NUM_TIMERS			6
#define SCP_TIMER_BASE(n)		(SCP_REG_BASE + 0x33000 + (0x10 * (n)))
#define SCP_CORE0_TIMER_EN(n)		REG32(SCP_TIMER_BASE(n) + 0x0000)
...
#define SCP_CORE0_TIMER_RST_VAL(n)	REG32(SCP_TIMER_BASE(n) + 0x0004)
#define SCP_CORE0_TIMER_CUR_VAL(n)	REG32(SCP_TIMER_BASE(n) + 0x0008)
#define SCP_CORE0_TIMER_IRQ_CTRL(n)	REG32(SCP_TIMER_BASE(n) + 0x000C)
...
/* OS timer */
#define SCP_OS_TIMER_BASE		(SCP_REG_BASE + 0x33080)
#define SCP_CORE0_OS_TIMER_EN		REG32(SCP_OS_TIMER_BASE)
#define   OS_TIMER_EN			BIT(0)
...
#define AP_GPIO_MODE16_SET		REG32(AP_GPIO_BASE + 0x0404)
#define AP_GPIO_MODE16_CLR		REG32(AP_GPIO_BASE + 0x0408)
