...
static struct {
	...
	[SCP_IRQ_TIMER0]		= { INTC_GRP_0, INTC_POL_HIGH },
	/* 16 */
	[SCP_IRQ_TIMER1]		= { INTC_GRP_0, INTC_POL_HIGH },
	[SCP_IRQ_TIMER2]		= { INTC_GRP_0, INTC_POL_HIGH },
	[SCP_IRQ_TIMER3]		= { INTC_GRP_0, INTC_POL_HIGH },
	[SCP_IRQ_TIMER4]		= { INTC_GRP_0, INTC_POL_HIGH },
	/* 20 */
	[SCP_IRQ_TIMER5]		= { INTC_GRP_0, INTC_POL_HIGH },
...
error:
	/* unreachable, SCP crashes after returning */
	return 0;
}
