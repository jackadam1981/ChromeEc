...
int chip_clear_pending_irq(int irq)
{
	...
	ccprintf("before miems: mstatus=%x\n", (unsigned int)read_csr(0x300));
	...
	ccprintf("after miems: mstatus=%x\n", (unsigned int)read_csr(0x300));
...
void chip_init_irqs(void)
{
	...
	SCP_CORE0_INTC_IRQ_POL(0) = 0xef001f20;
	SCP_CORE0_INTC_IRQ_POL(1) = 0x0800001d;
	SCP_CORE0_INTC_IRQ_POL(2) = 0x00000020;
