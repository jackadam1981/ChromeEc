...
static void cache_op_all(uint32_t op)
{
...
static struct mpu_entry mpu_entries[] = {
	{0, 0x100000, MPU_ATTR_W | MPU_ATTR_R},
	{0x60000000, 0x60100000, MPU_ATTR_W | MPU_ATTR_R},
	{0x70000000, 0x70100000, MPU_ATTR_W | MPU_ATTR_R},
};
BUILD_ASSERT(ARRAY_SIZE(mpu_entries) <= 16);
...
void cache_init(void)
{
	...
	/* set mpu entries */
	for (i = 0; i < ARRAY_SIZE(mpu_entries); ++i) {
