...
USB_DMA_RX_BUF(ep0_out_buf[NUM_OUT_BUFFERS], USB_MAX_PACKET_SIZE);
USB_DMA_DESC(ep0_out_desc[NUM_OUT_BUFFERS]);
...
USB_DMA_TX_BUF(ep0_in_buf, IN_BUF_SIZE);
USB_DMA_DESC(ep0_in_desc[NUM_IN_PACKETS_AT_ONCE]);
...
{
#ifdef CONFIG_ENABLE_H1_GLOBALSEC_USB
	/*
...
#else  /* CONFIG_ENABLE_H1_GLOBALSEC_USB */
...
#endif  /* CONFIG_ENABLE_H1_GLOBALSEC_USB */
}
