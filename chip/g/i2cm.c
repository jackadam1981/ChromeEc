 ...
 * A 2 byte register write uses the following sequence:
 *
 ...
 *
 * A 2 byte register read uses the following sequence:
 *
 * I2C_INST_START = 1         -> send start bit
 * I2C_INST_FWDEVADDR = 1     -> first send the slave device address
...
/*
 * TODO (crosbug.com/p/57059): For 100 and 400 kHz speed, phasestep0 has been
