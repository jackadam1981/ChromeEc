...
static int idle_default = IDLE_SLEEP;
...
/*
 * FW_DEFINED_BROM_APPLYSEC and GLOBALSEC_OBFS_SW_EN require high permission.
 *
 * Board init drops the permission level to medium, so idle init needs to
 * happen before that.
 */
