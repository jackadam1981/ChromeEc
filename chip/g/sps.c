 ...
 * assertion. When true, it indicates to the caller that the confirmation
 * pulse to the AP needs to be generated.
 */
static bool sps_rx_interrupt(uint32_t port, int cs_deasserted)
{
	bool pulse_needed = false;
