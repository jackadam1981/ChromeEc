			    ...
			    unsigned rx_fifo_threshold)
{
	...
	/*
	 * TODO(b148691139/): Call int_ap_extension_disable(), once
	 * TPM_BOARD_CFG is implemented.
	 */
	...
	/*
	 * TODO(b148691139/): Call int_ap_extension_enable(), once
	 * TPM_BOARD_CFG is implemented.
	 */
...
/*
 * Function that sets up for SPS to disable INT_AP_L extension.
 */

static void sps_int_ap_extension_disable_(void)
{
