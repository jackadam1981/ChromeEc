 ...
 * up to eight). The reg_size field is in fact one less than the actual region
 * size, The reg_perms bits are as used in the above macro, allowing to enable
 * the region and its read and write accesses separately.
 */
