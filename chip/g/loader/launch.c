...
void tryLaunch(uint32_t adr, size_t max_size)
{
	...
	if (!unlockedForExecution()) {
		debug_printf("Failed to unlock for execution, "
			     "what do I do?...\n");
		while(1)
			;
	}
