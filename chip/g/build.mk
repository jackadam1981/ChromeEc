...
chip-custom_obj-$(CONFIG_CUSTOMIZED_RO) += loader/main.o
chip-custom_obj-$(CONFIG_CUSTOMIZED_RO) += system.o
chip-custom_obj-$(CONFIG_CUSTOMIZED_RO) += uart.o

dirs-$(CONFIG_CUSTOMIZED_RO) += chip/g/loader
