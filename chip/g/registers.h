...
/* Key manager */
#define GR_KEYMGR_AES_KEY_START       GREG32(KEYMGR, AES_KEY_START)
#define GR_KEYMGR_AES_RFIFO_DATA      GREG32(KEYMGR, AES_RFIFO_DATA)
#define GR_KEYMGR_AES_WFIFO_DATA      GREG32(KEYMGR, AES_WFIFO_DATA)
