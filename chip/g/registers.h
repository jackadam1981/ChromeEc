 ...
 *
 * Register map for gChip processor
 */
...
/* Revision */
#define G_CHIP_REVISION_STR "A1"

/* G_PINMUX_BASE_ADDR is 0x40060000 */
#define G_PINMUX_DIOA0_SEL                        REG32(0x40060028)
#define G_PINMUX_DIOA0_CTL                        REG32(0x4006002c)
#define G_PINMUX_DIOA1_CTL                        REG32(0x40060034)
#define G_PINMUX_UART0_RX_SEL                     REG32(0x400602a8)
...
/* G_PMU_BASE_ADDR is 0x40000000 */
#define G_PMU_CLRDIS                              REG32(0x40000018)
#define G_PMU_OSC_HOLD_SET                        REG32(0x40000080)
#define G_PMU_OSC_HOLD_CLR                        REG32(0x40000084)
#define G_PMU_OSC_SELECT                          REG32(0x40000088)
#define G_PMU_OSC_SELECT_STAT                     REG32(0x4000008c)
#define G_PMU_OSC_CTRL                            REG32(0x40000090)
#define G_PMU_PERICLKSET0                         REG32(0x4000009c)
#define G_PMU_FUSE_RD_RC_OSC_26MHZ                REG32(0x4000011c)
#define G_PMU_FUSE_RD_XTL_OSC_26MHZ               REG32(0x40000124)
...
/* G_XO0_BASE_ADDR is 0x40420000 */
#define G_XO_OSC_RC_CAL_RSTB                      REG32(0x40420014)
#define G_XO_OSC_RC_CAL_LOAD                      REG32(0x40420018)
#define G_XO_OSC_RC_CAL_START                     REG32(0x4042001c)
#define G_XO_OSC_RC_CAL_DONE                      REG32(0x40420020)
#define G_XO_OSC_RC_CAL_COUNT                     REG32(0x40420024)
#define G_XO_OSC_RC                               REG32(0x40420028)
#define G_XO_OSC_RC_STATUS                        REG32(0x4042002c)
#define G_XO_OSC_XTL_TRIM                         REG32(0x40420048)
#define G_XO_OSC_XTL_TRIM_STAT                    REG32(0x4042004c)
#define G_XO_OSC_XTL_FSM_EN                       REG32(0x40420050)
#define G_XO_OSC_XTL_FSM                          REG32(0x40420054)
#define G_XO_OSC_XTL_FSM_CFG                      REG32(0x40420058)
#define G_XO_OSC_SETHOLD                          REG32(0x4042005c)
#define G_XO_OSC_CLRHOLD                          REG32(0x40420060)
