...
#define GR_PINMUX_USB0_EXT_DP_RPU2_ENB_SEL REG32(GC_PINMUX_BASE_ADDR +  GC_PINMUX_USB0_EXT_DP_RPU2_ENB_SEL_OFFSET)
#define GR_PINMUX_USB0_EXT_FS_EDGE_SEL_SEL REG32(GC_PINMUX_BASE_ADDR +  GC_PINMUX_USB0_EXT_FS_EDGE_SEL_SEL_OFFSET)
#define GR_PINMUX_USB0_EXT_RX_DMI_SEL      REG32(GC_PINMUX_BASE_ADDR +  GC_PINMUX_USB0_EXT_RX_DMI_SEL_OFFSET)
#define GR_PINMUX_USB0_EXT_RX_DPI_SEL      REG32(GC_PINMUX_BASE_ADDR +  GC_PINMUX_USB0_EXT_RX_DPI_SEL_OFFSET)
#define GR_PINMUX_USB0_EXT_RX_RCV_SEL      REG32(GC_PINMUX_BASE_ADDR +  GC_PINMUX_USB0_EXT_RX_RCV_SEL_OFFSET)
#define GR_PINMUX_USB0_EXT_SUSPENDB_SEL    REG32(GC_PINMUX_BASE_ADDR +  GC_PINMUX_USB0_EXT_SUSPENDB_SEL_OFFSET)
#define GR_PINMUX_USB0_EXT_TX_DMO_SEL      REG32(GC_PINMUX_BASE_ADDR +  GC_PINMUX_USB0_EXT_TX_DMO_SEL_OFFSET)
#define GR_PINMUX_USB0_EXT_TX_DPO_SEL      REG32(GC_PINMUX_BASE_ADDR +  GC_PINMUX_USB0_EXT_TX_DPO_SEL_OFFSET)
#define GR_PINMUX_USB0_EXT_TX_OEB_SEL      REG32(GC_PINMUX_BASE_ADDR +  GC_PINMUX_USB0_EXT_TX_OEB_SEL_OFFSET)
