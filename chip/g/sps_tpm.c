 ...
 *   MOSI: 43 aa bb cc 11 22 33 44
 *   MISO: xx xx xx x1 xx xx xx xx
 *
 *   xfer:  1  2  3  4  5  6  7  8
 *   MOSI: c3 aa bb cc xx xx xx xx
...
static void tpm_rx_handler(uint8_t *data, size_t data_size, int cs_enabled)
{
...
DECLARE_HOOK(HOOK_INIT, sps_tpm_enable, HOOK_PRIO_DEFAULT);
