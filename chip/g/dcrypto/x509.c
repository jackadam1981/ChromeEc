...
static size_t asn1_parse_tbs(const uint8_t **p, size_t *available, size_t *tbs_len)
{
	size_t consumed;
...
static size_t asn1_parse_signature_algorithm(const uint8_t **p, size_t *available)
{
