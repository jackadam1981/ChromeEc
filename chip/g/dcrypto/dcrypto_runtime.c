...
static const p256_int r_golden = {
	.a = {0x0DF84892, 0xAE1D98DF, 0xADE31F0F, 0x4CD7EC0E, 0x51866245,
	      0x8D96ABFC, 0x11FA2A69, 0xA86D8EF5},
};
static const p256_int s_golden = {
	.a = {0xF7561D34, 0x3BB0A846, 0x6D3D1B8D, 0x97CF3327, 0x27765E36,
	      0x166071E5, 0xDE738760, 0x73184B4E},
};
...
static int ecdsa_sign_go(p256_int *r, p256_int *s)
{
	...
	hmac_drbg_init(&drbg, r->a, sizeof(r->a), zeros, 32, zeros, 32);

	/* pick a key */
	hmac_drbg_generate_p256(&drbg, &d);

	/* drbg_reseed with entropy and message */
	hmac_drbg_reseed(&drbg, r->a, sizeof(r->a), s->a, sizeof(s->a), zeros,
			 32);
