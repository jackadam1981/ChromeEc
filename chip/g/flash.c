...
{
	/* Enable R/W access to INFO1. */
	GREG32(GLOBALSEC, FLASH_REGION3_BASE_ADDR) = FLASH_INFO1_MEMORY_BASE +
		FLASH_INFO1_MANUFACTURE_STATE_OFFSET;
	GREG32(GLOBALSEC, FLASH_REGION3_SIZE) =
		FLASH_INFO1_MANUFACTURE_STATE_SIZE - 1;
