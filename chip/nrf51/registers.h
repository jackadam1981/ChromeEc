...
/* Tasks */
#define NRF51_GPIOTE_OUT0      REG32(NRF51_GPIOTE_BASE + 0x000)
#define NRF51_GPIOTE_OUT1      REG32(NRF51_GPIOTE_BASE + 0x004)
#define NRF51_GPIOTE_OUT2      REG32(NRF51_GPIOTE_BASE + 0x008)
#define NRF51_GPIOTE_OUT3      REG32(NRF51_GPIOTE_BASE + 0x00C)
/* Events */
#define NRF51_GPIOTE_IN0       REG32(NRF51_GPIOTE_BASE + 0x100)
#define NRF51_GPIOTE_IN1       REG32(NRF51_GPIOTE_BASE + 0x104)
#define NRF51_GPIOTE_IN2       REG32(NRF51_GPIOTE_BASE + 0x108)
#define NRF51_GPIOTE_IN3       REG32(NRF51_GPIOTE_BASE + 0x10C)
...
#define NRF51_GPIOTE_CONFIG0   REG32(NRF51_GPIOTE_BASE + 0x510)
#define NRF51_GPIOTE_CONFIG1   REG32(NRF51_GPIOTE_BASE + 0x514)
#define NRF51_GPIOTE_CONFIG2   REG32(NRF51_GPIOTE_BASE + 0x518)
#define NRF51_GPIOTE_CONFIG3   REG32(NRF51_GPIOTE_BASE + 0x51C)
#define NRF51_GPIOTE_POWER     REG32(NRF51_GPIOTE_BASE + 0xFFC)
/* Bits */
/* For GPIOTE.INTEN */
#define NRF51_GPIOTE_IN0_BIT  ((0x100 - 0x100) / 4)
#define NRF51_GPIOTE_IN1_BIT  ((0x104 - 0x100) / 4)
#define NRF51_GPIOTE_IN2_BIT  ((0x108 - 0x100) / 4)
#define NRF51_GPIOTE_IN3_BIT  ((0x10C - 0x100) / 4)
#define NRF51_GPIOTE_PORT_BIT ((0x17C - 0x100) / 4)
/* For GPIOTE.CONFIG */
