...
#define NRF51_RADIO_READY_BIT     ((0x100 - 0x100) / 4)
#define NRF51_RADIO_ADDRESS_BIT   ((0x104 - 0x100) / 4)
#define NRF51_RADIO_PAYLOAD_BIT   ((0x108 - 0x100) / 4)
#define NRF51_RADIO_END_BIT       ((0x10C - 0x100) / 4)
#define NRF51_RADIO_DISABLED_BIT  ((0x110 - 0x100) / 4)
#define NRF51_RADIO_DEVMATCH_BIT  ((0x114 - 0x100) / 4)
#define NRF51_RADIO_DEVMISS_BIT   ((0x118 - 0x100) / 4)
#define NRF51_RADIO_RSSIEND_BIT   ((0x11C - 0x100) / 4)
#define NRF51_RADIO_BCMATCH_BIT   ((0x128 - 0x100) / 4)
