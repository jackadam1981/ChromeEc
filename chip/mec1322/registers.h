...
/* Mailbox */
#define MEC1322_MBX_RUNTIME_BASE	0x400f2400
#define MEC1322_MBX_INDEX_REG		REG8(MEC1322_MBX_RUNTIME_BASE + 0x0)
#define MEC1322_MBX_DATA_REG		REG8(MEC1322_MBX_RUNTIME_BASE + 0x1)
...
#define MEC1322_MBX_REG32(x)		REG32(MEC1322_MBX_BASE + 0x10 + \
					      (x & ~(0x3)))

#define MEC1322_MBX_REG_HOST_INDEX(x)	(0x84 + (x))
