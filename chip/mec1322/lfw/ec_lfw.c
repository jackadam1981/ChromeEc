...
static uintptr_t *const Switch2RWImage = (uintptr_t *const)
						SHARED_RAM_LOADER_RORW;


__attribute__ ((section(".intvector")))
const struct int_vector_t hdr_int_vect = {
				(void *)0x11FA00,	/* init sp, not used */
...
void lfw_main()
{
	...
	jump_to_image(*(uint32_t *)(init_addr + 4));
