 ...
 * Return EC_SUCCESS if successful, otherwise returns a common error code.
*/
static int i2c_slave_read(mxc_i2c_regs_t *i2c, i2c_req_t *req, uint32_t int_flags) {
	int i2c_num;
 ...
 * Return EC_SUCCESS if successful, otherwise returns a common error code.
 */
static int i2c_slave_write(mxc_i2c_regs_t *i2c, i2c_req_t *req, uint32_t int_flags) {
	int i2c_num;
