...
/* MAX32660 Registers, Bit Masks and Bit Positions for the GPIO Peripheral Module */
...
typedef struct {
	...
	__IO uint32_t out_en_set; /**< <tt>\b 0x10:<\tt> GPIO OUT_EN_SET Register */
	__IO uint32_t out_en_clr; /**< <tt>\b 0x14:<\tt> GPIO OUT_EN_CLR Register */
	...
	__IO uint32_t int_en_set; /**< <tt>\b 0x38:<\tt> GPIO INT_EN_SET Register */
	__IO uint32_t int_en_clr; /**< <tt>\b 0x3C:<\tt> GPIO INT_EN_CLR Register */
	...
	__IO uint32_t wake_en_set; /**< <tt>\b 0x50:<\tt> GPIO WAKE_EN_SET Register */
	__IO uint32_t wake_en_clr; /**< <tt>\b 0x54:<\tt> GPIO WAKE_EN_CLR Register */
	__R uint32_t rsv_0x58;
	__IO uint32_t int_dual_edge; /**< <tt>\b 0x5C:<\tt> GPIO INT_DUAL_EDGE Register */
 ...
 * @{
 */
#define MXC_R_GPIO_EN ((uint32_t)0x00000000UL)            /**< Offset from GPIO Base Address: <tt> 0x0x000 */
#define MXC_R_GPIO_EN_SET ((uint32_t)0x00000004UL)        /**< Offset from GPIO Base Address: <tt> 0x0x004 */
#define MXC_R_GPIO_EN_CLR ((uint32_t)0x00000008UL)        /**< Offset from GPIO Base Address: <tt> 0x0x008 */
#define MXC_R_GPIO_OUT_EN ((uint32_t)0x0000000CUL)        /**< Offset from GPIO Base Address: <tt> 0x0x00C */
#define MXC_R_GPIO_OUT_EN_SET ((uint32_t)0x00000010UL)    /**< Offset from GPIO Base Address: <tt> 0x0x010 */
#define MXC_R_GPIO_OUT_EN_CLR ((uint32_t)0x00000014UL)    /**< Offset from GPIO Base Address: <tt> 0x0x014 */
#define MXC_R_GPIO_OUT ((uint32_t)0x00000018UL)           /**< Offset from GPIO Base Address: <tt> 0x0x018 */
#define MXC_R_GPIO_OUT_SET ((uint32_t)0x0000001CUL)       /**< Offset from GPIO Base Address: <tt> 0x0x01C */
#define MXC_R_GPIO_OUT_CLR ((uint32_t)0x00000020UL)       /**< Offset from GPIO Base Address: <tt> 0x0x020 */
#define MXC_R_GPIO_IN ((uint32_t)0x00000024UL)            /**< Offset from GPIO Base Address: <tt> 0x0x024 */
#define MXC_R_GPIO_INT_MOD ((uint32_t)0x00000028UL)       /**< Offset from GPIO Base Address: <tt> 0x0x028 */
#define MXC_R_GPIO_INT_POL ((uint32_t)0x0000002CUL)       /**< Offset from GPIO Base Address: <tt> 0x0x02C */
#define MXC_R_GPIO_INT_EN ((uint32_t)0x00000034UL)        /**< Offset from GPIO Base Address: <tt> 0x0x034 */
#define MXC_R_GPIO_INT_EN_SET ((uint32_t)0x00000038UL)    /**< Offset from GPIO Base Address: <tt> 0x0x038 */
#define MXC_R_GPIO_INT_EN_CLR ((uint32_t)0x0000003CUL)    /**< Offset from GPIO Base Address: <tt> 0x0x03C */
#define MXC_R_GPIO_INT_STAT ((uint32_t)0x00000040UL)      /**< Offset from GPIO Base Address: <tt> 0x0x040 */
#define MXC_R_GPIO_INT_CLR ((uint32_t)0x00000048UL)       /**< Offset from GPIO Base Address: <tt> 0x0x048 */
#define MXC_R_GPIO_WAKE_EN ((uint32_t)0x0000004CUL)       /**< Offset from GPIO Base Address: <tt> 0x0x04C */
#define MXC_R_GPIO_WAKE_EN_SET ((uint32_t)0x00000050UL)   /**< Offset from GPIO Base Address: <tt> 0x0x050 */
#define MXC_R_GPIO_WAKE_EN_CLR ((uint32_t)0x00000054UL)   /**< Offset from GPIO Base Address: <tt> 0x0x054 */
#define MXC_R_GPIO_INT_DUAL_EDGE ((uint32_t)0x0000005CUL) /**< Offset from GPIO Base Address: <tt> 0x0x05C */
#define MXC_R_GPIO_PAD_CFG1 ((uint32_t)0x00000060UL)      /**< Offset from GPIO Base Address: <tt> 0x0x060 */
#define MXC_R_GPIO_PAD_CFG2 ((uint32_t)0x00000064UL)      /**< Offset from GPIO Base Address: <tt> 0x0x064 */
#define MXC_R_GPIO_EN1 ((uint32_t)0x00000068UL)           /**< Offset from GPIO Base Address: <tt> 0x0x068 */
#define MXC_R_GPIO_EN1_SET ((uint32_t)0x0000006CUL)       /**< Offset from GPIO Base Address: <tt> 0x0x06C */
#define MXC_R_GPIO_EN1_CLR ((uint32_t)0x00000070UL)       /**< Offset from GPIO Base Address: <tt> 0x0x070 */
#define MXC_R_GPIO_EN2 ((uint32_t)0x00000074UL)           /**< Offset from GPIO Base Address: <tt> 0x0x074 */
#define MXC_R_GPIO_EN2_SET ((uint32_t)0x00000078UL)       /**< Offset from GPIO Base Address: <tt> 0x0x078 */
#define MXC_R_GPIO_EN2_CLR ((uint32_t)0x0000007CUL)       /**< Offset from GPIO Base Address: <tt> 0x0x07C */
#define MXC_R_GPIO_IS ((uint32_t)0x000000A8UL)            /**< Offset from GPIO Base Address: <tt> 0x0x0A8 */
#define MXC_R_GPIO_SR ((uint32_t)0x000000ACUL)            /**< Offset from GPIO Base Address: <tt> 0x0x0AC */
#define MXC_R_GPIO_DS ((uint32_t)0x000000B0UL)            /**< Offset from GPIO Base Address: <tt> 0x0x0B0 */
#define MXC_R_GPIO_DS1 ((uint32_t)0x000000B4UL)           /**< Offset from GPIO Base Address: <tt> 0x0x0B4 */
#define MXC_R_GPIO_PS ((uint32_t)0x000000B8UL)            /**< Offset from GPIO Base Address: <tt> 0x0x0B8 */
#define MXC_R_GPIO_VSSEL ((uint32_t)0x000000C0UL)         /**< Offset from GPIO Base Address: <tt> 0x0x0C0 */
