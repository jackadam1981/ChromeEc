...
#define MXC_F_UART_CTRL_ENABLE \
	((uint32_t)(0x1UL      \
		    << MXC_F_UART_CTRL_ENABLE_POS)) /**< CTRL_ENABLE Mask */
...
#define MXC_F_UART_CTRL_PARITY \
	((uint32_t)(0x3UL      \
		    << MXC_F_UART_CTRL_PARITY_POS)) /**< CTRL_PARITY Mask */
...
#define MXC_F_UART_CTRL_PARMD \
	((uint32_t)(0x1UL     \
		    << MXC_F_UART_CTRL_PARMD_POS)) /**< CTRL_PARMD Mask  \
							  */
...
#define MXC_F_UART_CTRL_BITACC \
	((uint32_t)(0x1UL      \
		    << MXC_F_UART_CTRL_BITACC_POS)) /**< CTRL_BITACC Mask */
...
#define MXC_F_UART_CTRL_BREAK \
	((uint32_t)(0x1UL     \
		    << MXC_F_UART_CTRL_BREAK_POS)) /**< CTRL_BREAK Mask  \
							  */
...
#define MXC_F_UART_CTRL_CLKSEL \
	((uint32_t)(0x1UL      \
		    << MXC_F_UART_CTRL_CLKSEL_POS)) /**< CTRL_CLKSEL Mask */
...
#define MXC_F_UART_CTRL_RX_TO \
	((uint32_t)(0xFFUL    \
		    << MXC_F_UART_CTRL_RX_TO_POS)) /**< CTRL_RX_TO Mask */
...
#define MXC_F_UART_FIFO_FIFO \
	((uint32_t)(0xFFUL   \
		    << MXC_F_UART_FIFO_FIFO_POS)) /**< FIFO_FIFO Mask   \
							  */
...
#define MXC_F_UART_DMA_TDMA_EN \
	((uint32_t)(0x1UL      \
		    << MXC_F_UART_DMA_TDMA_EN_POS)) /**< DMA_TDMA_EN Mask */
