...
#define MXC_F_WDT_CTRL_WDT_EN \
	((uint32_t)(0x1UL     \
		    << MXC_F_WDT_CTRL_WDT_EN_POS)) /**< CTRL_WDT_EN Mask */
...
#define MXC_F_WDT_CTRL_INT_EN \
	((uint32_t)(0x1UL     \
		    << MXC_F_WDT_CTRL_INT_EN_POS)) /**< CTRL_INT_EN Mask */
...
#define MXC_F_WDT_CTRL_RST_EN \
	((uint32_t)(0x1UL     \
		    << MXC_F_WDT_CTRL_RST_EN_POS)) /**< CTRL_RST_EN Mask */
...
#define MXC_F_WDT_RST_WDT_RST \
	((uint32_t)(0xFFUL    \
		    << MXC_F_WDT_RST_WDT_RST_POS)) /**< RST_WDT_RST Mask */
