...
#define MXC_F_GCR_RSTR0_GPIO0 \
	((uint32_t)(0x1UL     \
		    << MXC_F_GCR_RSTR0_GPIO0_POS)) /**< RSTR0_GPIO0 Mask */
...
#define MXC_F_GCR_RSTR0_UART0 \
	((uint32_t)(0x1UL     \
		    << MXC_F_GCR_RSTR0_UART0_POS)) /**< RSTR0_UART0 Mask */
...
#define MXC_F_GCR_RSTR0_UART1 \
	((uint32_t)(0x1UL     \
		    << MXC_F_GCR_RSTR0_UART1_POS)) /**< RSTR0_UART1 Mask */
...
#define MXC_F_GCR_RSTR0_SPI0 \
	((uint32_t)(0x1UL    \
		    << MXC_F_GCR_RSTR0_SPI0_POS)) /**< RSTR0_SPI0 Mask   \
							 */
...
#define MXC_F_GCR_RSTR0_SPI1 \
	((uint32_t)(0x1UL    \
		    << MXC_F_GCR_RSTR0_SPI1_POS)) /**< RSTR0_SPI1 Mask   \
							 */
...
#define MXC_F_GCR_RSTR0_I2C0 \
	((uint32_t)(0x1UL    \
		    << MXC_F_GCR_RSTR0_I2C0_POS)) /**< RSTR0_I2C0 Mask   \
							 */
...
#define MXC_F_GCR_RSTR0_SRST \
	((uint32_t)(0x1UL    \
		    << MXC_F_GCR_RSTR0_SRST_POS)) /**< RSTR0_SRST Mask   \
							 */
...
#define MXC_F_GCR_RSTR0_PRST \
	((uint32_t)(0x1UL    \
		    << MXC_F_GCR_RSTR0_PRST_POS)) /**< RSTR0_PRST Mask   \
							 */
...
#define MXC_F_GCR_CLKCN_CKRDY \
	((uint32_t)(0x1UL     \
		    << MXC_F_GCR_CLKCN_CKRDY_POS)) /**< CLKCN_CKRDY Mask */
...
#define MXC_F_GCR_PM_GPIOWKEN \
	((uint32_t)(0x1UL     \
		    << MXC_F_GCR_PM_GPIOWKEN_POS)) /**< PM_GPIOWKEN Mask */
...
#define MXC_F_GCR_PM_RTCWKEN \
	((uint32_t)(0x1UL    \
		    << MXC_F_GCR_PM_RTCWKEN_POS)) /**< PM_RTCWKEN Mask   \
							 */
...
#define MXC_F_GCR_MEMCKCN_FWS \
	((uint32_t)(0x7UL     \
		    << MXC_F_GCR_MEMCKCN_FWS_POS)) /**< MEMCKCN_FWS Mask */
...
#define MXC_F_GCR_RSTR1_I2C1 \
	((uint32_t)(0x1UL    \
		    << MXC_F_GCR_RSTR1_I2C1_POS)) /**< RSTR1_I2C1 Mask   \
							 */
