...
struct i2c_req {
	uint8_t addr; /**     I2C 7-bit Address right aligned, bit 6 to bit 0.
	...
	i2c_transfer_direction_t
		direction; /* For master:  sets direction bit in address. For */
	/* slave: direction of request from master. */
 ...
 *    returns EC_SUCCESS if successful, otherwise returns a common error code
 */
