...
#define MXC_S_TMR_CN_TEN_EN  \
	(MXC_V_TMR_CN_TEN_EN \
	 << MXC_F_TMR_CN_TEN_POS) /**< CN_TEN_EN Setting   \
						       */
...
#define MXC_F_TMR_CN_PWMSYNC \
	((uint32_t)(0x1UL    \
		    << MXC_F_TMR_CN_PWMSYNC_POS)) /**< CN_PWMSYNC Mask   \
							 */
...
#define MXC_F_TMR_CN_NOLHPOL \
	((uint32_t)(0x1UL    \
		    << MXC_F_TMR_CN_NOLHPOL_POS)) /**< CN_NOLHPOL Mask   \
							 */
...
#define MXC_F_TMR_CN_NOLLPOL \
	((uint32_t)(0x1UL    \
		    << MXC_F_TMR_CN_NOLLPOL_POS)) /**< CN_NOLLPOL Mask   \
							 */
...
#define MXC_F_TMR_CN_PWMCKBD \
	((uint32_t)(0x1UL    \
		    << MXC_F_TMR_CN_PWMCKBD_POS)) /**< CN_PWMCKBD Mask   \
							 */
