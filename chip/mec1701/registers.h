 ...
 * NOTE: MEC17xx AHB masters do NOT require aliasing.
...
#define MEC17XX_PCR_CLK_REQ(x)	REG32(MEC17XX_PCR_BASE + 0x50 + ((x)<<2))
#define MEC17XX_PCR_RST_EN(x)	REG32(MEC17XX_PCR_BASE + 0x70 + ((x)<<2))

#define MEC17XX_PCR_SLP_RST_REG_MAX	(5)

/* Bit definitions for MEC17XX_PCR_SYS_SLP_CTL */
#define MEC17XX_PCR_SYS_SLP_LIGHT	(0ul << 0)
#define MEC17XX_PCR_SYS_SLP_HEAVY	(1ul << 0)
#define MEC17XX_PCR_SYS_SLP_ALL		(1ul << 3)
 ...
 */
#define MEC17XX_PCR_SLP_EN_DEV(d)	MEC17XX_PCR_SLP_EN((d >> 8) & 0x07) |=\
						(1ul << (d & 0x1f))
#define MEC17XX_PCR_SLP_DIS_DEV(d)	MEC17XX_PCR_SLP_EN((d >> 8) & 0x07) &=\
						~(1ul << (d & 0x1f))
 ...
 */
#define MEC17XX_PCR_SLP_EN_DEV_MASK(id, m)  MEC17XX_PCR_SLP_EN(id) |= (m)
#define MEC17XX_PCR_SLP_DIS_DEV_MASK(id, m) MEC17XX_PCR_SLP_EN(id) &= ~(m)

/* Slow Clock Control Mask */
#define MEC17xx_PCR_SLOW_CLK_CTL_MASK	0x03FFul

/* Sleep Enable, Clock Required, Reset on Sleep 0 bits */
#define MEC17XX_PCR_ISPI		(0x0002)
#define MEC17XX_PCR_EFUSE		(0x0001)
#define MEC17XX_PCR_JTAG		(0x0000)

/* Command all blocks to sleep */
#define MEC17XX_PCR_SLP_EN0_ISPI	(1 << 2)
#define MEC17XX_PCR_SLP_EN0_EFUSE	(1 << 1)
#define MEC17XX_PCR_SLP_EN0_JTAG	(1 << 0)
#define MEC17XX_PCR_SLP_EN0_SLEEP	0x07ul

/* Sleep Enable, Clock Required, Reset on Sleep 1 bits */
#define MEC17XX_PCR_BTMR16_1		((1 << 8) + 31)
#define MEC17XX_PCR_BTMR16_0		((1 << 8) + 30)
#define MEC17XX_PCR_ECS			((1 << 8) + 29)
#define MEC17XX_PCR_PWM8		((1 << 8) + 27)
#define MEC17XX_PCR_PWM7		((1 << 8) + 26)
#define MEC17XX_PCR_PWM6		((1 << 8) + 25)
#define MEC17XX_PCR_PWM5		((1 << 8) + 24)
#define MEC17XX_PCR_PWM4		((1 << 8) + 23)
#define MEC17XX_PCR_PWM3		((1 << 8) + 22)
#define MEC17XX_PCR_PWM2		((1 << 8) + 21)
#define MEC17XX_PCR_PWM1		((1 << 8) + 20)
#define MEC17XX_PCR_TACH2		((1 << 8) + 12)
#define MEC17XX_PCR_TACH1		((1 << 8) + 11)
#define MEC17XX_PCR_I2C0		((1 << 8) + 10)
#define MEC17XX_PCR_WDT			((1 << 8) + 9)
#define MEC17XX_PCR_CPU			((1 << 8) + 8)
#define MEC17XX_PCR_TFDP		((1 << 8) + 7)
#define MEC17XX_PCR_DMA			((1 << 8) + 6)
#define MEC17XX_PCR_PMC			((1 << 8) + 5)
#define MEC17XX_PCR_PWM0		((1 << 8) + 4)
#define MEC17XX_PCR_TACH0		((1 << 8) + 2)
#define MEC17XX_PCR_PECI		((1 << 8) + 1)
#define MEC17XX_PCR_ECIA		((1 << 8) + 0)

/* Command all blocks to sleep */
#define MEC17XX_PCR_SLP_EN1_BTMR16_1	(1 << 31)
#define MEC17XX_PCR_SLP_EN1_BTMR16_0	(1 << 30)
#define MEC17XX_PCR_SLP_EN1_ECS		(1 << 29)
/* bit[28] reserved */
#define MEC17XX_PCR_SLP_EN1_PWM_ALL	((1 << 4) + (0xff << 20))
...
/* bits[19:13] reserved */
#define MEC17XX_PCR_SLP_EN1_TACH2	(1 << 12)
#define MEC17XX_PCR_SLP_EN1_TACH1	(1 << 11)
#define MEC17XX_PCR_SLP_EN1_I2C0	(1 << 10)
#define MEC17XX_PCR_SLP_EN1_WDT		(1 << 9)
#define MEC17XX_PCR_SLP_EN1_CPU		(1 << 8)
#define MEC17XX_PCR_SLP_EN1_TFDP	(1 << 7)
#define MEC17XX_PCR_SLP_EN1_DMA		(1 << 6)
#define MEC17XX_PCR_SLP_EN1_PMC		(1 << 5)
#define MEC17XX_PCR_SLP_EN1_PWM0	(1 << 4)
/* bit[3] reserved */
#define MEC17XX_PCR_SLP_EN1_TACH0	(1 << 2)
#define MEC17XX_PCR_SLP_EN1_PECI	(1 << 1)
#define MEC17XX_PCR_SLP_EN1_ECIA	(1 << 0)
/* all sleep enable 1 bits */
#define MEC17XX_PCR_SLP_EN1_SLEEP	0xffffffff
/* 
 * block not used by default 
 * Always use ECIA, PMC, CPU and ECS
 */
#define MEC17XX_PCR_SLP_EN1_UNUSED_BLOCKS	0xdffffede

/* Sleep Enable2, Clock Required2, Reset on Sleep2 bits */
#define MEC17XX_PCR_P80CAP1		((2 << 8) + 26)
#define MEC17XX_PCR_P80CAP0		((2 << 8) + 25)
#define MEC17XX_PCR_ACPI_EC4		((2 << 8) + 23)
#define MEC17XX_PCR_ACPI_EC3		((2 << 8) + 22)
#define MEC17XX_PCR_ACPI_EC2		((2 << 8) + 21)
#define MEC17XX_PCR_ESPI		((2 << 8) + 19)
#define MEC17XX_PCR_RTC			((2 << 8) + 18)
#define MEC17XX_PCR_MBOX		((2 << 8) + 17)
#define MEC17XX_PCR_8042		((2 << 8) + 16)
#define MEC17XX_PCR_ACPI_PM1		((2 << 8) + 15)
#define MEC17XX_PCR_ACPI_EC1		((2 << 8) + 14)
#define MEC17XX_PCR_ACPI_EC0		((2 << 8) + 13)
#define MEC17XX_PCR_GCFG		((2 << 8) + 12)
#define MEC17XX_PCR_UART1		((2 << 8) + 2)
#define MEC17XX_PCR_UART0		((2 << 8) + 1)
#define MEC17XX_PCR_LPC			((2 << 8) + 0)

/* Command all blocks to sleep */
/* bits[31:27] reserved */
#define MEC17XX_PCR_SLP_EN2_P80CAP1	(1 << 26)
#define MEC17XX_PCR_SLP_EN2_P80CAP0	(1 << 25)
/* bit[24] reserved */
#define MEC17XX_PCR_SLP_EN2_ACPI_EC4	(1 << 23)
#define MEC17XX_PCR_SLP_EN2_ACPI_EC3	(1 << 22)
#define MEC17XX_PCR_SLP_EN2_ACPI_EC2	(1 << 21)
/* bit[20] reserved */
#define MEC17XX_PCR_SLP_EN2_ESPI	(1 << 19)
#define MEC17XX_PCR_SLP_EN2_RTC		(1 << 18)
#define MEC17XX_PCR_SLP_EN2_MAILBOX	(1 << 17)
#define MEC17XX_PCR_SLP_EN2_MIF8042	(1 << 16)
#define MEC17XX_PCR_SLP_EN2_ACPI_PM1	(1 << 15)
#define MEC17XX_PCR_SLP_EN2_ACPI_EC1	(1 << 14)
#define MEC17XX_PCR_SLP_EN2_ACPI_EC0	(1 << 13)
#define MEC17XX_PCR_SLP_EN2_GCFG	(1 << 12)
/* bits[11:3] reserved */
#define MEC17XX_PCR_SLP_EN2_UART1	(1 << 2)
#define MEC17XX_PCR_SLP_EN2_UART0	(1 << 1)
#define MEC17XX_PCR_SLP_EN2_LPC		(1 << 0)
/* all sleep enable 2 bits */
#define MEC17XX_PCR_SLP_EN2_SLEEP	0x07ffffff

/* Sleep Enable3, Clock Required3, Reset on Sleep3 bits */
#define MEC17XX_PCR_PWM9		((3 << 8) + 31)
#define MEC17XX_PCR_CCT0		((3 << 8) + 30)
#define MEC17XX_PCR_HTMR1		((3 << 8) + 29)
#define MEC17XX_PCR_AESHASH		((3 << 8) + 28)
#define MEC17XX_PCR_RNG			((3 << 8) + 27)
#define MEC17XX_PCR_PKE			((3 << 8) + 26)
#define MEC17XX_PCR_LED3		((3 << 8) + 25)
#define MEC17XX_PCR_BTMR32_1		((3 << 8) + 24)
#define MEC17XX_PCR_BTMR32_0		((3 << 8) + 23)
#define MEC17XX_PCR_BTMR16_3		((3 << 8) + 22)
#define MEC17XX_PCR_BTMR16_2		((3 << 8) + 21)
#define MEC17XX_PCR_GPSPI1		((3 << 8) + 20)
#define MEC17XX_PCR_BCM0		((3 << 8) + 19)
#define MEC17XX_PCR_LED2		((3 << 8) + 18)
#define MEC17XX_PCR_LED1		((3 << 8) + 17)
#define MEC17XX_PCR_LED0		((3 << 8) + 16)
#define MEC17XX_PCR_I2C3		((3 << 8) + 15)
#define MEC17XX_PCR_I2C2		((3 << 8) + 14)
#define MEC17XX_PCR_I2C1		((3 << 8) + 13)
#define MEC17XX_PCR_RPMPWM0		((3 << 8) + 12)
#define MEC17XX_PCR_KEYSCAN		((3 << 8) + 11)
#define MEC17XX_PCR_HTMR0		((3 << 8) + 10)
#define MEC17XX_PCR_GPSPI0		((3 << 8) + 9)
#define MEC17XX_PCR_PS2_2		((3 << 8) + 7)
#define MEC17XX_PCR_PS2_1		((3 << 8) + 6)
#define MEC17XX_PCR_PS2_0		((3 << 8) + 5)
#define MEC17XX_PCR_ADC			((3 << 8) + 3)

/* Command all blocks to sleep */
#define MEC17XX_PCR_SLP_EN3_PWM9	(1 << 31)
#define MEC17XX_PCR_SLP_EN3_CCT0	(1 << 30)
#define MEC17XX_PCR_SLP_EN3_HTMR1	(1 << 29)
#define MEC17XX_PCR_SLP_EN3_AESHASH	(1 << 28)
#define MEC17XX_PCR_SLP_EN3_RNG		(1 << 27)
#define MEC17XX_PCR_SLP_EN3_PKE		(1 << 26)
#define MEC17XX_PCR_SLP_EN3_LED3	(1 << 25)
#define MEC17XX_PCR_SLP_EN3_BTMR32_1	(1 << 24)
#define MEC17XX_PCR_SLP_EN3_BTMR32_0	(1 << 23)
#define MEC17XX_PCR_SLP_EN3_BTMR16_3	(1 << 22)
#define MEC17XX_PCR_SLP_EN3_BTMR16_2	(1 << 21)
#define MEC17XX_PCR_SLP_EN3_GPSPI1	(1 << 20)
#define MEC17XX_PCR_SLP_EN3_BCM0	(1 << 19)
#define MEC17XX_PCR_SLP_EN3_LED2	(1 << 18)
#define MEC17XX_PCR_SLP_EN3_LED1	(1 << 17)
#define MEC17XX_PCR_SLP_EN3_LED0	(1 << 16)
#define MEC17XX_PCR_SLP_EN3_I2C3	(1 << 15)
#define MEC17XX_PCR_SLP_EN3_I2C2	(1 << 14)
#define MEC17XX_PCR_SLP_EN3_I2C1	(1 << 13)
#define MEC17XX_PCR_SLP_EN3_RPMPWM0	(1 << 12)
#define MEC17XX_PCR_SLP_EN3_KEYSCAN	(1 << 11)
#define MEC17XX_PCR_SLP_EN3_HTMR0	(1 << 10)
#define MEC17XX_PCR_SLP_EN3_GPSPI0	(1 << 9)
/* bit[8] reserved */
#define MEC17XX_PCR_SLP_EN3_PS2_2	(1 << 7)
#define MEC17XX_PCR_SLP_EN3_PS2_1	(1 << 6)
#define MEC17XX_PCR_SLP_EN3_PS2_0	(1 << 5)
/* bit[4] reserved */
#define MEC17XX_PCR_SLP_EN3_ADC		(1 << 3)
/* bits[2:0] reserved */
/* all sleep enable 3 bits */
#define MEC17XX_PCR_SLP_EN3_SLEEP	0xfffffeed

/* Sleep Enable4, Clock Required4, Reset on Sleep4 bits */
#define MEC17XX_PCR_FJCL		((4 << 8) + 15)
#define MEC17XX_PCR_PSPI		((4 << 8) + 14)
#define MEC17XX_PCR_PROCHOT		((4 << 8) + 13)
#define MEC17XX_PCR_RCID2		((4 << 8) + 12)
#define MEC17XX_PCR_RCID1		((4 << 8) + 11)
#define MEC17XX_PCR_RCID0		((4 << 8) + 10)
#define MEC17XX_PCR_BCM1		((4 << 8) + 9)
#define MEC17XX_PCR_QMSPI		((4 << 8) + 8)
#define MEC17XX_PCR_RPMPWM1		((4 << 8) + 7)
#define MEC17XX_PCR_RTMR		((4 << 8) + 6)
#define MEC17XX_PCR_CNT16_3		((4 << 8) + 5)
#define MEC17XX_PCR_CNT16_2		((4 << 8) + 4)
#define MEC17XX_PCR_CNT16_1		((4 << 8) + 3)
#define MEC17XX_PCR_CNT16_0		((4 << 8) + 2)
#define MEC17XX_PCR_PWM11		((4 << 8) + 1)
#define MEC17XX_PCR_PWM10		((4 << 8) + 0)

/* Command all blocks to sleep */
#define MEC17XX_PCR_SLP_EN4_FJCL	(1 << 15)
#define MEC17XX_PCR_SLP_EN4_PSPI	(1 << 14)
#define MEC17XX_PCR_SLP_EN4_PROCHOT	(1 << 13)
#define MEC17XX_PCR_SLP_EN4_RCID2	(1 << 12)
#define MEC17XX_PCR_SLP_EN4_RCID1	(1 << 11)
#define MEC17XX_PCR_SLP_EN4_RCID0	(1 << 10)
#define MEC17XX_PCR_SLP_EN4_BCM1	(1 << 9)
#define MEC17XX_PCR_SLP_EN4_QMSPI	(1 << 8)
#define MEC17XX_PCR_SLP_EN4_RPMPWM1	(1 << 7)
#define MEC17XX_PCR_SLP_EN4_RTMR	(1 << 6)
#define MEC17XX_PCR_SLP_EN4_CNT16_3	(1 << 5)
#define MEC17XX_PCR_SLP_EN4_CNT16_2	(1 << 4)
#define MEC17XX_PCR_SLP_EN4_CNT16_1	(1 << 3)
#define MEC17XX_PCR_SLP_EN4_CNT16_0	(1 << 2)
#define MEC17XX_PCR_SLP_EN4_PWM_ALL	(3 << 0)
#define MEC17XX_PCR_SLP_EN4_PWM11	(1 << 1)
#define MEC17XX_PCR_SLP_EN4_PWM10	(1 << 0)
/* all sleep enable 4 bits */
#define MEC17XX_PCR_SLP_EN4_SLEEP	0x0000ffff

/* Allow all blocks to request clocks */
#define MEC17XX_PCR_SLP_EN0_WAKE	(~(MEC17XX_PCR_SLP_EN0_SLEEP))
#define MEC17XX_PCR_SLP_EN1_WAKE	(~(MEC17XX_PCR_SLP_EN1_SLEEP))
#define MEC17XX_PCR_SLP_EN2_WAKE	(~(MEC17XX_PCR_SLP_EN2_SLEEP))
#define MEC17XX_PCR_SLP_EN3_WAKE	(~(MEC17XX_PCR_SLP_EN3_SLEEP))
#define MEC17XX_PCR_SLP_EN4_WAKE	(~(MEC17XX_PCR_SLP_EN4_SLEEP))
...
#define MEC17XX_PCR_SLP_EN1_PKE		(1 << 26)
#define MEC17XX_PCR_SLP_EN1_NDRNG	(1 << 27)
#define MEC17XX_PCR_SLP_EN1_AES_SHA	(1 << 28)
#define MEC17XX_PCR_SLP_EN1_ALL_CRYPTO	(0x07 << 26)
...
/* MEC17XX_EC_JTAG_EN bit definitions */
#define MEC17XX_JTAG_ENABLE		0x01
/* bits [2:1] */
#define MEC17XX_JTAG_MODE_4PIN		0x00
/* ARM 2-pin SWD plus 1-pin Serial Wire Viewer (ITM) */
#define MEC17XX_JTAG_MODE_SWD_SWV	0x02
/* ARM 2-pin SWD with no SWV */
#define MEC17XX_JTAG_MODE_SWD		0x04
...
#define MEC17XX_INTx_BASE(x)   (MEC17XX_INT_BASE + \
		((x)<<4) + ((x)<<2) - 160)
...
#define MEC17XX_INT_GIRQ_FIRST	8
#define MEC17XX_INT_GIRQ_LAST	26
#define MEC17XX_INT_GIRQ_NUM	(26-8+1)
...
#define MEC17XX_INT22_WAKE_ONLY_LPC	(1ul << 0)
#define MEC17XX_INT22_WAKE_ONLY_I2C0	(1ul << 1)
#define MEC17XX_INT22_WAKE_ONLY_I2C1	(1ul << 2)
#define MEC17XX_INT22_WAKE_ONLY_I2C2	(1ul << 3)
#define MEC17XX_INT22_WAKE_ONLY_I2C3	(1ul << 4)
#define MEC17XX_INT22_WAKE_ONLY_ESPI	(1ul << 9)
...
/* MEC17xx each Port contains 32 GPIO's.
 ...
 *
 */
#define MEC17XX_GPIO_CTL(port, id) REG32(MEC17XX_GPIO_BASE + \
	(((port << 5) + id) << 2))

/* MEC17xx implements 6 GPIO ports */
#define MEC17XX_GPIO_MAX_PORT	(7)
 ...
 */
#define MEC17XX_GPIO_CTRL(gpio_num) REG32(MEC17XX_GPIO_BASE + \
	((gpio_num) << 2))

/*
 * GPIO control register bit fields
 */
#define MEC17XX_GPIO_CTRL_PUD_BITPOS		0
#define MEC17XX_GPIO_CTRL_PUD_MASK0		0x03
#define MEC17XX_GPIO_CTRL_PUD_MASK		0x03
#define MEC17XX_GPIO_CTRL_PUD_NONE		0x00
#define MEC17XX_GPIO_CTRL_PUD_PU		0x01
#define MEC17XX_GPIO_CTRL_PUD_PD		0x02
#define MEC17XX_GPIO_CTRL_PUD_KEEPER		0x03
#define MEC17XX_GPIO_CTRL_PWR_BITPOS		2
#define MEC17XX_GPIO_CTRL_PWR_MASK0		0x03
#define MEC17XX_GPIO_CTRL_PWR_MASK		(0x03 << 2)
#define MEC17XX_GPIO_CTRL_PWR_VTR		(0x00 << 2)
#define MEC17XX_GPIO_CTRL_PWR_OFF		(0x02 << 2)
#define MEC17XX_GPIO_INTDET_MASK		(0xF0)
#define MEC17XX_GPIO_INTDET_LVL_LO		(0x00)
#define MEC17XX_GPIO_INTDET_LVL_HI		(0x10)
#define MEC17XX_GPIO_INTDET_DISABLED		(0x40)
#define MEC17XX_GPIO_INTDET_EDGE_RIS		(0xD0)
#define MEC17XX_GPIO_INTDET_EDGE_FALL		(0xE0)
#define MEC17XX_GPIO_INTDET_EDGE_BOTH		(0xF0)
#define MEC17XX_GPIO_INTDET_EDGE_EN		(1u << 7)
#define MEC17XX_GPIO_PUSH_PULL			(0u << 8)
#define MEC17XX_GPIO_OPEN_DRAIN			(1u << 8)
#define MEC17XX_GPIO_INPUT			(0u << 9)
#define MEC17XX_GPIO_OUTPUT			(1u << 9)
#define MEC17XX_GPIO_OUTSET_CTRL		(0u << 10)
#define MEC17XX_GPIO_OUTSEL_PAR 		(1u << 10)
#define MEC17XX_GPIO_POLARITY_NINV		(0u << 11)
#define MEC17XX_GPIO_POLARITY_INV		(1u << 11)
#define MEC17XX_GPIO_CTRL_ALT_FUNC_BITPOS	12
#define MEC17XX_GPIO_CTRL_ALT_FUNC_MASK0	0x0F
#define MEC17XX_GPIO_CTRL_ALT_FUNC_MASK		(0x0F << 12)
#define MEC17XX_GPIO_CTRL_FUNC_GPIO		(0 << 12)
#define MEC17XX_GPIO_CTRL_FUNC_1		(1 << 12)
#define MEC17XX_GPIO_CTRL_FUNC_2		(2 << 12)
#define MEC17XX_GPIO_CTRL_FUNC_3		(3 << 12)
#define MEC17XX_GPIO_CTRL_OUT_LVL		(1 << 16)
...
/* RTimer */
#define MEC17XX_RTMR_BASE	(0x40007400)
#define MEC17XX_RTMR_COUNTER	REG32(MEC17XX_RTMR_BASE + 0x00)
#define MEC17XX_RTMR_PRELOAD	REG32(MEC17XX_RTMR_BASE + 0x04)
#define MEC17XX_RTMR_CONTROL	REG8(MEC17XX_RTMR_BASE + 0x08)
#define MEC17XX_RTMR_SOFT_INTR	REG8(MEC17XX_RTMR_BASE + 0x0c)
/* RTimer GIRQ21 bit[0] */
#define MEC17XX_RTMR_GIRQ		21
#define MEC17XX_RTMR_GIRQ_BIT(x)	(1ul << 0)
...
#define MEC17XX_VBAT_SHDN_DIS           REG32(MEC17XX_VBAT_BASE + 0xC)
...
#define MEC17XX_VBAT_RAM(x)   REG32(MEC17XX_VBAT_BASE + 0x400 + ((x) * 4))
#define MEC17XX_VBAT_VWIRE_BACKUP       30
...
#define MEC17XX_VBAT_STS_ANY_RST	(0xF4u)
 ...
 * 4 instances
 */
#define MEC17XX_BBLED_BASE(x)	(0x4000B800 + (((x) & 0x03) << 8))
#define MEC17XX_BBLEN_INSTANCES	4

#define MEC17XX_BBLED_CONFIG(x)		REG32(MEC17XX_BBLED_BASE(x) + 0x00)
#define MEC17XX_BBLED_LIMITS(x)		REG32(MEC17XX_BBLED_BASE(x) + 0x04)
#define MEC17XX_BBLED_LIMIT_MIN(x)	REG8(MEC17XX_BBLED_BASE(x) + 0x04)
#define MEC17XX_BBLED_LIMIT_MAX(x)	REG8(MEC17XX_BBLED_BASE(x) + 0x06)
#define MEC17XX_BBLED_DELAY(x)		REG32(MEC17XX_BBLED_BASE(x) + 0x08)
#define MEC17XX_BBLED_UPDATE_STEP(x)	REG32(MEC17XX_BBLED_BASE(x) + 0x0C)
#define MEC17XX_BBLED_UPDATE_INTV(x)	REG32(MEC17XX_BBLED_BASE(x) + 0x10)
#define MEC17XX_BBLED_OUTPUT_DLY(x)	REG8(MEC17XX_BBLED_BASE(x) + 0x14)

/* BBLED Configuration Register */
#define MEC17XX_BBLED_ASYMMETRIC	(1ul << 16)
#define MEC17XX_BBLED_WDT_RELOAD_BITPOS	(8)
#define MEC17XX_BBLED_WDT_RELOAD_MASK0	(0xFFul)
#define MEC17XX_BBLED_WDT_RELOAD_MASK	(0xFFul << 8)
#define MEC17XX_BBLED_RESET		(1ul << 7)
#define MEC17XX_BBLED_EN_UPDATE		(1ul << 6)
#define MEC17XX_BBLED_PWM_SIZE_BITPOS	(4)
#define MEC17XX_BBLED_PWM_SIZE_MASK0	(0x03ul)
#define MEC17XX_BBLED_PWM_SIZE_MASK	(0x03ul << 4)
#define MEC17XX_BBLED_PWM_SIZE_6BIT	(0x02ul << 4)
#define MEC17XX_BBLED_PWM_SIZE_7BIT	(0x01ul << 4)
#define MEC17XX_BBLED_PWM_SIZE_8BIT	(0x00ul << 4)
#define MEC17XX_BBLED_SYNC		(1ul << 3)
#define MEC17XX_BBLED_CLK_48M		(1ul << 2)
#define MEC17XX_BBLED_CLK_32K		(0ul << 2)
#define MEC17XX_BBLED_CTRL_MASK		(0x03ul)
#define MEC17XX_BBLED_CTRL_ALWAYS_ON	(0x03ul)
#define MEC17XX_BBLED_CTRL_BLINK	(0x02ul)
#define MEC17XX_BBLED_CTRL_BREATHE	(0x01ul)
#define MEC17XX_BBLED_CTRL_OFF		(0x00ul)

/* BBLED Delay Register */
#define MEC17XX_BBLED_DLY_MASK		(0x0FFFul)
#define MEC17XX_BBLED_DLY_LO_BITPOS	(0)
#define MEC17XX_BBLED_DLY_LO_MASK	(0x0FFFul << 0)
#define MEC17XX_BBLED_DLY_HI_BITPOS	(12)
#define MEC17XX_BBLED_DLY_HI_MASK	(0x0FFFul << 12)

/*
 * BBLED Update Step Register
 * 8 update fields numbered 0 - 7
 */
#define MEC17XX_BBLED_UPD_STEP_MASK0	(0x0Ful)
#define MEC17XX_BBLED_UPD_STEP_MASK(u)	(0x0Ful << (((u) & 0x07) + 4))

/*
 * BBLED Update Interval Register
 * 8 interval fields numbered 0 - 7
 */
#define MEC17XX_BBLED_UPD_INTV_MASK0	(0x0Ful)
#define MEC17XX_BBLED_UPD_INTV_MASK(i)	(0x0Ful << (((i) & 0x07) + 4))
...
#define MEC17XX_LPC_HOST_ERROR		REG32(MEC17XX_LPC_RT_BASE + 0x8)
#define MEC17XX_LPC_EC_SERIRQ		REG32(MEC17XX_LPC_RT_BASE + 0xC)
#define MEC17XX_LPC_EC_CLK_CTRL		REG32(MEC17XX_LPC_RT_BASE + 0x10)
#define MEC17XX_LPC_BAR_INHIBIT		REG32(MEC17XX_LPC_RT_BASE + 0x20)
...
#define MEC17XX_P80_CNT_GET(x)		(\
	REG32(MEC17XX_P80_BASE(x) + 0x10c) >> 8)
#define MEC17XX_P80_CNT_SET(x, c)	(\
	REG32(MEC17XX_P80_BASE(x) + 0x10c) = (c << 8))
...
#define MEC17XX_P80_CAP_TS_MASK			(\
	(MEC17XX_P80_CAP_TS_MASK0) << (MEC17XX_P80_CAP_TS_BITPOS))
...
#define MEC17XX_P80_TIMEBASE_MASK		(\
	(MEC17XX_P80_TIMEBASE_MASK0) << (MEC17XX_P80_TIMEBASE_BITPOS))
#define MEC17XX_P80_TIMEBASE_750KHZ		(\
	0x03 << (MEC17XX_P80_TIMEBASE_BITPOS))
#define MEC17XX_P80_TIMEBASE_1500KHZ		(\
	0x02 << (MEC17XX_P80_TIMEBASE_BITPOS))
#define MEC17XX_P80_TIMEBASE_3MHZ		(\
	0x01 << (MEC17XX_P80_TIMEBASE_BITPOS))
#define MEC17XX_P80_TIMEBASE_6MHZ		(\
	0x00 << (MEC17XX_P80_TIMEBASE_BITPOS))
...
#define MEC17XX_P80_CNT_MASK			((MEC17XX_P80_CNT_MASK0) << \
	(MEC17XX_P80_CNT_BITPOS))


/* PWM */
#define MEC17XX_PWM_ID_MAX	(12)
...
/* TACH */
#define MEC17XX_TACH_BASE(x)		(0x40006000 + (x) << 4)
#define MEC17XX_TACH_CTRL(x)		REG32(MEC17XX_TACH_BASE(x))
#define MEC17XX_TACH_CTRL_LO(x)		REG16(MEC17XX_TACH_BASE(x) + 0x00)
#define MEC17XX_TACH_CTRL_CNT(x)	REG16(MEC17XX_TACH_BASE(x) + 0x02)
#define MEC17XX_TACH_STATUS(x)		REG8(MEC17XX_TACH_BASE(x) + 0x04)
#define MEC17XX_TACH_LIMIT_HI(x)	REG16(MEC17XX_TACH_BASE(x) + 0x08)
#define MEC17XX_TACH_LIMIT_LO(x)	REG16(MEC17XX_TACH_BASE(x) + 0x0C)
/*
 * TACH [2:0] GIRQ17 bits[3:1]
 */
#define MEC17XX_TACH_GIRQ		17
#define MEC17XX_TACH_GIRQ_BIT(x)	(1ul << ((x) + 1))


/* ACPI */
#define MEC17XX_ACPI_EC_BASE(x)		(0x400f0800 + ((x) << 10))
#define MEC17XX_ACPI_EC_EC2OS(x, y) REG8(MEC17XX_ACPI_EC_BASE(x) + \
						0x100 + (y))
...
#define MEC17XX_ACPI_EC_OS2EC(x, y) REG8(MEC17XX_ACPI_EC_BASE(x) + \
						0x108 + (y))
...
/* I2C */
#define MEC17XX_I2C_CTRL0	(0)
#define MEC17XX_I2C_CTRL1	(1)
#define MEC17XX_I2C_CTRL2	(2)
#define MEC17XX_I2C_CTRL3	(3)
#define MEC17XX_I2C_CTRL_MAX	(4)
...
#define MEC17XX_I2C_ADDR(controller, offset) (offset + \
	MEC17XX_I2C_BASE(controller))
 ...
 */
#define MEC17XX_I2C_PORT_MASK	0x07FDul

enum mec17xx_i2c_port {
	MEC17XX_I2C_PORT0 = 0,
	MEC17XX_I2C_PORT1,	/* port 1, do not use. pins not present */
	MEC17XX_I2C_PORT2,
	MEC17XX_I2C_PORT3,
	MEC17XX_I2C_PORT4,
	MEC17XX_I2C_PORT5,
...
#define MEC17XX_SPI_TD_ADDR(ctrl)	(MEC17XX_SPI_BASE(ctrl) + 0x0c)
#define MEC17XX_SPI_RD_ADDR(ctrl)	(MEC17XX_SPI_BASE(ctrl) + 0x10)
...
#define MEC17XX_GPSPI0_ID	0
#define MEC17XX_GPSPI1_ID	1


/* Quad Master SPI (QMSPI) */
#define MEC17XX_QMSPI0_BASE		0x40005400
#define MEC17XX_QMSPI0_MODE		REG32(MEC17XX_QMSPI0_BASE + 0x00)
#define MEC17XX_QMSPI0_MODE_ACT_SRST	REG8(MEC17XX_QMSPI0_BASE + 0x00)
#define MEC17XX_QMSPI0_MODE_SPI_MODE	REG8(MEC17XX_QMSPI0_BASE + 0x01)
#define MEC17XX_QMSPI0_MODE_FDIV	REG8(MEC17XX_QMSPI0_BASE + 0x02)
...
#define MEC17XX_QMSPI0_TX_FIFO_ADDR	(MEC17XX_QMSPI0_BASE + 0x20)
...
#define MEC17XX_QMSPI0_RX_FIFO_ADDR	(MEC17XX_QMSPI0_BASE + 0x24)
...
#define MEC17XX_QMSPI0_DESCR(x)		REG32(MEC17XX_QMSPI0_BASE + \
	0x30 + ((x)<<2))
 ...
 */
#define MEC17XX_QMSPI_M_CLKDIV_BITPOS	16
#define MEC17XX_QMSPI_M_CLKDIV_48M  (1ul << 16)
#define MEC17XX_QMSPI_M_CLKDIV_24M  (2ul << 16)
#define MEC17XX_QMSPI_M_CLKDIV_16M  (3ul << 16)
#define MEC17XX_QMSPI_M_CLKDIV_12M  (4ul << 16)
#define MEC17XX_QMSPI_M_CLKDIV_8M   (6ul << 16)
#define MEC17XX_QMSPI_M_CLKDIV_6M   (8ul << 16)
#define MEC17XX_QMSPI_M_CLKDIV_1M   (48ul << 16)
#define MEC17XX_QMSPI_M_CLKDIV_188K (0x100ul << 16)
...
#define MEC17XX_QMSPI_CTRL_TX_DMA_MASK  (3ul << 4)
...
#define MEC17XX_QMSPI_CTRL_RX_DMA_MASK  (3ul << 7)
...
#define MEC17XX_QMSPI_CTRL_NEXT_DESCR_MASK \
	(MEC17XX_QMSPI_CTRL_NEXT_DESCR_MASK0 << 12)
...
#define MEC17XX_QMSPI_CTRL_MAX_UNITS		(0x7ffful)
#define MEC17XX_QMSPI_CTRL_NUM_UNITS_MASK \
	((MEC17XX_QMSPI_CTRL_MAX_UNITS) << 17)
 ...
 * b[7:0]=mask
 */
#define MEC17XX_ESPI_IO_BAR_CTL(x)	REG32(MEC17XX_ESPI_IO_BASE + \
	0x134 + ((x) << 2))
/* access mask field of eSPI IO BAR Control register */
#define MEC17XX_ESPI_IO_BAR_CTL_MASK(x)	REG8(MEC17XX_ESPI_IO_BASE + \
	0x134 + ((x) << 2))
 ...
 * b[0] = valid
 */
#define MEC17XX_ESPI_IO_BAR(x)	REG32(MEC17XX_ESPI_IO_BASE + 0x334 + \
					((x) << 2))

#define MEC17XX_ESPI_IO_BAR_VALID(x)	REG8(MEC17XX_ESPI_IO_BASE + \
	0x334 + ((x) << 2) + 0)
#define MEC17XX_ESPI_IO_BAR_ADDR_LSB(x)	REG8(MEC17XX_ESPI_IO_BASE + \
	0x334 + ((x) << 2) + 2)
#define MEC17XX_ESPI_IO_BAR_ADDR_MSB(x)	REG8(MEC17XX_ESPI_IO_BASE + \
	0x334 + ((x) << 2) + 3)
#define MEC17XX_ESPI_IO_BAR_ADDR(x)	REG16(MEC17XX_ESPI_IO_BASE + \
	0x334 + ((x) << 2) + 2)
...
#define MEC17XX_ESPI_IO_SERIRQ_REG(x)	REG8(MEC17XX_ESPI_IO_BASE + \
						0x3ac + (x))
...
#define MEC17XX_ESPI_MBAR_VALID(x) \
	REG8(MEC17XX_ESPI_MEM_BASE + 0x130 + ((x) << 3) + ((x) << 1))

#define MEC17XX_ESPI_MBAR_HOST_ADDR_0_15(x) \
	REG16(MEC17XX_ESPI_MEM_BASE + 0x132 + ((x) << 3) + ((x) << 1))

#define MEC17XX_ESPI_MBAR_HOST_ADDR_16_31(x) \
	REG16(MEC17XX_ESPI_MEM_BASE + 0x134 + ((x) << 3) + ((x) << 1))

#define MEC17XX_ESPI_MBAR_HOST_ADDR_32_47(x) \
	REG16(MEC17XX_ESPI_MEM_BASE + 0x136 + ((x) << 3) + ((x) << 1))

#define MEC17XX_ESPI_MBAR_HOST_ADDR_48_63(x) \
	REG16(MEC17XX_ESPI_MEM_BASE + 0x138 + ((x) << 3) + ((x) << 1))
 ...
 */
#define MEC17XX_ESPI_SRAM_BAR_CFG(x) \
	REG8(MEC17XX_ESPI_MEM_BASE + 0x1ac + ((x) << 3) + ((x) << 1))

#define MEC17XX_ESPI_SRAM_BAR_ADDR_0_15(x) \
	REG16(MEC17XX_ESPI_MEM_BASE + 0x1ae + ((x) << 3) + ((x) << 1))

#define MEC17XX_ESPI_SRAM_BAR_ADDR_16_31(x) \
	REG16(MEC17XX_ESPI_MEM_BASE + 0x1b0 + ((x) << 3) + ((x) << 1))

#define MEC17XX_ESPI_SRAM_BAR_ADDR_32_47(x) \
	REG16(MEC17XX_ESPI_MEM_BASE + 0x1b2 + ((x) << 3) + ((x) << 1))

#define MEC17XX_ESPI_SRAM_BAR_ADDR_48_63(x) \
	REG16(MEC17XX_ESPI_MEM_BASE + 0x1b4 + ((x) << 3) + ((x) << 1))

/* eSPI Memory Bus Master Registers */
#define MEC17XX_ESPI_BM_STATUS \
	REG32(MEC17XX_ESPI_MEM_BASE + 0x200)
#define MEC17XX_ESPI_BM_IEN \
	REG32(MEC17XX_ESPI_MEM_BASE + 0x204)
#define MEC17XX_ESPI_BM_CONFIG \
	REG32(MEC17XX_ESPI_MEM_BASE + 0x208)
#define MEC17XX_ESPI_BM1_CTL \
	REG32(MEC17XX_ESPI_MEM_BASE + 0x210)
#define MEC17XX_ESPI_BM1_HOST_ADDR_LO \
		REG32(MEC17XX_ESPI_MEM_BASE + 0x214)
#define MEC17XX_ESPI_BM1_HOST_ADDR_HI \
	REG32(MEC17XX_ESPI_MEM_BASE + 0x218)
#define MEC17XX_ESPI_BM1_EC_ADDR \
	REG32(MEC17XX_ESPI_MEM_BASE + 0x21c)
#define MEC17XX_ESPI_BM2_CTL \
	REG32(MEC17XX_ESPI_MEM_BASE + 0x224)
#define MEC17XX_ESPI_BM2_HOST_ADDR_LO \
	REG32(MEC17XX_ESPI_MEM_BASE + 0x228)
#define MEC17XX_ESPI_BM2_HOST_ADDR_HI \
	REG32(MEC17XX_ESPI_MEM_BASE + 0x22c)
#define MEC17XX_ESPI_BM2_EC_ADDR \
	REG32(MEC17XX_ESPI_MEM_BASE + 0x230)
 ...
 */
#define MEC17XX_ESPI_MBAR_EC_VSIZE(x) \
	REG32(MEC17XX_ESPI_MEM_BASE + 0x330 + ((x) << 3) + ((x) << 1))
#define MEC17XX_ESPI_MBAR_EC_ADDR_0_15(x) \
	REG16(MEC17XX_ESPI_MEM_BASE + 0x332 + ((x) << 3) + ((x) << 1))
#define MEC17XX_ESPI_MBAR_EC_ADDR_16_31(x) \
	REG16(MEC17XX_ESPI_MEM_BASE + 0x334 + ((x) << 3) + ((x) << 1))
#define MEC17XX_ESPI_MBAR_EC_ADDR_32_47(x) \
	REG16(MEC17XX_ESPI_MEM_BASE + 0x336 + ((x) << 3) + ((x) << 1))
...
#define MEC17XX_ESPI_MSVW_ADDR(n) ((MEC17XX_ESPI_MSVW_BASE) + \
	((n) * (MEC17XX_ESPI_MSVW_LEN)))
 ...
 * MEC17xx eSPI Master to Slave 96-bit VWire registers.
...
#define MSVW(id, w) REG32(MEC17XX_ESPI_MSVW_BASE + ((id) << 3) + \
	((id << 2)) + (((w) & 0x03) << 2))

/* Access index value in byte 0 */
#define MEC17XX_ESPI_VW_M2S_INDEX(id) \
	REG8(MEC17XX_ESPI_VW_BASE + ((id) << 3) + ((id) << 2))
 ...
 */
#define MEC17XX_ESPI_VW_M2S_MTOS(id) \
	REG8(MEC17XX_ESPI_VW_BASE + 1 + ((id) << 3) + ((id) << 2))
 ...
 */
#define MEC17XX_ESPI_VW_M2S_INDEX_MTOS(id) \
	REG16(MEC17XX_ESPI_VW_BASE + ((id) << 3) + ((id) << 2))

/* Access SRCn IRQ Select bit fields */
#define MEC17XX_ESPI_VW_M2S_IRQSEL0(id) \
	(REG8(MEC17XX_ESPI_VW_BASE + 4 + ((id) << 3) + ((id) << 2)))

#define MEC17XX_ESPI_VW_M2S_IRQSEL1(id) \
	(REG8(MEC17XX_ESPI_VW_BASE + 5 + ((id) << 3) + ((id) << 2)))

#define MEC17XX_ESPI_VW_M2S_IRQSEL2(id) \
	(REG8(MEC17XX_ESPI_VW_BASE + 6 + ((id) << 3) + ((id) << 2)))

#define MEC17XX_ESPI_VW_M2S_IRQSEL3(id) \
	(REG8(MEC17XX_ESPI_VW_BASE + 7 + ((id) << 3) + ((id) << 2)))

#define MEC17XX_ESPI_VW_M2S_IRQSEL(id, src) \
	REG8(MEC17XX_ESPI_VW_BASE + 4 + ((id) << 3) + ((id) << 2) + \
						((src) & 0x03))

#define MEC17XX_ESPI_VW_M2S_IRQSEL_ALL(id) \
	(REG32(MEC17XX_ESPI_VW_BASE + 4 + ((id) << 3) + ((id) << 2)))

/* Access individual source bits */
#define MEC17XX_ESPI_VW_M2S_SRC0(id) \
	REG8(MEC17XX_ESPI_VW_BASE + 8 + ((id) << 3) + ((id) << 2))

#define MEC17XX_ESPI_VW_M2S_SRC1(id) \
	REG8(MEC17XX_ESPI_VW_BASE + 9 + ((id) << 3) + ((id) << 2))

#define MEC17XX_ESPI_VW_M2S_SRC2(id) \
	REG8(MEC17XX_ESPI_VW_BASE + 10 + ((id) << 3) + ((id) << 2))

#define MEC17XX_ESPI_VW_M2S_SRC3(id) \
	REG8(MEC17XX_ESPI_VW_BASE + 11 + ((id) << 3) + ((id) << 2))

/*
 * Access all four Source bits as 32-bit value, Source bits are located
 * at bits[0, 8, 16, 24] of 32-bit word.
 */
#define MEC17XX_ESPI_VW_M2S_SRC_ALL(id) \
	REG32(MEC17XX_ESPI_VW_BASE + 8 + ((id) << 3) + ((id) << 2))

/*
 * Access an individual Source bit as byte where
 * bit[0] contains the source bit.
 */
#define MEC17XX_ESPI_VW_M2S_SRC(id, src) \
	REG8(MEC17XX_ESPI_VW_BASE + 8 + ((id) << 3) + ((src) & 0x03))
 ...
 * MEC17xx maps Host indices into its Slave to Master
 * 64-bit registers.
 */
#define SMVW_H04	0
#define SMVW_H05	1
...
#define SMVW(id, w) REG32(MEC17XX_ESPI_VW_BASE + 0x200 + ((id) << 3) + \
		(((w) & 0x01) << 2))

/* Access Index in b[7:0] of byte 0 */
#define MEC17XX_ESPI_VW_S2M_INDEX(id) \
	REG8(MEC17XX_ESPI_VW_BASE + 0x200 + ((id) << 3))

/* Access STOM_SOURCE and STOM_STATE in byte 1
 * STOM_SOURCE = b[1:0]
 * STOM_STATE = b[7:4]
 */
#define MEC17XX_ESPI_VW_S2M_STOM(id) \
	REG8(MEC17XX_ESPI_VW_BASE + 0x201 + ((id) << 3))
 ...
 * STOM_STATE = [15:12]
 */
#define MEC17XX_ESPI_VW_S2M_INDEX_STOM(id) \
	REG16(MEC17XX_ESPI_VW_BASE + 0x200 + ((id) << 3))

/* Access Change[0:3] RO bits. Set to 1 if any of SRC[0:3] change */
#define MEC17XX_ESPI_VW_S2M_CHANGE(id) \
	REG8(MEC17XX_ESPI_VW_BASE + 0x202 + ((id) << 3))

/* Access individual SRC bits
 * bit[0] = SRCn
 */
#define MEC17XX_ESPI_VW_S2M_SRC0(id) \
	REG8(MEC17XX_ESPI_VW_BASE + 0x204 + ((id) << 3))

#define MEC17XX_ESPI_VW_S2M_SRC1(id) \
	REG8(MEC17XX_ESPI_VW_BASE + 0x205 + ((id) << 3))

#define MEC17XX_ESPI_VW_S2M_SRC2(id) \
	REG8(MEC17XX_ESPI_VW_BASE + 0x206 + ((id) << 3))

#define MEC17XX_ESPI_VW_S2M_SRC3(id) \
	REG8(MEC17XX_ESPI_VW_BASE + 0x206 + ((id) << 3))
 ...
 */
#define MEC17XX_ESPI_VW_S2M_SRC(id, src) \
	REG8(MEC17XX_ESPI_VW_BASE + 0x204 + ((id) << 3) + ((src) & 0x03))
 ...
 * SRC3 = b[24]
 */
#define MEC17XX_ESPI_VW_S2M_SRC_ALL(id) \
	REG32(MEC17XX_ESPI_VW_BASE + 0x204 + ((id) << 3))
...
#define MEC17XX_ESPI_MSVW_SRC_GIRQ_BIT(v, n) \
...
#define MEC17XX_DMA_CH_OFS		0x40
#define MEC17XX_DMA_CH_OFS_BITPOS	6
#define MEC17XX_DMA_CH_BASE (MEC17XX_DMA_BASE + MEC17XX_DMA_CH_OFS)

#define MEC17XX_DMA_MAIN_CTRL		REG8(MEC17XX_DMA_BASE + 0x00)
#define MEC17XX_DMA_MAIN_PKT_RO		REG32(MEC17XX_DMA_BASE + 0x04)
#define MEC17XX_DMA_MAIN_FSM_RO		REG8(MEC17XX_DMA_BASE + 0x08)

/* DMA Channel Registers */
#define MEC17XX_DMA_CH_ACT(n) \
	REG8(MEC17XX_DMA_CH_BASE + ((n) << MEC17XX_DMA_CH_OFS_BITPOS))

#define MEC17XX_DMA_CH_MEM_START(n) \
	REG32(MEC17XX_DMA_CH_BASE + 0x04 + \
			((n) << MEC17XX_DMA_CH_OFS_BITPOS))

#define MEC17XX_DMA_CH_MEM_END(n) \
	REG32(MEC17XX_DMA_CH_BASE + 0x08 + \
			((n) << MEC17XX_DMA_CH_OFS_BITPOS))

#define MEC17XX_DMA_CH_DEV_ADDR(n) \
	REG32(MEC17XX_DMA_CH_BASE + 0x0c + \
			((n) << MEC17XX_DMA_CH_OFS_BITPOS))

#define MEC17XX_DMA_CH_CTRL(n) \
	REG32(MEC17XX_DMA_CH_BASE + 0x10 + \
			((n) << MEC17XX_DMA_CH_OFS_BITPOS))

#define MEC17XX_DMA_CH_ISTS(n) \
	REG8(MEC17XX_DMA_CH_BASE + 0x14 + \
			((n) << MEC17XX_DMA_CH_OFS_BITPOS))

#define MEC17XX_DMA_CH_MEM_IEN(n) \
	REG8(MEC17XX_DMA_CH_BASE + 0x18 + \
			((n) << MEC17XX_DMA_CH_OFS_BITPOS))

#define MEC17XX_DMA_CH_FSM_RO(n) \
	REG16(MEC17XX_DMA_CH_BASE + 0x1c + \
			((n) << MEC17XX_DMA_CH_OFS_BITPOS))

/*
 * DMA Channel 0 implements CRC-32 feature
 */
#define MEC17XX_DMA_CH0_CRC32_EN	REG8(MEC17XX_DMA_CH_BASE + 0x20)
#define MEC17XX_DMA_CH0_CRC32_DATA	REG32(MEC17XX_DMA_CH_BASE + 0x24)
#define MEC17XX_DMA_CH0_CRC32_POST_STS	REG8(MEC17XX_DMA_CH_BASE + 0x28)

/*
 * DMA Channel 1 implements memory fill feature
 */
#define MEC17XX_DMA_CH1_FILL_EN \
	REG8(MEC17XX_DMA_CH_BASE + MEC17XX_DMA_CH_OFS + 0x20)
#define MEC17XX_DMA_CH1_FILL_DATA \
	REG32(MEC17XX_DMA_CH_BASE + MEC17XX_DMA_CH_OFS + 0x24)
...
#define MEC17XX_DMA_MAIN_CTRL_ACT	(1 << 0)
#define MEC17XX_DMA_MAIN_CTRL_SRST	(1 << 1)

/* Bits for DMA channel regs */
#define MEC17XX_DMA_ACT_EN		(1 << 0)
/* DMA Channel Control */
#define MEC17XX_DMA_ABORT		(1 << 25)
#define MEC17XX_DMA_SW_GO		(1 << 24)
#define MEC17XX_DMA_XFER_SIZE_MASK	(7ul << 20)
...
/* DMA Channel Status */
#define MEC17XX_DMA_STS_ALU_DONE	(1 << 3)
#define MEC17XX_DMA_STS_DONE		(1 << 2)
#define MEC17XX_DMA_STS_HWFL_ERR	(1 << 1)
#define MEC17XX_DMA_STS_BUS_ERR		(1 << 0)
...
typedef struct mec17xx_dma_chan dma_chan_t;
 ...
 * no effect.
 */
#define MEC17XX_USEC_DELAY_REG_ADDR	(0x10000000)
#define MEC17XX_USEC_DELAY(x)	REG8(MEC17XX_USEC_DELAY_REG_ADDR) = (x)
...
#define MEC17XX_IRQ_8042EM_OBE   58
