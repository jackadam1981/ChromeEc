...
#define MEC17XX_PCR_SLP_EN1_SMB0	(1 << 10)
...
#define MEC17XX_PCR_SLP_EN1_SLEEP	0xeff01ff7
...
/* Command all blocks to sleep */
#define MEC17XX_PCR_SLP_EN3_PWM_ALL	(1 << 31)
...
#define MEC17XX_PCR_SLP_EN3_SMB3	(1 << 15)
#define MEC17XX_PCR_SLP_EN3_SMB2	(1 << 14)
#define MEC17XX_PCR_SLP_EN3_SMB1	(1 << 13)
...
#define MEC17XX_VBAT_RAM8(x)    REG8(MEC17XX_VBAT_BASE + 0x400 + (x))
...
/*
 * MEC17XX SPI Ports
 * GP-SPI0 & GP-SPI1 have one port each.
 * QMSPI0 has two ports, SHD & PVT.
 */
#define MEC17XX_GPSPI0_PORT		(0)
#define MEC17XX_GPSPI1_PORT		(1)
#define MEC17XX_QMSPI0_SHD_PORT		(2)
#define MEC17XX_QMSPI0_PVT_PORT		(3)
#define MEC17XX_SPI_MAX_PORT		(4)
...
#define MEC17XX_ESPI_MBAR_VALID(x)		REG8(MEC17XX_ESPI_MEM_BASE + \
	0x130 + ((x) << 3) + ((x) << 1))
#define MEC17XX_ESPI_MBAR_HOST_ADDR_0_15(x)	REG16(MEC17XX_ESPI_MEM_BASE + \
	0x132 + ((x) << 3) + ((x) << 1))
#define MEC17XX_ESPI_MBAR_HOST_ADDR_16_31(x)	REG16(MEC17XX_ESPI_MEM_BASE + \
	0x134 + ((x) << 3) + ((x) << 1))
#define MEC17XX_ESPI_MBAR_HOST_ADDR_32_47(x)	REG16(MEC17XX_ESPI_MEM_BASE + \
	0x136 + ((x) << 3) + ((x) << 1))
#define MEC17XX_ESPI_MBAR_HOST_ADDR_48_63(x)	REG16(MEC17XX_ESPI_MEM_BASE + \
	0x138 + ((x) << 3) + ((x) << 1))
 ...
 */
#define MEC17XX_ESPI_SRAM_BAR_CFG(x)		REG8(MEC17XX_ESPI_MEM_BASE + \
	0x1ac + ((x) << 3) + ((x) << 1))
#define MEC17XX_ESPI_SRAM_BAR_ADDR_0_15(x)	REG16(MEC17XX_ESPI_MEM_BASE + \
	0x1ae + ((x) << 3) + ((x) << 1))
#define MEC17XX_ESPI_SRAM_BAR_ADDR_16_31(x)	REG16(MEC17XX_ESPI_MEM_BASE + \
	0x1b0 + ((x) << 3) + ((x) << 1))
#define MEC17XX_ESPI_SRAM_BAR_ADDR_32_47(x)	REG16(MEC17XX_ESPI_MEM_BASE + \
	0x1b2 + ((x) << 3) + ((x) << 1))
#define MEC17XX_ESPI_SRAM_BAR_ADDR_48_63(x)	REG16(MEC17XX_ESPI_MEM_BASE + \
	0x1b4 + ((x) << 3) + ((x) << 1))
 ...
 */
#define MEC17XX_ESPI_MBAR_EC_VSIZE(x)		REG32(MEC17XX_ESPI_MEM_BASE + \
	0x330 + ((x) << 3) + ((x) << 1))
#define MEC17XX_ESPI_MBAR_EC_ADDR_0_15(x)	REG16(MEC17XX_ESPI_MEM_BASE + \
	0x332 + ((x) << 3) + ((x) << 1))
#define MEC17XX_ESPI_MBAR_EC_ADDR_16_31(x)	REG16(MEC17XX_ESPI_MEM_BASE + \
	0x334 + ((x) << 3) + ((x) << 1))
#define MEC17XX_ESPI_MBAR_EC_ADDR_32_47(x)	REG16(MEC17XX_ESPI_MEM_BASE + \
	0x336 + ((x) << 3) + ((x) << 1))
...
#define MEC17XX_ESPI_VW_M2S_IRQSEL0(id)	(REG8(MEC17XX_ESPI_VW_BASE + 4 + \
					     ((id) << 3) + ((id) << 2)))
...
#define MEC17XX_ESPI_VW_M2S_IRQSEL(id, src) REG8(MEC17XX_ESPI_VW_BASE + 4 + \
						((id) << 3) + ((id) << 2) + \
						((src) & 0x03))

#define MEC17XX_ESPI_VW_M2S_IRQSEL_ALL(id) (REG32(MEC17XX_ESPI_VW_BASE + \
						4 + ((id) << 3) + \
						((id) << 2)))
 ...
 */
#define MEC17XX_ESPI_VW_M2S_SRC(id, src) REG8(MEC17XX_ESPI_VW_BASE + 8 + \
					  ((id) << 3) + ((src) & 0x03))
...
#define MEC17XX_ESPI_VW_S2M_INDEX(id)	REG8(MEC17XX_ESPI_VW_BASE + \
						0x200 + ((id) << 3))
 ...
 * SRC3 = b[24]
 */
#define MEC17XX_ESPI_VW_S2M_SRC_ALL(id)	REG32(MEC17XX_ESPI_VW_BASE + 0x204 + \
							((id) << 3))
...
#define MEC17XX_ESPI_MSVW_SRC_GIRQ_BIT(v, n)	(((v) > 6) ? \
	(1ul << (((v)-7)+(n))) : (1ul << ((v)+(n))))
...
#define MEC17XX_DMA_CH_ACT(n)		REG8(MEC17XX_DMA_CH_BASE + \
	((n) << MEC17XX_DMA_CH_OFS_BITPOS))

#define MEC17XX_DMA_CH_MEM_START(n)	REG32(MEC17XX_DMA_CH_BASE + 0x04 +\
	((n) << MEC17XX_DMA_CH_OFS_BITPOS))

#define MEC17XX_DMA_CH_MEM_END(n)	REG32(MEC17XX_DMA_CH_BASE + 0x08 +\
	((n) << MEC17XX_DMA_CH_OFS_BITPOS))

#define MEC17XX_DMA_CH_DEV_ADDR(n)	REG32(MEC17XX_DMA_CH_BASE + 0x0c +\
	((n) << MEC17XX_DMA_CH_OFS_BITPOS))

#define MEC17XX_DMA_CH_CTRL(n)		REG32(MEC17XX_DMA_CH_BASE + 0x10 +\
	((n) << MEC17XX_DMA_CH_OFS_BITPOS))

#define MEC17XX_DMA_CH_ISTS(n)		REG8(MEC17XX_DMA_CH_BASE + 0x14 +\
	((n) << MEC17XX_DMA_CH_OFS_BITPOS))

#define MEC17XX_DMA_CH_MEM_IEN(n)	REG8(MEC17XX_DMA_CH_BASE + 0x18 +\
	((n) << MEC17XX_DMA_CH_OFS_BITPOS))

#define MEC17XX_DMA_CH_FSM_RO(n)	REG16(MEC17XX_DMA_CH_BASE + 0x1c +\
	((n) << MEC17XX_DMA_CH_OFS_BITPOS))
 ...
 */
#define MEC17XX_DMA_CH1_FILL_EN		REG8(MEC17XX_DMA_CH_BASE + \
	MEC17XX_DMA_CH_OFS + 0x20)
#define MEC17XX_DMA_CH1_FILL_DATA	REG32(MEC17XX_DMA_CH_BASE + \
	MEC17XX_DMA_CH_OFS + 0x24)
