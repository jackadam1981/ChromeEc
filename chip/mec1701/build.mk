...
#
# mec1701 chip specific files build
#

# mec1701 SoC has a Cortex-M4 ARM core
CORE:=cortex-m
...
# MEC1701 Boot-ROM API support
LDFLAGS_EXTRA=-Wl,--script=./chip/${CHIP}/bootrom.ld
...
chip-y=clock.o gpio.o hwtimer.o system.o uart.o jtag.o port80.o tfdp.o
...
chip-$(CONFIG_SHA256_HW)+=sha256_chip.o
...
# MEC1701 pack_ec.py has default values for --signing_key,
# --ecdh_packer_key, and --ecdh_mec1701_pub_key, --sign, --encrypt
# ECDSA signing is default disabled
# ECDH AES key generation and encryption is default disabled
...
mec1701-lfw = chip/mec1701/lfw/ec_lfw
mec1701-lfw-flat = $(out)/RW/$(mec1701-lfw)-lfw.flat

# build these specifically for lfw with -lfw suffix
objs_lfw = $(patsubst %, $(out)/RW/%-lfw.o, \
		$(addprefix common/, util gpio) \
		$(addprefix chip/$(CHIP)/, dma gpio clock hwtimer tfdp) \
		core/$(CORE)/cpu $(mec1701-lfw))
...
$(out)/$(PROJECT).bin: $(mec1701-lfw-flat)
