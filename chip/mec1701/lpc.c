...
static void lpc_init(void)
{
	 ...
	 */
	MEC17XX_PCR_SLP_DIS_DEV_MASK(2, MEC17XX_PCR_SLP_EN2_GCFG +
		MEC17XX_PCR_SLP_EN2_ACPI_EC0 + MEC17XX_PCR_SLP_EN2_ACPI_EC0 +
		MEC17XX_PCR_SLP_EN2_MIF8042);

	MEC17XX_PCR_SLP_DIS_DEV(MEC17XX_PCR_P80CAP0);
	...
	MEC17XX_PCR_SLP_DIS_DEV(MEC17XX_PCR_LPC);
...
/*
 * MCHP MEC17xx family allows selecting one of two GPIO pins alternate
 * functions as LRESET#.
 ...
 * 0 = Reset active
 * 1 = Reset not active
 * MEC17xx is different than MEC1322 in that LRESET# is not connected
...
void kb_ibf_interrupt(void)
{
	...
	MEC17XX_INT_SOURCE(MEC17XX_8042_GIRQ) = MEC17XX_8042_IBF_GIRQ_BIT;
...
{
	MEC17XX_INT_SOURCE(MEC17XX_8042_GIRQ) = MEC17XX_8042_OBE_GIRQ_BIT;
	task_wake(TASK_ID_KEYPROTO);
}
DECLARE_IRQ(MEC17XX_IRQ_8042EM_OBE, kb_obe_interrupt, 1);
#endif
