...
static void check_reset_cause(void)
{
	...
	trace11(0, MEC, 0, "  VBAT_PFR  = 0x%08X", MEC17XX_VBAT_STS);
	trace11(0, MEC, 0, "  PCR PWRST = 0x%08X", MEC17XX_PCR_PWR_RST_STS);
...
static void chip_periph_sleep_control(void)
{
	...
	d = MEC17XX_PCR_SLP_EN0_SLEEP;
#ifdef CONFIG_CHIPSET_DEBUG
	d &= ~(MEC17XX_PCR_SLP_EN0_JTAG);
#ifdef CONFIG_MCHP_JTAG_MODE
	MEC17XX_EC_JTAG_EN = CONFIG_MCHP_JTAG_MODE; 
#else
	MEC17XX_EC_JTAG_EN |= 0x01;
#endif
#else
	MEC17XX_EC_JTAG_EN &= ~0x01;
#endif
	MEC17XX_PCR_SLP_EN0 = d;
	MEC17XX_PCR_SLP_EN1 = MEC17XX_PCR_SLP_EN1_UNUSED_BLOCKS;
...
void system_hibernate(uint32_t seconds, uint32_t microseconds)
{
	...
	/*
	 * Assert S0 level reset to Host chipset and AP.
	 */
