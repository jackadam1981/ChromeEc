 ...
 * GPIO(I2C0_0_SCL,            PIN(15),  GPIO_INPUT)
 * { I2C0_0_SCL, GPIO_PIN(15), GPIO_INPUT }
 ...
 * 
 * GPIO_PIN(15) expands to (15 / 10), (1 << (15 mod 10)) = 5, 32
...
/* TODO MEC17xx */
#if 0 /* MEC1322 used base 10 on octal GPIO numbers to produce 'bank' and 'pin id' */
...
#define ENABLE_GPIO_GIRQ(x) \
	do { \
		MEC17XX_INT_SOURCE(x) = MEC17XX_INT_RESULT(x); \
...
static void gpio_interrupt(int girq)
{
	...
	TRACE12(72, GPIO, 0, "GPIO GIRQ %d result = 0x%08x",girq,sts);

	MEC17XX_INT_SOURCE(girq) = sts; /* write, no need for read-modify-write */
