 ...
 */
/** @file tfdp_chip.h
 *MEC17xx TFDP Peripheral Library API
 */
/** @defgroup MEC17xx Peripherals Trace
 */
...
#define TRACE14(nbr, cat, b, str, p1, p2, p3, p4) TFDPTrace14(nbr, p1, p2, \
	p3, p4)
...
#endif /* #ifdef CONFIG_MEC1701_TFDP */
