 ...
 * MEC1701H implements 11 ports:
 * SMB 0, 2-11. SMB 01 not implemented.
 * Any port can be mapped to any controller.
 */
 ...
 *
 * MEC17xx data sheet GPIO numbers are octal.
 * From comments in ec/include/gpio.wrap the PIN(x) macro expands to
 * GPIO_PIN(x) defined here.
 * We expect x parameter of GPIO_PIN(x) to be the octal number from
 * the MEC17xx data sheet.
 * GPIO_PIN(x) produces two comma separated values, the GPIO bank number
 * and bit position in the bank.
