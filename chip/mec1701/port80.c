 ...
 * large/slow handlers. If one does not want Por80h to pre-empt
 * other ISR's then a low priority periodic hook could be used to
 * clean out the Port80 FIFO.
 *
 */
void port_80_interrupt(void)
{
	...
	while (MEC17XX_P80_STS(0) & MEC17XX_P80_STS_NOT_EMPTY) {
		...
		TRACE1(94, P80, 0, "Port80h = 0x%02x", (d & 0xff));
