...
void uart_init(void)
{
	...
	MEC17XX_PCR_SLP_DIS_DEV(MEC17XX_PCR_UART0);
...
void uart_enter_dsleep(void)
{
	...
	MEC17XX_INT_DISABLE(MEC17XX_UART_GIRQ) = MEC17XX_UART_GIRQ_BIT(0);
...
void uart_exit_dsleep(void)
{
	 ...
	 */
	if (!((1 << 5) & MEC17XX_INT_SOURCE(9))) /* if edge interrupt */
	...
	uart_clear_rx_fifo(0);
	MEC17XX_INT_SOURCE(MEC17XX_UART_GIRQ) = MEC17XX_UART_GIRQ_BIT(0);
	MEC17XX_INT_ENABLE(MEC17XX_UART_GIRQ) = MEC17XX_UART_GIRQ_BIT(0);
	task_enable_irq(MEC17XX_IRQ_UART0); /* NVIC interrupt for UART = 40 */
