...
/*
 * MEC1701 BootROM requires two 4-byte TAG's at SPI offset 0x0 and 0x04.
 * TAG's point to a Header which must be located on a 256 byte
 * boundary anywhere in the flash (24-bit addressing).
 * Locate LFW + EC_RO at start of second 4KB sector (offset 0x1000)
 */
#define CONFIG_EC_PROTECTED_STORAGE_OFF	0
/* LFW + EC_RO flash region length = 192KB */
...
/*
 * EC_RW flash region length = 188KB (no LFW) but set storage
 * size to be the same as LFW+EC_RO
 */
