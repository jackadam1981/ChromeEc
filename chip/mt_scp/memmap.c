...
static void scp_cache_init(void)
{
	...
	SCP_L1_REMAP_CFG3 = 0;
	/*
	 * Setup OTHER1: Remap register for addr msb 31 to 28 equal to 0x0 and
	 * not overlap with L1C_EXT_ADDR0 to L1C_EXT_ADDR7.
	 *
	 * FIXME: I do not get why this works:
	 *    0x10000000 bits 31 to 28 => 0x1, not 0. But this successfully
	 *    remaps 0x10000000 to 0x50000000.
	 */
	SCP_L1_REMAP_OTHER =
	...
	/*
	 * FIXME: It seems like we need to call this twice, else the cache
	 * keeps stale data?!
	 */
