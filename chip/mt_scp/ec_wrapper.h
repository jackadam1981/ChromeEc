...
/* wrapper from FreeRTOS to Chrome EC */
...
#define configASSERT( x )  // TODO, if( ( x ) == 0 ) { taskDISABLE_INTERRUPTS(); vAssertCalled( __FILE__, __LINE__ ); }

#define scp_to_ap(scp_addr)  // TODO
#define ap_to_scp(ap_addr)  // TODO
