...
#define SCP_INTC_SPM_UART_RX_IRQ	REG32(SCP_INTC_BASE + 0x1C)
...
#define   CLK_COUNTER_MASK		0x3ff /* 10 bits */
...
#define SCP_UART2_BASE			(AP_BASE + 0x01020000) /* AP UART0 */
...
#define UART_REG(n, offset)		REG8(SCP_UART_BASE(n) + (offset))
...
#define SCP_WDT_RELOAD			SCP_WDT_REG(1)
