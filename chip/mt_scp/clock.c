...
void clock_init(void)
{
	...
	SCP_CLK_SYS_VAL = (SCP_CLK_SYS_VAL & ~CLK_COUNTER_MASK) | 1;
	SCP_CLK_HIGH_VAL = (SCP_CLK_HIGH_VAL & ~CLK_COUNTER_MASK) | 1;
	SCP_CLK_SLEEP_CTRL = (SCP_CLK_SLEEP_CTRL & ~VREQ_COUNTER_MASK) | VREQ_COUNTER_VAL(1);
