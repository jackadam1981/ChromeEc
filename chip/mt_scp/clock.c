...
void scp_clock_high_enable(int osc)
{
	...
	case 0:
		 ...
		 * Note that we can't use udelay here since the clock isn't configured
		 * correctly yet. The value 700000 is chosen so this loop takes about 25
		 * ms.
		 * */
		while (i--)
			;
