...
#define ADSP_REG_BASE			0x48000000
...
#define SCP_GIPC_CORE0_IPI		GIPC_IN(0)
#define SCP_GIPC_IS_CORE0_OK		GIPC_IN(1)
#define SCP_GIPC_CORE1_IPI		GIPC_IN(4)
...
#define SCP_UART2_BASE			(ADSP_REG_BASE + 0x1000) /* ADSP UART */
...
#define AP_GPIO_MODE1_SET		REG32(AP_GPIO_BASE + 0x0314)
#define AP_GPIO_MODE1_CLR		REG32(AP_GPIO_BASE + 0x0318)
