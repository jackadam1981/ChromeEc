...
#define SCP_CORE1_INTC_IRQ_STA(w) \
		REG32_ADDR(SCP_CORE1_INTC_IRQ_BASE + 0x0010)[(w)]
#define SCP_CORE1_INTC_IRQ_EN(w) \
		REG32_ADDR(SCP_CORE1_INTC_IRQ_BASE + 0x0020)[(w)]
#define SCP_CORE1_INTC_IRQ_POL(w) \
		REG32_ADDR(SCP_CORE1_INTC_IRQ_BASE + 0x0040)[(w)]
#define SCP_CORE1_INTC_IRQ_GRP(g, w) \
		REG32_ADDR(SCP_CORE1_INTC_IRQ_BASE + 0x0050 + \
			   ((g) << SCP_INTC_GRP_GAP))[(w)]
#define SCP_CORE1_INTC_IRQ_GRP_STA(g, w) \
		REG32_ADDR(SCP_CORE1_INTC_IRQ_BASE + 0x0150 + \
			   ((g) << SCP_INTC_GRP_GAP))[(w)]
#define SCP_CORE1_INTC_SLP_WAKE_EN(w) \
		REG32_ADDR(SCP_CORE1_INTC_IRQ_BASE + 0x0240)[(w)]
#define SCP_CORE1_INTC_IRQ_OUT		REG32(SCP_CORE1_INTC_IRQ_BASE + 0x0250)
