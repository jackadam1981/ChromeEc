...
#define AP_CQDMA_BASE			(AP_REG_BASE + 0x212000)
#define AP_CQDMA_EN			REG32(AP_CQDMA_BASE + 0x308)
#define   AP_CQDMA_RUN			BIT(0)
#define AP_CQDMA_RST			REG32(AP_CQDMA_BASE + 0x30C)
#define   AP_CQDMA_WARM_RST		BIT(0)
#define AP_CQDMA_CON			REG32(AP_CQDMA_BASE + 0x318)
#define   AP_CQDMA_CON_FIXED		BIT(1)
#define AP_CQDMA_SRC			REG32(AP_CQDMA_BASE + 0x31C)
#define AP_CQDMA_DST			REG32(AP_CQDMA_BASE + 0x320)
#define AP_CQDMA_LEN			REG32(AP_CQDMA_BASE + 0x324)
#define   AP_CQDMA_LEN_MAX		0x10000000
