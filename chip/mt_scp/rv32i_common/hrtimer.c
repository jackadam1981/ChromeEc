...
#ifdef CHIP_VARIANT_MT8195_CORE1
#define SCP_CORE_TIMER_IRQ_CTRL	SCP_CORE1_TIMER_IRQ_CTRL
#define SCP_CORE_TIMER_EN	SCP_CORE1_TIMER_EN
#define SCP_CORE_TIMER_RST_VAL	SCP_CORE1_TIMER_RST_VAL
#define SCP_CORE_TIMER_CUR_VAL	SCP_CORE1_TIMER_CUR_VAL
#else
#define SCP_CORE_TIMER_IRQ_CTRL	SCP_CORE0_TIMER_IRQ_CTRL
#define SCP_CORE_TIMER_EN	SCP_CORE0_TIMER_EN
#define SCP_CORE_TIMER_RST_VAL	SCP_CORE0_TIMER_RST_VAL
#define SCP_CORE_TIMER_CUR_VAL	SCP_CORE0_TIMER_CUR_VAL
#endif
