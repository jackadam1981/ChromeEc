...
static uint32_t clock_ulposc_measure_freq(uint32_t osc)
{
	...
	AP_CLK_DBG_CFG = (osc == 0 ? DBG_BIST_SOURCE_ULPOSC1 : DBG_BIST_SOURCE_ULPOSC2);
...
/* The HW tolerates +/-4%. Use +/-2% to reserve margin for temperature variation.
 * The valid freq. ranges are,
 *   400:(392,408)
 *   250:(245,255)
 */
