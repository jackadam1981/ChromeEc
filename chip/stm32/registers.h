...
#ifdef CHIP_VARIANT_STM32F373
#define STM32_COMP_CMP2INSEL_PA6       (7 << 20)
#define STM32_COMP_CMP2INSEL_PA2       (6 << 20)
#define STM32_COMP_CMP2INSEL_PA5       (5 << 20)
#define STM32_COMP_CMP2INSEL_PA4       (4 << 20)
#else
...
#ifdef CHIP_VARIANT_STM32F373
#define STM32_COMP_CMP1INSEL_PA6       (7 << 4)
#define STM32_COMP_CMP1INSEL_PA0       (6 << 4)
#define STM32_COMP_CMP1INSEL_PA5       (5 << 4)
#define STM32_COMP_CMP1INSEL_PA4       (4 << 4)
#else
