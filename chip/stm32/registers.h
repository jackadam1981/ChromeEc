...
/* STM32F3 and STM32F0 we use HSI clock for the UART */
#if (defined CHIP_FAMILY_STM32F3) || (defined CHIP_FAMILY_STM32F0)
#define STM32_USART_CLOCK(n)       CLOCK_TYPE_WAKE_PERIPH
#else
...
#else
#define STM32_I2C_PERIPH_CLASS(n) CLOCK_TYPE_WAKE_PERIPH
#endif
...
#define STM32_RCC_I2C_SYSCLK		1
#define STM32_RCC_I2C_HSI		0
#define stm32_rcc_cfgr3_i2c_offset(n)   (4 + (n))
#define STM32_RCC_I2C_MASK(n)	(1 << stm32_rcc_cfgr3_i2c_offset(n))

#define STM32_RCC_USART_PCLK		0
#define STM32_RCC_USART_SYSCLK		1
#define STM32_RCC_USART_LSE		2
#define STM32_RCC_USART_HSI		3
#define stm32_rcc_cfgr3_usart_offset(n)   ((n) == 1 ? 0 : (n) * 2 + 12)
#define STM32_RCC_USART_MASK(n)	(3 << stm32_rcc_cfgr3_usart_offset(n))
...
#define STM32_OTP_LOCK_MASK(_block)    ((0xFF << ((_block) % 4) * 8))
