...
#define STM32_PWR_CR_LPSDSR		BIT(0)
#define STM32_PWR_CR_FLPS		BIT(9)
#define STM32_PWR_CR_SVOS5		BIT(14)
...
#define STM32_PWR_D3CR_VOS3         BIT(14)
...
#define STM32_RCC_CFGR_SW_HSI		BIT(0)
...
#define STM32_RCC_CFGR_SWS_HSI		BIT(2)
...
#define STM32_RCC_PLLCFGR_PLLSRC_MSI	BIT(STM32_RCC_PLLCFGR_PLLSRC_SHIFT)
...
#define STM32_RCC_PLLCFGR_PLLREN_MASK	BIT(STM32_RCC_PLLCFGR_PLLREN_SHIFT)
...
#define STM32_RCC_CFGR_SW_HSI                  (0 << 0)
#define STM32_RCC_CFGR_SW_CSI                  BIT(0)
#define STM32_RCC_CFGR_SW_HSE                  (2 << 0)
#define STM32_RCC_CFGR_SW_PLL1                 (3 << 0)
#define STM32_RCC_CFGR_SW_MASK                 (3 << 0)
#define STM32_RCC_CFGR_SWS_HSI                 (0 << 3)
#define STM32_RCC_CFGR_SWS_CSI                 BIT(3)
...
#define STM32_RCC_D1CFGR_HPRE_DIV16           (1BIT(0))
...
#define STM32_RCC_PLLCKSEL_PLLSRC_CSI          BIT(0)
...
#define STM32_RCC_PLLCFG_PLL1RGE_2M_4M         BIT(2)
...
#define STM32_RCC_D2CCIP1R_SPI123SEL_PLL2P     BIT(12)
...
#define STM32_RCC_D2CCIP1R_SPI45SEL_PLL2Q      BIT(16)
...
#define STM32_RCC_D2CCIP2_USART234578SEL_PLL2Q BIT(0)
...
#define STM32_RCC_D2CCIP2_USART16SEL_PLL2Q     BIT(3)
...
#define STM32_RCC_D2CCIP2_RNGSEL_PLL1Q         BIT(8)
...
#define STM32_RCC_D2CCIP2_LPTIM1SEL_PLL2       BIT(28)
...
#define STM32_SPI_CFG1_UDRCFG_LAST_RX	BIT(9)
#define STM32_SPI_CFG1_UDRCFG_LAST_TX	(2 << 9)
#define STM32_SPI_CFG1_UDRDET_BEGIN_FRM	(0 << 11)
#define STM32_SPI_CFG1_UDRDET_END_FRM	BIT(11)
...
#define STM32_FLASH_ACR_WRHIGHFREQ_185MHZ BIT(4)
...
#define  FLASH_CR_PSIZE_HWORD             BIT(4)
...
#define STM32_ADC_CFGR1_EXTEN_RISE BIT(10)
...
#define STM32_ADC_CFGR1_TRG1	   BIT(6)
...
#define STM32_COMP_OUTSEL_TIM2_OCR  BIT(21)
...
#define STM32_COMP_INSEL_PB3        BIT(18)
...
#define STM32_COMP_CMP2HYST_LOW        BIT(28)
...
#define STM32_COMP_CMP2OUTSEL_TIM16_BRK BIT(24)
#else
#define STM32_COMP_CMP2OUTSEL_TIM1_OCR (3 << 24)
#define STM32_COMP_CMP2OUTSEL_TIM1_IC1 (2 << 24)
#define STM32_COMP_CMP2OUTSEL_TIM1_BRK BIT(24)
#endif
...
#define STM32_COMP_CMP1HYST_LOW        BIT(12)
...
#define STM32_COMP_CMP1OUTSEL_TIM15_BRK BIT(8)
#else
...
#define STM32_COMP_CMP1OUTSEL_TIM1_BRK BIT(8)
#endif
...
#define STM32_DMA_CCR_DIR_M2P		BIT(6)
...
#define STM32_CRC_CR_POLYSIZE_16    BIT(3)
#define STM32_CRC_CR_POLYSIZE_8     (2 << 3)
#define STM32_CRC_CR_POLYSIZE_7     (3 << 3)
#define STM32_CRC_CR_REV_IN_BYTE    BIT(5)
