...
// F & G are only on Category 4 devices.
...
#define STM32_GPIO_AFRH(b)      REG32((b) + 0x24)
#define STM32_GPIO_BRR(b)       REG32((b) + 0x28)
#define STM32_GPIO_ASCR(b)      REG32((b) + 0x2C)

/* TODO: Set GPIO_ALT_* if necessary. Reference manual page 268 */
#define GPIO_ALT_F0		0x0
#define GPIO_ALT_F1		0x1
#define GPIO_ALT_F2		0x2
#define GPIO_ALT_F3		0x3
...
#define STM32_DMA2_CSELR	REG32(STM32_DMA2_BASE + 0xA8)
#else
