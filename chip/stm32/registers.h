...
#define STM32_PWR_CR_VOS_1V8		(1 << 11)
#define STM32_PWR_CR_VOS_1V5		(2 << 11)
#define STM32_PWR_CR_VOS_1V2		(3 << 11)
#define STM32_PWR_CR_VOS_MASK		(3 << 11)
#define STM32_PWR_CSR               REG32(STM32_PWR_BASE + 0x04)
#define STM32_PWR_CSR_VOSF		(1 << 4)
...
#define STM32_RCC_CFGR_PLLSRC_HSI	(0 << 16)
#define STM32_RCC_CFGR_PLLSRC_HSE	(1 << 16)
#define STM32_RCC_CFGR_PLLMUL_3		(0 << 18)
#define STM32_RCC_CFGR_PLLMUL_4		(1 << 18)
#define STM32_RCC_CFGR_PLLMUL_6		(2 << 18)
#define STM32_RCC_CFGR_PLLMUL_8		(3 << 18)
#define STM32_RCC_CFGR_PLLDIV_2		(1 << 22)
#define STM32_RCC_CFGR_PLLDIV_3		(2 << 22)
#define STM32_RCC_CFGR_PLLDIV_4		(3 << 22)
