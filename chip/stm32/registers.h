...
#define STM32_RCC_CFGR_SW_MASK      (3 << 0)
#define STM32_RCC_CFGR_SWS_HSI      (0 << 2)
#define STM32_RCC_CFGR_SWS_CSI      (1 << 2)
#define STM32_RCC_CFGR_SWS_HSE      (2 << 2)
#define STM32_RCC_CFGR_SWS_PLL1     (3 << 2)
#define STM32_RCC_CFGR_SWS_MASK     (3 << 2)
...
#define STM32_RCC_PLLDIVR_DIVN(n)      (((n) - 1) << 0)
#define STM32_RCC_PLLDIVR_DIVP(p)      (((p) - 1) << 9)
#define STM32_RCC_PLLDIVR_DIVQ(q)      (((q) - 1) << 16)
#define STM32_RCC_PLLDIVR_DIVR(r)      (((r) - 1) << 24)
#define STM32_RCC_PLLFRACR(n)          ((n) << 3)
