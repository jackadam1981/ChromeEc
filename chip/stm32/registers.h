...
#define STM32_ADC1_SR               REG32(STM32_ADC1_BASE + 0x00)
#define STM32_ADC1_CR1              REG32(STM32_ADC1_BASE + 0x04)
#define STM32_ADC1_CR2              REG32(STM32_ADC1_BASE + 0x08)
#define STM32_ADC1_SMPR1            REG32(STM32_ADC1_BASE + 0x0C)
#define STM32_ADC1_SMPR2            REG32(STM32_ADC1_BASE + 0x10)
#define STM32_ADC1_JOFR(n)          REG32(STM32_ADC1_BASE + 0x14 + (n&3) * 4)
#define STM32_ADC1_HTR              REG32(STM32_ADC1_BASE + 0x24)
#define STM32_ADC1_LTR              REG32(STM32_ADC1_BASE + 0x28)
#define STM32_ADC1_SQR1             REG32(STM32_ADC1_BASE + 0x2C)
#define STM32_ADC1_SQR2             REG32(STM32_ADC1_BASE + 0x30)
#define STM32_ADC1_SQR3             REG32(STM32_ADC1_BASE + 0x34)
#define STM32_ADC1_JSQR             REG32(STM32_ADC1_BASE + 0x38)
#define STM32_ADC1_JDR(n)           REG32(STM32_ADC1_BASE + 0x3C + (n*3) * 4)
#define STM32_ADC1_DR               REG32(STM32_ADC1_BASE + 0x4C)
#endif
