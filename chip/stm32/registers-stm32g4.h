...
#define STM32_USB_BASE              (STM32_APB1PERIPH_BASE + 0x5C00UL)
/*!< USB_IP Packet Memory Area base address */
#define STM32_USB_PMAADDR           (STM32_APB1PERIPH_BASE + 0x6000UL)
#define STM32_FDCAN1_BASE           (STM32_APB1PERIPH_BASE + 0x6400UL)
  /*!< FDCAN configuration registers base address */
#define STM32_FDCAN_CONFIG_BASE     (STM32_APB1PERIPH_BASE + 0x6500UL)
