...
#define STM32_I2C_CR1(base)            REG16(stm32g4_i2c_reg(base, 0x00))
#define STM32_I2C_CR2(base)            REG16(stm32g4_i2c_reg(base, 0x04))
...
#define STM32_RCC_CCIPR_I2CNSEL_HSI      0x0
