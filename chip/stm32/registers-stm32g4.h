...
#if defined(CHIP_VARIANT_STM32G431)
...
#define STM32_PERIPH_BASE           (0x40000000UL) /*!< Peripheral base addr */
...
/*!< APB1 peripherals */
#define STM32_TIM2_BASE             (STM32_APB1PERIPH_BASE + 0x0000UL)
#define STM32_TIM3_BASE             (STM32_APB1PERIPH_BASE + 0x0400UL)
#define STM32_TIM4_BASE             (STM32_APB1PERIPH_BASE + 0x0800UL)
#define STM32_TIM6_BASE             (STM32_APB1PERIPH_BASE + 0x1000UL)
#define STM32_TIM7_BASE             (STM32_APB1PERIPH_BASE + 0x1400UL)
#define STM32_CRS_BASE              (STM32_APB1PERIPH_BASE + 0x2000UL)
#define STM32_TAMP_BASE             (STM32_APB1PERIPH_BASE + 0x2400UL)
#define STM32_RTC_BASE              (STM32_APB1PERIPH_BASE + 0x2800UL)
#define STM32_WWDG_BASE             (STM32_APB1PERIPH_BASE + 0x2C00UL)
#define STM32_IWDG_BASE             (STM32_APB1PERIPH_BASE + 0x3000UL)
#define STM32_SPI2_BASE             (STM32_APB1PERIPH_BASE + 0x3800UL)
#define STM32_SPI3_BASE             (STM32_APB1PERIPH_BASE + 0x3C00UL)
#define STM32_USART2_BASE           (STM32_APB1PERIPH_BASE + 0x4400UL)
#define STM32_USART3_BASE           (STM32_APB1PERIPH_BASE + 0x4800UL)
...
#define STM32_PWR_BASE              (STM32_APB1PERIPH_BASE + 0x7000UL)
...
#define STM32_VREFBUF_BASE          (STM32_APB2PERIPH_BASE + 0x0030UL)
#define STM32_COMP1_BASE            (STM32_APB2PERIPH_BASE + 0x0200UL)
#define STM32_COMP2_BASE            (STM32_APB2PERIPH_BASE + 0x0204UL)
#define STM32_COMP3_BASE            (STM32_APB2PERIPH_BASE + 0x0208UL)
#define STM32_COMP4_BASE            (STM32_APB2PERIPH_BASE + 0x020CUL)
#define STM32_OPAMP_BASE            (STM32_APB2PERIPH_BASE + 0x0300UL)
#define STM32_OPAMP1_BASE           (STM32_APB2PERIPH_BASE + 0x0300UL)
#define STM32_OPAMP2_BASE           (STM32_APB2PERIPH_BASE + 0x0304UL)
#define STM32_OPAMP3_BASE           (STM32_APB2PERIPH_BASE + 0x0308UL)

#define STM32_EXTI_BASE             (STM32_APB2PERIPH_BASE + 0x0400UL)
#define STM32_TIM1_BASE             (STM32_APB2PERIPH_BASE + 0x2C00UL)
#define STM32_SPI1_BASE             (STM32_APB2PERIPH_BASE + 0x3000UL)
#define STM32_TIM8_BASE             (STM32_APB2PERIPH_BASE + 0x3400UL)
#define STM32_USART1_BASE           (STM32_APB2PERIPH_BASE + 0x3800UL)
#define STM32_TIM15_BASE            (STM32_APB2PERIPH_BASE + 0x4000UL)
#define STM32_TIM16_BASE            (STM32_APB2PERIPH_BASE + 0x4400UL)
#define STM32_TIM17_BASE            (STM32_APB2PERIPH_BASE + 0x4800UL)
#define STM32_SAI1_BASE             (STM32_APB2PERIPH_BASE + 0x5400UL)
#define STM32_SAI1_Block_A_BASE     (SAI1_BASE + 0x0004UL)
#define STM32_SAI1_Block_B_BASE     (SAI1_BASE + 0x0024UL)

/*!< AHB1 peripherals */
#define STM32_DMA1_BASE             (STM32_AHB1PERIPH_BASE)
#define STM32_DMA2_BASE             (STM32_AHB1PERIPH_BASE + 0x0400UL)
#define STM32_DMAMUX_BASE           (STM32_AHB1PERIPH_BASE + 0x0800UL)
...
#define STM32_DMA1_Channel2_BASE    (STM32_DMA1_BASE + 0x001CUL)
#define STM32_DMA1_Channel3_BASE    (STM32_DMA1_BASE + 0x0030UL)
#define STM32_DMA1_Channel4_BASE    (STM32_DMA1_BASE + 0x0044UL)
#define STM32_DMA1_Channel5_BASE    (STM32_DMA1_BASE + 0x0058UL)
#define STM32_DMA1_Channel6_BASE    (STM32_DMA1_BASE + 0x006CUL)

#define STM32_DMA2_Channel1_BASE    (STM32_DMA2_BASE + 0x0008UL)
#define STM32_DMA2_Channel2_BASE    (STM32_DMA2_BASE + 0x001CUL)
#define STM32_DMA2_Channel3_BASE    (STM32_DMA2_BASE + 0x0030UL)
#define STM32_DMA2_Channel4_BASE    (STM32_DMA2_BASE + 0x0044UL)
#define STM32_DMA2_Channel5_BASE    (STM32_DMA2_BASE + 0x0058UL)
#define STM32_DMA2_Channel6_BASE    (STM32_DMA2_BASE + 0x006CUL)

#define STM32_DMAMUX_Channel0_BASE    (STM32_DMAMUX_BASE)
#define STM32_DMAMUX_Channel1_BASE    (STM32_DMAMUX_BASE + 0x0004UL)
#define STM32_DMAMUX_Channel2_BASE    (STM32_DMAMUX_BASE + 0x0008UL)
#define STM32_DMAMUX_Channel3_BASE    (STM32_DMAMUX_BASE + 0x000CUL)
#define STM32_DMAMUX_Channel4_BASE    (STM32_DMAMUX_BASE + 0x0010UL)
#define STM32_DMAMUX_Channel5_BASE    (STM32_DMAMUX_BASE + 0x0014UL)
#define STM32_DMAMUX_Channel6_BASE    (STM32_DMAMUX_BASE + 0x0020UL)
#define STM32_DMAMUX_Channel7_BASE    (STM32_DMAMUX_BASE + 0x0024UL)
#define STM32_DMAMUX_Channel8_BASE    (STM32_DMAMUX_BASE + 0x0028UL)
#define STM32_DMAMUX_Channel9_BASE    (STM32_DMAMUX_BASE + 0x002CUL)
#define STM32_DMAMUX_Channel10_BASE   (STM32_DMAMUX_BASE + 0x0030UL)
#define STM32_DMAMUX_Channel11_BASE   (STM32_DMAMUX_BASE + 0x0034UL)
#define STM32_DMAMUX_RequestGenerator0_BASE  (STM32_DMAMUX_BASE + 0x0100UL)
#define STM32_DMAMUX_RequestGenerator1_BASE  (STM32_DMAMUX_BASE + 0x0104UL)
#define STM32_DMAMUX_RequestGenerator2_BASE  (STM32_DMAMUX_BASE + 0x0108UL)
#define STM32_DMAMUX_RequestGenerator3_BASE  (STM32_DMAMUX_BASE + 0x010CUL)

#define STM32_DMAMUX_ChannelStatus_BASE      (STM32_DMAMUX_BASE + 0x0080UL)
#define STM32_DMAMUX_RequestGenStatus_BASE   (STM32_DMAMUX_BASE + 0x0140UL)

/*!< AHB2 peripherals */
#define STM32_GPIOA_BASE            (STM32_AHB2PERIPH_BASE + 0x0000UL)
#define STM32_GPIOB_BASE            (STM32_AHB2PERIPH_BASE + 0x0400UL)
#define STM32_GPIOC_BASE            (STM32_AHB2PERIPH_BASE + 0x0800UL)
#define STM32_GPIOD_BASE            (STM32_AHB2PERIPH_BASE + 0x0C00UL)
#define STM32_GPIOE_BASE            (STM32_AHB2PERIPH_BASE + 0x1000UL)
#define STM32_GPIOF_BASE            (STM32_AHB2PERIPH_BASE + 0x1400UL)
#define STM32_GPIOG_BASE            (STM32_AHB2PERIPH_BASE + 0x1800UL)

#define STM32_ADC1_BASE             (STM32_AHB2PERIPH_BASE + 0x08000000UL)
#define STM32_ADC2_BASE             (STM32_AHB2PERIPH_BASE + 0x08000100UL)
#define STM32_ADC12_COMMON_BASE     (STM32_AHB2PERIPH_BASE + 0x08000300UL)

#define STM32_DAC_BASE              (STM32_AHB2PERIPH_BASE + 0x08000800UL)
#define STM32_DAC1_BASE             (STM32_AHB2PERIPH_BASE + 0x08000800UL)
...
/* --- UCPD --- */
#define STM32_UCPD_REG1(base, offset) REG32(STM32_UCPD1_BASE + \
					   ((port) * 0x400)) + (offset))
...
#define STM32_UCPD_RX_ORDEXT1(port)	STM32_UCPD_REG(port, 0x34)
#define STM32_UCPD_RX_ORDEXT2(port)	STM32_UCPD_REG(port, 0x38)
...
#define STM32_UCPD_CFGR1_RXORDSETEN_VAL(x)  ((x) << STM32_UCPD_CFGR1_RXORDSETEN_SHIFT)
...
#define STM32_UCPD_CFGR1_TRANSWIN_VAL(x)    ((x) << STM32_UCPD_CFGR1_TRANSWIN_SHIFT)
...
#define STM32_UCPD_CFGR1_HBITCLKD_VAL(x)    ((x) << STM32_UCPD_CFGR1_HBITCLKD_SHIFT)
...
#define STM32_UCPD_TX_ORDSETR_MASK         ((0x3ffff) << \
...
/*
 * Reset causes in RCC CSR register. The generic names are requried
 */
...
/* --- FLASH WRP1 Bit Definitions --- */
#define  FLASH_WRP_START(val)       ((val) & 0x7f)
#define  FLASH_WRP_END(val)         (((val) >> 16) & 0x7f)
#define  FLASH_WRP_RANGE(start, end) (((start) & 0x7f) | (((end) & 0x7f) << 16))
#define  FLASH_WRP_RANGE_DISABLED   FLASH_WRP_RANGE(0x7F, 0x00)
#define  FLASH_WRP_MASK             FLASH_WRP_RANGE(0x7F, 0x7F)
...
#define STM32_OPTB_REG_READ(n)  REG32(STM32_FLASH_REGS_BASE + 0x20 + (n * 4))
...
enum dma_channel {
	...
	STM32_DMAC_USART1_RX = STM32_DMAC_CH9,
	STM32_DMAC_USART1_TX = STM32_DMAC_CH10,
	STM32_DMAC_USART3_RX = STM32_DMAC_CH9,
	STM32_DMAC_USART3_TX = STM32_DMAC_CH10,
