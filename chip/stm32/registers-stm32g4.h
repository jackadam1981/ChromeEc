...
#define STM32_DMAMUX1_BASE          (STM32_AHB1PERIPH_BASE + 0x0800UL)
...
#define STM32_DMAMUX1_Channel0_BASE    (STM32_DMAMUX1_BASE)
#define STM32_DMAMUX1_Channel1_BASE    (STM32_DMAMUX1_BASE + 0x0004UL)
#define STM32_DMAMUX1_Channel2_BASE    (STM32_DMAMUX1_BASE + 0x0008UL)
#define STM32_DMAMUX1_Channel3_BASE    (STM32_DMAMUX1_BASE + 0x000CUL)
#define STM32_DMAMUX1_Channel4_BASE    (STM32_DMAMUX1_BASE + 0x0010UL)
#define STM32_DMAMUX1_Channel5_BASE    (STM32_DMAMUX1_BASE + 0x0014UL)
#define STM32_DMAMUX1_Channel6_BASE    (STM32_DMAMUX1_BASE + 0x0020UL)
#define STM32_DMAMUX1_Channel7_BASE    (STM32_DMAMUX1_BASE + 0x0024UL)
#define STM32_DMAMUX1_Channel8_BASE    (STM32_DMAMUX1_BASE + 0x0028UL)
#define STM32_DMAMUX1_Channel9_BASE    (STM32_DMAMUX1_BASE + 0x002CUL)
#define STM32_DMAMUX1_Channel10_BASE   (STM32_DMAMUX1_BASE + 0x0030UL)
#define STM32_DMAMUX1_Channel11_BASE   (STM32_DMAMUX1_BASE + 0x0034UL)
#define STM32_DMAMUX1_RequestGenerator0_BASE  (STM32_DMAMUX1_BASE + 0x0100UL)
#define STM32_DMAMUX1_RequestGenerator1_BASE  (STM32_DMAMUX1_BASE + 0x0104UL)
#define STM32_DMAMUX1_RequestGenerator2_BASE  (STM32_DMAMUX1_BASE + 0x0108UL)
#define STM32_DMAMUX1_RequestGenerator3_BASE  (STM32_DMAMUX1_BASE + 0x010CUL)

#define STM32_DMAMUX1_ChannelStatus_BASE      (STM32_DMAMUX1_BASE + 0x0080UL)
#define STM32_DMAMUX1_RequestGenStatus_BASE   (STM32_DMAMUX1_BASE + 0x0140UL)
...
#define STM32_RCC_APB1ENR_I2C1EN                BIT(21)
#define STM32_RCC_APB1ENR_II2C2EN               BIT(22)
#define STM32_RCC_APB1ENR_II2C3EN               BIT(23)
#define STM32_RCC_APB1ENR_PWREN                 BIT(28)

/* --- RCC APB2ENR Bit Definitions --- */
#define STM32_RCC_APB2ENR_TIM1		BIT(0)
#define STM32_RCC_APB2ENR_TIM8		BIT(1)
#define STM32_RCC_APB2ENR_USART1        BIT(4)
#define STM32_RCC_APB2ENR_USART6        BIT(5)
#define STM32_RCC_APB2ENR_ADC1EN        BIT(8)
#define STM32_RCC_APB2ENR_SYSCFGEN	BIT(14)
#define STM32_RCC_APB2ENR_TIM9		BIT(16)
...
#define STM32_PWR_CR_CSBF               BIT(3)
#define STM32_PWR_CSR_SBF               BIT(1)

#define STM32_PWR_RESET_CAUSE STM32_PWR_CSR
#define  RESET_CAUSE_SBF                STM32_PWR_CSR_SBF
#define STM32_PWR_RESET_CAUSE_CLR STM32_PWR_CR
#define  RESET_CAUSE_SBF_CLR            STM32_PWR_CR_CSBF
