...
#define  PLLCFGR_PLLQ_OFF		20
#define  PLLCFGR_PLLQ(val)		((((val << 1) | 1) & 0xf) << PLLCFGR_PLLQ_OFF)
/* System and main CPU clock */
#define  PLLCFGR_PLLR_OFF		24
#define  PLLCFGR_PLLR(val)		((((val << 1) | 1) & 0x7) << PLLCFGR_PLLR_OFF)
...
#define STM32_RCC_APB2ENR_ADC34EN	BIT(14)
