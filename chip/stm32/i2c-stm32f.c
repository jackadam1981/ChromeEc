...
static void i2c_event_handler(int port)
{
	...
	if (i2c_sr1[port] & STM32_I2C_SR2_MSL) {
...
void i2c_slave_event_interrupt(void) { i2c_event_handler(IRQ_SLAVE_EV); }
...
void i2c_slave_error_interrupt(void) { i2c_error_handler(IRQ_SLAVE_ER); }
DECLARE_IRQ(IRQ_SLAVE_ER, i2c2_error_interrupt, 2);
#endif
