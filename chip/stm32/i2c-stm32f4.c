 ...
 * chich do not share the same registers or functionality. So we'll need
 * two sets of fucntions to handle this for stm32f4.
 */
#define STM32F4_I2C	0
#define STM32F4_FMPI2C	1
