...
/* stateful CRC32 (possibly using hardware block) */
#ifdef CONFIG_HW_CRC
...
#else
/* --- (large) CRC32 implementation --- */

/*
CRC-32 protects the data integrity of the data payload. CRC-32 is defined
as follows:
The CRC-32 polynomial shall be = 04C1 1DB7h.
The CRC-32 Initial value shall be = FFFF FFFFh.
CRC-32 shall be calculated for all bytes of the payload not inclusive of any
packet framing symbols (i.e. excludes the preamble, SOP, EOP).
CRC-32 calculation shall begin at byte 0 bit 0 and continue to bit 7 of each
of the bytes of the packet.
The remainder of CRC-32 shall be complemented.
The residual of CRC-32 shall be C704 DD7Bh.
Note: This inversion of the CRC-32 remainder adds an offset of FFFF FFFFh that
will create a constant CRC-32 residual of C704 DD7Bh at the receiver side.
