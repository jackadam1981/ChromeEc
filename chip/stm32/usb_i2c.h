 ...
 *         0x0006: The port specified is invalid.
...
struct usb_i2c_state {
	/* Request a deferred callback to enable. */
	int request_enabled;

	/* The current enabled state.  This is only updated in the deferred
	 * callback. This ensures that the board specific state update routines
	 * are only called from the deferred callback.
	 */
	int enabled;
};
