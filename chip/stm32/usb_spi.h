...
struct usb_spi_state {
	 ...
	 * header for the first response packet. Error code is cleared during first
	 * RX packet and set if a failure occurs.
	 */
	uint16_t status_code;
	 ...
	 */
	usb_spi_packet_ctx_t receive_packet;
	 ...
	 */
	usb_spi_receive_ctx_t spi_write_ctx;
	usb_spi_transmit_ctx_t spi_read_ctx;
};
