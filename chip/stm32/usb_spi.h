...
enum feature_bitmap {
	...
	/* Indicates support for concurent USB and SPI activity. */
...
#define EEPROM_FLAG_ALT_WIDTH_4WIRE (0x2UL << EEPROM_FLAG_ALT_WIDTH_POS)
#define EEPROM_FLAG_ALT_WIDTH_8WIRE (0x3UL << EEPROM_FLAG_ALT_WIDTH_POS)
