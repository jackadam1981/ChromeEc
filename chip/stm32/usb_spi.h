...
struct usb_spi_response_configuration_v2_t {
	int16_t packet_id;
	uint16_t max_write_count;
	uint16_t max_read_count;
} __packed;

struct usb_spi_command_v2_t {
	int16_t packet_id;
	int16_t write_count;
...
struct usb_spi_response_v2_t {
	int16_t packet_id;
	uint16_t status_code;
	uint8_t data[USB_SPI_PAYLOAD_SIZE_V2_RESPONSE];
} __packed;

struct usb_spi_continue_v2_t {
	int16_t packet_id;
	uint16_t data_index;
...
struct usb_spi_packet_ctx_t {
	union {
		...
		int16_t packet_id;
		struct usb_spi_command_v2_t cmd_start;
		struct usb_spi_continue_v2_t cmd_continue;
		struct usb_spi_response_configuration_v2_t rsp_config;
		struct usb_spi_response_v2_t rsp_start;
		struct usb_spi_continue_v2_t rsp_continue;
	} __packed;
	/*
