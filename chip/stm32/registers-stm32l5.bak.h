...
#define STM32_ADC_BASE              0x40028000
...
//#define STM32_RNG_BASE              0x420C4000
...
//#define STM32_UNIQUE_ID_BASE        0x0BFA0590
...
//#define STM32_USB_CAN_SRAM_BASE     0x4000D800
...
/*
 * Content below is copied verbatim from stm32l4.h without
 * verification that it all applies to L5xx.
 */
...
#define STM32_GPIO_SECCFGR(b)   REG32((b) + 0x30) /* only for stm32l5 */
...
#define STM32_RCC_CFGR_SW_MSK		(3 << 0)
...
#define STM32_RCC_CFGR_SWS_MSK		(3 << 2)
...
#define STM32_RCC_APB1ENR2_USB		BIT(21)
...
/* Below declarations verified in datasheet by JBK. */

#define EXTI_PVD_EVENT              BIT(16)
#define STM32_PWR_CR2               REG32(STM32_PWR_BASE + 0x04)

#define STM32_PWR_CSR               REG32(STM32_RCC_BASE + 0x94)
