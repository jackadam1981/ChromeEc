...
static const struct stm32f0_adc_profile_t adc_profiles[ADC_PROFILE_COUNT] = {
...
static const struct stm32f0_adc_profile_t *profile =
	&adc_profiles[CONFIG_ADC_PROFILE];
