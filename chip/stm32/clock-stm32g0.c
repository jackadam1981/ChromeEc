...
/* High-speed oscillator default is 16 MHz */
...
enum clock_osc {
	OSC_HSI = 0,	/* High-speed internal oscillator (about 16 MHz) */
	OSC_LSI,	/* Low-speed internal oscillator (about 32 kHz) */
	OSC_HSE,	/* High-speed external oscillator */
	OSC_LSE,	/* Low-speed external oscillator */
	OSC_PLL,	/* PLL */
};
