 ...
 * makes LPTIM_PERIOD_US an unsigned long instead of int, which causes a bug in
 * the LPTIM code and changes deep sleep behavior. In particular this causes
 * https://issuetracker.google.com/140538084
