 ...
 */
#ifndef __CROS_EC_USART_STM32H7_H
#define __CROS_EC_USART_STM32H7_H

#include "usart.h"

/*
 * The STM32H7 series can have as many as three UARTS.  These are the HW configs
...
#endif /* __CROS_EC_USART_STM32H7_H */
