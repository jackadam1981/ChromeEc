...
#ifdef CONFIG_RTC
#error "RTC support needs to be added for G4 family"
#endif
					    ...
					    uint32_t pll_clksrc)
{
	...
	if (sysclk_src == sysclk_hsi) {
		 ...
		 *
		 * TODO(b/161502871): Add support to use HSI as sysclk source
		 */
		...
		/*
		 * TODO(b/161502871): Add support to use HSE as sysclk source
		 */
	}
}
