...
/*
 * Only reference the usart_rx_dma_info function if CONFIG_USART_INFO_COMMAND
 * is defined.  This allows the compiler to remove this function as dead code
 * when CONFIG_USART_INFO_COMMAND is not defined.
 */
#ifdef CONFIG_USART_INFO_COMMAND
