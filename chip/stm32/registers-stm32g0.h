...
#elif defined(CHIP_FAMILY_STM32G0)
#define STM32_EXTI_BASE             0x40021800
#else
...
#elif defined(CHIP_FAMILY_STM32F0) || defined(CHIP_FAMILY_STM32F3) || \
	defined(CHIP_FAMILY_STM32L4) || defined(CHIP_FAMILY_STM32G0)
...
#elif defined(CHIP_FAMILY_STM32G0)
#define STM32_GPIOA_BASE            0x50000000
#define STM32_GPIOB_BASE            0x50000400
#define STM32_GPIOC_BASE            0x50000800
#define STM32_GPIOD_BASE            0x50000C00
#define STM32_GPIOF_BASE            0x50001400
#endif
...
#elif defined(CHIP_FAMILY_STM32G0)
#define STM32_OTP_BASE              0x1FFF7000
#endif
...
#define STM32_RCC_BASE              0x40023800
	...
	defined(CHIP_FAMILY_STM32F3) || defined(CHIP_FAMILY_STM32G0)
...
#define STM32_TIM1_BASE             0x40012c00 /* STM32F373 and STM32G0x1 */
...
#define STM32_TIM14_BASE            0x40002000 /* STM32F373 and STM32G0x1 */
...
#if defined(CHIP_FAMILY_STM32G0)
#define STM32_UCPD1_BASE            0x4000a000
#define STM32_UCPD2_BASE            0x4000a400
#endif
...
/* --- UCPD --- */
#if defined(CHIP_FAMILY_STM32G0)
#define STM32_UCPD_BASE(n)           CONCAT3(STM32_UCPD, n, _BASE)
#define STM32_UCPD_REG(base, offset) REG32((base) + (offset))

#define STM32_UCPD_CFG1(base)      STM32_UCPD_REG(base, 0x00)
#define STM32_UCPD_CFG1_HBTCLKDIV(n)	((n) & 0x3f)
#define STM32_UCPD_CFG1_IFRGAP(n)	(((n) & 0x1f) << 6)
#define STM32_UCPD_CFG1_TRANSWIN(n)	(((n) & 0x1f) << 11)
#define STM32_UCPD_CFG1_PSC_USBPDCLK(n)	(((n) & 7) << 17)
...
#define STM32_UCPD_CFG1_RXORDSETEN(n)	(((n) & 0x1ff) << 20)

enum ucpd_rx_orderset {
	RX_ORDERSET_SOP		= 0x0001,
	RX_ORDERSET_SOPP	= 0x0002,
	RX_ORDERSET_SOPPP	= 0x0004,
	RX_ORDERSET_HARD_RESET	= 0x0008,
	RX_ORDERSET_CABLE_DETECT = 0x0010,
	RX_ORDERSET_SOPP_DEBUG	= 0x0020,
	RX_ORDERSET_SOPPP_DEBUG = 0x0040,
	RX_ORDERSET_SOP_EXT1	= 0x0080,
	RX_ORDERSET_SOP_EXT2	= 0x0100,
};

#define STM32_UCPD_CFG1_TXDMAEN		BIT(29)
#define STM32_UCPD_CFG1_RXDMAEN		BIT(30)
#define STM32_UCPD_CFG1_UCPDEN		BIT(31)

#define STM32_UCPD_CFG2(base)		STM32_UCPD_REG(base, 0x04)
#define STM32_UCPD_CFG2_RXFILTDIS	BIT(0)
#define STM32_UCPD_CFG2_RXFILT2N3	BIT(1)
#define STM32_UCPD_CFG2_FORCECLK	BIT(2)
#define STM32_UCPD_CFG2_WUPEN		BIT(3)

#define STM32_UCPD_CR(base)		STM32_UCPD_REG(base, 0x0c)
#define STM32_UCPD_CR_TXMODE(n)		((n) & 3)
...
#define STM32_UCPD_CR_ANASUBMODE(n)	(((n) & 3) << 7)

enum ucpd_anasubmode {
	ANASUBMODE_RP_NONE = 0,
...
#define STM32_UCPD_CR_CCENABLE(n)	(((n) & 3) << 10)
...
#define STM32_UCPD_IMR(base)		STM32_UCPD_REG(base, 0x10)
...
enum ucpd_imr {
	IMR_TXISIE	= STM32_UCPD_IMR_TXISIE,
	IMR_TXMSGDISCIE = STM32_UCPD_IMR_TXMSGDISCIE,
	IMR_TXMSGSENTIE = STM32_UCPD_IMR_TXMSGSENTIE,
	IMR_TXMSGABTIE	= STM32_UCPD_IMR_TXMSGABTIE,
	IMR_HRSTDISCIE	= STM32_UCPD_IMR_HRSTDISCIE,
	IMR_HRSTSENTIE	= STM32_UCPD_IMR_HRSTSENTIE,
	IMR_TXUNDIE	= STM32_UCPD_IMR_TXUNDIE,
	IMR_RXNEIE	= STM32_UCPD_IMR_RXNEIE,
	IMR_RXORDDETIE	= STM32_UCPD_IMR_RXORDDETIE,
	IMR_RXHRSTDETIE	= STM32_UCPD_IMR_RXHRSTDETIE,
	IMR_RXOVRIE	= STM32_UCPD_IMR_RXOVRIE,
	IMR_RXMSGENDIE	= STM32_UCPD_IMR_RXMSGENDIE,
	IMR_TYPECEVT1IE = STM32_UCPD_IMR_TYPECEVT1IE,
	IMR_TYPECEVT2IE = STM32_UCPD_IMR_TYPECEVT2IE,
	IMR_FRSEVTIE	= STM32_UCPD_IMR_FRSEVTIE,
};

#define STM32_UCPD_SR(base)		STM32_UCPD_REG(base, 0x14)
...
#define   UCPD_SR_TYPEC_VSTATE_CC1(v)  (((v) >> 16) & 3)
#define   UCPD_SR_TYPEC_VSTATE_CC2(v)  (((v) >> 18) & 3)
#define STM32_UCPD_SR_FRSEVT		BIT(19)

enum ucpd_sr {
	SR_TXIS		= STM32_UCPD_SR_TXIS,
	SR_TXMSGDISC	= STM32_UCPD_SR_TXMSGDISC,
	SR_TXMSGSENT	= STM32_UCPD_SR_TXMSGSENT,
	SR_TXMSGABT	= STM32_UCPD_SR_TXMSGABT,
	SR_HRSTDISC	= STM32_UCPD_SR_HRSTDISC,
	SR_HRSTSENT	= STM32_UCPD_SR_HRSTSENT,
	SR_TXUND	= STM32_UCPD_SR_TXUND,
	SR_RXNE		= STM32_UCPD_SR_RXNE,
	SR_RXORDDET	= STM32_UCPD_SR_RXORDDET,
	SR_RXHRSTDET	= STM32_UCPD_SR_RXHRSTDET,
	SR_RXOVR	= STM32_UCPD_SR_RXOVR,
	SR_RXMSGEND	= STM32_UCPD_SR_RXMSGEND,
	SR_RXERR	= STM32_UCPD_SR_RXERR,
	SR_TYPECEVT1	= STM32_UCPD_SR_TYPECEVT1,
	SR_TYPECEVT2	= STM32_UCPD_SR_TYPECEVT2,
	SR_FRSEVT	= STM32_UCPD_SR_FRSEVT,
};

#define STM32_UCPD_ICR(base)		STM32_UCPD_REG(base, 0x18)
...
enum ucpd_icr {
	ICR_TXMSGDISCCF = STM32_UCPD_ICR_TXMSGDISCCF,
	ICR_TXMSGSENTCF = STM32_UCPD_ICR_TXMSGSENTCF,
	ICR_TXMSGABTCF	= STM32_UCPD_ICR_TXMSGABTCF,
	ICR_HRSTDISCCF	= STM32_UCPD_ICR_HRSTDISCCF,
	ICR_HRSTSENTCF	= STM32_UCPD_ICR_HRSTSENTCF,
	ICR_TXUNDCF	= STM32_UCPD_ICR_TXUNDCF,
	ICR_RXORDDETICF	= STM32_UCPD_ICR_RXORDDETCF,
	ICR_RXHRSTDETCF = STM32_UCPD_ICR_RXHRSTDETCF,
	ICR_RXOVRCF	= STM32_UCPD_ICR_RXOVRCF,
	ICR_RXMSGENDCF	= STM32_UCPD_ICR_RXMSGENDCF,
	ICR_TYPECEVT1CF = STM32_UCPD_ICR_TYPECEVT1CF,
	ICR_TYPECEVT2CF = STM32_UCPD_ICR_TYPECEVT2CF,
	ICR_FRSEVTCF	= STM32_UCPD_ICR_FRSEVTCF,
};

#define STM32_UCPD_TX_ORDSET(base)	STM32_UCPD_REG(base, 0x1c)
...
#define STM32_UCPD_TX_PAYSZ(base)	STM32_UCPD_REG(base, 0x20)
#define STM32_UCPD_TXPAYSZ(n)		((n) & 0x3ff)

#define STM32_UCPD_TXDR(base)		STM32_UCPD_REG(base, 0x24)
#define STM32_UCPD_TXDR_TXDATA(n)	((n) & 0xff)

#define STM32_UCPD_RX_ORDSET(base)	STM32_UCPD_REG(base, 0x28)
#define   UCPD_RX_ORDSET_RXORDSET(v)	((v) & 7)
#define   UCPD_RX_ORDSET_RXSOP3OF4(v) (((v) >> 3) & 1)
#define   UCPD_RX_ORDSET_RXSOPKINVALID(v) (((v) >> 4) & 7)
...
enum ucpd_rx_ordset {
	...
	RXORDERED_SET_SOP1,
	RXORDERED_SET_SOP2,
	RXORDERED_SET_SOP1_DEBUG,
	RXORDERED_SET_SOP2_DEBUG,
	RXORDERED_SET_CABLE_RESET,
	RXORDERED_SET_SOP_EXT1,
	RXORDERED_SET_SOP_EXT2,
};


#define STM32_UCPD_RX_PAYSZ(base)	STM32_UCPD_REG(base, 0x2c)
#define   UCPD_RX_PAYSZ(v)		((v) & 0x3ff)

#define STM32_UCPD_RXDR(base)		STM32_UCPD_REG(base, 0x30)
#define   UCPD_RXDR_RXDATA(v)		((v) & 0xff)

#define STM32_UCPD_RX_ORDEXT1(base)	STM32_UCPD_REG(base, 0x34)
#define STM32_UCPD_RXSOPX1(n)		((n) & 0xfffff)

#define STM32_UCPD_RX_ORDEXT2(base)	STM32_UCPD_REG(base, 0x38)
#define STM32_UCPD_RXSOPX2(n)		((n) & 0xfffff)

#endif /* CHIP_FAMILY_STM32G0 */
...
#define STM32_RCC_CFGR_SW_LSI		(3 << 0)
#define STM32_RCC_CFGR_SW_LSE           (4 << 0)
#define STM32_RCC_CFGR_SW_MASK		(7 << 0)
#define STM32_RCC_CFGR_SWS_HSI		(0 << 3)
#define STM32_RCC_CFGR_SWS_HSE		(1 << 3)
#define STM32_RCC_CFGR_SWS_PLL		(2 << 3)
#define STM32_RCC_CFGR_SWS_LSI		(3 << 3)
#define STM32_RCC_CFGR_SWS_LSE          (4 << 3)
#define STM32_RCC_CFGR_SWS_MASK		(7 << 3)
...
#define STM32_RCC_AHBRSTR		REG32(STM32_RCC_BASE + 0x28)
#define STM32_RCC_APBRSTR1		REG32(STM32_RCC_BASE + 0x2C)
#define STM32_RCC_APBRSTR1_UCPD1_RST	BIT(25)
#define STM32_RCC_APBRSTR1_UCPD2_RST    BIT(26)

#define STM32_RCC_APBRSTR2		REG32(STM32_RCC_BASE + 0x30)
#define STM32_RCC_IOPENR		REG32(STM32_RCC_BASE + 0x34)
#define STM32_RCC_IOPENR_GPIOMASK	(0x2f << 0)
#define STM32_RCC_AHBENR		REG32(STM32_RCC_BASE + 0x38)
#define STM32_RCC_AHBENR_DMAEN		BIT(0)

#define STM32_RCC_APBENR1		REG32(STM32_RCC_BASE + 0x3C)
/* Alias */
#define STM32_RCC_APB1ENR		STM32_RCC_APBENR1
#define STM32_RCC_TIM2EN		BIT(0)
#define STM32_RCC_TIM3EN		BIT(1)
#define STM32_RCC_TIM6EN		BIT(4)
#define STM32_RCC_TIM7EN		BIT(5)
#define STM32_RCC_SPI2EN		BIT(14)
#define STM32_RCC_USART2EN		BIT(17)
#define STM32_RCC_USART3EN		BIT(18)
#define STM32_RCC_USART4EN		BIT(19)
#define STM32_RCC_LPUART1EN		BIT(20)
#define STM32_RCC_I2C1EN		BIT(21)
#define STM32_RCC_I2C2EN		BIT(22)
#define STM32_RCC_UCPD1EN		BIT(25)
#define STM32_RCC_UCPD2EN		BIT(26)
#define STM32_RCC_PWREN			BIT(28)
#define STM32_RCC_DAC1EN		BIT(29)
#define STM32_RCC_LPTIM1EN		BIT(30)
#define STM32_RCC_LPTIM2EN		BIT(31)

#define STM32_RCC_APBENR2		REG32(STM32_RCC_BASE + 0x40)
/* Alias */
#define STM32_RCC_APB2ENR		STM32_RCC_APBENR2
#define STM32_RCC_SYSCFGEN		BIT(0)
#define STM32_RCC_TIM1EN		BIT(11)
#define STM32_RCC_SPI1			BIT(12)
#define STM32_RCC_USART1EN		BIT(14)
#define STM32_RCC_TIM14EN		BIT(15)
#define STM32_RCC_TIM15EN		BIT(16)
#define STM32_RCC_TIM16EN		BIT(17)
#define STM32_RCC_TIM17EN		BIT(18)
#define STM32_RCC_ADCEN			BIT(20)


#define STM32_RCC_CCIPR			REG32(STM32_RCC_BASE + 0x54)
...
#define STM32_RCC_BDCR			REG32(STM32_RCC_BASE + 0x5C)

#define STM32_RCC_CSR			REG32(STM32_RCC_BASE + 0x60)
...
#define STM32_SYSCFG_CFGR1_UCPD1_STROBE	BIT(9)
#define STM32_SYSCFG_CFGR1_UCPD2_STROBE BIT(10)
...
struct stm32_spi_regs {
	...
	uint32_t rxcrcr;
	uint32_t txcrcr;
	uint32_t i2scfgr;	/* STM32L and STM32G only */
	uint32_t i2spr;		/* STM32L and STM32G only */
#endif /* !CHIP_FAMILY_STM32H7 */
};
/* Must be volatile, or compiler optimizes out repeated accesses */
...
#elif defined(CHIP_FAMILY_STM32L4) || defined(CHIP_FAMILY_STM32G0)
#define STM32_FLASH_ACR             REG32(STM32_FLASH_REGS_BASE + 0x00)
#define STM32_FLASH_ACR_LATENCY_SHIFT (0)
#define STM32_FLASH_ACR_LATENCY_MASK  (7 << STM32_FLASH_ACR_LATENCY_SHIFT)
...
#define STM32_EXTI_RPR1             REG32(STM32_EXTI_BASE + 0x0c)
#define STM32_EXTI_FPR1             REG32(STM32_EXTI_BASE + 0x10)
#define STM32_EXTI_EXTICRx(x)       REG32(STM32_EXTI_BASE + 0x60 + (x) * 4)
#define STM32_EXTI_IMR1             REG32(STM32_EXTI_BASE + 0x80)
#define STM32_EXTI_EMR1             REG32(STM32_EXTI_BASE + 0x84)
/* Aliases */
...
#if defined(CHIP_FAMILY_STM32F0) || defined(CHIP_FAMILY_STM32F3) || \
	defined(CHIP_FAMILY_STM32F4) || defined(CHIP_FAMILY_STM32G0)
...
#elif defined(CHIP_FAMILY_STM32F0) || defined(CHIP_FAMILY_STM32G0)
...
#define STM32_ADC_SMPR_3_5_CY      0x1
#define STM32_ADC_SMPR_7_5_CY      0x2
#define STM32_ADC_SMPR_12_5_CY     0x3
#define STM32_ADC_SMPR_19_5_CY     0x4
#define STM32_ADC_SMPR_39_5_CY     0x5
#define STM32_ADC_SMPR_79_5_CY     0x6
#define STM32_ADC_SMPR_160_5_CY    0x7
#endif
...
#if defined(CHIP_FAMILY_STM32H7) || defined(CHIP_FAMILY_STM32G0)
/* The requests for the DMA1/DMA2 controllers are routed through DMAMUX1. */
/* DMAMUX1/2 registers */
#define DMAMUX1 0
#define DMAMUX2 1
#if defined(CHIP_FAMILY_STM32G0)
#define STM32_DMAMUX_BASE(n)        STM32_DMAMUX1_BASE
#else
...
#else /* CHIP_FAMILY_STM32G0 */
enum dmamux1_request {
	DMAMUX1_REQ_ADC1 = 5,
	DMAMUX1_REQ_AES_IN = 6,
	DMAMUX1_REQ_AES_OUT = 7,
	DMAMUX1_REQ_DAC_CH1 = 8,
	DMAMUX1_REQ_DAC_CH2 = 9,
	DMAMUX1_REQ_I2C1_RX = 10,
	DMAMUX1_REQ_I2C1_TX = 11,
	DMAMUX1_REQ_I2C2_RX = 12,
	DMAMUX1_REQ_I2C2_TX = 13,
	DMAMUX1_REQ_LPUART_RX = 14,
	DMAMUX1_REQ_LPUART_TX = 15,
	DMAMUX1_REQ_SPI1_RX = 16,
	DMAMUX1_REQ_SPI1_TX = 17,
	DMAMUX1_REQ_SPI2_RX = 18,
	DMAMUX1_REQ_SPI2_TX = 19,
	DMAMUX1_REQ_TIM1_CH1 = 20,
	DMAMUX1_REQ_TIM1_CH2 = 21,
	DMAMUX1_REQ_TIM1_CH3 = 22,
	DMAMUX1_REQ_TIM1_CH4 = 23,
	DMAMUX1_REQ_TIM1_TRIG_COM = 24,
	DMAMUX1_REQ_TIM1_UP = 25,
	DMAMUX1_REQ_TIM2_CH1 = 26,
	DMAMUX1_REQ_TIM2_CH2 = 27,
	DMAMUX1_REQ_TIM2_CH3 = 28,
	DMAMUX1_REQ_TIM2_CH4 = 29,
	DMAMUX1_REQ_TIM2_TRIG = 30,
	DMAMUX1_REQ_TIM2_UP = 31,
	DMAMUX1_REQ_TIM3_CH1 = 32,
	DMAMUX1_REQ_TIM3_CH2 = 33,
	DMAMUX1_REQ_TIM3_CH3 = 34,
	DMAMUX1_REQ_TIM3_CH4 = 35,
	DMAMUX1_REQ_TIM3_TRIG = 36,
	DMAMUX1_REQ_TIM3_UP = 37,
	DMAMUX1_REQ_TIM6_UP = 38,
	DMAMUX1_REQ_TIM7_UP = 39,
	DMAMUX1_REQ_TIM15_CH1 = 40,
	DMAMUX1_REQ_TIM15_CH2 = 41,
	DMAMUX1_REQ_TIM15_TRIG_COM = 42,
	DMAMUX1_REQ_TIM15_UP = 43,
	DMAMUX1_REQ_TIM16_CH1 = 44,
	DMAMUX1_REQ_TIM16_TRIG_COM = 45,
	DMAMUX1_REQ_TIM16_UP = 46,
	DMAMUX1_REQ_TIM17_CH1 = 47,
	DMAMUX1_REQ_TIM17_TRIG_COM = 48,
	DMAMUX1_REQ_TIM17_UP = 49,
	DMAMUX1_REQ_USART1_RX = 50,
	DMAMUX1_REQ_USART1_TX = 51,
	DMAMUX1_REQ_USART2_RX = 52,
	DMAMUX1_REQ_USART2_TX = 53,
	DMAMUX1_REQ_USART3_RX = 54,
	DMAMUX1_REQ_USART3_TX = 55,
	DMAMUX1_REQ_USART4_RX = 56,
	DMAMUX1_REQ_USART4_TX = 57,
	DMAMUX1_REQ_UCPD1_RX = 58,
	DMAMUX1_REQ_UCPD1_TX = 59,
	DMAMUX1_REQ_UCPD2_RX = 60,
	DMAMUX1_REQ_UCPD2_TX = 61,
};
#endif /* CHIP_FAMILY_STM32G0 */
#endif /* CHIP_FAMILY_STM32H7 */
