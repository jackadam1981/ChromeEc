...
#define HID_TOUCHPAD_REPORT_SIZE  sizeof(struct usb_hid_touchpad_packet)
...
const struct usb_endpoint_descriptor USB_EP_DESC(USB_IFACE_HID_TOUCHPAD, 81) = {
	...
	.bInterval = 8 /* ms polling interval */
};
...
static usb_uint hid_ep_buf[HID_TOUCHPAD_REPORT_SIZE / 2] __usb_ram;

/* FIXME: Figure out better interface */
...
USB_DECLARE_EP(USB_EP_HID_TOUCHPAD, hid_keyboard_tx, hid_keyboard_tx,
	       hid_keyboard_reset);
...
USB_DECLARE_IFACE(USB_IFACE_HID_TOUCHPAD, hid_keyboard_iface_request)
