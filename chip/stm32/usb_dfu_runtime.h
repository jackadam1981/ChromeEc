...
#define USB_DFU_RUNTIME_DESC_ATTR_CAN_DOWNLOAD       (1 << 0)
#define USB_DFU_RUNTIME_DESC_ATTR_CAN_UPLOAD         (1 << 1)
#define USB_DFU_RUNTIME_DESC_ATTR_MANIFEST_TOLERANT  (1 << 2)
#define USB_DFU_RUNTIME_DESC_ATTR_WILL_DETACH        (1 << 3)
...
#define USB_DFU_RUNTIME_REQ_CLR_STATUS  (5)
