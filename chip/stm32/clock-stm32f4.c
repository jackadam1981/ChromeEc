 ...
 */
#define RCC_PLLCFGR ((4 << 24) | (0 << 16) | (105 << 6) | (10 << 0))
...
#define APB1_PRESCALAR (1 + (CPU_CLOCK / 50000001))
...
#define RCC_CFGR ((APB_PRESCALAR_FIELD(APB2_PRESCALAR) << 13) | \
		  ...
		  (AHB_PRESCALAR_FIELD(AHB_PRESCALAR) << 4))
...
{
	/* Flash settings depend on the voltage and frequency */
