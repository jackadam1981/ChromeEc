...
#define UCPD_TRANSWIN_HBIT_CNT 11
#define UCPD_IFRGAP_HBIT_CNT 18
	...
	enum tcpc_cc_voltage_status *cc2)
{
	...
	if (anamode) {
		...
		if (log_count++ < 10)
			CPRINTS("ucpd: v_1 = %dm cc1 = %d, v_2 = %d, cc2 = %d",
				vstate_cc1, *cc1, vstate_cc2, *cc2);
	}
			...
			const uint32_t *data)
{
	...
	case TCPC_TX_SOP:
		 ...
		 * event.
		 */
		CPRINTS("ucpd: hard reset ctrl msg");
