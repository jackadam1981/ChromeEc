...
defined(CHIP_VARIANT_STM32F070)
	...
	/*
	 * Reset Clock Recovery System to default values.
	 *
	 * Default values configure the CRS to use the periodic USB SOF as the
	 * SYNC signal for calibrating the HSI48.
	 */
	STM32_RCC_APB1RSTR |= STM32_RCC_PB1_CRS;
	STM32_RCC_APB1RSTR &= ~STM32_RCC_PB1_CRS;
