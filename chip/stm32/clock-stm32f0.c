...
static void rtc_read(uint32_t *rtc, uint32_t *rtcss)
{
	/* Wait until RTC registers are copied to shadow regs. */
	while (!(STM32_RTC_ISR & STM32_RTC_ISR_RSF))
		;
	...
	*rtcss = STM32_RTC_SSR;
	...
	STM32_RTC_ISR &= ~STM32_RTC_ISR_RSF;
}
