...
__attribute__((naked)) void IRQ_HANDLER(STM32_IRQ_FPU)(void)
{
	...
	asm volatile("mov r0, lr\n"
		      ...
		      * (FPCCR) have ASPEN and LSPEN bits enabled. This means
		      * that lazy floating-point context save and restore is
		      * enabled. To save context on stack it's necessary to
		      * perform read access FPU.
		      */
		     "vmrs r2, fpscr\n"
		     /*
