...
typedef int (*iface_func)(usb_uint *ep0_buf_rx, usb_uint *ep0_buf_tx);
#ifndef PASS
#define PASS 1
#endif

#if PASS == 1
void __attribute__((used,naked)) ep_undefined(void);
void ep_undefined()
{
	asm(
	".thumb_func\n"
...
void __attribute__((used,naked)) ep_evt_undefined(enum usb_ep_event evt);
...
int __attribute__((used,naked)) iface_undefined(usb_uint *ep0_buf_rx, usb_uint *ep0_buf_tx);
int iface_undefined(usb_uint *ep0_buf_rx, usb_uint *ep0_buf_tx)
{
...
#define interface(number) \
	extern int __attribute__((used,weak,alias("iface_undefined"))) \
		iface_ ## number ## _request(usb_uint *ep0_buf_rx, usb_uint *ep0_buf_tx);
