...
typedef struct
{
	 ...
	 * in the usart_state.  This slightly complicates the fifo API, but
	 * results in a smaller usart_config struct.
	 */
	fifo_config rx;
	fifo_config tx;
 ...
 * TX_READY are the callback functions for the in and out streams.
 *
