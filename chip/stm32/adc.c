...
static int watchdog_high;
static int watchdog_low;
...
int adc_enable_watchdog_no_lock(void)
{
	...
	/* Set thresholds */
	STM32_ADC_HTR = watchdog_high & 0xfff;
	STM32_ADC_LTR = watchdog_low & 0xfff;
...
int adc_disable_watchdog_no_lock(void)
{
