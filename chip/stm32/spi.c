...
static const struct dma_option dma_tx_option = {
	DMAC_SPI1_TX, (void *)&stm32_spi_addr(STM32_SPI1_PORT)->data,
	DMA_MSIZE_BYTE | DMA_PSIZE_HALF_WORD
};

static const struct dma_option dma_rx_option = {
	DMAC_SPI1_RX, (void *)&stm32_spi_addr(STM32_SPI1_PORT)->data,
	DMA_MSIZE_BYTE | DMA_PSIZE_HALF_WORD
};
...
static void spi_init(void)
{
	...
	/* TODO: if we're hard-coding SPI1 here, why not everywhere? */
