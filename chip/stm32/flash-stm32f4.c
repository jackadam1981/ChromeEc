 ...
 *
 * stm32f4 has non-uniform sector sizes:
 *   16K, 16K, 16K, 16K, 64K, 128K, 128K, 128K, 128K, 128K ...
 *
 * Since we have non-uniform block size, we use the smallest block size (16K)
 * available as CONFIG_FLASH_BANK_SIZE. For F4, we present common code as if
 * we have uniform sector size with each sector having the size of 16K.
 */
