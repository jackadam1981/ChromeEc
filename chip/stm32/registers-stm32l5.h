...
#define STM32_OCTOSPI_DCR1_MTYP_MACRONIX_RAM (0x3UL << STM32_OCTOSPI_DCR1_MTYP_POS)
#define STM32_OCTOSPI_DCR1_MTYP_HYPERBUS_MEM (0x4UL << STM32_OCTOSPI_DCR1_MTYP_POS)
#define STM32_OCTOSPI_DCR1_MTYP_HYPERBUS_REG (0x5UL << STM32_OCTOSPI_DCR1_MTYP_POS)

#define STM32_OCTOSPI_DCR1_DEVSIZE_POS 16U
#define STM32_OCTOSPI_DCR1_DEVSIZE_MSK (0x1FUL << STM32_OCTOSPI_DCR1_DEVSIZE_POS)
...
#define STM32_OCTOSPI_DCR2_WRAPSIZE_MSK (0x7UL << STM32_OCTOSPI_DCR2_WRAPSIZE_POS)

#define STM32_OCTOSPI_DCR2_PRESCALER_POS 0U
#define STM32_OCTOSPI_DCR2_PRESCALER_MSK (0xFFUL << STM32_OCTOSPI_DCR2_PRESCALER_POS)

/* Bit values for STM32_OCTOSPI_DCR3 */
#define STM32_OCTOSPI_DCR3_CSBOUND_POS 16U
#define STM32_OCTOSPI_DCR3_CSBOUND_MSK (0x1FUL << STM32_OCTOSPI_DCR3_CSBOUND_POS)
...
#define STM32_OCTOSPI_FCR_SIOO_POS 31U
#define STM32_OCTOSPI_FCR_SIOO_MSK (0x1UL << STM32_OCTOSPI_FCR_SIOO_POS)
#define STM32_OCTOSPI_FCR_SIOO STM32_OCTOSPI_FCR_SIOO_MSK

#define STM32_OCTOSPI_FCR_DQSE_POS 29U
#define STM32_OCTOSPI_FCR_DQSE_MSK (0x1UL << STM32_OCTOSPI_FCR_DQSE_POS)
#define STM32_OCTOSPI_FCR_DQSE STM32_OCTOSPI_FCR_DQSE_MSK
...
#define STM32_OCTOSPI_CCR_ABSIZE_2BYTE (1UL << STM32_OCTOSPI_CCR_ABSIZE_POS)
#define STM32_OCTOSPI_CCR_ABSIZE_3BYTE (2UL << STM32_OCTOSPI_CCR_ABSIZE_POS)
#define STM32_OCTOSPI_CCR_ABSIZE_4BYTE (3UL << STM32_OCTOSPI_CCR_ABSIZE_POS)
...
#define STM32_OCTOSPI_CCR_ADSIZE_2BYTE (1UL << STM32_OCTOSPI_CCR_ADSIZE_POS)
#define STM32_OCTOSPI_CCR_ADSIZE_3BYTE (2UL << STM32_OCTOSPI_CCR_ADSIZE_POS)
#define STM32_OCTOSPI_CCR_ADSIZE_4BYTE (3UL << STM32_OCTOSPI_CCR_ADSIZE_POS)
...
#define STM32_OCTOSPI_CCR_ISIZE_2BYTE (1UL << STM32_OCTOSPI_CCR_ISIZE_POS)
#define STM32_OCTOSPI_CCR_ISIZE_3BYTE (2UL << STM32_OCTOSPI_CCR_ISIZE_POS)
#define STM32_OCTOSPI_CCR_ISIZE_4BYTE (3UL << STM32_OCTOSPI_CCR_ISIZE_POS)
