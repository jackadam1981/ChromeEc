...
static void check_reset_cause(void)
{
...
#ifdef CHIP_FAMILY_STM32H7 /* TEMPORARY: refactor ME */
	uint32_t raw_cause = STM32_RCC_RSR;
	...
	if (raw_cause & 0x01000000)
		flags |= RESET_FLAG_SOFT;

	if (raw_cause & 0x00800000)
		flags |= RESET_FLAG_POWER_ON;

	if (raw_cause & 0x00400000)
