 ...
 * registered properly. This type of descirptor may contain more than one
...
#elif defined(CONFIG_USB_MS_EXTENDED_COMPAT_ID_DESCRIPTOR)
		uint8_t b_req = req >> 8; /* bRequest in the transfer */
