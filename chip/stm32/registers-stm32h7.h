...
/*      STM32_DBGMCU_CR                 REG32(STM32_DBGMCU_BASE + 0x04) */
#define  STM32_DBGMCU_CR_DBGSLEEP_D1     BIT(0)
#define  STM32_DBGMCU_CR_DBGSTOP_D1      BIT(1)
#define  STM32_DBGMCU_CR_DBGSTBY_D1      BIT(2)
#define  STM32_DBGMCU_CR_DBGSTOP_D3      BIT(7)
#define  STM32_DBGMCU_CR_DBGSTBY_D3      BIT(8)
#define  STM32_DBGMCU_CR_TRACECLKEN      BIT(20)
#define  STM32_DBGMCU_CR_D1DBGCKEN       BIT(21)
#define  STM32_DBGMCU_CR_D3DBGCKEN       BIT(22)
#define  STM32_DBGMCU_CR_TRGOEN          BIT(28)
#define  STM32_DBGMCU_CR_MASK            (STM32_DBGMCU_CR_DBGSLEEP_D1 | \
					  STM32_DBGMCU_CR_DBGSTOP_D1  | \
					  STM32_DBGMCU_CR_DBGSTBY_D1  | \
					  STM32_DBGMCU_CR_DBGSTOP_D3  | \
					  STM32_DBGMCU_CR_DBGSTBY_D3  | \
					  STM32_DBGMCU_CR_TRACECLKEN  | \
					  STM32_DBGMCU_CR_D1DBGCKEN   | \
					  STM32_DBGMCU_CR_D3DBGCKEN   | \
					  STM32_DBGMCU_CR_TRGOEN)
/* DBGMCU APB3 peripheral freeze register */
#define STM32_DBGMCU_APB3FZ             REG32(STM32_DBGMCU_BASE + 0x34)
#define  STM32_DBGMCU_APB3FZ_WWDG1       BIT(6) /* Stop in debug mode */
#define  STM32_DBGMCU_APB3FZ_MASK        STM32_DBGMCU_APB3FZ_WWDG1
/* DBGMCU APB1L peripheral freeze register */
#define STM32_DBGMCU_APB1LFZ            REG32(STM32_DBGMCU_BASE + 0x3C)
#define  STM32_DBGMCU_APB1LFZ_DBG_TIM2   BIT(0)
#define  STM32_DBGMCU_APB1LFZ_DBG_TIM3   BIT(1)
#define  STM32_DBGMCU_APB1LFZ_DBG_TIM4   BIT(2)
#define  STM32_DBGMCU_APB1LFZ_DBG_TIM5   BIT(3)
#define  STM32_DBGMCU_APB1LFZ_DBG_TIM6   BIT(4)
#define  STM32_DBGMCU_APB1LFZ_DBG_TIM7   BIT(5)
#define  STM32_DBGMCU_APB1LFZ_DBG_TIM12  BIT(6)
#define  STM32_DBGMCU_APB1LFZ_DBG_TIM13  BIT(7)
#define  STM32_DBGMCU_APB1LFZ_DBG_TIM14  BIT(8)
#define  STM32_DBGMCU_APB1LFZ_DBG_LPTIM1 BIT(9)
#define  STM32_DBGMCU_APB1LFZ_DBG_I2C1   BIT(21)
#define  STM32_DBGMCU_APB1LFZ_DBG_I2C2   BIT(22)
#define  STM32_DBGMCU_APB1LFZ_DBG_I2C3   BIT(23)
#define  STM32_DBGMCU_APB1LFZ_MASK       (STM32_DBGMCU_APB1LFZ_DBG_TIM2   | \
					  STM32_DBGMCU_APB1LFZ_DBG_TIM3   | \
					  STM32_DBGMCU_APB1LFZ_DBG_TIM4   | \
					  STM32_DBGMCU_APB1LFZ_DBG_TIM5   | \
					  STM32_DBGMCU_APB1LFZ_DBG_TIM6   | \
					  STM32_DBGMCU_APB1LFZ_DBG_TIM7   | \
					  STM32_DBGMCU_APB1LFZ_DBG_TIM12  | \
					  STM32_DBGMCU_APB1LFZ_DBG_TIM13  | \
					  STM32_DBGMCU_APB1LFZ_DBG_TIM14  | \
					  STM32_DBGMCU_APB1LFZ_DBG_LPTIM1 | \
					  STM32_DBGMCU_APB1LFZ_DBG_I2C1   | \
					  STM32_DBGMCU_APB1LFZ_DBG_I2C2   | \
					  STM32_DBGMCU_APB1LFZ_DBG_I2C3)
/* DBGMCU APB2 peripheral freeze register */
#define STM32_DBGMCU_APB2FZ             REG32(STM32_DBGMCU_BASE + 0x4C)
#define  STM32_DBGMCU_APB2FZ_DBG_TIM1    BIT(0)
#define  STM32_DBGMCU_APB2FZ_DBG_TIM8    BIT(1)
#define  STM32_DBGMCU_APB2FZ_DBG_TIM15   BIT(16)
#define  STM32_DBGMCU_APB2FZ_DBG_TIM16   BIT(17)
#define  STM32_DBGMCU_APB2FZ_DBG_TIM17   BIT(18)
#define  STM32_DBGMCU_APB2FZ_DBG_HRTIM   BIT(29)
#define  STM32_DBGMCU_APB2FZ_MASK        (STM32_DBGMCU_APB2FZ_DBG_TIM1  | \
					  STM32_DBGMCU_APB2FZ_DBG_TIM8  | \
					  STM32_DBGMCU_APB2FZ_DBG_TIM15 | \
					  STM32_DBGMCU_APB2FZ_DBG_TIM16 | \
					  STM32_DBGMCU_APB2FZ_DBG_TIM17 | \
					  STM32_DBGMCU_APB2FZ_DBG_HRTIM)
/* DBGMCU APB4 peripheral freeze register */
#define STM32_DBGMCU_APB4FZ             REG32(STM32_DBGMCU_BASE + 0x54)
#define  STM32_DBGMCU_APB4FZ_DBG_I2C4    BIT(7)
#define  STM32_DBGMCU_APB4FZ_DBG_LPTIM2  BIT(9)
#define  STM32_DBGMCU_APB4FZ_DBG_LPTIM3  BIT(10)
#define  STM32_DBGMCU_APB4FZ_DBG_LPTIM4  BIT(11)
#define  STM32_DBGMCU_APB4FZ_DBG_LPTIM5  BIT(12)
#define  STM32_DBGMCU_APB4FZ_DBG_RTC     BIT(16)
#define  STM32_DBGMCU_APB4FZ_DBG_IIWDG   BIT(18)
#define  STM32_DBGMCU_APB4FZ_MASK        (STM32_DBGMCU_APB4FZ_DBG_I2C4   | \
					  STM32_DBGMCU_APB4FZ_DBG_LPTIM2 | \
					  STM32_DBGMCU_APB4FZ_DBG_LPTIM3 | \
					  STM32_DBGMCU_APB4FZ_DBG_LPTIM4 | \
					  STM32_DBGMCU_APB4FZ_DBG_LPTIM5 | \
					  STM32_DBGMCU_APB4FZ_DBG_RTC    | \
					  STM32_DBGMCU_APB4FZ_DBG_IIWDG)
/* Alias */
