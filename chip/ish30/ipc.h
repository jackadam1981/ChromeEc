...
#define IPC_REG_BASE			IPC_BASE
#define IPC_PIMR_HOST2ISH_OFFS		(0)
#define IPC_PIMR_PEER02ISH_OFFS		(0)
#define IPC_PIMR_ISH2PEER0_CLR_OFFS	(11)
#define IPC_INT_ISH2PEER0_CLR_OFFS	(0)
#define IPC_INT_ISH2PEER1_CLR_OFFS	(0)
#define IPC_PISR_PEER02ISH_OFFS		IPC_PIMR_HOST2ISH_OFFS
...
#define IPC_PIMR_ISH2PEER0_CLR_MASK_BIT	(1 << IPC_PIMR_ISH2PEER0_CLR_OFFS)
#define IPC_PIMR_PEER02ISH_BIT		(1 << IPC_PIMR_PEER02ISH_OFFS)
#define IPC_INT_ISH2PEER0_CLR_BIT	(1 << IPC_INT_ISH2PEER0_CLR_OFFS)
#define IPC_INT_ISH2PEER1_CLR_BIT	(1 << IPC_INT_ISH2PEER1_CLR_OFFS)
#define IPC_PISR_PEER02ISH_BIT		(1 << IPC_PISR_PEER02ISH_OFFS)
