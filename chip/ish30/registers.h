 ...
 * linear address space. Drivers need not probe their presence.
 */
...
#define LAPIC_ICR_REG			(LAPIC_BASE + 0x300)
...
#define ISH30_IPC_HOST2ISH_IRQ		12
#define ISH30_IPC_ISH2HOST_CLR_IRQ	24
...
#define ISH30_I2C0_VEC			IRQ_TO_VEC(ISH30_I2C0_IRQ)
#define ISH30_I2C1_VEC			IRQ_TO_VEC(ISH30_I2C1_IRQ)
#define ISH30_I2C2_VEC			IRQ_TO_VEC(ISH30_I2C2_IRQ)
#define ISH30_HPET_TIMER0_VEC		IRQ_TO_VEC(ISH30_HPET_TIMER0_IRQ)
#define ISH30_HPET_TIMER1_VEC		IRQ_TO_VEC(ISH30_HPET_TIMER1_IRQ)
#define ISH30_HPET_TIMER2_VEC		IRQ_TO_VEC(ISH30_HPET_TIMER2_IRQ)
#define ISH30_IPC_HOST2ISH_VEC		IRQ_TO_VEC(ISH30_IPC_HOST2ISH_IRQ)
#define ISH30_IPC_ISH2HOST_CLR_VEC	IRQ_TO_VEC(ISH30_IPC_ISH2HOST_CLR_IRQ)
#define ISH30_UART0_VEC			IRQ_TO_VEC(ISH30_UART0_IRQ)
#define ISH30_UART1_VEC			IRQ_TO_VEC(ISH30_UART1_IRQ)
#define ISH30_IPC_VEC			IRQ_TO_VEC(ISH30_IPC_HOST2ISH_IRQ)

/* IPC_Registers */
#define IPC_PISR                       (IPC_BASE + 0x0)
#define IPC_PIMR                       (IPC_BASE + 0x4)
#define IPC_ISH2HOST_MSG_REGS         (IPC_BASE + 0x60)
#define IPC_ISH_MINIMA_FWSTS           (IPC_BASE + 0x34)
#define IPC_HOST2ISH_DOORBELL         (IPC_BASE + 0x48)
#define IPC_HOST2ISH_MSG_REGS         (IPC_BASE + 0xE0)
#define IPC_ISH2HOST_DOORBELL         (IPC_BASE + 0x54)
