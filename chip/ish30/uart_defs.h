...
#define	UART_ERROR		-1
#define UART_BUSY		-2
#define HSU_BASE		UART_BASE
#define UART0_OFFS              (0x80)
#define UART0_BASE              (HSU_BASE + UART0_OFFS)
#define UART0_SIZE              (0x80)

#define UART1_OFFS              (0x100)
#define UART1_BASE              (HSU_BASE + UART1_OFFS)
#define UART1_SIZE              (0x80)

#define UART2_OFFS              (0x180)
#define UART2_BASE              (HSU_BASE + UART2_OFFS)
...
#define RXTRG(n)  (uart_ctx[n].base + UART_REG_RXTRG * uart_ctx[n].addr_interval)
...
#define UART_CONFIG_HW_FLOW_CONTROL       (1<<0)
  ...
  * is raised after a timeout is received on the UART line, and all data received
  * until now is provided. */
