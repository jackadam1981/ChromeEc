 ...
 *
 * Register map and API for STM32F processor dma registers
 */
...
/**
 * @param spi	SPI port to request: STM32F_SPI1_PORT or STM32F_SPI2_PORT
 * @return DMA channel to use for rx / tx on that port
 */
#define DMA_CHANNEL_FOR_SPI_RX(spi) \
	((spi) == STM32F_SPI1_PORT ? DMAC_SPI1_RX : DMAC_SPI2_RX)
#define DMA_CHANNEL_FOR_SPI_TX(spi) \
	((spi) == STM32F_SPI1_PORT ? DMAC_SPI1_TX : DMAC_SPI2_TX)
