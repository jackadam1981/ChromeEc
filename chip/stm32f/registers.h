...
#ifndef __STM32F_REGISTERS
#define __STM32F_REGISTERS
...
#define STM32F_AFIO_BASE             0x40010000
#define STM32F_AFIO_EXTICR(n)        REG32(STM32F_AFIO_BASE + 8 + 4 * (n))
...
#define STM32F_I2C1_PORT             0
#define STM32F_I2C2_PORT             1

static inline uint16_t *stm32f_i2c_reg(int port, int offset)
{
	return (uint16_t *)((STM32F_I2C1_BASE + (port * 0x400)) + offset);
}

#define STM32F_I2C_CR1(n)            REG16(stm32f_i2c_reg(n, 0x00))
#define STM32F_I2C_CR2(n)            REG16(stm32f_i2c_reg(n, 0x04))
#define STM32F_I2C_OAR1(n)           REG16(stm32f_i2c_reg(n, 0x08))
#define STM32F_I2C_OAR2(n)           REG16(stm32f_i2c_reg(n, 0x0c))
#define STM32F_I2C_DR(n)             REG16(stm32f_i2c_reg(n, 0x10))
#define STM32F_I2C_SR1(n)            REG16(stm32f_i2c_reg(n, 0x14))
#define STM32F_I2C_SR2(n)            REG16(stm32f_i2c_reg(n, 0x18))
#define STM32F_I2C_CCR(n)            REG16(stm32f_i2c_reg(n, 0x1c))
#define STM32F_I2C_TRISE(n)          REG16(stm32f_i2c_reg(n, 0x20))
...
#define STM32F_BKP_DATA(n)           REG16(STM32F_BKP_BASE + 2 + 4 * (n))
#define STM32F_BKP_RTCCR             REG16(STm32F_BKP_BASE + 0x02)
#define STM32F_BKP_CR                REG16(STm32F_BKP_BASE + 0x30)
#define STM32F_BKP_CSR               REG16(STm32F_BKP_BASE + 0x34)
