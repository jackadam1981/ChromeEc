...
#define OSC_CLK 		48000000  	/* Default clock is 40MHz, target is 48MHz */
#define WAKE_INTERVAL	61 			/* Unit: 61 usec */
#define IDLE_PARAMS		0x7 		/* Support deep idle, instant wake-up */

/* Frequency multiplier values definition according to the requested PLL_CLOCK Clock Frequency */
#define HFCGN    0x02
#if   (OSC_CLK == 50000000)
#define HFCGMH   0x0B
#define HFCGML   0xEC
