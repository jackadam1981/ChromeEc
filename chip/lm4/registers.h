...
#define LM4_SYSTEM_IMC         REG32(0x400fe054)
#define LM4_SYSTEM_MISC        REG32(0x400fe058)
#define LM4_SYSTEM_RESC        REG32(0x400fe05c)
#define LM4_SYSTEM_GPIOHBCTL   REG32(0x400fe06c)
#define LM4_SYSTEM_RSCLKCFG    REG32(0x400fe0b0)
#define LM4_SYSTEM_RSCLKCFG_USEPLL (1 << 28)
#define LM4_SYSTEM_RSCLKCFG_NEWFREQ (1 << 30)
#define LM4_SYSTEM_DSCLKCFG    REG32(0x400fe144)
#define LM4_SYSTEM_SYSPROP     REG32(0x400fe14c)
#define LM4_SYSTEM_PIOSCCAL    REG32(0x400fe150)
#define LM4_SYSTEM_PIOSCSTAT   REG32(0x400fe154)
#define LM4_SYSTEM_PLLFREQ0    REG32(0x400fe160)
#define LM4_SYSTEM_PLLFREQ0_PLLWPR (1 << 23)
#define LM4_SYSTEM_PLLFREQ1    REG32(0x400fe164)
#define LM4_SYSTEM_LDOPCAL     REG32(0x400fe1b0)
#define LM4_SYSTEM_SDPMST      REG32(0x400fe1cc)
#define LM4_SYSTEM_RESBEHAVCTL REG32(0x400fe1d8)
#define LM4_SYSTEM_LPCPDS      REG32(0x400fe2b8)
#define LM4_SYSTEM_LPCMPC      REG32(0x400fe2bc)
#define LM4_SYSTEM_PPWD        REG32(0x400fe300)
#define LM4_SYSTEM_PPTIMER     REG32(0x400fe304)
#define LM4_SYSTEM_PPGPIO      REG32(0x400fe308)
#define LM4_SYSTEM_PPDMA       REG32(0x400fe30c)
#define LM4_SYSTEM_PPEPI       REG32(0x400fe310)
#define LM4_SYSTEM_PPHIB       REG32(0x400fe314)
#define LM4_SYSTEM_PPUART      REG32(0x400fe318)
#define LM4_SYSTEM_PPSSI       REG32(0x400fe31c)
#define LM4_SYSTEM_PPI2C       REG32(0x400fe320)
#define LM4_SYSTEM_PPUSB       REG32(0x400fe328)
#define LM4_SYSTEM_PPCAN       REG32(0x400fe334)
#define LM4_SYSTEM_PPADC       REG32(0x400fe338)
#define LM4_SYSTEM_PPACMP      REG32(0x400fe33c)
#define LM4_SYSTEM_PPPWM       REG32(0x400fe340)
#define LM4_SYSTEM_PPQEI       REG32(0x400fe344)
#define LM4_SYSTEM_PPLPC       REG32(0x400fe348)
#define LM4_SYSTEM_PPPECI      REG32(0x400fe350)
#define LM4_SYSTEM_PPFAN       REG32(0x400fe354)
#define LM4_SYSTEM_PPEEPROM    REG32(0x400fe358)
#define LM4_SYSTEM_PPWTIMER    REG32(0x400fe35c)
#define LM4_SYSTEM_PPRTS       REG32(0x400fe370)
#define LM4_SYSTEM_PPOWIRE     REG32(0x400fe398)
#define LM4_SYSTEM_PPEMAC      REG32(0x400fe39c)
#define LM4_SYSTEM_PPPRB       REG32(0x400fe3a0)
#define LM4_SYSTEM_PPHIM       REG32(0x400fe3a4)
#define LM4_SYSTEM_SRWD        REG32(0x400fe500)
#define LM4_SYSTEM_SRTIMER     REG32(0x400fe504)
#define LM4_SYSTEM_SRGPIO      REG32(0x400fe508)
#define LM4_SYSTEM_SRDMA       REG32(0x400fe50c)
#define LM4_SYSTEM_SRHIB       REG32(0x400fe514)
#define LM4_SYSTEM_SRUART      REG32(0x400fe518)
#define LM4_SYSTEM_SRSSI       REG32(0x400fe51c)
#define LM4_SYSTEM_SRI2C       REG32(0x400fe520)
#define LM4_SYSTEM_SRADC       REG32(0x400fe538)
#define LM4_SYSTEM_SRACMP      REG32(0x400fe53c)
#define LM4_SYSTEM_SRLPC       REG32(0x400fe548)
#define LM4_SYSTEM_SRPECI      REG32(0x400fe550)
#define LM4_SYSTEM_SRFAN       REG32(0x400fe554)
#define LM4_SYSTEM_SROWIRE     REG32(0x400fe598)
#define LM4_SYSTEM_SRHIM       REG32(0x400fe5a4)
...
#define LM4_SYSTEM_RCGCACMP    REG32(0x400fe63c)
...
#define LM4_SYSTEM_RCGCOWIRE   REG32(0x400fe698)
#define LM4_SYSTEM_RCGCHIM     REG32(0x400fe6a4)
#define LM4_SYSTEM_SCGCWD      REG32(0x400fe700)
#define LM4_SYSTEM_SCGCTIMER   REG32(0x400fe704)
#define LM4_SYSTEM_SCGCGPIO    REG32(0x400fe708)
#define LM4_SYSTEM_SCGCHIB     REG32(0x400fe714)
#define LM4_SYSTEM_SCGCUART    REG32(0x400fe718)
#define LM4_SYSTEM_SCGCSSI     REG32(0x400fe71c)
#define LM4_SYSTEM_SCGCI2C     REG32(0x400fe720)
#define LM4_SYSTEM_SCGCADC     REG32(0x400fe738)
#define LM4_SYSTEM_SCGCACMP    REG32(0x400fe73c)
#define LM4_SYSTEM_SCGCLPC     REG32(0x400fe748)
#define LM4_SYSTEM_SCGCPECI    REG32(0x400fe750)
#define LM4_SYSTEM_SCGCFAN     REG32(0x400fe754)
#define LM4_SYSTEM_SCGCOWIRE   REG32(0x400fe798)
#define LM4_SYSTEM_SCGCHIM     REG32(0x400fe7a4)
#define LM4_SYSTEM_DCGCWD      REG32(0x400fe800)
#define LM4_SYSTEM_DCGCTIMER   REG32(0x400fe804)
#define LM4_SYSTEM_DCGCGPIO    REG32(0x400fe808)
#define LM4_SYSTEM_DCGCHIB     REG32(0x400fe814)
#define LM4_SYSTEM_DCGCUART    REG32(0x400fe818)
#define LM4_SYSTEM_DCGCSSI     REG32(0x400fe81c)
#define LM4_SYSTEM_DCGCI2C     REG32(0x400fe820)
#define LM4_SYSTEM_DCGCADC     REG32(0x400fe838)
#define LM4_SYSTEM_DCGCACMP    REG32(0x400fe83c)
#define LM4_SYSTEM_DCGCLPC     REG32(0x400fe848)
#define LM4_SYSTEM_DCGCPECI    REG32(0x400fe850)
#define LM4_SYSTEM_DCGCFAN     REG32(0x400fe854)
#define LM4_SYSTEM_DCGCOWIRE   REG32(0x400fe898)
#define LM4_SYSTEM_DCGCHIM     REG32(0x400fe8a4)
#define LM4_SYSTEM_PRWD        REG32(0x400fea00)
#define LM4_SYSTEM_PRTIMER     REG32(0x400fea04)
#define LM4_SYSTEM_PRGPIO      REG32(0x400fea08)
#define LM4_SYSTEM_PRDMA       REG32(0x400fea0c)
#define LM4_SYSTEM_PRHIB       REG32(0x400fea14)
#define LM4_SYSTEM_PRUART      REG32(0x400fea18)
#define LM4_SYSTEM_PRSSI       REG32(0x400fea1c)
#define LM4_SYSTEM_PRI2C       REG32(0x400fea20)
#define LM4_SYSTEM_PRADC       REG32(0x400fea38)
#define LM4_SYSTEM_PRACMP      REG32(0x400fea3c)
#define LM4_SYSTEM_PRLPC       REG32(0x400fea48)
#define LM4_SYSTEM_PRPECI      REG32(0x400fea50)
#define LM4_SYSTEM_PRFAN       REG32(0x400fea54)
#define LM4_SYSTEM_PROWIRE     REG32(0x400fea98)
#define LM4_SYSTEM_PRHIM       REG32(0x400feaa4)
