...
static int command_i2c(int argc, char **argv)
{
	...
	switch (rw) {
	case 0:
		rv = i2c_read8(I2C_PORT_BATTERY, slave_addr, offset, &value);
		break;
	case 1:
		/*rv = i2c_read16(I2C_PORT_BATTERY, slave_addr, offset, &value);*/
		rv = i2c_read8(I2C_PORT_BATTERY, slave_addr, offset, &value) |
		     i2c_read8(I2C_PORT_BATTERY, slave_addr, offset+1, &value2);
		value = (value << 8) + value2;
		break;
	case 2:
		rv = i2c_write8(I2C_PORT_BATTERY, slave_addr, offset, value);
		break;
	case 3:
		rv = i2c_write16(I2C_PORT_BATTERY, slave_addr, offset, value);
		break;
	}
...
DECLARE_CONSOLE_COMMAND(i2ccmd, command_i2c,
