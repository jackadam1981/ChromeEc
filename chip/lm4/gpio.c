...
{
	switch (gpio_port) {
	case LM4_GPIO_A: return 0x0001;
	case LM4_GPIO_B: return 0x0002;
	case LM4_GPIO_C: return 0x0004;
	case LM4_GPIO_D: return 0x0008;
	case LM4_GPIO_E: return 0x0010;
	case LM4_GPIO_F: return 0x0020;
	case LM4_GPIO_G: return 0x0040;
	case LM4_GPIO_H: return 0x0080;
	case LM4_GPIO_J: return 0x0100;
	case LM4_GPIO_K: return 0x0200;
	case LM4_GPIO_L: return 0x0400;
	case LM4_GPIO_M: return 0x0800;
	case LM4_GPIO_N: return 0x1000;
	case LM4_GPIO_P: return 0x2000;
	case LM4_GPIO_Q: return 0x4000;
...
void gpio_pre_init(void)
{
	...
	clock_enable_peripheral(CGC_OFFSET_GPIO,
				gpio_port_to_clock_gate_mask(LM4_GPIO_K),
				CGC_MODE_ALL);
#else
