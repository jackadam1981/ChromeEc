...
*      Supported from ISH2
*****************************************************************************/
uint32_t heci_send(const uint32_t handle, const mrd_t *message);
...
*      Supported from ISH2
*****************************************************************************/
uint32_t heci_dma_get (uint32_t handle, const uint64_t buffer, uint32_t buffer_size);
...
uint32_t heci_send_single_fragment (
	uint8_t host_addr,
	uint8_t ish_addr,
	bool last_fragment,
	uint8_t * data,
