...
hid_handle_t elantp_hid_handle;
...
int elantp_initialize(hid_handle_t handle)
{
	elantp_hid_handle = handle;
...
int elantp_get_hid_descriptor(hid_handle_t handle, uint8_t *buf, size_t buf_size)
{
...
int elantp_get_report_descriptor(hid_handle_t handle, uint8_t *buf, size_t buf_size)
{
...
int elantp_get_feature_report(hid_handle_t handle, uint8_t report_id, uint8_t *buf,
			     size_t buf_size)
{
...
int elantp_set_feature_report(hid_handle_t handle, uint8_t report_id,
...
int elantp_get_input_report(hid_handle_t handle, uint8_t report_id,
