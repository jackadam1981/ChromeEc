...
#define HECI_ERR_INVALID_ARGS			-2
#define HECI_ERR_TOO_BIG_MSG_SIZE		-3
#define HECI_ERR_TOO_MANY_MSG_ITEMS		-4
#define HECI_ERR_NO_CRED_FROM_CLIENT_IN_HOST	-5
#define HECI_ERR_CLIENT_IS_NOT_CONNECTED	-6
