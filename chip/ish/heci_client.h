...
struct heci_client_callbacks {
	int (*initialize)(heci_handle_t handle);
	void (*new_msg_received)(heci_handle_t handle, uint8_t *msg,
				 uint32_t msg_size);
	void (*disconnected)(heci_handle_t handle);

	int (*suspend)(heci_handle_t);
	int (*resume)(heci_handle_t);
};
