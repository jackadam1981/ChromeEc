...
unsigned char speed_val_arr[] = {
	STD_SPEED_VAL, FAST_SPEED_VAL, HIGH_SPEED_VAL };

const uint8_t mask_arr[] = { ENABLE_READ_INT, ENABLE_WRITE_INT };
