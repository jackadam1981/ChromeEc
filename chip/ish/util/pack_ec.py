...
# Based on 607297_Host_ISH_Firmware_Load_Chrome_OS_SAS_Rev0p5.pdf and
...
def gen_manifest(ext_id, code_offset, module_size):
...
def main():
  ...
  with open(args.output, 'wb') as f:
    ...
    f.write(gen_manifest('ISHM', HEADER_SIZE, args.image_size))
