...
#define IRQ_TO_VEC(irq)  ((irq == ISH_IPC_HOST2ISH_IRQ) ? 0xe0 : ((irq == ISH_IPC_ISH2HOST_CLR_IRQ) ? 0xe1 : ((irq) + USER_VEC_START + 10)))
#define VEC_TO_IRQ(vec)  ((vec == 0xe0) ? ISH_IPC_HOST2ISH_IRQ : ((vec == 0xe1) ? ISH_IPC_ISH2HOST_CLR_IRQ : ((vec) - USER_VEC_START - 10)))
