...
#define MISC_CHID_CFG_REG        REG32(DMA_REG_BASE + DMA_MISC_OFFSET + 0x400)
#define MISC_DMA_CTL_REG(ch)     REG32(DMA_REG_BASE + DMA_MISC_OFFSET + (4 * (ch)))
#define MISC_SRC_FILLIN_DMA(ch)  REG32(DMA_REG_BASE + DMA_MISC_OFFSET + 0x100 + (4 * (ch)))
#define MISC_DST_FILLIN_DMA(ch)  REG32(DMA_REG_BASE + DMA_MISC_OFFSET + 0x200 + (4 * (ch)))
#define MISC_ISH_ECC_ERR_SRESP   REG32(DMA_REG_BASE + DMA_MISC_OFFSET + 0x404)
#endif
