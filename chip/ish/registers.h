...
#define ISH_GPIO_PORT_0 0

/* Chip-independent aliases for port base group */
#define GPIO_0 ISH_GPIO_PORT_0
#define DUMMY_GPIO_BANK ISH_GPIO_PORT_0
...
#define ISH_WDT_CTL_T1 0xFF          /* T1 state value, count from 255 */
#define ISH_WDT_CTL_T2 (0xFF << 8)   /* T2 state value, count from 255 */
#define ISH_WDT_RL_VAL  (1 << 0)
