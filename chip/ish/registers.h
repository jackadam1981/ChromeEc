...
#define IPC_UMA_RANGE_LOWER_0      (ISH_IPC_BASE + 0x380)
#define IPC_UMA_RANGE_LOWER_1      (ISH_IPC_BASE + 0x384)
#define IPC_UMA_RANGE_UPPER_0      (ISH_IPC_BASE + 0x388)
#define IPC_UMA_RANGE_UPPER_1      (ISH_IPC_BASE + 0x38C)
...
#define OCP_AGENT_CONTROL        (OCP_IOSF2OCP_BRIDGE + 0x20)
#define OCP_RESPONSE_TO_DISABLE  0xFFFFF8FF

/* MISC registers */
#define MISC_REG_BASE            ISH_MISC_BASE
#define MISC_CHID_CFG_REG        (MISC_REG_BASE + 0x40)
#define MISC_DMA_CTL_REG(ch)     (MISC_REG_BASE + (4 * (ch)))
#define MISC_SRC_FILLIN_DMA(ch)  (MISC_REG_BASE + 0x20 + (4 * (ch)))
#define MISC_DST_FILLIN_DMA(ch)  (MISC_REG_BASE + 0x80 + (4 * (ch)))
...
#define DMA_EN_REG                    (DMA_REG_BASE + 0x3A0)
