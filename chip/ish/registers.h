...
#define IPC_ISH2HOST_MSG_REGS		REG8(ISH_IPC_BASE + 0x60)
#define IPC_ISH_FWSTS			REG32(ISH_IPC_BASE + 0x34)
#define IPC_HOST2ISH_DOORBELL		REG32(ISH_IPC_BASE + 0x48)
#define IPC_HOST2ISH_MSG_REGS		REG8(ISH_IPC_BASE + 0xE0)
#define IPC_ISH2HOST_DOORBELL		REG32(ISH_IPC_BASE + 0x54)
