...
#define PMU_MASK_EVENT2_SRAM_ERASE1 (1 << 3)
#define PMU_MASK_EVENT2_SRAM_ERASE0 (1 << 4)
#define PMU_MASK_EVENT2_ISOL_ACK_RISE (1 << 14)
#define PMU_MASK_EVENT2_ISOL_ACK_FALL (1 << 15)
#define PMU_MASK_EVENT2_HOST_RST_RISE (1 << 16)
#define PMU_MASK_EVENT2_HOST_RST_FALL (1 << 17)
