...
#define ISH_IPC_HOST2ISH_VEC       IRQ_TO_VEC(ISH_IPC_HOST2ISH_IRQ)
...
#define IPC_ISH_MINIMA_FWSTS       (ISH_IPC_BASE + 0x34)
...
#define IPC_PEER12ISH_MSG_REGS     (ISH_IPC_BASE + 0xE0)
#define IPC_PEER12ISH_DOORBELL     (ISH_IPC_BASE + 0x48)
#define IPC_ISH2PEER1_MSG_REGS     (ISH_IPC_BASE + 0x60)
#define IPC_ISH2PEER1_DOORBELL     (ISH_IPC_BASE + 0x54)
