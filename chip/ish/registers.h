...
#else
#define PMU_STATUS_REG			(ISH_PMU_BASE + 0xF00)
#define PMU_SCRATCHPAD0_REG		(ISH_PMU_BASE + 0xF04)
#define PMU_SCRATCHPAD1_REG		(ISH_PMU_BASE + 0xF08)
#define PMU_PG_EN_REG			(ISH_PMU_BASE + 0xF10)
...
#define PMU_STATUS_PG			(1 << 4)
#define PMU_STATUS_PG_AON		(1 << 5)
#define PMU_PG_EN			(1 << 0)
#define PMU_PG_EXIT_COMPLETE		(1 << 8)
