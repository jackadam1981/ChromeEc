...
/* PMU Registers */
#define PMU_VNN_REQ		(ISH_PMU_BASE + 0x3c)
#define VNN_REQ3_IPC_HOST_W		(1 << 3)  /* VNN IPC host write req */
#define VNN_REQ16_IPC_HOST_LONG_UP	(1 << 16)

#define PMU_VNN_REQ_ACK		(ISH_PMU_BASE + 0x40)
