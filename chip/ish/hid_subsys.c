...
static void hid_subsys_new_msg_received(heci_handle_t handle, uint8_t *msg,
				 uint32_t msg_size)
{
...
static int hid_subsys_initialize(heci_handle_t handle)
{
...
static int hid_subsys_resume(heci_handle_t handle)
{
	int i, ret = 0;
...
static int hid_subsys_suspend(heci_handle_t handle)
{
	int i, ret = 0;
