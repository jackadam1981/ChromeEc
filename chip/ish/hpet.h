...
#define MAIN_COUNTER_LOW_REG		0xF0
#define MAIN_COUNTER_HIGH_REG		0xF4
...
#define HPET_MAIN_COUNTER	REG32(ISH_HPET_BASE + MAIN_COUNTER_LOW_REG)
#define HPET_MAIN_COUNTER_HIGH	REG32(ISH_HPET_BASE + MAIN_COUNTER_HIGH_REG)
