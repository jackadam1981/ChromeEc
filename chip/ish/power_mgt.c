...
#define ISH_SUPPORT_TCG
/*
* pm_d0i1:
* This function performs the necessary preparations to enter d0i1.
* Configuring CCU for trunk clock gating
* or block clock dating
*/
static int pm_d0i1(void)
{
#if defined(ISH_SUPPORT_TCG)
	REG32(CCU_TRUNK_CG) = CCU_TRUNK_CG_EN;
#else
	REG32(CCU_BLOCK_CG) = (CCU_BLOCK_CG_ALL & ~(CCU_BLOCK_CG_HPET));
#endif
	/* TODO: wdt_disable(); */
...
/* TODO:
static int pm_d0i2(void){}
static int pm_d0i3(void){}
*/
...
void pm_init(void)
{
	...
	REG32(CCU_RST_HST) = REG32(CCU_RST_HST); /* Write Clear */
	...
	REG32(PMU_ISH_FABRIC_CNT) =
		(REG32(PMU_ISH_FABRIC_CNT) & 0xffff0000) | 50;
