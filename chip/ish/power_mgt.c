...
extern uint32_t __ro_start;
extern uint32_t __ro_end;
extern uint32_t __rw_start;
extern uint32_t __rw_end;
...
static void init_aon_task(void)
{
	...
	aon_share->main_fw_ro_addr = (uint32_t)&__ro_start;
	aon_share->main_fw_ro_size = (uint32_t)&__ro_end -
				     (uint32_t)&__ro_start;

	aon_share->main_fw_rw_addr = (uint32_t)&__rw_start;
	aon_share->main_fw_rw_size = (uint32_t)&__rw_end -
				     (uint32_t)&__rw_start;
