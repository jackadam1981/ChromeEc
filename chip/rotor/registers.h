...
#define ROTOR_MCU_IPC_HOST_EVENT (1 << 8)
...
/* PMU Misc */
#define ROTOR_MCU_PMU_MISC_BASE		0xEF002800
#define ROTOR_MCU_AP_ISOLATE		REG32(ROTOR_MCU_PMU_MISC_BASE + 0x05C)
#define ROTOR_MCU_EFUSE_PWR_CTL		REG32(ROTOR_MCU_PMU_MISC_BASE + 0x060)
...
struct rotor_mcu_dma_regs {
	...
	uint32_t params;
	uint32_t pad[0x24];	/* Pad to offset 0x100 */
