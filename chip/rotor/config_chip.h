 ...
 * - The lower 256KB is reserved for the image.
 * - The upper 128KB is reserved for RAM.
 */
...
#define CONFIG_RAM_SIZE		(ROTOR_MCU_SRAM_END - \
					 ROTOR_MCU_SRAM_BASE - CONFIG_RW_SIZE)
...
#define CONFIG_RW_SIZE			(2 * 0x20000)
