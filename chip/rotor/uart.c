...
void uart_init(void)
{
	...
	/* Set divisor for baud rate.  UART clk is 200MHz. */
	divisor = 200000000 / (16 * CONFIG_UART_BAUD_RATE);
	...
	/* Enable Received Data Avaiable Interrupt. */
...
int uart_tx_ready(void)
{
	...
	return (ROTOR_MCU_UART_USR(0) & (1 << 1));
...
int uart_rx_available(void)
{
	...
	return (ROTOR_MCU_UART_USR(0) & (1 << 3));
}
