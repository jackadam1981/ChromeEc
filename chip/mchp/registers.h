...
/* (VBatt Controller Interface) VCI subsystem */
#define MCHP_VCI_BASE		0x4000ae00
#define MCHP_VCI_VCIREG		REG32(MCHP_VCI_BASE + 0x00)
#define MCHP_VCI_LATCH_EN	REG32(MCHP_VCI_BASE + 0x04)
#define MCHP_VCI_LATCH_RST	REG32(MCHP_VCI_BASE + 0x08)
#define MCHP_VCI_INPUT_EN	REG32(MCHP_VCI_BASE + 0x0c)
#define MCHP_VCI_HOLDOFF_CNT	REG32(MCHP_VCI_BASE + 0x10)
#define MCHP_VCI_POLARITY	REG32(MCHP_VCI_BASE + 0x14)
#define MCHP_VCI_POSEDGE_DET	REG32(MCHP_VCI_BASE + 0x18)
#define MCHP_VCI_NEGEDGE_DET	REG32(MCHP_VCI_BASE + 0x1c)
#define MCHP_VCI_BUFFER_EN	REG32(MCHP_VCI_BASE + 0x20)

#define MCHP_VCI_VCIREG_FW_CNTRL	BIT(10)
#define MCHP_VCI_VCIREG_FW_EXT		BIT(11)

#define MCHP_VCI_POLARITY_IN0_POS_EDGE	BIT(0)

#define MCHP_VCI_LATCH_IN0_EN		BIT(0)
