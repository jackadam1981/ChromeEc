...
#define MCHP_ESPI_CAP1_MAX_FREQ_20M	BIT(0)
#define MCHP_ESPI_CAP1_MAX_FREQ_25M	BIT(1)
#define MCHP_ESPI_CAP1_MAX_FREQ_33M	BIT(2)
#define MCHP_ESPI_CAP1_MAX_FREQ_50M	BIT(3)
#define MCHP_ESPI_CAP1_MAX_FREQ_66M	BIT(4)
#define MCHP_ESPI_CAP1_SINGLE_MODE	BIT(0)
#define MCHP_ESPI_CAP1_SINGLE_DUAL_MODE	BIT(1)
#define MCHP_ESPI_CAP1_SINGLE_QUAD_MODE	BIT(2)
