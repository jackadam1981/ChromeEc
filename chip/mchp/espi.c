...
/* Set default to maximum frequency */
...
#if CONFIG_HOSTCMD_ESPI_EC_MAX_FREQ == 20
	MCHP_ESPI_IO_CAP1 |= MCHP_ESPI_CAP1_MAX_FREQ_20M;
#elif CONFIG_HOSTCMD_ESPI_EC_MAX_FREQ == 25
...
/* Config PLTRST SRC as Virtual wire */
