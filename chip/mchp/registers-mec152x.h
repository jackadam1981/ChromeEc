...
#define MCHP_INT15_P80_			BIT(22)
#define MCHP_INT15_P801			BIT(23)
#define MCHP_INT15_P8(x)		BIT(22 + ((x) & 0x01U))
...
#define MCHP_INT19_ESPI_LT		BIT(3)
#define MCHP_INT19_ESPI_OB_TX		BIT(4)
...
#define MCHP_INT22_WAKE_ONL_I2C7	BIT(8)
...
#define MCHP_ESPI_IO_BAR_P80_1		0x1
