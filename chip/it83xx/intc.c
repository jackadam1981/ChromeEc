...
static void __keep intc_cpu_int_group_5(void)
{
...
static void __keep intc_cpu_int_group_4(void)
{
	/* Determine interrupt number. */
...
static void __keep intc_cpu_int_group_12(void)
{
	/* Determine interrupt number. */
...
static void __keep intc_cpu_int_group_7(void)
{
	/* Determine interrupt number. */
...
static void __keep intc_cpu_int_group_6(void)
{
	/* Determine interrupt number. */
