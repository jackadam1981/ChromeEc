...
#define USBPD_GET_PULL_REGISTER_SELECTION(port) \
	((IT83XX_USBPD_CCGCR(port) >> 1) & 0x1)
...
#define USBPD_IS_TIMEOUT(port)           \
	IS_MASK_SET(IT83XX_USBPD_ISR(port), USBPD_REG_MASK_TIMER_TIMEOUT)
