...
#define NDS32_ILM1_ADDR_START ((uint32_t) & __nds32_ilm1_ram_code)
...
enum dlm_address_view {
	...
	SCAR1_ILM1_DLM11 = 0x8B000, /* DLM ~ 0x8BFFF ilm1 (ram 44K ~ 48K) */
...
static void flash_enable_second_ilm(void)
{
	...
	IT83XX_SMFI_SCAR1H = 0x08;
	/* Enable DLM 44k~48k region and than copy data into it */
	IT83XX_GCTRL_MCCR2 |= BIT(2);
	memcpy((void *)CHIP_ILM1_RAM_BASE, (const void *)NDS32_ILM1_ADDR_START,
	       IT83XX_ILM_BLOCK_SIZE);
	/* Disable DLM 44k~48k region and be the ram code section */
	IT83XX_GCTRL_MCCR2 &= ~BIT(2);
	/* Enable ILM1 */
	IT83XX_SMFI_SCAR1L = NDS32_ILM1_ADDR_START & 0xFF;
	IT83XX_SMFI_SCAR1M = (NDS32_ILM1_ADDR_START >> 8) & 0xFF;
	IT83XX_SMFI_SCAR1H = (NDS32_ILM1_ADDR_START >> 16) & 0x0F;
	/*
	 * Validate Direct-map SRAM function by programming
	 * register SCARx bit20=0
	 */
	IT83XX_SMFI_SCAR1H &= ~0x10;
#endif
	interrupt_enable();
}
