...
const struct dlm_ilm_ctrl_t dlm_ilm_ctrl_regs[] = {
	...
	[4] = { &IT83XX_SMFI_SCAR8L, &IT83XX_SMFI_SCAR8M,
		&IT83XX_SMFI_SCAR8H, &IT83XX_GCTRL_MCCR1, BIT(2) },
	[5] = { &IT83XX_SMFI_SCAR9L, &IT83XX_SMFI_SCAR9M,
		&IT83XX_SMFI_SCAR9H, &IT83XX_GCTRL_MCCR1, BIT(3) },
	[6] = { &IT83XX_SMFI_SCAR3L, &IT83XX_SMFI_SCAR3M,
		&IT83XX_SMFI_SCAR3H, &IT83XX_GCTRL_MCCR1, BIT(4) },
	[7] = { &IT83XX_SMFI_SCAR4L, &IT83XX_SMFI_SCAR4M,
		&IT83XX_SMFI_SCAR4H, &IT83XX_GCTRL_MCCR1, BIT(5) },
	[8] = { &IT83XX_SMFI_SCAR5L, &IT83XX_SMFI_SCAR5M,
		&IT83XX_SMFI_SCAR5H, &IT83XX_GCTRL_MCCR1, BIT(6) },
	[9] = { &IT83XX_SMFI_SCAR6L, &IT83XX_SMFI_SCAR6M,
		&IT83XX_SMFI_SCAR6H, &IT83XX_GCTRL_MCCR2, BIT(0) },
	[10] = { &IT83XX_SMFI_SCAR7L, &IT83XX_SMFI_SCAR7M,
		&IT83XX_SMFI_SCAR7H, &IT83XX_GCTRL_MCCR2, BIT(1) },
	[11] = { &IT83XX_SMFI_SCAR1L, &IT83XX_SMFI_SCAR1M,
		&IT83XX_SMFI_SCAR1H, &IT83XX_GCTRL_MCCR2, BIT(2) },
};
...
static void flash_enable_second_ilm(void)
{
	...
	for (int i = 0; i < ilm_block; i++) {
		...
		*dlm_ilm_ctrl_regs[dlm_base_idx].scar_m =
			(ilm_base >> 8) & 0xff;
		*dlm_ilm_ctrl_regs[dlm_base_idx].scar_h =
			(ilm_base >> 16) & 0x0f;
		/*
