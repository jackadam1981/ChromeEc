...
static void pwm_init(void)
{
	...
	/*
	 * The cycle timer1 of chip 81202 improve from 8bits to 10bits
	 * resolution, and others are still 8bit resolution. Because the
	 * cycle timer1 high byte default value is not zero, we clear cycle
	 * timer1 high byte at init and use it as 8-bit resolution like others.
	 */
	IT83XX_PWM_CTR1M = 0;
