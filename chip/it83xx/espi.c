...
/* eSPI cycle type field table */
const char espi_cycle_type_table[] = { [ESPI_FLASH_READ_CYCLE_TYPE] = 0x8,
					[ESPI_FLASH_WRITE_CYCLE_TYPE] = 0x9,
					[ESPI_FLASH_ERASE_CYCLE_TYPE] = 0xA,
					[ESPI_OOB_CYCLE_TYPE] = 0x7 };
#endif
