...
static const struct vw_interrupt_t vw_isr_list[CHIP_ESPI_VW_INTERRUPT_NUM] = {
	{espi_vw_idx2_isr,  ESPI_VW_INDEX(2)},
	{espi_vw_idx3_isr,  ESPI_VW_INDEX(3)},
	{espi_vw_idx7_isr,  ESPI_VW_INDEX(7)},
	{espi_vw_idx41_isr, ESPI_VW_INDEX(0x41)},
	{espi_vw_no_isr,    ESPI_VW_INDEX(0x42)},
	{espi_vw_no_isr,    ESPI_VW_INDEX(0x43)},
	{espi_vw_no_isr,    ESPI_VW_INDEX(0x44)},
	{espi_vw_no_isr,    ESPI_VW_INDEX(0x47)},
};
