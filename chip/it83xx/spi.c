...
#define EC_SPI_HOST_REQ_DATA_SIZE 12
#define EC_SPI_CAPTURE_DATA_LENGTH 0x06
...
static void spi_init(void)
{
	 ...
	 */
	IT83XX_SPI_FTCB1R = (EC_SPI_HOST_REQ_DATA_SIZE >> 8) & 0xff;
	IT83XX_SPI_FTCB0R = EC_SPI_HOST_REQ_DATA_SIZE & 0xff;
	/*
	 * The register setting can capture the data length of host requested
	 * data at 7th and 8th byte.
	 */
	IT83XX_SPI_TCCB1 = (EC_SPI_CAPTURE_DATA_LENGTH >> 8) & 0xff;
	IT83XX_SPI_TCCB0 = EC_SPI_CAPTURE_DATA_LENGTH & 0xff;
#else
