...
#define PECI_TARGE_ADDRESS          0x30
				...
				int timeout_us)
{
	...
	if (w_len > PECI_WRITE_DATA_FIFO_SIZE)
		w_len = PECI_WRITE_DATA_FIFO_SIZE;
	...
	if (r_len > PECI_READ_DATA_FIFO_SIZE)
		r_len = PECI_READ_DATA_FIFO_SIZE;
...
int peci_get_cpu_temp(void)
{
	...
	if (peci_transaction(PECI_TARGE_ADDRESS,
