...
static const struct {
	...
	[IT83XX_IRQ_WKO25] =    {GPIO_Q, BIT(0),        2, BIT(5)},
#endif
#ifdef IT83XX_GPIO_INT_FLEXIBLE
	...
	[IT83XX_IRQ_WKO134] =   {GPIO_J, BIT(6),        14, BIT(5)},
...
static const struct gpio_1p8v_t gpio_1p8v_sel[GPIO_PORT_COUNT][8] = {
	...
	[GPIO_M] = { [0] = {&IT83XX_GPIO_GCR30, BIT(4)},
		     [1] = {&IT83XX_GPIO_GCR30, BIT(4)},
		     [2] = {&IT83XX_GPIO_GCR30, BIT(4)},
		     [3] = {&IT83XX_GPIO_GCR30, BIT(4)},
		     [4] = {&IT83XX_GPIO_GCR30, BIT(4)},
		     [5] = {&IT83XX_GPIO_GCR30, BIT(4)},
		     [6] = {&IT83XX_GPIO_GCR30, BIT(4)} }, /* bit4 ctrl all */
#if defined(CHIP_FAMILY_IT8XXX1) || defined(CHIP_FAMILY_IT8XXX2)
