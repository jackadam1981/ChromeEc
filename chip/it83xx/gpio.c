...
#error "ITE pd active port count should be less than physical port count !"
	...
	/*
	 * The GPIOH7 does not utilize in IT81202/IT81302 and is left floating
	 * internally. We need to enable internal pull-down for the pin to
	 * prevent leakage current, but IT81202/IT81302 doesn't have the
