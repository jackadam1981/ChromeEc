...
/* USBPD addr */
#define USBPD_GCR(Port)  ECReg(USBPD_BASE(Port) + 0x0)
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
...
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
#define PDMSR(Port)      ECReg(USBPD_BASE(Port) + 0x01)
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
#define SOPPP_ENABLE   BIT7
#define SOPP_ENABLE    BIT6
#define SOP_ENABLE     BIT5
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
#define PDCSR(Port)     ECReg(USBPD_BASE(Port) + 0x02)
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
#define VCONN_ENABLE          BIT2
#define ACTIVE_MODE_ENABLE    BIT1
#define VBUS_STAT_5V_ENABLE   BIT0
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
#define PEPDRSR(Port)     ECReg(USBPD_BASE(Port) + 0x03)
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
#define USBPD_CC_BUSY       BIT4
#define USBPD_ROLE_DATA     BIT1
#define USBPD_ROLE_POWER    BIT0
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
#define CCGCR(Port)     ECReg(USBPD_BASE(Port) + 0x04)
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
#define USBPD_DISABLE_CC    BIT4
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
#define CCCSR(Port)     ECReg(USBPD_BASE(Port) + 0x05)
#define CCPSR(Port)     ECReg(USBPD_BASE(Port) + 0x06)
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
#define USBPD_DISCONNECT_POWER_CC2    BIT5
#define USBPD_DISCONNECT_POWER_CC1    BIT1
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/

#define DFPVDR(Port)     ECReg(USBPD_BASE(Port) + 0x08)
#define UFPVDR(Port)     ECReg(USBPD_BASE(Port) + 0x09)
#define CCADCR(Port)     ECReg(USBPD_BASE(Port) + 0x0C)
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
...
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
#define CCADIR(Port)     ECReg(USBPD_BASE(Port) + 0x0D)
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
...
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
#define CCADRR(Port)     ECReg(USBPD_BASE(Port) + 0x0E)
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
...
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
#define CCADIMR(Port)     ECReg(USBPD_BASE(Port) + 0x0F)
#define TSR0_OFFSET(Port)     (USBPD_BASE(Port) + 0x10)
#define TSR0(Port)     ECReg(USBPD_BASE(Port) + 0x10)
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
...
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
#define TSR1(Port)     ECReg(USBPD_BASE(Port) + 0x11)
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
...
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
#define TIMR0(Port)     ECReg(USBPD_BASE(Port) + 0x12)
#define TIMR1(Port)     ECReg(USBPD_BASE(Port) + 0x13)
#define USBPD_ISR(Port)     ECReg(USBPD_BASE(Port) + 0x14)
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
...
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
#define IMR(Port)     ECReg(USBPD_BASE(Port) + 0x15)
#define MTCR(Port)     ECReg(USBPD_BASE(Port) + 0x18)
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
...
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
#define MTSR0(Port)     ECReg(USBPD_BASE(Port) + 0x19)
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
#define USBPD_CABLE_ENABLE            BIT7
#define USBPD_SEND_HW_RESET           BIT6
#define USBPD_SEND_BIST_MODE_2        BIT5
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
#define MTSR1(Port)     ECReg(USBPD_BASE(Port) + 0x1A)
#define VDMMCSR(Port)     ECReg(USBPD_BASE(Port) + 0x1B)
#define MRSR(Port)     ECReg(USBPD_BASE(Port) + 0x1C)
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
#define USBPD_RX_MSG_VALID            BIT0
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
#define PEFSMR(Port)     ECReg(USBPD_BASE(Port) + 0x1D)
#define PES0R(Port)      ECReg(USBPD_BASE(Port) + 0x1E)
#define PES1R(Port)      ECReg(USBPD_BASE(Port) + 0x1F)
#define TDO_BASE(Port)   (USBPD_BASE(Port) + 0x20)
#define TDO0R0(Port)     ECReg(USBPD_BASE(Port) + 0x20)
#define TDO0R1(Port)     ECReg(USBPD_BASE(Port) + 0x21)
#define TDO0R2(Port)     ECReg(USBPD_BASE(Port) + 0x22)
#define TDO0R3(Port)     ECReg(USBPD_BASE(Port) + 0x23)
#define TDO1R0(Port)     ECReg(USBPD_BASE(Port) + 0x24)
#define TDO1R1(Port)     ECReg(USBPD_BASE(Port) + 0x25)
#define TDO1R2(Port)     ECReg(USBPD_BASE(Port) + 0x26)
#define TDO1R3(Port)     ECReg(USBPD_BASE(Port) + 0x27)
#define TDO2R0(Port)     ECReg(USBPD_BASE(Port) + 0x28)
#define TDO2R1(Port)     ECReg(USBPD_BASE(Port) + 0x29)
#define TDO2R2(Port)     ECReg(USBPD_BASE(Port) + 0x2A)
#define TDO2R3(Port)     ECReg(USBPD_BASE(Port) + 0x2B)
#define TDO3R0(Port)     ECReg(USBPD_BASE(Port) + 0x2C)
#define TDO3R1(Port)     ECReg(USBPD_BASE(Port) + 0x2D)
#define TDO3R2(Port)     ECReg(USBPD_BASE(Port) + 0x2E)
#define TDO3R3(Port)     ECReg(USBPD_BASE(Port) + 0x2F)
#define TDO4R0(Port)     ECReg(USBPD_BASE(Port) + 0x30)
#define TDO4R1(Port)     ECReg(USBPD_BASE(Port) + 0x31)
#define TDO4R2(Port)     ECReg(USBPD_BASE(Port) + 0x32)
#define TDO4R3(Port)     ECReg(USBPD_BASE(Port) + 0x33)
#define TDO5R0(Port)     ECReg(USBPD_BASE(Port) + 0x34)
#define TDO5R1(Port)     ECReg(USBPD_BASE(Port) + 0x35)
#define TDO5R2(Port)     ECReg(USBPD_BASE(Port) + 0x36)
#define TDO5R3(Port)     ECReg(USBPD_BASE(Port) + 0x37)
#define TDO6R0(Port)     ECReg(USBPD_BASE(Port) + 0x38)
#define TDO6R1(Port)     ECReg(USBPD_BASE(Port) + 0x39)
#define TDO6R2(Port)     ECReg(USBPD_BASE(Port) + 0x3A)
#define TDO6R3(Port)     ECReg(USBPD_BASE(Port) + 0x3B)
#define AGTMH_BASE(Port) (USBPD_BASE(Port) + 0x3C)
#define AGTMHLR(Port)    ECReg(USBPD_BASE(Port) + 0x3C)
#define AGTMHHR(Port)    ECReg(USBPD_BASE(Port) + 0x3D)
#define TMHLR(Port)      ECReg(USBPD_BASE(Port) + 0x3E)
#define TMHHR(Port)      ECReg(USBPD_BASE(Port) + 0x3F)
#define RDO_BASE(Port)   (USBPD_BASE(Port) + 0x40)
#define RDO0R0(Port)     ECReg(USBPD_BASE(Port) + 0x40)
#define RDO0R1(Port)     ECReg(USBPD_BASE(Port) + 0x41)
#define RDO0R2(Port)     ECReg(USBPD_BASE(Port) + 0x42)
#define RDO0R3(Port)     ECReg(USBPD_BASE(Port) + 0x43)
#define RDO1R0(Port)     ECReg(USBPD_BASE(Port) + 0x44)
#define RDO1R1(Port)     ECReg(USBPD_BASE(Port) + 0x45)
#define RDO1R2(Port)     ECReg(USBPD_BASE(Port) + 0x46)
#define RDO1R3(Port)     ECReg(USBPD_BASE(Port) + 0x47)
#define RDO2R0(Port)     ECReg(USBPD_BASE(Port) + 0x48)
#define RDO2R1(Port)     ECReg(USBPD_BASE(Port) + 0x49)
#define RDO2R2(Port)     ECReg(USBPD_BASE(Port) + 0x4A)
#define RDO2R3(Port)     ECReg(USBPD_BASE(Port) + 0x4B)
#define RDO3R0(Port)     ECReg(USBPD_BASE(Port) + 0x4C)
#define RDO3R1(Port)     ECReg(USBPD_BASE(Port) + 0x4D)
#define RDO3R2(Port)     ECReg(USBPD_BASE(Port) + 0x4E)
#define RDO3R3(Port)     ECReg(USBPD_BASE(Port) + 0x4F)
#define RDO4R0(Port)     ECReg(USBPD_BASE(Port) + 0x50)
#define RDO4R1(Port)     ECReg(USBPD_BASE(Port) + 0x51)
#define RDO4R2(Port)     ECReg(USBPD_BASE(Port) + 0x52)
#define RDO4R3(Port)     ECReg(USBPD_BASE(Port) + 0x53)
#define RDO5R0(Port)     ECReg(USBPD_BASE(Port) + 0x54)
#define RDO5R1(Port)     ECReg(USBPD_BASE(Port) + 0x55)
#define RDO5R2(Port)     ECReg(USBPD_BASE(Port) + 0x56)
#define RDO5R3(Port)     ECReg(USBPD_BASE(Port) + 0x57)
#define RDO6R0(Port)     ECReg(USBPD_BASE(Port) + 0x58)
#define RDO6R1(Port)     ECReg(USBPD_BASE(Port) + 0x59)
#define RDO6R2(Port)     ECReg(USBPD_BASE(Port) + 0x5A)
#define RDO6R3(Port)     ECReg(USBPD_BASE(Port) + 0x5B)
#define RMH_BASE(Port)   (USBPD_BASE(Port) + 0x5E)
#define RMHLR(Port)      ECReg(USBPD_BASE(Port) + 0x5E)
#define RMHHR(Port)      ECReg(USBPD_BASE(Port) + 0x5F)
#define CCPSR0(Port)     ECReg(USBPD_BASE(Port) + 0x60)
#define CCPSR1(Port)     ECReg(USBPD_BASE(Port) + 0x61)
#define CCPSR2(Port)     ECReg(USBPD_BASE(Port) + 0x62)
#define CCPSR3(Port)     ECReg(USBPD_BASE(Port) + 0x63)
#define BMCSR(Port)      ECReg(USBPD_BASE(Port) + 0x64)
#define PDMHSR(Port)     ECReg(USBPD_BASE(Port) + 0x65)
