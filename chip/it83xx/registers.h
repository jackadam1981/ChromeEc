...
#define IT83XX_ESPI_ESUCTRL0   REG8(IT83XX_ESPI_BASE+0xB0)
#define ESPI_UPSTREAM_EN                  (1 << 7)
#define ESPI_UPSTREAM_GO                  (1 << 6)
#define ESPI_UPSTREAM_INTERRUPT_EN        (1 << 5)
#define ESPI_UPSTREAM_CHANNEL_DIS         (1 << 2)
#define ESPI_UPSTREAM_DONE                (1 << 1)
#define ESPI_UPSTREAM_BUSY                (1 << 0)
#define IT83XX_ESPI_ESUCTRL1   REG8(IT83XX_ESPI_BASE+0xB1)
#define ESPI_UPSTREAM_CYCLE_PC_MESSAGE    0x6
#define ESPI_UPSTREAM_CYCLE_OOB_MESSAGE   0x7
#define ESPI_UPSTREAM_CYCLE_FLASH_READ    0x8
#define ESPI_UPSTREAM_CYCLE_FLASH_WRITE   0x9
#define ESPI_UPSTREAM_CYCLE_FLASH_ERASE   0xA
#define IT83XX_ESPI_ESUCTRL2   REG8(IT83XX_ESPI_BASE+0xB2)
#define IT83XX_ESPI_ESUCTRL3   REG8(IT83XX_ESPI_BASE+0xB3)
#define IT83XX_ESPI_ESOCTRL0   REG8(IT83XX_ESPI_BASE+0xC0)
#define ESPI_INTERRUPT_EVENT_PUT_OOB      (1 << 7)
#define IT83XX_ESPI_ESOCTRL1   REG8(IT83XX_ESPI_BASE+0xC1)
#define ESPI_INTERRUPT_EVENT_PUT_OOB_EN   (1 << 7)
#define IT83XX_ESPI_ESOCTRL4   REG8(IT83XX_ESPI_BASE+0xC4)
#define IT83XX_ESPI_ESPISAFSC0 REG8(IT83XX_ESPI_BASE+0xD0)
#define ESPI_INTERRUPT_EVENT_PUT_FLASH_EN (1 << 7)
#define IT83XX_ESPI_ESPISAFSC1 REG8(IT83XX_ESPI_BASE+0xD1)
#define ESPI_INTERRUPT_EVENT_PUT_FLASH    (1 << 7)
#define ESPI_FLASH_NP_CYCLE_ERASE         (1 << 1)
#define ESPI_FLASH_NP_CYCLE_WRITE         (1 << 0)
...
/* eSPI Queue 0 */
#define IT83XX_ESPI_QUEUE0_BASE  0x00F03300
/* PUT_PC data byte 0 - 63 */
#define IT83XX_ESPI_QUEUE0_PUT_PC(i)  REG8(IT83XX_ESPI_QUEUE0_BASE+(i))
/* PUT_OOB data byte 0 - 79 */
#define IT83XX_ESPI_QUEUE0_PUT_OOB(i) REG8(IT83XX_ESPI_QUEUE0_BASE+0x80+(i))

/* PUT_OOB SMBus format */
#define OOB_SMBUS_DEST_ADDR_PCH       0x2
#define OOB_SMBUS_DEST_ADDR_PCH_INTEL 0x10
#define OOB_SMBUS_CMD_GET_PCH_TEMP    0x1
#define OOB_SMBUS_CMD_GET_PCH_RTC     0x2
#define OOB_SMBUS_SRC_ADDR_EC         0x1F

/* eSPI Queue 1 */
#define IT83XX_ESPI_QUEUE1_BASE  0x00F03400
/* PUT_UPSTREAM data byte 0 - 79 */
#define IT83XX_ESPI_QUEUE1_PUT_UPSTREAM(i) REG8(IT83XX_ESPI_QUEUE1_BASE+(i))
/* PUT_FLASH_NP data byte 0 - 63 */
#define IT83XX_ESPI_QUEUE1_PUT_FLASH(i)   REG8(IT83XX_ESPI_QUEUE1_BASE+0x80+(i))
