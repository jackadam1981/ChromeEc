...
#define IT83XX_ESPI_CH2CC      REG8(IT83XX_ESPI_BASE+0x13)
#define ESPI_OOB_MESSAGE_CHANNEL_EN        (1 << 0)
...
#define ESPI_UPSTREAM_INTERRUPT_EVENT_DONE (1 << 1)
...
#define ESPI_INTERRUPT_PUT_OOB_EN          (1 << 7)
...
/* eSPI Queue 0(PC, OOB)/1(UPSTREAM, FLASH) */
#define IT83XX_ESPI_QUEUE_BASE     0x00F03300
#define PUT_PC_OFFSET              0x00
#define PUT_OOB_OFFSET             0x80
#define PUT_UPSTREAM_OFFSET        0x100
#define PUT_FLASH_OFFSET           0x180
#define IT83XX_ESPI_QUEUE(off, i)  REG8(IT83XX_ESPI_QUEUE_BASE+(off)+(i))
