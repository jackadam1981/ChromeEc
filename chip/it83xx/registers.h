...
#define IT83XX_GPIO_BASE2  0x00F03E00

#define IT83XX_GPIO_GPDRO       REG8(IT83XX_GPIO_BASE2+0x01)
#define IT83XX_GPIO_CS          BIT(1)
#define IT83XX_GPIO_GPCRO0      REG8(IT83XX_GPIO_BASE2+0x10)
#define IT83XX_GPIO_GPCRO1      REG8(IT83XX_GPIO_BASE2+0x11)
#define IT83XX_GPIO_GPCRO2      REG8(IT83XX_GPIO_BASE2+0x12)
#define IT83XX_GPIO_GPCRO3      REG8(IT83XX_GPIO_BASE2+0x13)
...
#define IT83XX_GCTRL_SPISLVPFE       (1 << 6)
...
#define IT83XX_SPI_TXFIFOFULL      BIT(6)
#define IT83XX_SPI_RXBYTEREACHINT  BIT(5)
#define IT83XX_SPI_BUSBUSY         BIT(4)
#define IT83XX_SPI_CMDININT        BIT(3)
#define IT83XX_SPI_ENDDETECTINT    BIT(2)
#define IT83XX_SPI_TXBYTEREACHINT  BIT(1)
#define IT83XX_SPI_TXEMPTYINT      BIT(0)
#define IT83XX_SPI_TXFSR        REG8(IT83XX_SPI_BASE+0x06)
#define IT83XX_SPI_TXFFSM          (BIT(4) | BIT(3))
#define IT83XX_SPI_TXF2NFS         BIT(2)
#define IT83XX_SPI_TXF1NFS         BIT(1)
#define IT83XX_SPI_TXFAS           BIT(0)
...
#define IT83XX_SPI_RXFAS           BIT(0)
#define IT83XX_SPI_SPISRDR      REG8(IT83XX_SPI_BASE+0x08)
#define IT83XX_SPI_CPUWTFDB0    REG32(IT83XX_SPI_BASE+0x08)
#define IT83XX_SPI_CPUWTFDB1    REG8(IT83XX_SPI_BASE+0x09)
#define IT83XX_SPI_CPUWTFDB2    REG8(IT83XX_SPI_BASE+0x0A)
#define IT83XX_SPI_CPUWTFDB3    REG8(IT83XX_SPI_BASE+0x0B)
#define IT83XX_SPI_FCR          REG8(IT83XX_SPI_BASE+0x09)
#define IT83XX_SPI_ISPISRTXF       BIT(3)
#define IT83XX_SPI_SPISRTXF        BIT(2)
#define IT83XX_SPI_RXFR            BIT(1)
#define IT83XX_SPI_RXFCMR          BIT(0)
#define IT83XX_SPI_RXFRDRB0     REG8(IT83XX_SPI_BASE+0x0C)
#define IT83XX_SPI_RXFRDRB1     REG8(IT83XX_SPI_BASE+0x0D)
#define IT83XX_SPI_RXFRDRB2     REG8(IT83XX_SPI_BASE+0x0E)
#define IT83XX_SPI_RXFRDRB3     REG8(IT83XX_SPI_BASE+0x0F)
#define IT83XX_SPI_RXFCMB0      REG8(IT83XX_SPI_BASE+0x14)
#define IT83XX_SPI_RXFCMB1      REG8(IT83XX_SPI_BASE+0x15)
#define IT83XX_SPI_TXFCMB0      REG8(IT83XX_SPI_BASE+0x16)
#define IT83XX_SPI_TXFCMB1      REG8(IT83XX_SPI_BASE+0x17)
