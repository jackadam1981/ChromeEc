...
#define IT83XX_SMB_RESLADR(ch)  REG8(IT83XX_SMB_BASE+0x48+(ch << 6))
#define IT83XX_SMB_SLDA(ch)     REG8(IT83XX_SMB_BASE+0x49+(ch << 6))
#define IT83XX_SMB_SLSTA(ch)    REG8(IT83XX_SMB_BASE+0x4B+(ch << 6))
#define IT83XX_SMB_SPDS         (1 << 5)
#define IT83XX_SMB_RCS          (1 << 3)
#define IT83XX_SMB_STS          (1 << 2)
#define IT83XX_SMB_SDS          (1 << 1)
#define IT83XX_SMB_SICR(ch)     REG8(IT83XX_SMB_BASE+0x4C+(ch << 6))
#define IT83XX_SMB_RESLADR2(ch) REG8(IT83XX_SMB_BASE+0x51+(ch << 6))
#define IT83XX_SMB_ENADDR2      (1 << 8)
