...
#define IT83XX_USBPD_PDCSR(p)     REG8(IT83XX_USBPD_BASE(p)+0x02)
#define USBPD_REG_MASK_VCONN_ENABLE           (1 << 2)
#define USBPD_REG_MASK_ACTIVE_MODE_ENABLE     (1 << 1)
#define USBPD_REG_MASK_VBUS_STAT_5V_ENABLE    (1 << 0)
#define IT83XX_USBPD_PEPDRSR(p)   REG8(IT83XX_USBPD_BASE(p)+0x03)
#define USBPD_REG_MASK_CC_BUSY                (1 << 4)
#define USBPD_REG_MASK_ROLE_DATA              (1 << 1)
#define USBPD_REG_MASK_ROLE_POWER             (1 << 0)
...
#define IT83XX_USBPD_CCADIR(p)    REG8(IT83XX_USBPD_BASE(p)+0x0D)
#define IT83XX_USBPD_CCADRR(p)    REG8(IT83XX_USBPD_BASE(p)+0x0E)
#define IT83XX_USBPD_CCADIMR(p)   REG8(IT83XX_USBPD_BASE(p)+0x0F)
#define IT83XX_USBPD_TSR0(p)      REG8(IT83XX_USBPD_BASE(p)+0x10)
#define USBPD_REG_MASK_TIMEOUT_BIST_CON_MODE_BIT (1 << 3)
#define USBPD_REG_MASK_TIMEOUT_SOURCE_CAP_BIT  (1 << 2)
#define USBPD_REG_MASK_TIMEOUT_SEND_RESP_BIT   (1 << 1)
#define USBPD_REG_MASK_TIMEOUT_CRC_RX_BIT      (1 << 0)
#define IT83XX_USBPD_TSR1(p)      REG8(IT83XX_USBPD_BASE(p)+0x11)
#define IT83XX_USBPD_TIMR0(p)     REG8(IT83XX_USBPD_BASE(p)+0x12)
#define IT83XX_USBPD_TIMR1(p)     REG8(IT83XX_USBPD_BASE(p)+0x13)
...
#define IT83XX_USBPD_CCPSR1(p)    REG8(IT83XX_USBPD_BASE(p)+0x61)
#define IT83XX_USBPD_CCPSR2(p)    REG8(IT83XX_USBPD_BASE(p)+0x62)
#define IT83XX_USBPD_CCPSR3(p)    REG8(IT83XX_USBPD_BASE(p)+0x63)
