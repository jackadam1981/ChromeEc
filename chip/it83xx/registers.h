...
#define IT83XX_SPI_SLAVECTRL0   REG8(IT83XX_SPI_BASE+0x00)
#define IT83XX_SPI_SLAVEMODE    (1 << 1)
#define IT83XX_SPI_SLAVECTRLEN  (1 << 0)
#define IT83XX_SPI_SLAVECTRL1   REG8(IT83XX_SPI_BASE+0x01)
#define IT83XX_SPI_FIFOPNTRST   (1 << 3)
#define IT83XX_SPI_FIFODIRCTRL  (1 << 2)
#define IT83XX_SPI_CPUDIREN     (1 << 1)
#define IT83XX_SPI_SRAMENB      (1 << 0)
#define IT83XX_SPI_INTENBSTATUS REG8(IT83XX_SPI_BASE+0x04)
#define IT83XX_SPI_INTSTATUS    REG8(IT83XX_SPI_BASE+0x05)
#define IT83XX_SPI_DATACONREACH (1 << 5)
#define IT83XX_SPI_SLAVEBUSBUSY (1 << 4)
#define IT83XX_SPI_DMATRSFDONE  (1 << 3)
#define IT83XX_SPI_BUSENDDETECT (1 << 2)
#define IT83XX_SPI_4BYTERXFULL  (1 << 1)
#define IT83XX_SPI_4BYTETXEMPTY (1 << 0)
#define IT83XX_SPI_SLAVEDATA0   REG32(IT83XX_SPI_BASE+0x08)
#define IT83XX_SPI_SLAVEDATA1   REG8(IT83XX_SPI_BASE+0x09)
#define IT83XX_SPI_SLAVEDATA2   REG8(IT83XX_SPI_BASE+0x0A)
#define IT83XX_SPI_SLAVEDATA3   REG8(IT83XX_SPI_BASE+0x0B)
#define IT83XX_SPI_DMAWADDR0    REG8(IT83XX_SPI_BASE+0x0C)
#define IT83XX_SPI_DMAWADDR1    REG8(IT83XX_SPI_BASE+0x0D)
#define IT83XX_SPI_DMARADDR0    REG8(IT83XX_SPI_BASE+0x10)
#define IT83XX_SPI_DMARADDR1    REG8(IT83XX_SPI_BASE+0x11)
#define IT83XX_SPI_FIFOCNTMON0  REG8(IT83XX_SPI_BASE+0x14)
#define IT83XX_SPI_FIFOCNTMON1  REG8(IT83XX_SPI_BASE+0x15)
#define IT83XX_SPI_FIFOTARCNT0  REG8(IT83XX_SPI_BASE+0x18)
#define IT83XX_SPI_FIFOTARCNT1  REG8(IT83XX_SPI_BASE+0x19)
