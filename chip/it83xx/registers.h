...
enum {
	...
	GPIO_KSI     = GPIO_PORT_COUNT,//GPIO_KBS_OFF + 0x9,
	/* KSO[15-8] GPIO data mirror register. */
	GPIO_KSO_H   = GPIO_PORT_COUNT + 1,//GPIO_KBS_OFF + 0xc,
	/* KSO[7-0]  GPIO data mirror register. */
	GPIO_KSO_L   = GPIO_PORT_COUNT + 2,//GPIO_KBS_OFF + 0xf,
};
...
#endif
	[GPIO_KSI] = {0x00F01D09, 0x0, 0x0},
	[GPIO_KSO_H] = {0x00F01D0C, 0x0, 0x0},
	[GPIO_KSO_L] = {0x00F01D0F, 0x0, 0x0},
};
//BUILD_ASSERT(ARRAY_SIZE(gpio_group_to_reg) == (GPIO_PORT_COUNT + 2));
...
#define IT83XX_GPIO_CTRL(port, pin_offset)     \
	REG8(gpio_group_to_reg[port].reg_gpcrx + pin_offset)
