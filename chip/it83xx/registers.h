...
struct gpio_reg_t {
	/*
	 * GPIO port data register; KSI/KSO port data mirror register
	 * (bit mapping to pin)
	 */
	uint32_t reg_gpdr;
	/*
	 * GPIO port data register; KSI/KSO port output data register
	 * (bit mapping to pin)
	 */
	uint32_t reg_gpdr_;
...
#define IT83XX_GPIO_DATA_(port)                 \
	REG8(gpio_group_to_reg[port].reg_gpdr_)
