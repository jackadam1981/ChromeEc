...
#define ADC_VCMPX_CMPEN               BIT(7)
#define ADC_VCMPX_CMPINTEN            BIT(6)
#define ADC_VCMPX_GREATER_THRESHOLD   BIT(5)
#define ADC_VCMPX_EDGE_TRIGGER        BIT(4)
#define ADC_VCMPX_GPIO_ACTIVE_LOW     BIT(3)
