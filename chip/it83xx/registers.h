...
#define IT83XX_SMB_SLVINCTL(ch) REG8(IT83XX_SMB_BASE+0x4C+(ch << 6))
#define IT83XX_SMB_RSLVADR(ch)  REG8(IT83XX_SMB_BASE+0x48+(ch << 6))
#define IT83XX_SMB_SLVDTA(ch)   REG8(IT83XX_SMB_BASE+0x49+(ch << 6))
#define IT83XX_SMB_SLVSTA(ch)   REG8(IT83XX_SMB_BASE+0x4B+(ch << 6))
#define IT83XX_SMB_RSLVADR2(ch) REG8(IT83XX_SMB_BASE+0x51+(ch << 6))
