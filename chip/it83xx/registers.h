...
#define ESPI_INTERRUPT_EVENT_UPSTREAM_GO (1 << 6)
#define ESPI_INTERRUPT_EVENT_UPSTREAM_DONE (1 << 1)
...
#define IT83XX_ESPI_QUEUE1_BASE  (0x00F03300 + 0x100)
/* PUT_PC data byte 0 - 63 */
#define IT83XX_ESPI_QUEUE_PUT_PC(i, q) \
		REG8(IT83XX_ESPI_QUEUE0_BASE+(i)+0x100*(q))
/* PUT_OOB data byte 0 - 79 */
#define IT83XX_ESPI_QUEUE_PUT_OOB(i, q) \
		REG8(IT83XX_ESPI_QUEUE0_BASE+0x80+(i)+0x100*(q))
