...
void keyboard_raw_init(void)
{
	 ...
	 * function, and the others are configured as GPIO output mode. In this
	 * case that we disable the ISR in critical section to avoid race
	 * condition.
	 */
	...
	IT83XX_KBS_KSOH1 &= ~KSOH_PIN_MASK; //other as GPIO, float?
	/* restore interrupts */
