...
test_mockable void keyboard_raw_drive_column(int col)
{
	...
	interrupt_disable();
	/*
	 * Because IT83XX_KBS_KSOH1 register is shared by keyboard scan out and
	 * GPIO output mode, so we don't drive all KSOH pins here
	 * (this depends on how many keyboard matrix output pin we are using).
	 */
