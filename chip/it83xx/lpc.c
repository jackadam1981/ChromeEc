...
/* LPC pool offsets. */
#define LPC_POOL_OFFS_HOST_CMD	  0x300
#define LPC_POOL_OFFS_HOST_STATUS 0x301
#define LPC_POOL_OFFS_HOST_DATA   0x302
#define LPC_POOL_OFFS_MEMMAP      0x100
#define LPC_POOL_OFFS_CMD_DATA    0x200
