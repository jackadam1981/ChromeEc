...
/*
 * This claims RAM space for LPC shared memory at the appropriate location. Use
 * the pool data pointers defined above to access the shared memory.
 */
uint8_t __lpc_reserved[0x204] __attribute__((section(".lpc.reserved")));
...
static void lpc_init(void)
{
	...
	/***************************************************/
	/* Host memory mapped data EC_LPC_ADDR_MEMMAP setup. */
...
#if EC_MEMMAP_SIZE > 256
#error "EC_MEMMAP_SIZE is too large. Consider changing IT83XX_SMFI_HRAMW0AAS."
#endif
	...
	/*
	 * LPC I/O path and H2RAM-HLPC base address high nibble set to 0xd0.
	 * This places the host to RAM ports at 0xdXXX.
	 */
	status |= ec2i_write_host_pnpcfg(PNPCFG_ADDR_PORT, 0xf5);
	...
	*(lpc_get_memmap_range() + EC_MEMMAP_HOST_CMD_FLAGS) =
	...
	/***************************************************/
	/*
	 * Host commands (EC_LPC_ADDR_HOST_CMD, EC_LPC_ADDR_HOST_DATA,
	 * EC_LPC_ADDR_HOST_STATUS, and EC_LPC_ADDR_HOST_PACKET) setup.
	 */
	 ...
	 * EC_LPC_ADDR_HOST_CMD is written.
	 */
