...
#ifdef USE_IRQ1_FOR_WATCHDOG
static void __watchdog_irq(void)
{
	/* clear interrupt status */
	IT83XX_INTC_ISR19 = 0x08;

	/* Reset warning timer (timer 3). */
	IT83XX_ETWD_ET3CTRL = 0x03;

	panic_printf("Pre-watchdog warning!\n");
}
DECLARE_IRQ(1, __watchdog_irq, 1);
#endif
