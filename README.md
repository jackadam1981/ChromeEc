...
The `devicename` is name of device or board or variant which belong to a family of base board. `boardname` is base board name in this case. Eg : `/build/dedede/firmware/madoo/ec.bin`
