 ...
 *   }, 63,
 *   {  // Expected PRK changes based on IKM. With CONFIG_OTP_KEY disabled:
 ...
 *
 *     //With CONFIG_OTP_KEY enabled:
 *     0x2d, 0x11, 0x63, 0xe6, 0x05, 0xdf, 0x3c, 0xdc,
+      0xb8, 0xf8, 0xf6, 0x2e, 0x17, 0x69, 0x0a, 0x06,
+      0x2f, 0x12, 0x24, 0x16, 0x96, 0x04, 0x67, 0x16,
+      0x29, 0xfa, 0xbd, 0x0b, 0xf9, 0xde, 0xd5, 0xf8,
 *   }, 32,
 ...
 * to run all tests including hkdf or (quicker) to run only HKDF tests:
 * $ ./build/crypto/crypto_test --gtest_filter=\*HK\*
 */
...
test_static int test_derive_encryption_key(void)
{
	...
	static const uint8_t key2[] = { 0xa3, 0x38, 0x1e, 0x4e, 0x60, 0xf1,
					...
					0xfb, 0x4c, 0x87, 0x0a };
#else
	static const uint8_t key2[] = { 0x8d, 0x53, 0xaf, 0x4c, 0x96, 0xa2,
					0xee, 0x46, 0x9c, 0xe2, 0xe2, 0x6f,
					0xe6, 0x66, 0x3d, 0x3a };
#endif
