...
/* Test the STATIC_REQUIRES and STATIC_UNLESS macros. */
...
STATIC_UNLESS(CONFIG_BLANK) int this_var_is_extern_too;
STATIC_REQUIRES(CONFIG_BLANK) int this_var_is_static;
STATIC_UNLESS(CONFIG_UNDEFINED) int this_var_is_static_too;
...
{
	/*
	 * This should cause linker errors if the variables actually
	 * go used.
	 */
