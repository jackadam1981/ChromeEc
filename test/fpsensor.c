...
static int test_derive_new_pos_match_secret(void)
{
...
static int test_derive_positive_match_secret_fail_seed_not_set(void)
{
	static uint8_t output[FP_POSITIVE_MATCH_SECRET_BYTES];
...
static int test_derive_positive_match_secret_fail_rollback_fail(void)
{
	static uint8_t output[FP_POSITIVE_MATCH_SECRET_BYTES];
...
static int test_derive_positive_match_secret_fail_salt_trivial(void)
{
	static uint8_t output[FP_POSITIVE_MATCH_SECRET_BYTES];
...
static int test_enable_positive_match_secret(void)
{
...
static int test_disable_positive_match_secret(void)
{
	struct positive_match_secret_state dumb_state = {
		.template_matched = FP_NO_SUCH_TEMPLATE,
		.readable = false,
...
static int test_command_read_match_secret(void)
{
	int rv;
...
static int test_command_read_match_secret_wrong_finger(void)
{
	int rv;
	struct ec_params_fp_read_match_secret params;
...
static int test_command_read_match_secret_timeout(void)
{
	int rv;
	struct ec_params_fp_read_match_secret params;
...
static int test_command_read_match_secret_unreadable(void)
{
	int rv;
	struct ec_params_fp_read_match_secret params;
