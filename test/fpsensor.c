...
<<<<<<< HEAD   (6939b7 fpsensor: Move crypto-related code to fpsensor_crypto.c)
...
>>>>>>> CHANGE (620667 fpsensor: Extend unit test for FPTPM seed set status.)
{
