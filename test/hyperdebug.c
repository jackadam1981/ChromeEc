...
{
	int ret;
	/* Frequency of 100 can be hit exactly by dividing 1000 with 10 */
	SUBTEST(test_divisor(100, 100, 10, 1000));
	/*
	 * Frequency of 2000 is realied with divisor 50 and base frequency
	 * 100000
	 */
	SUBTEST(test_divisor(2000, 2000, 50, 100000));
	/* Frequency of 30000 can be hit exactly by dividing 150000 by 5 */
	SUBTEST(test_divisor(30000, 30000, 5, 150000));
	/* Frequency of 34000 can best be approximated by 100000 by 3 */
	SUBTEST(test_divisor(34000, 33333, 3, 100000));
	/*
	 * Frequency of 80000 can best be approximated by dividing 150000 by 2
	 */
	 ...
	 * be the experience, if HyperDebug had refused to exceed by a fraction
	 * of a Hertz.
	 */
