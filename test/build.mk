...
test-list-host += static_requires
test-list-host += static_requires_error
...
static_requires-y=static_requires.o
stress-y=stress.o
system-y=system.o
thermal-y=thermal.o
...
host-static_requires_error: TEST_SCRIPT=static_requires_error.sh
static_requires_error-y=static_requires_error.o.cmd
