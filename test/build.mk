...
$(out)/RO/common/new_nvmem.o: CFLAGS += -I$(CROS_WORKON_SRCROOT)/src/third_party/tpm2
$(out)/RO/test/nvmem.o: CFLAGS += -I$(CROS_WORKON_SRCROOT)/src/third_party/tpm2
$(out)/RO/test/nvmem_tpm2_mock.o: CFLAGS += -I$(CROS_WORKON_SRCROOT)/src/third_party/tpm2
