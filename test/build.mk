...
#%/test/fpsensor_hw.o: CFLAGS+=-I/build/hatch/usr/include/gtest
%/test/fpsensor_hw.o: CFLAGS+=-I~/chromiumos/src/third_party/tmp/include
#%/test/fpsensor_hw.o: LDFLAGS+=-L$(HOME)/chromiumos/src/third_party/tmp/lib -lgtest
