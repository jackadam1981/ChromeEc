...
#define NEW_FLASH_HALF_NVMEM_SIZE (NVMEM_PARTITION_SIZE - CONFIG_FLASH_BANK_SIZE)
#define NEW_NVMEM_PAGES_COUNT ((2 * NEW_FLASH_HALF_NVMEM_SIZE)/CONFIG_FLASH_BANK_SIZE)
#define CONFIG_SW_CRC
