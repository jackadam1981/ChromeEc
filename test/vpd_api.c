...
static enum vpd_gpo mock_cc_rp1a5_odh;
...
static int mock_cfg_cc2_rpusb_odh;
static int mock_cc2_rpusb_odh;
static int mock_cfg_cc2_rp1a5_odh;
static int mock_cc2_rp1a5_odh;
static int mock_cfg_cc1_rpusb_odh;
static int mock_cc1_rpusb_odh;
static int mock_cfg_cc_vpdmcu;
static int mock_cc_vpdmcu;
static enum vpd_pin mock_cfg_cc_rp3a0_rd_l;
static int mock_cc_rp3a0_rd_l;
static int mock_cfg_cc1_rp1a5_odh;
static int mock_cc1_rp1a5_odh;
...
{
	if (mock_cfg_cc_vpdmcu == PIN_ADC) {
		switch (v) {
		case TYPEC_CC_VOLT_SNK_DEF:
			mock_cc_vpdmcu = PD_SNK_VA;
			break;
		case TYPEC_CC_VOLT_SNK_1_5:
			mock_cc_vpdmcu = TYPE_C_SRC_1500_THRESHOLD;
			break;
		case TYPEC_CC_VOLT_SNK_3_0:
			mock_cc_vpdmcu = TYPE_C_SRC_3000_THRESHOLD;
			break;
		default:
			mock_cc_vpdmcu = 0;
		}
...
{
	return mock_cfg_cc2_rpusb_odh;
}

int mock_set_cc2_rpusb_odh(int v)
{
	if (mock_cfg_cc2_rpusb_odh == PIN_ADC) {
		switch (v) {
		case TYPEC_CC_VOLT_SNK_DEF:
			mock_cc2_rpusb_odh = PD_SNK_VA;
			break;
		case TYPEC_CC_VOLT_SNK_1_5:
			mock_cc2_rpusb_odh = TYPE_C_SRC_1500_THRESHOLD;
			break;
		case TYPEC_CC_VOLT_SNK_3_0:
			mock_cc2_rpusb_odh = TYPE_C_SRC_3000_THRESHOLD;
			break;
		default:
			mock_cc2_rpusb_odh = 0;
		}
...
int mock_get_cfg_cc2_rp1a5_odh(void)
{
	return mock_cfg_cc2_rp1a5_odh;
}

int mock_set_cc2_rp1a5_odh(int v)
{
	if (mock_cfg_cc2_rp1a5_odh == PIN_ADC) {
		mock_cc2_rp1a5_odh = v;
		return 1;
	}
...
{
	return mock_cfg_cc1_rpusb_odh;
}

int mock_set_cc1_rpusb_odh(int v)
{
	if (mock_cfg_cc1_rpusb_odh == PIN_ADC) {
		switch (v) {
		case TYPEC_CC_VOLT_SNK_DEF:
			mock_cc1_rpusb_odh = PD_SNK_VA;
			break;
		case TYPEC_CC_VOLT_SNK_1_5:
			mock_cc1_rpusb_odh = TYPE_C_SRC_1500_THRESHOLD;
			break;
		case TYPEC_CC_VOLT_SNK_3_0:
			mock_cc1_rpusb_odh = TYPE_C_SRC_3000_THRESHOLD;
			break;
		default:
			mock_cc1_rpusb_odh = 0;
		}
...
{
	return mock_cfg_cc_vpdmcu;
}

enum vpd_pin mock_get_cfg_cc_rp3a0_rd_l(void)
{
	return mock_cfg_cc_rp3a0_rd_l;
}

int mock_get_cc_rp3a0_rd_l(void)
{
	return mock_cc_rp3a0_rd_l;
}

int mock_get_cfg_cc1_rp1a5_odh(void)
{
	return mock_cfg_cc1_rp1a5_odh;
}

int mock_set_cc1_rp1a5_odh(int v)
{
	if (mock_cfg_cc1_rp1a5_odh == PIN_ADC) {
		mock_cc1_rp1a5_odh = v;
		return 1;
	}
...
void vpd_ct_set_pull(int pull, int rp_value)
{
	...
	case TYPEC_CC_RP:
		...
		case TYPEC_RP_1A5:
			...
			vpd_config_cc1_rp1a5_odh(PIN_GPO, 1);
			vpd_config_cc2_rp1a5_odh(PIN_GPO, 1);
			break;
		}
		break;
	case TYPEC_CC_RD:
		vpd_config_cc1_rpusb_odh(PIN_ADC, 0);
		vpd_config_cc2_rpusb_odh(PIN_ADC, 0);
		/* TODO(shurst): Change to PIN_ADC in next chocodile rev. */
		vpd_config_cc1_rp1a5_odh(PIN_GPO, 0);
		/* TODO(shurst): Change to PIN_ADC in next chocodile rev. */
		vpd_config_cc2_rp1a5_odh(PIN_GPO, 0);
		vpd_cc1_cc2_rd_l(GPO_LOW);
		break;
	case TYPEC_CC_OPEN:
		vpd_cc1_cc2_rd_l(GPO_HIGH);
		vpd_config_cc1_rpusb_odh(PIN_ADC, 0);
...
void vpd_ct_get_cc(int *cc1, int *cc2)
{
	...
	case TYPEC_CC_RP:
		...
		case TYPEC_RP_USB:
			cc1_v = mock_cc1_rp1a5_odh;
			cc2_v = mock_cc2_rp1a5_odh;
			break;
		case TYPEC_RP_1A5:
			cc1_v = mock_cc1_rpusb_odh;
			cc2_v = mock_cc2_rpusb_odh;
			break;
		}
		break;
	case TYPEC_CC_RD:
...
void vpd_host_set_pull(int pull, int rp_value)
{
	...
	case TYPEC_CC_RP:
		...
		case TYPEC_RP_USB:
			...
			vpd_cc_rp1a5_odh(GPO_HZ);
			vpd_cc_rpusb_odh(GPO_HIGH);
			break;
		case TYPEC_RP_1A5:
			vpd_config_cc_rp3a0_rd_l(PIN_CMP, 0);
			vpd_cc_rpusb_odh(GPO_HZ);
			vpd_cc_rp1a5_odh(GPO_HIGH);
			break;
		case TYPEC_RP_3A0:
			vpd_cc_rp1a5_odh(GPO_HZ);
			vpd_cc_rpusb_odh(GPO_HZ);
...
{
	*cc = vpd_cc_voltage_to_status(mock_cc_vpdmcu, host_cc_pull);
}
...
{
	mock_cfg_cc_vpdmcu = cfg;

	if (cfg == PIN_GPO)
		mock_cc_vpdmcu = en ? 1 : 0;
}
...
{
	mock_cfg_cc_rp3a0_rd_l = cfg;

	if (cfg == PIN_GPO)
		mock_cc_rp3a0_rd_l = en ? 1 : 0;
}

/*
 * PA4: Configure as ADC, CMP, or GPO
 */
void vpd_config_cc1_rp1a5_odh(enum vpd_pin cfg, int en)
{
	mock_cfg_cc1_rp1a5_odh = cfg;

	if (cfg == PIN_GPO)
		mock_cc1_rp1a5_odh = en ? 1 : 0;
}

/*
 * PA5: Configure as ADC, COMP, or GPO
 */
void vpd_config_cc2_rp1a5_odh(enum vpd_pin cfg, int en)
{
	mock_cfg_cc2_rp1a5_odh = cfg;

	if (cfg == PIN_GPO)
		mock_cc2_rp1a5_odh = en ? 1 : 0;
}
...
{
	mock_cfg_cc1_rpusb_odh = cfg;

	if (cfg == PIN_GPO)
		mock_cc1_rpusb_odh = en ? 1 : 0;
}
...
{
	mock_cfg_cc2_rpusb_odh = cfg;

	if (cfg == PIN_GPO)
		mock_cc2_rpusb_odh = en ? 1 : 0;
}
...
int vpd_is_host_vbus(void)
{
	return (vpd_read_host_vbus() >= PD_SNK_VA);
}

int vpd_is_ct_vbus(void)
{
	return (vpd_read_ct_vbus() >= PD_SNK_VA);
}

int vpd_is_vconn(void)
{
...
{
	mock_cc_rp1a5_odh = val;
}

void vpd_cc1_cc2_rd_l(enum vpd_gpo val)
{
