...
static struct mock_pin mock_cc2_rp1a5_odh;
static struct mock_pin mock_cc1_rpusb_odh;
static struct mock_pin mock_cc1_rp1a5_odh;
...
int mock_set_host_cc_sink_voltage(int v)
{
	if (mock_cc_vpdmcu.cfg == PIN_ADC) {
...
int mock_set_host_cc_source_voltage(int v)
{
	if (mock_cc_vpdmcu.cfg == PIN_ADC) {
...
{
	return mock_cc2_rp1a5_odh.cfg;
}

int mock_set_cc2_rp1a5_odh(int v)
{
	if (mock_cc2_rp1a5_odh.cfg == PIN_ADC) {
		mock_cc2_rp1a5_odh.value = v;
		return 1;
	}
...
{
	return mock_cc1_rp1a5_odh.cfg;
}

int mock_set_cc1_rp1a5_odh(int v)
{
	if (mock_cc1_rp1a5_odh.cfg == PIN_ADC) {
		mock_cc1_rp1a5_odh.value = v;
		return 1;
	}
...
void vpd_ct_get_cc(int *cc1, int *cc2)
{
	...
	case TYPEC_CC_RP:
		...
		case TYPEC_RP_USB:
			cc1_v = mock_cc1_rp1a5_odh.value;
			cc2_v = mock_cc2_rp1a5_odh.value;
			break;
		case TYPEC_RP_1A5:
...
{
	mock_cc1_rp1a5_odh.cfg = cfg;

	if (cfg == PIN_GPO)
		mock_cc1_rp1a5_odh.value = en ? 1 : 0;
}
...
{
	mock_cc2_rp1a5_odh.cfg = cfg;

	if (cfg == PIN_GPO)
		mock_cc2_rp1a5_odh.value = en ? 1 : 0;
}
