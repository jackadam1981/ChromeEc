...
uint8_t dummy_board_id[4] = {'Z', 'Z', 'C', 'R'};
uint8_t dummy_device_id[8] = {'T', 'H', 'X', 1, 1, 3, 8, 0xfe};
...
{
	uint8_t server_private_key[32] = RMA_TEST_SERVER_PRIVATE_KEY;
	int server_key_id = RMA_TEST_SERVER_KEY_ID;
	int version, key_id;
