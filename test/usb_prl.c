...
static int test_extented_260_byte_data_msg_xmit(void)
{
	int port = PORT0;
	...
	TEST_ASSERT(simulate_send_extended_260_byte_data_msg_request_from_pe(
				port, TCPC_TX_SOP, PD_DATA_SOURCE_CAP, 0));
...
static int test_extented_260_byte_data_msg_xmit_with_extra_chunk(void)
{
	int port = PORT0;
	...
	TEST_ASSERT(simulate_send_extended_260_byte_data_msg_request_from_pe(
				port, TCPC_TX_SOP, PD_DATA_SOURCE_CAP, 1));
...
void run_test(void)
{
	...
	RUN_TEST(test_data_msg_xmit);
	RUN_TEST(test_data_msg_xmit_to_much_data);
	RUN_TEST(test_extented_260_byte_data_msg_xmit);
	RUN_TEST(test_extented_260_byte_data_msg_xmit_with_extra_chunk);
