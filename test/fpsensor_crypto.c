...
test_static int get_ikm_failure_seed_not_set(void)
{
	uint8_t ikm;
...
test_static int test_get_ikm_tpm_seed_set(void)
{
...
void run_test(int argc, char **argv)
{
	...
	RUN_TEST(get_ikm_failure_seed_not_set);
	/*
	...
	RUN_TEST(test_get_ikm_tpm_seed_set);
