...
test_static int test_vsnprintf_32bit_long_supported(void)
{
	 ...
	 * Presently, only FPMCU boards have enabled this configuration.
	 */
...
test_static int test_vsnprintf_long(void)
{
	 ...
	 * explicitly enabled via configuration. Presently, only Bloonchipper
	 * and Dartmonkey boards have enabled this configuration.
	 */
