...
static void host_connect(void)
{
	mock_set_cc_vpdmcu(TYPEC_CC_VOLT_SNK_3_0);
}
...
static int test_vpd_initial_state(void)
{
	int port = PORT0;
...
static int test_vpd_host_detection_no_vconn_no_vbus(void)
{
	int port = PORT0;
...
static int test_vpd_host_detection_vconn_no_vbus(void)
{
	int port = PORT0;
...
static int test_vpd_host_detection_no_vconn_vbus(void)
{
	int port = PORT0;
...
void run_test(void)
{
	...
	RUN_TEST(test_vpd_initial_state);
	RUN_TEST(test_vpd_host_detection);
	RUN_TEST(test_vpd_host_detection_no_vconn_no_vbus);
	RUN_TEST(test_vpd_host_detection_vconn_no_vbus);
	RUN_TEST(test_vpd_host_detection_no_vconn_vbus);
