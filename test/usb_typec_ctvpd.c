...
void run_test(void)
{
	...
	/*
	 * TODO(shurst): Add the following test
	 *  test_ctvpd_ctunattached_vpd
	 *  test_ctvpd_ctattach_wait_vpd
	 *  test_ctvpd_ctdisabled_vpd
	 *  test_ctvpd_ctattached_vpd
	 *  test_ctvpd_ctattached_vpd_drp_toggle
	 *  test_ctvpd_ctunattached_unsupported
	 *  test_ctvpd_ctunattached_unsupported_drp_toggle
	 *  test_ctvpd_ctattach_wait_unsupported
	 *  test_ctvpd_cttry_snk
	 *  test_ctvpd_ctattached_unsupported
	 *  and more tests
	 */
#endif
	test_print_result();
