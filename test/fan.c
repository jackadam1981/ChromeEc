...
static int test_temp_ratio_to_rpm_path_dependent(void)
{
	...
	TEST_ASSERT(temp_ratio_to_rpm_path_dependent(fan_table, num_fan_levels,
						     0, 0, NULL) == 0);
	TEST_ASSERT(temp_ratio_to_rpm_path_dependent(fan_table, num_fan_levels,
						     0, 20, NULL) == 2500);
	TEST_ASSERT(temp_ratio_to_rpm_path_dependent(fan_table, num_fan_levels,
...
{
	RUN_TEST(test_fan);
	RUN_TEST(test_temp_ratio_to_rpm_path_dependent);
