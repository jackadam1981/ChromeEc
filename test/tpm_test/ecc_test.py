...
#
# TEST_SIGN:
# OP | CURVE_ID | SIGN_MODE | HASHING | MSG_LEN | MSG |
#   DIGEST_LEN | DIGEST
#    @returns R | S
_TEST_SIGN = '{o:c}{c:c}{s:c}{h:c}{ml:s}{msg}{dl:s}{dig}'

# TEST_SIGN_ANY:
# OP | CURVE_ID | SIGN_MODE | HASHING | MSG_LEN | MSG |
#   DIGEST_LEN | DIGEST | D_LEN | D
#    @returns R | S
_TEST_SIGN_ANY = '{o:c}{c:c}{s:c}{h:c}{ml:s}{msg}{dl:s}{dig}{pl:s}{pk}'
...
_TEST_VERIFY = '{o:c}{c:c}{sm:c}{h:c}{rl:s}{r}{sl:s}{s}{dl:s}{dig}'
...
# TEST_KEYDERIVE (MSG is a seed):
# OP | CURVE_ID | MSG_LEN | MSG
#    @returns 1 if successful
#
...
def _sign_cmd(curve_id, hash_func, sign_mode, msg):
  ...
  return _TEST_SIGN.format(o=op, c=curve_id, s=sign_mode, h=_HASH['SHA256'],
                           ml=struct.pack('>H', len(msg)), msg=msg,
...
def _verify_cmd(curve_id, hash_func, sign_mode, msg, sig):
  ...
  return _TEST_VERIFY.format(o=op, c=curve_id, sm=sign_mode, h=_HASH['SHA256'],
                             rl=struct.pack('>H', len(sig[:sig_len])),
                             r=sig[:sig_len],
                             sl=struct.pack('>H', len(sig[sig_len:])),
                             s=sig[sig_len:],
