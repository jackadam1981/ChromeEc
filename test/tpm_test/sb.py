...
def sb_test(tpm):
    ...
    + Tag(KM_TAG_ALGORITHM, 0) + U32(KM_ALG_EC)
    + Tag(KM_TAG_KEY_SIZE, 0) + U32(256)
    + Tag(KM_TAG_PURPOSE, 0) + U32(KM_PURPOSE_SIGN)
    ...
    expected_blob_hdr = (U32(KM_SECURITY_STRONGBOX) + U32(18) +
         Tag(KM_TAG_ORIGIN, 0) + U32(KM_ORIGIN_GENERATED) +
         ...
         Tag(KM_TAG_PURPOSE, 0) + U32(KM_PURPOSE_SIGN) +
         Tag(KM_TAG_DIGEST, 0) + U32(KM_DIGEST_SHA_2_256) +
         U32(KM_SECURITY_KEYSTORE) + U32(3) +
        Tag(KM_TAG_ALLOW_WHILE_ON_BODY, 0) +
        Tag(KM_TAG_USER_ID, 4) + U32(0xf00) +
        U32(80)
         )
