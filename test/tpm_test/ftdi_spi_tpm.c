...
#define TPM_INT_ENABLE_REG     (TPM_LOCALITY_0_SPI_BASE + 8)
#define TPM_INT_VECTOR_REG     (TPM_LOCALITY_0_SPI_BASE + 0xC)
#define TPM_INT_STATUS_REG     (TPM_LOCALITY_0_SPI_BASE + 0x10)
#define TPM_INTF_CAPABILITY_REG (TPM_LOCALITY_0_SPI_BASE + 0x14)
#define TPM_STS_REG                    (TPM_LOCALITY_0_SPI_BASE + 0x18)
#define TPM_DATA_FIFO_REG      (TPM_LOCALITY_0_SPI_BASE + 0x24)
#define TPM_INTERFACE_ID_REG    (TPM_LOCALITY_0_SPI_BASE + 0x30)
