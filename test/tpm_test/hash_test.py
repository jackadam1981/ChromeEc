...
TEST_INPUTS = (
  ...
  (CMD_HASH, ALG_SHA256, 0, '',
   ('some more text, this time for sha256 long long long long long long long '
    'long long text which longer than block')),
  (CMD_HMAC_SW, ALG_SHA256, 0, 'hmac_key1',
   ('some more text, this time long long long long long long long long long '
    'text which longer than block')),
  (CMD_HMAC_HW, ALG_SHA256, 0, 'hmac_key1',
   ('some more text, this time long long long long long long long long long '
    'text which longer than block')),
  (CMD_HMAC_SW, ALG_SHA256, 0,
   ('long long long long long long long long long long long long key long key'
    ' long long key'),
   ('some more text, this time for sha256 long long long long long long long'
    ' long text which longer than block')),
  (CMD_HMAC_HW, ALG_SHA256, 0,
   ('long long long long long long long long long long long long key long key'
    ' long long key'),
   ('some more text, this time for sha256 long long long long long long long'
...
def hash_test(tpm):
  ...
  for test in TEST_INPUTS:
    ...
    if hash_cmd in (CMD_HASH_START, CMD_HASH_CONT):
      ...
      hash_context.update(bytes(text, "ascii"))
    ...
    if hash_cmd == CMD_HASH_FINISH:
      ...
      hash_context = hmac.new(bytes(hmac_key, "ascii"), digestmod=hash_func)
    else:
