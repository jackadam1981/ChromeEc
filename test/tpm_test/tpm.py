...
def tpm2_create_ek(tpm):
    create_primary_ek = [
        ...
        0x00, 0x20, # public.auth_policy.size = 32
        ...
        0x69, 0xaa, # Above 32 bytes = TPM2_PolicySecret(TPM_RH_ENDORSEMENT)
        ...
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x20, # public_area->unique.ecc.y.b.size
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, # outside_info.size = 0
