...
const uint8_t DEFAULT_IV[] = {
		...
		0x4e, 0x1d, 0x8a, 0x66, 0x60, 0xd9, 0x5f, 0x9a,
		0xd9, 0x78, 0x72, 0x27, 0x56, 0xa7, 0x75, 0x64, };
 ...
 * operations.
 */
static void print_hex(uint8_t (*data)[], size_t n) __attribute__ ((unused));
static void print_hex(uint8_t (*data)[], size_t n)
{
	size_t x;
...
static void setup_default_empty_path(hash_t (*hashes)[]) __attribute__((unused));
