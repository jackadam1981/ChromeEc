 ...
 * 16 bits of panic reason and info (upper 16 bits should be zero). These
 * information are saved in backup RAM because hard reboot clears memory.
 * Check if lower 16 bits of reason and info are present and upper 16 bits are
 * zero.
 */
