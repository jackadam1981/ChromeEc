...
static int calandar_time_comp(struct calandar_date time_1,
			   struct calandar_date time_2)
{
...
static int test_time_conversion(void)
{
	...
	for (i = 0; i <= 50; i++) {
		...
		TEST_ASSERT(calandar_time_comp(time_1, time_2));
		...
		/*
		 * Test month boundary and leap year:
