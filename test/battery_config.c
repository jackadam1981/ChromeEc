...
static bool board_batt_conf_supported_return = true;
...
__override bool board_batt_conf_supported(void)
{
	return board_batt_conf_supported_return;
}
...
{
	board_batt_conf_supported_return = false;
