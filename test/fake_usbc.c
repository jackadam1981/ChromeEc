...
static enum tcpc_cc_polarity lcl_polarity;
__overridable void typec_select_polarity(int port,
					 enum tcpc_cc_polarity polarity)
{
	lcl_polarity = polarity;
}
__overridable int typec_update_polarity(int port)
{
	return EC_SUCCESS;
}
