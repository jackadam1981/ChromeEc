...
test_static enum ec_error_list test_cleanse_wrapper_sha256(void)
{
	...
	std::array<uint8_t, 32> expected_result = {
		0x10, 0x5C, 0xC1, 0x32, 0x30, 0x80, 0xE3, 0x73,
		0xB9, 0xFB, 0xA6, 0x88, 0x38, 0x4F, 0x40, 0xAE,
		0x45, 0x09, 0x89, 0xFB, 0xC9, 0x3A, 0xD4, 0xFD,
		0x29, 0xCA, 0x57, 0xC6, 0x29, 0xCD, 0x4A, 0x60,
	};
...
test_static enum ec_error_list test_cleanse_wrapper_normal_usage(void)
{
	...
	/* There is no way to check the contest is cleared without undefined
	 * behavior. */
