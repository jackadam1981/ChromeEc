...
test_static int test_round_divide(void)
{
	...
	/* Check macro version */
	TEST_EQ((int)ROUND_DIVIDE(10, 1), 10, "%d");
	TEST_EQ((int)ROUND_DIVIDE(10, 2), 5, "%d");
	TEST_EQ((int)ROUND_DIVIDE(10, 3), 3, "%d");
	TEST_EQ((int)ROUND_DIVIDE(10, 4), 3, "%d");
	TEST_EQ((int)ROUND_DIVIDE(10, 5), 2, "%d");
	TEST_EQ((int)ROUND_DIVIDE(10, 6), 2, "%d");
	TEST_EQ((int)ROUND_DIVIDE(10, 7), 1, "%d");
	TEST_EQ((int)ROUND_DIVIDE(10, 9), 1, "%d");
	TEST_EQ((int)ROUND_DIVIDE(10, 10), 1, "%d");
	TEST_EQ((int)ROUND_DIVIDE(10, 11), 1, "%d");
	TEST_EQ((int)ROUND_DIVIDE(10, 20), 1, "%d");
	TEST_EQ((int)ROUND_DIVIDE(10, 21), 0, "%d");
