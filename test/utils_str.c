...
static int test_strcspn(void)
{
	...
	TEST_EQ(strcspn(str1, "a"), 0lu, "%lu");
	TEST_EQ(strcspn(str1, "b"), 1lu, "%lu");
	TEST_EQ(strcspn(str1, "c"), 2lu, "%lu");
	TEST_EQ(strcspn(str1, "ccc"), 2lu, "%lu");
	TEST_EQ(strcspn(str1, "cba"), 0lu, "%lu");
	TEST_EQ(strcspn(str1, "cb"), 1lu, "%lu");
	TEST_EQ(strcspn(str1, "bc"), 1lu, "%lu");
	TEST_EQ(strcspn(str1, "cbc"), 1lu, "%lu");
	TEST_EQ(strcspn(str1, "z"), strlen(str1), "%lu");
	TEST_EQ(strcspn(str1, "xyz"), strlen(str1), "%lu");
	TEST_EQ(strcspn(str1, ""), strlen(str1), "%lu");

	TEST_EQ(strcspn(str2, " "), 4lu, "%lu");
	TEST_EQ(strcspn(str2, "\n"), 16lu, "%lu");
	TEST_EQ(strcspn(str2, "\n "), 4lu, "%lu");
	TEST_EQ(strcspn(str2, "!"), strlen(str2)-1, "%lu");
	TEST_EQ(strcspn(str2, "z"), strlen(str2), "%lu");
	TEST_EQ(strcspn(str2, "z!"), strlen(str2)-1, "%lu");
