...
test_static int test_watchdog()
{
	...
	/*
	 * TODO(b/390021325): watchdog_period_us * 1.1 should work. It appears
	 * that the watchdog timer is being set to longer than
	 * CONFIG_WATCHDOG_PERIOD_MS.
	 */
	udelay(watchdog_period_us * 3);
...
test_static int test_panic_data()
{
	 ...
	 * for the end.
	 */
	const uint32_t udelay_start_addr = reinterpret_cast<uint32_t>(udelay);
