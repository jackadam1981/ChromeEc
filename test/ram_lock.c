...
/* Set a part of code RAM to fetch protection and use to check this region can
 * be written */
...
/* Set a part of the alias region as a protection area and return success */
...
test_static int test_ram_fetch_protect(void)
{
	...
	/* The "flashinfo" command is placed in the protection region. Thus, it
	 * will cause a busfault and reboot.
	 */
	test_send_console_command("flashinfo");
