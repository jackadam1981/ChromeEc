...
int test_pd_extract_pdo_power(void)
{
	...
	pd_extract_pdo_power(MAKE_FIXED(/*v=*/5000, /*c=*/3000), &ma, &mv);
	TEST_EQ(mv, 5000, "%d");
	TEST_EQ(ma, 3000, "%d");
	pd_extract_pdo_power(MAKE_FIXED(/*v=*/20000, /*c=*/2600), &ma, &mv);
	TEST_EQ(mv, 20000, "%d");
	TEST_EQ(ma, 2600, "%d");
	pd_extract_pdo_power(MAKE_FIXED(/*v=*/20000, /*c=*/4000), &ma, &mv);
	TEST_EQ(mv, 20000, "%d");
	TEST_EQ(ma, 3000, "%d"); /* Capped at PD_MAX_CURRENT_MA */
	pd_extract_pdo_power(MAKE_FIXED(/*v=*/10000, /*c=*/4000), &ma, &mv);
	TEST_EQ(mv, 10000, "%d");
	TEST_EQ(ma, 3000, "%d"); /* Capped at PD_MAX_CURRENT_MA */
	pd_extract_pdo_power(MAKE_FIXED(/*v=*/21000, /*c=*/4000), &ma, &mv);
	TEST_EQ(mv, 21000, "%d");
	...
	pd_extract_pdo_power(MAKE_BATT(/*v_max=*/25000, /*v_min=*/5000,
				       /*p=*/61000),
			     &ma, &mv);
	TEST_EQ(mv, 25000, "%d");
	...
	pd_extract_pdo_power(
		MAKE_VAR(/*v_max=*/5000, /*v_min=*/3300, /*c=*/3000), &ma, &mv);
	TEST_EQ(mv, 5000, "%d");
	TEST_EQ(ma, 3000, "%d");
	...
	TEST_EQ(mv, 10000, "%d");
	TEST_EQ(ma, 3000, "%d"); /* Capped at PD_MAX_CURRENT_MA */
	pd_extract_pdo_power(MAKE_VAR(/*v_max=*/21000, /*v_min=*/5000,
				      /*c=*/4000),
			     &ma, &mv);
	TEST_EQ(mv, 21000, "%d");
	TEST_EQ(ma, 2857, "%d"); /* Capped at PD_MAX_POWER_MW */
	...
	pd_extract_pdo_power(
		MAKE_AUG(/*v_max=*/5000, /*v_min=*/3300, /*c=*/3000), &ma, &mv);
	TEST_EQ(mv, 5000, "%d");
	TEST_EQ(ma, 3000, "%d");
	...
	TEST_EQ(mv, 10000, "%d");
	TEST_EQ(ma, 3000, "%d"); /* Capped at PD_MAX_CURRENT_MA */
	pd_extract_pdo_power(MAKE_AUG(/*v_max=*/21000, /*v_min=*/3300,
				      /*c=*/4000),
			     &ma, &mv);
	TEST_EQ(mv, 21000, "%d");
	TEST_EQ(ma, 2857, "%d"); /* Capped at PD_MAX_POWER_MW */
