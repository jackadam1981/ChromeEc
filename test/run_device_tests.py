...
class AllTests:
    ...
    @staticmethod
    def get(board_config: BoardConfig, debugger_connected: bool) -> List[TestConfig]:
        public_tests = AllTests.get_public_tests(board_config, debugger_connected)
    ...
    def get_public_tests(board_config: BoardConfig) -> List[TestConfig]:
        tests = [
            ...
            TestConfig(
                test_name="debug",
                test_args=["debugger" if debugger_connected else "no_debugger"],
            ),
            TestConfig(
...
def get_test_list(
    config: BoardConfig, debugger_connected: bool, test_args
) -> List[TestConfig]:
    ...
    for t in test_args:
        ...
        tests = [
            test
            for test in AllTests.get(config, debugger_connected)
