...
def flash_and_run_test(
    ...
    if test.ro_image is not None:
        # Use the RO specified by the test. Replace KEY_RO, RW_FW and SIG_RW
        # in the RO image. This better reflects the production usecase in which
        # the RW part is changed and other sections (e.g rollbacks) remain
        # unchanged.
        try:
