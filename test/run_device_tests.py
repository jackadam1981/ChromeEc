...
class AllTests:
    ...
    def get_public_tests(
        ...
        tests = [
            ...
            # TODO(b/372968708): Timeout is temporarily increased due to a
            # performance regression in Renode.
            ...
            # performance regression in Renode.
            TestConfig(
                test_name="timer_dos", timeout_secs=35, skip_for_zephyr=True
            ),
    ...
    while True:
        ...
        if not line:
            ...
            if now - start > test.timeout_secs:
                ...
                logging.debug(
                    "Renode passed marker status: %s",
                    os.path.exists("/tmp/renode-test-passed"),
                )
                try:
                    with open(
