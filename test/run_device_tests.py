...
BLOONCHIPPER_CONFIG = BoardConfig(
    ...
    # stddev of 0.06 mW and fp power as 0.0 mW with a stddev of 0.03 mW.
    # However, tests are showing consistent results of mcu power of 16.2 mW
    # with stddev of 0.05 and fp power of 0.55 mW with a stddev of 0.08 mW.
    # This needs to be resolved.
    expected_fp_power=PowerUtilization(
        idle=RangedValue(0.6, 0.1), sleep=RangedValue(0.6, 0.1)
    ),
    expected_mcu_power=PowerUtilization(
        idle=RangedValue(16.2, 0.1), sleep=RangedValue(0.34, 0.13)
    ),
    variants={
