...
BLOONCHIPPER_CONFIG = BoardConfig(
    ...
    dev_board_name="google_dragonclaw",
)
...
DARTMONKEY_CONFIG = BoardConfig(
    ...
    dev_board_name="google_icetower",
)
...
def run_test_zephyr(test: TestConfig) -> str:
    ...
    # Zephyr upstream tests run automaticly
    if test.zephyr_name:
        return []
...
def flash_and_run_test(
    ...
    if test.build_board is not None:
        ...
        build_board = board_config.dev_board_name
