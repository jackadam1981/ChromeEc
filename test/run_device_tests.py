...
# TODO(bobbycasey): refactor into multiple modules
...
def enter_sleep_mode(config=None) -> bool:
    """Get the name of the console for a given board."""
    # TODO: FIX THIS - it should either be a pre-commit hook or not but not both!
    enter_sleep = True if hasattr(config, "find") else config
