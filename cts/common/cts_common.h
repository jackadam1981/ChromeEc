...
#define CTS_DEBUG_START "[DEBUG]\n" 
#define CTS_DEBUG_END "\n[DEBUG_END]"
/* Debug message should not contain text of debug start or end tag on single line */
#define CTS_DEBUG_PRINTF(format, args...) CPRINTF(CTS_DEBUG_START \
 												format CTS_DEBUG_END, ## args)
#else
