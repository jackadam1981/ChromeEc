...
enum cts_error_code dut_set_high_test(void)
{
	int level;
...
enum cts_error_code dut_set_low_test(void)
{
	int level;
...
enum cts_error_code dut_read_high_test(void)
{
...
enum cts_error_code dut_read_low_test(void)
{
	gpio_set_flags(GPIO_OUTPUT_TEST, GPIO_ODR_LOW);
