...
all-obj-y+=$(call objs_from_dir_p,core/$(CORE),core,y)
all-obj-y+=$(call objs_from_dir_p,chip/$(CHIP),chip,y)
all-obj-y+=$(call objs_from_dir_p,$(BDIR),board,y)
all-obj-y+=$(call objs_from_dir_p,private,private,y)
ifneq ($(PDIR),)
all-obj-y+=$(call objs_from_dir_p,$(PDIR),$(PDIR),y)
endif
all-obj-y+=$(call objs_from_dir_p,common,common,y)
all-obj-y+=$(call objs_from_dir_p,driver,driver,y)
all-obj-y+=$(call objs_from_dir_p,power,power,y)
ifdef CTS_MODULE
all-obj-y+=$(call objs_from_dir_p,cts,cts,y)
endif
all-obj-y+=$(call objs_from_dir_p,test,$(PROJECT),y)
...
# Get all sources to build
all-obj-y+=$(call objs_from_dir_p,core/$(CORE),core,rw)
all-obj-y+=$(call objs_from_dir_p,chip/$(CHIP),chip,rw)
all-obj-y+=$(call objs_from_dir_p,$(BDIR),board,rw)
all-obj-y+=$(call objs_from_dir_p,private,private,rw)
ifneq ($(PDIR),)
all-obj-y+=$(call objs_from_dir_p,$(PDIR),$(PDIR),rw)
endif
all-obj-y+=$(call objs_from_dir_p,common,common,rw)
all-obj-y+=$(call objs_from_dir_p,driver,driver,rw)
all-obj-y+=$(call objs_from_dir_p,power,power,rw)
ifdef CTS_MODULE
all-obj-y+=$(call objs_from_dir_p,cts,cts,rw)
endif
all-obj-y+=$(call objs_from_dir_p,test,$(PROJECT),rw)
