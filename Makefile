...
# command to define an empty string
...
CFLAGS_BASEBOARD=-DHAS_BASEBOARD=$(call empty) \
		 -DBASEBOARD_$(UC_BASEBOARD)=$(call empty)
...
_tsk_lst_flags+=-I$(BDIR) -DBOARD_$(UC_BOARD)=$(call empty) -I$(BASEDIR) \
		-DBASEBOARD_$(UC_BASEBOARD)=$(call empty) \
