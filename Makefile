...
#
# build-util-bin-y - Utils for the system doing the "build" (e.g. 64-bit GNU/Linux)
# host-util-bin-y  - Utils for the target platform on top of the ec (e.g. 32-bit Chromium OS)
